...
On clusters that support converting Machine API resources to Cluster API resources, a two-way synchronization controller creates these primary resources automatically.
For more information, see xref:../../machine_management/cluster_api_machine_management/cluster-api-getting-started.adoc#capi-mapi-conversion-overview_cluster-api-getting-started[Converting Machine API resources to Cluster API resources].

[id="creating-primary-resources_{context}"]
== Creating the Cluster API primary resources

For clusters that do not support converting Machine API resources to Cluster API resources, you must manually create the following Cluster API resources in the `openshift-cluster-api` namespace:
...
include::modules/capi-mapi-conversion-overview.adoc[leveloffset=+1]

//Converting a Machine API resource to use the Cluster API
...
* xref:../../machine_management/cluster_api_machine_management/cluster-api-disabling.adoc#capi-mapi-reversion-overview_cluster-api-disabling[Converting Cluster API resources to Machine API resources]