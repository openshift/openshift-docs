...
[role="_abstract"]
Learn how to provision and manage Cluster API resources in your {product-title} cluster, including creating machine templates and compute machine sets, and migrating between Machine API and Cluster API.
