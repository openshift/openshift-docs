...
The Cluster API is an upstream project that is integrated into {product-title} as a Technology Preview for {aws-first}, {gcp-first}, {azure-first}, {rh-openstack-first}, {vmw-first}, and bare-metal platforms.

[role="_additional-resources"]
.Additional resources

* link:https://cluster-api.sigs.k8s.io/[Kubernetes Cluster API (Kubernetes documentation)] 
