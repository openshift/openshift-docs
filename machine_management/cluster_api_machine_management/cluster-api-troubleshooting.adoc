...
[id="ts-capi-resource-conversion_{context}"]
== Troubleshooting resource conversion

#This section needs an introduction.#

//Unexpected resource deletion behavior
include::modules/ts-capi-convert-unexpected-deletion-behavior.adoc[leveloffset=+2]

//Unexpected machine scaling behavior
include::modules/ts-capi-convert-unexpected-machine-scaling-behavior.adoc[leveloffset=+2]

//Incomplete synchronization of labels and annotations 
include::modules/ts-capi-convert-sync-label-annotation.adoc[leveloffset=+2]

//Migrating {aws-short} cloud credentials
include::modules/ts-capi-convert-aws-creds.adoc[leveloffset=+2]

//Sample resource conversion TS topic
//include::modules/ts-capi-convert-sample-issue.adoc[leveloffset=+2]
...
* Gaps list
+
https://issues.redhat.com/issues/?filter=12442091 

* From code comments
+
https://redhat-internal.slack.com/archives/GE2HQ9QP4/p1746016891304809?thread_ts=1746016506.370149&cid=GE2HQ9QP4
////