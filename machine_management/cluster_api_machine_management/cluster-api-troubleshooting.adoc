...
include::modules/ts-capi-migrate-unexpected-deletion-behavior.adoc[leveloffset=+2]

//Unexpected machine scaling behavior
include::modules/ts-capi-migrate-unexpected-machine-scaling-behavior.adoc[leveloffset=+2]
...
//include::modules/ts-capi-migrate-sample-issue.adoc[leveloffset=+2]
