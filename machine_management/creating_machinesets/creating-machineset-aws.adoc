...
include::modules/machineset-creating-dedicated-hosts.adoc[leveloffset=+2]

//Place machines on a specific Dedicated Host by using machine sets
include::modules/machineset-creating-dedicated-hosts-byo-machineset.adoc[leveloffset=+2]
