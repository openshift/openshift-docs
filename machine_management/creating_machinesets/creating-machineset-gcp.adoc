...
//include::modules/mapi-machine-set-yaml-universal.adoc[leveloffset=+1]

//Creating a machine set
include::modules/machineset-creating.adoc[leveloffset=+1]

//Provider-specific machine set options
include::modules/mapi-about-providerspec.adoc[leveloffset=+1]
...
include::modules/machineset-non-guaranteed-instance.adoc[leveloffset=+2]

//Creating preemptible VM instances by using machine sets
include::modules/machineset-creating-non-guaranteed-instances.adoc[leveloffset=+3]

//Enabling customer-managed encryption keys for a machine set
include::modules/machineset-enabling-customer-managed-encryption.adoc[leveloffset=+2]
//TODO break out procedure as a L3

//Enabling GPU support for a machine set
include::modules/machineset-gcp-enabling-gpu-support.adoc[leveloffset=+2]
//TODO break out procedure as a L3
