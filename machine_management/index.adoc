...
A CRD object defines a new unique object `Kind` in the cluster and enables the Kubernetes DERP server to handle the object's entire lifecycle.

The Machine DERP Operator provisions the following resources:
