...
You can use machine management to flexibly work with underlying infrastructure such as Amazon Web Services (AWS), Microsoft Azure, {gcp-first}, {rh-openstack-first}, {rh-virtualization-first}, and VMware vSphere to manage the {product-title} cluster.
...
** xref:../machine_management/creating_machinesets/creating-machineset-alibaba.adoc#creating-machineset-alibaba[Alibaba Cloud]
