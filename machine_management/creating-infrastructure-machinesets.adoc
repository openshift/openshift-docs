...
* See xref:../architecture/control-plane.adoc#machine-config-pools-custom_control-plane[Node configuration management with machine config pools] for more information on grouping infra machines in a custom pool.
