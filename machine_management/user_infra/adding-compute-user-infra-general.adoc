...
To add more compute machines to your {product-title} cluster on bare metal, see xref:../../machine_management/managing-user-provisioned-infrastructure-manually.adoc#adding-bare-metal-compute-user-infra[Adding compute machines to bare metal].