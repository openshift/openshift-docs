...
* You xref:../../installing/installing_bare_metal/installing_bare_metal_upi/installing-bare-metal.adoc#installing-bare-metal[installed a cluster on bare metal].
* You have installation media and {op-system-first} images that you used to create your cluster. If you do not have these files, you must obtain them by following the instructions in the xref:../../installing/installing_bare_metal/installing_bare_metal_upi/installing-bare-metal.adoc#installing-bare-metal[installation procedure].
