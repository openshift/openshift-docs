...
* You xref:../../installing/installing_bare_metal/upi/installing-bare-metal.adoc#installing-bare-metal[installed a cluster on bare metal].
* You xref:../../installing/installing_platform_agnostic/installing-platform-agnostic.adoc#installing-platform-agnostic[installed a cluster on any platform].
