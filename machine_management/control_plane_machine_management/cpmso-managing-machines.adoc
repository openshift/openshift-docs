...
* xref:../../machine_management/control_plane_machine_management/cpmso-configuration.adoc#cpmso-config-provider-specific_cpmso-configuration[Provider-specific configuration options]