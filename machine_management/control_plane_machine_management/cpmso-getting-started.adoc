...
In {product-title} {product-version}, the control plane machine set is supported for Amazon Web Services (AWS), {gcp-full}, Microsoft Azure, Nutanix, and VMware vSphere clusters.
