...
* xref:../../../networking/configuring-ingress-cluster-traffic-ingress-controller.adoc.adoc#nw-ingresscontroller-change-internal_configuring-ingress-cluster-traffic-ingress-controller.adoc[Configuring the Ingress Controller endpoint publishing scope to Internal]
