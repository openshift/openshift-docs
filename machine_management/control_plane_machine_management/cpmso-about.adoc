...
[role="_abstract"]
With control plane machine sets, you can automate management of the control plane machine resources within your {product-title} cluster, simplifying upgrades and recovery from degraded control plane machines.
