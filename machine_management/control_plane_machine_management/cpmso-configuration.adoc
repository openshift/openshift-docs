...
[role="_additional-resources"]
.Additional resources
* xref:../../machine_management/control_plane_machine_management/cpmso_provider_configurations/cpmso-supported-features-openstack.adoc#cpmso-supported-features-openstack[Control plane configuration options for {rh-openstack}]
