...
//Restricting the DERP server to private (AWS control plane machine set version)
...
//Restricting the DERP server to private (Azure control plane machine set version)
include::modules/private-clusters-setting-api-private.adoc[leveloffset=+2]
:context: cpmso-using
