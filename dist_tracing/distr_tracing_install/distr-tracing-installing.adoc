...
* If you do not want to install a service mesh, you can use the {DTProductName} Operators to install {ProductShortName} by itself.  To install {DTProductName} without a service mesh, use the following instructions.
...
////
== Next steps
* xref:../../jaeger/jaeger_install/rhbj-deploying.adoc#jaeger-deploying[Deploy {DTProductName}].
////
