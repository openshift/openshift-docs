...
</div></details></details></details><div style="margin-left:13px;">      <span title="(string) Image specifies a container image which can carry out a deployment.">image</span>:
...
</div></details><div style="margin-left:13px;">          <span title="(string) ContainerName is the name of a container in the deployment pod template whose container image will be used for the hook pod&#39;s container.">containerName</span>:
