...
| HTTP code | Reponse body
| 200 - OK
| xref:../objects/index.adoc#apiservicelist-apiregistration-k8s-io-v1[`APIServiceList apiregistration.k8s.io/v1`]
| 401 - Unauthorized
| Empty
|===
...
| Parameter | Type | Description
| `body`
| xref:../apiregistration_k8s_io/apiservice-apiregistration-k8s-io-v1.adoc#apiservice-apiregistration-k8s-io-v1[`APIService apiregistration.k8s.io/v1`]
| 
|===
