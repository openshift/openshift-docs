...
</div></details><details><summary><span title="(v1.NetworkPolicySpec) Specification of the desired behavior for this NetworkPolicy.">spec</span>:
...
</summary><details><summary>    - <span title="(v1.IPBlock) IPBlock defines policy on a particular IPBlock. If this field is set then neither of the other fields can be.">ipBlock</span>:
