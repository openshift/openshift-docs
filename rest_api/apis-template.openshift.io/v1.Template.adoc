...
== Description
[%hardbreaks]
<<<<<<< HEAD:rest_api/apis-template.openshift.io/v1.Template.adoc
...
>>>>>>> ce18cef... update rest api docs to latest master:rest_api/apis-apps/v1beta2.ControllerRevision.adoc
...
|200 OK|v1.Template
=======
|200 OK|v1beta2.ControllerRevision
|201 Created|v1beta2.ControllerRevision
|202 Accepted|v1beta2.ControllerRevision
>>>>>>> ce18cef... update rest api docs to latest master:rest_api/apis-apps/v1beta2.ControllerRevision.adoc
|401 Unauthorized|
|===
