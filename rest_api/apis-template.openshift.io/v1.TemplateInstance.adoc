...
|===
|HTTP Code|Schema
<<<<<<< HEAD:rest_api/apis-template.openshift.io/v1.TemplateInstance.adoc
...
>>>>>>> ce18cef... update rest api docs to latest master:rest_api/apis-autoscaling/v2beta1.HorizontalPodAutoscaler.adoc
|401 Unauthorized|
|===
