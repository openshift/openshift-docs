...
| `template`
| xref:../../rest_api/objects/index.adoc#podtemplatespec-core-v1[`PodTemplateSpec core/v1`]
...
| `active`
| xref:../../rest_api/objects/index.adoc#objectreference-core-v1[`array (ObjectReference core/v1)`]
...
| 200 - OK
| xref:../../rest_api/objects/index.adoc#cronjoblist-batch-v1beta1[`CronJobList batch/v1beta1`]
|===
...
| Parameter | Type | Description
| `body`
| xref:../workloads_apis/cronjob-batch-v1beta1.adoc#cronjob-batch-v1beta1[`CronJob batch/v1beta1`]
|
|===
