...
| HTTP code | Reponse body
| 200 - OK
| xref:../objects/index.adoc#oauthauthorizetokenlist-oauth-openshift-io-v1[`OAuthAuthorizeTokenList oauth.openshift.io/v1`]
|===
...
| Parameter | Type | Description
| `body`
| xref:../oauth_apis/oauthauthorizetoken-oauth-openshift-io-v1.adoc#oauthauthorizetoken-oauth-openshift-io-v1[`OAuthAuthorizeToken oauth.openshift.io/v1`]
| 
|===
