...
| Parameter | Type | Description
| `body`
| xref:../oauth_apis/oauthclientauthorization-oauth-openshift-io-v1.adoc#oauthclientauthorization-oauth-openshift-io-v1[`OAuthClientAuthorization oauth.openshift.io/v1`]
| 
|===
