...
| 200 - OK
| xref:../objects/index.adoc#endpointslicelist-discovery-k8s-io-v1[`EndpointSliceList discovery.k8s.io/v1`]
|===
...
| Parameter | Type | Description
| `body`
| xref:../network_apis/endpointslice-discovery-k8s-io-v1.adoc#endpointslice-discovery-k8s-io-v1[`EndpointSlice discovery.k8s.io/v1`]
| 
|===
