...
| 200 - OK
| xref:../objects/index.adoc#podnetworkconnectivitychecklist-controlplane-operator-openshift-io-v1alpha1[`PodNetworkConnectivityCheckList controlplane.operator.openshift.io/v1alpha1`]
|===
...
| Parameter | Type | Description
| `body`
| xref:../network_apis/podnetworkconnectivitycheck-controlplane-operator-openshift-io-v1alpha1.adoc#podnetworkconnectivitycheck-controlplane-operator-openshift-io-v1alpha1[`PodNetworkConnectivityCheck controlplane.operator.openshift.io/v1alpha1`]
| 
|===
