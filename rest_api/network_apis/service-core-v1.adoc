...
| `ports`
| xref:../../rest_api/objects/index.adoc#serviceport-core-v1[`array (ServicePort core/v1)`]
...
| xref:../../rest_api/objects/index.adoc#sessionaffinityconfig-core-v1[`SessionAffinityConfig core/v1`]
...
| `conditions`
| xref:../../rest_api/objects/index.adoc#condition-meta-v1[`array (Condition meta/v1)`]
...
| `ingress`
| xref:../../rest_api/objects/index.adoc#loadbalanceringress-core-v1[`array (LoadBalancerIngress core/v1)`]
...
| 200 - OK
| xref:../../rest_api/objects/index.adoc#servicelist-core-v1[`ServiceList core/v1`]
|===
