...
- `GET`: list objects of kind NetNamespace
...
| Parameter | Type | Description
| `body`
| xref:../network_apis/netnamespace-network-openshift-io-v1.adoc#netnamespace-network-openshift-io-v1[`NetNamespace network.openshift.io/v1`]
| 
|===
