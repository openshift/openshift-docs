...
| 200 - OK
| xref:../objects/index.adoc#networkattachmentdefinitionlist-k8s-cni-cncf-io-v1[`NetworkAttachmentDefinitionList k8s.cni.cncf.io/v1`]
|===
...
| Parameter | Type | Description
| `body`
| xref:../network_apis/networkattachmentdefinition-k8s-cni-cncf-io-v1.adoc#networkattachmentdefinition-k8s-cni-cncf-io-v1[`NetworkAttachmentDefinition k8s.cni.cncf.io/v1`]
| 
|===
