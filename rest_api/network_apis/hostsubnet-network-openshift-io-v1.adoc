...
- `GET`: list objects of kind HostSubnet
...
| Parameter | Type | Description
| `body`
| xref:../network_apis/hostsubnet-network-openshift-io-v1.adoc#hostsubnet-network-openshift-io-v1[`HostSubnet network.openshift.io/v1`]
| 
|===
