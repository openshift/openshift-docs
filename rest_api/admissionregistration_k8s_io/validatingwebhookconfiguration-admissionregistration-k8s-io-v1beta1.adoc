[id="validatingwebhookconfiguration-admissionregistration-k8s-io-v1beta1"]
...
| HTTP code | Reponse body
| 200 - OK
| xref:../objects/index.adoc#validatingwebhookconfigurationlist-admissionregistration-k8s-io-v1beta1[`ValidatingWebhookConfigurationList admissionregistration.k8s.io/v1beta1`]
| 401 - Unauthorized
| Empty
|===
...
| Parameter | Type | Description
| `body`
| xref:../admissionregistration_k8s_io/validatingwebhookconfiguration-admissionregistration-k8s-io-v1beta1.adoc#validatingwebhookconfiguration-admissionregistration-k8s-io-v1beta1[`ValidatingWebhookConfiguration admissionregistration.k8s.io/v1beta1`]
| 
|===
