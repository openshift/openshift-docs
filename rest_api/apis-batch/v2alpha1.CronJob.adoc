...
</div></details><details><summary><span title="(v2alpha1.CronJobSpec) Specification of the desired behavior of a cron job, including the schedule. More info: https://git.k8s.io/community/contributors/devel/api-conventions.md#spec-and-status">spec</span>:
...
[[Post-apis-batch-v2alpha1-cronjobs]]
=== Create a CronJob
Create a CronJob

==== HTTP request
----
POST /apis/batch/v2alpha1/cronjobs HTTP/1.1
...
$ curl -k \
    ...
    https://$ENDPOINT/apis/batch/v2alpha1/cronjobs <<'EOF'
{
  "kind": "CronJob",
  "apiVersion": "batch/v2alpha1",
  ...
...
==== HTTP request
----
POST /apis/batch/v2alpha1/namespaces/$NAMESPACE/cronjobs HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
Content-Type: application/json'
...
$ curl -k \
    ...
    -H 'Accept: application/json' \
    -H 'Content-Type: application/json' \
    https://$ENDPOINT/apis/batch/v2alpha1/namespaces/$NAMESPACE/cronjobs <<'EOF'
{
  "kind": "CronJob",
  "apiVersion": "batch/v2alpha1",
  ...
...
==== HTTP request
----
GET /apis/batch/v2alpha1/namespaces/$NAMESPACE/cronjobs/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/apis/batch/v2alpha1/namespaces/$NAMESPACE/cronjobs/$NAME
----
...
==== HTTP request
----
GET /apis/batch/v2alpha1/cronjobs HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/apis/batch/v2alpha1/cronjobs
----
...
==== HTTP request
----
GET /apis/batch/v2alpha1/namespaces/$NAMESPACE/cronjobs HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/apis/batch/v2alpha1/namespaces/$NAMESPACE/cronjobs
----
...
==== HTTP request
----
GET /apis/batch/v2alpha1/watch/namespaces/$NAMESPACE/cronjobs/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/apis/batch/v2alpha1/watch/namespaces/$NAMESPACE/cronjobs/$NAME
----
...
==== HTTP request
----
GET /apis/batch/v2alpha1/watch/cronjobs HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/apis/batch/v2alpha1/watch/cronjobs
----
...
==== HTTP request
----
GET /apis/batch/v2alpha1/watch/namespaces/$NAMESPACE/cronjobs HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/apis/batch/v2alpha1/watch/namespaces/$NAMESPACE/cronjobs
----
...
==== HTTP request
----
PUT /apis/batch/v2alpha1/namespaces/$NAMESPACE/cronjobs/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
Content-Type: application/json'
...
$ curl -k \
    ...
    -H 'Accept: application/json' \
    -H 'Content-Type: application/json' \
    https://$ENDPOINT/apis/batch/v2alpha1/namespaces/$NAMESPACE/cronjobs/$NAME <<'EOF'
{
  "kind": "CronJob",
  "apiVersion": "batch/v2alpha1",
  ...
...
==== HTTP request
----
PATCH /apis/batch/v2alpha1/namespaces/$NAMESPACE/cronjobs/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
...
==== HTTP request
----
DELETE /apis/batch/v2alpha1/namespaces/$NAMESPACE/cronjobs/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
Content-Type: application/json'
...
==== HTTP request
----
DELETE /apis/batch/v2alpha1/namespaces/$NAMESPACE/cronjobs HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
==== HTTP request
----
GET /apis/batch/v2alpha1/namespaces/$NAMESPACE/cronjobs/$NAME/status HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/apis/batch/v2alpha1/namespaces/$NAMESPACE/cronjobs/$NAME/status
----
...
==== HTTP request
----
PUT /apis/batch/v2alpha1/namespaces/$NAMESPACE/cronjobs/$NAME/status HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
Content-Type: application/json'
...
$ curl -k \
    ...
    -H 'Accept: application/json' \
    -H 'Content-Type: application/json' \
    https://$ENDPOINT/apis/batch/v2alpha1/namespaces/$NAMESPACE/cronjobs/$NAME/status <<'EOF'
{
  "kind": "CronJob",
  "apiVersion": "batch/v2alpha1",
  ...
...
==== HTTP request
----
PATCH /apis/batch/v2alpha1/namespaces/$NAMESPACE/cronjobs/$NAME/status HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
Content-Type: application/json-patch+json'
