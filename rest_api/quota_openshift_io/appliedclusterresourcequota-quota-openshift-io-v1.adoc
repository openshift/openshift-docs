...
| HTTP code | Reponse body
| 200 - OK
| xref:../quota_openshift_io/appliedclusterresourcequota-quota-openshift-io-v1.adoc#appliedclusterresourcequota-quota-openshift-io-v1[`AppliedClusterResourceQuota quota.openshift.io/v1`]
| 401 - Unauthorized
| Empty
|===
