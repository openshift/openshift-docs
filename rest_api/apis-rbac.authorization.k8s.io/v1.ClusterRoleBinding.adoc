...
</div></details><details><summary><span title="(v1.RoleRef) RoleRef can only reference a ClusterRole in the global namespace. If the RoleRef cannot be resolved, the Authorizer must return an error.">roleRef</span>:
...
==== HTTP request
----
POST /apis/rbac.authorization.k8s.io/v1/clusterrolebindings HTTP/1.1
...
$ curl -k \
    ...
    https://$ENDPOINT/apis/rbac.authorization.k8s.io/v1/clusterrolebindings <<'EOF'
{
  "kind": "ClusterRoleBinding",
  "apiVersion": "rbac.authorization.k8s.io/v1",
  ...
...
==== HTTP request
----
GET /apis/rbac.authorization.k8s.io/v1/clusterrolebindings/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/apis/rbac.authorization.k8s.io/v1/clusterrolebindings/$NAME
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/apis/rbac.authorization.k8s.io/v1/clusterrolebindings
----
...
==== HTTP request
----
GET /apis/rbac.authorization.k8s.io/v1/watch/clusterrolebindings/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/apis/rbac.authorization.k8s.io/v1/watch/clusterrolebindings/$NAME
----
...
==== HTTP request
----
GET /apis/rbac.authorization.k8s.io/v1/watch/clusterrolebindings HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/apis/rbac.authorization.k8s.io/v1/watch/clusterrolebindings
----
...
==== HTTP request
----
PUT /apis/rbac.authorization.k8s.io/v1/clusterrolebindings/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
Content-Type: application/json'
...
$ curl -k \
    ...
    -H 'Accept: application/json' \
    -H 'Content-Type: application/json' \
    https://$ENDPOINT/apis/rbac.authorization.k8s.io/v1/clusterrolebindings/$NAME <<'EOF'
{
  "kind": "ClusterRoleBinding",
  "apiVersion": "rbac.authorization.k8s.io/v1",
  ...
...
==== HTTP request
----
PATCH /apis/rbac.authorization.k8s.io/v1/clusterrolebindings/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
...
==== HTTP request
----
DELETE /apis/rbac.authorization.k8s.io/v1/clusterrolebindings/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
Content-Type: application/json'
...
==== HTTP request
----
DELETE /apis/rbac.authorization.k8s.io/v1/clusterrolebindings HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
