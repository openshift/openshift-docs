...
==== HTTP request
----
POST /apis/rbac.authorization.k8s.io/v1/clusterroles HTTP/1.1
...
$ curl -k \
    ...
    https://$ENDPOINT/apis/rbac.authorization.k8s.io/v1/clusterroles <<'EOF'
{
  "kind": "ClusterRole",
  "apiVersion": "rbac.authorization.k8s.io/v1",
  ...
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/apis/rbac.authorization.k8s.io/v1/clusterroles/$NAME
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/apis/rbac.authorization.k8s.io/v1/clusterroles
----
...
==== HTTP request
----
GET /apis/rbac.authorization.k8s.io/v1/watch/clusterroles/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/apis/rbac.authorization.k8s.io/v1/watch/clusterroles/$NAME
----
...
==== HTTP request
----
GET /apis/rbac.authorization.k8s.io/v1/watch/clusterroles HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/apis/rbac.authorization.k8s.io/v1/watch/clusterroles
----
...
==== HTTP request
----
PUT /apis/rbac.authorization.k8s.io/v1/clusterroles/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
Content-Type: application/json'
...
$ curl -k \
    ...
    -H 'Accept: application/json' \
    -H 'Content-Type: application/json' \
    https://$ENDPOINT/apis/rbac.authorization.k8s.io/v1/clusterroles/$NAME <<'EOF'
{
  "kind": "ClusterRole",
  "apiVersion": "rbac.authorization.k8s.io/v1",
  ...
...
==== HTTP request
----
PATCH /apis/rbac.authorization.k8s.io/v1/clusterroles/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
...
==== HTTP request
----
DELETE /apis/rbac.authorization.k8s.io/v1/clusterroles/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
Content-Type: application/json'
...
==== HTTP request
----
DELETE /apis/rbac.authorization.k8s.io/v1/clusterroles HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
