...
==== HTTP request
----
POST /apis/rbac.authorization.k8s.io/v1/namespaces/$NAMESPACE/roles HTTP/1.1
...
$ curl -k \
    ...
    https://$ENDPOINT/apis/rbac.authorization.k8s.io/v1/namespaces/$NAMESPACE/roles <<'EOF'
{
  "kind": "Role",
  "apiVersion": "rbac.authorization.k8s.io/v1",
  ...
...
==== HTTP request
----
GET /apis/rbac.authorization.k8s.io/v1/namespaces/$NAMESPACE/roles/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/apis/rbac.authorization.k8s.io/v1/namespaces/$NAMESPACE/roles/$NAME
----
...
==== HTTP request
----
GET /apis/rbac.authorization.k8s.io/v1/roles HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/apis/rbac.authorization.k8s.io/v1/roles
----
...
==== HTTP request
----
GET /apis/rbac.authorization.k8s.io/v1/namespaces/$NAMESPACE/roles HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/apis/rbac.authorization.k8s.io/v1/namespaces/$NAMESPACE/roles
----
...
==== HTTP request
----
GET /apis/rbac.authorization.k8s.io/v1/watch/namespaces/$NAMESPACE/roles/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/apis/rbac.authorization.k8s.io/v1/watch/namespaces/$NAMESPACE/roles/$NAME
----
...
==== HTTP request
----
GET /apis/rbac.authorization.k8s.io/v1/watch/roles HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/apis/rbac.authorization.k8s.io/v1/watch/roles
----
...
==== HTTP request
----
GET /apis/rbac.authorization.k8s.io/v1/watch/namespaces/$NAMESPACE/roles HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/apis/rbac.authorization.k8s.io/v1/watch/namespaces/$NAMESPACE/roles
----
...
==== HTTP request
----
PUT /apis/rbac.authorization.k8s.io/v1/namespaces/$NAMESPACE/roles/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
Content-Type: application/json'
...
$ curl -k \
    ...
    -H 'Accept: application/json' \
    -H 'Content-Type: application/json' \
    https://$ENDPOINT/apis/rbac.authorization.k8s.io/v1/namespaces/$NAMESPACE/roles/$NAME <<'EOF'
{
  "kind": "Role",
  "apiVersion": "rbac.authorization.k8s.io/v1",
  ...
...
==== HTTP request
----
PATCH /apis/rbac.authorization.k8s.io/v1/namespaces/$NAMESPACE/roles/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
...
==== HTTP request
----
DELETE /apis/rbac.authorization.k8s.io/v1/namespaces/$NAMESPACE/roles/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
Content-Type: application/json'
...
==== HTTP request
----
DELETE /apis/rbac.authorization.k8s.io/v1/namespaces/$NAMESPACE/roles HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
