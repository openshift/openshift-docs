...
| 200 - OK
| xref:../objects/index.adoc#routelist-route-openshift-io-v1[`RouteList route.openshift.io/v1`]
| 401 - Unauthorized
| Empty
|===
...
| Parameter | Type | Description
| `body`
| xref:../route_openshift_io/route-route-openshift-io-v1.adoc#route-route-openshift-io-v1[`Route route.openshift.io/v1`]
| 
|===
