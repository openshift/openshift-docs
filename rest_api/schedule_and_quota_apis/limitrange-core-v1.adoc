...
| 200 - OK
| xref:../objects/index.adoc#limitrangelist-core-v1[`LimitRangeList core/v1`]
|===
...
| Parameter | Type | Description
| `body`
| xref:../schedule_and_quota_apis/limitrange-core-v1.adoc#limitrange-core-v1[`LimitRange core/v1`]
| 
|===
