...
| HTTP code | Reponse body
| 200 - OK
| xref:../objects/index.adoc#flowschemalist-flowcontrol-apiserver-k8s-io-v1alpha1[`FlowSchemaList flowcontrol.apiserver.k8s.io/v1alpha1`]
| 401 - Unauthorized
| Empty
|===
...
| Parameter | Type | Description
| `body`
| xref:../schedule_and_quota_apis/flowschema-flowcontrol-apiserver-k8s-io-v1alpha1.adoc#flowschema-flowcontrol-apiserver-k8s-io-v1alpha1[`FlowSchema flowcontrol.apiserver.k8s.io/v1alpha1`]
| 
|===
