...
</div></details><details><summary><span title="(v1.SelfSubjectAccessReviewSpec) Spec holds information about the request being evaluated.  user and groups must be empty">spec</span>:
