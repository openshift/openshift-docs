...
| HTTP code | Reponse body
| 200 - OK
| xref:../objects/index.adoc#volumeattachmentlist-storage-k8s-io-v1[`VolumeAttachmentList storage.k8s.io/v1`]
| 401 - Unauthorized
| Empty
|===
...
| Parameter | Type | Description
| `body`
| xref:../storage_apis/volumeattachment-storage-k8s-io-v1.adoc#volumeattachment-storage-k8s-io-v1[`VolumeAttachment storage.k8s.io/v1`]
| 
|===
