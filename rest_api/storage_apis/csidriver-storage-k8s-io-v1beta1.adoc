...
| HTTP code | Reponse body
| 200 - OK
| xref:../objects/index.adoc#csidriverlist-storage-k8s-io-v1beta1[`CSIDriverList storage.k8s.io/v1beta1`]
| 401 - Unauthorized
| Empty
|===
...
| Parameter | Type | Description
| `body`
| xref:../storage_apis/csidriver-storage-k8s-io-v1beta1.adoc#csidriver-storage-k8s-io-v1beta1[`CSIDriver storage.k8s.io/v1beta1`]
| 
|===
