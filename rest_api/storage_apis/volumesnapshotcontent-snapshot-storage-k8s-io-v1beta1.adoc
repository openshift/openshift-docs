...
* `/apis/snapshot.storage.k8s.io/v1beta1/volumesnapshotcontents`
...
* `/apis/snapshot.storage.k8s.io/v1beta1/volumesnapshotcontents/{name}`
...
* `/apis/snapshot.storage.k8s.io/v1beta1/volumesnapshotcontents/{name}/status`
...
| HTTP code | Reponse body
| 200 - OK
| xref:../objects/index.adoc#volumesnapshotcontentlist-snapshot-storage-k8s-io-v1beta1[`VolumeSnapshotContentList snapshot.storage.k8s.io/v1beta1`]
| 401 - Unauthorized
| Empty
|===
...
| Parameter | Type | Description
| `body`
| xref:../storage_apis/volumesnapshotcontent-snapshot-storage-k8s-io-v1beta1.adoc#volumesnapshotcontent-snapshot-storage-k8s-io-v1beta1[`VolumeSnapshotContent snapshot.storage.k8s.io/v1beta1`]
| 
|===
