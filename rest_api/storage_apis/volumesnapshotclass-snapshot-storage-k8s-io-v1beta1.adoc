...
* `/apis/snapshot.storage.k8s.io/v1beta1/volumesnapshotclasses/{name}`
...
| HTTP code | Reponse body
| 200 - OK
| xref:../objects/index.adoc#volumesnapshotclasslist-snapshot-storage-k8s-io-v1beta1[`VolumeSnapshotClassList snapshot.storage.k8s.io/v1beta1`]
| 401 - Unauthorized
| Empty
|===
...
| Parameter | Type | Description
| `body`
| xref:../storage_apis/volumesnapshotclass-snapshot-storage-k8s-io-v1beta1.adoc#volumesnapshotclass-snapshot-storage-k8s-io-v1beta1[`VolumeSnapshotClass snapshot.storage.k8s.io/v1beta1`]
| 
|===
