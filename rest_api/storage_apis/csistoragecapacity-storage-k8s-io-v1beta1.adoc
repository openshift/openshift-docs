[id="csistoragecapacity-storage-k8s-io-v1beta1"]
...
| 200 - OK
| xref:../objects/index.adoc#csistoragecapacitylist-storage-k8s-io-v1beta1[`CSIStorageCapacityList storage.k8s.io/v1beta1`]
|===
...
| Parameter | Type | Description
| `body`
| xref:../storage_apis/csistoragecapacity-storage-k8s-io-v1beta1.adoc#csistoragecapacity-storage-k8s-io-v1beta1[`CSIStorageCapacity storage.k8s.io/v1beta1`]
| 
|===
