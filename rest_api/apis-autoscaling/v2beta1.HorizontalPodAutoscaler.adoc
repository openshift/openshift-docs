...
</div><details><summary><span title="(v1.ObjectMeta) metadata is the standard object metadata. More info: https://git.k8s.io/community/contributors/devel/api-conventions.md#metadata">metadata</span>:
...
</div></details><details><summary><span title="(v2beta1.HorizontalPodAutoscalerSpec) spec is the specification for the behaviour of the autoscaler. More info: https://git.k8s.io/community/contributors/devel/api-conventions.md#spec-and-status.">spec</span>:
