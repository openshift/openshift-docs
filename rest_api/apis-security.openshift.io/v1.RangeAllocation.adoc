...
</div><div style="margin-left:13px;"><span title="(string) data is a byte array representing the serialized state of a range allocation.  It is a bitmap with each bit set to one to represent a range is taken.">data</span>:
...
</div></details><div style="margin-left:13px;"><span title="(string) range is a string representing a unique label for a range of uids, &#34;1000000000-2000000000/10000&#34;.">range</span>:
</div>
</pre>
++++
...
[[Post-apis-security.openshift.io-v1-rangeallocations]]
=== Create a RangeAllocation
Create a RangeAllocation

==== HTTP request
----
POST /apis/security.openshift.io/v1/rangeallocations HTTP/1.1
...
$ curl -k \
    ...
    https://$ENDPOINT/apis/security.openshift.io/v1/rangeallocations <<'EOF'
{
  "kind": "RangeAllocation",
  "apiVersion": "security.openshift.io/v1",
  ...
...
|===
|HTTP Code|Schema
|200 OK|v1.RangeAllocation
|201 Created|v1.RangeAllocation
|202 Accepted|v1.RangeAllocation
|401 Unauthorized|
|===
...
[[Get-apis-security.openshift.io-v1-rangeallocations-name]]
=== Get a RangeAllocation
Read the specified RangeAllocation

==== HTTP request
----
GET /apis/security.openshift.io/v1/rangeallocations/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/apis/security.openshift.io/v1/rangeallocations/$NAME
----
...
|===
|Parameter|Description
|name|name of the RangeAllocation
|===
...
[[Get-apis-security.openshift.io-v1-rangeallocations]]
=== Get all RangeAllocations
List or watch objects of kind RangeAllocation

==== HTTP request
----
GET /apis/security.openshift.io/v1/rangeallocations HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/apis/security.openshift.io/v1/rangeallocations
----
...
[[Get-apis-security.openshift.io-v1-watch-rangeallocations-name]]
=== Watch a RangeAllocation
Watch changes to an object of kind RangeAllocation

==== HTTP request
----
GET /apis/security.openshift.io/v1/watch/rangeallocations/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/apis/security.openshift.io/v1/watch/rangeallocations/$NAME
----
...
[[Get-apis-security.openshift.io-v1-watch-rangeallocations]]
=== Watch all RangeAllocations
Watch individual changes to a list of RangeAllocation

==== HTTP request
----
GET /apis/security.openshift.io/v1/watch/rangeallocations HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/apis/security.openshift.io/v1/watch/rangeallocations
----
...
[[Put-apis-security.openshift.io-v1-rangeallocations-name]]
=== Update a RangeAllocation
Replace the specified RangeAllocation

==== HTTP request
----
PUT /apis/security.openshift.io/v1/rangeallocations/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
Content-Type: application/json'
...
$ curl -k \
    ...
    -H 'Accept: application/json' \
    -H 'Content-Type: application/json' \
    https://$ENDPOINT/apis/security.openshift.io/v1/rangeallocations/$NAME <<'EOF'
{
  "kind": "RangeAllocation",
  "apiVersion": "security.openshift.io/v1",
  ...
...
[[Patch-apis-security.openshift.io-v1-rangeallocations-name]]
=== Patch a RangeAllocation
Partially update the specified RangeAllocation

==== HTTP request
----
PATCH /apis/security.openshift.io/v1/rangeallocations/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
...
[[Delete-apis-security.openshift.io-v1-rangeallocations-name]]
=== Delete a RangeAllocation
Delete a RangeAllocation

==== HTTP request
----
DELETE /apis/security.openshift.io/v1/rangeallocations/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
Content-Type: application/json'
...
[[Delete-apis-security.openshift.io-v1-rangeallocations]]
=== Delete all RangeAllocations
Delete collection of RangeAllocation

==== HTTP request
----
DELETE /apis/security.openshift.io/v1/rangeallocations HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
