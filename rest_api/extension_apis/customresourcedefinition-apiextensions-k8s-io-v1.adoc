...
| HTTP code | Reponse body
| 200 - OK
| xref:../objects/index.adoc#customresourcedefinitionlist-apiextensions-k8s-io-v1[`CustomResourceDefinitionList apiextensions.k8s.io/v1`]
|===
...
| Parameter | Type | Description
| `body`
| xref:../extension_apis/customresourcedefinition-apiextensions-k8s-io-v1.adoc#customresourcedefinition-apiextensions-k8s-io-v1[`CustomResourceDefinition apiextensions.k8s.io/v1`]
| 
|===
