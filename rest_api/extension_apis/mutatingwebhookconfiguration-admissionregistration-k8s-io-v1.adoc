...
| HTTP code | Reponse body
| 200 - OK
| xref:../objects/index.adoc#mutatingwebhookconfigurationlist-admissionregistration-k8s-io-v1[`MutatingWebhookConfigurationList admissionregistration.k8s.io/v1`]
|===
...
| Parameter | Type | Description
| `body`
| xref:../extension_apis/mutatingwebhookconfiguration-admissionregistration-k8s-io-v1.adoc#mutatingwebhookconfiguration-admissionregistration-k8s-io-v1[`MutatingWebhookConfiguration admissionregistration.k8s.io/v1`]
| 
|===
