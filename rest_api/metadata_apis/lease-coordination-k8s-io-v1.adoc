...
| 200 - OK
| xref:../objects/index.adoc#leaselist-coordination-k8s-io-v1[`LeaseList coordination.k8s.io/v1`]
| 401 - Unauthorized
| Empty
|===
...
| Parameter | Type | Description
| `body`
| xref:../metadata_apis/lease-coordination-k8s-io-v1.adoc#lease-coordination-k8s-io-v1[`Lease coordination.k8s.io/v1`]
| 
|===
