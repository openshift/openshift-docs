...
| 200 - OK
| xref:../objects/index.adoc#eventlist-events-k8s-io-v1[`EventList events.k8s.io/v1`]
| 401 - Unauthorized
| Empty
|===
...
| Parameter | Type | Description
| `body`
| xref:../metadata_apis/event-events-k8s-io-v1.adoc#event-events-k8s-io-v1[`Event events.k8s.io/v1`]
| 
|===
