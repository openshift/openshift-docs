...
</div></details><details><summary><span title="(v1.ClusterResourceQuotaSpec) Spec defines the desired quota">spec</span>:
...
</div></details><details><summary>    <span title="(v1.ScopeSelector) scopeSelector is also a collection of filters like scopes that must match each object tracked by a quota but expressed using ScopeSelectorOperator in combination with possible values. For a resource to match, both scopes AND scopeSelector (if specified in spec), must be matched.">scopeSelector</span>:
</summary><details><summary>      <span title="(array) A list of scope selector requirements by scope of the resources.">matchExpressions</span>:
</summary><div style="margin-left:13px;">      - <span title="(string) Represents a scope&#39;s relationship to a set of values. Valid operators are In, NotIn, Exists, DoesNotExist.">operator</span>:
</div><div style="margin-left:13px;">        <span title="(string) The name of the scope that the selector applies to.">scopeName</span>:
</div><details><summary>        <span title="(array) An array of string values. If the operator is In or NotIn, the values array must be non-empty. If the operator is Exists or DoesNotExist, the values array must be empty. This array is replaced during a strategic merge patch.">values</span>:
</summary><div style="margin-left:13px;">        - <span title="(string)">[string]</span>:
</div></details></details></details><details><summary>    <span title="(array) A collection of filters that must match each object tracked by a quota. If not specified, the quota matches all objects.">scopes</span>:
</summary><div style="margin-left:13px;">    - <span title="(string)">[string]</span>:
