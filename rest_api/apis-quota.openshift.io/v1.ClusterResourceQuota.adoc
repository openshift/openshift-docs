...
|===
|HTTP Code|Schema
<<<<<<< HEAD:rest_api/apis-quota.openshift.io/v1.ClusterResourceQuota.adoc
|200 OK|v1.ClusterResourceQuota
=======
|200 OK|v1.ClusterRole
|201 Created|v1.ClusterRole
|202 Accepted|v1.ClusterRole
>>>>>>> ce18cef... update rest api docs to latest master:rest_api/apis-rbac.authorization.k8s.io/v1.ClusterRole.adoc
|401 Unauthorized|
|===
