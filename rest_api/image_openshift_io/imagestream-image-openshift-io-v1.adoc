...
| Parameter | Type | Description
| `body`
| xref:../image_openshift_io/imagestream-image-openshift-io-v1.adoc#imagestream-image-openshift-io-v1[`ImageStream image.openshift.io/v1`]
| 
|===
...
| HTTP code | Reponse body
| 200 - OK
| xref:../objects/index.adoc#secretlist-core-v1[`SecretList core/v1`]
| 401 - Unauthorized
| Empty
|===
