...
[id="ingressclasslist-networking-k8s-io-v1beta1"]
== IngressClassList [networking.k8s.io/v1beta1]
...
| `.items`
| xref:../network_apis/ingressclass-networking-k8s-io-v1beta1.adoc#ingressclass-networking-k8s-io-v1beta1[`array (IngressClass networking.k8s.io/v1beta1)`]
