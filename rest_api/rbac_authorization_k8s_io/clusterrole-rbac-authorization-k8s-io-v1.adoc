...
| Parameter | Type | Description
| `body`
| xref:../rbac_authorization_k8s_io/clusterrole-rbac-authorization-k8s-io-v1.adoc#clusterrole-rbac-authorization-k8s-io-v1[`ClusterRole rbac.authorization.k8s.io/v1`]
| 
|===
