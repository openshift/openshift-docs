...
| Parameter | Type | Description
| `body`
| xref:../rbac_authorization_k8s_io/clusterrolebinding-rbac-authorization-k8s-io-v1.adoc#clusterrolebinding-rbac-authorization-k8s-io-v1[`ClusterRoleBinding rbac.authorization.k8s.io/v1`]
| 
|===
