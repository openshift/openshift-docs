...
| 200 - OK
| xref:../objects/index.adoc#rolebindinglist-rbac-authorization-k8s-io-v1[`RoleBindingList rbac.authorization.k8s.io/v1`]
| 401 - Unauthorized
| Empty
|===
...
| Parameter | Type | Description
| `body`
| xref:../rbac_authorization_k8s_io/rolebinding-rbac-authorization-k8s-io-v1.adoc#rolebinding-rbac-authorization-k8s-io-v1[`RoleBinding rbac.authorization.k8s.io/v1`]
| 
|===
