...
| 200 - OK
| xref:../objects/index.adoc#imagetaglist-image-openshift-io-v1[`ImageTagList image.openshift.io/v1`]
|===
...
| Parameter | Type | Description
| `body`
| xref:../image_apis/imagetag-image-openshift-io-v1.adoc#imagetag-image-openshift-io-v1[`ImageTag image.openshift.io/v1`]
| 
|===
