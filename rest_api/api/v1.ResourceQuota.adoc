...
</div></details><details><summary><span title="(v1.ResourceQuotaSpec) Spec defines the desired quota. https://git.k8s.io/community/contributors/devel/api-conventions.md#spec-and-status">spec</span>:
