...
</div></details><details><summary><span title="(v1.LimitRangeSpec) Spec defines the limits enforced. More info: https://git.k8s.io/community/contributors/devel/api-conventions.md#spec-and-status">spec</span>:
