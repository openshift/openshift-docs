...
</div><details><summary><span title="(v1.ObjectMeta) metadata for EgressNetworkPolicy">metadata</span>:
...
</div></details><details><summary><span title="(v1.EgressNetworkPolicySpec) spec is the specification of the current egress network policy">spec</span>:
