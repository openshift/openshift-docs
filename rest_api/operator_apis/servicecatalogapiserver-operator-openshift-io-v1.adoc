...
* `/apis/operator.openshift.io/v1/servicecatalogapiservers`
- `DELETE`: delete collection of ServiceCatalogAPIServer
- `GET`: list objects of kind ServiceCatalogAPIServer
- `POST`: create a ServiceCatalogAPIServer
* `/apis/operator.openshift.io/v1/servicecatalogapiservers/{name}`
- `DELETE`: delete a ServiceCatalogAPIServer
- `GET`: read the specified ServiceCatalogAPIServer
- `PATCH`: partially update the specified ServiceCatalogAPIServer
- `PUT`: replace the specified ServiceCatalogAPIServer
* `/apis/operator.openshift.io/v1/servicecatalogapiservers/{name}/status`
- `GET`: read status of the specified ServiceCatalogAPIServer
- `PATCH`: partially update status of the specified ServiceCatalogAPIServer
- `PUT`: replace status of the specified ServiceCatalogAPIServer
...
| HTTP code | Reponse body
| 200 - OK
| xref:../objects/index.adoc#servicecatalogapiserverlist-operator-openshift-io-v1[`ServiceCatalogAPIServerList operator.openshift.io/v1`]
| 401 - Unauthorized
| Empty
|===
...
| Parameter | Type | Description
| `body`
| xref:../operator_apis/servicecatalogapiserver-operator-openshift-io-v1.adoc#servicecatalogapiserver-operator-openshift-io-v1[`ServiceCatalogAPIServer operator.openshift.io/v1`]
| 
|===
...
| `name`
| `string`
| name of the ServiceCatalogAPIServer
|===
