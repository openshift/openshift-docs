...
| HTTP code | Reponse body
| 200 - OK
| xref:../objects/index.adoc#csisnapshotcontrollerlist-operator-openshift-io-v1[`CSISnapshotControllerList operator.openshift.io/v1`]
|===
...
| Parameter | Type | Description
| `body`
| xref:../operator_apis/csisnapshotcontroller-operator-openshift-io-v1.adoc#csisnapshotcontroller-operator-openshift-io-v1[`CSISnapshotController operator.openshift.io/v1`]
| 
|===
