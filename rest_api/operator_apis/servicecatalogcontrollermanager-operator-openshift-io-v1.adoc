...
* `/apis/operator.openshift.io/v1/servicecatalogcontrollermanagers`
- `DELETE`: delete collection of ServiceCatalogControllerManager
- `GET`: list objects of kind ServiceCatalogControllerManager
- `POST`: create a ServiceCatalogControllerManager
* `/apis/operator.openshift.io/v1/servicecatalogcontrollermanagers/{name}`
- `DELETE`: delete a ServiceCatalogControllerManager
- `GET`: read the specified ServiceCatalogControllerManager
- `PATCH`: partially update the specified ServiceCatalogControllerManager
- `PUT`: replace the specified ServiceCatalogControllerManager
* `/apis/operator.openshift.io/v1/servicecatalogcontrollermanagers/{name}/status`
- `GET`: read status of the specified ServiceCatalogControllerManager
- `PATCH`: partially update status of the specified ServiceCatalogControllerManager
- `PUT`: replace status of the specified ServiceCatalogControllerManager
...
| HTTP code | Reponse body
| 200 - OK
| xref:../objects/index.adoc#servicecatalogcontrollermanagerlist-operator-openshift-io-v1[`ServiceCatalogControllerManagerList operator.openshift.io/v1`]
| 401 - Unauthorized
| Empty
|===
...
| Parameter | Type | Description
| `body`
| xref:../operator_apis/servicecatalogcontrollermanager-operator-openshift-io-v1.adoc#servicecatalogcontrollermanager-operator-openshift-io-v1[`ServiceCatalogControllerManager operator.openshift.io/v1`]
| 
|===
...
| `name`
| `string`
| name of the ServiceCatalogControllerManager
|===
