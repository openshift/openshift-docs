...
| HTTP code | Reponse body
| 200 - OK
| xref:../objects/index.adoc#kubeschedulerlist-operator-openshift-io-v1[`KubeSchedulerList operator.openshift.io/v1`]
| 401 - Unauthorized
| Empty
|===
...
| Parameter | Type | Description
| `body`
| xref:../operator_apis/kubescheduler-operator-openshift-io-v1.adoc#kubescheduler-operator-openshift-io-v1[`KubeScheduler operator.openshift.io/v1`]
| 
|===
