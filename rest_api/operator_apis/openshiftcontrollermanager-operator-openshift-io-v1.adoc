...
| HTTP code | Reponse body
| 200 - OK
| xref:../objects/index.adoc#openshiftcontrollermanagerlist-operator-openshift-io-v1[`OpenShiftControllerManagerList operator.openshift.io/v1`]
|===
...
| Parameter | Type | Description
| `body`
| xref:../operator_apis/openshiftcontrollermanager-operator-openshift-io-v1.adoc#openshiftcontrollermanager-operator-openshift-io-v1[`OpenShiftControllerManager operator.openshift.io/v1`]
| 
|===
