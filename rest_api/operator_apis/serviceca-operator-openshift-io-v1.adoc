...
| HTTP code | Reponse body
| 200 - OK
| xref:../objects/index.adoc#io.openshift.operator.v1.ServiceCAList[`ServiceCAList`] schema
| 401 - Unauthorized
| Empty
|===
...
| Parameter | Type | Description
| `body`
| xref:../operator_apis/serviceca-operator-openshift-io-v1.adoc#serviceca-operator-openshift-io-v1[`ServiceCA`] schema
|
|===
