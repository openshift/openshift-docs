...
| HTTP code | Reponse body
| 200 - OK
| xref:../objects/index.adoc#storagelist-operator-openshift-io-v1[`StorageList operator.openshift.io/v1`]
|===
...
| Parameter | Type | Description
| `body`
| xref:../operator_apis/storage-operator-openshift-io-v1.adoc#storage-operator-openshift-io-v1[`Storage operator.openshift.io/v1`]
| 
|===
