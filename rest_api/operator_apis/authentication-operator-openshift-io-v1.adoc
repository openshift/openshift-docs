...
| HTTP code | Reponse body
| 200 - OK
| xref:../objects/index.adoc#authenticationlist-operator-openshift-io-v1[`AuthenticationList operator.openshift.io/v1`]
|===
...
| Parameter | Type | Description
| `body`
| xref:../operator_apis/authentication-operator-openshift-io-v1.adoc#authentication-operator-openshift-io-v1[`Authentication operator.openshift.io/v1`]
| 
|===
