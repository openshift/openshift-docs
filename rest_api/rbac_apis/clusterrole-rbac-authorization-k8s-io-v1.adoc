...
| HTTP code | Reponse body
| 200 - OK
| xref:../objects/index.adoc#clusterrolelist-rbac-authorization-k8s-io-v1[`ClusterRoleList rbac.authorization.k8s.io/v1`]
|===
...
| Parameter | Type | Description
| `body`
| xref:../rbac_apis/clusterrole-rbac-authorization-k8s-io-v1.adoc#clusterrole-rbac-authorization-k8s-io-v1[`ClusterRole rbac.authorization.k8s.io/v1`]
| 
|===
