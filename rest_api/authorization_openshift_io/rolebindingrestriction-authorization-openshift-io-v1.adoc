...
| 200 - OK
| xref:../objects/index.adoc#rolebindingrestrictionlist-authorization-openshift-io-v1[`RoleBindingRestrictionList authorization.openshift.io/v1`]
| 401 - Unauthorized
| Empty
|===
...
| Parameter | Type | Description
| `body`
| xref:../authorization_openshift_io/rolebindingrestriction-authorization-openshift-io-v1.adoc#rolebindingrestriction-authorization-openshift-io-v1[`RoleBindingRestriction authorization.openshift.io/v1`]
| 
|===
