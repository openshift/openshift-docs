...
| Parameter | Type | Description
| `body`
| xref:../authorization_openshift_io/clusterrole-authorization-openshift-io-v1.adoc#clusterrole-authorization-openshift-io-v1[`ClusterRole authorization.openshift.io/v1`]
| 
|===
