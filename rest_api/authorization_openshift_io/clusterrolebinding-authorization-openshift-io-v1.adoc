...
| Parameter | Type | Description
| `body`
| xref:../authorization_openshift_io/clusterrolebinding-authorization-openshift-io-v1.adoc#clusterrolebinding-authorization-openshift-io-v1[`ClusterRoleBinding authorization.openshift.io/v1`]
| 
|===
