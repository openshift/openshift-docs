...
| Parameter | Type | Description
| `body`
| xref:../security_apis/certificatesigningrequest-certificates-k8s-io-v1beta1.adoc#certificatesigningrequest-certificates-k8s-io-v1beta1[`CertificateSigningRequest certificates.k8s.io/v1beta1`]
| 
|===
