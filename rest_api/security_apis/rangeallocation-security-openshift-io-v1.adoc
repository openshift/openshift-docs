...
| HTTP code | Reponse body
| 200 - OK
| xref:../objects/index.adoc#rangeallocationlist-security-openshift-io-v1[`RangeAllocationList security.openshift.io/v1`]
| 401 - Unauthorized
| Empty
|===
...
| Parameter | Type | Description
| `body`
| xref:../security_apis/rangeallocation-security-openshift-io-v1.adoc#rangeallocation-security-openshift-io-v1[`RangeAllocation security.openshift.io/v1`]
| 
|===
