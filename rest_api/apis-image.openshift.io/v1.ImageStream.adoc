...
|===
|HTTP Code|Schema
<<<<<<< HEAD:rest_api/apis-image.openshift.io/v1.ImageStream.adoc
|200 OK|v1.ImageStream
=======
|200 OK|v1.RoleBinding
|201 Created|v1.RoleBinding
|202 Accepted|v1.RoleBinding
>>>>>>> ce18cef... update rest api docs to latest master:rest_api/apis-rbac.authorization.k8s.io/v1.RoleBinding.adoc
|401 Unauthorized|
|===
