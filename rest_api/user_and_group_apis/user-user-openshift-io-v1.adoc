...
| HTTP code | Reponse body
| 200 - OK
| xref:../objects/index.adoc#userlist-user-openshift-io-v1[`UserList user.openshift.io/v1`]
| 401 - Unauthorized
| Empty
|===
...
| Parameter | Type | Description
| `body`
| xref:../user_and_group_apis/user-user-openshift-io-v1.adoc#user-user-openshift-io-v1[`User user.openshift.io/v1`]
| 
|===
