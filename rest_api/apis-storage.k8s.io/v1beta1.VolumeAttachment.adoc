...
</div><details><summary><span title="(v1.ObjectMeta) Standard object metadata. More info: https://git.k8s.io/community/contributors/devel/api-conventions.md#metadata">metadata</span>:
...
</div></details><details><summary><span title="(v1beta1.VolumeAttachmentSpec) Specification of the desired attach/detach volume behavior. Populated by the Kubernetes system.">spec</span>:
</summary><div style="margin-left:13px;">  <span title="(string) Attacher indicates the name of the volume driver that MUST handle this request. This is the name returned by GetPluginName().">attacher</span>:
</div><div style="margin-left:13px;">  <span title="(string) The node that the volume should be attached to.">nodeName</span>:
</div><details><summary>  <span title="(v1beta1.VolumeAttachmentSource) Source represents the volume that should be attached.">source</span>:
</summary><div style="margin-left:13px;">    <span title="(string) Name of the persistent volume to attach.">persistentVolumeName</span>:
</div></details></details><details><summary><span title="(v1beta1.VolumeAttachmentStatus) Status of the VolumeAttachment request. Populated by the entity completing the attach or detach operation, i.e. the external-attacher.">status</span>:
</summary><details><summary>  <span title="(v1beta1.VolumeError) The last error encountered during attach operation, if any. This field must only be set by the entity completing the attach operation, i.e. the external-attacher.">attachError</span>:
</summary><div style="margin-left:13px;">    <span title="(string) String detailing the error encountered during Attach or Detach operation. This string maybe logged, so it should not contain sensitive information.">message</span>:
</div><div style="margin-left:13px;">    <span title="(v1.Time) Time the error was encountered.">time</span>:
</div></details><div style="margin-left:13px;">  <span title="(boolean) Indicates the volume is successfully attached. This field must only be set by the entity completing the attach operation, i.e. the external-attacher.">attached</span>:
</div><details><summary>  <span title="(object) Upon successful attach, this field is populated with any information returned by the attach operation that must be passed into subsequent WaitForAttach or Mount calls. This field must only be set by the entity completing the attach operation, i.e. the external-attacher.">attachmentMetadata</span>:
</summary><div style="margin-left:13px;">    <span title="(string)">[string]</span>:
</div></details><details><summary>  <span title="(v1beta1.VolumeError) The last error encountered during detach operation, if any. This field must only be set by the entity completing the detach operation, i.e. the external-attacher.">detachError</span>:
</summary><div style="margin-left:13px;">    <span title="(string) String detailing the error encountered during Attach or Detach operation. This string maybe logged, so it should not contain sensitive information.">message</span>:
</div><div style="margin-left:13px;">    <span title="(v1.Time) Time the error was encountered.">time</span>:
</div></details></details>
</pre>
...
==== HTTP request
----
POST /apis/storage.k8s.io/v1beta1/volumeattachments HTTP/1.1
...
$ curl -k \
    ...
    https://$ENDPOINT/apis/storage.k8s.io/v1beta1/volumeattachments <<'EOF'
{
  "kind": "VolumeAttachment",
  "apiVersion": "storage.k8s.io/v1beta1",
  ...
...
|===
|HTTP Code|Schema
|200 OK|v1beta1.VolumeAttachment
|201 Created|v1beta1.VolumeAttachment
|202 Accepted|v1beta1.VolumeAttachment
|401 Unauthorized|
|===
...
=== Get a VolumeAttachment
Read the specified VolumeAttachment

==== HTTP request
----
GET /apis/storage.k8s.io/v1beta1/volumeattachments/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/apis/storage.k8s.io/v1beta1/volumeattachments/$NAME
----
...
==== HTTP request
----
GET /apis/storage.k8s.io/v1beta1/volumeattachments HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/apis/storage.k8s.io/v1beta1/volumeattachments
----
...
|===
|HTTP Code|Schema
|200 OK|v1beta1.VolumeAttachmentList
|401 Unauthorized|
|===
...
=== Watch a VolumeAttachment
Watch changes to an object of kind VolumeAttachment

==== HTTP request
----
GET /apis/storage.k8s.io/v1beta1/watch/volumeattachments/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/apis/storage.k8s.io/v1beta1/watch/volumeattachments/$NAME
----
...
=== Watch all VolumeAttachments
Watch individual changes to a list of VolumeAttachment

==== HTTP request
----
GET /apis/storage.k8s.io/v1beta1/watch/volumeattachments HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/apis/storage.k8s.io/v1beta1/watch/volumeattachments
----
...
==== HTTP request
----
PUT /apis/storage.k8s.io/v1beta1/volumeattachments/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
Content-Type: application/json'
...
$ curl -k \
    ...
    -H 'Accept: application/json' \
    -H 'Content-Type: application/json' \
    https://$ENDPOINT/apis/storage.k8s.io/v1beta1/volumeattachments/$NAME <<'EOF'
{
  "kind": "VolumeAttachment",
  "apiVersion": "storage.k8s.io/v1beta1",
  ...
...
=== Patch a VolumeAttachment
Partially update the specified VolumeAttachment

==== HTTP request
----
PATCH /apis/storage.k8s.io/v1beta1/volumeattachments/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
...
==== HTTP request
----
DELETE /apis/storage.k8s.io/v1beta1/volumeattachments/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
Content-Type: application/json'
...
=== Delete all VolumeAttachments
Delete collection of VolumeAttachment

==== HTTP request
----
DELETE /apis/storage.k8s.io/v1beta1/volumeattachments HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
