...
| 200 - OK
| xref:../objects/index.adoc#serviceaccountlist-core-v1[`ServiceAccountList core/v1`]
| 401 - Unauthorized
| Empty
|===
...
| Parameter | Type | Description
| `body`
| xref:../core/serviceaccount-core-v1.adoc#serviceaccount-core-v1[`ServiceAccount core/v1`]
| 
|===
