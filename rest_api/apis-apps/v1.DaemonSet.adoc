...
</div></details><details open><summary><span title="(v1.DaemonSetSpec) The desired behavior of this daemon set. More info: https://git.k8s.io/community/contributors/devel/api-conventions.md#spec-and-status">spec</span>:
...
</div></details></details></details></details><details><summary>  <span title="(v1.DaemonSetUpdateStrategy) An update strategy to replace existing DaemonSet pods with new pods.">updateStrategy</span>:
</summary><details><summary>    <span title="(v1.RollingUpdateDaemonSet) Rolling update config params. Present only if type = &#34;RollingUpdate&#34;.">rollingUpdate</span>:
...
</div></details></details><details><summary><span title="(v1.DaemonSetStatus) The current status of this daemon set. This data may be out of date by some window of time. Populated by the system. Read-only. More info: https://git.k8s.io/community/contributors/devel/api-conventions.md#spec-and-status">status</span>:
...
[[Post-apis-apps-v1-daemonsets]]
=== Create a DaemonSet
Create a DaemonSet

==== HTTP request
----
POST /apis/apps/v1/daemonsets HTTP/1.1
...
$ curl -k \
    ...
    https://$ENDPOINT/apis/apps/v1/daemonsets <<'EOF'
{
  "kind": "DaemonSet",
  "apiVersion": "apps/v1",
  ...
...
|HTTP Code|Schema
|200 OK|v1.DaemonSet
|201 Created|v1.DaemonSet
|202 Accepted|v1.DaemonSet
|401 Unauthorized|
|===
...
==== HTTP request
----
POST /apis/apps/v1/namespaces/$NAMESPACE/daemonsets HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
Content-Type: application/json'
...
$ curl -k \
    ...
    -H 'Accept: application/json' \
    -H 'Content-Type: application/json' \
    https://$ENDPOINT/apis/apps/v1/namespaces/$NAMESPACE/daemonsets <<'EOF'
{
  "kind": "DaemonSet",
  "apiVersion": "apps/v1",
  ...
...
==== HTTP request
----
GET /apis/apps/v1/namespaces/$NAMESPACE/daemonsets/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/apis/apps/v1/namespaces/$NAMESPACE/daemonsets/$NAME
----
...
==== HTTP request
----
GET /apis/apps/v1/daemonsets HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/apis/apps/v1/daemonsets
----
...
==== HTTP request
----
GET /apis/apps/v1/namespaces/$NAMESPACE/daemonsets HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/apis/apps/v1/namespaces/$NAMESPACE/daemonsets
----
...
==== HTTP request
----
GET /apis/apps/v1/watch/namespaces/$NAMESPACE/daemonsets/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/apis/apps/v1/watch/namespaces/$NAMESPACE/daemonsets/$NAME
----
...
==== HTTP request
----
GET /apis/apps/v1/watch/daemonsets HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/apis/apps/v1/watch/daemonsets
----
...
==== HTTP request
----
GET /apis/apps/v1/watch/namespaces/$NAMESPACE/daemonsets HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/apis/apps/v1/watch/namespaces/$NAMESPACE/daemonsets
----
...
==== HTTP request
----
PUT /apis/apps/v1/namespaces/$NAMESPACE/daemonsets/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
Content-Type: application/json'
...
$ curl -k \
    ...
    -H 'Accept: application/json' \
    -H 'Content-Type: application/json' \
    https://$ENDPOINT/apis/apps/v1/namespaces/$NAMESPACE/daemonsets/$NAME <<'EOF'
{
  "kind": "DaemonSet",
  "apiVersion": "apps/v1",
  ...
...
==== HTTP request
----
PATCH /apis/apps/v1/namespaces/$NAMESPACE/daemonsets/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
...
==== HTTP request
----
DELETE /apis/apps/v1/namespaces/$NAMESPACE/daemonsets/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
Content-Type: application/json'
...
==== HTTP request
----
DELETE /apis/apps/v1/namespaces/$NAMESPACE/daemonsets HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
==== HTTP request
----
GET /apis/apps/v1/namespaces/$NAMESPACE/daemonsets/$NAME/status HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/apis/apps/v1/namespaces/$NAMESPACE/daemonsets/$NAME/status
----
...
==== HTTP request
----
PUT /apis/apps/v1/namespaces/$NAMESPACE/daemonsets/$NAME/status HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
Content-Type: application/json'
...
$ curl -k \
    ...
    -H 'Accept: application/json' \
    -H 'Content-Type: application/json' \
    https://$ENDPOINT/apis/apps/v1/namespaces/$NAMESPACE/daemonsets/$NAME/status <<'EOF'
{
  "kind": "DaemonSet",
  "apiVersion": "apps/v1",
  ...
...
==== HTTP request
----
PATCH /apis/apps/v1/namespaces/$NAMESPACE/daemonsets/$NAME/status HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
Content-Type: application/json-patch+json'
