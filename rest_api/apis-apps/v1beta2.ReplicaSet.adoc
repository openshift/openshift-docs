...
</div></details><details open><summary><span title="(v1beta2.ReplicaSetSpec) Spec defines the specification of the desired behavior of the ReplicaSet. More info: https://git.k8s.io/community/contributors/devel/api-conventions.md#spec-and-status">spec</span>:
...
[[Post-apis-apps-v1beta2-replicasets]]
=== Create a ReplicaSet
Create a ReplicaSet

==== HTTP request
----
POST /apis/apps/v1beta2/replicasets HTTP/1.1
...
$ curl -k \
    ...
    https://$ENDPOINT/apis/apps/v1beta2/replicasets <<'EOF'
{
  "kind": "ReplicaSet",
  "apiVersion": "apps/v1beta2",
  ...
