...
</div><details><summary><span title="(v1.ObjectMeta) If the Labels of a ReplicaSet are empty, they are defaulted to be the same as the Pod(s) that the ReplicaSet manages. Standard object&#39;s metadata. More info: https://git.k8s.io/community/contributors/devel/api-conventions.md#metadata">metadata</span>:
...
</div></details><details><summary><span title="(v1beta2.ReplicaSetSpec) Spec defines the specification of the desired behavior of the ReplicaSet. More info: https://git.k8s.io/community/contributors/devel/api-conventions.md#spec-and-status">spec</span>:
...
</div></details></details></details></details></details><details><summary><span title="(v1beta2.ReplicaSetStatus) Status is the most recently observed status of the ReplicaSet. This data may be out of date by some window of time. Populated by the system. Read-only. More info: https://git.k8s.io/community/contributors/devel/api-conventions.md#spec-and-status">status</span>:
...
==== HTTP request
----
POST /apis/apps/v1beta2/namespaces/$NAMESPACE/replicasets HTTP/1.1
...
$ curl -k \
    ...
    https://$ENDPOINT/apis/apps/v1beta2/namespaces/$NAMESPACE/replicasets <<'EOF'
{
  "kind": "ReplicaSet",
  "apiVersion": "apps/v1beta2",
  ...
...
|===
|HTTP Code|Schema
|200 OK|v1beta2.ReplicaSet
|201 Created|v1beta2.ReplicaSet
|202 Accepted|v1beta2.ReplicaSet
|401 Unauthorized|
|===
...
==== HTTP request
----
GET /apis/apps/v1beta2/namespaces/$NAMESPACE/replicasets/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/apis/apps/v1beta2/namespaces/$NAMESPACE/replicasets/$NAME
----
...
==== HTTP request
----
GET /apis/apps/v1beta2/replicasets HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/apis/apps/v1beta2/replicasets
----
...
==== HTTP request
----
GET /apis/apps/v1beta2/namespaces/$NAMESPACE/replicasets HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/apis/apps/v1beta2/namespaces/$NAMESPACE/replicasets
----
...
==== HTTP request
----
GET /apis/apps/v1beta2/watch/namespaces/$NAMESPACE/replicasets/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/apis/apps/v1beta2/watch/namespaces/$NAMESPACE/replicasets/$NAME
----
...
==== HTTP request
----
GET /apis/apps/v1beta2/watch/replicasets HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/apis/apps/v1beta2/watch/replicasets
----
...
==== HTTP request
----
GET /apis/apps/v1beta2/watch/namespaces/$NAMESPACE/replicasets HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/apis/apps/v1beta2/watch/namespaces/$NAMESPACE/replicasets
----
...
==== HTTP request
----
PUT /apis/apps/v1beta2/namespaces/$NAMESPACE/replicasets/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
Content-Type: application/json'
...
$ curl -k \
    ...
    -H 'Accept: application/json' \
    -H 'Content-Type: application/json' \
    https://$ENDPOINT/apis/apps/v1beta2/namespaces/$NAMESPACE/replicasets/$NAME <<'EOF'
{
  "kind": "ReplicaSet",
  "apiVersion": "apps/v1beta2",
  ...
...
==== HTTP request
----
PATCH /apis/apps/v1beta2/namespaces/$NAMESPACE/replicasets/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
...
==== HTTP request
----
DELETE /apis/apps/v1beta2/namespaces/$NAMESPACE/replicasets/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
Content-Type: application/json'
...
==== HTTP request
----
DELETE /apis/apps/v1beta2/namespaces/$NAMESPACE/replicasets HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
==== HTTP request
----
GET /apis/apps/v1beta2/namespaces/$NAMESPACE/replicasets/$NAME/scale HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/apis/apps/v1beta2/namespaces/$NAMESPACE/replicasets/$NAME/scale
----
...
==== HTTP request
----
PUT /apis/apps/v1beta2/namespaces/$NAMESPACE/replicasets/$NAME/scale HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
Content-Type: application/json'
...
$ curl -k \
    ...
    -H 'Accept: application/json' \
    -H 'Content-Type: application/json' \
    https://$ENDPOINT/apis/apps/v1beta2/namespaces/$NAMESPACE/replicasets/$NAME/scale <<'EOF'
{
  "kind": "Scale",
  "apiVersion": "apps/v1beta2",
  ...
...
==== HTTP request
----
PATCH /apis/apps/v1beta2/namespaces/$NAMESPACE/replicasets/$NAME/scale HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
Content-Type: application/json-patch+json'
...
==== HTTP request
----
GET /apis/apps/v1beta2/namespaces/$NAMESPACE/replicasets/$NAME/status HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/apis/apps/v1beta2/namespaces/$NAMESPACE/replicasets/$NAME/status
----
...
==== HTTP request
----
PUT /apis/apps/v1beta2/namespaces/$NAMESPACE/replicasets/$NAME/status HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
Content-Type: application/json'
...
$ curl -k \
    ...
    -H 'Accept: application/json' \
    -H 'Content-Type: application/json' \
    https://$ENDPOINT/apis/apps/v1beta2/namespaces/$NAMESPACE/replicasets/$NAME/status <<'EOF'
{
  "kind": "ReplicaSet",
  "apiVersion": "apps/v1beta2",
  ...
...
==== HTTP request
----
PATCH /apis/apps/v1beta2/namespaces/$NAMESPACE/replicasets/$NAME/status HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
Content-Type: application/json-patch+json'
