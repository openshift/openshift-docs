...
</div></details><details open><summary><span title="(v1.DeploymentSpec) Specification of the desired behavior of the Deployment.">spec</span>:
...
==== HTTP request
----
POST /apis/apps/v1/deployments HTTP/1.1
...
$ curl -k \
    ...
    https://$ENDPOINT/apis/apps/v1/deployments <<'EOF'
{
  "kind": "Deployment",
  "apiVersion": "apps/v1",
  ...
