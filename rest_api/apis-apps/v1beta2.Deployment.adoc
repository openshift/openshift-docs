...
</div></details><details open><summary><span title="(v1beta2.DeploymentSpec) Specification of the desired behavior of the Deployment.">spec</span>:
...
[[Post-apis-apps-v1beta2-deployments]]
=== Create a Deployment
Create a Deployment

==== HTTP request
----
POST /apis/apps/v1beta2/deployments HTTP/1.1
...
$ curl -k \
    ...
    https://$ENDPOINT/apis/apps/v1beta2/deployments <<'EOF'
{
  "kind": "Deployment",
  "apiVersion": "apps/v1beta2",
  ...
