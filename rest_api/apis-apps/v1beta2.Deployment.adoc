...
</div><details><summary><span title="(v1.ObjectMeta) Standard object metadata.">metadata</span>:
...
</div></details><details><summary><span title="(v1beta2.DeploymentSpec) Specification of the desired behavior of the Deployment.">spec</span>:
...
</div><div style="margin-left:13px;">  <span title="(integer) The number of old ReplicaSets to retain to allow rollback. This is a pointer to distinguish between explicit zero and not specified. Defaults to 10.">revisionHistoryLimit</span>:
</div><details><summary>  <span title="(v1.LabelSelector) Label selector for pods. Existing ReplicaSets whose pods are selected by this will be the ones affected by this deployment. It must match the pod template&#39;s labels.">selector</span>:
...
</div></details></details><details><summary>  <span title="(v1beta2.DeploymentStrategy) The deployment strategy to use to replace existing pods with new ones.">strategy</span>:
</summary><details><summary>    <span title="(v1beta2.RollingUpdateDeployment) Rolling update config params. Present only if DeploymentStrategyType = RollingUpdate.">rollingUpdate</span>:
</summary><div style="margin-left:13px;">      <span title="(intstr.IntOrString) The maximum number of pods that can be scheduled above the desired number of pods. Value can be an absolute number (ex: 5) or a percentage of desired pods (ex: 10%). This can not be 0 if MaxUnavailable is 0. Absolute number is calculated from percentage by rounding up. Defaults to 25%. Example: when this is set to 30%, the new ReplicaSet can be scaled up immediately when the rolling update starts, such that the total number of old and new pods do not exceed 130% of desired pods. Once old pods have been killed, new ReplicaSet can be scaled up further, ensuring that total number of pods running at any time during the update is atmost 130% of desired pods.">maxSurge</span>:
</div><div style="margin-left:13px;">      <span title="(intstr.IntOrString) The maximum number of pods that can be unavailable during the update. Value can be an absolute number (ex: 5) or a percentage of desired pods (ex: 10%). Absolute number is calculated from percentage by rounding down. This can not be 0 if MaxSurge is 0. Defaults to 25%. Example: when this is set to 30%, the old ReplicaSet can be scaled down to 70% of desired pods immediately when the rolling update starts. Once new pods are ready, old ReplicaSet can be scaled down further, followed by scaling up the new ReplicaSet, ensuring that the total number of pods available at all times during the update is at least 70% of desired pods.">maxUnavailable</span>:
...
</div></details></details></details></details></details><details><summary><span title="(v1beta2.DeploymentStatus) Most recently observed status of the Deployment.">status</span>:
...
==== HTTP request
----
POST /apis/apps/v1beta2/namespaces/$NAMESPACE/deployments HTTP/1.1
...
$ curl -k \
    ...
    https://$ENDPOINT/apis/apps/v1beta2/namespaces/$NAMESPACE/deployments <<'EOF'
{
  "kind": "Deployment",
  "apiVersion": "apps/v1beta2",
  ...
...
|===
|HTTP Code|Schema
|200 OK|v1beta2.Deployment
|201 Created|v1beta2.Deployment
|202 Accepted|v1beta2.Deployment
|401 Unauthorized|
|===
...
==== HTTP request
----
GET /apis/apps/v1beta2/namespaces/$NAMESPACE/deployments/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/apis/apps/v1beta2/namespaces/$NAMESPACE/deployments/$NAME
----
...
==== HTTP request
----
GET /apis/apps/v1beta2/deployments HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/apis/apps/v1beta2/deployments
----
...
==== HTTP request
----
GET /apis/apps/v1beta2/namespaces/$NAMESPACE/deployments HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/apis/apps/v1beta2/namespaces/$NAMESPACE/deployments
----
...
==== HTTP request
----
GET /apis/apps/v1beta2/watch/namespaces/$NAMESPACE/deployments/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/apis/apps/v1beta2/watch/namespaces/$NAMESPACE/deployments/$NAME
----
...
==== HTTP request
----
GET /apis/apps/v1beta2/watch/deployments HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/apis/apps/v1beta2/watch/deployments
----
...
==== HTTP request
----
GET /apis/apps/v1beta2/watch/namespaces/$NAMESPACE/deployments HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/apis/apps/v1beta2/watch/namespaces/$NAMESPACE/deployments
----
...
==== HTTP request
----
PUT /apis/apps/v1beta2/namespaces/$NAMESPACE/deployments/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
Content-Type: application/json'
...
$ curl -k \
    ...
    -H 'Accept: application/json' \
    -H 'Content-Type: application/json' \
    https://$ENDPOINT/apis/apps/v1beta2/namespaces/$NAMESPACE/deployments/$NAME <<'EOF'
{
  "kind": "Deployment",
  "apiVersion": "apps/v1beta2",
  ...
...
==== HTTP request
----
PATCH /apis/apps/v1beta2/namespaces/$NAMESPACE/deployments/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
...
==== HTTP request
----
DELETE /apis/apps/v1beta2/namespaces/$NAMESPACE/deployments/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
Content-Type: application/json'
...
==== HTTP request
----
DELETE /apis/apps/v1beta2/namespaces/$NAMESPACE/deployments HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
==== HTTP request
----
GET /apis/apps/v1beta2/namespaces/$NAMESPACE/deployments/$NAME/scale HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/apis/apps/v1beta2/namespaces/$NAMESPACE/deployments/$NAME/scale
----
...
==== HTTP request
----
PUT /apis/apps/v1beta2/namespaces/$NAMESPACE/deployments/$NAME/scale HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
Content-Type: application/json'
...
$ curl -k \
    ...
    -H 'Accept: application/json' \
    -H 'Content-Type: application/json' \
    https://$ENDPOINT/apis/apps/v1beta2/namespaces/$NAMESPACE/deployments/$NAME/scale <<'EOF'
{
  "kind": "Scale",
  "apiVersion": "apps/v1beta2",
  ...
...
==== HTTP request
----
PATCH /apis/apps/v1beta2/namespaces/$NAMESPACE/deployments/$NAME/scale HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
Content-Type: application/json-patch+json'
...
==== HTTP request
----
GET /apis/apps/v1beta2/namespaces/$NAMESPACE/deployments/$NAME/status HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/apis/apps/v1beta2/namespaces/$NAMESPACE/deployments/$NAME/status
----
...
==== HTTP request
----
PUT /apis/apps/v1beta2/namespaces/$NAMESPACE/deployments/$NAME/status HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
Content-Type: application/json'
...
$ curl -k \
    ...
    -H 'Accept: application/json' \
    -H 'Content-Type: application/json' \
    https://$ENDPOINT/apis/apps/v1beta2/namespaces/$NAMESPACE/deployments/$NAME/status <<'EOF'
{
  "kind": "Deployment",
  "apiVersion": "apps/v1beta2",
  ...
...
==== HTTP request
----
PATCH /apis/apps/v1beta2/namespaces/$NAMESPACE/deployments/$NAME/status HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
Content-Type: application/json-patch+json'
