...
| 200 - OK
| xref:../objects/index.adoc#clusterrolelist-authorization-openshift-io-v1[`ClusterRoleList authorization.openshift.io/v1`]
|===
...
| Parameter | Type | Description
| `body`
| xref:../role_apis/clusterrole-authorization-openshift-io-v1.adoc#clusterrole-authorization-openshift-io-v1[`ClusterRole authorization.openshift.io/v1`]
| 
|===
