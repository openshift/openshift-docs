...
| 200 - OK
| xref:../objects/index.adoc#rolelist-authorization-openshift-io-v1[`RoleList authorization.openshift.io/v1`]
|===
...
| Parameter | Type | Description
| `body`
| xref:../role_apis/role-authorization-openshift-io-v1.adoc#role-authorization-openshift-io-v1[`Role authorization.openshift.io/v1`]
| 
|===
