...
| 200 - OK
| xref:../objects/index.adoc#alertmanagerlist-monitoring-coreos-com-v1[`AlertmanagerList monitoring.coreos.com/v1`]
|===
...
| Parameter | Type | Description
| `body`
| xref:../monitoring_apis/alertmanager-monitoring-coreos-com-v1.adoc#alertmanager-monitoring-coreos-com-v1[`Alertmanager monitoring.coreos.com/v1`]
| 
|===
