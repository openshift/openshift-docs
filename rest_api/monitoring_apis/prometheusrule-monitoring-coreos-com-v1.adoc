...
| 200 - OK
| xref:../objects/index.adoc#prometheusrulelist-monitoring-coreos-com-v1[`PrometheusRuleList monitoring.coreos.com/v1`]
| 401 - Unauthorized
| Empty
|===
...
| Parameter | Type | Description
| `body`
| xref:../monitoring_apis/prometheusrule-monitoring-coreos-com-v1.adoc#prometheusrule-monitoring-coreos-com-v1[`PrometheusRule monitoring.coreos.com/v1`]
| 
|===
