...
| Parameter | Type | Description
| `body`
| xref:../template_openshift_io/templateinstance-template-openshift-io-v1.adoc#templateinstance-template-openshift-io-v1[`TemplateInstance template.openshift.io/v1`]
| 
|===
