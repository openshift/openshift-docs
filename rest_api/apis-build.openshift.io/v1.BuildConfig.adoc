...
</div><details><summary><span title="(v1.ObjectMeta) metadata for BuildConfig.">metadata</span>:
...
</div></details><details><summary><span title="(v1.BuildConfigSpec) spec holds all the input necessary to produce a new build, and the conditions when to trigger them.">spec</span>:
