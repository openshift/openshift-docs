...
</div></details><details><summary><span title="(v1beta1.DaemonSetSpec) The desired behavior of this daemon set. More info: https://git.k8s.io/community/contributors/devel/api-conventions.md#spec-and-status">spec</span>:
