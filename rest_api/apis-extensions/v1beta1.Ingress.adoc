...
</div></details><details><summary><span title="(v1beta1.IngressSpec) Spec is the desired state of the Ingress. More info: https://git.k8s.io/community/contributors/devel/api-conventions.md#spec-and-status">spec</span>:
