...
</div><div style="margin-left:13px;"><span title="(string) Description is the description of this object.">description</span>:
...
</div></details><details><summary><span title="(array) Versions are versions for this third party object">versions</span>:
</summary><div style="margin-left:13px;">- <span title="(string) Name of this version (e.g. &#39;v1&#39;).">name</span>:
</div></details>
</pre>
++++
...
==== HTTP request
----
POST /apis/extensions/v1beta1/thirdpartyresources HTTP/1.1
...
$ curl -k \
    ...
    https://$ENDPOINT/apis/extensions/v1beta1/thirdpartyresources <<'EOF'
{
  "kind": "ThirdPartyResource",
  "apiVersion": "extensions/v1beta1",
  ...
...
|===
|Parameter|Schema
|body|v1beta1.ThirdPartyResource
|===
...
|===
|HTTP Code|Schema
|200 OK|v1beta1.ThirdPartyResource
|401 Unauthorized|
|===
...
=== Get a ThirdPartyResource
Read the specified ThirdPartyResource

==== HTTP request
----
GET /apis/extensions/v1beta1/thirdpartyresources/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/apis/extensions/v1beta1/thirdpartyresources/$NAME
----
...
=== Get all ThirdPartyResources
List or watch objects of kind ThirdPartyResource

==== HTTP request
----
GET /apis/extensions/v1beta1/thirdpartyresources HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/apis/extensions/v1beta1/thirdpartyresources
----
...
|===
|HTTP Code|Schema
|200 OK|v1beta1.ThirdPartyResourceList
|401 Unauthorized|
|===
...
=== Watch a ThirdPartyResource
Watch changes to an object of kind ThirdPartyResource

==== HTTP request
----
GET /apis/extensions/v1beta1/watch/thirdpartyresources/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/apis/extensions/v1beta1/watch/thirdpartyresources/$NAME
----
...
=== Watch all ThirdPartyResources
Watch individual changes to a list of ThirdPartyResource

==== HTTP request
----
GET /apis/extensions/v1beta1/watch/thirdpartyresources HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/apis/extensions/v1beta1/watch/thirdpartyresources
----
...
=== Update a ThirdPartyResource
Replace the specified ThirdPartyResource

==== HTTP request
----
PUT /apis/extensions/v1beta1/thirdpartyresources/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
Content-Type: application/json'
...
$ curl -k \
    ...
    -H 'Accept: application/json' \
    -H 'Content-Type: application/json' \
    https://$ENDPOINT/apis/extensions/v1beta1/thirdpartyresources/$NAME <<'EOF'
{
  "kind": "ThirdPartyResource",
  "apiVersion": "extensions/v1beta1",
  ...
...
=== Patch a ThirdPartyResource
Partially update the specified ThirdPartyResource

==== HTTP request
----
PATCH /apis/extensions/v1beta1/thirdpartyresources/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
...
==== HTTP request
----
DELETE /apis/extensions/v1beta1/thirdpartyresources/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
Content-Type: application/json'
...
=== Delete all ThirdPartyResources
Delete collection of ThirdPartyResource

==== HTTP request
----
DELETE /apis/extensions/v1beta1/thirdpartyresources HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
