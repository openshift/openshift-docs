...
</div><details><summary><span title="(v1.ObjectMeta)">metadata</span>:
...
</div></details><details><summary><span title="(v1beta1.CertificateSigningRequestSpec) The certificate request itself and any additional information.">spec</span>:
...
=== Get status of a CertificateSigningRequest
Read status of the specified CertificateSigningRequest

==== HTTP request
----
GET /apis/certificates.k8s.io/v1beta1/certificatesigningrequests/$NAME/status HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/apis/certificates.k8s.io/v1beta1/certificatesigningrequests/$NAME/status
----
...
=== Patch status of a CertificateSigningRequest
Partially update status of the specified CertificateSigningRequest

==== HTTP request
----
PATCH /apis/certificates.k8s.io/v1beta1/certificatesigningrequests/$NAME/status HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
Content-Type: application/json-patch+json'
