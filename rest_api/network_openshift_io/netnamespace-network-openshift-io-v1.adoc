...
- `DELETE`: delete collection of NetNamespace
- `GET`: list or watch objects of kind NetNamespace
- `POST`: create a NetNamespace
* `/apis/network.openshift.io/v1/netnamespaces/{name}`
- `DELETE`: delete a NetNamespace
- `GET`: read the specified NetNamespace
- `PATCH`: partially update the specified NetNamespace
- `PUT`: replace the specified NetNamespace
...
| HTTP code | Reponse body
| 200 - OK
| xref:../objects/index.adoc#netnamespacelist-network-openshift-io-v1[`NetNamespaceList network.openshift.io/v1`]
| 401 - Unauthorized
| Empty
|===
...
| Parameter | Type | Description
| `body`
| xref:../network_openshift_io/netnamespace-network-openshift-io-v1.adoc#netnamespace-network-openshift-io-v1[`NetNamespace network.openshift.io/v1`]
| 
|===
