...
- `GET`: list or watch objects of kind EgressNetworkPolicy
* `/apis/network.openshift.io/v1/namespaces/{namespace}/egressnetworkpolicies`
- `DELETE`: delete collection of EgressNetworkPolicy
- `GET`: list or watch objects of kind EgressNetworkPolicy
- `POST`: create an EgressNetworkPolicy
* `/apis/network.openshift.io/v1/namespaces/{namespace}/egressnetworkpolicies/{name}`
- `DELETE`: delete an EgressNetworkPolicy
- `GET`: read the specified EgressNetworkPolicy
- `PATCH`: partially update the specified EgressNetworkPolicy
- `PUT`: replace the specified EgressNetworkPolicy
...
| 200 - OK
| xref:../objects/index.adoc#egressnetworkpolicylist-network-openshift-io-v1[`EgressNetworkPolicyList network.openshift.io/v1`]
| 401 - Unauthorized
| Empty
|===
...
| Parameter | Type | Description
| `body`
| xref:../network_openshift_io/egressnetworkpolicy-network-openshift-io-v1.adoc#egressnetworkpolicy-network-openshift-io-v1[`EgressNetworkPolicy network.openshift.io/v1`]
| 
|===
