...
| 200 - OK
| xref:../objects/index.adoc#profilelist-tuned-openshift-io-v1[`ProfileList tuned.openshift.io/v1`]
| 401 - Unauthorized
| Empty
|===
...
| Parameter | Type | Description
| `body`
| xref:../node_apis/profile-tuned-openshift-io-v1.adoc#profile-tuned-openshift-io-v1[`Profile tuned.openshift.io/v1`]
| 
|===
