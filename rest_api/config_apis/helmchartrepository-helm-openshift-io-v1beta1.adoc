...
| HTTP code | Reponse body
| 200 - OK
| xref:../objects/index.adoc#helmchartrepositorylist-helm-openshift-io-v1beta1[`HelmChartRepositoryList helm.openshift.io/v1beta1`]
|===
...
| Parameter | Type | Description
| `body`
| xref:../config_apis/helmchartrepository-helm-openshift-io-v1beta1.adoc#helmchartrepository-helm-openshift-io-v1beta1[`HelmChartRepository helm.openshift.io/v1beta1`]
| 
|===
