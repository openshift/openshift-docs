...
| HTTP code | Reponse body
| 200 - OK
| xref:../objects/index.adoc#oauthlist-config-openshift-io-v1[`OAuthList config.openshift.io/v1`]
|===
...
| Parameter | Type | Description
| `body`
| xref:../config_apis/oauth-config-openshift-io-v1.adoc#oauth-config-openshift-io-v1[`OAuth config.openshift.io/v1`]
| 
|===
