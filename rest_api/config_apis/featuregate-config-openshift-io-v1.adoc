...
| HTTP code | Reponse body
| 200 - OK
| xref:../objects/index.adoc#featuregatelist-config-openshift-io-v1[`FeatureGateList config.openshift.io/v1`]
| 401 - Unauthorized
| Empty
|===
...
| Parameter | Type | Description
| `body`
| xref:../config_apis/featuregate-config-openshift-io-v1.adoc#featuregate-config-openshift-io-v1[`FeatureGate config.openshift.io/v1`]
| 
|===
