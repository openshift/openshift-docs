...
| `maxUnavailable`
| xref:../../rest_api/objects/index.adoc#intorstring-util-none[`IntOrString util/none`]
...
| `disruptedPods`
| xref:../../rest_api/objects/index.adoc#time-meta-v1[`object (Time meta/v1)`]
...
| 200 - OK
| xref:../../rest_api/objects/index.adoc#poddisruptionbudgetlist-policy-v1beta1[`PodDisruptionBudgetList policy/v1beta1`]
|===
