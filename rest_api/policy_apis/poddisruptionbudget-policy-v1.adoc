...
| 200 - OK
| xref:../objects/index.adoc#poddisruptionbudgetlist-policy-v1[`PodDisruptionBudgetList policy/v1`]
|===
...
| Parameter | Type | Description
| `body`
| xref:../policy_apis/poddisruptionbudget-policy-v1.adoc#poddisruptionbudget-policy-v1[`PodDisruptionBudget policy/v1`]
| 
|===
