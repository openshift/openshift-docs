...
| HTTP code | Reponse body
| 200 - OK
| xref:../objects/index.adoc#storageclasslist-storage-k8s-io-v1[`StorageClassList storage.k8s.io/v1`]
| 401 - Unauthorized
| Empty
|===
...
| Parameter | Type | Description
| `body`
| xref:../storage_k8s_io/storageclass-storage-k8s-io-v1.adoc#storageclass-storage-k8s-io-v1[`StorageClass storage.k8s.io/v1`]
| 
|===
