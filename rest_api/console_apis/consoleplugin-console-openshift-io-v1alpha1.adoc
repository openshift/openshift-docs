...
| HTTP code | Reponse body
| 200 - OK
| xref:../objects/index.adoc#consolepluginlist-console-openshift-io-v1alpha1[`ConsolePluginList console.openshift.io/v1alpha1`]
|===
...
| Parameter | Type | Description
| `body`
| xref:../console_apis/consoleplugin-console-openshift-io-v1alpha1.adoc#consoleplugin-console-openshift-io-v1alpha1[`ConsolePlugin console.openshift.io/v1alpha1`]
| 
|===
