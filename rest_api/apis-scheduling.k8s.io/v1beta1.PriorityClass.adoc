...
</div><div style="margin-left:13px;"><span title="(string) description is an arbitrary string that usually provides guidelines on when this priority class should be used.">description</span>:
</div><div style="margin-left:13px;"><span title="(boolean) globalDefault specifies whether this PriorityClass should be considered as the default priority for pods that do not have any priority class. Only one PriorityClass can be marked as `globalDefault`. However, if more than one PriorityClasses exists with their `globalDefault` field set to true, the smallest value of such global default PriorityClasses will be used as the default priority.">globalDefault</span>:
...
</div></details><div style="margin-left:13px;"><span title="(integer) The value of this priority class. This is the actual priority that pods receive when they have the name of this class in their pod spec.">value</span>:
</div>
</pre>
++++
...
==== HTTP request
----
POST /apis/scheduling.k8s.io/v1beta1/priorityclasses HTTP/1.1
...
$ curl -k \
    ...
    https://$ENDPOINT/apis/scheduling.k8s.io/v1beta1/priorityclasses <<'EOF'
{
  "kind": "PriorityClass",
  "apiVersion": "scheduling.k8s.io/v1beta1",
  ...
...
|===
|HTTP Code|Schema
|200 OK|v1beta1.PriorityClass
|201 Created|v1beta1.PriorityClass
|202 Accepted|v1beta1.PriorityClass
|401 Unauthorized|
|===
...
==== HTTP request
----
GET /apis/scheduling.k8s.io/v1beta1/priorityclasses/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/apis/scheduling.k8s.io/v1beta1/priorityclasses/$NAME
----
...
==== HTTP request
----
GET /apis/scheduling.k8s.io/v1beta1/priorityclasses HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/apis/scheduling.k8s.io/v1beta1/priorityclasses
----
...
|===
|HTTP Code|Schema
|200 OK|v1beta1.PriorityClassList
|401 Unauthorized|
|===
...
=== Watch a PriorityClass
Watch changes to an object of kind PriorityClass

==== HTTP request
----
GET /apis/scheduling.k8s.io/v1beta1/watch/priorityclasses/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/apis/scheduling.k8s.io/v1beta1/watch/priorityclasses/$NAME
----
...
=== Watch all PriorityClasses
Watch individual changes to a list of PriorityClass

==== HTTP request
----
GET /apis/scheduling.k8s.io/v1beta1/watch/priorityclasses HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
...
$ curl -k \
    -H "Authorization: Bearer $TOKEN" \
    -H 'Accept: application/json' \
    https://$ENDPOINT/apis/scheduling.k8s.io/v1beta1/watch/priorityclasses
----
...
=== Update a PriorityClass
Replace the specified PriorityClass

==== HTTP request
----
PUT /apis/scheduling.k8s.io/v1beta1/priorityclasses/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
Content-Type: application/json'
...
$ curl -k \
    ...
    -H 'Accept: application/json' \
    -H 'Content-Type: application/json' \
    https://$ENDPOINT/apis/scheduling.k8s.io/v1beta1/priorityclasses/$NAME <<'EOF'
{
  "kind": "PriorityClass",
  "apiVersion": "scheduling.k8s.io/v1beta1",
  ...
...
=== Patch a PriorityClass
Partially update the specified PriorityClass

==== HTTP request
----
PATCH /apis/scheduling.k8s.io/v1beta1/priorityclasses/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
...
==== HTTP request
----
DELETE /apis/scheduling.k8s.io/v1beta1/priorityclasses/$NAME HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
Content-Type: application/json'
...
=== Delete all PriorityClasses
Delete collection of PriorityClass

==== HTTP request
----
DELETE /apis/scheduling.k8s.io/v1beta1/priorityclasses HTTP/1.1
Authorization: Bearer $TOKEN
Accept: application/json
Connection: close
----
