...
| 200 - OK
| xref:../objects/index.adoc#controllerrevisionlist-apps-v1[`ControllerRevisionList apps/v1`]
| 401 - Unauthorized
| Empty
|===
...
| Parameter | Type | Description
| `body`
| xref:../apps/controllerrevision-apps-v1.adoc#controllerrevision-apps-v1[`ControllerRevision apps/v1`]
| 
|===
