...
| Parameter | Type | Description
| `body`
| xref:../security_openshift_io/podsecuritypolicyreview-security-openshift-io-v1.adoc#podsecuritypolicyreview-security-openshift-io-v1[`PodSecurityPolicyReview security.openshift.io/v1`]
| 
|===
