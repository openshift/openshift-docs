...
* `/apis/operators.coreos.com/v1/operatorsources`
- `GET`: list objects of kind OperatorSource
* `/apis/operators.coreos.com/v1/namespaces/{namespace}/operatorsources`
- `DELETE`: delete collection of OperatorSource
- `GET`: list objects of kind OperatorSource
- `POST`: create an OperatorSource
* `/apis/operators.coreos.com/v1/namespaces/{namespace}/operatorsources/{name}`
- `DELETE`: delete an OperatorSource
- `GET`: read the specified OperatorSource
- `PATCH`: partially update the specified OperatorSource
- `PUT`: replace the specified OperatorSource
...
| 200 - OK
| xref:../objects/index.adoc#operatorsourcelist-operators-coreos-com-v1[`OperatorSourceList operators.coreos.com/v1`]
| 401 - Unauthorized
| Empty
|===
...
| Parameter | Type | Description
| `body`
| xref:../operatorhub_apis/operatorsource-operators-coreos-com-v1.adoc#operatorsource-operators-coreos-com-v1[`OperatorSource operators.coreos.com/v1`]
| 
|===
