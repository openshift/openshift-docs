...
| 200 - OK
| xref:../objects/index.adoc#operatorconditionlist-operators-coreos-com-v2[`OperatorConditionList operators.coreos.com/v2`]
|===
...
| Parameter | Type | Description
| `body`
| xref:../operatorhub_apis/operatorcondition-operators-coreos-com-v2.adoc#operatorcondition-operators-coreos-com-v2[`OperatorCondition operators.coreos.com/v2`]
| 
|===
