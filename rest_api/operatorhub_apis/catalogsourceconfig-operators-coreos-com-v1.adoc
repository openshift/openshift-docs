...
* `/apis/operators.coreos.com/v1/catalogsourceconfigs`
- `GET`: list objects of kind CatalogSourceConfig
* `/apis/operators.coreos.com/v1/namespaces/{namespace}/catalogsourceconfigs`
- `DELETE`: delete collection of CatalogSourceConfig
- `GET`: list objects of kind CatalogSourceConfig
- `POST`: create a CatalogSourceConfig
* `/apis/operators.coreos.com/v1/namespaces/{namespace}/catalogsourceconfigs/{name}`
- `DELETE`: delete a CatalogSourceConfig
- `GET`: read the specified CatalogSourceConfig
- `PATCH`: partially update the specified CatalogSourceConfig
- `PUT`: replace the specified CatalogSourceConfig
...
| 200 - OK
| xref:../objects/index.adoc#catalogsourceconfiglist-operators-coreos-com-v1[`CatalogSourceConfigList operators.coreos.com/v1`]
| 401 - Unauthorized
| Empty
|===
...
| Parameter | Type | Description
| `body`
| xref:../operatorhub_apis/catalogsourceconfig-operators-coreos-com-v1.adoc#catalogsourceconfig-operators-coreos-com-v1[`CatalogSourceConfig operators.coreos.com/v1`]
| 
|===
...
| `name`
| `string`
| name of the CatalogSourceConfig
| `namespace`
| `string`
| object name and auth scope, such as for teams and projects
|===
