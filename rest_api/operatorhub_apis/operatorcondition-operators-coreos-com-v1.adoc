...
| `metadata`
| xref:../../rest_api/objects/index.adoc#objectmeta_v2-meta-v1[`ObjectMeta_v2 meta/v1`]
...
| 200 - OK
| xref:../../rest_api/objects/index.adoc#operatorconditionlist-operators-coreos-com-v1[`OperatorConditionList operators.coreos.com/v1`]
|===
...
| HTTP code | Reponse body
| 200 - OK
| xref:../../rest_api/objects/index.adoc#status_v2-meta-v1[`Status_v2 meta/v1`]
|===
...
| Parameter | Type | Description
| `body`
| xref:../../rest_api/objects/index.adoc#deleteoptions_v2-meta-v1[`DeleteOptions_v2 meta/v1`]
|
|===
