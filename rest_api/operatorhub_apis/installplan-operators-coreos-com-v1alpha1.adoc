...
| 200 - OK
| xref:../objects/index.adoc#installplanlist-operators-coreos-com-v1alpha1[`InstallPlanList operators.coreos.com/v1alpha1`]
|===
...
| Parameter | Type | Description
| `body`
| xref:../operatorhub_apis/installplan-operators-coreos-com-v1alpha1.adoc#installplan-operators-coreos-com-v1alpha1[`InstallPlan operators.coreos.com/v1alpha1`]
| 
|===
