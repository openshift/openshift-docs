...
|===
|Name|Description|Required|Schema|Default
|cidrSelector|cidrSelector is the CIDR range to allow/deny traffic to. If this is set, dnsName must be unset|true|string|
|dnsName|dnsName is the domain name to allow/deny traffic to. If this is set, cidrSelector must be unset|true|string|
|===
...
|labels|Selectors specifies a list of label selectors over group labels.|true|<<unversioned.LabelSelector>> array|
|===
...
|labels|Selectors specifies a list of label selectors over user labels.|true|<<unversioned.LabelSelector>> array|
|===
