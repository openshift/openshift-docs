...
The following table describes the parameters for the `AppliedClusterResourceQuota` object:
...
| `.spec.quota.scopeSelector.matchExpressions[].operator`
| string
| Represents a scope's relationship to a set of values. Valid operators are In, NotIn, Exists, DoesNotExist.

| `.spec.quota.scopeSelector.matchExpressions[].scopeName`
| string
| The name of the scope that the selector applies to.

| `.spec.quota.scopeSelector.matchExpressions[].values`
| array (string)
...
| `.spec.selector.labels.matchExpressions`
| array
...
| `.spec.selector.labels.matchExpressions[].key`
| string
| key is the label key that the selector applies to.

| `.spec.selector.labels.matchExpressions[].operator`
| string
| operator represents a key's relationship to a set of values. Valid operators are In, NotIn, Exists and DoesNotExist.

| `.spec.selector.labels.matchExpressions[].values`
| array (string)
| values is an array of string values. If the operator is In or NotIn, the values array must be non-empty. If the operator is Exists or DoesNotExist, the values array must be empty. This array is replaced during a strategic merge patch.

| `.spec.selector.labels.matchLabels`
| object (string)
...
| `.status.namespaces[].status.hard`
| object (string)
| Hard is the set of enforced hard limits for each named resource. More info: https://kubernetes.io/docs/concepts/policy/resource-quotas/

| `.status.namespaces[].status.used`
| object (string)
...
The following table describes the parameters for the `ClusterResourceQuota` object:
