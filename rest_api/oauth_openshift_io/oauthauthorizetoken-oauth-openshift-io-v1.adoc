...
| Parameter | Type | Description
| `body`
| xref:../oauth_openshift_io/oauthauthorizetoken-oauth-openshift-io-v1.adoc#oauthauthorizetoken-oauth-openshift-io-v1[`OAuthAuthorizeToken oauth.openshift.io/v1`]
| 
|===
