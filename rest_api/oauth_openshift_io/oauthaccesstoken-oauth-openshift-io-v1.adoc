...
| HTTP code | Reponse body
| 200 - OK
| xref:../objects/index.adoc#oauthaccesstokenlist-oauth-openshift-io-v1[`OAuthAccessTokenList oauth.openshift.io/v1`]
| 401 - Unauthorized
| Empty
|===
...
| Parameter | Type | Description
| `body`
| xref:../oauth_openshift_io/oauthaccesstoken-oauth-openshift-io-v1.adoc#oauthaccesstoken-oauth-openshift-io-v1[`OAuthAccessToken oauth.openshift.io/v1`]
| 
|===
