...
[role="_abstract"]
Configure a Keystone identity provider to connect {product-title} to an OpenStack Keystone v3 server so that users can sign in with Keystone credentials.
