...
[role="_abstract"]
Configure the `github` identity provider so users can log in to {product-title} with GitHub or GitHub Enterprise accounts through OAuth. Use this integration when you want cluster users to authenticate with existing GitHub credentials instead of managing separate cluster passwords.
...
* link:https://docs.github.com/en/authentication/keeping-your-account-and-data-secure/authorizing-oauth-apps[GitHub authentication (GitHub documentation)]
