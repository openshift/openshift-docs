...
[role="_abstract"]
Configure the `github` identity provider so users can log in to {product-title} with GitHub or GitHub Enterprise accounts through OAuth.
...
* link:https://docs.github.com/en/authentication/keeping-your-account-and-data-secure/authorizing-oauth-apps[GitHub authentication]
