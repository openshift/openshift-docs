...
[role="_abstract"]
To interact with {product-title}, log in so the authentication layer can verify your identity. The authorization layer then uses your identity to determine which actions and resources you can access.
