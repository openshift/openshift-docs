...
include::modules/cco-short-term-creds-pod-webhook.adoc[leveloffset=+2]

.Additional resources
* xref:../../nodes/pods/nodes-pods-webhooks.adoc#pod-id-webhook-aws_nodes-pods-webhooks[Configuring a pod identity webhook for {aws-short} {sts-short}]
...
.Additional resources
* xref:../../nodes/pods/nodes-pods-webhooks.adoc#pod-id-webhook-gcp_nodes-pods-webhooks[Configuring a pod identity webhook for {gcp-wid-short}]
...
.Additional resources
* xref:../../nodes/pods/nodes-pods-webhooks.adoc#pod-id-webhook-azure_nodes-pods-webhooks[Configuring a pod identity webhook for {entra-first}]
