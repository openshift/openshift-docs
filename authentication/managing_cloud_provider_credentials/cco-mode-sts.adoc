...
To install a cluster that is configured to use the CCO in manual mode with STS:
...
. xref:../../authentication/managing_cloud_provider_credentials/cco-mode-sts.adoc#cco-ccoctl-configuring_cco-mode-sts[Create the required AWS resources]
...
//Task part 1: Creating AWS resources with the Cloud Credential Operator utility
