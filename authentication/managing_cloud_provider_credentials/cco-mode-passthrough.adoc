...
To locate the `CredentialsRequest` CRs that are required, see xref:../../installing/installing_gcp/ipi/installing-gcp-customizations.adoc#manually-create-iam_installing-gcp-customizations[Manually creating long-term credentials for GCP].
...
* xref:../../installing/installing_gcp/ipi/installing-gcp-customizations.adoc#manually-create-iam_installing-gcp-customizations[Manually creating long-term credentials for GCP]
