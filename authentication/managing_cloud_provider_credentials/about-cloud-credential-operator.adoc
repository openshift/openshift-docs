...
* xref:../../operators/reference/operator-reference.adoc#cloud-credential-operator_red-hat-operators[Platform Operators reference page for the Cloud Credential Operator]
