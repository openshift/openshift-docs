...
image::334_OpenShift_cluster_updating_and_CCO_workflows_0523_4.10_A.png[Decision tree showing how to determine the configured CCO credentials mode for your cluster.]
