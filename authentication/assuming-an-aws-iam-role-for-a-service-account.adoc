...
* link:https://docs.redhat.com/en/documentation/red_hat_openshift_service_on_aws/4/html/architecture/admission-plug-ins#admission-webhooks-about_admission-plug-ins[Webhook admission plugins]
