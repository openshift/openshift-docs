...
* link:https://docs.redhat.com/en/documentation/red_hat_quay/3.18/html/about_quay_io/allow-robot-access-user-repo[Red{nbsp}Hat Quay Robot Account overview]
