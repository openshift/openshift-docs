...
* For an Overview topic, use the xref:templates/overview_topic_template.adoc#contributing-to-docs-templates-overview-topic-template[Overview
topic template].
* For revision history topics, use the xref:templates/rev_history_guide_dirname.adoc#contributing-to-docs-templates-rev-history-guide-dirname[Revision
History Template].
* For all other topics, use their xref:templates/topic_template.adoc#contributing-to-docs-templates-topic-template[normal
topic template].
