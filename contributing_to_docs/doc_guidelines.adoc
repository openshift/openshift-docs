...
<4> Specify the target average DERPEEDOO utilization over all the pods, represented as a percent of requested CPU.
....
...
The default amount of DERPEEDOO that a container can use if not specified in the `Pod` spec.
