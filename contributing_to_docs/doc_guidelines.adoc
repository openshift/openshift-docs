...
*Problem*
The following is invalid formatting. It is intended to mark up a literal value, _openshift-*_:

----
`openshift-*`
----

Travis reports the combination of the asterisk and the grave accent (`) as and_Opening and ending tag mismatch_.

*Solution*
Use passthrough characters to enclose the characters you do not want to render `+openshift-*+`
