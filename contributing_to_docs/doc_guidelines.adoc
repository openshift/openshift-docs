...
* For snippets or sections of a file, use an ellipsis (`...`) to show that the file continues before and/or after the quoted block. For large YAML snippets, use an ellipsis preceded by a YAML comment `#`.
+
----
apiVersion: v1
kind: Pod
