...
====
Rollbacks revert an application back to a previous deployment and can be performed using the REST API or the OpenShift CLI. See the xref:cli.adoc#deployment-rollbacks[CLI documentation] for more information.
