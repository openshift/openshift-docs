...
== Ensuring that you don't include sensitive information in your docs
...
Remove or rework text or comments that inadvertently describe or name new or un-released Red Hat, customer, or partner features or products.
...
Ensure that you do not include sensitive customer or Red Hat data in documentation.

Possible sources of customer identifying data include:

* Example custom resource YAML snippets
...
If you have any doubt about what you are documenting, contact a subject matter expert.
====
