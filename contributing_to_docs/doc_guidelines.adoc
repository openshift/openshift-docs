...
[WARNING]
====
Some filtering functionality, such as the use of a wildcard (*), is not fully supported by PV1. Verify that access.redhat.com builds and docs.openshift.com builds are including or excluding content as expected if you try to use them.
====
