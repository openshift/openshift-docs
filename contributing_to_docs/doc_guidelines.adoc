...
In OpenShift docs
* all links to internal topics are created using `xref` and have a anchor id.
...
Before you can create a domain, you must first xref:../dev_guide/new_app.adoc#new-app[create an application].
----
...
----
link:http://othersite.com/otherpath[friendly descriptor]
----
