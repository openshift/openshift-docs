...
[TIP]
====
The Atom editor removes trailing whitespace by default. In VS Code, you must turn this on. In your user settings, go to *Text Editor* -> *Files* and select the *Trim Trailing Whitespace* checkbox.
====
