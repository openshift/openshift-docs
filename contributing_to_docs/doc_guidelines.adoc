...
* You can include only entire modules in assemblies. Although it is valid AsciiDoc, including only link:https://docs.asciidoctor.org/asciidoc/latest/directives/include-lines/#specifying-line-ranges[certain lines] of files can cause build errors and other unintended behavior.
====
...
[IMPORTANT]
====
You must include the entire snippet in another file. Although it is valid AsciiDoc, including only link:https://docs.asciidoctor.org/asciidoc/latest/directives/include-lines/#specifying-line-ranges[certain lines] of files can cause build errors and other unintended behavior.
====
