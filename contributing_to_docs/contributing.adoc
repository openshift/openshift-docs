...
Topics:
  ...
  - Name: The Curious Crocodile
    ...
    Distros: openshift-enterprise <4>
...
_openshift-origin,openshift-enterprise,openshift-dedicated,openshift-aro,openshift-webscale_.
* The *all* value overrides other values, so _all_ is processed
as *all*.
