...
This tutorial walks you through deploying services to stand up an application called `national-parks-app` on {product-title} that displays a map of national parks across the world. You will use the {product-title} web console to complete this tutorial.
...
* You have xref:../web_console/web-console.adoc#web-console-overview[logged into the {product-title} web console].
