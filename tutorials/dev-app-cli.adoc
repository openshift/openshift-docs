...
. xref:../tutorials/dev-app-cli.adoc#getting-started-cli-creating-new-project_dev-app-cli[Create a new project for the application].
+
...
. xref:../tutorials/dev-app-cli.adoc#getting-started-cli-view_dev-app-cli[Verify that the map application is available].
+
This step verifies that you can view the map of national parks in a browser.
