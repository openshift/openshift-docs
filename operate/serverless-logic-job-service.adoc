...
[NOTE]
====
You do not need to manually install or configure the Job service if you are using the {ServerlessLogicOperatorName} to deploy workflows. The Operator handles these tasks automatically and manages all necessary configurations for each workflow to connect with it.
====
