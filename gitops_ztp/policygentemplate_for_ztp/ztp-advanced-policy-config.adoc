...
<<<<<<< HEAD:edge_computing/policygentemplate_for_ztp/ztp-advanced-policy-config.adoc
=======
...
>>>>>>> 5997cf630b (TELCODOCS#2177: Refactor Edge Computing to improve ToC navigation):gitops_ztp/policygentemplate_for_ztp/ztp-advanced-policy-config.adoc
...
* xref:../../gitops_ztp/policygentemplate_for_ztp/ztp-advanced-policy-config.adoc#ztp-using-pgt-to-update-source-crs_ztp-advanced-policy-config[Using PolicyGenTemplate CRs to override source CRs content]
