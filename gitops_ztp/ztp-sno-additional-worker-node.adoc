...
* For more information about {sno} clusters tuned for vDU application deployments, see xref:../gitops_ztp/ztp-reference-cluster-configuration-for-vdu.adoc#sno-configure-for-vdu[Reference configuration for deploying vDUs on {sno}].
