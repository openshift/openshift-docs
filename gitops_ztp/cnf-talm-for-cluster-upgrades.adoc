...
For more information about the `PolicyGenTemplate` CRD, see xref:../gitops_ztp/ztp-configuring-managed-clusters-policies.adoc#ztp-the-policygentemplate_ztp-configuring-managed-clusters-policies[About the PolicyGenTemplate CRD].
...
* For more information about using {cgu-operator-full} in the ZTP workflow, see xref:../gitops_ztp/ztp-talm-updating-managed-policies.adoc#ztp-topology-aware-lifecycle-manager[Updating managed policies with {cgu-operator-full}].
