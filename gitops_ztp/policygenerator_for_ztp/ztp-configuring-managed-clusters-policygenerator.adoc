...
* xref:../../gitops_ztp/policygenerator_for_ztp/ztp-advanced-policygenerator-config.adoc#ztp-creating-a-validator-inform-policy_ztp-advanced-policy-config[Signalling {ztp} cluster deployment completion with validator inform policies]
...
* For information about using {cgu-operator-first} to construct your own `ClusterGroupUpgrade` CR, see xref:../../gitops_ztp/cnf-talm-for-cluster-upgrades.adoc#talo-about-cgu-crs_cnf-topology-aware-lifecycle-manager[About the ClusterGroupUpgrade CR].
