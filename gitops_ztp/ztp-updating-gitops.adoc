...
* For information about creating `ClusterGroupUpgrade` CRs, see xref:../gitops_ztp/ztp-talm-updating-managed-policies.adoc#talo-precache-autocreated-cgu-for-ztp_ztp-talm[About the auto-created ClusterGroupUpgrade CR for ZTP].
