...
ifdef::openshift-enterprise[]
* link:https://docs.openshift.com/container-platform/latest/operators/admin/olm-restricted-networks.adoc#olm-restricted-networks[Using Operator Lifecycle Manager on restricted networks]
* link:https://docs.openshift.com/container-platform/latest/operators/understanding/olm-understanding-operatorhub.adoc#olm-operatorhub-overview[Understanding OperatorHub]
* link:https://docs.openshift.com/container-platform/latest/installing/cluster-capabilities.adoc#cluster-capabilities[Cluster capabilities]
endif::[]
