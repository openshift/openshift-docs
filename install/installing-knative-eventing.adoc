...
* If you want to learn more about `KnativeKafka` custom resource, see  xref:../install/serverless-kafka-admin.adoc#serverless-kafka-admin[Configuring Knative broker for Apache Kafka].

* If you want to use Knative services, you can xref:../install/installing-knative-serving.adoc#installing-knative-serving[install Knative Serving].
