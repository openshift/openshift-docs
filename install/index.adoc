...
you use POWER servers, review the xref:install_power[Power Limitations and Considerations].
endif::[]
...
As of version 3.10.z, you can install {product-title} on IBM POWER servers.
...
* Cloud provider storage is not supported. You can use the following storage
providers:
** GlusterFS
** NFS
** Local storage
