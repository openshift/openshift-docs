...
link:https://docs.ansible.com/ansible/2.4/YAMLSyntax.html[YAML syntax].
====
...
----
[masters]
master.example.com openshift_public_hostname=ose3-master.public.example.com
----
...
cluster variable in the *[OSEv3:vars]* section of your inventory file.
...
`oreg_auth_password` parameter value.
...
`oreg_auth_user` parameter value.
|===

[NOTE]
====
For more information on accessing the default registry, which requires authentication,
