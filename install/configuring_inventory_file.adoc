...
|Sets `loggingPublicURL` in the master configuration. See xref:../install_config/logging/aggregate_logging_configure.html#aggregate-logging-kibana[Kibana] for details. Example value: `\https://kibana.example.com`
