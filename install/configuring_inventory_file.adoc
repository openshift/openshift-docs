...
[IMPORTANT]
====
If you plan to deploy using the `deploy_cluster.yml` playbook, you should define the
...
|`openshift_release`
|Specifies the generic release of {product-title} to install. This is mainly used during containerized installation from images.
