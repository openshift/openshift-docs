...
link:https://access.redhat.com/documentation/en-us/red_hat_enterprise_linux_atomic_host/7/html-single/installation_and_configuration_guide/[RHEL Atomic Host]
7.4.5 or later.
** IBM POWER9: RHEL 7.5 with the "Minimal" installation option and the latest
packages from the Extras channel.
** IBM POWER8: RHEL-alt 7.5 with the "Minimal" installation option and the
...
The
xref:configuring_inventory_file.adoc#configuring-ansible[Advanced
