...
* xref:../install/ossm-cert-manager-assembly.adoc#inplace-istio-csr-installation_ossm-cert-manager-assembly[istio-csr installation: InPlace update strategy]
* xref:../install/ossm-cert-manager-assembly.adoc#revision-based-istio-csr-installation_ossm-cert-manager-assembly[istio-csr installation: RevisionBased update strategy]

include::modules/ossm-cert-manager-istio-csr-inplace-update-strategy.adoc[leveloffset=+2]

.Next steps
* xref:../install/ossm-cert-manager-assembly.adoc#install-istio-resource_ossm-cert-manager-assembly[Install your Istio resource]
