...
* xref:modules/ossm-cert-manager-istio-csr-inplace-update-strategy.adoc[istio-csr installation: InPlace update strategy]
...
.Next steps
* xref:modules/ossm-cert-manager-install-istio-resource.adoc[Install your Istio resource]
