...
* xref:../../ossm-cert-manager-istio-csr-inplace-update-strategy.adoc[istio-csr installation: InPlace update strategy]
* xref:../../ossm-cert-manager-istio-csr-revisionbased-strategy.adoc[istio-csr installation: RevisionBased update strategy]
