...
* xref:../../install/ossm-cert-manager-assembly.adoc#inplace-istio-csr-installation_ossm-cert-manager.adoc[istio-csr installation: InPlace update strategy]
* xref:../../install/ossm-cert-manager-assembly.adoc#revision-based-istio-csr-installation_ossm-cert-manager.adoc[istio-csr installation: RevisionBased update strategy]

include::modules/ossm-cert-manager-istio-csr-inplace-update-strategy.adoc[leveloffset=+2]

.Next steps
* xref:../../ossm-cert-manager-install-istio-resource.adoc[Install your Istio resource]
