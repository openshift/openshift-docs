...
* After installing Knative Serving, you can start xref:../knative-serving/getting-started/serverless-applications.adoc[creating serverless applications].

* If you want to use Knative event-driven architecture, you can xref:../install/installing-knative-eventing.adoc#installing-knative-eventing[install Knative Eventing].
