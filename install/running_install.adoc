...
# atomic install --system \
    ...
    --set OPTS="-v" \
ifdef::openshift-enterprise[]
    registry.access.redhat.com/openshift3/ose-ansible:v3.11
endif::[]
ifdef::openshift-origin[]
...
- Deploy an xref:../install_config/registry/index.adoc#install-config-registry-overview[integrated container registry].
