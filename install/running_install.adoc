...
and xref:../../install_config/install/host_preparation.adoc#install-config-install-host-preparation[Host Preparation] 
...
xref:index.adoc#planning-installation-types[RPM vs System Container Considerations] 
...
inventory file in *_/etc/ansible/hosts_*, run the advanced installation
