...
and the web console port number to access the web console with a web browser. You
can launch the web console, but you cannot log in until you 
xref:../../getting_started/configure_openshift.html#change-log-in-identity-provider[configure an idendity provider and users].
+
