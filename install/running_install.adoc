...
* If you are installing in a new environment, you can run the
*_deploy_cluster.yml_* playbook again.
...
you can
xref:../install/running_install.adoc#installer-known-issues[retry the installation].
...
run the *_deploy_cluster.yml_* playbook again.
...
installation or xref:uninstalling-advanced[uninstall] and
install again.
* If you use virtual machines, start from a fresh image or
xref:uninstalling-advanced[uninstall] and install again.
* If you use bare metal machines, xref:uninstalling-advanced[uninstall]
and install again.
