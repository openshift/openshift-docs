...
and link:https://github.com/openshift/openshift-ansible/tree/release-3.11/playbooks/openstack[Ansible playbooks]
...
prerequisites, see
link:https://github.com/openshift/openshift-ansible/tree/release-3.11/playbooks/openstack#installation[the OpenStack Provisioning readme file].
...
|metrics-server
|*_{pb-prefix}playbooks/metrics-server/config.yml_*
