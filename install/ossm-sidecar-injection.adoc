...
include::modules/ossm-enabling-sidecar-injection-istio-revision-tag.adoc[leveloffset=+1]
...
//Update when PR for *about-concepts-resources#istiorevistiontag has been merged