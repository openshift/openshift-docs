...
6.1] server that acts as a container registry.
////
...
$ docker pull registry.redhat.io/openshift3/efs-provisioner:<tag>
...
$ docker pull registry.redhat.io/openshift3/ose-f5-router:<tag>
...
[source, bash]
----
$ docker pull registry.redhat.io/openshift3/logging-curator5:<tag>
$ docker pull registry.redhat.io/openshift3/logging-elasticsearch5:<tag>
$ docker pull registry.redhat.io/openshift3/logging-eventrouter:<tag>
$ docker pull registry.redhat.io/openshift3/logging-fluentd:<tag>
$ docker pull registry.redhat.io/openshift3/logging-kibana5:<tag>
...
$ docker pull registry.redhat.io/cloudforms46/cfme-openshift-postgresql:<tag>
$ docker pull registry.redhat.io/cloudforms46/cfme-openshift-memcached:<tag>
$ docker pull registry.redhat.io/cloudforms46/cfme-openshift-app-ui:<tag>
$ docker pull registry.redhat.io/cloudforms46/cfme-openshift-app:<tag>
$ docker pull registry.redhat.io/cloudforms46/cfme-openshift-embedded-ansible:<tag>
$ docker pull registry.redhat.io/cloudforms46/cfme-openshift-httpd:<tag>
$ docker pull registry.redhat.io/cloudforms46/cfme-httpd-configmap-generator:<tag>
$ docker pull registry.redhat.io/rhgs3/rhgs-server-rhel7:<tag>
$ docker pull registry.redhat.io/rhgs3/rhgs-volmanager-rhel7:<tag>
$ docker pull registry.redhat.io/rhgs3/rhgs-gluster-block-prov-rhel7:<tag>
$ docker pull registry.redhat.io/rhgs3/rhgs-s3-server-rhel7:<tag>
----
+
[IMPORTANT]
====
...
$ docker pull registry.redhat.io/openshift3/jenkins-1-rhel7:<tag>
...
$ docker save -o ose3-images.tar \
    ...
    registry.redhat.io/openshift3/efs-provisioner \
    ...
    registry.redhat.io/openshift3/ose-f5-router \
...
$ docker save -o ose3-optional-imags.tar \
    registry.redhat.io/openshift3/logging-curator5 \
    registry.redhat.io/openshift3/logging-elasticsearch5 \
    registry.redhat.io/openshift3/logging-eventrouter \
    registry.redhat.io/openshift3/logging-fluentd \
    registry.redhat.io/openshift3/logging-kibana5 \
...
$ docker save -o ose3-builder-images.tar \
    ...
    registry.redhat.io/openshift3/jenkins-1-rhel7:<tag>\
