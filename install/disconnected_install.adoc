...
:latest-registry-console-tag: v3.9.14
:data-uri:
:icons:
:experimental:
:toc: macro
...
====
For
xref:index.adoc#planning-installation-types[containerized installations], to install the etcd container, you can set the Ansible variable `osm_etcd_image` to be the fully qualified name of the etcd image on
