...
For the latest version, you must run this command twice to ensure that you have
all the required images. Run the command one time as shown, and then replace
`<tag>` with `{latest-tag}` and run the command again.
endif::[]
+
[source, bash]
----
