...
//In regard to upgrades, if the OpenShift Service Mesh users's current subscription is in conflict, they wont be able to use Gateway API for Ingress until that is (manually) resolved [Updated for OCP 4.19].
