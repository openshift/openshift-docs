...
include::modules/ossm-about-accessing-bookinfo-application-using-gateway[leveloffset=+2]
include::modules/ossm-accessing-bookinfo-application-using-istio-gateway-injection[leveloffset=+2]
