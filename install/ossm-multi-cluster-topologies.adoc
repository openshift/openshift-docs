...
.Next steps
To verify that the multi-cluster topology was configured or to remove the topology from a development environment, see the following procedures for more information:  
