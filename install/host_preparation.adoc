...
xref:../../install_config/install/advanced_install.adoc#advanced-install-networking-variables-table[`openshift_portal_net`] parameter in your inventory file.
...
used when xref:dvanced_install.adoc#running-the-installation-playbooks[running
...
xref:../../install_config/install/advanced_install.adoc#running-the-advanced-installation-rpm[RPM-based installer] to run the installation, you can skip this step. However, if
you plan to use the
