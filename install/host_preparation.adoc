...
7.5 or 7.6 with the latest packages from the Extras channel.
* For servers that use IBM POWER9 architecture, use a base installation of
RHEL-ALT 7.5 or 7.6 with the latest packages from the Extras channel.
...
. Enable only the repositories required by {product-title} 3.110.
