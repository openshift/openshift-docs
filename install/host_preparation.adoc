...
These directories set by default in a new RHEL 7.x installation. Run the following command to verify your `PATH` settings:
...
+
====
If the *yum-config-manager* command is not found, xref:#installing-base-packages[install the base packages]
