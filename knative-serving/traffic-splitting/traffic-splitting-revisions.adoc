...
After you create a serverless application, the application is displayed in the *Topology* view in the {ocp-product-title} web console. The application revision is represented by the node, and the Knative service is indicated by a quadrilateral around the node.
