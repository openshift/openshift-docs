...
xref:../../dev_guide/templates.adoc#dev-guide-templates[template] for MariaDB
...
----
$ oc create -f \
    https://github.com/openshift/origin/blob/master/examples/db-templates/mariadb-ephemeral-template.json
----
====
