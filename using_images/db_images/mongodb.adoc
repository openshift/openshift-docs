...
xref:../../dev_guide/deployment_configs.adoc#config-change-trigger[configuration change
...
To xref:../../dev_guide/deployment_configs.adoc#scaling[increase the number of members]
in the cluster:
