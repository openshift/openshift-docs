...
xref:../../dev_guide/builds.adoc#environment-files[`.sti/environment`] file
inside your source code repository, or define them in the
xref:../../dev_guide/builds.adoc#buildconfig-environment[environment section]
...
After you built your application image with your version of link:https://github.com/openshift/source-to-image#anatomy-of-a-builder-image[S2I run script], run the image with the RACK_ENV=development environment variable passed to the link:http://docker.io[Docker] -e run flag:
