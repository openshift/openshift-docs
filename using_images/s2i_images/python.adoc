...
== Versions
Currently, OpenShift provides versions https://github.com/openshift/sti-python/tree/master/3.3[3.3] and https://github.com/openshift/sti-python/tree/master/3.5[3.5] of Python.
