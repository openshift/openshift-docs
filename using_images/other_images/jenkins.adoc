...
Pipeline build pods are deleted by default after the build completes or is aborted. 
...
----
<1> Allowed values for `podRetention` are "NEVER", "ON_FAILURE", "ALWAYS", and "DEFAULT".
====
