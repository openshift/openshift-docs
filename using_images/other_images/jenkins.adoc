...
xref:jenkins_agents.adoc#overview[Jenkins Agents] for more information.
...
xref:../../using_images/other_images/jenkins_agents.adoc#agent-pod-retention[Agent Pod Retention]
for further details.
