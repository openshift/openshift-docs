...
https://github.com/openshift/jenkins/tree/master/1.6[1.609] of Jenkins.
...
----
$ docker pull registry.access.redhat.com/openshift3/jenkins-16-rhel7
----
...
the adminstrator user and password.  The default login is `*admin/password*`.
