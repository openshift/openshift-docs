...
To use a persistent volume store, the cluster administrator must define a link:../../admin_guide/persistent_storage/persistent_storage_nfs.html[persistent volume pool] in the OpenShift deployment.
