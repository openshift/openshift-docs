...
n|link:../using_images/s2i_images/ruby.html[Source-to-Image (S2I) -> Ruby]
|Clarified description of the `*DISABLE_ASSET_COMPILATION*` environment variable.

n|link:../using_images/s2i_images/perl.html[Source-to-Image (S2I) -> Perl]
|Clarified description of the `*ENABLE_CPAN_TEST*` environment variable.

|link:../using_images/s2i_images/nodejs.html[Source-to-Image (S2I) -> Node.js]
