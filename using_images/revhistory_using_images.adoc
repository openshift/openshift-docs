...
|xref:../using_images/db_images/mysql.adoc#using-images-database-images-mysql[Database Images -> MySQL]
|Added `*MYSQL_SERVICE_HOST*` and `*MYSQL_SERVICE_PORT*` to the xref:../using_images/db_images/mysql.adoc#environment-variables[Environment Variables] section.

|xref:../using_images/db_images/postgresql.adoc#using-images-database-images-postgresql[Database Images -> PostgreSQL]
...
|xref:../using_images/db_images/mongodb.adoc#using-images-database-images-mongodb[Database Images -> MongoDB]
