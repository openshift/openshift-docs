...
//Tue Nov 08 2016
|link:../using_images/s2i_images/python.adoc#using-images-s2i-images-python[Source-to-Image (S2I) -> Python]
|Added the `*PIP_INDEX_URL*` environment variable to the link:../using_images/s2i_images/python.adoc#using-images-python-configuration[Configuration] section.

|link:../using_images/db_images/mysql.adoc#using-images-db-images-mysql[MySQL]
|Updated the Additional MySQL Settings table in the link:../using_images/db_images/mysql.adoc#mysql-environment-variables[Environment Variables] section with new variables.
