...
* _http://<application-name>-<project-name>.<hostname>/<app-context>_: for the web server, and
* _https://secure-<application-name>-<project-name>.<hostname>/<app-context>_: for the encrypted web server, where <app-context> is one of app-jee, app-profile-jee, app-profile-jee-saml, or service depending on the example application.
