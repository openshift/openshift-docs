...
----
+
For further information, see xref:../../install_config/install/docker_registry.adoc#install-config-install-docker-registry[Deploying a Docker Registry]

. *Deploy a Router* - Use the instructions at the xref:../../install_config/install/deploy_router.adoc#install-config-install-deploy-router[Deploying a Router] page for this step.
