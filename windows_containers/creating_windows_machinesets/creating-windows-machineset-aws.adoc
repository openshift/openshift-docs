...
* For disconnected clusters, the Windows AMI must have the EC2LaunchV2 agent version 2.0.1643 or later installed. For more information on the EC2LaunchV2 agent, see the link:https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/ec2launch-v2-install.html[AWS documentation].
