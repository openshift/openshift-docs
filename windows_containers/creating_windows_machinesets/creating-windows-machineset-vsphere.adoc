...
[role="_abstract"]
You can use a `MachineSet` custom resource (CR) to add a Windows compute node to your {vmw-full} cluster, where you can run Windows container workloads.
...
[id="prerequisites_creating-windows-machineset-vsphere"]
== Prerequisites
