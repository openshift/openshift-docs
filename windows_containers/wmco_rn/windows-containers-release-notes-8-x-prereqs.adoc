...
:context: windows-containers-release-notes-8-x-prereqs
[id="windows-containers-release-notes-8-x-prereqs"]
...
[id="wmco-prerequisites-supported-install-8-x_{context}"]
...
|Amazon Web Services (AWS)
|Windows Server 2022, OS Build link:https://support.microsoft.com/en-us/topic/april-25-2022-kb5012637-os-build-20348-681-preview-2233d69c-d4a5-4be9-8c24-04a450861a8d[20348.681] or later ^[1]^
