...
:context: windows-containers-release-notes-7-x-past
[id="windows-containers-release-notes-7-x-past"]
...
For the current version, see xref:../../windows_containers/wmco_rn/windows-containers-release-notes-7-x.adoc#windows-containers-release-notes-7-x[Red Hat OpenShift support for Windows Containers release notes].

[id="wmco-7-2-1_{context}"]
...
[id="wmco-7-2-1-bug-fixes_{context}"]
=== Bug fixes
...
[id="wmco-7-1-0-bug-fixes_{context}"]
=== Bug fixes
...
[id="wmco-7-0-1-bug-fixes_{context}"]
=== Bug fixes
...
[id="wmco-7-0-0-new-features_{context}"]
=== New features and improvements

[id="wmco-7-0-0-wicd_{context}"]
...
[id="wmco-7-0-0-bug-fixes_{context}"]
=== Bug fixes
...
[id="wmco-7-0-0-known-issues_{context}"]
=== Known issues
...
See the full list of xref:../../windows_containers/wmco_rn/windows-containers-release-notes-7-x-known-limitations.adoc#windows-containers-release-notes-7-x-known-limitations[known limitations]
