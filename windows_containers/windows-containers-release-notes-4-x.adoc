...
For more information, see the Red Hat OpenShift Container Platform Life Cycle Policy document for linkhttps://access.redhat.com/support/policy/updates/openshift#windows[OpenShift Container Platform for Windows Containers].
