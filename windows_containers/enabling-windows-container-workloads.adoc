...
[role="_additional-resources"]
.Additional resources
* xref:../windows_containers/enabling-windows-container-workloads.html#wmco-disconnected-cluster_enabling-windows-container-workloads[Using Windows containers with a mirror registry]
