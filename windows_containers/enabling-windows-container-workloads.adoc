...
* For the comprehensive prerequisites for the Windows Machine Config Operator, see xref:../windows_containers/wmco_rn/windows-containers-release-notes-10-18-x-prereqs.adoc#windows-containers-release-notes-10-18-x-prereqs[Windows Machine Config Operator prerequisites].
