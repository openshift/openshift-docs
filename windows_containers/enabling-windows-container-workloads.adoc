...
[NOTE]
====
Due to a limitation within the Windows operating system, {product-title} clusters configured with Class E `clusterNetwork` CIDR (240.0.0.0) is not compatible with Windows nodes.
====
