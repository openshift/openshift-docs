...
* For the comprehensive prerequisites for the Windows Machine Config Operator, see xref:../windows_containers/windows-containers-release-notes-7-x#wmco-prerequisites_windows-containers-release-notes[Windows Machine Config Operator prerequisites].
