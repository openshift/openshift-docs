...
This release of the WMCO provides new features and bug fixes for running Windows compute nodes in an {product-title} cluster. The components of WMCO 8.1.3 were released in link:https://access.redhat.com/errata/RHSA-2024:TDB[RHSA-2024:TBD].

[id="wmco-8-1-3-bug-fixes"]
=== Bug fixes
