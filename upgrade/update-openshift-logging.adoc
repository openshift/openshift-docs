...
[id="update-openshift-logging"]
= Update OpenShift Logging
...
+
For information about updating {coo-short}, see the {coo-first} documentation.

include::modules/checking-update-readiness-of-clo.adoc[leveloffset=+1]

include::modules/checking-update-readiness-of-loki-operator.adoc[leveloffset=+1]

include::modules/updating-the-loki-operator.adoc[leveloffset=+1]

include::modules/updating-the-loki-operator-by-using-the-cli.adoc[leveloffset=+1]

include::modules/updating-the-clo.adoc[leveloffset=+1]

include::modules/updating-the-clo-by-using-the-cli.adoc[leveloffset=+1]

[role="_additional-resources"]
.Additional resources

* link:https://access.redhat.com/support/policy/updates/openshift_operators?extIdCarryOver=true&sc_cid=7013a000003StsiAAC#platform-agnostic[OpenShift Operator Life Cycles (Red Hat support policy)]
