...
= Review release updates to plan cluster upgrades
...
For more information about {builds-shortname}, see "Overview of {builds-shortname}".
...
* xref:../discover/overview-openshift-builds.adoc#overview-openshift-builds[Overview of {builds-shortname}]
