...
other than the supported xref:../admin_guide/persistent_storage_nfs.adoc#admin-guide-persistent-storage-nfs[NFS]
plug-in, such as
...
xref:../install_config/upgrades.adoc#install-config-upgrades[upgrading your OpenShift cluster] properly,
...
* To make it easier to xref:../install_config/upgrades.adoc#install-config-upgrades[upgrade your cluster],
...
* You can now xref:../admin_guide/web_console_customization.adoc#admin-guide-web-console-customization[customize the
