...
See the link:../admin_guide/install/setup.html[Administrator Guide] for
...
- https://bugzilla.redhat.com/show_bug.cgi?id=1233540[BZ#1233540]: Persistent Volume does not get recycled when the persistentVolumeReclaimPolicy is "Recycle"
