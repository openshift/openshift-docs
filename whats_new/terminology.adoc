...
xref:../architecture/core_concepts/index.adoc[Core Concepts] topics for more
...
the xref:applications.adoc[Applications] topic for a more in-depth look at this
change.
...
(S2I)] and xref:../architecture/core_concepts/templates.adoc[templated
configuration].

See the xref:carts_vs_images.adoc[Cartridges vs Images] topic for more detailed
