...
To browse the {product-title} {product-version} documentation, use one of the following methods:
...
* xref:../microshift_release_notes/microshift-4-13-release-notes.adoc#microshift-4-13-release-notes[{product-title} release notes]
