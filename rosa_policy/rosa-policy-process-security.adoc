...
* For more information about customer or shared responsibilities, see the xref:../../assemblies/rosa-policies-responsibility-matrix.adoc[ROSA Responsibilities] document.
* For more information about ROSA and its components, see the xref:../../assemblies/rosa-service-definition.adoc[ROSA Service Definition].
