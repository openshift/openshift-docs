...
//
* Ensure that you have completed the xref:../rosa_planning/rosa-hcp-prereqs.adoc[AWS prerequisites for ROSA clusters] or xref:../rosa_planning/rosa-classic-prereqs.adoc[AWS prerequisites for ROSA (classic architecture) clusters].
