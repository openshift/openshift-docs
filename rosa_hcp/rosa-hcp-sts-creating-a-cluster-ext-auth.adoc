...
* xref:../rosa_architecture/rosa_policy_service_definition/rosa-policy-process-security.adoc#rosa-policy-compliance_rosa-policy-process-security[Compliance]
...
.Additional resources
* link:https://learn.microsoft.com/en-us/entra/fundamentals/whatis[What is Microsoft Entra ID?]
...
* xref:../cli_reference/rosa_cli/rosa-cli-commands.adoc#rosa-create-idp[`rosa create idp`]
* xref:../cli_reference/rosa_cli/rosa-cli-commands.adoc#rosa-create-external-auth-provider[`rosa create external-auth-provider`]
