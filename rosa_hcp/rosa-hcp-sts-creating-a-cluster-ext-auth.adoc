...
//
* Completed the xref:../rosa_planning/rosa-hcp-prereqs.adoc#rosa-hcp-prereqs[AWS prerequisites for ROSA] and xref:../rosa_planning/rosa-classic-prereqs.adoc#rosa-classic-prereqs[AWS prerequisites for ROSA (classic achitecture)]
endif::openshift-rosa-hcp[]
...
//
* For information about the prerequisites to installing ROSA with STS, see xref:../rosa_planning/rosa-hcp-prereqs.adoc#rosa-hcp-prereqs[AWS prerequisites for ROSA] and xref:../rosa_planning/rosa-classic-prereqs.adoc#rosa-classic-prereqs[AWS prerequisites for ROSA with STS].
