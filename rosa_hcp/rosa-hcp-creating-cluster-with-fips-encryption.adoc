...
include::modules/rosa-hcp-creating-account-wide-sts-roles-and-policies-fips.adoc[leveloffset=+1]

include::modules/rosa-hcp-create-network.adoc[leveloffset=+1]

include::modules/rosa-sts-byo-oidc.adoc[leveloffset=+1]

include::modules/rosa-operator-config-fips.adoc[leveloffset=+1]
