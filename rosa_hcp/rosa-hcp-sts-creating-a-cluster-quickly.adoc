...
* Ensure that you have completed the xref:../rosa_planning/rosa-hcp-prereqs.adoc[AWS prerequisites for ROSA clusters] and xref:../rosa_planning/rosa-classic-prereqs.adoc[AWS prerequisites for ROSA (classic architecture) clusters].
endif::openshift-rosa-hcp[]
...
* For information about the prerequisites to installing ROSA with STS, see xref:../rosa_planning/rosa-hcp-prereqs.adoc#rosa-hcp-prereqs[AWS prerequisites for ROSA].
* For information about the prerequisites to installing ROSA with STS, see xref:../rosa_planning/rosa-classic-prereqs.adoc#rosa-classic-prereqs[AWS prerequisites for ROSA (classic architecture)].
