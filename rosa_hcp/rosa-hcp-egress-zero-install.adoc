...
* You have enabled the necessary xref:../rosa_planning/rosa-hcp-aws-prereqs.adoc#ffirewall-cli-bastion_rosa-hcp-aws-prereqs[ROSA CLI firewall rules] and xref:../rosa_planning/rosa-hcp-aws-prereqs.adoc#firewall-hcm-bastion_rosa-hcp-aws-prereqs[{hybrid-console} firewall rules].
