...
[role="_abstract"]
Use this guide to create a {product-title} cluster with the {rosa-cli-first}, grant user access, deploy an application, and manage your cluster.
...
* link:https://docs.redhat.com/en/documentation/red_hat_openshift_service_on_aws_classic_architecture/4/html/introduction_to_rosa/rosa-sts-about-iam-resources[About IAM resources for {product-title} clusters that use STS]