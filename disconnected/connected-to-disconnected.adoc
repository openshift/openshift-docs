...
* An installed mirror registry, which is a container image registry that supports link:https://github.com/opencontainers/distribution-spec/blob/main/spec.md[OCI v1] in the location that will host the {product-title} cluster, such as one of the following registries:
+
--
