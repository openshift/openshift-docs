...
[IMPORTANT]
====
The oc-mirror v1 plugin is now deprecated. The default mirroring method is changing to the oc-mirror v2 plugin in a future release, requiring you to specify the `--v1` flag to continue using the oc-mirror v1 plugin. Transition to the xref:../disconnected/about-installing-oc-mirror-v2.adoc#installation-oc-mirror-v2-about_about-installing-oc-mirror-v2[oc-mirror v2 plugin] for continued support and improvements.
====
