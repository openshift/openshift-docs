...
* If you are working with private registries, including `quay.io/openshift-community`, set the `REG_CREDS` environment variable to the file path of your registry credentials for use in later steps. For example, for the `podman` CLI:
endif::[]
+
[source,terminal]
----
