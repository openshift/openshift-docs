...
[IMPORTANT]
====
The oc-mirror v1 plugin is deprecated. To use the supported version, you must migrate to oc-mirror v2 plugin and specify the `--v2` flag. To continue using the deprecated version, you must specify the `--v1` flag. Transition to the xref:../../disconnected/mirroring/about-installing-oc-mirror-v2.adoc#installation-oc-mirror-v2-about_about-installing-oc-mirror-v2[oc-mirror v2 plugin] for continued support and improvements.
====
