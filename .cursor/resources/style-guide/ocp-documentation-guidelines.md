...
| --- | --- | --- |
| `openshift-origin` | OKD | - 4.18, 4.19, 4.20, 4.21 - 4 for the `latest/` build from the `main` branch |
| `openshift-enterprise` | OpenShift Container Platform | - 3.0, 3.1, 3.2, 3.3, 3.4, 3.5, 3.6, 3.7, 3.9, 3.10, 3.11 - 4.1, 4.2, 4.3, 4.4, 4.5, 4.6, 4.7, 4.8, 4.9, 4.10, 4.11, 4.12, 4.13, 4.14, 4.15, 4.16, 4.17, 4.18, 4.19, 4.20, 4.21, 4.22 |
| `openshift-dedicated` | OpenShift Dedicated | - No value set for the latest `dedicated/` build from the `enterprise-4.21` branch - 3 for the `dedicated/3` build from the `enterprise-3.11` branch |
| `openshift-rosa` | Red Hat OpenShift Service on AWS (classic architecture) | No value set for the `rosa/` build from the `enterprise-4.21` branch |
| `openshift-rosa-hcp` | Red Hat OpenShift Service on AWS | No value set for the `rosa/` build from the `enterprise-4.21` branch |
