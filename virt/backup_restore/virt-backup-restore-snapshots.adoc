...
You can create snapshots of virtual machines (VMs) by using the {product-title} web console or command line. You can also create a snapshot clone by using the {product-title} web console and then use the clone to create a VM.
...
include::modules/virt-cloning-vm-snapshot.adoc[leveloffset=+2]
