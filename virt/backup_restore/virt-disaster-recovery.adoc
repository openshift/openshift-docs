...
* link:https://access.redhat.com/documentation/en-us/red_hat_advanced_cluster_management_for_kubernetes/2.10[Red Hat Advanced Cluster Management for Kubernetes 2.10]