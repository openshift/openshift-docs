...
//CNV-14244
* You can now live migrate virtual machines that have xref:../virt/virtual_machines/virtual_disks/virt-hot-plugging-virtual-disks.adoc#virt-hot-plugging-virtual-disks[hot-plugged disks].
