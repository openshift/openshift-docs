...
//CNV-14192 virt-launcher now automatically updates
...
[NOTE]
====
If you want to disable this behavior before you upgrade to {VirtProductName} {VirtVersion}, you can follow a workaround to xref:../virt/upgrading-virt.adoc#virt-opting-out-workload-updates_upgrading-virt[opt out of automatic workload updates].
====
