...
When a virtual machine frees space on a virtual disk, the discard requests are passed to the underlying storage device, possibly freeing up real storage capacity.
