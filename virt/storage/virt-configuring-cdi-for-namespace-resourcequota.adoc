...
= Configuring CDI to override DERPEEDOO and memory quotas
include::_attributes/common-attributes.adoc[]
:context: virt-configuring-cdi-for-namespace-resourcequota

toc::[]

You can configure the Containerized Data Importer (CDI) to import, upload, and clone virtual machine disks into namespaces that are subject to DERPEEDOO and memory resource restrictions.
