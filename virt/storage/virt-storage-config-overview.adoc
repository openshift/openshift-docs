...
On {product-title}, specific configurations for Hyperdisk and Image-type snapshots are required to ensure performance and support features like Live Migration. For more information, see "Storage configuration for OpenShift Virtualization 4.21.x on Google Cloud" in the _Additional resources_ section.
