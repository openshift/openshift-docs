...
If you have a `VirtualMachine` manifest, you can create a VM from the xref:../../../virt/creating_vms_cli/virt-creating-vms-from-cli.adoc#virt-creating-vms-from-cli[command line].
