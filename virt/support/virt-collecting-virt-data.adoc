...
For information about the {product-title} monitoring stack, see link:https://docs.redhat.com/en/documentation/monitoring_stack_for_red_hat_openshift/4.15/html/about_monitoring/about-ocp-monitoring[About {product-title} monitoring].
endif::openshift-dedicated,openshift-rosa[]
...
. link:https://docs.redhat.com/en/documentation/monitoring_stack_for_red_hat_openshift/4.15/html/accessing_metrics/accessing-metrics-as-an-administrator#querying-metrics-for-all-projects-with-mon-dashboard_accessing-metrics-as-an-administrator[Collect Prometheus metrics for the cluster].
endif::openshift-rosa,openshift-dedicated[]
