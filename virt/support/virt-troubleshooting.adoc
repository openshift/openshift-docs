...
You can troubleshoot {VirtProductName} components by using the tools provided in the web console or by using the {oc-first}.
...
* link:https://docs.redhat.com/en/documentation/red_hat_openshift_logging/latest/html/installing_logging/installing-logging#installing-loki-operator-web-console_installing-logging[Installing Loki Operator by using the web console]
* link:https://docs.redhat.com/en/documentation/red_hat_openshift_logging/latest/html/installing_logging/installing-logging#install-loki-operator-cli_installing-logging[Installing the Loki Operator by using the CLI]
* link:https://docs.redhat.com/en/documentation/red_hat_openshift_logging/latest/html/configuring_logging/configuring-lokistack-storage[Configuring the log store]
