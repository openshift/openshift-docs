...
You can troubleshoot {VirtProductName} components
ifndef::openshift-origin[]
by using the xref:../../virt/support/virt-support-overview.adoc#virt-web-console_virt-support-overview[tools provided in the web console] or
endif::[]
by using the `oc` CLI tool.
