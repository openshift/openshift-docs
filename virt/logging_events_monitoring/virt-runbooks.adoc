...
You can use the procedures in these runbooks to diagnose and resolve issues that trigger {VirtProductName} xref:../../observability/monitoring/managing-alerts.adoc#managing-alerts[alerts].
...
include::modules/virt-runbook-kubevirtvmstuckinerrorstate.adoc[leveloffset=+1]

include::modules/virt-runbook-kubevirtvmstuckinmigratingstate.adoc[leveloffset=+1]

include::modules/virt-runbook-kubevirtvmstuckinstartingstate.adoc[leveloffset=+1]
