...
Dashboards in the {product-title} web console provide visual representations of cluster metrics to help you to quickly understand the state of your cluster. Dashboards belong to the xref:../../monitoring/monitoring-overview.adoc#monitoring-overview[monitoring stack] that provides monitoring for core platform components.
