...
For a list of the `oc` client troubleshooting and debugging commands, see the xref:../../cli_reference/openshift_cli/cli-command-reference.adoc#cli-command-reference[OpenShift CLI command reference].
