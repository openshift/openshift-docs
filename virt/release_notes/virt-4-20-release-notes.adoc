...
// CNV-62056
* With this update, the {product-title} web console displays reports of read and write latency metrics in the *Top Consumers* pane of the Virtualization interface and in the *VM metrics* tab. This makes it possible to evaluate your storage performance in more detail, identify bottlenecks, and optimize workloads accordingly.
