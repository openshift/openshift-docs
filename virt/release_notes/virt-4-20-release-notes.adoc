...
//CNV-61637
* You can now use golden images in heterogeneous clusters. This feature is currently in Technology Preview. For more information, see Heterogeneous cluster support.
