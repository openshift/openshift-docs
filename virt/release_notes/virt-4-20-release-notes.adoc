...
//CNV-69039
* {SMProductName} 3.1.0 and Istio versions 1.25 and later are incompatible with {VirtProductName} {VirtVersion} because the annotation `traffic.sidecar.istio.io/kubevirtInterfaces` is deprecated. (link:https://issues.redhat.com/browse/CNV-64852[*CNV-64852*])
