...
//CNV-61637
* You can now use golden images in heterogeneous clusters. This feature is currently in Technology Preview. For more information, see xref:../../virt/creating_vms_advanced/creating_vms_advanced_web/virt-golden-image-heterogeneous-clusters[Heterogeneous cluster support].
...
//CNV-62357
* Golden image support for heterogeneous clusters is xref:../../virt/creating_vms_advanced/creating_vms_advanced_web/virt-golden-image-heterogeneous-clusters[now available].
