...
* In this release, the *InstanceTypes* tab of the *Create new VirtualMachine* page displays options for xref:../../virt/creating_vm/virt-creating-vms-from-instance-types.adoc#virt-creating-vm-instancetype_virt-creating-vms-from-instance-types[selecting huge pages].. These options appear in the *M* and *CX* series of InstanceTypes. They are accessible both in the *Select InstanceType* cards and in the *Default InstanceType* menu of the *Add volume* dialog box.
