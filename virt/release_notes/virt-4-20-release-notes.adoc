...
* In this release, the *InstanceTypes* tab of the *Create new VirtualMachine* page displays options for xref:../../modules/virt-creating-vm-instancetype.adoc#virt-creating-vm-instancetype[selecting huge pages]. These options appear in the *M* and *CX* series of InstanceTypes and are accessible both in the *Select InstanceType* cards and in the *Default InstanceType* menu of the *Add volume* dialog box.
