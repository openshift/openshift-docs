...
//CNV-59402
* You can now use the Border Gateway Protocol (BGP) to configure dynamic ingress and egress routing for VMs that are connected to primary user-defined networks. For more information, see xref:../../networking/advanced_networking/route_advertisements/about-route-advertisements.adoc#nw-routeadvertisements-about_about-route-advertisements[Advertise cluster network routes with Border Gateway Protocol].
