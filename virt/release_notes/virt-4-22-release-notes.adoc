...
Primary user-defined networks not supported for VMs on multi-architecture clusters::
{VirtProductName} does not support connecting VMs to primary user-defined networks on multi-architecture clusters where cluster nodes have different CPUs architectures. 
+
link:https://redhat.atlassian.net/browse/CNV-87506[CNV-87506]
