...
* You can now install and edit xref:../../virt/virtual_machines/virt-create-vms.adoc#virt-creating-vm-instancetype_virt-create-vms[customized instance types] and preferences to create a VM from a volume or PersistentVolumeClaim (PVC).
