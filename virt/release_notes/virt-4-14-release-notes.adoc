...
//CNV-29935
* As a VM owner, you can add an xref:../../virt/virtual_machines/virt-accessing-vm-ssh.adoc#adding-static-public-key-project-web_virt-accessing-vm-ssh[authorized SSH key] to a project by using the web console. The key is subsequently added to all VMs that you create in the project.
