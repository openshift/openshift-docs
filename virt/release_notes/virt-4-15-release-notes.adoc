...
//CNV-66487
* To avoid known issues with newer versions of {VirtProductName} 4.15, customers can remain on {pipelines-shortname} 1.18. Before upgrading to {pipelines-shortname} 1.19, ensure that the feature gate `deployTektonTaskResources` is set to `false`. (link:https://issues.redhat.com/browse/CNV-66487[*CNV-66487*])
