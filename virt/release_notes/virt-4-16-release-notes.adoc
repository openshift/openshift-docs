...
* Red Hat Enterprise Linux CoreOS workers. In the Microsoft SVVP Catalog, they are named __Red{nbsp}Hat {product-title} 4.16__.
* Intel and AMD CPUs.
...
** As a workaround, link:https://docs.redhat.com/en/documentation/monitoring_stack_for_red_hat_openshift/4.16/html/managing_alerts/managing-alerts-as-an-administrator#managing-silences_managing-alerts-as-an-administrator[silence alerts].
