...
* You can now select `sysprep` options while you create a Windows VM from an instance type. Previously it was necessary to set the options by customizing the VM after its creation.
>>>>>>> 1a6f7e5fcb (CNV-37545)
