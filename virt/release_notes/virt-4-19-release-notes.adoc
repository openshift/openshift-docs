...
* The `OperatorConditionsUnhealthy` alert is deprecated. You can safely link:https://docs.redhat.com/en/documentation/monitoring_stack_for_red_hat_openshift/4.19/html/managing_alerts/managing-alerts-as-an-administrator#silencing-alerts_managing-alerts-as-an-administrator[silence] it.
