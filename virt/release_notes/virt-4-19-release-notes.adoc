...
* You can now xref:../../virt/managing_vms/virt-edit-vms.adoc#virt-updating-multiple-vms_virt-edit-vms[update multiple virtual machines (VMs) at the same time] from the {product-title} `oc` CLI.
