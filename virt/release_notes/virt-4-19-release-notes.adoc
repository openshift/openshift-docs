...
// CNV-55958:
* On the *VirtualMachines* page, you can now navigate between your VMs by using the tree view. You can use this tree view to filter projects with VMs, drag and drop VMs to other projects, or control the state of all VMs in the project.
