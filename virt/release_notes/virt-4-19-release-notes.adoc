...
//CNV-58007
* Red Hat Enterprise Linux 10 is added as a certified guest operating system. For a complete list of supported guest operating systems, see link:https://access.redhat.com/articles/4234591[Certified Guest Operating Systems in OpenShift Virtualization].
