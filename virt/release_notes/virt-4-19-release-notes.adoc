...
//CNV-69040
* {SMProductName} 3.1.0 is incompatible with {VirtProductName} {VirtVersion}.
** As a workaround, when installing {SMProductShortName} for integration with {VirtProductName}, select version 3.0.4 instead of the default version that is displayed in the web console.
