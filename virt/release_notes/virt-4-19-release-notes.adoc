...
// CNV-56843:
* On the *VirtualMachines* page, you can now see the summary of CPU, memory, and storage usage by your VMs. To restrict this summary to VMs in a specific project, select the project name in the tree view.
