...
* You can prevent the inadvertent deletion of a virtual machine (VM) by enabling delete protection for the VM. Should you change your mind, you can easily disable delete protection for the VM.
+
You enable or disable delete protection from either xref:../../virt/managing_vms/virt-enabling-disabling-vm-delete-protection.adoc#virt-enabling-disabling-vm-delete-protection-cli_virt-enabling-disabling-vm-delete-protection[the command line] or the VM’s VirtualMachine details page in the xref:../../virt/managing_vms/virt-enabling-disabling-vm-delete-protection.adoc#virt-enabling-disabling-vm-delete-protection-web_virt-enabling-disabling-vm-delete-protection[OpenShift Container Platform web console]. The option is disabled by default.
