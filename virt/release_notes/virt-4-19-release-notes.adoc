...
//CNV-55965
* You can now  xref:../../virt/managing_vms/virt-controlling-vm-states.adoc#virt-controlling-vm-states[control the states of VMs] from the tree view by right-clicking the VM and selecting the desired action from a pop-up menu. The following actions are available:
** Start
** Stop
** Restart
** Pause
** Unpause
** Change the state of all VMs in the selected project
