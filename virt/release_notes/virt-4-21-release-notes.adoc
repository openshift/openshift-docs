...
[id="virt-4-21-ki-installation-update_{context}"]
=== Installation and update

//CNV-75837
* When upgrading from {VirtProductName} 4.20 to 4.21, you must remove the `KubeletConfig` component before initating the upgrade. For more information about removing the `wasp-agent` component, see xref:../../virt/post_installation_configuration/virt-configuring-higher-vm-workload-density.adoc[Removing the KubeletConfig component].
