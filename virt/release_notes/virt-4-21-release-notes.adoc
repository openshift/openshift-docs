...
Ephemeral hotplug disks are deprecated::

Ephermeral hotplug disks, which provide the capability of adding additional storage without restarting your VM, is deprecated and will be removed in a future release. You can use `DeclarativeHotplugVolumes` for this purpose instead.
