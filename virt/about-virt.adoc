...
In the meantime, the link:https://docs.openshift.com/container-platform/4.10/virt/about-virt.html[{VirtProductName} 4.10 documentation] is available as part of the {product-title} 4.10 documentation.
...
// Compliance Operator integration (TP) is targeted for 4.11
