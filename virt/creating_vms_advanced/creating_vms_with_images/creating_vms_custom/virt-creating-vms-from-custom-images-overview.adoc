...
* xref:../../../virt/creating_vms_cli/virt-creating-vms-from-container-disks.adoc#virt-creating-vms-from-container-disks[Importing the image as a container disk from a registry].
+
...
* xref:../../../virt/creating_vms_with_images/creating_vms_third_party/virt-creating-vms-from-web-images.adoc#virt-creating-vms-from-web-images[Importing the image from a web page].
* xref:../../../virt/creating_vms_with_images/creating_vms_third_party/virt-creating-vms-uploading-images.adoc#virt-creating-vms-uploading-images[Uploading the image from a local machine].
* xref:../../../virt/creating_vms_cli/virt-creating-vms-by-cloning-pvcs.adoc#virt-creating-vms-by-cloning-pvcs[Cloning a persistent volume claim (PVC) that contains the image].
