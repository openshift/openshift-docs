...
* xref:../../../modules/virt-golden-images-namespace-web.adoc#virt-golden-images-namespace-web[Configuring a custom namespace for golden images by using the web console]

* xref:../../../modules/virt-golden-images-namespace-cli.adoc#virt-golden-images-namespace-cli[Configuring a custom namespace for golden images by using the CLI]

* xref:../../../virt/storage/virt-automatic-bootsource-updates.adoc#managing-rh-boot-source-updates_virt-automatic-bootsource-updates[Managing Red Hat boot source updates]


* xref:../../../virt/storage/virt-automatic-bootsource-updates.adoc#managing-rh-boot-source-updates_virt-automatic-bootsource-updates[Managing Red Hat boot source updates]

* xref:../../../virt/about_virt/about-virt.adoc#about-virt[Web console]
