...
//* xref:../../../virt/creating_vms_advanced/creating_vms_advanced_web/virt-creating-vms-from-rh-images-overview.adoc#virt-about-golden-images_virt-golden-images-namespace-web[Configuring a custom namespace for golden images by using the web console]
//* xref:../../../virt/creating_vms_advanced/creating_vms_advanced_web/virt-creating-vms-from-rh-images-overview.adoc#virt-about-golden-images_virt-golden-images-namespace-cli[Configuring a custom namespace for golden images by using the CLI]
