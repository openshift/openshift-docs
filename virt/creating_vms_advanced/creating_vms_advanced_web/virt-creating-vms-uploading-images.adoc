...
* xref:../../../virt/creating_vms_advanced/creating_vms_cli/virt-creating-vms-by-cloning-pvcs.adoc#virt-cloning-pvc-to-dv-cli_virt-creating-vms-by-cloning-pvcs[Cloning a PVC to a data volume]
