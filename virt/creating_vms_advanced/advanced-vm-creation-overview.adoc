...
[role="_abstract"]
To easily view all supported configuration options and simplify provisioning, you can use the web console to create virtual machines (VMs) from Red Hat images, templates, instance types, or cloned persistent volume claims (PVCs).
...
[role="_abstract"]
To configure VMs for automation or advanced workflows, you can use the virtctl command line (CLI) to create or edit a VirtualMachine manifest.
