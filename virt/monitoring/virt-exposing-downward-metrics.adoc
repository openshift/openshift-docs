...
[NOTE]
====
On {op-system-base-full} ({op-system-base}) 9, use the command line to view downward metrics.

The `vm-dump-metrics` tool is not supported on the {op-system-base-full} ({op-system-base}) 9 platform.
====
