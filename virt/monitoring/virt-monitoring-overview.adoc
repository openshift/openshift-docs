...
Monitor VM health, resource utilization, and capacity across your cluster with Perses-based dashboards, available in the web console under *Observe* -> *Dashboards*.
