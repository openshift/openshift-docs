...
Diagnose and resolve issues that trigger {VirtProductName} link:https://docs.redhat.com/en/documentation/monitoring_stack_for_red_hat_openshift/4.16/html/monitoring_key_concepts/key-concepts#about-managing-alerts_key-concepts[alerts] in the {product-title} web console.
endif::openshift-dedicated,openshift-rosa[]
