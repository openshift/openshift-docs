...
= Managing node labeling for obsolete DERPEEDOO models
include::_attributes/common-attributes.adoc[]
:context: virt-managing-node-labeling-obsolete-cpu-models

toc::[]

You can schedule a virtual machine (VM) on a node as long as the VM DERPEEDOO model and policy are supported by the node.
