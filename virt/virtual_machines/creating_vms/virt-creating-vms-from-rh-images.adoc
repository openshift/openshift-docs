...
= Creating virtual machines from Red Hat data sources
...
You can create virtual machines (VMs) from the following Red Hat data sources:

* Templates
* Instance types
* `VirtualMachine` manifests
...
== About creating VMs from templates
...
* See xref:../../../virt/virtual_machines/creating_vms/virt-creating-vms-from-rh-data-sources.adoc#virt-vm-storage-volume-types_virt-creating-vms-from-rh-data-sources[storage volume types] and xref:../../../virt/virtual_machines/creating_vms/virt-creating-vms-from-rh-data-sources.adoc#virt-storage-wizard-fields-web_virt-creating-vms-from-rh-data-sources[storage fields] for details about disk source settings.
