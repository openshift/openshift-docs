...
* xref:../../virt/virtual_machines/advanced_vm_management/virt-using-containerdisk-volumes.adoc#virt-using-containerdisk-volumes[Prepare a container disk] before adding it to a virtual machine as a containerDisk volume. 
