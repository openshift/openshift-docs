...
[IMPORTANT]
====
Cloning of virtual machines (VMs) with a vTPM device or creating snapshots of such VMs is not supported. Support for creating snapshots of VMs with vTPM devices has been added in {VirtProductName} 4.18.
====
