...
[NOTE]
====
If you installed your cluster by using xref:../../installing/installing_bare_metal/installing_bare_metal_ipi/ipi-install-overview.adoc#ipi-install-overview[installer-provisioned infrastructure] and you properly configured machine health checks:
