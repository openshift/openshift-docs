...
To configure storage class defaults, use storage profiles. For more information, see xref:../../virt/storage/virt-creating-data-volumes.adoc#virt-customizing-storage-profile_virt-creating-data-volumes[Customizing the storage profile].
