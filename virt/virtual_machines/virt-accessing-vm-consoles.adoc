...
[id="additional-resources_virt-accessing-vm-consoles"]
== Additional resources

* xref:../../virt/about_virt/virt-architecture#virt-about-ssp-operator_virt-architecture[About the Scheduling, Scale, and Performance (SSP) Operator]