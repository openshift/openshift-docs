...
The {pipelines-shortname} tasks and example pipeline allow you to do the following:
...
The tasks are located in link:https://artifacthub.io/packages/search?repo=redhat-tekton-tasks&sort=relevance&page=1[the task catalog].

The example Windows pipeline is located in link:https://artifacthub.io/packages/tekton-pipeline/redhat-pipelines/windows-efi-installer[the pipeline catalog].
