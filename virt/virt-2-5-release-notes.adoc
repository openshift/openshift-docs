...
* When you xref:../virt/install/installing-virt-web.adoc#installing-virt-web[install] or xref:../virt/upgrading-virt.adoc#virt-about-upgrading-virt_upgrading-virt[upgrade] {VirtProductName}, you select an *Update Channel*. There is a new *Update Channel* option that is named *stable*. Select the *stable* channel to ensure that you install or upgrade to the version of {VirtProductName} that is compatible with your {product-title} version.
