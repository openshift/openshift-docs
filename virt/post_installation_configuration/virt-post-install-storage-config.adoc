...
[id="configuring-local-storage-hpp_{context}"]
...
* xref:../../storage/dynamic-provisioning.adoc#defining-storage-classes_dynamic-provisioning[Defining a storage class]
