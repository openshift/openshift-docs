...
include::modules/virt-configuring-node-placement-ibm-z.adoc[leveloffset=+1]
...
* xref:../../hardware_enablement/psap-node-feature-discovery-operator.adoc#installing-the-node-feature-discovery-operator_psap-node-feature-discovery-operator[Installing the Node Feature Discovery Operator]
