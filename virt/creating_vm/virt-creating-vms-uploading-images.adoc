...
* xref:../../virt/creating_vm/virt-cloning-vms.adoc#virt-cloning-vms[Cloning VMs]
* xref:../../virt/creating_vm/virt-creating-vms-by-cloning-pvcs.adoc#virt-cloning-pvc-to-dv-cli_virt-creating-vms-by-cloning-pvcs[Cloning a PVC to a data volume]
