...
You can use the {product-title} web console or the CLI to change the instance type for an existing VM.
...
include::modules/virt-change-controller-revision-latest-version.adoc[leveloffset=+1]
