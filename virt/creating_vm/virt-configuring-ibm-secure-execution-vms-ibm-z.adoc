...
include::modules/virt-creating-ibm-secure-execution-vm-tekton-pipeline-ibm-z.adoc[leveloffset=+1]

[role="_additional-resources"]
[id="additional-resources_{context}"]
== Additional resources
* link:https://www.ibm.com/docs/en/linux-on-systems?topic=execution-introduction[What is IBM Secure Execution?]
* link:https://docs.redhat.com/en/documentation/red_hat_openshift_pipelines/latest/html-single/about_openshift_pipelines/index#understanding-openshift-pipelines[Understanding {pipelines-title}]
