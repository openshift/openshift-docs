...
* xref:../../networking/multiple_networks/primary_networks/about-primary-nwt-nad.adoc#configuration-additional-network-attachment_understanding-multiple-networks[Configuration for an additional network attachment]
endif::openshift-rosa,openshift-dedicated[]