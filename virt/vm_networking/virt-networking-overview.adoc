...
[role="_abstract"]
Configure the default pod network so that your virtual machines connect reliably and use the standard OpenShift networking model across your cluster.
...
[role="_abstract"]
Configure a primary user-defined network to give your virtual machines isolated, flexible traffic paths and support multi-namespace connectivity for your workloads.
