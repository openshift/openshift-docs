...
[IMPORTANT]
====
The following features are not supported on {product-rosa}, {azure-first}, {product-dedicated}, {gcp-first}, and {oci-first}:
...
ifndef::openshift-rosa,openshift-dedicated,openshift-rosa-hcp[]
* xref:../../virt/vm_networking/virt-connecting-vm-to-physical-network-ovs-bridge.adoc#virt-connecting-vm-to-physical-network-ovs-bridge[Connect a VM to the physical network by using an Open vSwitch bridge]
