...
[role="_abstract"]
To ensure that your virtual machines (VMs) connect reliably and use the standard OpenShift networking model across your cluster, configure the default pod network.
...
[role="_abstract"]
To give your virtual machines isolated, flexible traffic paths and support multi-namespace connectivity for your workloads, configure a primary user-defined network.
