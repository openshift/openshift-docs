...
[role="_abstract"]
To ensure your virtual machines connect reliably using the standard OpenShift networking model, configure the default pod network for cluster-wide connectivity.
