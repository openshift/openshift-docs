...
* xref:../../virt/vm_networking/virt-connecting-vm-to-physical-network-ovs-bridge.adoc#virt-connecting-vm-to-physical-network-ovs-bridge[Connecting a virtual machine to a secondary localnet user-defined network]
