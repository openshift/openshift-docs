...
//BZ-2054650
* The web console does not display templates that are deployed to a custom namespace. Only templates deployed to the default namespace will display in the web console. (link:https://bugzilla.redhat.com/show_bug.cgi?id=2056623[*BZ#2054650*])
+
** As a workaround, avoid deploying templates to a custom namespace. To use templates from the web console, deploy templates to the default namespace.
