...
[id="using_ansible"]
== Using Ansible
To use the Ansible collection for Openshift Virtualization, see link:https://console.redhat.com/ansible/automation-hub/repo/published/redhat/openshift_virtualization[Red Hat Ansible Automation Hub].
