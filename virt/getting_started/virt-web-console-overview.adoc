...
|*Add volume* button
|Click to upload a new volume, use an existing persistent volume claim, or use an existing volume snapshot.
...
You can create a snapshot, create a copy of a virtual machine from a snapshot, restore a snapshot as a new PVC, edit labels or annotations, and edit or delete volume snapshots on the *Snapshots* tab.
...
Click the actions menu {kebab} beside a snapshot to select *Create VirtualMachine*, *Restore as a new PVC*, *Edit labels*, *Edit annotations*, *Edit VolumeSnapshot* or *Delete VolumeSnapshot*.
|====
=====
