...
|Number of virtual machines created from templates, grouped by template name.
|====
=====
...
The *Cluster* tab displays the {VirtProductName} version and update status. You configure live migration, template project, preview features, and load balancer service settings on the *Cluster* tab.
...
|InstanceType tiles
|Select an instance type for your virtual machine.
...
Click the actions menu {kebab} beside a virtual machine to select *Stop*, *Restart*, *Pause*, *Clone*, *Migrate*, *Copy SSH command*, *Edit labels*, *Edit annotations*, or *Delete*.
...
|*YAML* switch
|Set to *ON* to view your live changes in the YAML configuration file. The switch is displayed when you click the *Details* or *Configuration* tab.
...
|Cloud-init settings, authorized SSH key for Linux virtual machines, Sysprep settings for Windows virtual machines.
...
You manage cloud-init settings, authorized SSH keys for Linux virtual machines, or Sysprep for Windows virtual machines on the *Scripts* tab.
...
You open a console session to the virtual machine on the *Console* tab.
...
You create, edit, and clone virtual machine templates on the *Templates* page.
...
[id="bootablevolumes-details-page_virt-web-console-overview"]
=== Bootable volume details page

You configure a bootable volume on the *Bootable volume details* page.
...
|*Details* tab
|Configure the data source of a bootable volume by editing a form.

|*YAML* tab
|Configure the data source of a bootable volume by editing a YAML configuration file.

|*Actions* menu
|Select *Edit labels*, *Edit annotations*, *Delete*, or *Manage source*.

*Manage source* is disabled for Red Hat data sources.
|====
=====

[id="bootablevolume-details-details_virt-web-console-overview"]
==== Details tab

You configure the data source of the bootable volume by editing a form on the *Details* tab.
...
|*Namespace*
|Data source namespace. The default project is *openshift-virtualization-os-images*.

|*DataImportCron*
|The `DataImportCron` polls disk images and imports them as persistent volume claims.
...
|*Conditions* table
|Displays the status of the data source.
|====
=====

[id="bootablevolume-details-yaml_virt-web-console-overview"]
==== YAML tab

You configure the data source of the bootable volume by editing the YAML file on the *YAML* tab.
