...
[id="datasource-details-page_virt-web-console-overview"]
=== DataSource details page

You configure a bootable volume on the *DataSource details* page.
...
[id="datasource-details-details_virt-web-console-overview"]
==== Details tab
...
[id="datasource-details-yaml_virt-web-console-overview"]
==== YAML tab
