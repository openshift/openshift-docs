...
* xref:../../virt/virtual_machines/virt-creating-vms.adoc#virt-creating-vm-from-template_virt-creating-vms[Create a VM from a template].
* xref:../../virt/virtual_machines/virt-creating-vms.adoc#virt-creating-vm-instancetype_virt-creating-vms[Create a VM from an instance type].
* xref:../../virt/virtual_machines/virt-creating-vms.adoc#virt-creating-vm-cli_virt-creating-vms[Create a VM from the command line].
