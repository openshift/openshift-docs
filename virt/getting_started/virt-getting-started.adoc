...
* xref:../../virt/creating_vm/virt-creating-vms-web.adoc#virt-creating-vms-web[Create a VM by using the web console]
* xref:../../virt/creating_vm/virt-creating-vms-from-cli.adoc#virt-creating-vm-web-page-cli_virt-creating-vms-cli[Import a custom image from a web page]
* xref:../../virt/creating_vm/virt-creating-vms-from-cli.adoc#virt-uploading-image-virtctl_virt-creating-vms-cli[Upload an image from your local machine]
* xref:../../virt/creating_vm/virt-creating-vms-from-cli.adoc#virt-creating-vm-by-cloning-pvcs-cli_virt-creating-vms-cli[Clone a persistent volume claim (PVC)]
ifndef::openshift-rosa,openshift-dedicated,openshift-rosa-hcp[]
