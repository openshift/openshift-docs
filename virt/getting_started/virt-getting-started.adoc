...
* xref:../../virt/post_installation_configuration/virt-post-install-storage-config.adoc#configuring-local-storage-hpp[Configuring local storage by using a hostpath provisioner].
...
* xref:../../virt/virtual_machines/creating_vms/virt-creating-vms-from-rh-data-sources.adoc#virt-creating-vm-from-template_virt-creating-vms-from-rh-data-sources[Create a VM from a template].
* xref:../../virt/virtual_machines/creating_vms/virt-creating-vms-from-rh-data-sources.adoc#virt-creating-vm-instancetype_virt-creating-vms-from-rh-data-sources[Create a VM from an instance type].
