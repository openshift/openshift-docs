...
Alternatively, you can use the xref:../../virt/getting_started/modules/virt-vm-export-commands.adoc#vm-export-commands_virt-using-the-cli-tools[`virtctl vmexport` command] to create a `VirtualMachineExport` CR and to download exported volumes.
