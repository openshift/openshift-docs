...
include::modules/virt-enabling-persistentreservation.adoc[leveloffset=+1]

include::modules/virt-enabling-persistentreservation-web.adoc[leveloffset=+2]

include::modules/virt-enabling-persistentreservation-cli.adoc[leveloffset=+2]
