...
You enable or disable delete protection from either the the command line or the VM's *VirtualMachine details* page in the {product-title} web console. The option is disabled by default.
