...
include::modules/virt-enabling-vm-delete-protection-web.adoc[leveloffset=+1]
include::modules/virt-disabling-vm-delete-protection-web.adoc[leveloffset=+1]

include::modules/virt-enabling-vm-delete-protection-cli.adoc[leveloffset=+1]
include::modules/virt-disabling-vm-delete-protection-cli.adoc[leveloffset=+1]