...
* OpenShift Virtualuzation has been installed on your OpenShift cluster. For instructions, see xref:../../../virt/install/preparing-cluster-for-virt.adoc#preparing-cluster-for-virt[Installing OpenShift Virtualization].
