...
* link:https://docs.github.com/en/get-started/start-your-journey/creating-an-account-on-github[Creating an account on GitHub]
* xref:../../../virt/install/installing-virt.adoc#installing-virt[OpenShift Virtualization installation]
* link:https://docs.openshift.com/gitops/1.15/installing_gitops/preparing-gitops-install.html[Installing GitOps]
* link:https://developers.redhat.com/learning/learn:manage-openshift-virtual-machines-gitops/resource/resources:connect-and-configure-external-repository-argo-cd-virtual-machines[the _Manage OpenShift virtual machines with GitOps_ learning path]
