...
* xref:../../../virt/nodes/virt/nodes/virt-node-maintenance.adoc#virt-delete-failed-node-vm-failover_virt-node-maintenance[Delete a failed node to trigger virtual machine failover]
