...
+
If you run Windows VMs, you might need to perform link:https://access.redhat.com/articles/6978371[Optimizing ODF PersistentVolumes for Windows VMs] to improve their performance.zing ODF PersistentVolumes for Windows VMs] for details.
