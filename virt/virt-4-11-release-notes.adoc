...
*  Administrators can now create copy of a template from their own namespace to the {product-title} common namespace. The copy of the shared template is a standalone template and does not change if the original template is modified.
