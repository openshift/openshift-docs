...
* xref:../../edge_computing/policygenerator_for_ztp/ztp-advanced-policygenerator-config.adoc#ztp-adding-new-content-to-gitops-ztp_ztp-advanced-policygenerator-config[Adding custom content to the {ztp} pipeline]
