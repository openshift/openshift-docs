...
* xref:../../disconnected/oc_mirror_v2/about-installing-oc-mirror-v2.adoc#oc-mirror-building-image-set-config-v2_about-installing-oc-mirror-v2[Creating the image set configuration]
* xref:../../disconnected/oc_mirror_v2/about-installing-oc-mirror-v2.adoc#using-oc-mirror_about-installing-oc-mirror-v2[Mirroring an image set to a mirror registry]
