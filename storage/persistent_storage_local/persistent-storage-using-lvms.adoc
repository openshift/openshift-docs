...
include::modules/static-mode-enforcement.adoc[leveloffset=+2]

include::modules/validation-rules-for-device-discovery-policy.adoc[leveloffset=+2]

include::modules/lvm-cluster-custom-resource-examples.adoc[leveloffset=+2]

include::modules/lvm-cluster-custom-resource-status-reporting.adoc[leveloffset=+2]
...
// Software RAID configuration support in LVMS

include::modules/lvms-about-software-raid.adoc[leveloffset=+1]

include::modules/lvms-raid-configuration-parameters.adoc[leveloffset=+2]

include::modules/lvms-configuring-software-raid-array.adoc[leveloffset=+2]

include::modules/lvms-replacing-failed-disk-raid-array.adoc[leveloffset=+2]

include::modules/lvms-software-raid-limitations.adoc[leveloffset=+2]


include::modules/storageclass-customization-for-lvms-device-classes.adoc[leveloffset=+1]

include::modules/storageclass-options.adoc[leveloffset=+2]

include::modules/updating-lvm-cluster-labels.adoc[leveloffset=+2]

include::modules/sample-lvm-cluster-configuration-with-storage-class-option.adoc[leveloffset=+2]

include::modules/immutable-fields-of-the-storage-class-options.adoc[leveloffset=+2]

include::modules/behaviors-not-controlled-by-storage-class-options.adoc[leveloffset=+2]
