...
* link:https://github.com/container-storage-interface/spec[CSI spec]
...
[role="_additional-resources"]
.Additional resources
* xref:../../storage/container_storage_interface/persistent-storage-csi-aws-efs.adoc#persistent-storage-efs-csi-driver-operator-setup_persistent-storage-csi-aws-efs[Setting up the AWS EFS CSI Driver Operator]
