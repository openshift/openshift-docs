...
For information about installing with user-managed encryption for IBM VPC, see xref:../../installing/installing_ibm_cloud/user-managed-encryption-ibm-cloud.adoc[User-managed encryption for IBM Cloud] and xref:../../installing/installing_ibm_cloud/preparing-to-install-on-ibm-cloud.adoc[Preparing to install on IBM Cloud].
