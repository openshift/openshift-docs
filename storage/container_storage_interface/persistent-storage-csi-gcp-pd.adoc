...
include::modules/persistent-storage-csi-gcp-hyperdisk-storage-pools.adoc[leveloffset=+2]

ifndef::openshift-dedicated[]
include::modules/persistent-storage-csi-gcp-hyperdisk-create-sc-during-install.adoc[leveloffset=+2]
