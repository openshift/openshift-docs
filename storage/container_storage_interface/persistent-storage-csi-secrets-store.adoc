...
[NOTE]
====
{secrets-store-driver} now supports the disconnected environment. For more information, see xref:../../disconnected/about.adoc#about[About disconnected environments]
====
