...
* xref:../../installing/installing_vsphere/upi/installing-vsphere.adoc#installation-vsphere-machines_installing-vsphere[During installation: Step 7 of Installing {op-system} and starting the {product-title} bootstrap process]
...
* link:https://techdocs.broadcom.com/us/en/vmware-cis/vsphere/vsphere/8-0.html[For vSphere v8.0]

* link:https://techdocs.broadcom.com/us/en/vmware-cis/vcf.html[For VCF 9]
