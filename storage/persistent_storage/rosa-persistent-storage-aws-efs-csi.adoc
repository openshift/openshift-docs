...
* link:link:https://access.redhat.com/documentation/en-us/openshift_container_platform/4.12/html-single/authentication_and_authorization/index#sts-mode-about[About manual mode with AWS Security Token Service]
