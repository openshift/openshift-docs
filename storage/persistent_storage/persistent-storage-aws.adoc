...
By default, newly created clusters by using {product-title} version 4.10 and later use gp3 storage and the AWS EBS CSI driver.
...
* link:https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/concepts.html[Amazon EC2 documentation]
* link:https://github.com/openshift/aws-ebs-csi-driver[AWS EBS CSI driver]
ifndef::openshift-rosa,openshift-rosa-hcp,openshift-dedicated[]
