...
[role="_abstract"]
You can provision your {product-title} cluster with persistent storage by using Fibre Channel volumes for workloads that require high-speed, reliable block-level storage.
