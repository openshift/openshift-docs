...
Dynamically provisioning VMware vSphere volumes is the recommended method. {product-title} {product-version} supports VMDK dynamic provisioning using VMware vSphere 6.5, vSphere 6.7 Update 2, or later.
