...
* You have installed xref:../install/install-openshift-pipelines.adoc#installing-pipelines_install-openshift-pipelines[Install the {pipelines-shortname} Operator] by using the {pipelines-title} Operator listed in the OpenShift OperatorHub. After you install it, it is applicable to the entire cluster.
* You have installed xref:../install/install-openshift-pipelines.adoc#installing-tkn_install-openshift-pipelines[{pipelines-shortname} CLI].
