...
[NOTE]
====
There are two ways to install Jaeger, as part of a service mesh or as a stand alone component. If you have installed Jaeger as part of Red Hat OpenShift Service Mesh, you must configure and deploy Jaeger as part of the xref:../../service_mesh/v1x/customizing-installation-ossm.adoc#customizing-installation-ossm-v1x[ServiceMeshControlPlane].
====
