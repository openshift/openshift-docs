...
[role="_abstract"]
You can delete Operators that were previously installed with Operator Lifecycle Manager (OLM) on your {product-title} cluster.
...
* xref:../../operators/admin/olm-troubleshooting-operator-issues.adoc#olm-reinstall_olm-troubleshooting-operator-issues[Reinstalling Operators after failed uninstallation]
endif::openshift-dedicated,openshift-rosa,openshift-rosa-hcp[]
