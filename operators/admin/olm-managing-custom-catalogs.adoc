...
ifndef::openshift-dedicated,openshift-rosa,openshift-rosa-hcp[]
For more information about working with file-based catalogs, see the Operator Framework packaging format and Mirroring images for a disconnected installation using the oc-mirror plugin documentation.
endif::openshift-dedicated,openshift-rosa,openshift-rosa-hcp[]
ifdef::openshift-dedicated,openshift-rosa,openshift-rosa-hcp[]
For more information about working with file-based catalogs, see the Operator Framework packaging format documentation.
endif::openshift-dedicated,openshift-rosa,openshift-rosa-hcp[]
====
