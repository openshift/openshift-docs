...
* xref:../../installing/installing-mirroring-installation-images.adoc#installing-mirroring-installation-images[Creating a mirror registry for installation in a restricted network]
