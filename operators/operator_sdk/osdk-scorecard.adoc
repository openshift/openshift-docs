...
* xref:../../operators/operator_sdk/osdk-getting-started.adoc#managing-memcached-operator-using-olm_osdk-getting-started[Managing a Go-based Operator using the Operator Lifecycle Manager]
