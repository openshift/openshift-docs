...
* xref:../../operators/operator_sdk/golang/osdk-golang-tutorial.html#osdk-bundle-deploy-olm_osdk-golang-tutorial[Bundling and deploying your Operator by using OLM]
