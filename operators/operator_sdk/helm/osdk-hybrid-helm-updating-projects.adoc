...
* link:https://docs.redhat.com/en/documentation/openshift_container_platform/4.15/html-single/operators/index#osdk-upgrading-projects_osdk-hybrid-helm-updating-projects[Upgrading projects for Operator SDK 1.31.0] ({product-title} 4.15)