...
* xref:../../operator_sdk/osdk-about.adoc#osdk-about[About the Operator SDK]
* xref:../../operator_sdk/osdk-generating-csvs.adoc#osdk-generating-csvs[Defining cluster service versions (CSVs)]
