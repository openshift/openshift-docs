...
ifndef::openshift-dedicated,openshift-rosa,openshift-rosa-hcp[]
* xref:../../disconnected/oc_mirror_v2/about-installing-oc-mirror-v2.adoc#installation-oc-mirror-installing-plugin_about-installing-oc-mirror-v2[Mirroring images for a disconnected installation by using the oc-mirror plugin v2]
