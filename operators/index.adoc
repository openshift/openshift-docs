...
ifdef::openshift-dedicated,openshift-rosa,openshift-rosa-hcp[]
** xref:../operators/admin/olm-adding-operators-to-cluster.adoc#olm-installing-operators-from-software-catalog_olm-adding-operators-to-a-cluster[Install an Operator from OperatorHub].
endif::openshift-dedicated,openshift-rosa,openshift-rosa-hcp[]
