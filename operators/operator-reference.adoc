...
* See xref:../architecture/control-plane.adoc#operators-overview_control-plane[Operators in {product-title}] for more details on the Cluster Version Operator (CVO).
