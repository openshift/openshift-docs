...
Shared device:: This method allows for an NVIDIA GPUDirect RDMA device to be shared among multiple pods on the OpenShift worker node where the device is exposed. 
