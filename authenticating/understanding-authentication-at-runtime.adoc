...
[role="_abstract"]
Developers building images need to configure authentication and use secrets to handle sensitive data safely within the build process. Role-based access control (RBAC) defined by cluster administrators governs the access to build resources.
