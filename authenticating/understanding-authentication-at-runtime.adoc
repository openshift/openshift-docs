...
[role="_abstract"]
Developers building images need to control authentication and use secrets to handle sensitive data safely within the build process. Role-based access control (RBAC) defined by cluster administrators governs the access to build resources.
