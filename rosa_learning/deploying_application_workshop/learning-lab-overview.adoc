...
* The xref:../../cli_reference/openshift_cli/getting-started-cli.adoc#cli-getting-started[OpenShift command line interface (CLI)]
...
[NOTE]
====
You must complete the ACK section of this workshop to see the "ACK S3" section of OSToy. If you do not complete that section, the OSToy application still functions.
====
+
