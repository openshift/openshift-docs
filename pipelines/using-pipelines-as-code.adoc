...
* link:https://docs.openshift.com/container-platform/latest/networking/enable-cluster-wide-proxy.html#nw-proxy-configure-object[Enabling the cluster-wide proxy]
...
* xref:../pipelines/installing-pipelines.adoc#installing-pipelines[Installing {pipelines-shortname}]

* link:https://docs.openshift.com/container-platform/latest/cli_reference/tkn_cli/installing-tkn.html#installing-tkn[Installing tkn]

* xref:../pipelines/op-release-notes.adoc#op-release-notes[{pipelines-title} release notes]
