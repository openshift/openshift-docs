...
* link:https://docs.openshift.com/container-platform/latest/nodes/clusters/nodes-cluster-limit-ranges.html#nodes-cluster-limit-ranges[Restrict resource consumption with limit ranges]
