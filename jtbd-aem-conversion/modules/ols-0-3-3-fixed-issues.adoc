...
[role="_abstract"]
{ols-official} 0.3.3 resolves an issue where the Operator failed to report errors when the API token key for the Large Language Model (LLM) provider was missing.
