...
[role="_abstract"]
{ols-official} 0.3.6 contains known issues regarding the disappearance of the user interface icon on {ocp-product-title} 4.17 and delays in applying quota parameter updates.
