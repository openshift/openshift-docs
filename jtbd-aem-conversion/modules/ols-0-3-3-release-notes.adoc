...
[role="_abstract"]
{ols-official} 0.3.3 is now generally available for {ocp-product-title} 4.15 and later.
...
[role="_abstract"]
{ols-official} 0.3.3 introduces local YAML file uploads for prompt context and a PostgreSQL database for conversation caching.
