...
[role="_abstract"]
{ols-official} 0.1.6 is now generally available for {ocp-product-title} 4.15 and later.
...
[role="_abstract"]
{ols-official} 0.1.6 introduces support for {ocp-ai-official} as an LLM provider and enables cluster monitoring by default during installation.
