...
= Creating the {ols-long} custom resource file by using the web console

[role="_abstract"]
Use the {ocp-product-title} web console to create the custom resource (CR) file required to deploy {ols-long}.
