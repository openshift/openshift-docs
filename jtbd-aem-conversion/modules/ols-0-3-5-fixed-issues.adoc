...
[role="_abstract"]
{ols-official} 0.3.5 resolves an issue where self-signed certificates with custom Certificate Authorities (CAs) could not be used to secure connections to self-hosted large language model (LLM) providers.
