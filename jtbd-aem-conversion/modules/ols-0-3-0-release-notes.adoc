...
[role="_abstract"]
{ols-official} 0.3.0 is now generally available for {ocp-product-title} 4.15 and later.
...
[role="_abstract"]
{ols-official} 0.3.0 enables the installation of the {ols-short} Operator in any namespace within the cluster.

The following enhancement is made with {ols-official} 0.3.0:
