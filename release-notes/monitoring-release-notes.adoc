...
For more information about monitoring updates, see link:https://docs.redhat.com/en/documentation/openshift_container_platform/4.17/html-single/release_notes/index#ocp-4-17-asynchronous-errata-updates_release-notes[Asynchronous errata updates].
