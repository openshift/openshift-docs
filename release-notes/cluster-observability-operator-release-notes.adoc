...
=== New features and enhancements
* With this release, the {coo-full} adds backend support for future {ocp-product-title} observability web console UI plugins and observability components.
...
=== New features and enhancements
* With this release, the {coo-full} supports installing and managing observability-related plugins for the {ocp-product-title} web console user interface (UI). (link:https://issues.redhat.com/browse/COO-58[*COO-58*])
