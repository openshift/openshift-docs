...
* xref:../rosa_getting_started/rosa-aws-private-link-creating-cluster.adoc#rosa-aws-privatelink-creating-cluster[Creating an AWS PrivateLink cluster on ROSA]
