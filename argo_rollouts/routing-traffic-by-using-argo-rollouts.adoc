...
* xref:../gitops_cli_argocd/configuring-argocd-gitops-cli.adoc#configuring-argocd-gitops-cli[Configure shell environment with productivity features]
* xref:../argo_rollouts/argo-rollouts-overview.adoc#gitops-argo-rollouts-cli-overview_argo-rollouts-overview[Argo Rollouts CLI capabilities and usage]
