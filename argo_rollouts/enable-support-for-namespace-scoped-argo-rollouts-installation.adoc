...
* xref:../argo_rollouts/using-cluster-scoped-rollouts-instance-to-manage-rollouts-resources.adoc#using-cluster-scoped-argo-rollouts-instance-to-manage-rollouts-resources[Cluster-scoped Argo Rollouts]
