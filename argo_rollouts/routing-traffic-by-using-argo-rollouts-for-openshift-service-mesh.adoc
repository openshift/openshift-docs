...
Argo Rollouts in {gitops-title} support various traffic management mechanisms such as xref:../argo_rollouts/routing-traffic-by-using-argo-rollouts.adoc#routing-traffic-by-using-argo-rollouts[OpenShift Routes] and Istio-based OpenShift Service Mesh. You can use OpenShift Service Mesh to split traffic between two application versions:
...
* xref:../argo_rollouts/routing-traffic-by-using-argo-rollouts.adoc#routing-traffic-by-using-argo-rollouts[Route traffic by using OpenShift Routes]
