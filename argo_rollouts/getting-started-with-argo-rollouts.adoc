...
* xref:../installing_gitops/uninstall-gitops-and-clean-up-cluster-resources.adoc#uninstall-gitops-and-clean-up-cluster-resources[Uninstall GitOps and clean up cluster resources]
