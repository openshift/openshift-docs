...
[IMPORTANT]
====
If you have not already updated your {es-op} as described in xref:../../logging/cluster-logging-upgrading.adoc#cluster-logging-upgrading_cluster-logging-upgrading[Updating Logging], complete that update before updating your {JaegerName} Operator.
====
...
* xref:../../logging/cluster-logging-upgrading.adoc#cluster-logging-upgrading_cluster-logging-upgrading[Updating Logging]
