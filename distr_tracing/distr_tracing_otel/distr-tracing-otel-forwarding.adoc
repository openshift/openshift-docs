...
For the following steps, we will deploy an OpenTelemetry collector using the recomended processors/receivers/exporters, this example will deploy the collector in deployment mode, for other modes see the OpenTelemetry collector documentation.
