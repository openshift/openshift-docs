...
This type of deployment is ideal for demo and test setups, for in-memory and Persistent Volume storage of traces (object storage is not required) and the recommended migration path of the {JaegerName} all-in-one deployment.
