...
* Support monitor tab in the Jaeger console.

[id="bug-fixes_tempo-release-notes_distributed-tracing-rn-3-0"]
=== Bug fixes

* The custom TLS CA option is not fully supported for connecting to object storage. (link:https://issues.redhat.com/browse/TRACING-3462[TRACING-3462])
