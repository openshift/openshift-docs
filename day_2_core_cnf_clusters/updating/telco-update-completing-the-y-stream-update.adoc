...
* xref:../../day_2_core_cnf_clusters/updating/telco-update-api.adoc#telco-update-selecting-the-target-release_telco-update-api[Selecting the target release]
...
* xref:../../day_2_core_cnf_clusters/updating/telco-update-completing-the-control-plane-only-update.adoc#telco-update-updating-the-worker-nodes_completing-the-update[Updating the worker nodes]
