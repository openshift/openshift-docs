...
include
xref:../cli_reference/basic_cli_operations.adoc#cli-reference-basic-cli-operations[the CLI] (the `oc` command) and
...
xref:developers/developers_console.adoc#getting-started-developers-developers-console[Getting Started for Developers: Web
Console].
