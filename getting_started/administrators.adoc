...
[NOTE]
====
If you want to use link:../install_config/aggregate_logging.html[OpenShift's
...
link:../getting_started/developers_console.html[Getting Started for Developers: Web
Console].
