...
----
+
. Set up an integrated container registry for the {product-title} cluster:
+
----
$ oc adm registry
----
...
----
+
which will summarize the build. When the build completes, the resulting container image will be pushed to the container registry.
