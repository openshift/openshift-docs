...
+
----
# touch /etc/origin/master/htpasswd <1>
# htpasswd -b /etc/origin/master/htpasswd admin redhat
----
<1> Specify the path to the httpd file in the identityProviders section of the *_/etc/origin/master/master-config.yaml_* file.
+
...
. Configure the *router* service account to allow access the host network:
+
----
oc adm policy add-scc-to-user hostnetwork -z router
scc "hostnetwork" added to: ["system:serviceaccount:logging:router"]
----
