...
link:../getting_started/basic_walkthrough.html[Basic Walkthrough] topic up and
running on {product-title} 3 Developer Preview.

[NOTE]
====
If you are unfamiliar with the core concepts of OpenShift version 3, you might
want to start by reading about
link:../getting_started/online_v2_vs_v3.html[what’s new]. This version of
...
following the link:../getting_started/basic_walkthrough.html[Basic Walkthrough]
topic.
====
...
=======
for your project, such as `<your_username>-example`:
>>>>>>> b222e91... Getting Started structure changes and other updates
+
----
...
[NOTE]
====
If you followed the link:../getting_started/basic_walkthrough.html[Basic
...
initial walkthrough of {product-title} 3 Developer Preview.

[[btb-developer-preview-considerations]]
=== Developer Preview Usage Considerations

Please review the link:../getting_started/devpreview_faq.html[Developer Preview
...
Similar to link:../getting_started/online_v2_vs_v3.html[OpenShift Online 2],
{product-title} 3 Developer Preview provides out of the box a set of
...
Check out the link:../dev_guide/new_app.html[Creating New Applications] topic
...
.^|link:../using_images/xpaas_images/jws.html[Java]
...
See link:../dev_guide/copy_files_to_container.html[Copying Files] for steps on
...
See link:../dev_guide/pod_autoscaling.html[Pod Autoscaling] for steps on
...
and link:../dev_guide/new_app.html[Creating New Applications] topics.
