...
Review some of the common tips and suggestions in https://github.com/openshift/origin/blob/master/docs/debugging-openshift.md[OpenShift Origin Troubleshooting].
