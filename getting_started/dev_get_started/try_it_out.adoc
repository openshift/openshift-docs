...
== Overview
After link:setup.html[setting up] and link:installation.html[installing] OpenShift, you can start creating applications on your instance by trying out the following example. Additional examples will be added to this section over time, such as creating an application using official Red Hat container images or any arbitrary Docker image.
