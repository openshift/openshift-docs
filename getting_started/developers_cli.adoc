...
<<<<<<< HEAD:getting_started/developers_cli.adoc

=======
>>>>>>> b222e91... Getting Started structure changes and other updates:getting_started/developers_cli.adoc
...
and link:../using_images/s2i_images/index.html[builder images]
that conform to the current
link:../getting_started/devpreview_considerations.html[set of considerations]
