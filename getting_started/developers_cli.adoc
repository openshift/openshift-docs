...
ifdef::openshift-online[]
- You must register for an account with the https://openshift.com[{product-title} 3 Developer Preview.]
...
considerations] for running in the {product-title} 3 Developer Preview
offering.
endif::[]
ifdef::openshift-enterprise,openshift-origin,openshift-dedicated[]
