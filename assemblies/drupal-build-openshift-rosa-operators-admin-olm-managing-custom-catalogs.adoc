...
and Operator catalog maintainers can create and manage custom catalogs packaged using the xref:olm-bundle-format_olm-packaging-format[bundle format] on Operator Lifecycle Manager (OLM) in {product-title}.
...
* You have installed the link:https://access.redhat.com/documentation/en-us/openshift_container_platform/4.16/html-single/cli_tools/#cli-opm-install[`opm` CLI].
...
ifndef::openshift-dedicated,openshift-rosa[]
For more information about working with file-based catalogs, see xref:olm-file-based-catalogs_olm-packaging-format[Operator Framework packaging format] and xref:../../installing/disconnected_install/installing-mirroring-disconnected.adoc#installing-mirroring-disconnected[Mirroring images for a disconnected installation using the oc-mirror plugin].
endif::openshift-dedicated,openshift-rosa[]
ifdef::openshift-dedicated,openshift-rosa[]
For more information about working with file-based catalogs, see xref:olm-file-based-catalogs_olm-packaging-format[Operator Framework packaging format].
endif::openshift-dedicated,openshift-rosa[]
====

include::../includes/olm-creating-fb-catalog-image.adoc[leveloffset=+2]
[role="_additional-resources"]
.Additional resources

* link:https://access.redhat.com/documentation/en-us/openshift_container_platform/4.16/html-single/cli_tools/#cli-opm-ref[`opm` CLI reference]

include::../includes/olm-filtering-fbc.adoc[leveloffset=+2]
ifndef::openshift-dedicated,openshift-rosa[]
[role="_additional-resources"]
.Additional resources
...
include::../includes/deprecated-feature.adoc[leveloffset=+1]

include::../includes/olm-creating-index-image.adoc[leveloffset=+2]
include::../includes/olm-updating-index-image.adoc[leveloffset=+2]
include::../includes/olm-pruning-index-image.adoc[leveloffset=+2]

include::../includes/olm-catalog-source-and-psa.adoc[leveloffset=+1]
...
include::../includes/olm-migrating-sqlite-catalog-to-fbc.adoc[leveloffset=+2]
...
include::../includes/olm-updating-sqlite-catalog-to-a-new-opm-version.adoc[leveloffset=+2]
include::../includes/olm-sqlite-catalog-configuring-elevated-permissions.adoc[leveloffset=+2]

include::../includes/olm-creating-catalog-from-index.adoc[leveloffset=+1]
...
ifdef::openshift-dedicated,openshift-rosa[]
include::../includes/sd-olm-removing-catalogs.adoc[leveloffset=+1]
endif::openshift-dedicated,openshift-rosa[]