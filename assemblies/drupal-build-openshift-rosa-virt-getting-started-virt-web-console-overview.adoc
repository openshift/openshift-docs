...
|xref:checkups-page_virt-web-console-overview[*Checkups* page]
...
|xref:overview-settings-preview_virt-web-console-overview[*Preview features* tab]
...
|xref:virtualmachine-details-details_virt-web-console-overview[*Configuration* -> *Details* tab]
|Configure the *VirtualMachine details* of the VM.

|xref:virtualmachine-details-storage_virt-web-console-overview[*Configuration* -> *Storage* tab]
|Configure the storage of the VM.

|xref:virtualmachine-details-network_virt-web-console-overview[*Configuration* -> *Network* tab]
...
|xref:virtualmachine-details-ssh_virt-web-console-overview[*Configuration* -> *SSH* tab]
|Configure the SSH settings of the VM.

|xref:virtualmachine-details-initial-run_virt-web-console-overview[*Configuration* -> *Initial run* tab]
|Configure the cloud-init settings for the VM, or the Sysprep settings if the VM is Windows.

|xref:virtualmachine-details-metadata_virt-web-console-overview[*Configuration* -> *Metadata* tab]
...
|xref:virtualmachine-details-events_virt-web-console-overview[*Console* tab]
...
|xref:virtualmachine-details-storage_virt-web-console-overview[*Storage* tab]
|Configure the storage of the VM.

|xref:virtualmachine-details-network_virt-web-console-overview[*Network* tab]
|Configure the network of the VM.

|xref:virtualmachine-details-scheduling_virt-web-console-overview[*Scheduling* tab]
|Configure the schedule of a VM to run on specific nodes.

|xref:virtualmachine-details-ssh_virt-web-console-overview[*SSH* tab]
|Configure the SSH settings of the VM.

|xref:virtualmachine-details-initial-run_virt-web-console-overview[*Initial run* tab]
|Configure the cloud-init settings for the VM, or the Sysprep settings if the VM is Windows.

|xref:virtualmachine-details-metadata_virt-web-console-overview[*Metadata* tab]
|Configure label and annotation metadata of the VM.
|====
=====
