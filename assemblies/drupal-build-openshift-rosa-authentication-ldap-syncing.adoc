...
ifdef::openshift-dedicated,openshift-rosa[]
For more information on configuring LDAP, see
xref:config-ldap-idp_sd-configuring-identity-providers[Configuring an LDAP identity provider].
endif::openshift-dedicated,openshift-rosa[]
...
include::includes/ldap-syncing-about.adoc[leveloffset=+1]
include::includes/ldap-syncing-config-rfc2307.adoc[leveloffset=+2]
include::includes/ldap-syncing-config-activedir.adoc[leveloffset=+2]
include::includes/ldap-syncing-config-augmented-activedir.adoc[leveloffset=+2]
include::includes/ldap-syncing-running.adoc[leveloffset=+1]
include::includes/ldap-syncing-running-all-ldap.adoc[leveloffset=+2]
include::includes/ldap-syncing-running-openshift.adoc[leveloffset=+2]
include::includes/ldap-syncing-running-subset.adoc[leveloffset=+2]
include::includes/ldap-syncing-pruning.adoc[leveloffset=+1]
...
include::includes/ldap-syncing-examples.adoc[leveloffset=+1]
include::includes/ldap-syncing-rfc2307.adoc[leveloffset=+2]
include::includes/ldap-syncing-rfc2307-user-defined.adoc[leveloffset=+2]
include::includes/ldap-syncing-rfc2307-user-defined-error.adoc[leveloffset=+2]
include::includes/ldap-syncing-activedir.adoc[leveloffset=+2]
include::includes/ldap-syncing-augmented-activedir.adoc[leveloffset=+2]
include::includes/ldap-syncing-nesting.adoc[leveloffset=+2]
include::includes/ldap-syncing-spec.adoc[leveloffset=+1]
