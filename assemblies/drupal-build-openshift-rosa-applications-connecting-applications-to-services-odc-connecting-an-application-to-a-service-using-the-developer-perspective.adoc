...
include::../includes/odc-discovering-and-identifying-operator-backed-bindable-services.adoc[leveloffset=+1]
include::../includes/odc-creating-a-visual-connection-between-components.adoc[leveloffset=+1]
include::../includes/odc-creating-a-binding-connection-between-components.adoc[leveloffset=+1]
include::../includes/odc-verifying-the-status-of-your-service-binding-from-the-topology-view.adoc[leveloffset=+1]
include::../includes/odc-visualizing-the-binding-connections-to-resources.adoc[leveloffset=+1]
