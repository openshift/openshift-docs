...
For more information, see xref:../../observability/distr_tracing/distr_tracing_jaeger/distr-tracing-jaeger-configuring.adoc#distr-tracing-config-sampling_distr-tracing-jaeger-configuring[Distributed tracing configuration options].
