...
* xref:../rosa_backing_up_and_restoring_applications/backing-up-applications.adoc#oadp-preparing-aws-credentials_backing-up-applications[Preparing AWS credentials]

[id="rosa-backing-up-applications-known-issues_{context}"]
== Known issues
...
[role="_additional-resources"]
[id="additional-resources_rosa-backing-up-applications_{context}"]
== Additional resources
