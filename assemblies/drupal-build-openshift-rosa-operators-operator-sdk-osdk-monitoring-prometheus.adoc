...
* link:https://access.redhat.com/documentation/en-us/openshift_container_platform/4.16/html-single/monitoring/#understanding-the-monitoring-stack_monitoring-overview[Understanding the monitoring stack] in {product-title}
endif::openshift-dedicated,openshift-rosa[]
