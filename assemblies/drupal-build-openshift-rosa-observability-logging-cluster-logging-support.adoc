...
include::includes/logging-supported-config-snip.adoc[]
...
include::includes/cluster-logging-maintenance-support-list.adoc[leveloffset=+1]
...
You can use the link:https://access.redhat.com/documentation/en-us/openshift_container_platform/4.16/html-single/support/#gathering-cluster-data[`must-gather` tool] to collect diagnostic information for project-level resources, cluster-level resources, and each of the {logging} components.
...
include::includes/cluster-logging-must-gather-about.adoc[leveloffset=+2]
include::includes/cluster-logging-must-gather-collecting.adoc[leveloffset=+2]
