...
See link:https://access.redhat.com/documentation/en-us/openshift_container_platform/4.16/html-single/networking/#configuring-egress-ips-ovn[Configuring an egress IP address] for more information.
...
* The link:https://access.redhat.com/documentation/en-us/openshift_container_platform/4.16/html-single/cli_tools/#cli-getting-started[OpenShift CLI] (`oc`)
* The link:https://access.redhat.com/documentation/en-us/openshift_container_platform/4.16/html-single/cli_tools/#rosa-get-started-cli[ROSA CLI] (`rosa`)
