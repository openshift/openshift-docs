...
For more information about supported configurations, see xref:maintenance-and-support_configuring-the-monitoring-stack[Maintenance and support for monitoring].
