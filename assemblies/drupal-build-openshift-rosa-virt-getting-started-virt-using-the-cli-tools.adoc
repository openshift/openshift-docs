...
include::../includes/virt-installing-virtctl-binary.adoc[leveloffset=+2]

include::../includes/virt-installing-virtctl-rhel8-rpm.adoc[leveloffset=+2]

include::../includes/virt-virtctl-commands.adoc[leveloffset=+1]

include::../includes/virt-deploying-libguestfs-with-virtctl.adoc[leveloffset=+1]

include::../includes/virt-about-libguestfs-tools-virtctl-guestfs.adoc[leveloffset=+2]
