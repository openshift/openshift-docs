...
include::includes/mobb-support-statement.adoc[leveloffset=+1]
...
This process depends on if you are using the link:https://access.redhat.com/documentation/en-us/openshift_container_platform/4.16/html-single/building_applications/#rosa-config-custom-domains-applications[Custom Domain Operator].
+
.. Clusters not using the link:https://access.redhat.com/documentation/en-us/openshift_container_platform/4.16/html-single/building_applications/#rosa-config-custom-domains-applications[Custom Domain Operator]:
+
If you are only using the default Ingress Controller, and not using the link:https://access.redhat.com/documentation/en-us/openshift_container_platform/4.16/html-single/building_applications/#rosa-config-custom-domains-applications[Custom Domain Operator], run the following command to patch the Ingress Controller:
+
[source,terminal]
----
...
----
+
.. Clusters using the link:https://access.redhat.com/documentation/en-us/openshift_container_platform/4.16/html-single/building_applications/#rosa-config-custom-domains-applications[Custom Domain Operator]:
+
Customers who are using the link:https://access.redhat.com/documentation/en-us/openshift_container_platform/4.16/html-single/building_applications/#rosa-config-custom-domains-applications[Custom Domain Operator] need to loop through each of their Ingress Controllers to patch each one.
...
.. Clusters not using the link:https://access.redhat.com/documentation/en-us/openshift_container_platform/4.16/html-single/building_applications/#rosa-config-custom-domains-applications[Custom Domain Operator]:
+
If you are not using the link:https://access.redhat.com/documentation/en-us/openshift_container_platform/4.16/html-single/building_applications/#rosa-config-custom-domains-applications[Custom Domain Operator], create the CronJob by running the following command:
+
[source,terminal]
----
$ cat << EOF | oc apply -f -
...
.. Clusters using the link:https://access.redhat.com/documentation/en-us/openshift_container_platform/4.16/html-single/building_applications/#rosa-config-custom-domains-applications[Custom Domain Operator]:
+
If you are using the link:https://access.redhat.com/documentation/en-us/openshift_container_platform/4.16/html-single/building_applications/#rosa-config-custom-domains-applications[Custom Domain Operator], the CronJob needs to loop through and patch each Ingress Controller.
