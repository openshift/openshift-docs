...
** xref:osdk-installing-cli[Install Operator SDK CLI].
...
** Create xref:osdk-golang-tutorial[Go-based Operators], xref:osdk-ansible-tutorial[Ansible-based Operators], and xref:osdk-helm-tutorial[Helm-based Operators].
endif::openshift-dedicated,openshift-rosa[]
** xref:osdk-about[Use Operator SDK to build, test, and deploy an Operator].
ifndef::openshift-dedicated,openshift-rosa[]
...
** xref:olm-creating-apps-from-installed-operators[Create an application from an installed Operator through the web console].
...
** xref:olm-managing-custom-catalogs[Manage custom catalogs].
ifndef::openshift-dedicated,openshift-rosa[]
...
ifdef::openshift-dedicated,openshift-rosa[]
** xref:olm-installing-operators-from-operatorhub_olm-adding-operators-to-a-cluster[Install an Operator from OperatorHub].
endif::openshift-dedicated,openshift-rosa[]
** xref:olm-status[View Operator status].
** xref:olm-managing-operatorconditions[Manage Operator conditions].
** xref:olm-upgrading-operators[Upgrade installed Operators].
** xref:olm-deleting-operators-from-a-cluster[Delete installed Operators].
** xref:olm-configuring-proxy-support[Configure proxy support].
ifndef::openshift-dedicated,openshift-rosa[]
...
To understand more about Operators, see xref:olm-what-operators-are[What are Operators?]
