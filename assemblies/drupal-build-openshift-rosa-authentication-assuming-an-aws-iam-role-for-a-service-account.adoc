...
include::includes/understanding-pod-identity-webhook-workflow-in-user-defined-projects.adoc[leveloffset=+1]
include::includes/assuming-an-aws-iam-role-in-your-own-pods.adoc[leveloffset=+1]
include::includes/setting-up-an-aws-iam-role-a-service-account.adoc[leveloffset=+2]
include::includes/creating-a-service-account-in-your-project.adoc[leveloffset=+2]
include::includes/creating-an-example-aws-sdk-container-image.adoc[leveloffset=+2]
include::includes/deploying-a-pod-that-includes-an-aws-sdk.adoc[leveloffset=+2]
include::includes/verifying-the-assumed-iam-role-in-your-pod.adoc[leveloffset=+2]
