...
[NOTE]
====
If you are looking for a quickstart guide for ROSA Classic, see link:https://access.redhat.com/documentation/en-us/openshift_container_platform/4.16/html-single/getting_started/#rosa-quickstart-guide-ui[{product-title} quickstart guide].
====
...
[discrete]
include::includes/rosa-hcp-vpc-manual.adoc[leveloffset=+2]
[discrete]
include::includes/rosa-hcp-vpc-subnet-tagging.adoc[leveloffset=+3]
...
* See link:https://access.redhat.com/documentation/en-us/openshift_container_platform/4.16/html-single/introduction_to_rosa/#rosa-sts-about-operator-role-prefixes_rosa-sts-about-iam-resources[About custom Operator IAM role prefixes] for information on the Operator prefixes.

include::includes/rosa-hcp-sts-creating-a-cluster-cli.adoc[leveloffset=+1]
