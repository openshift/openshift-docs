...
include::../includes/creating-a-project-using-the-web-console.adoc[leveloffset=+2]

// include modules/odc-creating-projects-using-developer-perspective.adoc[leveloffset=+2]

.Additional resources

* xref:odc-customizing-available-cluster-roles-using-the-web-console_projects[Customizing the available cluster roles using the web console]

include::../includes/creating-a-project-using-the-CLI.adoc[leveloffset=+2]
...
include::../includes/viewing-a-project-using-the-web-console.adoc[leveloffset=+2]

include::../includes/viewing-a-project-using-the-CLI.adoc[leveloffset=+2]

include::../includes/odc-providing-project-permissions-using-developer-perspective.adoc[leveloffset=+1]

include::../includes/odc-customizing-available-cluster-roles-using-the-web-console.adoc[leveloffset=+1]
...
include::../includes/checking-project-status-using-the-web-console.adoc[leveloffset=+2]

include::../includes/checking-project-status-using-the-CLI.adoc[leveloffset=+2]
...
include::../includes/deleting-a-project-using-the-web-console.adoc[leveloffset=+2]

include::../includes/deleting-a-project-using-the-CLI.adoc[leveloffset=+2]
