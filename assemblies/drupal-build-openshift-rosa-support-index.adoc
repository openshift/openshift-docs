...
* link:https://access.redhat.com/documentation/en-us/openshift_container_platform/4.16/html-single/logging/#cluster-logging[Logging issues]: A cluster administrator can follow the procedures in the "Support" and "Troubleshooting logging" sections to resolve logging issues:

** link:https://access.redhat.com/documentation/en-us/openshift_container_platform/4.16/html-single/logging/#cluster-logging-clo-status_cluster-logging-cluster-status[Viewing the status of the {clo}]
** link:https://access.redhat.com/documentation/en-us/openshift_container_platform/4.16/html-single/logging/#cluster-logging-clo-status-comp_cluster-logging-cluster-status[Viewing the status of {logging} components]
** link:https://access.redhat.com/documentation/en-us/openshift_container_platform/4.16/html-single/logging/#troubleshooting-logging-alerts[Troubleshooting logging alerts]
** link:https://access.redhat.com/documentation/en-us/openshift_container_platform/4.16/html-single/logging/#cluster-logging-must-gather-collecting_cluster-logging-support[Collecting information about your logging environment by using the `oc adm must-gather` command]
