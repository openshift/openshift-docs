...
* link:https://access.redhat.com/documentation/en-us/openshift_container_platform/4.16/html-single/operators/#managing-resources-from-crds[Managing resources from custom resource definitions].
