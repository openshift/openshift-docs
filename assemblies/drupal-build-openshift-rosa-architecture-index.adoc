...
To learn more about {product-title} and Kubernetes, see xref:architecture[product architecture].

include::includes/openshift-architecture-common-terms.adoc[leveloffset=+1]
...
* For more information on storage, see link:https://access.redhat.com/documentation/en-us/openshift_container_platform/4.16/html-single/storage/#index[{product-title} storage].
* For more information on authentication, see link:https://access.redhat.com/documentation/en-us/openshift_container_platform/4.16/html-single/authentication_and_authorization/#index[{product-title} authentication].
* For more information on Operator Lifecycle Manager (OLM), see link:https://access.redhat.com/documentation/en-us/openshift_container_platform/4.16/html-single/operators/#olm-understanding-olm[OLM].
* For more information on logging, see link:https://access.redhat.com/documentation/en-us/openshift_container_platform/4.16/html-single/logging/#cluster-logging[About Logging].
// Topic not included in the OSD/ROSA docs
ifndef::openshift-dedicated,openshift-rosa[]
...
ifdef::openshift-dedicated,openshift-rosa[]
include::includes/sd-vs-ocp.adoc[leveloffset=+1]
endif::openshift-dedicated,openshift-rosa[]
...
The xref:control-plane[control plane] manages the worker nodes and the pods in your cluster. You can configure nodes with the use of machine config pools (MCPs).
...
As a developer, you can use different tools, methods, and formats to xref:understanding-development[develop your containerized application] based on your unique requirements, for example:
