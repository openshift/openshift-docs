...
You can add services to your existing {product-title} (ROSA) cluster using the xref:adding-service[{cluster-manager-first} console].

These services can also be installed link:https://access.redhat.com/documentation/en-us/openshift_container_platform/4.16/html-single/cli_tools/#rosa-managing-objects-cli[using the `rosa` CLI].


include::includes/aws-cloudwatch.adoc[leveloffset=+1]
...
include::includes/rosa-rhods.adoc[leveloffset=+1]
