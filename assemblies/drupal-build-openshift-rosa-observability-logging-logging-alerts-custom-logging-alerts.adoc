...
include::../includes/configuring-logging-loki-ruler.adoc[leveloffset=+1]
include::../includes/loki-rbac-rules-permissions.adoc[leveloffset=+1]
...
include::../includes/logging-enabling-loki-alerts.adoc[leveloffset=+1]

[role="_additional-resources"]
[id="additional-resources_custom-logging-alerts"]
== Additional resources
* link:https://access.redhat.com/documentation/en-us/openshift_container_platform/4.16/html-single/monitoring/#about-openshift-monitoring[About {product-title} monitoring]
