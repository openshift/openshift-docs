...
include::../includes/logging-input-spec-filter-namespace-container.adoc[leveloffset=+1]
include::../includes/logging-input-spec-filter-labels-expressions.adoc[leveloffset=+1]
include::../includes/logging-input-spec-filter-audit-infrastructure.adoc[leveloffset=+1]