...
* link:https://access.redhat.com/documentation/en-us/openshift_container_platform/4.16/html-single/monitoring/#reviewing-monitoring-dashboards[Reviewing monitoring dashboards]
