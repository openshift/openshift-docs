...
include::../includes/log-collector-http-server.adoc[leveloffset=+2]
//include::../includes/log-collector-rsyslog-server.adoc[leveloffset=+2]
// uncomment for 5.9 release

[role="_additional-resources"]
.Additional resources
* xref:logging-audit-filtering_configuring-log-forwarding[Overview of API audit filter]
