...
include::includes/monitoring-reviewing-monitoring-dashboards-admin.adoc[leveloffset=+1]
...
* xref:accessing-third-party-monitoring-apis[Accessing monitoring APIs by using the CLI]
