...
For an overview about basic Operator concepts and terminology, see xref:olm-what-operators-are[Understanding Operators].

include::../includes/osdk-workflow.adoc[leveloffset=+1]
