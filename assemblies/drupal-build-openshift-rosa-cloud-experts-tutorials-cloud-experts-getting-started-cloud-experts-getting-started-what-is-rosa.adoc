...
* *Global availability:* Refer to the link:https://access.redhat.com/documentation/en-us/openshift_container_platform/4.16/html-single/introduction_to_rosa/#rosa-sdpolicy-regions-az_rosa-service-definition[product regional availability page] to see where ROSA is available globally.
...
Refer to the link:https://access.redhat.com/documentation/en-us/openshift_container_platform/4.16/html-single/introduction_to_rosa/#rosa-sdpolicy-regions-az_rosa-service-definition[product regional availability] page for an up-to-date view of where ROSA is available.
...
For a complete list of supported instances for worker nodes see link:https://access.redhat.com/documentation/en-us/openshift_container_platform/4.16/html-single/introduction_to_rosa/#rosa-sdpolicy-aws-instance-types_rosa-service-definition[AWS instance types]. Spot instances are also supported.

=== Node autoscaling
Autoscaling allows you to automatically adjust the size of the cluster based on the current workload. See link:https://access.redhat.com/documentation/en-us/openshift_container_platform/4.16/html-single/cluster_administration/#rosa-nodes-about-autoscaling-nodes[About autoscaling nodes on a cluster] for more details.

=== Maximum number of worker nodes
The maximum number of worker nodes is 180 worker nodes for each ROSA cluster. See link:https://access.redhat.com/documentation/en-us/openshift_container_platform/4.16/html-single/prepare_your_environment/#rosa-limits-scalability[limits and scalability] for more details on node counts.

A list of the account-wide and per-cluster roles is provided in the link:https://access.redhat.com/documentation/en-us/openshift_container_platform/4.16/html-single/introduction_to_rosa/#rosa-sts-account-wide-roles-and-policies-creation-methods_rosa-sts-about-iam-resources[ROSA documentation].
...
ROSA is a managed service which is based on OpenShift Container Platform. You can view the current version and life cycle dates in the link:https://access.redhat.com/documentation/en-us/openshift_container_platform/4.16/html-single/introduction_to_rosa/#rosa-life-cycle-dates_rosa-life-cycle[ROSA documentation].

Customers can upgrade to the newest version of OpenShift and use the features from that version of OpenShift. For more information, see link:https://access.redhat.com/documentation/en-us/openshift_container_platform/4.16/html-single/introduction_to_rosa/#rosa-life-cycle-dates_rosa-life-cycle[life cycle dates]. Not all OpenShift features are be available on ROSA. Review the link:https://access.redhat.com/documentation/en-us/openshift_container_platform/4.16/html-single/introduction_to_rosa/#rosa-service-definition[Service Definition] for more information.

== Support
You can open a ticket directly from the {cluster-manager-url}. See the link:https://access.redhat.com/documentation/en-us/openshift_container_platform/4.16/html-single/support/#getting-support[ROSA support documentation] for more details about obtaining support.
...
=== Limited support
If a ROSA cluster is not upgraded before the "end of life" date, the cluster continues to operate in a limited support status. The SLA for that cluster will no longer be applicable, but you can still get support for that cluster. See the link:https://access.redhat.com/documentation/en-us/openshift_container_platform/4.16/html-single/introduction_to_rosa/#rosa-life-cycle[limited support status] documentation for more details.
...
Refer to the link:https://access.redhat.com/documentation/en-us/openshift_container_platform/4.16/html-single/introduction_to_rosa/#rosa-sdpolicy-sla_rosa-service-definition[ROSA SLA] page for details.
...
== SRE cluster access
All SRE cluster access is secured by MFA. See link:https://access.redhat.com/documentation/en-us/openshift_container_platform/4.16/html-single/introduction_to_rosa/#rosa-sre-access[SRE access] for more details.
...
== Infrastructure
ROSA uses several different cloud services such as virtual machines, storage, and load balancers. You can see a defined list in the link:https://access.redhat.com/documentation/en-us/openshift_container_platform/4.16/html-single/prepare_your_environment/#rosa-aws-policy-provisioned_rosa-sts-aws-prereqs[AWS prerequisites].
...
== Storage
Refer to the link:https://access.redhat.com/documentation/en-us/openshift_container_platform/4.16/html-single/introduction_to_rosa/#rosa-sdpolicy-storage_rosa-service-definition[storage] section of the service definition.

OpenShift includes the CSI driver for AWS EFS. For more information, see link:https://access.redhat.com/documentation/en-us/openshift_container_platform/4.16/html-single/storage/#osd-persistent-storage-aws-efs-csi[Setting up AWS EFS for Red Hat OpenShift Service on AWS].
...
ROSA allows multiple clusters to share the same VPC. The number of clusters on one VPC is limited by the remaining AWS resource quota and CIDR ranges that cannot overlap. See link:https://access.redhat.com/documentation/en-us/openshift_container_platform/4.16/html-single/networking/#cidr-range-definitions[CIDR Range Definitions] for more information.

== Network plugin
ROSA uses the OpenShift OVN-Kubernetes default CNI network provider.

== Cross-namespace networking
Cluster admins can customize, and deny, cross-namespace on a project basis using NetworkPolicy objects. Refer to link:https://access.redhat.com/documentation/en-us/openshift_container_platform/4.16/html-single/networking/#nw-networkpolicy-multitenant-isolation_multitenant-network-policy[Configuring multitenant isolation with network policy] for more information.
...
== Cluster backups
ROSA STS clusters do not have backups. Users must have their own backup policies for applications and data. See our link:https://access.redhat.com/documentation/en-us/openshift_container_platform/4.16/html-single/introduction_to_rosa/#rosa-sdpolicy-backup-policy_rosa-service-definition[backup policy] for more information.

== Custom domain
You can define a custom domain for your applications. See link:https://access.redhat.com/documentation/en-us/openshift_container_platform/4.16/html-single/building_applications/#rosa-config-custom-domains-applications[Configuring custom domains for applications] for more information.
...
** link:https://access.redhat.com/documentation/en-us/openshift_container_platform/4.16/html-single/about/#welcome-index[ROSA documentation]
...
** link:https://access.redhat.com/documentation/en-us/openshift_container_platform/4.16/html-single/introduction_to_rosa/#rosa-policy-responsibility-matrix[ROSA responsibility assignment matrix]
** link:https://access.redhat.com/documentation/en-us/openshift_container_platform/4.16/html-single/introduction_to_rosa/#rosa-policy-process-security[Understanding Process and Security]
** link:https://access.redhat.com/documentation/en-us/openshift_container_platform/4.16/html-single/introduction_to_rosa/#rosa-policy-understand-availability[About Availability]
** link:https://access.redhat.com/documentation/en-us/openshift_container_platform/4.16/html-single/introduction_to_rosa/#rosa-life-cycle[Updates Lifecycle]
