...
* For steps to quickly create a ROSA cluster with STS, including the AWS IAM resources, see link:https://access.redhat.com/documentation/en-us/openshift_container_platform/4.16/html-single/install_rosa_classic_clusters/#rosa-sts-creating-a-cluster-quickly[Creating a ROSA cluster with STS using the default options].
* For steps to create a ROSA cluster with STS using customizations, including the AWS IAM resources, see link:https://access.redhat.com/documentation/en-us/openshift_container_platform/4.16/html-single/install_rosa_classic_clusters/#rosa-sts-creating-a-cluster-with-customizations[Creating a ROSA cluster with STS using customizations].

[id="rosa-sts-ocm-roles-and-permissions_{context}"]
== {cluster-manager} roles and permissions

If you create ROSA clusters by using {cluster-manager-url}, you must have the following AWS IAM roles linked to your AWS account to create and manage the clusters. For more information about linking your IAM roles to your AWS account, see link:https://access.redhat.com/documentation/en-us/openshift_container_platform/4.16/html-single/prepare_your_environment/#rosa-associating-account_rosa-sts-aws-prereqs[Associating your AWS account].
...
include::includes/rosa-sts-understanding-ocm-role.adoc[leveloffset=+2]

[role="_additional-resources"]
.Additional resources
* xref:rosa-sts-account-wide-roles-and-policies-creation-methods_rosa-sts-about-iam-resources[Methods of account-wide role creation]

[discrete]
include::includes/rosa-sts-ocm-role-creation.adoc[leveloffset=+2]

AWS IAM roles link to your AWS account to create and manage the clusters. For more information about linking your IAM roles to your AWS account, see link:https://access.redhat.com/documentation/en-us/openshift_container_platform/4.16/html-single/prepare_your_environment/#rosa-associating-account_rosa-sts-aws-prereqs[Associating your AWS account].
...
//
//* link:https://access.redhat.com/documentation/en-us/openshift_container_platform/4.16/html-single/install_rosa_classic_clusters/#rosa-sts-creating-a-cluster-with-customizations[Understanding the auto and manual deployment modes]

include::includes/rosa-sts-account-wide-roles-and-policies.adoc[leveloffset=+1]

[role="_additional-resources"]
.Additional resources

* For a definition of OpenShift major, minor, and patch versions, see xref:rosa-life-cycle-definitions_rosa-life-cycle[the {product-title} update life cycle].

include::includes/rosa-sts-account-wide-role-and-policy-commands.adoc[leveloffset=+2]
...
* For more information about creating the required account-wide STS roles and policies see link:https://access.redhat.com/documentation/en-us/openshift_container_platform/4.16/html-single/install_rosa_classic_clusters/#rosa-sts-creating-account-wide-sts-roles-and-policies_rosa-sts-creating-a-cluster-quickly[Creating the account-wide STS roles and policies].

include::includes/rosa-sts-operator-roles.adoc[leveloffset=+1]
include::includes/rosa-sts-operator-role-commands.adoc[leveloffset=+2]
include::includes/rosa-sts-about-operator-role-prefixes.adoc[leveloffset=+2]

[role="_additional-resources"]
.Additional resources
 For steps to create the cluster-specific Operator IAM roles using a custom prefix, see link:https://access.redhat.com/documentation/en-us/openshift_container_platform/4.16/html-single/install_rosa_classic_clusters/#rosa-sts-creating-cluster-customizations-cli_rosa-sts-creating-a-cluster-with-customizations[Creating a cluster with customizations using the CLI] or link:https://access.redhat.com/documentation/en-us/openshift_container_platform/4.16/html-single/install_rosa_classic_clusters/#rosa-sts-creating-cluster-customizations-ocm_rosa-sts-creating-a-cluster-with-customizations[Creating a cluster with customizations by using {cluster-manager}].
...
include::includes/rosa-sts-oidc-provider-command.adoc[leveloffset=+2]

include::includes/rosa-oidc-config-overview.adoc[leveloffset=+2]
[discrete]
include::includes/rosa-sts-byo-oidc.adoc[leveloffset=+3]
[discrete]
include::includes/rosa-sts-byo-oidc-options.adoc[leveloffset=+3]

include::includes/rosa-aws-scp.adoc[leveloffset=+1]