...
* link:https://access.redhat.com/documentation/en-us/openshift_container_platform/4.16/html-single/nodes/#priority-preemption-other_nodes-pods-priority[Pod disruption budgets]
