...
[NOTE]
====
The examples listed cover several of the most common ROSA CLI commands. For more information regarding ROSA CLI commands, see xref:rosa-common-commands_rosa-managing-objects-cli[Common commands and arguments].
====
...
include::../includes/rosa-cli-hcp-classic-examples.adoc[leveloffset=+1]
include::../includes/rosa-cli-hcp-examples.adoc[leveloffset=+1]
include::../includes/rosa-cli-classic-examples.adoc[leveloffset=+1]
include::../includes/rosa-cli-no-permissions-required.adoc[leveloffset=+1]
