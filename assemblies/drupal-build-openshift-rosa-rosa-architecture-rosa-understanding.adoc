...
//A listing of the account-wide and per-cluster roles is provided in xref:rosa-sts-about-iam-resources[About IAM resources for ROSA clusters that use STS].
...
To get started with deploying your cluster, ensure your AWS account has met the prerequisites, you have a Red Hat account ready, and follow the procedures outlined in link:https://access.redhat.com/documentation/en-us/openshift_container_platform/4.16/html-single/getting_started/#rosa-getting-started[Getting started with {product-title}].

[discrete]
[role="_additional-resources"]
== Additional resources

* link:https://access.redhat.com/documentation/en-us/openshift_container_platform/4.16/html-single/red_hat_openshift_cluster_manager/#ocm-overview[OpenShift Cluster Manager]
* xref:rosa-sts-about-iam-resources[About IAM resources for ROSA clusters that use STS]
* link:https://access.redhat.com/documentation/en-us/openshift_container_platform/4.16/html-single/getting_started/#rosa-getting-started[Getting started with {product-title}]
* link:https://aws.amazon.com/rosa/pricing/[AWS pricing page]


// Remove these modules?
//include::includes/rosa-understanding.adoc[leveloffset=+1]
//include::includes/rosa-using-sts.adoc[leveloffset=+2]
