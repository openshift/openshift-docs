...
include::../includes/sbo-methods-of-exposing-binding-data.adoc[leveloffset=+1]
include::../includes/sbo-data-model.adoc[leveloffset=+1]
include::../includes/sbo-setting-annotations-mapping-optional.adoc[leveloffset=+1]
include::../includes/sbo-rbac-requirements.adoc[leveloffset=+1]
include::../includes/sbo-categories-of-exposable-binding-data.adoc[leveloffset=+1]
...
* xref:projecting-binding-data[Projecting binding data].
