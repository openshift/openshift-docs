...
[role="_additional-resources"]
.Additional resources
* For more details on running add-on Operators in {product-title}, see the _Operators_ guide sections on link:https://access.redhat.com/documentation/en-us/openshift_container_platform/4.16/html-single/operators/#olm-understanding-olm[Operator Lifecycle Manager (OLM)] and link:https://access.redhat.com/documentation/en-us/openshift_container_platform/4.16/html-single/operators/#olm-understanding-operatorhub[OperatorHub].
* For more details on the Operator SDK, see link:https://access.redhat.com/documentation/en-us/openshift_container_platform/4.16/html-single/operators/#osdk-about[Developing Operators].
