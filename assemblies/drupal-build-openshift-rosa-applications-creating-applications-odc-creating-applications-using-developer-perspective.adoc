...
include::../includes/odc-creating-sample-applications.adoc[leveloffset=+1]

include::../includes/odc-using-quickstarts.adoc[leveloffset=+1]

include::../includes/odc-importing-codebase-from-git-to-create-application.adoc[leveloffset=+1]

include::../includes/odc-deploying-container-image.adoc[leveloffset=+1]

include::../includes/odc-deploying-java-applications.adoc[leveloffset=+1]

include::../includes/odc-using-the-devfile-registry.adoc[leveloffset=+1]

include::../includes/odc-using-the-developer-catalog-to-add-services-or-components.adoc[leveloffset=+1]
...
* For more information about adding a new user to a project, see xref:odc-providing-project-permissions-using-developer-perspective_projects[Working with projects].
* For more information about creating a Helm Chart repository, see xref:odc-creating-helm-releases-using-developer-perspective_configuring-custom-helm-chart-repositories[Creating Helm Chart repositories].
