...
include::../includes/nodes-cma-autoscaling-custom-creating-workload.adoc[leveloffset=+1]
...
* xref:nodes-cma-autoscaling-custom-trigger-auth[Understanding custom metrics autoscaler trigger authentications]
