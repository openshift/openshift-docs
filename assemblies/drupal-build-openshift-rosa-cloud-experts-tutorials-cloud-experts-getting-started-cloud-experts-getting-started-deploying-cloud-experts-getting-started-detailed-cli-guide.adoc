...
** 2 worker nodes
** No autoscaling
** See the documentation on link:https://access.redhat.com/documentation/en-us/openshift_container_platform/4.16/html-single/prepare_your_environment/#rosa-ec2-instances_rosa-sts-aws-prereqs[ec2 instances] for more details.  
...
This section uses the `--interactive` mode. See the documentation on link:https://access.redhat.com/documentation/en-us/openshift_container_platform/4.16/html-single/install_rosa_classic_clusters/#rosa-sts-interactive-mode-reference[interactive mode] for a description of the fields in this section.
...
----
+
You can also see the contents in the link:https://access.redhat.com/documentation/en-us/openshift_container_platform/4.16/html-single/introduction_to_rosa/#rosa-sts-account-wide-roles-and-policies-creation-methods_rosa-sts-about-iam-resources[About IAM resources for ROSA clusters] documentation.
...
----
+
See the link:https://access.redhat.com/documentation/en-us/openshift_container_platform/4.16/html-single/install_rosa_classic_clusters/#rosa-sts-interactive-mode-reference[ROSA documentation] for a description of the fields.
