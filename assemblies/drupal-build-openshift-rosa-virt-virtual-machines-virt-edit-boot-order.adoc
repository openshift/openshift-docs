...
include::../includes/virt-add-boot-order-web.adoc[leveloffset=+1]
include::../includes/virt-edit-boot-order-web.adoc[leveloffset=+1]
include::../includes/virt-edit-boot-order-yaml-web.adoc[leveloffset=+1]
include::../includes/virt-remove-boot-order-item-web.adoc[leveloffset=+1]
