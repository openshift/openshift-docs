...
====
////
include::../includes/rosa-enable-private-cluster-new.adoc[leveloffset=+1]
include::../includes/rosa-enable-private-cluster-existing.adoc[leveloffset=+1]

[role="_additional-resources"]
== Additional resources

* xref:rosa-aws-privatelink-creating-cluster[Creating an AWS PrivateLink cluster on ROSA]
