...
include::../../includes/virt-installing-qemu-guest-agent-on-linux-vm.adoc[leveloffset=+2]

include::../../includes/virt-installing-qemu-guest-agent-on-windows-vm.adoc[leveloffset=+2]
...
include::../../includes/virt-attaching-virtio-disk-to-windows.adoc[leveloffset=+2]

include::../../includes/virt-attaching-virtio-disk-to-windows-existing.adoc[leveloffset=+2]

include::../../includes/virt-installing-virtio-drivers-installing-windows.adoc[leveloffset=+2]

include::../../includes/virt-installing-virtio-drivers-existing-windows.adoc[leveloffset=+2]

include::../../includes/virt-adding-container-disk-as-cd.adoc[leveloffset=+2]

[id="updating-virtio-drivers"]
== Updating VirtIO drivers

include::../../includes/virt-updating-virtio-drivers-windows.adoc[leveloffset=+2]
