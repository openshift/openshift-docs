...
{product-title} {product-version} supports Operator SDK {osdk_ver}. If you already have the {osdk_ver_n1} CLI installed on your workstation, you can update the CLI to {osdk_ver} by xref:osdk-installing-cli[installing the latest version].
...
include::../../includes/osdk-updating-128-to-131.adoc[leveloffset=+1]

[id="additional-resources_osdk-helm-upgrading-projects"]
[role="_additional-resources"]
== Additional resources

* xref:osdk-pkgman-to-bundle[Migrating package manifest projects to bundle format]
