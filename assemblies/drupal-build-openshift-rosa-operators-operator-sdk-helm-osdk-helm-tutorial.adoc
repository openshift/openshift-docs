...
include::../../includes/osdk-helm-existing-chart.adoc[leveloffset=+2]
include::../../includes/osdk-project-file.adoc[leveloffset=+2]

include::../../includes/osdk-helm-logic.adoc[leveloffset=+1]
include::../../includes/osdk-helm-sample-chart.adoc[leveloffset=+2]
include::../../includes/osdk-helm-modify-cr.adoc[leveloffset=+2]
...
* See xref:osdk-helm-project-layout[Project layout for Helm-based Operators] to learn about the directory structures created by the Operator SDK.
ifndef::openshift-dedicated,openshift-rosa[]
