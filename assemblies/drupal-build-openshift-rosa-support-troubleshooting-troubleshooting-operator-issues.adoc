...
* link:https://access.redhat.com/documentation/en-us/openshift_container_platform/4.16/html-single/operators/#olm-cs-health_olm-understanding-olm[Catalog health requirements]
...
include::../includes/querying-operator-pod-status.adoc[leveloffset=+1]

// Gathering Operator logs
include::../includes/gathering-operator-logs.adoc[leveloffset=+1]
