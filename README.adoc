= OpenShift Documentation image:https://travis-ci.org/openshift/openshift-docs.svg?branch=master["Build Status", link="https://travis-ci.org/openshift/openshift-docs"]
