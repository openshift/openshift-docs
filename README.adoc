...
image:https://travis-ci.org/openshift/openshift-docs.svg?branch=master[Build, title="Travis Build Status" link="https://travis-ci.org/openshift/openshift-docs"]
image:https://ci.openshift.redhat.com/jenkins/buildStatus/icon?job=openshift-docs_ci[Build, title="Jenkins CI Build Status", link="https://ci.openshift.redhat.com/jenkins/job/openshift-docs_ci/""]
