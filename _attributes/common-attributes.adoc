...
// IBM Cloud with registered trademark symbol; use this attribute for first instance of product name
:ibmcloudBMRegProductName: IBM Cloud(R) Bare Metal (Classic)
// IBM Power
:ibmpowerProductName: IBM Power
// IBM Power with registered trademark symbol; use this attribute for first instance of product name
:ibmpowerRegProductName: IBM Power(R)
// IBM zSystems
:ibmzProductName: IBM Z
:linuxoneProductName: IBM(R) LinuxONE
// IBM Z with registered trademark symbol; use this attribute for first instance of product name
:ibmzRegProductName: IBM Z(R)
