...
:oda-short: ODA
// Red Hat OpenStack Services on OpenShift (RHOSO)/OpenStack
ifndef::openshift-origin[]
:rh-openstack-first: Red{nbsp}Hat OpenStack Services on OpenShift (RHOSO)
:rh-openstack: RHOSO
...
:rhoso: RHOSO
:rh-openstack-legacy-first: Red{nbsp}Hat OpenStack Platform (RHOSP)
:rh-openstack-legacy: RHOSP
// VMware vSphere
