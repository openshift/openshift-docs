...
// :data-uri: (commented out - problematic for DITA conversion, no images in logging docs)
:icons:
:experimental:
:toc: macro
:toc-title:
...
:gcp-wid-first: Google Cloud Workload Identity
...
// Cluster API Provider Google Cloud (GCP)
:cap-gcp-first: Cluster API Provider Google Cloud (GCP)
...
:logging-major-version: 6.5
:logging-minor-version: 0
