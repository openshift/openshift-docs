...
// IMPORTANT: Update the :red-hat-insights: product name variable to "Red Hat Lightspeed" on Nov 4, 2025.
:red-hat-insights: Red Hat Insights
<<<<<<< HEAD
:red-hat-lightspeed: Red Hat Lightspeed
=======
>>>>>>> 3fb94ec297 (HCCDOC-4361: Add Red Hat Insights and Lightspeed attributes)
// OADP attributes
