...
:sandboxed-containers-version: 1.4
:sandboxed-containers-version-z: 1.4.0
:sandboxed-containers-legacy-version: 1.3.3
...
:mce-first: multicluster engine for Kubernetes operator (MCE)
:mce-short: MCE
