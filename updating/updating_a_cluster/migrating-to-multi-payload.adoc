...
// Migrating x86 control plane to arm64 on Azure
include::modules/migrating-from-x86-to-arm-cp-azure.adoc[leveloffset=+1]
...
* xref:../../installing/installing_azure/ipi/installing-azure-customizations.adoc#installation-azure-arm-tested-machine-types_installing-azure-customizations[Tested instance types for {azure-short} on 64-bit ARM infrastructures]
