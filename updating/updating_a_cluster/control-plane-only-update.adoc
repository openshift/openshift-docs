...
* All the clusters might update using EUS channels for a conventional update without pools paused, but only clusters with non control-plane `MachineConfigPools` objects can do Control Plane Only update with pools paused.
...
* xref:../../operators/admin/olm-upgrading-operators.adoc#olm-upgrading-operators[Updating installed Operators]
* xref:../../updating/updating_a_cluster/eus-eus-update.adoc#updating-control-plane-only-update-console_control-plane-only-update[Control Plane Only update using the web console]
* xref:../../updating/updating_a_cluster/eus-eus-update.adoc#updating-control-plane-only-update-cli_control-plane-only-update[Control Plane Only update using the CLI]
