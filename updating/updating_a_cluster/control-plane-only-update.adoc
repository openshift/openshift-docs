...
include::modules/updating-control-plane-only-upgrade.adoc[leveloffset=+1]

// Control Plane Only update using the web console
include::modules/updating-control-plane-only-upgrade-console.adoc[leveloffset=+2]

[role="_additional-resources"]
[id="additional-resources_updating-control-plane-only-upgrade-console"]
...
include::modules/updating-control-plane-only-upgrade-cli.adoc[leveloffset=+2]

[role="_additional-resources"]
[id="additional-resources_updating-control-plane-only-upgrade-cli"]
.Additional resources
...
* xref:../../operators/admin/olm-upgrading-operators.adoc#olm-upgrading-operators[Updating installed Operators]
* xref:../../updating/updating_a_cluster/control-plane-only-update.adoc#updating-control-plane-only-upgrade-console_control-plane-only-update[Control Plane Only update using the web console]
* xref:../../updating/updating_a_cluster/control-plane-only-update.adoc#updating-control-plane-only-upgrade-cli_control-plane-only-update[Control Plane Only update using the CLI]
