...
* Have a recent xref:../../etcd/etcd-backup.adoc#backing-up-etcd-data_backup-etcd[etcd backup] in case your update fails and you must restore your cluster to a previous state.
