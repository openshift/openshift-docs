...
* Have a recent xref:../../etcd/etcd-backup.adoc#backing-up-etcd-data_etcd-backup[etcd backup] in case your update fails and you must restore your cluster to a previous state.
