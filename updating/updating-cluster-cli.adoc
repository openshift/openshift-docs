...
You can update, or upgrade, an {product-title} cluster within a minor version by using the {oc-first}. You can also update a cluster between minor versions by following the same instructions.
