...
* xref:../updating/updating-cluster-between-minor.adoc#update-upgrading-web_updating-cluster-within-minor[Updating a cluster within a minor versions from the web console]
