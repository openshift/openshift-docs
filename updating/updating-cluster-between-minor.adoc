...
. If your cluster uses installer-provisioned infrastructure in Microsoft Azure, you must xref:../installing/installing_azure/migrating-azure-dns-zones.adoc#migrating-azure-dns-zones[migrate the legacy Azure DNS zone] before you update your cluster.
