...
[IMPORTANT]
====
Using the `unsupportedConfigOverrides` section to modify an Operator's configuration is unsupported and will block cluster upgrades. You must remove this setting before you can upgrade your cluster.
====
