...
[id="update-service-mirror-release-osus"]
...
== Updating a disconnected cluster with the OpenShift Update Service

After you have configured your cluster to use your locally installed OpenShift Update Service application and local mirror registry, you can use any of the available update methods as you would with a connected cluster.

Before updating your disconnected cluster, you should have performed the following tasks:
...
After those tasks have been completed, you can perform any of the following procedures for updating your cluster:
