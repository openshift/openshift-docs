...
* xref:../updating/updating-restricted-network-cluster/uninstalling-osus.adoc#update-service-uninstall_uninstalling-osus[Uninstalling the OpenShift Update Service Operator]
