...
If your deployment exceeds the capacity of the chosen size, you can either increase the LokiStack size or scale individual components. For guidance on when to resize versus scale components, see xref:../../configure/configure_lokistack/advanced-deployment-scalability-for-loki.adoc#loki-sizing-vs-component-scaling_advanced-deployment-scalability-for-loki[LokiStack sizing versus component scaling].
