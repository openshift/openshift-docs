[id='use-crio-engine']
= Using the CRI-O Container Engine - the next generation replacement for Docker
...
* link:https://thenewstack.io/cri-o-project-run-containers-without-docker-reaches-1-0/[CRI-O: the project to run containers without Docker]
