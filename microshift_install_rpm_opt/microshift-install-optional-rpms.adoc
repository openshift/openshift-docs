...
:context: microshift-install-optional-rpms
...
When you install {microshift-short}, you can add optional RPM packages. Examples of optional RPMs include those designed to expand your network, add and manage Operators, and manage applications. Use the following procedures to add the packages that you need.
