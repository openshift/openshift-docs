...
xref:../install_config/master_node_configuration.adoc#master-config-image-config[configured
globally] at the system level. See xref:importing-tag-and-image-metadata[Importing
Tag and Image Metadata] for more details.
