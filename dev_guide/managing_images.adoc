...
To move images from one container registry to another, use the `oc image mirror`
...
If the container registry requires authentication to pull or push an image, you
