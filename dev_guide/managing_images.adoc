...
[IMPORTANT]
====
Avoid tagging internally managed images (those built and pushed locally to an
internal registry). There is a
...
preventing the registry client from pulling from such a tag.
endif::[]
====
