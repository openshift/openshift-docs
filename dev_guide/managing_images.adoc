...
refreshed (i.e., re-imported) periodically. The period is xref:../install_config/master_node_configuration.adoc#master-config-image-policy-config[configured globally] at
