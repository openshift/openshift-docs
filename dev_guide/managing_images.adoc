...
results in longer
xref:../architecture/core_concepts/builds_and_image_streams.adoc#image-stream-tag[tag history] and, therefore, the image pruner is more likely remove to old and unused images.
ifdef::openshift-origin,openshift-enterprise[]
