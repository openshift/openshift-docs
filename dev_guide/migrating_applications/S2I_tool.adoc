...
Source-to-Image (S2I) tool] injects application source code into a Docker image
...
xref:../../install_config/install/docker_registry.adoc#access-pushing-and-pulling-images[OpenShift
registry].
