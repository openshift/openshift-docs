...
|hot_deploy  |xref:../../using_images/s2i_images/ruby.adoc#ruby-hot-deploy[Ruby], xref:../../using_images/s2i_images/python.adoc#python-hot-deploy[Python], xref:../../using_images/s2i_images/perl.asoc#perl-hot-deploy[Perl], xref:../../using_images/s2i_images/php.html#php-hot-deploy[PHP], xref:../../using_images/s2i_images/nodejs.html#nodejs-hot-deploying[Node.js]
