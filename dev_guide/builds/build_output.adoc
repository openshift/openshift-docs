...
To push an image to a private Docker registry, credentials can be supplied via a secret.  Instructions
for doing this can be found xref:build_inputs.adoc#using-docker-credentials-for-private-registries[here].
