...
build] process and resulting image. xref:environment-files[Environment files]
and xref:buildconfig-environment[*BuildConfig* environment] values. Variables
provided will be present during the build process and in the output image.
