...
[NOTE]
====
You can also use xref:source-secrets-combinations[combinations] of the these configurations
...
stream to the builder.   You can also specify a url to a file.  The builder 
then stores the data in a file with the same name at the top of the build context.
