...
private container registry or pull a builder image from the private container registry
that requires authentication.

[NOTE]
====
For the {product-title} container registry, this is not required because secrets
...
You can define multiple container registry entries in this file. Alternatively, you
...
. Pull the builder container image from a private container registry by specifying the
