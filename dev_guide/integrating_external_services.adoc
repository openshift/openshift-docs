...
. Create an
xref:../architecture/core_concepts/pods_and_services.adoc#services[OpenShift
...
<3> Endpoints IPs
http://kubernetes.io/v1.0/docs/user-guide/services.adoc#services-without-selectors[cannot
