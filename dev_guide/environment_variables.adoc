...
{product-title} provides the
xref:../cli_reference/basic_cli_operations.adoc#set[`oc set env`] command to set
or unset environment variables for objects that have a pod
