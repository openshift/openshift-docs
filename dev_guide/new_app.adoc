...
by running the `oc new-app` command link:#using-the-cli[from the CLI].
{product-title} creates a new application by specifying
link:#specifying-source-code[source code], link:#specifying-an-image[images], or
