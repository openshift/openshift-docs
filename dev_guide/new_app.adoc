...
xref:deployment_configs.adoc#triggers[deployment triggers] and image environment
variables.
<7> Replica xref:deployment_configs.adoc#scaling[scaling] section for configuring the
