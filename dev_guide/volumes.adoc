...
link:../architecture/core_objects/kubernetes_model.html#pod[pods] and their
...
controllers] or
link:../architecture/core_objects/openshift_model.html#deploymentconfig[deployment
