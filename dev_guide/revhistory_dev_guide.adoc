...
|Clarified that {product-title} customers can utilize wildcard CNAMEs for custom domains on routes in the xref:../dev_guide/expose_service/index.adoc#getting-traffic-into-cluster-router[Using a Router] section.
endif::[]
