...
n|xref:../dev_guide/openshift_pipeline.adoc#dev-guide-openshift-pipeline[OpenShift Pipeline]
|Added section.
...
|Updated template service broker annotation namespaces.
...
|Added the xref:../dev_guide/routes.adoc#dev-guide-routes-allowing-endpoints-to-control-cookies[Allowing Route Endpoints to Control Cookie Names] section.
...
// end::dev_guide_wed_feb_07_2018[]
== Wed Jan 31 2018

// tag::dev_guide_wed_jan_31_2018[]
[cols="1,3",options="header"]
|===
...
|xref:../dev_guide/notifications.adoc#dev-guide-notifications[Notifications]
|New topic on the Notifications feature, which allows you to opt in to receive email notifications
about various failures, including dead or failed deployments, dead builds, and dead or failed persistent volume claims (PVCs) for each of your projects.
