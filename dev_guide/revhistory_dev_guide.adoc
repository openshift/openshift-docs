...
|Added a link:../dev_guide/builds.html#troubleshooting[Troubleshooting Guidance] table.
...
|Added a link:../dev_guide/jobs.html#setting-maximum-duration[Setting Maximum Duration] section, which includes job deadline information.

|Resource Quota
|Moved the topic from Developer Guide to link:../admin_guide/quota.html[Cluster Administration], as it involves cluster administration tasks.
...
|link:../dev_guide/compute_resources.html[Quotas, Limit Ranges, and Compute Resources]
...
link:../dev_guide/compute_resources.html[Quotas, Limit Ranges, and Compute
Resources].
