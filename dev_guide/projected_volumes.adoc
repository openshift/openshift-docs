...
. In another terminal, use the xref:../cli_reference/basic_cli_operations.adoc#troubleshooting-and-debugging-cli-operations[`oc exec` command] to open a shell to the running container:
+
----
