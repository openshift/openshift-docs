...
xref:compute_resources.adoc#dev-guide-compute-resources[compute resources]
...
If a quota has been defined for your project, see xref:../dev_guide/deployments.adoc#deployment-resources[Deployment Resources] for considerations on any deployment configurations.
