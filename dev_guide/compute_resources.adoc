...
CPU, memory (RAM), and local ephemeral storage (if your administrator has
enabled the ephemeral storage technology preview in {product-title} 3.10) each
...
<3> The container requests 1Gi ephemeral storage (if your administrator has enabled the ephemeral storage technology preview in {product-title} 3.10).
<4> The container limits 200m CPU.
<5> The container limits 400Mi memory.
<6> The container limits 2Gi ephemeral storage (if your administrator has enabled the ephemeral storage technology preview in {product-title} 3.10).
...
[NOTE]
====
This topic applies only if your administrator has enabled the ephemeral storage technology preview in {product-title} 3.10.
====
...
Ephemeral storage applies only if your administrator has enabled the ephemeral storage technology preview in {product-title} 3.10.
endif::[]
