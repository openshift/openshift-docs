...
----
<1> The allowable format for the keys in the `data` field must meet the guidelines in the "DNS_SUBDOMAIN" value in
link:https://github.com/GoogleCloudPlatform/kubernetes/blob/master/docs/design/identifiers.md[the Kubernetes identifiers glossary].
====
