...
== Starting a Deployment [[start-deployment]]
...
----
$ osc describe dc <deployment_config>
----
...
NOTE: More fine grained rollback options are described in the
link:../cli_reference/basic_cli_operations.html#deployment-operations[deployment operations reference].
