...
After creating the the `rails-app` xref:../../dev_guide/projects.adoc#dev-guide-projects[project], you will be automatically switched to the new project namespace.
...
To bring your application to {product-title}, you need to specify a repository in which your application lives, using once again the xref:../../dev_guide/application_lifecycle/new_app.adoc#dev-guide-new-app[oc new-app] command, in which you will need to specify database related xref:../../using_images/db_images/postgresql.adoc#postgresql-environment-variables[environment variables] we setup in the xref:../../dev_guide/app_tutorials/ruby_on_rails.adoc#creating-the-database-service[Creating the Database Service]:
