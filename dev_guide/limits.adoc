...
A `*LimitRange*` object enumerates xref:compute_resources.adoc#dev-guide-compute-resources[compute resource
constraints] in a xref:projects.adoc#dev-guide-projects[project] at the pod and container level.
