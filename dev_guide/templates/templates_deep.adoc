...
<3> DNS name used to access our application. This DNS name needs to resolve to the ip address of the https://docs.openshift.com/enterprise/3.0/architecture/core_concepts/routes.adoc#routers[OpenShift router].
