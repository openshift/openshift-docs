...
You can use templates to limit the resouces that can be consumed by a project.
...
but the uniqueness of the NFS volume’s server and path is up to the administrator.
...
nforcing-disk-quotas[Enforcing Disk Quotas].
