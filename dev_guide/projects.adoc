...
administrator, you can create a new project using link:../cli_reference/overview.html[the CLI] or the link:../architecture/infrastructure_components/web_console.html[web console].
