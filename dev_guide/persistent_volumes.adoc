...
link:../install_config/persistent_storage/persistent_storage_nfs.html[NFS] plug-in, such as
...
currently in
link:../release_notes/ose_3.0/ose_3.0.1_release_notes.html[Technology
Preview]. The Administrator Guide provides instructions on provisioning an
OpenShift cluster with
link:../install_config/persistent_storage/persistent_storage_nfs.html[persistent storage using NFS].
====
endif::[]
