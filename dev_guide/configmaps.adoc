...
metadata:
  ...
  namespace: default
  resourceVersion: "407"-
  selfxref: /api/v1/namespaces/default/configmaps/game-config
...
metadata:
  ...
  namespace: default
  resourceVersion: "516"
  selfxref: /api/v1/namespaces/default/configmaps/game-config-2
...
metadata:
  ...
  namespace: default
  resourceVersion: "530"
  selfxref: /api/v1/namespaces/default/configmaps/game-config-3
...
metadata:
  ...
  namespace: default
  resourceVersion: "651"
  selfxref: /api/v1/namespaces/default/configmaps/special-config
...
metadata:
  ...
  selfxref: /api/v1/namespaces/default/configmaps/example-redis-config
