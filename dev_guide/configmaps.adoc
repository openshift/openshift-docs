...
data: <1>
  ...
  example.property.file: |-
    ...
    property.3=value-3
binaryData:
  bar: jjqDQKxU/GNsmW== <2>
----
<1> Contains the configuration data.
<2> Points to a files containing non-UTF8 data. For example, a binary Java keystore file.
...
[NOTE]
====
If you create a configmap from a file, you can include files containing non-UTF8 data will be placed in this new field in order to preserve the non-UTF8 data. 
