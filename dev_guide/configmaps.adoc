...
link:../dev_guide/secrets.html[secrets], but designed to more conveniently
...
link:#configmaps-creating-from-directories[Creating from Directories] example:
...
link:#configmaps-use-case-consuming-in-env-vars[Consuming in Environment
