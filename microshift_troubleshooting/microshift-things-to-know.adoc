...
* xref:../../microshift_configuring/microshift_auth_security/modules/microshift-custom-ca-con.adoc#microshift-custom-cas[Configuring custom certificate authorities]