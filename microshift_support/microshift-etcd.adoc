...
The {product-title} RPM includes the etcd service. The etcd service runs as a separate process and {microshift-short} automatically manages the etcd lifecycle.
