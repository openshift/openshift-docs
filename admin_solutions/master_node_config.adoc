...
or https://docs.openshift.org/latest/getting_started/administrators.adoc[Manual installation]
...
xref:../install_config/install/prerequisites.adoc#ensuring-host-access[SSH keys] to all the nodes referenced in the playbook.
====
