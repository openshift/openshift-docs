...
* xref:../admin_solutions/user_role_mgmt.adoc#setting-limits-users-projects[Place quotas and limits on projects],
enabling you to control pod and container limits, object counts, and compute
resources.
* xref:../admin_solutions/user_role_mgmt.adoc#limit-number-projects[Limit the number of projects a user can have].
* xref:../admin_solutions/user_role_mgmt.adoc#control-monitor-resources[Monitor resource usage],
...
* xref:../admin_solutions/user_role_mgmt.adoc#control-user-roles[Apply roles to users and service accounts],
enabling you to control what they are able to do in OpenShift projects and in
the cluster.
* xref:../admin_solutions/user_role_mgmt.adoc#share-templates-cluster[Share templates with all projects in the cluster].
* xref:../admin_solutions/user_role_mgmt.adoc#create-cluster-admin[Create other cluster administrators].
