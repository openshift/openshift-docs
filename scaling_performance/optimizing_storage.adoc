...
For more information about Overlay, including supportability and usage caveats, see
link:https://access.redhat.com/documentation/en-US/Red_Hat_Enterprise_Linux/7/html-single/7.3_Release_Notes/index.html#technology_previews_file_systems[RHEL 7.3 Release Notes].
