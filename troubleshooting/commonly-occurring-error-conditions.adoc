...
The main parts of Collector startup process are:
...
Failure at any step is considered to be fatal. If any part of the startup
procedure fails, the logs display a diagnostic summary detailing which steps
succeeded or failed .
