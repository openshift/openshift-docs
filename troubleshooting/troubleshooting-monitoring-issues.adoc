...
* xref:../configuring-user-workload-monitoring/configuring-performance-and-scalability-uwm.adoc#setting-scrape-sample-and-label-limits-for-user-defined-projects_configuring-performance-and-scalability-uwm[Setting scrape sample and label limits for user-defined projects]
endif::openshift-dedicated,openshift-rosa[]
