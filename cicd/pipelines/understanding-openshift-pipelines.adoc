...
* For more details on secured routes, see the xref:../../networking/ingress_load_balancing/routes/securing-routes.adocc#securing-routes[Securing routes] section.
