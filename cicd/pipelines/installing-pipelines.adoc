...
* Your cluster has the xref:../../post_installation_configuration/cluster-capabilities.adoc [Marketplace capability] enabled or the Red Hat Operator catalog source configured manually.
