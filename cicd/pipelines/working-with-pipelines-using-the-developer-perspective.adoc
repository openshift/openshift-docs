...
* You have access to an {product-title} cluster and have switched to the xref:../web_console/web-console-overview.adoc#about-developer-perspective[*Developer* perspective] in the web console.
