...
* For information on creating different types of secrets, see xref:../../nodes/pods/nodes-pods-secrets.html#nodes-pods-secrets-creating_nodes-pods-secrets[Creating secrets].
