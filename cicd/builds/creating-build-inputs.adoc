...
include::modules/nodes-pods-secrets-about.adoc[leveloffset=+2]

include::modules/nodes-pods-secrets-creating.adoc[leveloffset=+2]

.Additional informatiuon

* For information on creating different types of secrets, see xref:../../nodes/pods/nodes-pods-secrets.html#nodes-pods-secrets-creating_nodes-pods-secrets[Creating secrets] in _Nodes_.
...
include::modules/nodes-pods-secrets-updating.adoc[leveloffset=+2]
