...
[NOTE]
====
Because Builds releases on a different cadence from {product-title}, the Builds documentation is now available as a separate documentation set at link:builds_for_red_hat_openshift[builds for Red Hat OpenShift].
====
