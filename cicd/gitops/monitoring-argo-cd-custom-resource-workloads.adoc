...
* Optional: If you are enabling monitoring for an Argo CD instance already present in a user-defined project, ensure that the monitoring is xref:../../observability/monitoring/configuring-user-workload-monitoring/before-you-begin-uwm.adoc#enabling-monitoring-for-user-defined-projects-uwm_before-you-begin-uwm[enabled for user-defined projects] in your cluster.
+
[NOTE]
====
