 ...
 ** <<defining-remote-sources,Defining Remote Sources>>
 ...
 ** `metadata.annotations[build.shipwright.io/build-run-deletion]` - Enables deleting the `BuildRun` objects when you delete a `Build` object belong to a . The default is `false`.
