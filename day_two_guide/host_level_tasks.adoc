...
include::day_two_guide/topics/proc_etcd_backup.adoc[]

[[day-two-guide-etcd-restore]]
:context: host-level-tasks
=== etcd restore
include::day_two_guide/topics/proc_restore_etcd.adoc[]

[[restore-etcd-quorum-add-etcd-after-restoring]
=== etcd restore
include::day_two_guide/topics/proc_add-etcd-after-restoring.adoc
