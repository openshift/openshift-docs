...
# yum install etcd  
----
The package also installs the systemd service. Disable and mask the service as it shouldn't start when etcd runs in static pod.
+
----
# systemctl disable etcd.service 
# systemctl mask etcd.service
----
You can obtain etcd binary directly from upstream by running the following commands.
+
----
