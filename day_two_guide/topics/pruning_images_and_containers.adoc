...
To modify these settings manually edit the appropriate xref:../admin_guide/manage_nodes.adoc#modifying-nodes[node configuration map] as:
...
To modify this settings manually edit the appropriate xref:../admin_guide/manage_nodes.adoc#modifying-nodes[node configuration map] as:
...
Disk thresholds are configured in the appropriate xref:../admin_guide/manage_nodes.adoc#modifying-nodes[node configuration map] as:
