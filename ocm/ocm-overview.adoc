...
{cluster-manager} guides you to install {OCP}, {product-title}, and {product-short-name} clusters. It is also responsible for managing both {OCP} clusters after self-installation as well as your {product-title} and {product-short-name} clusters.
//Does this make sense? Is this a post-publish HCP pruning task?
