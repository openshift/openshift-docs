...
* For steps to add cluster notification contacts, see xref:../logging/rosa-accessing-the-service-logs.adoc#adding-cluster-notification-contacts_rosa-accessing-the-service-logs[Adding cluster notification contacts].
endif::openshift-rosa[]
