...
include::_attributes/attributes-openshift-openshift-dedicated.adoc[]
endif::openshift-dedicated[]
ifdef::openshift-rosa-hcp[]
include::_attributes/attributes-openshift-rosa-hcp.adoc[]
endif::openshift-rosa-hcp[]
ifdef::openshift-rosa[]
include::_attributes/attributes-openshift-rosa.adoc[]
...
[IMPORTANT]
====
This box tests the attribute sheets. `product-title` and `product-title-short`, so resolve to the appropriate names based on the distribution:
...
{cluster-manager} guides you to install {OCP}, Red Hat OpenShift Service on AWS (ROSA), and {dedicated} clusters. It is also responsible for managing both {OCP} clusters after self-installation as well as your ROSA and {dedicated} clusters.
