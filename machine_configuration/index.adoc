...
include::modules/machine-config-change.adoc[leveloffset=+2]

[role="_additional-resources"]
.Additional resources

* xref:../machine_configuration/machine-config-pool-custom.adoc#machine-config-pool-custom[About using custom machine config pools to configure nodes]
