...
= Configure nodes by using machine config objects
...
You can create a machine config that applies changes to all control plane or all worker nodes, or you can use xref:../machine_configuration/machine-config-pools-about.adoc#machine-config-pools-custom_machine-config-pools-about[custom machine config pools] that apply changes to a specific set of worker nodes.
