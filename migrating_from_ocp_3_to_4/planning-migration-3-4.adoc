...
For information on configuring your {product-title} 4 cluster, review the appropriate sections of the {product-title} documentation. For information on new features and other notable technical changes, review the xref:../release_notes/ocp-4-16-release-notes.adoc#ocp-4-16-release-notes[OpenShift Container Platform 4.16 release notes].
endif::[]
