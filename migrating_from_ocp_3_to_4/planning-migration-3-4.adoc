...
For more information, see xref:../observability/logging/logging-6.1/log6x-about#quick-start_logging-6x.adoc#quick-start_logging-6x[OpenShift Logging quick start].
...
For more information, see xref:../observability/logging/logging-6.1/log6x-about.adoc#log6x-about[About OpenShift Logging].
