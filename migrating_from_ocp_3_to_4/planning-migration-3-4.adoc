...
For more information, see xref:../architecture/architecture.adoc#architecture[{product-title} architecture].
...
For more information, see xref:../architecture/architecture-installation.adoc#installation-overview_architecture-installation[{product-title} installation overview].
