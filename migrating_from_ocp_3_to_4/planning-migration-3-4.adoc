...
<<<<<<< HEAD:migrating_from_ocp_3_to_4/planning-migration-3-4.adoc
...
=======
>>>>>>> 27b01b755... BZ1959400: Break out OCP 3 to 4 migration into top level doc:migration/migrating_3_4/planning-migration-3-to-4.adoc
