...
For more information on the explicitly unsupported logging cases, see the xref:../observability/logging/logging_release_notes/cluster-logging-support.adoc#cluster-logging-support[logging support documentation].
