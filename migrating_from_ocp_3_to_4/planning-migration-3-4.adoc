...
[WARNING]
====
No supported method exists for migrating from the OpenShift SDN network plugin to the OVN-Kubernetes network plugin in {product-title} 4.17. You must migrate to the OVN-Kubernetes plugin before upgrading to {product-title} 4.17.
====
