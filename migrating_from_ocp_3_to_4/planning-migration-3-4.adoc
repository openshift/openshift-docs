...
For more information on the removal of the OpenShift SDN network plugin and why it has been removed see link:https://access.redhat.com/articles/7065170[OpenShiftSDN CNI removal in OCP 4.17].

For information on OVN-Kubernetes features that are similar to features in the OpenShift SDN plugin see:

* xref:../networking/ovn_kubernetes_network_provider/configuring-egress-ips-ovn.adoc#configuring-egress-ips[Configuring an egress IP address]
...
* xref:../networking/ovn_kubernetes_network_provider/enabling-multicast.adoc#enabling-multicast[Enabling multicast for a project]

* xref:../networking/ovn_kubernetes_network_provider/deploying-egress-router-ovn-redirection.adoc#deploying-egress-router-ovn-redirection[Deploying an egress router pod in redirect mode]
...
// this content is not supported on this branch. For more information, see xrf:../observability/logging/cluster-logging-deploying.adoc#cluster-logging-deploying_cluster-logging-deploying[Installing OpenShift Logging].
...
// this content is not supported on this branch. For more information, see xrf:../observability/logging/cluster-logging.adoc#cluster-logging-about_cluster-logging[About OpenShift Logging].
...
// this content is not supported on this branch. For more information on the explicitly unsupported logging cases, see the xrf:../observability/logging/cluster-logging-support.adoc#cluster-logging-support[logging support documentation].
...
For more information, see xref:../observability/monitoring/managing-alerts.adoc#applying-custom-alertmanager-configuration_managing-alerts[Applying custom Alertmanager configuration].
