...
For more information, see xref:../observability/logging/logging-6.1/log6x-about-6.1#quick-start_logging-6x.adoc#quick-start_logging-6x-6.1[OpenShift Logging quick start].
...
For more information, see xref:../observability/logging/logging-6.1/log6x-about-6.1.adoc#log6x-about[About OpenShift Logging].
...
// The following link seems obsolete now
