...
For known issues, see the xref:../migration_toolkit_for_containers/release-notes/mtc-release-notes-1-8.adoc#migration-mtc-release-notes-1-8-3_mtc-release-notes[{mtc-short} {mtc-version} release notes].
