<<<<<<< HEAD:migrating_from_ocp_3_to_4/migrating-applications-3-4.adoc
[id='migrating-applications-3-4_{context}']
=======
[id="migrating-applications-3-4_{context}"]
>>>>>>> 27b01b755... BZ1959400: Break out OCP 3 to 4 migration into top level doc:migration/migrating_3_4/migrating-applications-with-cam-3-4.adoc
