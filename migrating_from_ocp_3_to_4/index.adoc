...
* xref:../migrating_from_ocp_3_to_4/planning-considerations-3-4.adoc#migration-dns-considerations_planning-considerations-3-4[DNS considerations]
** xref:../migrating_from_ocp_3_to_4/planning-considerations-3-4.adoc#isolating-dns-domain-of-target-cluster-from-clients_planning-considerations-3-4[Isolating the DNS domain of the target cluster from the clients].
** xref:../migrating_from_ocp_3_to_4/planning-considerations-3-4.adoc#setting-up-target-cluster-to-accept-source-dns-domain_planning-considerations-3-4[Setting up the target cluster to accept the source DNS domain].
...
Before you migrate your application workloads with the Migration Toolkit for Containers (MTC), review the xref:../migrating_from_ocp_3_to_4/premigration-checklists.adoc#premigration-checks[premigration checklists].
