...
include::modules/nw-ptp-gnrd-tech-preview-limitations-reference.adoc[leveloffset=+3]
...
* xref:../../../networking/advanced_networking/ptp/configuring-ptp.adoc#nw-ptp-gnrd-tech-preview-limitations-reference_configuring-ptp[Technology Preview limitations for Intel Granite Rapids-D Telecom Grandmaster]
