...
* You configured pod-level bonding. For more information, see xref:../../networking/hardware_networks/sriov-ha-bonding.adoc#using-pod-level-bonding[Combine SR-IOV interfaces with bonding].
