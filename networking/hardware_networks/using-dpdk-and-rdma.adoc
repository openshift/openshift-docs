...
* xref:../../scalability_and_performance/low_latency_tuning/cnf-reducing-nic-queues-with-nto.adoc#adjusting-nic-queues-with-the-performance-profile_cnf-reducing-nic-queues[Adjusting the NIC queues with the performance profile]
