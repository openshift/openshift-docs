...
include::modules/gwapi-configuring-internal-lb.adoc[leveloffset=+1]

include::modules/nw-ingress-gateway-api-internal-lb-annotations.adoc[leveloffset=+1]

include::modules/nw-ingress-gateway-api-verifying-status.adoc[leveloffset=+1]
