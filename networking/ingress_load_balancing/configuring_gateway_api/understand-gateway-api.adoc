...
By using a well-designed Gateway API deployment, you can use a portable and role-oriented routing infrastructure. To successfully plan your Gateway API implementation, review the following concepts:
...
include::modules/configuring-gateway-api.adoc[leveloffset=+1]
