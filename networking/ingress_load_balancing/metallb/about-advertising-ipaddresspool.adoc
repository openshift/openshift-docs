...
// Configure MetalLB with a secondary interface (MachineConfig method)
...
include::modules/nw-enabling-ip-forwarding-nmstate.adoc[leveloffset=+1]

// nmstate IP forwarding parameter reference
include::modules/nw-nmstate-ip-forwarding-parameter.adoc[leveloffset=+1]

// IP forwarding interoperability considerations
include::modules/nw-ip-forwarding-interoperability.adoc[leveloffset=+1]
