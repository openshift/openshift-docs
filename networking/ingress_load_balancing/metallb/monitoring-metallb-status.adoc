...
// View ConfigurationState (moved out until 422)
//include::modules/nw-metallb-configuration-state.adoc[leveloffset=+1]

// Add an address pool
include::modules/nw-metallb-viewing-ipaddresspool-status.adoc[leveloffset=+1]

// View ServiceL2Status not currently in scope
// include::modules/nw-metallb-viewing-viewing-servicel2status.adoc[leveloffset=+1]
...
// Troubleshooting
include::modules/nw-metallb-status-troubleshooting.adoc[leveloffset=+1]
