...
[IMPORTANT]
====
Applications in the cluster are not allowed to send traffic with a destination port of `22623` or `22624`. These ports are reserved for use by the {product-title} and all other traffic sent to these port numbers will be dropped.
====
