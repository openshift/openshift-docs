...
[NOTE]
====
Applications in the cluster are not allowed to send traffic with a destination port of 22623 or 22624. These ports are reserved for use by the OpenShift platform and all other traffic destined to these port numbers will be dropped.
====
