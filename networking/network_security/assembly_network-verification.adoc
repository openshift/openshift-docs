...
include::modules/con_understanding-network-verification.adoc[leveloffset=+1]

include::modules/ref_nv-scope-network-verification-checks.adoc[leveloffset=+1]
...
include::modules/con_automatic-network-verification-bypassing.adoc[leveloffset=+1]

ifdef::openshift-rosa[]
include::modules/con_running-network-verification-manually.adoc[leveloffset=+1]

endif::openshift-rosa[]
ifdef::openshift-rosa,openshift-dedicated[]
include::modules/proc_running-network-verification-manually-ocm.adoc[leveloffset=+1]

endif::openshift-rosa,openshift-dedicated[]
ifdef::openshift-rosa,openshift-rosa-hcp[]
include::modules/proc_running-network-verification-manually-cli.adoc[leveloffset=+2]
