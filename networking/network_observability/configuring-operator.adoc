...
include::modules/nw-network-observability-view-flowcollector-state.adoc[leveloffset=+2]
...
include::modules/modules/nw-network-observability-view-flowcollector-state.adoc[leveloffset=+2]