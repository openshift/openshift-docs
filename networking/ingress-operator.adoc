...
[role="_additional-resources_networkingingress-controller-parameters"]
.Additional resources
* xref:../networking/ingress-operator.adoc#nw-ingress-controller-configuration-parameters_configuring-ingress[Ingress Controller endpoint publishing strategy]
