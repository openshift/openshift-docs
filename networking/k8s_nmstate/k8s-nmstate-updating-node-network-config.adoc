...
* xref:../../networking/k8s_nmstate/k8s-nmstate-updating-node-network-config.adoc#virt-removing-interface-from-nodes_k8s-nmstate-updating-node-network-config[Removing an interface from nodes]
...
* xref:../../networking/k8s_nmstate/k8s-nmstate-updating-node-network-config.adoc#virt-example-nmstate-IP-management_k8s-nmstate-updating-node-network-config[Examples of different IP management methods in policies]
