...
include::modules/nw-about-per-interface-ip-forwarding.adoc[leveloffset=+1]

// Enable per-interface IP forwarding using nmstate API
include::modules/nw-enabling-ip-forwarding-nmstate.adoc[leveloffset=+2]

// nmstate IP forwarding parameter reference
include::modules/nw-nmstate-ip-forwarding-parameter.adoc[leveloffset=+2]

.Additional resources

* xref:../../networking/ingress_load_balancing/metallb/about-advertising-ipaddresspool.adoc#nw-metallb-configure-secondary-interface_about-advertising-ip-address-pool[Enabling per-interface IP forwarding by using a MachineConfig]
* xref:../../networking/ingress_load_balancing/metallb/about-advertising-ipaddresspool.adoc#nw-ip-forwarding-interoperability_about-advertising-ip-address-pool[IP forwarding interoperability considerations]
