...
* Review the xref:../installing/install_config/configuring-firewall.adoc#configuring-firewall[sites that your cluster requires access to]
...
endif::openshift-dedicated,openshift-online,openshift-aro[]
