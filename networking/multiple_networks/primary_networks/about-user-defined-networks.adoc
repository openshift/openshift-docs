...
[role="_abstract"]
User-defined networks extend OVN-Kubernetes to enable custom Layer 2 and Layer 3 network segments with default isolation, providing enhanced network flexibility, security, and segmentation capabilities for multi-tenant deployments and custom network architectures.

//about UDN
include::modules/nw-udn-basics.adoc[leveloffset=+1]
