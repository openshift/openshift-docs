...
You can manage the life cycle of an additional network with one of the following two approaches:
...
* By applying a YAML manifest. With this method, you can manage the additional network directly by creating an `NetworkAttachmentDefinition` object. This approach allows for the chaining of CNI plugins.
