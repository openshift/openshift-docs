...
[id="udn-support-matrix_{context}"]
== Support matrix for UserDefinedNetworks and secondary networks {product-title}

include::modules/nw-udn-support-matrix-primary-secondary.adoc[leveloffset=+1]

.Additional resources

xref:../../networking/ovn_kubernetes_network_provider/enabling-multicast.adoc#ovn-kubernetes-enabling-multicast[About multicast].
