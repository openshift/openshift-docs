...
[NOTE]
====
User-defined networks are not available for use with the Multus CNI plugin.
====
...
For a complete list of supported CNI plugins, see "Additional networks in {product-title}".
