...
* xref:../../../networking/hardware_networks/using-pod-level-bonding.adoc#nw-sriov-cfg-creating-bond-network-attachment-definition_using-pod-level-bonding[Creating a bond network attachment definition].
