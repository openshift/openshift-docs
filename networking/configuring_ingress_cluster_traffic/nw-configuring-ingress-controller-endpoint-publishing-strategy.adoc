...
// Adding a second `HostNetwork` endpoint publishing strategy
include::modules/nw-ingress-controller-second-endpoint-publishing-strategies.adoc[leveloffset=+2]
