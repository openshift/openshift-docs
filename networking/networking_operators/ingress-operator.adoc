...
:../../rest_apis/ingresscontroller-operator-openshift-io-v1.adoc#ingresscontroller-operator-openshift-io-v1[IngressController operator.openshift.io/v1]
////

// Enabling DCM
include::modules/enabling-disabling-dcm.adoc[leveloffset=+2]
...
include::modules/nw-about-haproxy-versions.adoc[leveloffset=+2]

include::modules/nw-selecting-haproxy-version.adoc[leveloffset=+3]

include::modules/nw-verifying-haproxy-version.adoc[leveloffset=+3]
...
include::modules/osd-ingress-excluded-namespaces-ocm-cli.adoc[leveloffset=+2]
