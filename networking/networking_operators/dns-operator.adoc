...
* xref:../../networking/ingress_load_balancing/configuring_ingress_cluster_traffic/configuring-ingress-cluster-traffic-ingress-controller.adoc#troubleshooting-nids-ai-agent_configuring-ingress-cluster-traffic-ingress-controller[Troubleshooting NIDS issues with an AI agent]
