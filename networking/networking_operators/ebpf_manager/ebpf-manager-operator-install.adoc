...
* ../../../networking/network_security/ebpf_manager/ebpf-manager-operator-deploy.adoc#bpfman-operator-deploy[Deploying a containerized eBPF program]
* ../../../networking/network_security/ingress-node-firewall-operator.adoc#bpfman-infw-configure_ingress-node-firewall-operator[Configuring Ingress Node Firewall Operator to use the eBPF Manager Operator]
