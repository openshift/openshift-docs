...
* To set up a {product-title} cluster with multiple availability zones, see xref:../../rosa_install_access_delete_clusters/rosa-sts-creating-a-cluster-quickly.adoc#rosa-sts-creating-a-cluster-quickly[Creating a {product-title} cluster with STS using the default options]
endif::openshift-rosa[]
ifdef::openshift-rosa-hcp[]
* To set up a {product-title} cluster with multiple availability zones, see xref:../../rosa_hcp/rosa-hcp-sts-creating-a-cluster-quickly.html[A multi-AZ {product-title} cluster]
