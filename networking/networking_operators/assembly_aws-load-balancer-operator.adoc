...
include::modules/con_albo-prerequisites.adoc[leveloffset=+1]

include::modules/proc_aws-load-balancer-operator-environment.adoc[leveloffset=+2]

include::modules/proc_tagging-aws-vpc-subnets.adoc[leveloffset=+2]
...
include::modules/proc_albo-installation.adoc[leveloffset=+1]
...
include::modules/proc_albo-validate-install.adoc[leveloffset=+1]

include::modules/proc_albo-deleting.adoc[leveloffset=+1]