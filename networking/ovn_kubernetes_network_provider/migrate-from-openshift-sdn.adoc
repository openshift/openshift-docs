...
[WARNING]
====
There is no supported migration from OpenShift SDN network plugin to OVN-Kubernetes network plugin in {product-title} 4.17. You must migrate to the OVN-Kubernetes plugin before upgrading to {product-title} 4.17.
====
