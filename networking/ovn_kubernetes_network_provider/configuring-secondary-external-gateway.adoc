...
The external gateway feature offers the following benefits:
...
* link:https://kubernetes.io/docs/concepts/overview/working-with-objects/labels/#set-based-requirement[Set-based requirement (Kubernetes documentation)]
