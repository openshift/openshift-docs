...
* xref:../../networking/ingress-operator.adoc#nw-ingress-creating-a-reencrypt-route-with-a-custom-certificate_secured-routes[Configuring a common CA bundle for validating re-encrypt routes]
