...
[IMPORTANT]
====
From {product-title} 4.18 onwards, FRR-K8s must be enabled from the Cluster Ntework Operator (CNO) configuration. For more information, see xref:../../networking/bgp-routing/configuring-bgp-routing.adoc#nw-bgp-routing-config[Configuring BGP routing].
====
...
- xref:../../networking/bgp-routing/about-bgp-routing.adoc#about-bgp-routing[About BGP routing]
