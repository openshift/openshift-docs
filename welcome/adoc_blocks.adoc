...
Definition lists are not as common, but can be counterintuitive to embed anything other than plain text into.

A definition list item with list content under subheading::
+
--
.Cat breeds
...
A definition list item with tabular content::
+
--
Here are some cloud providers:
|====
