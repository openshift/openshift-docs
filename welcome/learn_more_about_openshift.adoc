...
| xref:../observability_overview/observability-overview.adoc#cluster-logging-index_observability-overview[Logging]
...
a|* xref:../architecture/understanding-development.adoc#understanding-development[Understand {product-title} development]
* xref:../applications/projects/working-with-projects.adoc#working-with-projects[Work with projects]
