...
* xref:../installing/installing_ibm_cloud_public/installing-ibm-cloud-restricted.adoc#installing-ibm-cloud-restricted[{ibm-cloud-name}]
...
//// 
Hiding until WMCO 10.17.0 releases, replace as the last row of the above table after WMCO GAs
