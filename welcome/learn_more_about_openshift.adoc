...
| https://docs.redhat.com/en/documentation/red_hat_build_of_opentelemetry/latest/html/receiving_telemetry_data/otel-receiving-telemetry-data[Receiving telemetry data from multiple clusters]
