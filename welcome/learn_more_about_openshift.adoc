...
* xref:../hosted_control_planes/hcp-deploy/hcp-deploy-ibmpower.adoc#hcp-deploy-ibmpower[Deploying {hcp} on {ibm-power-title}]

| xref:../hosted_control_planes/hcp-disconnected/hcp-deploy-dc.adoc#hcp-deploy-dc[Deploying {hcp} in a disconnected environment]
