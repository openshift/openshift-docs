...
* xref:../getting_started/install_openshift.adoc##getting-started-install-openshift[As a cluster administrator]
endif::[]
|===
...
* xref:../release_notes/osd_latest_product_updates.adoc#release-notes-osd-product-updates[Find out the what's new in the latest release of {product-title} 3]
endif::[]
