...
* xref:../release_notes/ose_3_1_release_notes.adoc#release-notes-ose-3-1-release-notes[Find out the what's new in the latest release of {product-title} 3]
endif::[]
ifdef::openshift-dedicated[]
* xref:../release_notes/osd_3_1_release_notes.adoc#release-notes-osd-3-1-release-notes[Find out the what's new in the latest release of {product-title} 3]
endif::[]

* xref:../architecture/index.adoc#architecture-index[Learn about the architecture of OpenShift]

* xref:../cli_reference/index.adoc#cli-reference-index[Get started with OpenShift's CLI]
|===
...
* xref:../getting_started/developers/developers_console.adoc#getting-started-developers-developers-console[As an application developer]
...
* xref:../install_config/install/index.adoc#install-config-install-index[Choose a quick or advanced installation of {product-title} at your site]
...
* xref:../dev_guide/new_app.adoc#dev-guide-new-app[Bring your code or use example repos to create a new application]
