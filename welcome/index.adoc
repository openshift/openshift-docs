...
[.lead]
Welcome to the official {rh-rhacs-first} documentation, where you can learn about {product-title-short} and start exploring its features.
...
- *xref:../installing/acs-installation-platforms.adoc#install-platforms-methods[Installation methods for different platforms]*: Determine the best installation method for your product and platform.
