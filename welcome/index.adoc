...
* Select the task that interests you from the contents of this Welcome pages.

== Installation activities

- *xref:../installing/acs-high-level-overview.adoc#install-platforms-methods_acs-high-level-overview[Understanding installation methods for different platforms]*: Determine the best installation method for your product and platform.
...
- *xref:../operating/manage-compliance/compliance-feature-overview.adoc#compliance-feature-overview[Compliance feature overview]*: Understand how to run automated checks and validate compliance based on industry standards, including CIS, NIST, PCI, and HIPAA.
- *xref:../operating/manage-vulnerabilities/vulnerability-management.adoc#manage-vulnerabilities[Managing vulnerabilities]*: Learn how to identify and prioritize vulnerabilities for remediation.
