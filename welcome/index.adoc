...
xref:../installing/installing_gcp/upi/installing-restricted-networks-gcp.adoc#installing-restricted-networks-gcp[{gcp-short}],
...
xref:../installing/installing_gcp/ipi/installing-gcp-vpc.adoc#installing-gcp-vpc[{gcp-short}] or an existing
xref:../installing/installing_azure/ipi/installing-azure-vnet.adoc#installing-azure-vnet[VNet]
on Microsoft Azure, you can install a cluster. Also consider xref:../installing/installing_gcp/ipi/installing-gcp-shared-vpc.adoc#installation-gcp-shared-vpc-prerequisites_installing-gcp-shared-vpc[Installing a cluster on {gcp-short} into a shared VPC]
...
xref:../installing/installing_gcp/ipi/installing-gcp-private.adoc#installing-gcp-private[{gcp-short}], or
