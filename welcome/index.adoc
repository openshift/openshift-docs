...
xref:../installing/installing_aws/installing-restricted-networks-aws.adoc[AWS],
GCP,
xref:../installing/installing_vsphere/installing-restricted-networks-vsphere.adoc[vSphere],
or
xref:../installing/installing_bare_metal/installing-restricted-networks-bare-metal.adoc[bare metal]
...
- **Install a cluster in an existing network**: If you use an existing VPC in
xref:../installing/installing_aws/installing-aws-vpc.adoc[AWS] or
xref:../installing/installing_gcp/installing-gcp-vpc.adoc[GCP] or an existing
xref:../installing/installing_azure/installing-azure-vnet.adoc[VNet]
...
xref:../installing/installing_aws/installing-aws-private.html[AWS],
xref:../installing/installing_azure/installing-azure-private.html[Azure], or
xref:../installing/installing_gcp/installing-gcp-private.html[GCP].
You still require internet access to access the cloud APIs and installation
media.
...
- **Deploy Helm Charts**: 
xref:../cli_reference/helm-cli/getting-started-with-helm-on-openshift-container-platform.html[Helm 3]
...
- **xref:../rest_api/[REST API Guide]**: Lists {product-title} application programming interface endpoints.
...
- **xref:../registry/registry-options.adoc#registry-options[Manage container registries]**: Each {product-title} cluster includes a built-in container registry for storing its images. You can also configure a separate link:https://access.redhat.com/documentation/en-us/red_hat_quay/[Red Hat Quay] registry to use with {product-title}. The link:https://quay.io[Quay.io] site provides a public container registry that stores {product-title} containers and Operators.
...
xref:../storage/red-hat-openshift-container-storage.html[Red Hat OpenShift Container Storage],
