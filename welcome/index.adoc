...
Then, see
xref:../release_notes/ocp-4-7-release-notes.adoc#ocp-4-7-release-notes[Release notes].
endif::[]
endif::[]
...
xref:../installing/installing-mirroring-installation-images.adoc#installing-mirroring-installation-images[mirror the {product-title} installation images]
...
Use xref:../web_console/web-console-overview.adoc#about-developer-perspective_web-console-overview[the *Developer* perspective] in the {product-title} web console to easily
...
If an update is available from the Container Platform update service, you apply that cluster update from either the xref:../updating/updating-cluster-within-minor.adoc#updating-cluster-within-minor[web console] or the xref:../updating/updating-cluster-cli.adoc#updating-cluster-cli[CLI].
...
- **xref:../monitoring/monitoring-overview.adoc#monitoring-overview[Monitoring overview]**: Learn to
