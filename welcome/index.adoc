...
// [%header,format=csv,subs="attributes+"]
// |===
// include::snippets/4.18/test.csv[]
// |===
...
// [%header,format=csv,subs="attributes+"]
// |===
// include::https://raw.githubusercontent.com/openshift-kni/commatrix/main/docs/{product-version}/commatrix-common-master.csv[]
// |===

This is version: {product-version}.
