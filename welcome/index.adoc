...
{product-title} is currently available in the link:https://cloud.ibm.com/docs/openshift?topic=openshift-regions-and-zones[following regions].
...
endif::openshift-enterprise,openshift-webscale,openshift-origin,openshift-dedicated[]
