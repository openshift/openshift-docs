...
* xref:../install_config/install/planning.adoc#install-config-install-planning[As a cluster administrator]
endif::[]
|===
...
* xref:../install_config/index.adoc#install-config-index[Perform an advanced installation of {product-title} at your site]
