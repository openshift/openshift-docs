...
Learn to xref:../monitoring/cluster_monitoring/managing-cluster-alerts.adoc#managing-cluster-alerts[manage alerts]
using the Alertmanager UI.
Learn to xref:../monitoring/cluster_monitoring/examining-cluster-metrics.adoc#examining-cluster-metrics[visualize and examine cluster metrics] with the Metrics UI.
