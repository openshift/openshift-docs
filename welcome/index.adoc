...
[.lead]
Welcome to the official {product-title} {product-version} documentation, where you can
...
- **xref:../monitoring/monitoring-overview.adoc#monitoring-overview[Monitor clusters]**: Learn to
