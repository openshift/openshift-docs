...
ifdef::openshift-enterprise[]
* xref:../welcome/revhistory_full.adoc#welcome-revhistory-full[Find out the what's new in the latest release of {product-title} 3]
endif::[]
ifdef::openshift-dedicated[]
* xref:../welcome/revhistory_all.adoc#welcome-revhistory-all[Find out the what's new in the latest release of {product-title} 3]
endif::[]
...
* xref:../dev_guide/application_lifecycle.adoc#dev-guide-application-lifecycle[Understand the application life cycle on {product-title}]
