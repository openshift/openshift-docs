...
- **xref:../installing/installing_ibm_powervs/preparing-to-install-on-ibm-power-reg-vs.adoc#preparing-to-install-on-ibm-power-reg-vs[Install a cluster on {iibm-cloud-bm-reg} Virtual Server]**: You can install {product-title} on {iibm-cloud-bm-reg} Virtual Server on installer-provisioned infrastructure.

- **xref:../installing/installing_ibm_power/installing-ibm-power-reg.adoc#installing-ibm-power-reg[Install a cluster on {iibm-cloud-bm-reg}]**: You can install {product-title} on {iibm-cloud-bm-reg} on user-provisioned infrastructure.
...
ifndef::openshift-origin[]
- **xref:../installing/installing_ibm_z/installing-ibm-z-reg.adoc#installing-ibm-z-reg[Install a cluster with z/VM on {ibm-z-reg} and {ibm-linux-one-reg}]**: You can install {product-title} with z/VM on {ibm-z-reg} and {ibm-linux-one-reg} on user-provisioned infrastructure.

- **xref:../installing/installing_ibm_z/installing-ibm-z-reg-kvm.adoc#installing-ibm-z-reg-kvm[Install a cluster with RHEL KVM on {ibm-z-reg} and {ibm-linux-one-reg}]**: You can install {product-title} with RHEL KVM on {ibm-z-reg} and {ibm-linux-one-reg} on user-provisioned infrastructure.
endif::openshift-origin[]
...
xref:../installing/installing_ibm_z/installing-restricted-networks-ibm-z-reg.adoc#installing-restricted-networks-ibm-z-reg[{ibm-z-reg} and {ibm-linux-one-reg} with z/VM], xref:../installing/installing_ibm_z/installing-restricted-networks-ibm-z-reg-kvm.adoc#installing-restricted-networks-ibm-z-reg-kvm[{ibm-z-reg} and {ibm-linux-one-reg} with RHEL KVM], xref:../installing/installing_ibm_power/installing-restricted-networks-ibm-power-reg.adoc#installing-restricted-networks-ibm-power-reg[{iibm-cloud-bm-reg}],
 or
