...
Use the
xref:../applications/application_life_cycle_management/odc-working-with-applications-in-the-topology-view.adoc#odc-viewing-application-composition-using-topology-view[Topology view]
