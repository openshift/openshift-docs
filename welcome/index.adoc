...
Then, see the
xref:../release_notes/ocp-4-11-release-notes.adoc#ocp-4-11-release-notes[release notes].
endif::[]
endif::[]
...
ifndef::openshift-origin[]
- **xref:../installing/installing_ibm_cloud_power_vs/preparing-to-install-on-ibm-cloud-power-vs.adoc#preparing-to-install-on-ibm-cloud-power-vs[Install a cluster on IBM Cloud Power VS]**: You can install {product-title} on IBM Cloud Power VS on installer-provisioned infrastructure.
