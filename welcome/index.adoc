...
- **xref:../storage/persistent_storage/persistent-storage-ocs.adoc#red-hat-openshift-container-storage[Install {rh-storage-first}]**: You can install {rh-storage-first} as an Operator to provide highly integrated and simplified persistent storage management for containers.
endif::[]
...
xref:../storage/persistent_storage/persistent-storage-ocs.adoc#red-hat-openshift-container-storage[Red Hat {rh-storage-first}],
