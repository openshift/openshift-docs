...
by xref:../machine_management/deploying-machine-health-checks.adoc#deploying-machine-health-checks[deploying health checks] and xref:../nodes/clusters/autoscaling/nodes-clusters-autoscaling-cluster.adoc#cluster-autoscaler-about[applying autoscaling to machines].
