...
* xref:../../observe/monitoring/monitoring-argo-cd-instances.adoc#monitoring-argo-cd-instances[Argo CD instance monitoring]
* xref:../../observe/monitoring/monitoring-the-gitops-operator-performance.adoc#monitoring-the-gitops-operator-performance[GitOps Operator performance]
