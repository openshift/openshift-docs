...
* xref:../../observe/monitoring/monitoring-argo-cd-instances.adoc#monitoring-argo-cd-instances[Monitor Argo CD instances]
* xref:../../observe/monitoring/monitoring-the-gitops-operator-performance.adoc#monitoring-the-gitops-operator-performance[Monitor the GitOps Operator performance]
