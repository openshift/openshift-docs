...
* xref:../../observe/monitoring/monitoring-argo-cd-custom-resource-workloads.adoc#monitoring-argo-cd-custom-resource-workloads[Argo CD custom resource workloads]