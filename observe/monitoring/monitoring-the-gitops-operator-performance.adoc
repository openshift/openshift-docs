...
* xref:../../install/installing-openshift-gitops.adoc#installing-gitops-operator-in-web-console_installing-openshift-gitops[Install GitOps by using web console]
