...
* link:https://docs.openshift.com/container-platform/latest/rest_api/workloads_apis/deploymentconfig-apps-openshift-io-v1.html[DeploymentConfig [apps.openshift.io/v1]]
* link:https://docs.openshift.com/container-platform/latest/installing/cluster-capabilities.html#deployment-config-capability_cluster-capabilities[DeploymentConfig capability]