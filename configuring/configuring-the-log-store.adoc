...
{loki-op} can deploy and manage a set of `NetworkPolicies` that restrict the communications to and from the Loki components to enhance security. On {ocp-product-title} versions 4.20 and later, `NetworkPolicies` are deployed by default.
