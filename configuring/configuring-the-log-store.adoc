...
You can enable network policies for Loki that {loki-op} will deploy. Use these network policies to allow or restrict communication to and from the Loki components to enhance security.
