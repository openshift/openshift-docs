...
[role="_abstract"]
The {TempoOperator} uses a custom resource definition (CRD) file that defines the architecture and configuration settings for creating and deploying {dt} resources. You can install the default configuration or modify the file.
