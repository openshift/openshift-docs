...
If you do not have an {aws-short} IAM role pre-configured with trust policies, you must first create the role with the required trust policies. Follow these procedures to create a secret and a `ClusterLogForwarder` CR and also a role:
