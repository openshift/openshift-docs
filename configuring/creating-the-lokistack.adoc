...
* You have determined the correct deployment size for your log volume. See xref:../installing/loki-deployment-sizing.adoc#loki-deployment-sizing[Loki deployment sizing].
* You have configured object storage for LokiStack. See xref:../installing/configuring-storage-for-lokistack.adoc#configuring-storage-for-lokistack[Configuring storage for LokiStack].
...
//Loki storage STS
[id="installing-log-storage-loki-sts_{context}"]
