...
In environments with complex log forwarding configurations, the Vector log collector exposes metrics that can affect the {product-title} monitoring stack.

include::modules/collector-metrics-cardinality-impact.adoc[leveloffset=+2]

include::modules/configuring-collector-metrics-profiles.adoc[leveloffset=+2]

include::modules/collector-minimal-metrics-reference.adoc[leveloffset=+2]
