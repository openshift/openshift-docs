...
* xref:../declarative_clusterconfig/customizing-permissions-by-creating-aggregated-cluster-roles.adoc#gitops-creating-aggregated-cluster-roles_customizing-permissions-by-creating-aggregated-cluster-roles[Create aggregated cluster roles]
...
With {gitops-title} 1.14 and later, as a cluster administrator, you can use aggregated cluster roles so that users can easily add user-defined permissions for Argo CD Application Controller.
