...
* xref:../declarative_clusterconfig/modules/gitops-using-argo-cd-instance-to-manage-cluster-scoped-resources.adoc[Using an Argo CD instance to manage cluster-scoped resources]
