...
* xref:../argocd_instance/setting-up-argocd-instance.adoc#setting-up-argocd-instance[Install a user-defined Argo CD instance]
...
* xref:../argocd_instance/setting-up-argocd-instance.adoc#gitops-configuring-common-cluster-roles-by-specifying-user-defined-cluster-roles-for-namespace-scoped-instances_setting-up-argocd-instance[Configure common cluster roles for namespace-scoped instances]
