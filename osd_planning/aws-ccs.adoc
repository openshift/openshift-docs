...
[role="_abstract"]
{product-title} provides a Customer Cloud Subscription (CCS) model that allows Red{nbsp}Hat to deploy and manage clusters into a customer's existing Amazon Web Services (AWS) account.
