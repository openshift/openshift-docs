...
include::modules/osd-gcp-shared-vpc-firewall-rules.adoc[leveloffset=+1]
...
* link:https://cloud.google.com/vpc/docs/provisioning-shared-vpc#set-up-shared-vpc[Set up Shared VPC]
