...
include::modules/ocm-cli-create-managed-dns-zone.adoc[leveloffset=+1]
...
include::modules/osd-gcp-firewall-rules.adoc[leveloffset=+1]
include::modules/osd-gcp-delete-firewall-rules.adoc[leveloffset=+2]
...
* xref:../osd_gcp_clusters/creating-a-gcp-cluster-with-workload-identity-federation.adoc#create-wif-configuration_osd-creating-a-cluster-on-gcp-with-workload-identity-federation[Creating a Workload Identity Federation configuration]

* link:https://github.com/openshift/managed-cluster-config/blob/master/resources/wif/latest/vanilla.yaml[Example Workload Identity Federation configuration for {product-title} on {GCP}]
