...
[role="_abstract"]
{product-title} provides a Customer Cloud Subscription (CCS) model that allows Red{nbsp}Hat to deploy and manage clusters in a customer's existing {gcp-first} account.
...
//Link throws "404 - page not found"
