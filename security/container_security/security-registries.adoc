...
[role="_abstract"]
Container registries store container images to organize repositories, manage access, and make images securely accessible to others.
...
To manage your own registry, you could purchase a container registry such as Red Hat Quay.
...
* link:https://access.redhat.com/products/red-hat-quay[Red Hat Quay Container Registry]