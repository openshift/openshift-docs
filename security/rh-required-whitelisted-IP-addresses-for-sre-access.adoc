...
[id="rh-required-allowed-IP-addresses-for-sre-access_{context}"]
include::_attributes/attributes-openshift-dedicated.adoc[]
include::_attributes/common-attributes.adoc[]
= Required allowlist IP addresses for SRE cluster access

:context: rh-required-allowed-IP-addresses-for-sre-access

toc::[]

[id="required-allowed-overview_{context}"]
== Overview
...
[id="required-allowed-access_{context}"]
