...
The following release notes track the development of the Security Profiles Operator in OpenShift Container Platform.

* link:https://access.redhat.com/errata/RHEA-2023:120658-03[RHEA-2023:120658-03 - Release of nbde tang server 1.0]

// the customer-facing link must be updated
