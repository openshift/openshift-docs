...
= Customizing the External Secrets Operator for Red Hat OpenShift using the ExternalSecretsConfig custom resource
...
include::modules/external-secrets-set-reconciliation-level.adoc[leveloffset=+1]
