...
By default, the {external-secrets-operator} exposes metrics for the Operator and the operand. You can configure OpenShift Monitoring to collect these metrics by using the Prometheus Operator format.
