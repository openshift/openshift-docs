...
[role="_abstract"]
By default, the {external-secrets-operator} exposes metrics for the Operator and the operands. You can configure the {product-title} monitoring stack to collect these metrics by using the Prometheus Operator format.
