...
By default, the {external-secrets-operator} exposes metrics for the Operator and the operands ('external-secrets'). You can configure OpenShift Monitoring to collect these metrics by using the Prometheus Operator format.
