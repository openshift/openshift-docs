...
ifdef::openshift-enterprise,openshift-origin[]
- _{product-title} Installation and Configuration_
** xref:{sourcedir}install_config/persistent_storage/persistent_storage_aws.adoc#install-config-persistent-storage-persistent-storage-aws
** xref:{sourcedir}install_config/persistent_storage/persistent_storage_gce.adoc#install-config-persistent-storage-persistent-storage-gce
** xref:{sourcedir}install_config/persistent_storage/persistent_storage_iscsi.adoc#install-config-persistent-storage-persistent-storage-iscsi
endif::[]
