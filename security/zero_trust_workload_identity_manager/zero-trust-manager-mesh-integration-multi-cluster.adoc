...
= Integrating SPIRE federation with multi-cluster {SMProductName}
...
[role="_abstract"]
Configure {spire-full} (SPIRE) federation across multiple {product-title} clusters to enable cross-cluster mutual TLS (mTLS) authentication and zero trust workload identity in a multi-cluster service mesh deployment.
...
[role="_additional-resources-deploy-spire"]
...
* link:https://docs.redhat.com/en/documentation/red_hat_openshift_service_mesh/latest/html-single/installing/index#ossm-multi-cluster-configuration-overview_ossm-multi-cluster-topologies[Multi-cluster configuration overview]
