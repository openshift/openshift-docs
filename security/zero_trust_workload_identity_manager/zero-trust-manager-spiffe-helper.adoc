...
[role="_abstract"]
SPIFFE Helper lets you provide Transport Layer Security (TLS) certificates on disk to your application when it cannot use the SPIFFE Workload API. Use it to eliminate manual certificate management and reduce the risk of expired certificates.
