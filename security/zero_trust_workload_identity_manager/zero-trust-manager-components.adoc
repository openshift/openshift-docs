...
[role="_abstract"]
Review the components available in {zero-trust-full} to understand the architecture. These components provide the foundation for identifying and securing your workloads.
