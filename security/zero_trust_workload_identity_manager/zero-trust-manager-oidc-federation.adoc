...
// configure the Entra ID OIDC
include::modules/zero-trust-manager-config-entra-oidc.adoc[leveloffset=+1]

// configure Azure
include::modules/zero-trust-manager-configure-aws.adoc[leveloffset=+1]
