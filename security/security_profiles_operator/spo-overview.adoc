...
You can create xref:../security_profiles_operator/spo-seccomp.adoc#[seccomp] and xref:../security_profiles_operator/spo-selinux.adoc#[SELinux] profiles to bind to pods and record from workloads, as well as synchronize across all worker nodes in a namespace.
