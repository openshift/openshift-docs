...
Use xref:../../security/security_profiles_operator/spo-logging.adoc#spo-advanced[SPO Advanced Audit Logging] to access logs in {op-system} containers for container-level security audit features.
