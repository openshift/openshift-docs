...
[source,terminal]
----
oc exec -n openshift-security-profiles my-pod -c nginx -- sh -c "touch /tmp/testfile.txt"
----
...
[source,terminal]
----
NODE=$(oc get pod my-pod -n openshift-security-profiles -o jsonpath='{.spec.nodeName}')
----
...
[source,terminal]
----
oc delete pod my-pod -n openshift-security-profiles
