...
.  Require images from the internal registry in the 'openshift' namespace are signed by the Red Hat public key
.  Require images from the internal registry in the 'production' namespace are signed by example.com's public key
