...
= Update the Compliance Operator
...
[role="_abstract"]
You can update the Compliance Operator on your {product-title} cluster as a cluster administrator to receive the latest features, bug fixes, and security updates.
//
