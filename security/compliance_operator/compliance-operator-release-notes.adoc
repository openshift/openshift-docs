...
* Compliance Operator 1.3.0 now supports {iibm-cloud-bm-reg} and {ibm-z-reg} for NIST 800-53 Moderate-Impact Baseline for {product-title} platform and node profiles.
