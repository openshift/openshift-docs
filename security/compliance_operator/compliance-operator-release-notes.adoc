...
* link:https://access.redhat.com/errata/RHSA-2026:XXXX[RHSA-2026:XXXX - OpenShift Compliance Operator 1.8.2 bug fix and enhancement update]

[id="compliance-operator-1-8-2-bug-fixes_{context}"]
=== Bug Fixes

*  Before this release, Compliance Operator used gnupg. Because a potential security threat has been identified in gnupg, this release of Compliance Operator mitigates the threat by using gnupg2. It is recommended that customers upgrade to this version of Compliance Operator. For more information, see (link:https://access.redhat.com/security/cve/cve-2025-68973[CVE-2025-68973]).
