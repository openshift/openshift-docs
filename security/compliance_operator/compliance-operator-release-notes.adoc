...
[id="compliance-operator-1-2-0-known-issues"]
=== Known issues

* When using the CIS {product-title} 4 Benchmark v1.4.0 profile, some controls might fail due to tighter permissions in the CIS profile than in {product-title}. For more information, see link:https://access.redhat.com/solutions/7024725[Solution article #7024725].
