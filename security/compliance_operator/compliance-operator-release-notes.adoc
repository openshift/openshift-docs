...
* It is recommended that customers upgrade to this version of Compliance Operator. For more information, see (link:https://access.redhat.com/security/cve/cve-2025-68973[CVE-2025-68973]).
