...
[id="co-overview-operator-cel-profilebundles"]
== Using Common Expression Language (CEL) rules from ProfileBundles

xref:../../security/compliance_operator/compliance-operator-cel-profilebundles.adoc#compliance-operator-cel-profilebundles[Using Common Expression Language (CEL) rules from ProfileBundles]
