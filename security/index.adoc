...
* xref:../security/certificate_types_descriptions/aggregated-api-server-certificates.adoc#cert-types-aggregated-api-server-certificates[Aggregated API Server Certificates]
