...
. xref:../../security/nbde_tang_server_operator/nbde-tang-server-operator-installing.adoc/nbde-tang-server-operator-configuring-managing.adoc#deploying-nbde-tang-server_configuring-and-managing-nbde-tang-server-operator[Deploying a Tang server using the NBDE Tang Server Operator]
