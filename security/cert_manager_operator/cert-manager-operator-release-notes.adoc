...
include::modules/cert-manager-operator-release-notes-1-19-2.adoc[leveloffset=+1]

include::modules/cert-manager-operator-release-notes-1-19-1.adoc[leveloffset=+1]
