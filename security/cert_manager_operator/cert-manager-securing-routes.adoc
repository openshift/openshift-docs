...
* xref:../../networking/ingress_load_balancing/routes/securing-routes.adoc#nw-ingress-route-secret-load-external-cert_secured-routes[Externally managed certificates]