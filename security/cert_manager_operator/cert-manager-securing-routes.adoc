...
* xref:../../networking/routes/nw-configuring-routes.adoc#nw-ingress-route-secret-load-external-cert_creating-advanced-routes[Creating a route with externally managed certificate]
