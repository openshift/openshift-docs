...
* Understand the xref:../../installing/acs-high-level-overview.adoc#install-platforms-methods_acs-high-level-overview[installation methods for different platforms].
