...
The following sections describe how to install the {loki-op} and the {clo} by using the CLI.
...
The following sections describe how to install the {loki-op} and the {clo} by using the web console.
