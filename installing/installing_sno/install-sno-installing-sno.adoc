...
You can install {sno} using the Assisted Service or you can generate an installation ISO using `openshift-installer`.

[id="installing-sno-assisted-installer"]
== Installing {sno} using the Assisted Service

To install {sno} with the Assisted Service, please refer to the following documentation:
