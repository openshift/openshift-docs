...
* xref:../../installing/installing_bare_metal/upi/upi/installing-bare-metal-network-customizations.adoc#configuring-dhcp-or-static-ip-addresses_installing-bare-metal-network-customizations[Configuring DHCP or static IP addresses]
