...
* You have configured object storage for LokiStack. See xref:../installing/configure-object-storage-for-lokistack.adoc#configure-object-storage-for-lokistack[Configure object storage for LokiStack].
