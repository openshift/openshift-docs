...
[role="_abstract"]
{rh-rhacs-first} and {rh-rhacscs-first} are supported on {ocp} and Kubernetes platforms.
...
* xref:../cloud_service/getting-started-rhacs-cloud-ocp.adoc#getting-started-rhacs-cloud-ocp[Getting started with {product-title-managed-short}]
...
* xref:../cloud_service/getting-started-rhacs-cloud-ocp.adoc#securing-kubernetes-clusters[Securing Kubernetes clusters for {product-title-managed-short}]
...
* xref:../cloud_service/getting-started-rhacs-cloud-ocp.adoc#getting-started-rhacs-cloud-ocp[Setting up {product-title-managed-short} on {osp}]
