...
* xref:../../installing/installing_vmc/installing-vmc-customizations.adoc#installation-configuration-parameters-additional-vsphere_installing-vmc-customizations[Additional VMware vSphere configuration parameters]

* xref:../../installing/installing_vmc/installing-vmc-customizations.adoc#deprecated-parameters-vsphere_installing-vmc-customizations[Deprecated VMware vSphere configuration parameters]
