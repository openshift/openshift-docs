...
* See xref:../updating/updating-cluster-between-minor.adoc#updating-cluster-within-minor[Updating a cluster between minor versions] for more information on updating your cluster.

//* See ../updating/updating-cluster-between-minor.adoc#understanding-upgrade-channels_updating-cluster-between-minor[OpenShift Container Platform upgrade channels and releases] for an overview about upgrade release channels.
