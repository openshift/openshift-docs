...
* link:https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/using-regions-availability-zones.html#opt-in-local-zone[Opt in to {aws-short} Local Zones ({aws-short} documentation)]
* link:https://aws.amazon.com/about-aws/global-infrastructure/localzones/locations[{aws-short} Local Zones available locations ({aws-short} documentation)]
* link:https://aws.amazon.com/about-aws/global-infrastructure/localzones/features[{aws-short} Local Zones features ({aws-short} documentation)]