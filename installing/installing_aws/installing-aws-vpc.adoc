...
* After installing a cluster on AWS into an existing VPC, you can xref:../../installing/installing_aws/installing-aws-outposts.adoc#installing-aws-outposts[extend the AWS VPC cluster into an AWS Outpost].
