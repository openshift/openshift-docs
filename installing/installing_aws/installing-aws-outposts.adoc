...
* xref:../../installing/installing_aws/installing-aws-outposts.adoc#nw-aws-load-balancer-with-outposts_installing-aws-outposts[Using the AWS Load Balancer Operator in an AWS VPC cluster extended into an Outpost]
...
For more information, see xref:../../installing/installing_aws/installing-aws-outposts.adoc#aws-outposts-load-balancer-clb_installing-aws-outposts[Using AWS Classic Load Balancers in an AWS VPC cluster extended into an Outpost].
...
For more information, see xref:../../installing/installing_aws/installing-aws-outposts.adoc#nw-aws-load-balancer-with-outposts_installing-aws-outposts[Using the AWS Load Balancer Operator in an AWS VPC cluster extended into an Outpost].
