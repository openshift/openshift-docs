...
include::modules/installation-aws-ipv6.adoc[leveloffset=+1]

[role="_additional-resources"]
.Additional resources
* link:https://docs.aws.amazon.com/vpc/latest/userguide/aws-ipv6-support.html[{aws-first} services that support IPv6]
