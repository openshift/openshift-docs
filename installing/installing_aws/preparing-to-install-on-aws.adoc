...
You can install {product-title} on Amazon Web Services (AWS) using installer-provisioned or user-provisioned infrastructure, depending on the needs of your use case.
