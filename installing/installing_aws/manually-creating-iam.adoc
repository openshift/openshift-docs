...
* For a detailed description of all available CCO credential modes and their supported platforms, see xref:../../operators/operator-reference.adoc#cloud-credential-operator_red-hat-operators[Cloud Credential Operator].
