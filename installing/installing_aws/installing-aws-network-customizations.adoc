...
[IMPORTANT]
====
Ensure the IngressController's public and private subnets are correctly tagged for Kubernetes to pick the correct internal load balancer. For more information about the proper tags for public and private subnets, see link:https://docs.openshift.com/container-platform/4.8/installing/installing_aws/installing-aws-user-infra.html#installation-cloudformation-dns_installing-aws-user-infra[CloudFormation template for the network and load balancers] in the AWS documentation.
====
