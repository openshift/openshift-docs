...
** xref:../../installing/installing_aws_user_infra/installing-aws-user-infra.adoc#installing-aws-user-infra[Install a cluster on infrastructure that you provision]
