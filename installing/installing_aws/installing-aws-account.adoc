...
* link:https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/using-regions-availability-zones.html[Availability zones within a region ({aws-short} documentation)]
* link:https://docs.aws.amazon.com/vpc/latest/userguide/vpc-nat-gateway.html[NAT Gateway ({aws-short} documentation)]
...
* link:https://aws.amazon.com/about-aws/global-infrastructure/[{aws-short} global infrastructure]
