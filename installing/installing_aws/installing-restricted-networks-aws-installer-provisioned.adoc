...
====
* You created your own VPC in AWS hosting the mirror registry. When installing to a restricted network using installer-provisioned infrastructure, you cannot use the installer-provisioned VPC; your mirror registry must be hosted on a user-provided VPC configured for the cluster to use.
