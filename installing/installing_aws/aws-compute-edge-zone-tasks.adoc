...
* link:https://aws.amazon.com/wavelength/features/[{aws-short} Wavelength features ({aws-short} documentation)]
...
* link:https://docs.aws.amazon.com/local-zones/latest/ug/how-local-zones-work.html[How {aws-short} Local Zones work ({aws-short} documentation)]
