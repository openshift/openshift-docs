...
[role="_abstract"]
In {product-title} version {product-version}, you can install a private cluster into an existing VPC and {ibm-power-server-name} workspace. The installation program provisions the rest of the required infrastructure, which you can then further customize.
