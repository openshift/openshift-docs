...
[role="_abstract"]
In {product-title} version {product-version}, you can install a customized cluster on {ibm-power-server-title} infrastructure that the installation program provisions.
