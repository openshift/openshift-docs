...
include::modules/installation-ibm-power-vs-ipv6.adoc[leveloffset=+1]

[role="_additional-resources"]
.Additional resources
* link:https://cloud.ibm.com/docs/power-iaas?topic=power-iaas-configuring-subnet[Configuring a private network subnet]
