...
include::modules/quotas-and-limits-ibm-power-reg-vs.adoc[leveloffset=+1]
...
== Next steps
* xref:../../installing/installing_ibm_powervs/creating-ibm-power-reg-vs-workspace.adoc#creating-ibm-power-reg-vs-workspace[Creating an {iibm-cloud-bm-reg} Virtual Server workspace]
