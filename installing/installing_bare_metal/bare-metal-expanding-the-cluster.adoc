...
[role="_abstract"]
Expand a bare-metal cluster by adding worker nodes or replacing control plane nodes.

include::modules/proc_ipi-install-preparing-the-bare-metal-node.adoc[leveloffset=+1]
...
include::modules/proc_ipi-install-replacing-a-bare-metal-control-plane-node.adoc[leveloffset=+1]
...
include::modules/proc_ipi-install-preparing-to-deploy-with-virtual-media-on-the-baremetal-network.adoc[leveloffset=+1]

include::modules/proc_ipi-install-diagnosing-duplicate-mac-address.adoc[leveloffset=+1]

include::modules/proc_ipi-install-provisioning-the-bare-metal-node.adoc[leveloffset=+1]
