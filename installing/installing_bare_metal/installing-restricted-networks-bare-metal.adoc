...
* See xref:../../installing/installing_bare_metal/installing-restricted-networks-bare-metal.adoc#installation-load-balancing-user-infra_installing-restricted-networks-bare-metal[Load balancing requirements for user-provisioned infrastructure] for more information on the DERP and application ingress load balancing requirements.
