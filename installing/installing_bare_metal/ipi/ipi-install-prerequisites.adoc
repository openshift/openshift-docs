...
[role="_abstract"]
You must meet several prerequisites before installing a installer-provisioned cluster on bare metal.
...
* link:https://ucshcltool.cloudapps.cisco.com/public/[UCSHCL]
...
include::modules/ipi-install-configuring-nodes-secure-boot.adoc[leveloffset=+2]
