...
* xref:../../../installing/install_config/installing-customizing.adoc#installation-special-config-butane-create_installing-customizing[Creating a MachineConfig object by using Butane]
...
include::modules/ipi-install-manifest-config-files.adoc[leveloffset=+1]
