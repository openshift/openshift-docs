...
* xref:../../installing/installing_bare_metal_ipi/ipi-install-expanding-the-cluster.adoc#preparing-the-bare-metal-node_ipi-install-expanding-the-cluster[Preparing the bare-metal node]
...
* xref:../../installing/installing_bare_metal_ipi/ipi-install-expanding-the-cluster.adoc#ipi-install-diagnosing-duplicate-mac-address_ipi-install-expanding-the-cluster[Diagnosing a duplicate MAC address when provisioning a new host in the cluster]
