...
* xref:../../installing/installing_bare_metal_ipi/ipi-install-installation-workflow#configuring-host-network-interfaces-in-the-install-config-yaml-file_ipi-install-installation-workflow[Configuring host network interfaces]

* xref:../../deploying_installer-provisioned_clusters_on_bare_metal/index#root-device-hints_ipi-install-installation-workflow[Root device hints]
