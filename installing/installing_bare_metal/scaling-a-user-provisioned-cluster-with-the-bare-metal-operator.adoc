...
* xref:../../installing/installing_bare_metal_ipi/ipi-install-expanding-the-cluster#preparing-the-bare-metal-node_ipi-install-expanding[Preparing the bare metal node]

* xref:../../installing/installing_bare_metal_ipi/ipi-install-installation-workflow#root-device-hints_ipi-install-installation-workflow[Root device hints]
