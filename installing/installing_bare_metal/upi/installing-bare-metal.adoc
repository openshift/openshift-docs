...
Ensure that you meet the following prerequisites before you start to install a cluster on bare-metal infrastructure.
...
* xref:../../../installing/installing_vsphere/upi/installing-vsphere.adoc#installation-vsphere-machines_installing-vsphere[Installing RHCOS and starting the OpenShift Container Platform bootstrap process]
