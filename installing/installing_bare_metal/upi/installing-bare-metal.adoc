...
* xref:../../../installing/installing_bare_metal/upi/installing-bare-metal.adoc#installation-user-infra-machines-advanced_installing-bare-metal[Advanced {op-system} installation configuration]
