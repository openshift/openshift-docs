...
* xref:../../../installing/installing_bare_metal/upi/installing-restricted-networks-bare-metal.adoc#installation-user-infra-machines-advanced_installing-restricted-networks-bare-metal[Advanced {op-system} installation configuration]
