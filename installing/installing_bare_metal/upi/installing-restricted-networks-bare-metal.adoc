...
* xref:../../../installing/installing_bare_metal/upi/installing-restricted-networks-bare-metal.adoc#installation-approve-csrs_installing-restricted-networks-bare-metal[Approving the certificate signing requests for your machines]
