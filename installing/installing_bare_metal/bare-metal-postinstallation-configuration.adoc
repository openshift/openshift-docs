...
* xref:../../networking/ovn_kubernetes_network_provider/converting-to-dual-stack.adoc#nw-dual-stack-convert_converting-to-dual-stack[Converting to IPv4/IPv6 dual-stack networking]
...
[role="_additional-resources"]
.Additional resources
* xref:../../rest_api/provisioning_apis/hardwaredata-metal3-io-v1alpha1.adoc#spec-hardware-nics-2[NICs]
