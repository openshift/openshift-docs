...
* If you use a firewall, you configured it to allow the sites that your cluster requires access to. See the Configuring the firewall to allow the sites that your cluster requires access to link in Additional resources.
...
[id="additional-resources_installing-azure-stack-hub-default-ipi"]
[role="_additional-resources"]
== Additional resources
