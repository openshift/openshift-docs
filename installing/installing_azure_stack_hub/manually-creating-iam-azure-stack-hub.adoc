...
** xref:../../installing/installing_azure_stack_hub/installing-azure-stack-hub-customizations.adoc#installing-azure-stack-hub-customizations[Installing a cluster on Azure Stack Hub with customizations].
