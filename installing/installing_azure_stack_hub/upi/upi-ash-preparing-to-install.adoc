...
[role="_abstract"]
You prepare to install an {product-title} cluster on Azure Stack Hub by verifying connectivity, configuring your account, generating SSH keys, downloading the installation program, and installing the CLI.
