...
include::modules/installation-azure-stack-hub-ipv6.adoc[leveloffset=+1]

[role="_additional-resources"]
.Additional resources
* link:https://learn.microsoft.com/en-us/azure-stack/user/azure-stack-network-overview[Azure Stack Hub networking]
