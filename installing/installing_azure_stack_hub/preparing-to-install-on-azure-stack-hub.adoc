...
* **xref:../../installing/installing_azure_stack_hub/installing-azure-stack-hub-default.adoc#installing-azure-stack-hub-default[Installing a cluster]**: You can install {product-title} on Azure Stack Hub infrastructure that is provisioned by the {product-title} installation program.
