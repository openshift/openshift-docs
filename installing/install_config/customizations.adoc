...
[NOTE]
====
If you install your cluster on IBM Z, not all features and functions are available. See the xref:../../release_notes/ocp-4-2-release-notes.adoc#ocp-4-2-10-features[release notes] for details.
====
