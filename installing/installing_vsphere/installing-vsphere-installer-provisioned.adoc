...
[role="_additional-resources"]
.Additional resources
* xref:../../post_installation_configuration/node-tasks.adoc#nodes-vsphere-scaling-machines-static-ip_post-install-node-tasks[Scaling a machines to use static IP addresses]
* xref:../../post_installation_configuration/node-tasks.adoc#nodes-vsphere-machine-set-scaling-static-ip_post-install-node-tasks[Using a machine set to scale machines with configured static IP addresses]
