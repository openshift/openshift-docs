...
For more information, see xref:../../machine_management/creating_machinesets/creating-machineset-vsphere.adoc#creating-machineset-vsphere[Creating a compute machine set].
====
