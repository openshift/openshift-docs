...
* xref:../../installing/installing_vsphere/ipi-vsphere-installation-reqs.adoc#installation-vsphere-minimum-permissions-storage_ipi-vsphere-installation-reqs[Minimum permissions for the storage components]
