...
* xref:../../installing/installing_vsphere/installing-restricted-networks-vsphere.adoc#installation-configuration-parameters-additional-vsphere_installing-restricted-networks-vsphere[Additional VMware vSphere configuration parameters]
