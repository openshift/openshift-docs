...
* xref:../../installing/installing_vsphere/upi-vsphere-installation-reqs.adoc#installation-vsphere-minimum-permissions-storage_upi-vsphere-installation-reqs[Minimum permissions for the storage components]
