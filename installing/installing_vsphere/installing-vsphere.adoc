...
[IMPORTANT]
====
If you do not plan on using the VMware CSI, removing the vCenter user authentication, or reducing the vCenter user's privileges consider that a bare-metal deployment may be more appropriate.
====
