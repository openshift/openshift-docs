...
.Next steps:
* xref:../../installing/installing_vsphere/installing-vsphere.adoc#configuring-vsphere-regions-zones_installing-vsphere[Configuring regions and zones for a VMware vCenter]

[role="_additional-resources"]
.Additional resources

* See xref:../../installing/installing_vsphere/installing-vsphere.adoc#installation-configuration-parameters-zone-region-vsphere_installing-vsphere[VMware vSphere zone and region enablement configuration parameters]
