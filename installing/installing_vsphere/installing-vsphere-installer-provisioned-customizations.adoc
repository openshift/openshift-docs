...
* See xref:../../installing/installing_vsphere/installing-vsphere-installer-provisioned-customizations.adoc#installation-configuration-parameters-zone-region-vsphere_installing-vsphere-installer-provisioned-customizations[VMware vSphere zone and region enablement configuration parameters]
