...
include::modules/installation-vsphere-static-ip-addresses.adoc[leveloffset=+2]

[role="_additional-resources"]
.Additional resources
* xref:../../post_installation_configuration/node-tasks.adoc#nodes-vsphere-scaling-machines-static-ip[Scaling a machines to use static IP addresses]
* xref:../../post_installation_configuration/node-tasks.adoc#nodes-vsphere-machine-set-scaling-static-ip[Using a machine set to scale machines with configured static IP addresses]
