...
* See xref:../../installing/installing_vsphere/installing-vsphere-installer-provisioned-network-customizations.adoc#installation-configuration-parameters-zone-region-vsphere_installing-vsphere-installer-provisioned-network-customizations[VMware vSphere zone and region enablement configuration parameters]
