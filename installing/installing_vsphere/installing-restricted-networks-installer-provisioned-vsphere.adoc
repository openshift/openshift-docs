...
* xref:../../installing/installing_vsphere/installing-restricted-networks-installer-provisioned-vsphere.adoc#installation-configuration-parameters-additional-vsphere_installing-restricted-networks-installer-provisioned-vsphere[Additional VMware vSphere configuration parameters]
