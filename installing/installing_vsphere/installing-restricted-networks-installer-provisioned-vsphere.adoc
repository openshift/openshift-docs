...
.Next steps:
* xref:../../installing/installing_vsphere/installing-restricted-networks-installer-provisioned-vsphere.adoc#configuring-vsphere-regions-zones_installing-restricted-networks-installer-provisioned-vsphere[Configuring regions and zones for a VMware vCenter]

[role="_additional-resources"]
.Additional resources

* See xref:../../installing/installing_vsphere/installing-restricted-networks-installer-provisioned-vsphere.adoc#installation-configuration-parameters-zone-region-vsphere_installing-restricted-networks-installer-provisioned-vsphere[VMware vSphere zone and region enablement configuration parameters]
