...
[NOTE]
====
If you are installing in a disconnected environment, you extract the installation program from the mirrored content.
====
...
[id="additional-resources_ipi-vsphere-preparing-to-install"]
