...
xref:../../../support/remote_health_monitoring/remote-health-reporting.adoc#opting-out-remote-health-reporting_remote-health-reporting[opt out of remote health reporting].
