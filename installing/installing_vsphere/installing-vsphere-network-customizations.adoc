...
.Next steps:
* xref:../../installing/installing_vsphere/installing-vsphere-network-customizations.adoc#configuring-vsphere-regions-zones_installing-vsphere-network-customizations[Configuring regions and zones for a VMware vCenter]

[role="_additional-resources"]
.Additional resources

* See xref:../../installing/installing_vsphere/installing-vsphere-network-customizations.adoc#installation-configuration-parameters-zone-region-vsphere_installing-vsphere-network-customizations[VMware vSphere zone and region enablement configuration parameters]
