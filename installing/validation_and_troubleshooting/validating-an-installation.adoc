...
* See link:https://docs.redhat.com/en/documentation/monitoring_stack_for_red_hat_openshift/4.16/html/about_monitoring/about-ocp-monitoring[About {product-title} monitoring] for more information about the {product-title} monitoring stack.
...
* See link:https://docs.redhat.com/en/documentation/monitoring_stack_for_red_hat_openshift/4.16/html/managing_alerts/managing-alerts-as-an-administrator[Managing alerts as an Administrator] for further details about alerting in {product-title}.
