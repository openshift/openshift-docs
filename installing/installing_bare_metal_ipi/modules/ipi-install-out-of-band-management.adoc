...
Each node must be accessible via out-of-band management. The provisioning node requires access to the out-of-band management network for a successful OpenShift 4 installation.
