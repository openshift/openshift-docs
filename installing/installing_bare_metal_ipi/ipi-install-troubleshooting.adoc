...
xref:investigating-an-unavailable-kubernetes-api_{context}[ a non-accessible API] to a xref:ipi-install-troubleshooting-reviewing-the-installation_{context}[validated installation].
