...
[NOTE]
====
If you are installing {product-title} on Google Cloud Dedicated sovereign cloud infrastructure, follow the dedicated Google Cloud Dedicated installation procedure instead.
For more information, see xref:../../installing/installing_gcp/installing-gcp-dedicated.adoc#installing-gcp-dedicated[Installing {product-title} on Google Cloud Dedicated].
====
