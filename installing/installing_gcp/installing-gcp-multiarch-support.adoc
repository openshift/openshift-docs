...
You can install a {gcp-first} cluster with the support for configuring multi-architecture compute machines. After installing the {gcp-full} cluster, you can add multi-architecture compute machines to the cluster in the following ways:
