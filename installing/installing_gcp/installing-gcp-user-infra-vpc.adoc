...
= Installing a cluster into a shared VPC on {gcp-short} using Deployment Manager templates
...
Before you can install {product-title}, you must configure a {gcp-full}
Platform ({gcp-short}) project to host it.
