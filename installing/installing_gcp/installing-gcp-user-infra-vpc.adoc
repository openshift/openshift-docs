...
== Configuring the {gcp-full} project that hosts your cluster

Before you can install {product-title}, you must configure a Google Cloud
Platform project to host it.
