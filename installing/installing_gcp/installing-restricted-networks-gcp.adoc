...
* xref:../../installing/installing-mirroring-installation-images.adoc#installing-mirroring-installation-images[Create a mirror registry on your bastion host] and obtain the `imageContentSources` data for your version of {product-title}.
+
[IMPORTANT]
====
