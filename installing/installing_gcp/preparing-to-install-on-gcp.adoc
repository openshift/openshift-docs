...
* **xref:../../installing/installing_gcp/installing-gcp-dedicated.adoc#installing-gcp-dedicated[Installing a cluster on Google Cloud Dedicated]**: You can install {product-title} on Google Cloud Dedicated, a sovereign cloud platform that provides {gcp-short} technology in a fully isolated environment with data and operational sovereignty guarantees.
