...
xref:../../installing/installing_gcp/ipi/installing-gcp-customizations.adoc#installing-gcp-customizations[install a customized cluster]
or xref:../../installing/installing_gcp/ipi/installing-gcp-default.adoc#installing-gcp-default[quickly install a cluster]
