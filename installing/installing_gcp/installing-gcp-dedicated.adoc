...
* xref:../../storage/dynamic-provisioning.adoc#change-default-storage-class_dynamic-provisioning[Changing the default storage class]
...
xref:../../support/remote_health_monitoring/remote-health-reporting.adoc#remote-health-reporting[opt out of remote health reporting].
