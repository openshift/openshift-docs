...
* xref:../../installing/install_config/configuring-firewall.adoc#configuring-firewall[Configuring the firewall to allow the sites]
...
include::modules/installation-gcp-config-project-intro.adoc[leveloffset=+1]
...
include::modules/installation-gcp-user-infra-requirements-intro.adoc[leveloffset=+1]
...
include::modules/installation-gcp-exporting-variables-intro.adoc[leveloffset=+1]
