...
= Installing a cluster on {gcp-full} with network customizations
...
provisions on {gcp-full}. By customizing your network
...
* To implement short-term credentials that are managed outside the cluster for individual components, follow the procedures in xref:../../installing/installing_gcp/installing-gcp-network-customizations.adoc#installing-gcp-with-short-term-creds_installing-gcp-network-customizations[Configuring a {gcp-full} cluster to use short-term credentials].
