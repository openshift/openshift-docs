...
include::modules/installation-oci-edge-ipv6.adoc[leveloffset=+1]

[role="_additional-resources"]
.Additional resources
* link:https://docs.oracle.com/iaas/releasenotes/compute-cloud-at-customer/release-note-m3-12-oct2025.htm[{oci-c3} October 2025 release notes]
