...
* xref:../../installing/installing_bare_metal/upi/ipi/ipi-install-installation-workflow.adoc#root-device-hints_ipi-install-installation-workflow[Root device hints]