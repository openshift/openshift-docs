...
* link:https://www.ibm.com/docs/en/linux-on-systems?topic=commands-chzdev[chzdev - Configure {ibm-z-name} devices]

* link:https://www.ibm.com/docs/en/linux-on-systems?topic=linuxonibm/com.ibm.linux.z.ludd/ludd_c_perscfg.html[Persistent device configuration]
