...
[id="installing-ibm-z-reg"]
= Installing a cluster with z/VM on {ibm-z-reg} and {ibm-linux-one-reg}
include::_attributes/common-attributes.adoc[]
:context: installing-ibm-z-reg
...
[role="_additional-resources"]
[id="additional-resources_configure-nbde-ibm-z-reg"]
.Additional resources
