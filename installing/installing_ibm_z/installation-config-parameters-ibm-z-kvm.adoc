...
[id="installation-config-parameters-ibm-z-kvm"]
= Installation configuration parameters for IBM Z(R) and {linuxoneProductName} with {op-system-base} KVM
include::_attributes/common-attributes.adoc[]
:context: installation-config-parameters-ibm-z-kvm
:platform: IBM Z
