...
[id="installing-ibm-z-reg-kvm"]
= Installing a cluster with {op-system-base} KVM on {ibm-z-reg} and {ibm-linux-one-reg}
include::_attributes/common-attributes.adoc[]
:context: installing-ibm-z-reg-kvm

toc::[]

[role="_abstract"]
In {product-title} version {product-version}, you can install a cluster on
{ibm-z-reg} or {ibm-linux-one-reg} infrastructure that you provision.
...
[role="_additional-resources"]
[id="additional-resources_configure-nbde-ibm-z-reg-kvm"]
.Additional resources
