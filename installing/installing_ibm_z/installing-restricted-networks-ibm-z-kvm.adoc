...
[id="installing-restricted-networks-ibm-z-reg-kvm"]
= Installing a cluster with {op-system-base} KVM on {ibm-z-reg} and {ibm-linux-one-reg} in a restricted network
include::_attributes/common-attributes.adoc[]
:context: installing-restricted-networks-ibm-z-reg-kvm

toc::[]

[role="_abstract"]
In {product-title} version {product-version}, you can install a cluster on
{ibm-z-reg} or {ibm-linux-one-reg} infrastructure that you provision in a restricted network.

[NOTE]
====
While this document refers to only {ibm-z-reg}, all information in it also applies to {ibm-linux-one-reg}.
====
...
include::modules/installation-requirements-user-infra-ibm-z-reg-kvm.adoc[leveloffset=+1]
...
* xref:../../scalability_and_performance/ibm-z-reg-recommended-host-practices.adoc#ibm-z-reg-recommended-host-practices[Recommended host practices for {ibm-z-reg} & {ibm-linux-one-reg} environments]
...
[role="_additional-resources"]
.Additional resources
* xref:../../installing/installing_ibm_z/installation-config-parameters-ibm-z-reg.adoc#installation-config-parameters-ibm-z-reg[Installation configuration parameters for {ibm-z-reg}]
...
include::modules/installation-ibm-z-reg-kvm-user-infra-installing-rhcos.adoc[leveloffset=+1]

include::modules/ibm-z-reg-secure-execution.adoc[leveloffset=+2]
...
[role="_additional-resources"]
[id="additional-resources_configure-nbde-ibm-z-reg-kvm-restricted"]
.Additional resources
...
include::modules/installation-ibm-z-reg-kvm-user-infra-machines-iso.adoc[leveloffset=+2]

include::modules/installation-full-ibm-z-reg-kvm-user-infra-machines-iso.adoc[leveloffset=+2]
