...
* *Full control*: You can deploy a cluster on xref:../../installing/installing_ibm_z/upi/installing-ibm-z.adoc#installing-ibm-z[infrastructure that you prepare and maintain], which provides maximum customizability. You can deploy clusters in connected or disconnected environments.
