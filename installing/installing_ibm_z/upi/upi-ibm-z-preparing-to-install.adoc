...
[role="_abstract"]
Before installing {product-title} on {ibm-z-name} or {ibm-linuxone-name} with user-provisioned infrastructure, you must verify connectivity, download the installation program, and prepare your pull secret and SSH key.
