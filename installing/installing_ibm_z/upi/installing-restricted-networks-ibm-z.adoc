...
[role="_abstract"]
You can install {product-title} on {ibm-z-name} or {ibm-linuxone-name} by using z/VM on infrastructure that you provision in a disconnected environment, using an internal mirror of the installation release content.
