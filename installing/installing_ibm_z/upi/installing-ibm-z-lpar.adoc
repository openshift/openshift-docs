...
[role="_abstract"]
In {product-title} version {product-version}, you can install a cluster directly in a logical partition (LPAR) on {ibm-z-name} or {ibm-linuxone-name} infrastructure that you provision, without using a hypervisor layer.
...
include::modules/prereqs-ibm-z-upi.adoc[leveloffset=+1]
