...
[role="_abstract"]
You can install {product-title} on {ibm-z-name} or {ibm-linuxone-name} by using {op-system-base} KVM on infrastructure that you provision in a disconnected environment, using an internal mirror of the installation release content.
