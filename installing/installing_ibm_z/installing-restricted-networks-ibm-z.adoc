...
* You have completed the tasks in xref:../../installing/installing_ibm_z/upi-ibm-z-preparing-to-install.adoc#upi-ibm-z-preparing-to-install[Preparing to install a cluster on {ibm-z-title} using user-provisioned infrastructure].
