...
[id="installing-restricted-networks-ibm-z-reg"]
= Installing a cluster with z/VM on {ibm-z-reg} and {ibm-linux-one-reg} in a restricted network
include::_attributes/common-attributes.adoc[]
:context: installing-restricted-networks-ibm-z-reg
...
include::modules/minimum-ibm-z-reg-system-requirements.adoc[leveloffset=+2]
include::modules/preferred-ibm-z-reg-system-requirements.adoc[leveloffset=+2]
...
[role="_additional-resources"]
[id="additional-resources_Configure-nbde-ibm-z-reg-restricted"]
.Additional resources
...
include::modules/installation-ibm-z-reg-user-infra-machines-iso.adoc[leveloffset=+1]
