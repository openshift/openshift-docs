...
[role="_abstract"]
In {product-title} {product-version}, you can install a cluster in a restricted network on an existing {ibm-cloud-name} VPC by mirroring the installation release content.

After installation, complete post-installation configuration such as disabling default software catalog sources and installing mirror policy resources.
