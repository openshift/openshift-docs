...
[role="_abstract"]
In {product-title} version {product-version}, you can install a private cluster into an existing Virtual Private Cloud (VPC) on {ibm-cloud-name}. The installation program provisions the rest of the required infrastructure, which you can further customize.
