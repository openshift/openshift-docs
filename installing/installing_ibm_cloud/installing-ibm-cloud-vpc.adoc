...
[role="_abstract"]
In {product-title} version {product-version}, you can install a cluster into an existing Virtual Private Cloud (VPC) on {ibm-cloud-name}. The installation program provisions the rest of the required infrastructure, which you can further customize.

include::modules/prereqs-ibm-cloud-installer-provisioned.adoc[leveloffset=+1]
...
[role="_additional-resources"]
[id="additional-resources_installing-ibm-cloud-vpc"]
== Additional resources
