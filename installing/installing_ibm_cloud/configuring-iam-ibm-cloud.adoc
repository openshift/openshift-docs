...
== Next steps
* xref:../../installing/installing_ibm_cloud/ipi/installing-ibm-cloud-customizations.adoc#installing-ibm-cloud-customizations[Installing a cluster on {ibm-cloud-name} with customizations]
