...
* You reviewed link:https://docs.redhat.com/en/documentation/red_hat_openstack_platform/16.2/html-single/reference_architecture_for_deploying_red_hat_openshift_container_platform_on_red_hat_openstack_platform/index#storage-for-openshift-nodes[the etcd storage requirements] and understands the differences between link:https://docs.redhat.com/en/documentation/red_hat_openstack_platform/16.2/html-single/reference_architecture_for_deploying_red_hat_openshift_container_platform_on_red_hat_openstack_platform/index#options-to-provide-disk-to-openshift-nodes[the different options].
