...
You must prepare the underlying {rh-openstack} networking before you install a cluster that uses SR-IOV on it.

// TODO: SME/QE check: Confirm that the following SR-IOV network creation workflow remains the recommended RHOSO path and does not require additional RHOSO data plane prerequisites.
