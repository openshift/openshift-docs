...
====
* You understand performance and scalability practices for cluster scaling, control plane sizing, and etcd. For more information, see xref:../../scalability_and_performance/recommended-host-practices.adoc#recommended-host-practices[Recommended host practices].
...
* If necessary, see xref:../../support/remote_health_monitoring/opting-out-of-remote-health-reporting.html#insights-operator-register-disconnected-cluster_opting-out-remote-health-reporting[Registering your disconnected cluster]
