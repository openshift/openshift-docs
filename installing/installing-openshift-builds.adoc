...
include::modules/ob-verifying-a-openshift-build-resource-console.adoc[leveloffset=+2]

include::modules/ob-installing-builds-using-CLI.adoc[leveloffset=+1]

include::modules/ob-verifying-a-openshift-build-resource-cli.adoc[leveloffset=+2]
