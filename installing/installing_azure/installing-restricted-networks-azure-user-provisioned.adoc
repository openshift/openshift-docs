...
* If you use customer-managed encryption keys, you xref:../../installing/installing_azure/installing-azure-preparing-ipi.adoc#preparing-disk-encryption-sets_installing-azure-preparing-ipi[prepared your Azure environment for encryption].
