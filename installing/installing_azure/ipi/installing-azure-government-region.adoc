...
* link:https://docs.microsoft.com/en-us/azure/virtual-network/what-is-ip-address-168-63-129-16[What is IP address 168.63.129.16?]
...
[id="additional-resources_installing-azure-government-region"]
[role="_additional-resources"]
== Additional resources
