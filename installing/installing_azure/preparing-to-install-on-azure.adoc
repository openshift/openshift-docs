...
You can install {product-title} on {azure-first} by using one of the following installation methods:
...
You can install a cluster on {azure-short} infrastructure that is provisioned by the {product-title} installation program, by using one of the following methods:
...
* **xref:../../installing/installing_azure/ipi/installing-azure-customizations.adoc#installing-azure-customizations[Installing a cluster with customizations on {azure-short}]**: You can install a cluster on Azure with customizations in configuration. You can also install a xref:../../installing/installing_sno/install-sno-installing-sno.adoc#installing-sno-on-azure_install-sno-installing-sno-with-the-assisted-installer[single-node OpenShift on {azure-short}]. For more customization options, see xref:../../post_installation_configuration/cluster-tasks.adoc#post-install-cluster-tasks[post-installation].
