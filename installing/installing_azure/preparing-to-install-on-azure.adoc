...
* **xref:../../installing/installing_azure/installing-azure-customizations.adoc#installing-azure-customizations[Installing a customized cluster on Azure]**: You can install a customized cluster on Azure infrastructure that the installation program provisions. The installation program allows for some customization to be applied at the installation stage. You can also install a xref:../installing/installing_sno/install-sno-installing-sno.adoc#installing-sno-on-azure_install-sno-installing-sno-with-the-assisted-installer[single-node OpenShift on Azure]. Many other customization options are available xref:../../post_installation_configuration/cluster-tasks.adoc#post-install-cluster-tasks[post-installation].
