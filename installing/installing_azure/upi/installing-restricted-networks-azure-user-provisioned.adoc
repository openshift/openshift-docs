...
* xref:../../../installing/installing_azure/upi/installing-azure-user-infra.adoc#installation-azure-create-dns-zones_installing-azure-user-infra[Example for creating DNS zones]
...
* xref:../../../installing/installing_azure/upi/installing-restricted-networks-azure-user-provisioned.adoc#installation-azure-network-config_installing-restricted-networks-azure-user-provisioned[Configuring a public DNS zone in {azure-short}]
