...
[role="_abstract"]
After installing {product-title-short}, you can perform some steps to verify that the installation was successful.

:FeatureName: {product-title-short}
include::snippets/field-trial.adoc[leveloffset=+1]

To verify installation, access your ACS Console from the {cloud-console}. The Dashboard will display the number of clusters that {product-title-short} is monitoring, along with information about nodes, deployments, images, and violations.
