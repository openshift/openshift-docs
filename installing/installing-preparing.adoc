...
||AWS |Azure |Azure Stack Hub |GCP |{rh-openstack} |{rh-openstack} on SR-IOV |oVirt |Bare metal |vSphere |VMC |IBM Z |IBM Power
endif::openshift-origin[]
...
|xref:../installing/installing_azure_stack_hub/installing-azure-stack-hub-customizations.adoc#installing-azure-stack-hub-customizations[X]
