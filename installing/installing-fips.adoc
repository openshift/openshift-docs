...
* xref:../installing/installing_ibm_power/installing-ibm-power-reg.adoc#installing-ibm-power-reg[{iibm-cloud-bm-reg}]
* xref:../installing/installing_ibm_z/installing-ibm-z-reg.adoc#installing-ibm-z-reg[{ibm-z-reg} and {ibm-linux-one-reg}]
* xref:../installing/installing_ibm_z/installing-ibm-z-reg-kvm.adoc#installing-ibm-z-reg-kvm[{ibm-z-reg} and {ibm-linux-one-reg} with {op-system-base} KVM]
