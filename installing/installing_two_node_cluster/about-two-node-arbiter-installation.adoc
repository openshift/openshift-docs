...
* Installing on bare metal with UPI: 
  ...
  - xref:../installing_bare_metal/upi/modules/upi-install-config-local-arbiter-node.adoc[Configuring a local arbiter node by using UPI]

  - xref:../installing_bare_metal/upi/installing-bare-metal.adoc[Installing a user-provisioned cluster on bare metal]
