...
* 2 or more vCPUs.
* 8 GB of RAM.
* About 8.7 GB for {product-title} 4.8 Release images, or about 668 GB for {product-title} 4.8 Release images and {product-title} 4.8 Red Hat Operator images. Up to 1 TB per stream or more is suggested.
+
[IMPORTANT]
====
