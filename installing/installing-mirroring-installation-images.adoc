...
* xref:../operators/admin/olm-restricted-networks.adoc#olm-mirror-catalog_olm-restricted-network[Mirror] the Operator Hub images for the Operators that you want to install in your cluster.
