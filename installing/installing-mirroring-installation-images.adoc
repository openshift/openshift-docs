...
* 2 or more vCPUs.
* 8 GB of RAM.
* About 7.7 GB for {product-title} 4.7 Release images, or about 713 GB for {product-title} 4.7 Release images and {product-title} 4.7 Red Hat Operator images. Up to 1 TB per stream or more is suggested.
+
[IMPORTANT]
====
