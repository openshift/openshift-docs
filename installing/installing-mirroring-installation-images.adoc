...
* 2 or more vCPUs.
* 8 GB of RAM.
* About 9.6 GB for {product-title} 4.9 Release images, or about 444 GB for {product-title} 4.9 Release images and {product-title} 4.9 Red Hat Operator images. Up to 1 TB per stream or more is suggested.
+
[IMPORTANT]
====
