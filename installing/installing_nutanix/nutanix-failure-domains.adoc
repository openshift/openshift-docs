...
* xref:../../installing/installing_nutanix/nutanix-failure-domains.adoc#post-installation-adding-nutanix-failure-domains-compute-machines-edit_nutanix-failure-domains[Editing existing compute machine sets]
* xref:../../installing/installing_nutanix/nutanix-failure-domains.adoc#post-installation-adding-nutanix-failure-domains-compute-machines-replace_nutanix-failure-domains[Replacing existing compute machine sets]
