...
In {product-title} version {product-version}, you can install a cluster on your Nutanix instance with
ifdef::openshift-origin[one method:]
ifndef::openshift-origin[two methods:]
