...
* xref:../../installing/overview/installing-preparing.adoc#installing-preparing-selecting-cluster-type_installing-preparing[Selecting a cluster installation type]
