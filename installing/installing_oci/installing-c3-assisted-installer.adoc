...
{oci-c3} (C3) lets you run applications and middleware using {oci-first} services on high performance cloud infrastructure in your data center. You can quickly deploy applications using a rack-scale platform with optional GPU acceleration and infrastructure-as-code automation. 
