...
// Uploading the discovery ISO to OCI
include::modules/installing-oci-ai-uploading-discovery-iso.adoc[leveloffset=+2]

// Creating a pre-authenticated request URL
include::modules/installing-oci-ai-creating-pre-authenticated-request.adoc[leveloffset=+2]

// Creating a stack
include::modules/installing-oci-ai-creating-stack.adoc[leveloffset=+2]

// Editing patch manifests
include::modules/installing-oci-ai-editing-custom-manifests.adoc[leveloffset=+2]
