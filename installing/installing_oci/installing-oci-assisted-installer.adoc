...
= The Assisted Installer for cluster installation on {oci-first-no-rt}
...
//* link:https://access.redhat.com/node/7038262[The Agent-based Installer for cluster installation on Oracle Cloud Infrastructure]
