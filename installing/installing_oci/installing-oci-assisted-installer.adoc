...
[NOTE]
====
You can deploy {product-title} on a link:https://www.oracle.com/uk/cloud/cloud-at-customer/dedicated-region/[Dedicated Region] the same as any region from {oci-first-no-rt}.
====
