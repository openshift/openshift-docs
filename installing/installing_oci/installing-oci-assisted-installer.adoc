...
// Creating OCI resources and services - option 2
include::modules/creating-oci-resources-services-temp.adoc[leveloffset=+1]
...
// Using the Assisted Installer to generate an OCI-compatible discovery ISO image - option 2
include::modules/using-assisted-installer-oci-agent-iso-temp.adoc[leveloffset=+1]
...
// Provisioning OCI infrastructure for your cluster - option 2
include::modules/provision-oci-infrastructure-ocp-cluster-temp.adoc[leveloffset=+1]

// Completing the remaining Assisted Installer steps
include::modules/complete-assisted-installer-oci.adoc[leveloffset=+1]

// Completing the remaining Assisted Installer steps - option 2
include::modules/complete-assisted-installer-oci-temp.adoc[leveloffset=+1]
