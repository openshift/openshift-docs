...
[role="_abstract"]
As a cluster administrator, you can use cluster capabilities to enable or disable optional components before installation. Additionally, you can also enable cluster capabilities at any time after installation.
