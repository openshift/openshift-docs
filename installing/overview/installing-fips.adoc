...
* xref:../../installing/installing_bare_metal/upi/ipi/ipi-install-installation-workflow.adoc#retrieving-the-openshift-installer_ipi-install-installation-workflow[Extracting the OpenShift Container Platform installation program]
...
* xref:../../installing/installing_bare_metal/upi/upi/installing-bare-metal.adoc#installing-bare-metal[Bare metal]
