...
* xref:../../installing/installing_bare_metal/ipi/ipi-install-installation-workflow.adoc#retrieving-the-openshift-installer_ipi-install-installation-workflow[Extracting the {product-title} installation program]
