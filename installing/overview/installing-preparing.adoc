...
|===
||Alibaba |AWS |Azure |Azure Stack Hub |{gcp-short} |Nutanix |{rh-openstack} |Bare metal |vSphere |{ibm-cloud-name} |{ibm-z-name} |{ibm-power-name}
...
ifdef::openshift-origin[]
|===
||Alibaba |AWS |Azure |Azure Stack Hub |{gcp-short} |Nutanix |{rh-openstack}|Bare metal |vSphere |{ibm-cloud-name} |{ibm-z-name} |{ibm-z-name} with {op-system-base} KVM |{ibm-power-name} |Platform agnostic
