...
* xref:../../installing/disconnected_install/installing-mirroring-disconnected.adoc#installing-mirroring-disconnected-v1[Mirroring images for a disconnected installation using the oc-mirror plugin V1]
* xref:../../installing/disconnected_install/installing-mirroring-disconnected-v2[Mirroring images for a disconnected installation using the oc-mirror plugin V2]
