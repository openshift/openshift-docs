...
* For more information on adding worker nodes to single-node OpenShift clusters, see xref:../../nodes/nodes/nodes-sno-worker-nodes.adoc#nodes-sno-worker-nodes[Adding worker nodes to sigle-node OpenShift clusters].
