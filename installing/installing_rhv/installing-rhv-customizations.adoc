...
You can also use of `install-config.yaml` the installation file to automate deploying multiple clusters.
...
[IMPORTANT]
====
Running the installer consumes the `install-config.yaml` file. If you do not provide a working copy of this file, you must recreate the file the next time you want to run the installer.
====
