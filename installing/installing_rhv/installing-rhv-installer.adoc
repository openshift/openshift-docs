[id="installing-rhv-installer"]
= Installing a cluster on RHV
include::modules/common-attributes.adoc[]
:context: installing-rhv-installer
...
* Have access to an {rh-rhv} administrator's account

* On {rh-rhv}, have access to an external network that does not overlap these CIDR ranges:
** `10.0.0.0/16`
** `172.30.0.0/16`
** `10.128.0.0/14`
+
If the external network overlaps these ranges, go to xref:./installing-rhv-installer-custom.adoc#installing-rhv-installer-custom[Installing a cluster on RHV with customizations]
