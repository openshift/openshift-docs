...
* xref:../../machine_configuration/machine-configs-configure.html#rhcos-enabling-multipath-day-2_machine-configs-configure[Enabling multipathing with kernel arguments on {op-system}].
