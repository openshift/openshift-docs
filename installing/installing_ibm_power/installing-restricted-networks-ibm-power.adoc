...
* xref:../../installing/installing-mirroring-installation-images.adoc#installing-mirroring-installation-images[Create a mirror registry for installation in a restricted network] and obtain the `imageContentSources` data for your version of {product-title}. Use the `docker.io/ibmcom/registry-ppc64le:2.6.2.5` image.
