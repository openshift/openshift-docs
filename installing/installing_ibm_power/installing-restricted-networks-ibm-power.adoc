...
[id="installing-restricted-networks-ibm-power-reg"]
= Installing a cluster on {iibm-cloud-bm-reg} in a restricted network
include::_attributes/common-attributes.adoc[]
:context: installing-restricted-networks-ibm-power-reg

toc::[]

In {product-title} version {product-version}, you can install a cluster on
{iibm-cloud-bm-reg} infrastructure that you provision in a restricted network.
...
include::modules/minimum-ibm-power-reg-system-requirements.adoc[leveloffset=+2]
include::modules/recommended-ibm-power-reg-system-requirements.adoc[leveloffset=+2]
...
[role="_additional-resources"]
.Additional resources
* xref:../../installing/installing_ibm_power/installation-config-parameters-ibm-power-reg.adoc#installation-config-parameters-ibm-power-reg[Installation configuration parameters for {iibm-cloud-bm-reg}]
