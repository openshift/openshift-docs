...
on the `mappingmethod` used as part of the identity provider configuration. See
the
xref:../install_config/configuring_authentication.adoc#mapping-identities-to-users[Mapping
