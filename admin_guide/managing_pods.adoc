...
[[admin-guide-controlling-egress-traffic-pods]]
...
[[admin-guide-limit-pod-access-egress-router-pods]]
...
[[admin-guide-limit-pod-access-important-deployment-considerations-pods]]
