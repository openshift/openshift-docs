...
To confirm the loss of etcd quorum, run one of the following commands and confirm
...
include::day_two_guide/topics/proc_adding-etcd-after-restoring.adoc[leveloffset=+1]
