...
properly link:../configuring_openstack.html[configured for OpenStack].
====
...
link:../configuring_openstack.html[configured for OpenStack], all that is
required for Cinder is a Cinder volume ID and the `*PersistentVolume*` API.
