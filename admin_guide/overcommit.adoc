...
To configure `experimental-qos-reserved`, edit the appropriate xref:../admin_guide/manage_nodes.adoc#modifying-nodes[node configuration map].
...
by naming the directory in the `kubeletArguments.config` field of 
