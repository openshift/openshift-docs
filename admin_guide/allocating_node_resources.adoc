...
Currently, the `*cpu*`, `*memory*`, and, if you have enabled the ephemeral storage tech preview in {product-title} 3.10, `*ephemeral-storage*` resource types are supported. For `*cpu*`,
