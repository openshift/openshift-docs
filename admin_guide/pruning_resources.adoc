...
xref:../install_config/install/docker_registry.adoc#docker-registry-configuration-reference-storage[registry is configured] with `*storage:delete:enabled*` set to *true*.
====
endif::[]
