...
[NOTE]
====
Pruning images removes data from the Docker registry. For this operation to work
properly, ensure your
xref:../install_config/registry/extended_registry_configuration.adoc#docker-registry-configuration-reference-storage[registry
