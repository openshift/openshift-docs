...
The
xref:../install_config/install/first_steps.adoc#creating-instantapp-templates[example
...
This is similar to the process for xref:git-repository-access[using proxies for
Git cloning].
