...
/admin_guide/diagnostics_tool.adoc#overview[Diagnostics Tool section] for more
information.

[NOTE]
====
Currently, the diagnostics tool cannot determine information about IP failover
issues. As a workaround, you can run the script at
