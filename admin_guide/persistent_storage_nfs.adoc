...
https://access.redhat.com/documentation/en-US/Red_Hat_Enterprise_Linux/7.adoc/Storage_Administration_Guide/ch-nfs.html[NFS].
...
[IMPORTANT]
====
Starting in OpenShift Enterprise 3.1, the export values have changed. See the https://docs.openshift.com/enterprise/3.1/install_config/persistent_storage/persistent_storage_nfs.adoc[OpenShift Enterprise 3.1 documentation] for instructions on ensuring proper security for NFS in 3.1.
====
