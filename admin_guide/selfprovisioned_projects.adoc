...
xref:../dev_guide/templates.adoc#dev-guide-templates[template]. This endpoint is made accessible
when a developer xref:../dev_guide/projects.adoc#dev-guide-projects[creates a new project].
