...
storage technology preview in {product-title} 3.10. This feature is disabled by
default.
...
ephemeral storage technology preview in {product-title} 3.10. This feature is
disabled by default.
|===
...
[NOTE]
====
Ephemeral storage requests and limits apply only if you enabled the the
ephemeral storage technology preview in {product-title} 3.10. This feature is
disabled by default.
====
