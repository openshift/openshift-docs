...
You can object count quota these standard namespaced resource types using the `count/<resource>.<group>` syntax 
...
To create a quota, first define the quota to your specifications in a file, 
