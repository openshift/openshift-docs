...
*BestEffort* scoped pods can take advantage of slack compute resources in their
namespace, and then require that users make an explicit resource request for
