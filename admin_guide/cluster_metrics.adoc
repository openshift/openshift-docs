...
xref:../admin_guide/service_accounts.adoc#admin-guide-service-accounts[service account] with the *cluster-reader*
xref:manage_authorization_policy.adoc#viewing-cluster-policy[cluster role] to
