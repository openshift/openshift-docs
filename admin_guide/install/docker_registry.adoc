...
Docker registry] that can be deployed in your OpenShift environment to manage
images "locally".
...
the *_/etc/openshift/master_* directory, as a user with cluster administrator
