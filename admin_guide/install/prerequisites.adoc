...
+
ifdef::openshift-enterprise[]
If you are using the link:quick_install.html[Quick Installation Method] you must also install the GNU Compiler Collection (*gcc*) and the Python Virtual Environment (*python-virtualenv*) packages:
----
