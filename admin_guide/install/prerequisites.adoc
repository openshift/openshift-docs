...
+
ifdef::openshift-enterprise[]
If you are using the link:../../admin_guide/install/quick_install.html[Quick Installation Method] you must also install the GNU Compiler Collection (GCC) and the Python Virtual Environment (python-virtualenv) packages:
----
