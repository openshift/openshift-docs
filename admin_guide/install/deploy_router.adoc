...
If you have not yet done so, you can link:docker_registry.html[deploy the
integrated Docker registry], and then continue on to the
link:first_steps.html[First Steps] topic to complete the basic installation.
