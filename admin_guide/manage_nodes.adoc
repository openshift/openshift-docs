...
certificates, and other important steps. See
xref:../install_config/adding_hosts_to_existing_cluster.adoc#adding-nodes-advanced[Adding Hosts to an Existing Cluster] for instructions on running the playbook
directly.
