...
Allocatable:
 ...
 pods:					10
System Info:                                 <5>
 Machine ID:			6d48b4ed994e4baa915236703275389b
 System UUID:			BFE23571-186B-4E9B-828F-25ABC6838CBC
 Boot ID:			c07a5150-75dc-4dbe-9c3b-f7e748edfb74
...
ExternalID:			vm251-93.gsslab.pnq2.redhat.com  <6>
...
Events:                                                          <8>
  ...
  ---------	--------	-----	----					-------------	--------	------			-------
  1h		1h		1	{kubelet vm251-93.gsslab.pnq2.redhat.com}			Normal		Starting		Starting kubelet.
  1h		1h		2	{kubelet vm251-93.gsslab.pnq2.redhat.com}			Normal		NodeHasSufficientDisk	Node vm251-93.gsslab.pnq2.redhat.com status is now: NodeHasSufficientDisk
  1h		1h		2	{kubelet vm251-93.gsslab.pnq2.redhat.com}			Normal		NodeHasSufficientMemory	Node vm251-93.gsslab.pnq2.redhat.com status is now: NodeHasSufficientMemory
  1h		1h		2	{kubelet vm251-93.gsslab.pnq2.redhat.com}			Normal		NodeHasNoDiskPressure	Node vm251-93.gsslab.pnq2.redhat.com status is now: NodeHasNoDiskPressure
  1h		1h		1	{kubelet vm251-93.gsslab.pnq2.redhat.com}			Warning		Rebooted		Node vm251-93.gsslab.pnq2.redhat.com has been rebooted, boot id: c07a5150-75dc-4dbe-9c3b-f7e748edfb74
  1h		1h		1	{kubelet vm251-93.gsslab.pnq2.redhat.com}			Normal		NodeNotReady		Node vm251-93.gsslab.pnq2.redhat.com status is now: NodeNotReady
  1h		1h		1	{kubelet vm251-93.gsslab.pnq2.redhat.com}			Normal		NodeReady		Node vm251-93.gsslab.pnq2.redhat.com status is now: NodeReady
----

<1> The name of the node.
<2> The xref:../install_config/install/advanced_install.adoc#configuring-node-host-labels[labels] applied to the node.
<3> xref:../admin_guide/manage_nodes.adoc#node-conditions[Node conditions].
<4> The xref:../admin_guide/allocating_node_resources.adoc#admin-guide-allocating-node-resources[pod resources and allocatable resources].
<5> Information about the node host.
<6> The host name of the node.  
<7> The pods on the node.
<8> xref:../dev_guide/events.adoc#dev-guide-events[Events] affecting the node.
