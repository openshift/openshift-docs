...
----
# oc describe node vm252-28.gsslab.pnq2.redhat.com     
Name:			vm252-28.gsslab.pnq2.redhat.com <1>
Role:			                                <2>
Labels:			beta.kubernetes.io/arch=amd64   <3>
			beta.kubernetes.io/os=linux
			kubernetes.io/hostname=vm252-28.gsslab.pnq2.redhat.com
			region=infra
			zone=default
...
Addresses:		10.74.252.28,10.74.252.28,vm252-28.gsslab.pnq2.redhat.com  <7>
Capacity:                            <8>
 cpu:		8
 memory:	32780308Ki
 pods:		80
Allocatable:
 ...
 pods:		80
System Info:                         <9>
 Machine ID:			4cb86a52e7884f94ab9a32d701689043
 System UUID:			4CB86A52-E788-4F94-AB9A-32D701689043
 Boot ID:			4a592874-26bb-4d98-889a-6a58e3f3ae0a
...
ExternalID:			vm252-28.gsslab.pnq2.redhat.com  <10>
Non-terminated Pods:		(9 in total)                     <11>
  ...
  openshift-infra		hawkular-metrics-9tlw3			0 (0%)		0 (0%)		1500M (4%)	2500M (7%)
  openshift-infra		heapster-bhpqq				4 (50%)		4 (50%)		937500k (2%)	2Gi (6%)
