...
xref:../install_config/adding_hosts_to_installs.adoc#adding-nodes-advanced[advanced
...
xref:../install_config/adding_hosts_to_installs.adoc#adding-nodes-or-reinstalling-quick[re-run
