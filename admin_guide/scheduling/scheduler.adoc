...
**_GeneralPredicates_** check whether non-critical predicates and essential predicates pass. 
See xref:admin-guide-scheduler-general-predicates[General Predicates] below.
