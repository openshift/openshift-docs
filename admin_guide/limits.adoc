...
Ephemeral Storage].  Ephemeral storage encompasses EmptyDir
volumes and writable layers; in addition, if CRI-O is used as the
container runtime, logs are included in ephemeral storage.
