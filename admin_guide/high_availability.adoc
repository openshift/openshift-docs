...
|
|Full path name in the pod file system of a script that is periodically run to verify the application is operating.
...
|
|Full path name in the pod file system of a script that is run whenever the state changes.
