...
link:../admin_guide/manage_nodes.html#updating-labels-on-nodes[should be labeled
...
desired `region` label to the `nodeSelectorLabelBlacklist` section of a master
...
[[controlling-pod-placement-nodeselector]]
