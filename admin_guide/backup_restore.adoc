...
However, an example on how to perform a *generic* backup of xref:application-date[application data] is
...
The paths to be backed up are also *application specific*.
Often you can figure out which path to back up from looking at the
deploymentconfig.
