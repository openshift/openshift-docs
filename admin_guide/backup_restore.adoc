...
For now, to back up API objects at the project level, use `oc get --export` for each
object to be saved. For example, to save the deployment configuration `frontend`
in YAML format:

----
$ oc get dc --export frontend -o yaml > dc-frontend.yaml
----
...
----
$ oc get all --export -o yaml > project.yaml
----
