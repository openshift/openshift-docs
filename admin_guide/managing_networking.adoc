...
router rather than connecting directly to the destination IP. This will ensure external
destinations treat traffic as though it were coming from a known source.
