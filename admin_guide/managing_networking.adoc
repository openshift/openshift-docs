...
contain a single IP address, as of {product-title} version 3.10 `egressIPs` can
...
isolation, and do not support Kubernetes `NetworkPolicy`. However, `NetworkPolicy` support
