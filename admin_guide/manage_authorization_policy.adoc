...
----
$ oc get clusterrole.rbac view -o yaml > clusterrole_view.yaml
...
Then, to create the local role, run:

----
$ oc create -f role_exampleview.yaml -n <project_you_want_to_add_the_local_role_exampleview_to>
----
...
----
$ oc adm policy add-role-to-user exampleview user2 --role-namespace=<name_of_project> -n <name_of_project>
----
