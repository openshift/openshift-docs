...
the default SCCs other than priority, labels, and annotations.
====
...
. Update an SCC interactively:
+
----
$ oc edit scc <scc_name>
----
. Update an SCC by using a patch:
+
----
$ oc patch scc <scc_name> -p '{"<parameter>": <value>}'
----
...
[NOTE]
====
If you customized settings other than priority, labels, or annotations in an
