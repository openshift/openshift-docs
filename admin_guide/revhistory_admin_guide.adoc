...
|xref:../admin_guide/manage_nodes.adoc#manage-node-change-node-traffic-interface[Cluster Administration -> Managing Nodes]
|Added details on how to change the node traffic interface.

|xref:../admin_guide/manage_scc.html#creating-new-security-context-constraints[Cluster Administration -> Managing Security Context Constraints]
|Added information about required drop capabilities to the xref:../admin_guide/manage_scc.html#creating-new-security-context-constraints[Creating New Security Context Constraints] section.
