...
|Added an Important box to the xref:../admin_guide/high_availability.adoc#configuring-ip-failover[Configuring IP Failover] section about using high availability with AWS.
