...
ref:../admin_guide/seccomp.adoc#admin-guide-seccomp[Restricting Application Capabilities Using Seccomp]
|Added the Restricting Application Capabilities Using Seccomp file.
