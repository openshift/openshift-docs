[[admin-guide-configuring-authentication]]
...
xref:../admin_guide/master_node_configuration.adoc#admin-guide-master-node-configuration[master configuration file] to specify an
xref:identity-providers[identity provider]. If you installed OpenShift using
the
...
xref:DenyAllPasswordIdentityProvider[Deny All] identity provider is used by
...
provider by modifying the xref:../admin_guide/master_node_configuration.adoc#admin-guide-master-node-configuration[master
...
xref:../admin_guide/master_node_configuration.adoc#admin-guide-master-node-configuration[master configuration file].
...
http://httpd.apache.org/docs/2.4/programs/htpasswd.adoc[`htpasswd`].
...
link:https://access.redhat.com/documentation/en-US/OpenShift_Enterprise/2.adoc/Deployment_Guide/Configuring_OpenShift_Enterprise_Authentication.html[the
...
xref:../install_config/install/deploy_router.adoc#install-config-install-deploy-router[running a router] on the
