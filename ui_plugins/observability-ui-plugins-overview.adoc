...
Perses dashboards::
The Perses dashboards feature integrates the open-source Perses dashboard
tool with the {product-title} web console. You can create and manage custom
dashboards through the *Observe -> Dashboards (Perses)* menu.
