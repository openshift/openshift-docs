...
* For information about the requirements for custom additional security groups, see xref:../../osd_planning/aws-ccs.adoc#osd-security-groups-custom_aws-ccs[Security groups].
