...
* For information about Private Service Connect (PSC), see xref:../osd_install_access_delete_cluster/creating-a-gcp-psc-enabled-private-cluster.adoc#configuring-a-cluster-wide-proxy[Private Service Connect overview].
