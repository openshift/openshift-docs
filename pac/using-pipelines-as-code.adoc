...
* link:https://docs.openshift.com/container-platform/latest/networking/enable-cluster-wide-proxy.html#nw-proxy-configure-object_config-cluster-wide-proxy[Enabling the cluster-wide proxy]
...
* xref:../install_config/installing-pipelines.adoc#installing-pipelines[Installing OpenShift Pipelines]
