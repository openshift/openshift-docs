...
ifdef::openshift-rosa[]
See xref:../rosa_install_access_delete_clusters/rosa_getting_started_iam/rosa-installing-rosa.adoc[Installing the {product-title} CLI, rosa] for detailed instructions.
endif::openshift-rosa[]
