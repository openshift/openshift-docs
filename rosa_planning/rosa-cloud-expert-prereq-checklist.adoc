...
//
* For more information about resources provisioned during ROSA cluster deployment, see xref:../rosa_planning/rosa-classic-prereqs.adoc#rosa-aws-policy-provisioned_rosa-classic-prereqs[Provisioned AWS Infrastructure].
