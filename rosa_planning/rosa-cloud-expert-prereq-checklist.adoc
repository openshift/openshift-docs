...
* xref:../networking/ovn_kubernetes_network_provider/assembly_configuring-cluster-wide-proxy.adoc#configuring-cluster-wide-proxy[Configuring a cluster-wide proxy]
endif::openshift-rosa[]
ifdef::openshift-rosa-hcp[]
