...
* To use the `ocm` CLI, you must have an OpenShift Cluster Manager role and user role resource. See xref:../rosa_planning/rosa-sts-ocm-role.adoc#rosa-sts-ocm-role[OpenShift Cluster Manager role resources].
