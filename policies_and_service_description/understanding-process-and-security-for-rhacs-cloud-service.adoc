...
Read more about RBAC controls for customer Control plane instances in xref:../operating/manage-user-access/manage-role-based-access-control-3630.adoc[Managing RBAC in Red Hat Advanced Cluster Security for Kubernetes].
