...
The following sections provide a detailed view of the various OpenShift Serverless Logic concepts.
...
include::modules/serverless-logic-overview-configuration-properties.adoc[leveloffset=+1]
