...
If your deployment exceeds the capacity of the chosen size, you can either increase the LokiStack size or scale individual components. For guidance on when to resize versus scale components, see xref:../configuring/tune-loki-for-performance-and-scalability.adoc#loki-sizing-vs-component-scaling_tune-loki-for-performance-and-scalability[LokiStack sizing versus component scaling].
...
* xref:../installing/install-the-loki-operator.adoc#install-the-loki-operator[Install the {loki-op}]
