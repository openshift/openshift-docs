...
[id="additional-resources-about-pipelinerun_{context}"]
...
* xref:../create/remote-pipelines-tasks-resolvers.adoc#remote-pipelines-tasks-resolvers[Specifying remote pipelines, tasks, and StepActions using resolvers]
