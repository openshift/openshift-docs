...
include::modules/ols-con-supported-interfaces.adoc[leveloffset=+2]
...
include::modules/ols-data-flow-architecture.adoc[leveloffset=+1]
...
include::modules/ols-data-retention-and-deletion.adoc[leveloffset=+1]

include::modules/ols-ai-training-policy.adoc[leveloffset=+1]
...
* xref:../operate/ols-using-openshift-lightspeed.adoc#ols-disabling-data-collection-operator_ols-using-openshift-lightspeed[Disabling data collection on the {ols-long} Service]