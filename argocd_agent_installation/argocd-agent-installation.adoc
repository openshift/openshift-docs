...
* You know the context names for both the hub (principal) and spoke (agent) clusters.
...
* link:https://argocd-agent.readthedocs.io/latest/user-guide/appprojects/[Creating AppProjects for Agents, Argo CD upstream documentation]