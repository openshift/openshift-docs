...
* You have reviewed the key Argo CD Agent terms required to understand the Principal and Agent components in the _Argo CD Terminologies_ section.
...
* xref:../plan/argocd-agent-architecture-overview.adoc[Argo CD Agent architecture]

* xref:../deploy/managing-apps-in-non-control-plane-namespaces.adoc[Apps in any namespaces]
