...
To include spaces within a label value, enclose the value in quotes (`"`). Do
not include spaces between comma-separated values. See the https://docs.docker.com/engine/reference/builder/#label[Docker
