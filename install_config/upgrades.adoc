...
See the xref:../whats_new/ose_3_0_release_notes.adoc#whats-new-ose-3-0-release-notes[OpenShift Enterprise 3.0
...
if you installed using the xref:install/advanced_install.adoc#install-config-install-advanced-install[advanced
installation] and the inventory file that was used is available, you can
xref:upgrade-playbook[use the upgrade playbook] to automate the upgrade
process. Alternatively, you can xref:manual-upgrades[upgrade OpenShift
manually].
...
ifdef::openshift-enterprise[]
(i.e., the xref:install/quick_install.adoc#install-config-install-quick-install[quick] and xref:install/advanced_install.adoc#install-config-install-advanced-install[advanced installation] methods)
endif::[]
ifdef::openshift-origin[]
(i.e., the xref:install/advanced_install.adoc#install-config-install-advanced-install[advanced installation] method)
endif::[]
 and does
...
[[manual-upgrades]]
== Upgrading Manually
As an alternative to using the xref:upgrade-playbook[automated upgrade
...
xref:../install_config/install/deploy_router.adoc#install-config-install-deploy-router[deployed a router], the router
...
xref:additional-instructions-per-release[Additional Manual Instructions per Release]
...
xref:install/docker_registry.adoc#storage-for-the-registry[registry
...
By default, the
ifdef::openshift-enterprise[]
xref:install/quick_install.adoc#install-config-install-quick-install[quick installation] and
xref:install/advanced_install.adoc#install-config-install-advanced-install[advanced installation] methods automatically
create
endif::[]
ifdef::openshift-origin[]
xref:install/advanced_install.adoc#install-config-install-advanced-install[advanced installation] method automatically
creates
endif::[]
...
xref:../whats_new/ose_3_0_release_notes.adoc#ose-3-0-1-0[OpenShift Enterprise
3.0.1.0 release].
endif::[]
ifdef::openshift-origin[]
...
The following steps are required for the
xref:../whats_new/ose_3_0_release_notes.adoc#ose-3-0-2-0[OpenShift Enterprise
3.0.2.0 release].
endif::[]
ifdef::openshift-origin[]
...
xref:install/deploy_router.adoc#using-the-container-network-stack[using the
