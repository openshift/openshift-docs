...
When
xref:accessing_registry.adoc#access-logging-in-to-the-registry[logging in] to the secured and exposed
...
When
xref:accessing_registry.adoc#access-logging-in-to-the-registry[logging in] to the non-secured and
