...
This section lists the supported registry storage drivers. See link:https://docs.docker.com/registry/configuration/#storage[the container registry documentation for more information].
...
General registry storage configuration options are supported. See link:https://docs.docker.com/registry/configuration/#maintenance[the container registry documentation for more information].
