...
. Log in to the Administration Portal and click menu:Compute[Virtual Machines] to verify that the bastion virtual machine, *_rhel-bastion_*, was created successfully.
...
# openshift_ovirt role variables: https://github.com/openshift/openshift-ansible/tree/master/roles/openshift_ovirt#role-variables
# openshift installation variables: https://github.com/openshift/openshift-ansible/tree/master/inventory
