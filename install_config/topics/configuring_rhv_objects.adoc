...
----
+
<1> `<qcow_url>` is the URL for downloading the *_RHEL-guest-image_*.
+
====
You can copy the `<qcow_url>` from link:https://access.redhat.com/downloads/content/69/ver=/rhel---7/latest/x86_64/product-software[]:
