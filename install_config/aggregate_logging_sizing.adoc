...
== Overview
The xref:../install_config/aggregate_logging.adoc#overview[Elasticsearch,
...
xref:../install_config/aggregate_logging.adoc#overview[Persistent Elasticsearch
...
xref:../install_config/install/prerequisites.adoc#managing-docker-container-log[Learn
more].
