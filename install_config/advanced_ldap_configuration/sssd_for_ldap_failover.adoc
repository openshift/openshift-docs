...
xref:../authentication/configuring_authentication_ldap.adoc#install-config-configuring-authentication-ldap
[authentication provider] for use with Lightweight Directory Access Protocol (LDAP) setups, but
