...
Currently, up to 100 CNS volumes on one trusted storage pool (TSP) is supported.
...
====
Follow the
link:https://access.redhat.com/documentation/en-us/red_hat_gluster_storage/3.1/html-single/container-native_storage_for_openshift_container_platform_3.4/#idm140521922231280[planning
guidelines] when planning hardware for a CNS storage environment to ensure that
