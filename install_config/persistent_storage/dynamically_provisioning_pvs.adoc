...
<3> Filesystem that will be created on dynamically provisioned volumes. This
value is copied to `fsType` field of dynamically provisioned PersistentVolumes
and the filesystem is created when the volume is mounted for the first time.
Default: `ext4`.
...
<7> Filesystem that will be created on dynamically provisioned volumes. This
value is copied to `fsType` field of dynamically provisioned PersistentVolumes
and the filesystem is created when the volume is mounted for the first time.
Default: `ext4`.
...
cluster has a node. Zone and zones parameters must not be used at the same time.
<4> Filesystem that will be created on dynamically provisioned volumes. This
value is copied to `fsType` field of dynamically provisioned PersistentVolumes
and the filesystem is created when the volume is mounted for the first time.
Default: `ext4`.
...
<8> Filesystem that will be created on dynamically provisioned volumes. This
value is copied to `fsType` field of dynamically provisioned PersistentVolumes
and the filesystem is created when the volume is mounted for the first time.
Default: `ext4`.
