. To enable static provisioning, first create a GlusterFS volume. See the link:https://access.redhat.com/documentation/en-us/red_hat_gluster_storage/3.4/html/administration_guide[{gluster} Administration Guide] for information on
