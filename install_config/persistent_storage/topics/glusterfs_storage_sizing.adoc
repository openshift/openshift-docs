...
* The Gluster S3 service binds to two GlusterFS volumes. In a default installation
via the
xref:../../install_config/install/advanced_install.adoc#install-config-install-advanced-install[Advanced Installer], these volumes are 1 GB each, consuming a total of 6 GB of raw
storage.
