...
xref:../archcture/infrastructure_components/kubernetes_infrastructure.adoc#node[node
...
for the changes to take effect. See xref:mater-node-config-restart-services[Restarting {product-title} services].
====
