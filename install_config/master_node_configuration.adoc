...
xref:../architedcture/infrastructure_components/kubernetes_infrastructure.adoc#master[master
server] and `node` to launch a
xref:../architecture/infrastructure_components/kubernetes_infrastructure.adoc[node
...
xref:mater-configuration-files[Master configuration files] and
