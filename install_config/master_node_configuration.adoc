...
* xref:../architecture/infrastructure_components/kubernetes_infrastructure.adoc#mster[Master] host files at xref:../install_config/master_node_configuration.adoc#master-configuration-files[*_/etc/origin/master/master-config.yaml_*]
...
installation] method using Ansible, then make your configuration changes in the
Ansible playbook.

ifdef::openshift-origin[]
If you followed the
link:https://docs.openshift.org/latest/getting_started/administrators.html[Manual
