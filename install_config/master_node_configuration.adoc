...
xref:../install_config/master_node_configuration.adoc#master-config-options[master] and
xref:../install_config/master_node_configuration.adoc#node-config-options[node configuration] options are
...
xref:../install_config/master_node_configuration.adoc#master-config-options[master] and
xref:../install_config/master_node_configuration.adoc#node-config-options[node configuration] options, and further customize your own cluster by making further modifications.
