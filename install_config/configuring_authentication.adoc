...
link:../install_config/web_console_customization.html#customizing-the-login-page[customized].
...
<10> Optional password to use to bind during the search phase. This value may also be provided in an
...
the first GitHub login by the organization admin, or from the GitHub organization settings.
====
