...
. Confirm that you can log in to the `oc` command line using your Kerberos ticket:
.. If you have not done so, provide your Kerberos credentials to get a ticket:
----
# kinit
----
+
