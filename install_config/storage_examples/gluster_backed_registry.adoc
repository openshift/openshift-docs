...
to the link:../persistent_storage/persistent_storage_glusterfs.html[GlusterFS
...
refer back to the
link:../install/docker_registry.html#deploy-registry[*docker-registry*] setup
...
link:../install/docker_registry.html[Deploying a Docker Registry] provides more
