...
* The xref:../install/docker_registry.adoc#deploy-registry[docker-registry] was deployed *without*
configuring storage.
...
refer back to the
xref:../install/docker_registry.adoc#deploy-registry[*docker-registry*] setup
...
xref:../install/docker_registry.adoc#install-config-install-docker-registry[Deploying a Docker Registry] provides more
...
# Wildcard DNS for {product-title} Applications - Points to Router
...
# This is for default {product-title} SDN - change as needed.
