...
== Overview
This topic reviews how to configure link:https://azure.microsoft.com/en-us/services/storage/blobs/[Microsoft Azure Blob Storage] for xref:../../install_config/registry/deploy_registry_existing_clusters.adoc[OpenShift integrated Docker registry].
...
* xref:../../install_config/registry/deploy_registry_existing_clusters.adoc#deploying-new-registry[Deploy the integrated Docker registry] if it is not deployed.
