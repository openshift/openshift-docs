...
xref:../install_config/redeploying_certificates.adoc#redeploying-all-certificates-using-the-current-product-title-and-etcd-ca[*_redeploy-certificates.yml_* playbook].  
