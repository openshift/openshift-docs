...
* To enable and configure {tekton-results}, see xref:../records/using-tekton-results-for-openshift-pipelines-observability.adoc#using-tekton-results-for-openshift-pipelines-observability[Using {tekron-results} for {pipelines-shortname} observability].
