...
== Overview
The {product-title} link:../../architecture/core_concepts/routes.html[router] is
...
A link:../../dev_guide/configmaps.html[configMap] permits you to customize
...
link:#deploying-customized-router[described above]. Modify the
...
through the link:../../architecture/additional_concepts/sdn.html[{product-title} SDN].
ifdef::openshift-origin[]
