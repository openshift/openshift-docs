...
- xref:../install_config/install/advanced_install.adoc#adding-nodes-or-reinstalling-quick[add nodes] to an existing cluster,
- xref:../../install_config/upgrading/index.adoc#install-config-upgrading-index[upgrade your cluster], or
- xref:../install_config/install/advanced_install.adoc#adding-nodes-or-reinstalling-quick[reinstall] the {product-title} cluster
completely.
endif::[]
...
- ip: 10.0.0.3
  ...
  connect_to: 10.0.0.3
----
<1> The version of this installation configuration file. As of {product-title} 3.1,
the only valid version here is `v1`.
...
method on how to
xref:../../install_config/adding_hosts_to_installs.adoc#adding-nodes-advanced[run
