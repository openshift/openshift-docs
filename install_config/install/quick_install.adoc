...
[IMPORTANT]
====
The quick installer tool, `atomic-openshift-utils`, is blocked until the fix for
link:https://bugzilla.redhat.com/show_bug.cgi?id=1509112[BZ#1509112] ships. See
xref:../../release_notes/ocp_3_7_release_notes.adoc#ocp37-quick-installer-known-issue[Known Issues].
====
