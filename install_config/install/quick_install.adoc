...
<3> A valid version of your selected variant: `3.6`, `3.5`, `3.4`, `3.3`, `3.2`, or
`3.1`. If not specified, this defaults to the latest version for the specified
variant.
...
- xref:../../install_config/authentication/index.adoc#install-config-configuring-authentication-index[Configure
authentication]; by default, authentication is set to
xref:../../install_config/authentication/configuring_authentication_deny_all.adoc#install-config-configuring-authentication-deny[Deny
All].
