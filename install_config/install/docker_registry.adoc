...
----
$ oadm registry --credentials=openshift-registry.kubeconfig <1>
----
endif::[]
...
----
$ oadm registry --credentials=/etc/origin/master/openshift-registry.kubeconfig \//<1>
    --images='registry.access.redhat.com/openshift3/ose-${component}:${version}' <2>
----
endif::[]
...
ifdef::openshift-enterprise[]
<2> Required to pull the correct image for OpenShift Enterprise.
endif::[]
