...
[IMPORTANT]
====
The docker registry pod run as user *1001*. This user needs to be able to write to the host directory. You may need to change directory ownership to user ID *1001* with this command: `sudo chown 1001:root <path>`
====
