...
. link:#deploy-registry[Deploy the registry].
. Edit the configuration file locally as needed. The initial file deployed on the registry is provided below. See details on
https://docs.docker.com/registry/configuration/[overriding registry options].
+
----
version: 0.1
log:
