...
Follow this topic to ensure you have the correct version of Docker installed on
your hosts before installing or upgrading to OSE 3.1.
====
endif::[]
...
| *5404* or *5405*
|UDP ports associated with Corosync and used with `*pacemaker*` HA.
...
[IMPORTANT]
====
Docker 1.9 is currently not supported
due to performance issues. See the
https://access.redhat.com/solutions/2214221[Red Hat Knowledgebase] for details.
====
endif::[]
