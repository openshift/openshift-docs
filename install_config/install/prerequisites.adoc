...
The OpenShift master caches deserialized versions of resources fairly
...
resources, can grow to occupy 1-2GB of memory.  This cache size can be reduced
using the following setting the in master-config.yaml
