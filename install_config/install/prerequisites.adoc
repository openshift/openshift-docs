...
7.3 or later] with the "Minimal" installation option and the latest packages
...
- Base OS:
link:https://access.redhat.com/documentation/en-us/red_hat_enterprise_linux/7/html-single/installation_guide/index[RHEL
7.3 or later] with the "Minimal" installation option and the latest packages from
...
link:https://access.redhat.com/documentation/en-us/red_hat_enterprise_linux/7/html-single/installation_guide/index[RHEL
7.3 or later] with "Minimal" installation option, or
link:https://access.redhat.com/documentation/en-us/red_hat_enterprise_linux_atomic_host/7/html-single/installation_and_configuration_guide/[RHEL
Atomic Host] 7.4.5 or later.
endif::[]
ifdef::openshift-enterprise[]
...
*_origin-upstream-dns.conf_* dnsmasq file, and you would need to configure
dnsmasq manually.
//end::networkmanager[]
...
| *9300*
|TCP
<<<<<<< HEAD:install_config/install/prerequisites.adoc
...
>>>>>>> 3121731... Add required ports for Prometheus to required ports section:install/prerequisites.adoc
with each other.
...
| *8444*
| TCP 
| Port that the controller service listens on. 
Port 8444 needs to be open on each {product-title} host 
