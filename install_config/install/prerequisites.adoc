...
The link:../install_config/install/advanced_install.html#configuring-ansible[Advanced Installation] topic discusses the available Ansible variables in greater detail.
