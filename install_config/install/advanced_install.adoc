...
xref:../../install_config/authentication/index.adoc#install-config-configuring-authentication-index[identity provider], which
defaults to
...
xref:../../install_config/authentication/index.adoc#install-config-configuring-authentication-index[session
...
The {product-title} xref:../../architecture/infrastructure_components/kubernetes_infrastructure.adoc#master[master]
includes a built-in
...
xref:../../install_config/authentication/index.adoc#install-config-configuring-authentication-index[master configuration file to specify an
identity provider].
Alternatively, you can do this after the installation using the master configuration file.

When you install {product-title} using the Advanced Installation
method, the
ifdef::openshift-enterprise[]
xref:../../install_config/authentication/configuring_authentication_deny_all.adoc#install-config-configuring-authentication-deny[Deny All] identity provider is
...
The Deny All default identity provider can be overridden during installation by configuring the `*openshift_master_identity_providers*` parameter in the inventory file.
...
ifdef::openshift-origin[]
xref:../../install_config/authentication/configuring_authentication_allow_all.adoc#install-config-configuring-authentication-allow[Allow
All].
endif::[]
