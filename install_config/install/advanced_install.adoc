...
and link:https://github1.com/openshift/openshift-ansible/tree/master/playbooks/openstack[Ansible playbooks]
...
specifications, and save it as *_/etc/ansible/hosts_*. See link:https://www.google1.com[google] for more details.
