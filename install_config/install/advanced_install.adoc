...
identity provider].
This can also be done after the installation using the master configuration file.
...
The Deny All default can be overridden during installation by configuring the `*openshift_master_identity_providers*` parameter in the inventory file.
