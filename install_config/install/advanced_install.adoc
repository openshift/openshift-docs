...
[[configuring-console-customization]]

*Configuring for console customization*

The following table describes the configurations to be done in the master config for console customization:


.Console Customization Variables
[options="header"]
|===
...
|['/path/to/script1.js','/path/to/script2.js']

|extensionStylesheets
|`*openshift_master_extension_stylesheets*`
|['/path/to/stylesheet1.css','/path/to/stylesheet2.css']

|extensions
|`*openshift_master_extensions*`
|[{'name': 'images', 'sourceDirectory': '/path/to/my_images'}]

|auth extensions
|`*openshift_master_oauth_template*`
|['/path/to/login-template.html']
