...
The following table describe variables for use with the Ansible installer that
...
Starting with {product-title} 3.7, the xref:../../architecture/service_catalog/template_service_broker.adoc#arch-template-service-broker[template service broker] (TSB) is enabled by default.
