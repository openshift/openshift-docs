...
To install the TSB, add the following in your inventory file's `[OSEv3:vars]`
section:
...
By default, the TSB will include templates from the `openshift` namespace in its
catalog.  This can be overriden by modifying the following in your inventory
