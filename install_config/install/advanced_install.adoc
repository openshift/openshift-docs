...
`openshift_schedulable=true` host variable.
----
[nodes]
...
[IMPORTANT]
====
For production environments, setting master host to schedulable or running _etcd_ and other master services on nodes is not recommended.
====
