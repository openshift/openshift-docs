...
+
If you are not using a proxy, you can skip this step. Otherwise, to workaround
this issue, add the IP address of the etcd endpoint to the `openshift_no_proxy`
cluster variable in your inventory file. For example:
+
----
