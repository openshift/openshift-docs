...
|`*openshift_no_proxy_auto_include_hosts*`
|This boolean variable specifies whether or not the names of all defined OpenShift
hosts and *.cluster.local should be automatically added to the NO_PROXY environment
variable for Masters, Nodes, and the Docker Daemon. Default to 'true', set it to
'false' to override this option.
