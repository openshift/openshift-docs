...
link:prerequisites.html[Prerequisites] topic to prepare your hosts, which
...
continue to link:#configuring-ansible[Configuring Ansible].
...
inventory file when link:#advanced-running-the-ansible-installer[running the
Ansible installer].
...
link:../../install_config/install/quick_install.html#adding-nodes-or-reinstalling[quick
...
====
+
See link:#configuring-host-variables[Configuring Host Variables] for more options.
...
link:#verifying-the-installation[verify the installation].
