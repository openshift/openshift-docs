...
.3+.^|These variables are only required when using the `pacemaker` HA method.
See link:#multiple-masters[Multiple Masters] for more information.
...
link:../../admin_guide/configuring_authentication.html#session-options[session
