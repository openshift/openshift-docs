...
|This variable allows you to specify resources per node using kubelet arguments.
See link:../admin_guide/manage_nodes.html#configuring-node-resources[Configuring
Node Resources] for more information.
|===
