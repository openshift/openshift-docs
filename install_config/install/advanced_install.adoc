...
Enabling the
service catalog allows service brokers to be registered with the catalog. The web
...
Ansible service broker (ASB) is also enabled.
...
also enable the template service broker (TSB).
