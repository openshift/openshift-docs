...
+
----
# docker pull registry.access.redhat.com/openshift3/ose-haproxy-router:v3.2.1.13
...
# docker pull registry.access.redhat.com/openshift3/ose-docker-registry:v3.2.1.13
----
...
xref:../../architecture/core_concepts/builds_and_image_streams.adoc#source-build[Source-to-Image (S2I)] builder images. S2I is the process that {product-title} uses to take
