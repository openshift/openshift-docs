...
link:../../architecture/index.html[{product-title}'s overall architecture] and that
...
+
----
# docker pull registry.access.redhat.com/openshift3/ose-haproxy-router:v3.2.1.1
# docker pull registry.access.redhat.com/openshift3/ose-deployer:v3.2.1.1
# docker pull registry.access.redhat.com/openshift3/ose-sti-builder:v3.2.1.1
# docker pull registry.access.redhat.com/openshift3/ose-docker-builder:v3.2.1.1
# docker pull registry.access.redhat.com/openshift3/ose-pod:v3.2.1.1
# docker pull registry.access.redhat.com/openshift3/ose-docker-registry:v3.2.1.1
----
