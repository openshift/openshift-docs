...
streams] and xref:../../architecture/core_concepts/templates.adoc#architecture-core-concepts-templates[templates] to
make it easy for developers to create new applications. By default, the
ifdef::openshift-enterprise[]
xref:quick_install.adoc#install-config-install-quick-install[quick installation] and
xref:advanced_install.adoc#install-config-install-advanced-install[advanced installation] methods automatically create
endif::[]
ifdef::openshift-origin[]
xref:advanced_install.adoc#install-config-install-advanced-install[advanced installation] method automatically creates
endif::[]
...
than the xref:quick_install.adoc#install-config-install-quick-install[quick installation] or the
xref:advanced_install.adoc#install-config-install-advanced-install[advanced installation]. Image streams and templates
...
ifdef::openshift-origin[]
- You installed OpenShift Origin using the  xref:advanced_install.adoc#install-config-install-advanced-install[advanced
installation] method.
endif::[]
////
- The xref:docker_registry.adoc#install-config-install-docker-registry[integrated Docker registry] service must be
...
xref:../../using_images/db_images/postgresql.adoc#using-images-db-images-postgresql[*PostgreSQL*] to support data
storage.
...
xref:../../using_images/xpaas_images/jws.adoc#using-images-xpaas-images-jws[*JBoss JWS*], and
xref:../../using_images/xpaas_images/a_mq.adoc#using-images-xpaas-images-a-mq[*JBoss A-MQ*]. They can be used
...
xref:../../using_images/db_images/mysql.adoc#using-images-db-images-mysql[*MySQL*], and
xref:../../using_images/db_images/postgresql.adoc#using-images-db-images-postgresql[*PostgreSQL*]), two templates
are defined.
...
xref:../../admin_guide/persistent_storage_nfs.adoc#admin-guide-persistent-storage-nfs[persistent volumes]
configured.
...
- xref:../../architecture/core_concepts/builds_and_image_streams.adoc#builds[Build configurations] to build the
application from source located in a GitHub public repository
- xref:../../architecture/core_concepts/deployments.adoc#deployments-and-deployment-configurations[Deployment configurations] to deploy the
...
- xref:../../architecture/core_concepts/routes.adoc#architecture-core-concepts-routes[Routes] to
...
xref:../../using_images/xpaas_images/jws.adoc#using-images-xpaas-images-jws[*JBoss JWS*], and
xref:../../using_images/xpaas_images/a_mq.adoc#using-images-xpaas-images-a-mq[*JBoss A-MQ*]), which can be
...
xref:creating-image-streams-for-xpaas-middleware-images[xPaaS Middleware image
...
xref:../../dev_guide/authentication.adoc#dev-guide-authentication[log into the web console] and follow
the flow for
xref:../../dev_guide/templates.adoc#creating-from-templates-using-the-web-console[creating
...
xref:../../dev_guide/templates.adoc#using-the-instantapp-templates[Using the
