...
link:../architecture/additional_concepts/networking.html#openshift-sdn[{product-title}
...
with the link:../rest_api/kubernetes_v1.html#v1-containerport[host port
exposed]. The pre-packaged
link:../architecture/core_concepts/routes.html#routers[HAProxy router] in
