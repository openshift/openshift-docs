...
the data stored in the cluster rebalances across the cluster.  The same thing
happens If you remove a node from the cluster.
====
...
+
----
# oc scale -n openshift-infra --replicas=0 rc hawkular-metrics
----
+
