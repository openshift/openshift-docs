...
Or you can change the base URL for all doc links:

====
----
// The example below would result in the default help URL
// https://example.com/docs/welcome/index.html
window.OPENSHIFT_CONSTANTS.HELP_BASE_URL = "https://example.com/docs/"; // Must end in a '/'
----
====
