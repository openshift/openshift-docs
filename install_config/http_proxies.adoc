...
The
link:../install_config/default_imagestreams_templates.html#creating-instantapp-templates[example templates]
...
This is similar to the process for link:../install_config/http_proxies.html#git-repository-access[using proxies for
Git cloning].
endif::[]
