...
- The
xref:../../architecture/additional_concepts/f5_big_ip.adoc#architecture-additional-concepts-f5-big-ip[F5
router] integrates with an existing *F5 BIG-IP®* system in your environment to
