...
xref:../../architecture/core_concepts/routes.adoc#architecture-core-concepts-routes[routes] are created, the user
...
xref:../../admin_guide/high_availability.adoc#admin-guide-high-availability[high availability] configuration
is  being created.
...
xref:../../architecture/core_concepts/routes.adoc#router-sharding[_Router sharding_] uses
xref:../../architecture/core_concepts/routes.adoc#env-variables[`NAMESPACE_LABELS`]
and/or
xref:../../architecture/core_concepts/routes.adoc#env-variables[`ROUTE_LABELS`],
