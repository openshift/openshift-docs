...
tag::installconfig_imagestreams_templates3[]
...
end::installconfig_imagestreams_templates3[]
...
tag::installconfig_imagestreams_prereqs[]
- The
...
+
end::installconfig_imagestreams_prereqs[]
