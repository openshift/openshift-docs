...
- link:https://access.redhat.com/documentation/en-us/red_hat_jboss_fuse/6.2.1/html-single/fuse_integration_services_1.0_for_openshift/[Red Hat JBoss Fuse Integration Services]
...
ifdef::openshift-origin[]
----
$ IMAGESTREAMDIR=~/openshift-ansible/roles/openshift_examples/files/examples/v3.7/image-streams; \
    DBTEMPLATES=~/openshift-ansible/roles/openshift_examples/files/examples/v3.7/db-templates; \
    QSTEMPLATES=~/openshift-ansible/roles/openshift_examples/files/examples/v3.7/quickstart-templates
----
endif::[]
ifdef::openshift-enterprise[]
----
...
== Creating Image Streams for xPaaS Middleware Images
The xPaaS Middleware image streams provide images for *JBoss EAP*, *JBoss JWS*, *JBoss A-MQ*, *JBoss Fuse Integration Services*, *Decision Server*, and *JBoss Data Grid*. They can be
