...
Follow the Cluster Restore procedure to restore
xref:../admin_guide/backup_restore.adoc#cluster-restore-single-member-etcd-clusters[single-member
etcd clusters] or
xref:../admin_guide/backup_restore.adoc#cluster-restore-multiple-member-etcd-clusters[multiple-member
clusters].
