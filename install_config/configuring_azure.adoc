...
=== Configuring for Azure with Ansible

During
xref:../install_config/install/advanced_install.adoc#install-config-install-advanced-install[advanced installations],
Azure can be configured using `*openshift_cloudprovider_azure_client_id*`, `*openshift_cloudprovider_azure_client_secret*`, `*openshift_cloudprovider_azure_tenant_id*`, `*openshift_cloudprovider_azure_subscription_id*`, `*openshift_cloudprovider_azure_resource_group*`, `*openshift_cloudprovider_azure_location*`, `*openshift_cloudprovider_kind*`
parameters, which are configurable in the inventory file.

.Example Azure Configuration with Ansible
...
=== Manually Configuring Masters for Azure
...
=== Manually Configuring Nodes for Azure
