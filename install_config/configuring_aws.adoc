...
== Permissions
Configuring AWS for {product-title} requires following permissions on:

* Master:
+
.AWS permissions required on Master
[options='header']
|===
| Elastic Compute Cloud(EC2) | Elastic Load Balancing
| _ec2:DescribeVolume_ | _elasticloadbalancing:DescribeTags_
| _ec2:CreateVolume_ | _elasticloadbalancing:CreateLoadBalancerListeners_
| _ec2:CreateTags_ | _elasticloadbalancing:ConfigureHealthCheck_
| _ec2:DescribeInstance_ | _elasticloadbalancing:DeleteLoadBalancerListeners_
| _ec2:AttachVolume_ | _elasticloadbalancing:RegisterInstancesWithLoadBalancer_
| _ec2:DetachVolume_ | _elasticloadbalancing:DescribeLoadBalancers_
| _ec2:DeleteVolume_ | _elasticloadbalancing:CreateLoadBalancer_
| _ec2:DescribeSubnets_ | _elasticloadbalancing:DeleteLoadBalancer_
| _ec2:CreateSecurityGroup_ | _elasticloadbalancing:ModifyLoadBalancerAttributes_
| _ec2:DescribeSecurityGroups_ | _elasticloadbalancing:DescribeLoadBalancerAttributes_
| _ec2:DescribeRouteTables_ |
| _ec2:AuthorizeSecurityGroupIngress_ |
|===

* Nodes:
** _ec2:DescribeInstance*_
...
** Do not tag all security groups with the `KubernetesCluster: value` or the Elastic Load Balancing (ELB) will not be able to create.
====
