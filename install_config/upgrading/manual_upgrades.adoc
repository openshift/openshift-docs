...
[[manual-step-ose-3-2-1-30]]
=== {product-title} 3.2.1.30

There are no additional manual steps for the upgrade to
xref:../../release_notes/ose_3_2_release_notes.adoc#ose-3-2-1-30[{product-title}
3.2.1.30] that are not already mentioned inline during the standard manual
upgrade process.

[[manual-step-ose-3-2-1-31-2]]
=== {product-title} 3.2.1.31-2

There are no additional manual steps for the upgrade to
xref:../../release_notes/ose_3_2_release_notes.adoc#ose-3-2-1-31-2[{product-title}
3.2.1.31-2] that are not already mentioned inline during the standard manual
upgrade process.

[[manual-step-ose-3-2-1-31-4]]
=== {product-title} 3.2.1.31-4

There are no additional manual steps for the upgrade to
xref:../../release_notes/ose_3_2_release_notes.adoc#ose-3-2-1-31-4[{product-title}
3.2.1.31-4] that are not already mentioned inline during the standard manual
upgrade process.
endif::openshift-enterprise[]
