...
There are no additional manual steps for the upgrade to OpenShift Enterprise 3.2.0 that are not already mentioned inline during the standard manual upgrade
process.

[[manual-step-ose-3-2-1-1]]
=== OpenShift Enterprise 3.2.1.1

The upgrade to OpenShift Enterprise 3.2.1.1 involves updating to Docker
...
[IMPORTANT]
====
See the Known Issues for OpenShift Enterprise 3.2.1.1 for more details on using
...
There are no additional manual steps for the upgrade to OpenShift
