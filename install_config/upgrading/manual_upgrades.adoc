 ...
 template:
    spec:
      ...
      - env:
        ...
ifdef::openshift-enterprise[]
        image: registry.access.redhat.com/openshift3/ose-haproxy-router:v3.3.0.34 <1>
endif::[]
ifdef::openshift-origin[]
 ...
 template:
    spec:
      ...
      - env:
        ...
ifdef::openshift-enterprise[]
        image: registry.access.redhat.com/openshift3/ose-docker-registry:v3.3.0.34 <1>
endif::[]
ifdef::openshift-origin[]
