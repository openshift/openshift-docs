...
----
====
<<<<<<< 6c71c29501f072140de8f3de185ee66ccb9fee0f
=======
...
Next, xref:../install/adding_hosts_to_installs.adoc#adding-nodes-advanced[the green
...
>>>>>>> Bug 1353400 arranged and added to info on adding hosts
