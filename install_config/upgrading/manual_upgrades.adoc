 ...
 template:
    spec:
      ...
      - env:
        ...
ifdef::openshift-enterprise[]
        image: registry.access.redhat.com/openshift3/ose-haproxy-router:v3.2.0 <1>
endif::[]
ifdef::openshift-origin[]
 ...
 template:
    spec:
      ...
      - env:
        ...
ifdef::openshift-enterprise[]
        image: registry.access.redhat.com/openshift3/ose-docker-registry:v3.2.0 <1>
endif::[]
ifdef::openshift-origin[]
...
v3.2.0          <pushed>        16 hours ago    registry.access.redhat.com/openshift3/nodejs-010-rhel7:v3.2.0 66d92cebc0e48e4e4be3a93d0f9bd54f21af7928ceaa384d20800f6e6fcf669f
----
====
...
originally installed prior to the OpenShift Enterprise 3.1 release. This may
include any and all updates from that version.
endif::[]
ifdef::openshift-origin[]
The following steps may be required for any OpenShift cluster that was
...
ifdef::openshift-enterprise[]
With OpenShift Enterprise 3.1, certificates for each of the kubelet nodes were
updated to include the IP address of the node. Any node certificates generated
before OpenShift Enterprise 3.1 may not contain the IP address of the node.
endif::[]
ifdef::openshift-origin[]
...
ifdef::openshift-enterprise[]
With OpenShift Enterprise 3.1, certificates for each of the masters were updated
to include all names that pods may use to communicate with masters. Any master
certificates generated before OpenShift Enterprise 3.1 may not contain these
