 ...
 template:
    spec:
      ...
      - env:
        ...
ifdef::openshift-enterprise[]
        image: registry.access.redhat.com/openshift3/ose-haproxy-router:v3.2.1.21 <1>
endif::[]
ifdef::openshift-origin[]
 ...
 template:
    spec:
      ...
      - env:
        ...
ifdef::openshift-enterprise[]
        image: registry.access.redhat.com/openshift3/ose-docker-registry:v3.2.1.21 <1>
endif::[]
ifdef::openshift-origin[]
...
xref:../install/docker_registry.adoc#docker-registry-configuration-reference-middleware[middleware
...
Edit your custom configuration file, add the missing entries, and
xref:../install/docker_registry.adoc#docker-registry-deploying-updated-configuration[deploy
your updated configuration]. Append the `--overwrite` flag to `oc volume
dc/docker-registry --add` to replace a volume mount of your previous secret.
Then you can safely remove the old secret.

[[updating-the-registry-accept-schema2]]
==== Accept schema 2
Docker registry since version
ifdef::openshift-enterprise[]
`v3.2.1.16`
endif::[]
ifdef::openshift-origin[]
...
allows to accept images of
xref:../install/docker_registry.adoc#middleware-repository-acceptschema2[manifest
V2 schema 2]. If your are sure that all clients of your internal Docker
registry support this schema, you can safely
xref:../install/docker_registry.adoc#advanced-overriding-the-registry-configuration[enable
this option]. The schema is supported by Docker daemon of version 1.10 or
higher.
...
# oc get -n default dc/docker-registry -o json | grep \"image\"
    "image": "openshift3/ose-docker-registry:v3.2.1.21",
# oc get -n default dc/router -o json | grep \"image\"
    "image": "openshift3/ose-haproxy-router:v3.2.1.21",
endif::[]
ifdef::openshift-origin[]
# oc get -n default dc/docker-registry -o json | grep \"image\"
