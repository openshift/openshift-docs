...
xref:../../release_notes/ose_3_2_release_notes.adoc#release-notes-ose-3-2-release-notes[OpenShift Enterprise 3.2.0]
that are not already mentioned inline during the standard manual upgrade
process.
