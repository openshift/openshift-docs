...
. Add any other `openshift_logging_*` variables that you to specify to override
the defaults, as described in
...
<2> Used for the Hawkular Metrics route. Should correspond to a fully qualified
domain name.

. Add any other `openshift_metrics_*` variables that you to specify to override
the defaults, as described in
