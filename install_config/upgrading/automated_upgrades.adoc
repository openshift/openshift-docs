...
xref:../../release_notes/ocp_3_4_release_notes.adoc#ocp-34-asynchronous-errata-updates[asynchronous errata updates] within a minor version (e.g., 3.4.z).
...
xref:../../release_notes/ocp_3_4_release_notes.adoc#ocp-34-asynchronous-errata-updates[asynchronous
errata updates]
