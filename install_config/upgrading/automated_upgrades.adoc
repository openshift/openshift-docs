...
xref:../../release_notes/ocp_3_6_release_notes.html#ocp-36-asynchronous-errata-updates[asynchronous
errata updates]
...
openshift_hosted_metrics_deployer_version=<tag>
----
...
<5> Replace `<tag>` with `{latest-int-tag}` for the latest metrics deployer version.
