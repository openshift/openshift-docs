...
openshift_hosted_logging_deployer_version=3.6 <3>
----
...
<3> Replace `3.6` with `{latest-int-tag}` for the latest version if desired.
...
openshift_hosted_metrics_deployer_version=3.6 <3>
