...
This includes upgrading from previous minor versions, such as release 3.5 to
3.6, and applying asynchronous errata updates within a minor version (3.6.z
releases). See the xref:../../release_notes/ocp_3_6_release_notes.adoc#release-notes-ocp-3-6-release-notes[{product-title} 3.6 Release Notes] to review the latest changes.
