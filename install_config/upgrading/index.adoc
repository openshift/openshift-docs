...
releases). See the xref:../../release_notes/ocp_3_3_release_notes.adoc#release-notes-ose-3-3-release-notes[{product-title} 3.3 Release Notes] to review the latest changes.
...
With
xref:../../install_config/upgrading/blue_green_deployments.html#upgrading-blue-green-deployments[blue-green deployments], you can reduce downtime caused while upgrading an environment by
