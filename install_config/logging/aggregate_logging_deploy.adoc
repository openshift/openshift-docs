...
and the xref:../../install_config/logging/aggregate_logging_configure.html#aggregated-fluentd[Fluentd] sections
...
described in
xref:../../install_config/logging/aggregate_logging_configure.adoc#install-config-aggregate-logging-configure-understanding[Creating the Curator Configuration].
