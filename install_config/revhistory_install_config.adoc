...
|link:../install_config/storage_examples/shared_storage.html[Storage Examples -> Sharing an NFS Persistent Volume (PV) Across Two Pods]
|New topic providing an end-to-end example of how to use an existing NFS cluster and {product-title} persistent store.

|link:../install_config/storage_examples/gluster_example.html[Storage Examples -> Complete Example Using GlusterFS]
|New topic providing an end-to-end example of how to use an existing Gluster cluster as an {product-title} persistent store.

|link:../install_config/storage_examples/ceph_example.html[Storage Examples -> Complete Example Using Ceph RBD]
|New topic providing end-to-end example of using an existing Ceph cluster as an {product-title} persistent store.

.2+|link:../install_config/persistent_storage/persistent_storage_ceph_glusterfs.html[Configuring Persistent Storage -> Persistent Storage Using GlusterFS]
