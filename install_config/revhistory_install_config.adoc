...
|xref:../install_config/install/disconnected_install.adoc[Installing -> Disconnected Installation]
|Fixed command in xref:../install_config/install/disconnected_install.html#disconnected-syncing-repos[Syncing Repositories] section.
...
|xref:../install_config/upgrading/automated_upgrades.adoc[Performing Automated Cluster Upgrades]
...
|xref:../install_config/install/prerequisites.adoc[Install -> Prerequisites]
