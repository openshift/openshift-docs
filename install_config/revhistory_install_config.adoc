...
|xref:../install_config/upgrading/automated_upgrades.adoc#install-config-upgrading-automated-upgrades-upgrades[Upgrading a Cluster -> Automated In-Place Upgrades]
|xref:../install_config/upgrading/blue_green_deployments.adoc#install-config-upgrading-blue-green-deployments[Upgrading a Cluster -> Blue-Green Deployments]
