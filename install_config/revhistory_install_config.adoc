...
|Removed information on disabling DNSMSQ from the xref:../install_config/install/prerequisites.adoc#dns[DNS section]. DNSMSQ must be enabled starting in version 3.6.
