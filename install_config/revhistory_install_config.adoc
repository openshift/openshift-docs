...
|Added troubleshooting guidance on xref:../install_config/registry/registry_known_issues.adocc#known-issue-prune-fails-due-to-delete-disabled[Image Pruning Failures].
