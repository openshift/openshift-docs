...
|Updated authentication proxy requirements in xref:../install_config/configuring_authentication.adc#RequestHeaderIdentityProvider[Request Header].
...
|xref:../install_config/cluster_metrics.adoc#[install-config-cluster-metrics[Enabling Cluster Metrics]
|Added more details to the xref:../install_config/cluster_metrics.adoc#metrics-ansible-variables[Metrics Ansible Variables] section.

n|xref:../install_config/aggregate_logging.adoc#install-config-aggregate-logging-sizing[Aggregate Logging Sizing Guidelines]
...
|xref:../install_config/upgrading/automated_upgrades.adoc#install-config-upgrading-automated-upgrades[Upgrading a Cluster -> Automated In-place Cluster Upgrades]
...
n|xref:../install_config/upgrading/manual_upgrades.adoc#install-config-upgrading-manual-upgrades[Upgrading a Cluster -> Performing Manual In-place Cluster Upgrades]
...
n|xref:../install_config/router/default_haproxy_router.adoc#install-config-router-default-haproxy[Setting up a Router -> Using the F5 Router Plug-in]
...
n|xref:../install_config/configuring_authentication.adoc#install-config-configuring-authentication[Configuring Authentication and User Agent]
...
|xref:../install_config/redeploying_certificates.adoc#install-config-redeploying-certificates[Redeploying Certificates]
|Added xref:../install_config/redeploying_certificates.adoc#redeploying-registry-router-certificates[Registry and Router Certificates] section with instructions on redeploying these certificates manually.
