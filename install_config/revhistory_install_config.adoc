...
|Removed the `--port` option when creating the route in the xref:../install_config/cluster_metrics.adoc#metrics-reencrypting-route[Using a Re-encrypting Route] section, as it caused issues. link:https://bugzilla.redhat.com/show_bug.cgi?id=1359598[(*BZ#1359598*)]
