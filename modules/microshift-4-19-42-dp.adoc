...
[id="microshift-4-19-42-dp_{context}"]
= RHSA-2026:51422 - {microshift-short} 4.19.42 fixed issue and security update advisory

Issued: 12 August 2026

[role="_abstract"]
{product-title} release 4.19.42 is now available. Bug fixes and enhancements are listed in the link:https://access.redhat.com/errata/RHSA-2026:51422[RHSA-2026:51422] advisory. Release notes for fixed issues are provided in this documentation. The images that are included in the update are provided by the {OCP} link:https://access.redhat.com/errata/RHSA-2026:51007[RHSA-2026:51007] advisory.
...
[id="microshift-4-19-42-dp-bug-fixes_{context}"]
== Fixed issues
