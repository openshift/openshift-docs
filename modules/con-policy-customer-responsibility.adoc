...
[role="_abstract"]
The customer is responsible for the applications, workloads, and data that they deploy to {product-title}. However, Red Hat and AWS provide various tools to help the customer manage data and applications on the platform.
...
- Enable integration with third-party data services (such as AWS RDS) to store and manage data outside of the cluster and/or cloud provider.
