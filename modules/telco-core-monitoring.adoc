...
[role="_abstract"]
The Cluster Monitoring Operator (CMO) is included by default in {product-title} and provides monitoring, including metrics, dashboards, and alerting, for the platform components and optionally user projects.
