...
//
// * troubleshoot/auto-reboot-during-argo-cd-sync-with-machine-configurations.adoc
...
. If a rebooting node hosts the Argo CD application controller, the controller stops and the sync is aborted.
