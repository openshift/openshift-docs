...
The following table details the components of the Ingress Operator and if Red Hat Site Reliability Engineering (SRE) maintains this component on {product-title} clusters.
