...
* To restore the Central certificates and redeploy Central, run the `roxctl central generate interactive` command and provide the path to your backup file, which creates a central-bundle folder with the necessary manifests and scripts. 
+
