...
// FIXME: Link targets RHOSP 16.2 docs. Update when RHOSO equivalent is available.
...
// FIXME: Link targets RHOSP 16.1 docs. Update when RHOSO equivalent is available.
