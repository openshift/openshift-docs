...
* You can deploy SR-IOV on {rh-openstack-first}. See "Planning an SR-IOV deployment ({rh-openstack-first} documentation)".
...
** You can configure CPUs on compute nodes on {rh-openstack}. See "Configuring CPUs on Compute nodes ({rh-openstack-first} documentation)".
