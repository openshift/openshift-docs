...
[role="_abstract"]
Create dual-stack networks and VIPs, then edit the `install-config.yaml` file to deploy a cluster with both IPv4 and IPv6 addressing on {rh-openstack-first}.
