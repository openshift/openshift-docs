...
* This release introduces the ability to attach logs on the *Details* page for the `DaemonSet`, `Deployment`, `Job`, `ReplicaSet` and `StatefulSet` resource types. When asking {ols-long} a question, attaching logs helps provide additional context so {ols-long} can provide a more refined answer. 
