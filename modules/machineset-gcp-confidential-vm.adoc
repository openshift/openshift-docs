...
For more information about Confidential Compute features, functionality, and compatibility, see the {gcp-short} Compute Engine documentation about link:https://cloud.google.com/compute/confidential-vm/docs/about-cvm[Confidential VM].
