...
= About `NonAdminDownloadRequest` (NADR)

As a namespace admin user, you can use the `NonAdminDownloadRequest` (NADR) CR to access detailed information about your backups and restores for troubleshooting. 
...
After the NADR request is validated, a secure download URL is generated to access the requested information.

The following table lists the NADR resources that you can download:
