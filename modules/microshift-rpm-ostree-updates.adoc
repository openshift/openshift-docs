...
= Update {microshift-short} on {op-system-ostree}
...
To begin a {microshift-short} update by embedding the new version in a {op-system-ostree} image, use the procedures in "Applying updates on a RHEL for Edge system".
