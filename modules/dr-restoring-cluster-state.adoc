...
.. Remove the northbound database (nbdb) and southbound database (sbdb). Access the recovery host and the remaining nodes by using Secure Shell (SSH) and run the following command:
+
[source,terminal]
----
