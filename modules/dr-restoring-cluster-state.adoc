...
[IMPORTANT]
====
When you restore your cluster, you must use an etcd backup that was taken from the same z-stream release. For example, an {product-title} 4.4.2 cluster must use an etcd backup that was taken from 4.4.2.
====
