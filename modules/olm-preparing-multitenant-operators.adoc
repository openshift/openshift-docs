...
[role="_abstract"]
To provide separate Operator instances for each tenant in a multitenant {product-title} cluster, you can install multiple instances of the same Operator in dedicated namespaces.
