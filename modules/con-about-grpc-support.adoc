...
[role="_abstract"]
You can use `GRPCRoute` custom resources (CRs) for your Remote Procedure Call (gRPC)-native applications and services in all of your {prodname} policies except `TokenRateLimitPolicy` CRs. You can migrate existing policies after you create your `GRPCRoute` CRs.
