...
[role="_abstract"]
You can use the *Vulnerability Management* dashboard view to identify vulnerabilities in your nodes, including core Kubernetes components and container runtimes.
