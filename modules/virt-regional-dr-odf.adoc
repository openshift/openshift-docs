...
* Because Regional-DR uses RBD snapshots to replicate data, applications must be resilient to small variances between VM disks. You can avoid this scenario by using single disk VMs.
