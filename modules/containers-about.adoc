...
[role="_abstract"]
Containers are isolated running instances of container images that serve as the basic units of {product-title} applications. Understanding containers helps you work with containerized applications and manage how they run in your cluster.
