...
RWOP persistent volume (PV) access mode uses the SELinux mount feature. This feature is driver dependent, and enabled by default in AWS EBS
...
SELinux mount for RWO and RWX access modes is a Technology Preview feature.
