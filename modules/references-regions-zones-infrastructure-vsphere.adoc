...
|`vcenters` | The vCenter servers for your {product-title} cluster. You can only specify one vCenter for your cluster in production; however, you can specify up to three vCenters if installing with VSphereMultiVcenter feature gate.
