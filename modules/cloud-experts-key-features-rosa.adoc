...
{product-title} is a managed service which is based on {product-title}. You can view the current version and life cycle dates in the _Additional resources_.
