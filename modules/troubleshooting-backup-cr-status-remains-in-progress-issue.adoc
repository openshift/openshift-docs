...
= Troubleshooting backup CR status remains in progress issue

If a backup is interrupted, it cannot be resumed, and the status of a `Backup` CR remains in the `InProgress` phase and does not complete.
