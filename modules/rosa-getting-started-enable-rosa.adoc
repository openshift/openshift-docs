...
. Under *ROSA enablement*, ensure that a green checkmark and `You previously enabled ROSA` are displayed.
+
...
.. Click *Enable ROSA*.
+
After a short wait, a green checkmark and `You enabled ROSA` message are displayed.
