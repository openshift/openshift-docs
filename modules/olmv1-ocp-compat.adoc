...
Before cluster administrators can update their cluster to the next minor version of {product-title} (4.y), they must ensure that all installed Operators are updated to a version that is compataible with that next cluster minor version.
