...
Labels in Loki are both the keyspace on which Loki shards incoming data, and the index used for finding logs at query-time. You can optimize query performance by properly using labels. 
