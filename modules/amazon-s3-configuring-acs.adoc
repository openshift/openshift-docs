...
. Optionally, enter an *Object Prefix* if you want to save the backups in a specific folder structure. For more information, see the "Working with object metadata" Amazon documentation topic.
...
. Select *Test* to confirm that the integration with Amazon S3 is working.
