...
metadata:
  name: new-profile
  annotations:
    compliance.openshift.io/product-type: Node # Set 'Node' or 'Platform' accordingly
spec:
  compliance.openshift.io/product-type: Node # Set 'Node' or 'Platform' accordingly
spec:
  extends: ocp4-cis-node # The 'extends' field is optional
  description: My custom profile # Use the description field to describe the function of the new TailoredProfile object
  title: Custom profile # Give your TailoredProfile object a title with the title field
  enableRules:
