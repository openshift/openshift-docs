...
+
--
`spec.updates.- name`:: To set a BIOS version, set the `name` attribute to `bios`.
`spec.updates.- name.url`:: To set a BIOS version, set the `url` attribute to the URL for the firmware version of the BIOS.
`spec.updates.- name`:: To set a BMC version, set the `name` attribute to `bmc`.
`spec.updates.- name.url`:: To set a BMC version, set the `url` attribute to the URL for the firmware version of the BMC.
--
