...
existing shards from that node to other nodes if possible. If no nodes have free capacity below 85%, Elasticsearch effectively rejects creating new indices
