...
[role="_abstract"]
Configure advanced correlation search settings in the {coo-full} troubleshooting panel, including time ranges, search distance, goal classes, and custom {korrel8r} queries.
