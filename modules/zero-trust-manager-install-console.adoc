...
.. Update the *Update channel*, if necessary. The channel defaults to *alpha*, which installs the latest alpha release of the {zero-trust-full}.
...
zero-trust-workload-identity-manager-controller-manager-6c4djb  1/1     Running   0          4m2s
----
+
You can use the {zero-trust-full} only after the operand pods are up and running.
