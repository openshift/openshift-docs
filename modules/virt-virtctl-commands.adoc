...
|Return full list of filesystems available on the guest machine.

|`virtctl guestosinfo <vmi_name>`
|Return guest agent info about operating system.

|`virtctl userlist <vmi_name>`
|Return full list of logged in users on the guest machine.
|===
