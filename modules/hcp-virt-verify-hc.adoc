...
:navtitle: Verify hosted cluster creation on {VirtProductName}
[id="hcp-virt-verify-hc_{context}"]
= Verifying hosted cluster creation on {VirtProductName}

[role="_abstract"]
After you create a hosted cluster on {VirtProductName}, verify that it was successfully created.
