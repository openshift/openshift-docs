...
. Click one of the permission sets to view its details. The details page shows a list of resources and their permissions for the selected permission set.
+
[NOTE]
====
You cannot change permissions for a system permission set.
====