...
[id='nodes-pods-configuring-replication_{context}']
= Understanding how to control pod counts using replication controllers

A replication controller ensures that a specified number of replicas of a pod are running at
...
The following is an example defintion of a replication controller:
