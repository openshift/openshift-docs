...
[id="logging-release-notes-6-5-0-enhancement_{context}"]
= New features and enhancements

[role="_abstract"]
The following section lists the new features and enhancements introduced in this release of {LoggingProductName}. It highlights key improvements, added capabilities, and updates that enhance functionality.
