...
Installing {product-title} x86 tenant cluster (3 Control plane nodes and 3 workers nodes) requires a discovery ISO, which you can generate with the following procedure.
