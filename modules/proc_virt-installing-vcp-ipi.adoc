...
[NOTE]
====
Installer-provisioned infrastructure for virtualized control planes requires a provisioning network or a {op-system-base} 9 provisioner node.
...
* A {op-system-base} 9 provisioner node is available, or a provisioning network is configured.
