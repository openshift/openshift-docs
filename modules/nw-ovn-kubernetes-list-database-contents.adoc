...
[role="_abstract"]
To understand OVN-Kubernetes logical networking entities, you must examine the northbound database running as a container inside the node pod. This inspection allows you to view active configurations and verify switch properties.
