...
The `watchNamespace` value cannot be set to a Red{nbsp}Hat SRE-managed namespace. If you try to set the `watchNamespace` value to watch resources inside any of these protected system namespaces, the service account associated with the request will be blocked.
endif::[]
