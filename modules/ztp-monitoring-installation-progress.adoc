...
When the synchronization is complete, the installation generally proceeds as follows: the Assisted Service Operator installs {product-title} on the cluster. You can monitor the progress of cluster installation from the {rh-rhacm} dashboard or from the command line.
