...
+
----
$ curl -J -L -O https://releases-art-rhcos.svc.ci.openshift.org/art/storage/releases/ootpa/410.8.20190429.0/rhcos-410.8.20190429.0-metal-bios.raw.gz
----

*** To download the UEFI file:
+
----
$ curl -J -L -O https://releases-art-rhcos.svc.ci.openshift.org/art/storage/releases/ootpa/410.8.20190429.0/rhcos-410.8.20190429.0-metal-uefi.raw
----
