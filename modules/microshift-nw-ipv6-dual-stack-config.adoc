...
= Configuring IPv6 dual-stack before {microshift-short} starts
...
. If you have not started {microshift-short}, replace the default values in the `network` section of the {microshift-short} YAML with your desired valid values.
+
...
<3> Example node IP address. Must be an IPv6 address family.
