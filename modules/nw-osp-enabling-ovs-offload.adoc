...
:navtitle: Enable OVS hardware offloading
...
`kind`:: Specifies the `SriovNetworkNodePolicy` value.
`spec.nicSelector.pfNames`:: Specifies the physical function (PF) name. Both interfaces must include PF names.
--
+
