...
[role="_abstract"]
You can declaratively customize Prometheus resources and resolve configuration conflicts by using Server-Side Apply.
...
`spec.logLevel`:: Added and set to `info`
