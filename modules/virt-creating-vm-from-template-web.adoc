...
.. Optional: Filter the template list. You can select a project from the *All projects* menu, apply a *Category* filter to narrow templates by application type, apply other filters such as operating system, or enter a keyword in the *Filter by keyword* field.
