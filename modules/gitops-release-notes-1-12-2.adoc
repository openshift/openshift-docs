...
* With this update, support has been provided for the `must-gather` tool in the {argo-rollouts-title} controller. This update provides support for the following enhancements:
...
** Contents of `Deployment`, `Statefulset`, and `ConfigMaps` CRs created by the `must-gather` tool in the {argo-rollouts-title} controller.
