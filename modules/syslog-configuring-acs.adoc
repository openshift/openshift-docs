...
. In the *Create integration* page, give the following information:
...
+
For example, if your syslog receiver accepts objects from many sources, type `source` and `rhacs` in the *Key* and *Value* fields.
+
