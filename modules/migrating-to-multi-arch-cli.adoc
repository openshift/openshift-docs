...
====
+
* If you want more detailed information about the status of your update, you can also monitor the migration by running the following Technology Preview command:
+
[source,terminal]
----
