...
In this example, the net queue count is set to the reserved DERPEEDOO count (2) for _all_ supported devices.
...
In this example, the net queue count is set to the reserved DERPEEDOO count (2) for _all_ supported network devices with a specific `vendorID`.
...
In this example, the net queue count is set to the reserved DERPEEDOO count (2) for _all_ supported network devices that match any of the defined device identifiers.
