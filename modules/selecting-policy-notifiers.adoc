...
[role="_abstract"]
You can attach notifiers to the policy to send policy violations to email recipients or external tools such as Slack, Jira, Splunk, or other applications that use webhooks. 
