...
----
$ oc create ns _<namespace-name>_ <1>
----
<1> Replace _<namespace-name>_ with the namespace name you want to use. In the following examples, `ai-demo` is used.
...
[source,terminal,subs="+quotes"]
----
$ oc get ns _<namespace-name>_ <1>
----
<1> Replace _<namespace-name>_ with the namespace name you want to use. In the following examples, `ai-demo` is used.
+
.Example output
