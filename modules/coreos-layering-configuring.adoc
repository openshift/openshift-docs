...
<2> Specifies the path to the Hotfix package. Use the full path and name in your Containerfile, such as: `FROM quay.io/openshift-release/ocp-release@sha256:6499bc69a0707fcad481c3cb73225b867d`.
+
[NOTE]
====
...
<2> Specifies the path to the custom layered image in the repository. Use the full path and name in your machine config, such as: `osImageURL: quay.io/my-registry/custom-image@sha256:306b606615dcf8f0e5e7d87fee3`.
