...
metadata:
  ...
  name: installer-cloud-credentials
data:
  aws_subscription_id: <base64_encrypted_aws_subscription_id>
  aws_client_id: <base64_encrypted_aws_client_id>
  aws_client_secret: <base64_encrypted_aws_client_secret>
  aws_tenant_id: <base64_encrypted_aws_tenant_id>
  aws_resource_prefix: <base64_encrypted_aws_resource_prefix>
  aws_resourcegroup: <base64_encrypted_aws_resourcegroup>
  aws_region: <base64_encrypted_aws_region>
----
+
[IMPORTANT]
====
