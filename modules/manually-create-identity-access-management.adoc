...
--included:: The `--included` parameter includes only the manifests that your specific cluster configuration requires.
<path_to_directory_with_installation_configuration>/install-config.yaml:: Specifies the location of the `install-config.yaml` file.
