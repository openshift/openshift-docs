...
[role="_abstract"]
You can view the compliance status for all clusters or an individual cluster to monitor adherence to required compliance standards.
...
* To view the compliance status for a specific cluster in your environment:
