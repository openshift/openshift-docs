...
To prevent pod failure, do not add the `quay.io/openshift-community` and `quay.io` registries to the `blockedRegistries` list. Payload images within your environment require access to these registries.
endif::[]
====
