...
[role="_abstract"]
Create a `SharedSecret` custom resource (CR) to share a `Secret` object across namespaces. This resource ensures that sensitive configuration data is consistently available throughout your cluster.
