...
* You have created a `Secret` object that you want to share in other namespaces. To create a `Secret` object, see link:https://docs.redhat.com/en/documentation/openshift_container_platform/4.19/html/builds_using_buildconfig/creating-build-inputs#builds-creating-secrets_creating-build-inputs[Creating Secrets].
