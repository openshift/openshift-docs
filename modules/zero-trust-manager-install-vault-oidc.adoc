...
* A route needs to be configured. For more information, see link:https://docs.redhat.com/en/documentation/openshift_container_platform/4.19/html/ingress_and_load_balancing/configuring-routes#route-configuration[Route configuration]

* Helm is installed.

* A command-line JSON processor for easily reading the output from the Vault API.

* The HashiCorp Helm repository is added.
