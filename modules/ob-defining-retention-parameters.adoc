...
[role="_abstract"]
Retention parameters provide a way to clean your `BuildRun` instances or resources automatically.
...
The following example shows the usage of retention parameters in a `Build` custom resource (CR):
