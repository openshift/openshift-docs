...
= Enable cross-namespace waypoint usage
...
.. Add the `istio.io/use-waypoint-namespace` label to specify the namespace where the waypoint is present by running the following command:
+
[source,terminal]
----
