...
. In the web console, go to the *Observe* -> *Alerting* -> *Alerts* page.
...
. In the web console, go to the *Observe* -> *Alerting* -> *Silences* page.
...
. In the web console, go to the *Observe* -> *Alerting* -> *Alerting rules* page.
