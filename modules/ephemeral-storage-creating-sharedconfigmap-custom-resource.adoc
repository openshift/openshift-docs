...
[role="_abstract"]
Create a `SharedConfigMap` custom resource (CR) to share a `ConfigMap` object across namespaces. By creating a `SharedConfigMap` CR, you can ensure that consistent configuration data is accessible throughout your cluster environment.
...
[source,terminal]
----
$ oc get role <role_name> -n <namespace>
----
.Example output
[source,terminal]
----
NAME                   CREATED AT
shared-test-config     2025-11-18T22:00:00Z
----
...
[source,terminal]
----
oc get rolebinding <rolebinding_name> -n <namespace>
----
.Example output
[source,terminal]
----
...
[source,terminal]
----
oc get clusterrole <clusterrole_name>
----
.Example output
[source,terminal]
----
NAME                      CREATED AT
shared-configmap-user     2025-11-18T21:58:00Z
----
