...
rd.zfcp=0.0.5677,0x600606680g7f0056,0x034F000000000000 \ <2>
zfcp.allow_lun_scan=0 \
rd.znet=qeth,0.0.bdd0,0.0.bdd1,0.0.bdd2,layer2=1 \
rd.zfcp=0.0.5677,0x600606680g7f0056,0x034F000000000000
----
<1> For installations on FCP-type disks, add `zfcp.allow_lun_scan=0`. Omit this value for DASD-type disks.
<2> For installations on FCP-type disks, add `rd.zfcp=0.0.5677`.
endif::ibm-z-kvm[]
ifdef::ibm-z-kvm[]
[source,terminal]
----
