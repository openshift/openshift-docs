...
:navtitle: Install the PF Status Relay Operator using the web console
[id="installing-pfsr-console_{context}"]
= Installing the PF Status Relay Operator using the web console

[role="_abstract"]
Install the PF Status Relay Operator to enable {product-title} to use Link Aggregation Control Protocol (LACP) as an active health check on physical functions.
