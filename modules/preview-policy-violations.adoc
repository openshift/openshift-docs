...
. View the results in the *Preview violations* panel to ensure that the policy is working. This panel provides additional information, including if build phase or deploy phase deployments have violations of the policy.
+
[NOTE]
====
Runtime violations are not available in this preview because they are generated when future events occur.
====
