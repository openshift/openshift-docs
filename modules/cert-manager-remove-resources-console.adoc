...
:navtitle: Remove {cert-manager-operator} resources
[id="cert-manager-remove-resources-console_{context}"]
= Removing {cert-manager-operator} resources

[role="_abstract"]
After you uninstall the {cert-manager-operator}, you can delete its associated resources from your cluster.
