...
[role="_abstract"]
ifdef::operator-ref[]
The Marketplace Operator is an optional cluster capability that can be disabled by cluster administrators if you do not need the Operator.

For more information about optional cluster capabilities, see "Cluster capabilities"_.
endif::operator-ref[]
