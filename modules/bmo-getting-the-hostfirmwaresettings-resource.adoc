...
[role="_abstract"]
To review vendor-specific BIOS properties for a physical host, you can get the `HostFirmwareSettings` resource. This resource provides the information required to verify the BIOS properties.
