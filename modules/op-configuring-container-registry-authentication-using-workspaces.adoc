...
$ tkn task start <task-name>
      --workspace name=<workspace-name>,secret=<secret-name> # <1>
      # ...
----
<1> Replace `<workspace-name>` with the name of the workspace that you configured and `<secret-name>` with the name of the secret that you created.
