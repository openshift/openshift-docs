...
*QUESTION: I think it is too soon to say this, as it will be created as part of the stack. So it won't be there yet, correct?*

|*OpenShift version*
| * For installations on virtual machines only, specify `OpenShift 4.15` or a later version.

* For installations that include bare metal machines, specify `OpenShift 4.16` or a later version. 

*QUESTION: Is what I wrote here correct? The VM integration was supported for 4.14 but it was technology preview*
