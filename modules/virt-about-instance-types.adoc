...
An instance type is a reusable object for which you can define resources and characteristics to apply to new VMs. You can define custom instance types or use the predefined instance types that are included when you install {VirtProductName}.
