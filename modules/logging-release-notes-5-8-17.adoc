...
= Logging 5.8.17
This release includes link:https://access.redhat.com/errata/RHBA-2025:1224[OpenShift Logging Bug Fix Release 5.8.17] and link:https://access.redhat.com/errata/RHSA-2025:1225[OpenShift Logging Bug Fix Release 5.8.17].
