...
[id="installing-odo-on-linux-on-ibm-power-reg_{context}"]
= Installing {odo-title} on Linux on IBM Power

[id="installing-odo-on-linux-on-ibm-power-reg-binary_{context}"]
== Binary installation
...
[id="installing-odo-on-linux-on-ibm-power-reg-tarball_{context}"]
