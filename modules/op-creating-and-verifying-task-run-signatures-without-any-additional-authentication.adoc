...
[id="create-and-verifying-task-run-signatures-without-any-additional-authentication_{context}"]
= Create and verify task run signatures
...
. To verify the signature by using the public key that you created, enter the following command:
+
[source,terminal]
----
