...
[role="_abstract"]
Review the following troubleshooting scenarios for common VPN connection issues.
...
If the tunnel connection doesn't remain *Up*, check that all AWS tunnel connections must be initiated from your gateway. AWS tunnels link:https://docs.aws.amazon.com/vpn/latest/s2svpn/VPC_VPN.html#CustomerGateway[do not initiate tunneling].
