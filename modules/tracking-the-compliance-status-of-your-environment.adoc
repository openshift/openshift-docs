...
[role="_abstract"]
You can generate executive reports (PDF) or evidence reports (CSV) to track and communicate the compliance status of your environment to stakeholders.

By generating compliance reports, you can track the compliance status of your environment. You can use these reports to communicate compliance status across various industry mandates to other stakeholders.
