...
:navtitle: Determin the phase of a machine by using the web console
[id="machine-determine-phase-gui_{context}"]
= Determining the phase of a machine by using the web console

[role="_abstract"]
To troubleshoot issues with a machine, you can find the phase of a machine by using the {product-title} web console.
