...
* The Kafka channel implementation was updated to include some improvements to the config map and data plane. If you are using the previous Kafka channel implementation, this is migrated to the new implementation automatically.
