...
[role="_abstract"]
If you are using custom priorities or mandatory custom fields in your Jira project, you might get an error when you try to integrate {product-title} with Jira Software.
...
. Extract the `.zip` file to retrieve the custom priority values in use in your JIRA project.
