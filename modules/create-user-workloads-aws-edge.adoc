...
<location_label>:: Specifies a label to identify workloads deployed in the Outpost. For example: `outposts`.
...
<application_name>:: Specifies a name for your application.
<application_namespace>:: Specifies a namespace for your application.
