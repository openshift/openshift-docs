...
[role="_abstract"]
When `Central` or `SecuredCluster` custom resources do not expose certain low-level configuration options as parameters, you can use the `.spec.overlays` field for adjustments.
