...
[IMPORTANT]
====
If your cluster deployment requires a proxy configuration, you must create a seed image from a seed cluster featuring a proxy configuration and you must configure the `machineNetwork` field in your installation manifest. The proxy configurations do not have to match.
====
