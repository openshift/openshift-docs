...
[NOTE]
====
The label for the gateway namespace differs between mulitenant and cluster-wide meshes. Return to the either the multitenant or cluster-wide migration guide to understand which labels to use in your specific migration case.
====
...
.. If necessary, remove `istio-injection=enabled`.
