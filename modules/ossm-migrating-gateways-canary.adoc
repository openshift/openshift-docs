...
The gateway canary migration scenario is recommend for a gradual rollout. It uses multiple gateway versions with maximum control over your gateway rollout.
