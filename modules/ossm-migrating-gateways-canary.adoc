...
The gateway canary migration method is recommend for a gradual rollout. It uses multiple gateway versions with maximum control over your gateway rollout.
