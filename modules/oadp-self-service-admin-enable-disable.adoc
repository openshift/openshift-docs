...
[NOTE]
====
You can install only one instance of the `NonAdminController` (NAC) in the cluster. You get the following error, if you install the NAC again:
...
* To enable {oadp-short} Self-Service, edit the DPA and perform the following steps:
