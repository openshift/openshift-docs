...
[id="configuring-lokistack-otlp-data-ingestion_{context}"]
= Configure LokiStack for OTLP data ingestion

[role="_abstract"]
Enable OpenTelemetry Protocol log ingestion on LokiStack by using schema version 13.
