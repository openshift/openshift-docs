...
== New features
{pipelines-title} Technology Preview (TP) 1.3 is now available on {OCP} 4.7.
{pipelines-title} TP 1.3 is updated to support:

* Tekton Pipelines 0.19.0
* Tekton `tkn` CLI 0.15.0
* Tekton Triggers 0.10.2
* cluster tasks based on Tekton Catalog 0.19.0
* {ibmpowerProductName} Systems on {OCP} 4.7
* {ibmzProductName} and LinuxONE on {OCP} 4.7
