...
= Installing the {oadp-short} VMDP CLI

[role="_abstract"]
Install the {oadp-short} VM data protection (VMDP) command-line tool inside your virtual machine (VM) to back up and restore data. This helps you to download the correct binary for your VM guest operating system.
...
----
+
Make a note the `CLUSTER-IP` value from the output.
