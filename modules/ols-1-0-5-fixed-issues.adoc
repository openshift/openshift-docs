...
[role="_abstract"]
{ols-official} 1.0.5 resolves a technical issue that prevented successful communication with the GPT-5 model. This fix eliminates `Error code: 400` messages from OpenAI, ensuring that users can leverage the latest large language model (LLM) capabilities within the virtual assistant.
