...
[role="_abstract"]
Use the *Configuration Management* view to get information about the Kubernetes roles assigned to specific users and groups.
...
The *Users and Groups* view displays a list of Kubernetes users and groups, their assigned roles, and whether each has the `cluster-admin` role.
