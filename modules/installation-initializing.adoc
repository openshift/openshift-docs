...
[NOTE]
====
After you create the installation configuration file, you can modify the file to deploy machines across multiple {rh-openstack} availability zones. For more information, see "{rh-openstack} availability zone enablement".
====
endif::[]
ifeval::["{context}" == "installing-openstack-installer-restricted"]
[NOTE]
