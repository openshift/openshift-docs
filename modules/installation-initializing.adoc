...
[IMPORTANT]
====
Do not specify `windows` or other variants of this word in the `metadata.name` parameter of the `install-config.yaml` file. Specifying this word for the cluster name causes the installation program to generate the following error message:
