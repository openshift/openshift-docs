...
[id="oadp-cli-admin-nabsl-prereqs_{context}"]
== Prerequisites
...
[id="oadp-cli-admin-nabsl-list_{context}"]
...
[id="oadp-cli-admin-nabsl-describe_{context}"]
...
[id="oadp-cli-admin-nabsl-approve_{context}"]
...
[id="oadp-cli-admin-nabsl-reject_{context}"]
