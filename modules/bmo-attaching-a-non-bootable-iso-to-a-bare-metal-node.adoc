...
<iso_url>:: Specifies the URL and path to the ISO image.
...
<node_namespace>:: Specifies the namespace that matches the namespace for the `BareMetalHost` resource. For example, `openshift-machine-api`.
