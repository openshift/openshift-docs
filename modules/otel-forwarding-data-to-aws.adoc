...
= Forward telemetry to AWS

[role="_abstract"]
To forward telemetry to AWS, use the OpenTelemetry Collector with the following exporters: AWS CloudWatch Logs Exporter for logs, AWS EMF Exporter for metrics, and AWS X-Ray Exporter for traces.
