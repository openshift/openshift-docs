...
[role="_abstract"]
{ols-official} 0.3.6 resolves an issue where the Operator was unable to connect to Large Language Model (LLM) providers when a cluster-wide proxy was configured.
