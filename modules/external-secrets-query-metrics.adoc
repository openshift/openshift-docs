...
= Querying metrics for the {external-secrets-operator} by using the web console

After you enable monitoring for the {external-secrets-operator}, you can query its metrics by using the {product-title} web console.
