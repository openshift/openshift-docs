...
* link:https://mirror.openshift.com/pub/cgw/pipelines/{osp-version-minor}.{osp-version-patch}/tkn-linux-amd64.tar.gz[Linux (x86_64, amd64)]
* link:https://mirror.openshift.com/pub/cgw/pipelines/{osp-version-minor}.{osp-version-patch}/tkn-linux-s390x.tar.gz[Linux on {ibmzProductName} and {linuxoneProductName} (s390x)]
* link:https://mirror.openshift.com/pub/cgw/pipelines/{osp-version-minor}.{osp-version-patch}/tkn-linux-ppc64le.tar.gz[Linux on {ibmpowerProductName} (ppc64le)]
* link:https://mirror.openshift.com/pub/cgw/pipelines/{osp-version-minor}.{osp-version-patch}/tkn-linux-arm64.tar.gz[Linux on ARM (aarch64, arm64)]
* link:https://mirror.openshift.com/pub/cgw/pipelines/{osp-version-minor}.{osp-version-patch}/tkn-macos-amd64.tar.gz[macOS]
* link:https://mirror.openshift.com/pub/cgw/pipelines/{osp-version-minor}.{osp-version-patch}/tkn-windows-amd64.zip[Windows]
