...
* link:https://mirror.openshift.com/pub/openshift-v4/clients/pipelines/1.11.0/tkn-linux-s390x.tar.gz[Linux on {ibm-z-reg} and {ibm-linux-one-reg} (s390x)]
* link:https://mirror.openshift.com/pub/openshift-v4/clients/pipelines/1.11.0/tkn-linux-ppc64le.tar.gz[Linux on {iibm-cloud-bm-reg} (ppc64le)]
