...
[role="_abstract"]
You can migrate individual {from-api-name} resources to equivalent {to-api-name} resources to test the {to-api-name} functionality or migrate to using the {to-api-name} for managing compute resources.
...
* xref:../../machine_management/cluster_api_machine_management/cluster-api-getting-started.adoc#machine-set-authoritative-api-machines_cluster-api-getting-started[Authoritative API types of compute machines]
