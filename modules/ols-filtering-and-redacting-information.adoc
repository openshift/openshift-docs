...
Configure {ols-long} to filter or redact sensitive information, preventing it from being sent to the LLM provider. 
...
This example shows how to modify the `OLSConfig` custom resource (CR) file to redact IP addresses, but you can also filter or redact other kinds of sensitive information.   
