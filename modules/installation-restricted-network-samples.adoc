...
Most image streams in the `openshift` namespace managed by the Cluster Samples Operator point to images located in the Red{nbsp}Hat registry at link:https://registry.redhat.io[registry.redhat.io].
endif::[]
ifdef::openshift-origin[]
Most image streams in the `openshift` namespace managed by the Cluster Samples Operator point to images located in the Red{nbsp}Hat registry at link:https://quay.io/openshift-community[quay.io/openshift-community].
endif::[]
...
ifdef::openshift-origin[]
. Mirror images from link:https://quay.io/openshift-community[quay.io/openshift-community] associated with any image streams you need
endif::[]
ifdef::restrictednetwork[]
