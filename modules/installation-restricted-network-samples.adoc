...
[NOTE]
====
Any unmirrored imagestreams that are not skipped, or if the Cluster Samples Operator is
not changed to `Removed`, will result in the Cluster Samples Operator reporting a
