...
//
// * extend/configuring_traffic_management_and_metric_plugins_in_argo_rollouts.adoc
...
[role="_abstract"]
Enable traffic management and metric plugins in Argo Rollouts to control canary and blue-green deployment traffic routing and to collect deployment analysis metrics.
