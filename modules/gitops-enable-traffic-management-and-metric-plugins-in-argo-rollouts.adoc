...
[role="_abstract"]
Enable traffic management and metric plugins in Argo Rollouts to integrate with external traffic routers and analysis providers during progressive deployments.
