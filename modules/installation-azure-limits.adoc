...
ifndef::ash[]
[role="_abstract"]
The {product-title} cluster uses a number of Microsoft {cp} components. Default subscription and service limits, quotas, and constraints can affect your ability to install {product-title} clusters.
