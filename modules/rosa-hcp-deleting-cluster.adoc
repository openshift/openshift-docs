...
[WARNING]
====
If you attached another security group to the PrivateLink endpoint, you must remove it before deleting your cluster. Failure to remove the security group may cause cluster deletion to fail.
====
+
