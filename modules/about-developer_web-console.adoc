...
//To be added when snippet is merged.
//include::snippets/unified-perspective-web-console.adoc[]

Developers have access to workflows specific to thier use cases, such as the ability to:
...
See link:https://docs.openshift.com/container-platform/4.18/applications/odc-viewing-application-composition-using-topology-view.html[Viewing application composition using the Topology] view for more information on using the *Topology* view.
