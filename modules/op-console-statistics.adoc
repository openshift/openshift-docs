...
* Install {tekton-results}. For more information about installing {tekton-results}, see _Using Tekton Results for {pipelines-shortname} observability_ in the _Additional resources_ section.
