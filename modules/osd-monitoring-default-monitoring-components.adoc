...
By default, the {product-title} monitoring stack includes these components:
...
|The Cluster Monitoring Operator (CMO) is a central component of the monitoring stack. It deploys and manages Prometheus Operator instances, the Thanos Querier, the Telemeter Client, and metrics targets and ensures that they are up to date. The CMO is deployed by the Cluster Version Operator (CVO).
