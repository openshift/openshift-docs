...
You can define the relationships between templates in your reference configuration. 

By defining relationships, you can support use-cases with complex dependencies. For example, you can configure a component to require specific templates, require one template from a group, or allow any template from a group, and so on. 
