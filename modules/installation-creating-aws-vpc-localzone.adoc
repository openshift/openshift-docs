...
[role="_abstract"]
You can create a Virtual Private Cloud (VPC), and subnets for all {zone-type} locations, in Amazon Web Services (AWS) for your {product-title} cluster to extend compute nodes to edge locations.
