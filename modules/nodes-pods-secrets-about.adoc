...
[[nodes-pods-secrets-about-types]]
== Types of secrets
...
* `kubernetes.io/dockercfg`. Uses the *_.dockercfg_* file for required Docker credentials.
* `kubernetes.io/dockerconfigjson`. Uses the *_.docker/config.json_* file for required Docker credentials.
...
[[nodes-pods-secrets-about-examples]]
