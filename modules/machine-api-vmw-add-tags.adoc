...
+
--
`spec.template.spec.providerSpec.value.tagIDs`:: Specifies a list of up to 10 tags to add to the machines that this machine set provisions.
`<tag_id_value>`:: Specifies the value of the tag that you want to add to your machines.
