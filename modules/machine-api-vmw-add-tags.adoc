...
tagIDs:: Specify a list of up to 10 tags to add to the machines that this machine set provisions.
<tag_id_value>:: Specify the value of the tag that you want to add to your machines.
