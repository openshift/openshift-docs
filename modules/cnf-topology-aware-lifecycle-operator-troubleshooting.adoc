...
[WARNING]
====
After you set the `spec.enable` to `true` in the `ClusterUpgradeGroup` CR , the update procedure starts and you cannot edit the CR's `spec` fields anymore.
====
...
Issue:: You want to check the logs of the manager container of TALO.
