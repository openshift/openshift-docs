...
ifndef::openshift-origin[The {op-system-base-full} 8.1 installation process on the provisioner node might vary. To install {op-system-base-full} 8.1 using a local Satellite server or a PXE server, you may PXE-enable NIC2.]
ifdef::openshift-origin[The {op-system-first} installation process on the provisioner node might vary. To install {op-system} using a local Satellite server or a PXE server, you may PXE-enable NIC2.]
