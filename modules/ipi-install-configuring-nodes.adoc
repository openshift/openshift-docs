...
The RHEL 8.1 installation process on the provisioner node may vary. To install RHEL 8.1 using a local Satellite server or a PXE server, you may PXE-enable NIC2.
