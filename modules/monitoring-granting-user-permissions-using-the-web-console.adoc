...
= Grant user permissions by using the web console

[role="_abstract"]
Cluster administrators can grant users permissions for the `openshift-monitoring` project or their own projects, by using the {ocp} web console.
