...
[id="machine-config-node-update-phases_{context}"]
= Node update phases and conditions

[role="_abstract"]
You can view detailed update phases and conditions and monitor cluster configuration changes by querying the machine config node custom resource.
