...
[NOTE]
====
`roxctl` CLI for Linux is available for `x86_64`, `amd64`, `ppc64le`, and `s390x` architectures.
====

.Procedure

. Query the architecture where to install `roxctl` and set `$arch` environment variable:
+
