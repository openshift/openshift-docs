...
[role="_abstract"]
You can have the request rate, error, and duration (RED) metrics extracted from traces and visualized through the Jaeger Console in the *Monitor* tab of the {ocp-product-title} web console.

.Prerequisites

* You have configured the permissions and tenants for {dt}. For more information, see "Configuring the permissions and tenants".
