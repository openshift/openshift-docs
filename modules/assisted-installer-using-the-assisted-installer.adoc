...
[id="additional-resources_nmstate-configurations"]
== Additional resources

* For more information, related to NMState configuration examples, see xref:https://nmstate.io/examples.html[NMState configuration examples].
