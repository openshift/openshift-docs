...
+
A window opens that gives information about the image and the SBOM format that {product-title-short} generates. {product-title-short} creates the file in JSON format. Depending on your browser configuration, your browser can automatically download the file to your computer.