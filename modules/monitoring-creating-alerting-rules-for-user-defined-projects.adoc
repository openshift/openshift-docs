...
* Include alert severity and message in your YAML configuration file. This ensures clarity regarding why the alert is triggered and and its resulting impact.
====
