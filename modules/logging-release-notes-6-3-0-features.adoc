...
* With this release, the default values of Splunk metadata keys, such as index, indexed fields, source, and message payload, are predefined for log forwarders. The values are based on the log type. As a user, you can override these values. (https://issues.redhat.com/browse/LOG-6859[LOG-6859])
