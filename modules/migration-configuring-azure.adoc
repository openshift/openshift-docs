...
[NOTE]
====
Always assign a specific `--role` and `--scopes` when you create a service principal.
====
+
[source,terminal]
----
$ AZURE_CLIENT_SECRET=`az ad sp create-for-rbac --name "velero" \
                                                ...
                                                --scopes /subscriptions/<subscription_ID>/<resource_groups>/<resource_group_group_name> `
----
+
[NOTE]
====
