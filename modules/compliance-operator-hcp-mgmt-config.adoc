...
spec:
  ...
  extends: ocp4-cis # Only ocp4-cis and ocp4-pci-dss profiles are supported in hcp management clusters
  ...
  - name: ocp4-hypershift-cluster
    ...
    value: 79136a1bdb84b3c13217 # The value is the NAME from the output in the previous step
  - name: ocp4-hypershift-namespace-prefix
    rationale: This value is used for HyperShift control plane namespace detection
    value: local-cluster # The value is the NAMESPACE from the output in the previous step
----
