...
. You can select the checkboxes for one or more CVEs, and then click *Add selected CVEs to Policy* (*`add`* icon) or point to a CVE in the list, and click the *Add* icon.
...
. Verify the listed CVEs that this policy includes.
. Click *Save Policy*.