...
//* you did everything else up to this point

.Procedure

//what would a real-world use query be? possibly asking the model to classify the image in this request/reseemblence chance result based on what the model was trained with
