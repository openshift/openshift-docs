...
After you created an `ocm-role` resource with administrative permissions, you can use the automatic creation method from {cluster-manager}. Selecting this method creates the roles and policies that uses the default names.
