...
.ROSA installer role, policy, and policy file
[cols="1,2",options="header"]
|===
...
|`HCP-ROSA-Installer-Role-Policy`
|An IAM policy that provides the ROSA installer with the permissions required to complete cluster installation tasks.
...
.ROSA compute node role, policy, and policy file
[cols="1,2",options="header"]
|===
