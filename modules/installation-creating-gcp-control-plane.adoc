...
= Creating the control plane machines in {gcp-full}

You must create the control plane machines in {gcp-full} for
...
* Ensure you defined the variables in the _Exporting common variables_, _Creating load balancers in {gcp-full}_, _Creating IAM roles in {gcp-full}_, and _Creating the bootstrap machine in {gcp-full}_ sections.
