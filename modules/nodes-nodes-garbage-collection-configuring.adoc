...
<10> For image garbage collection: Image garbage collection attempts to free resources to the specified disk usage (expressed as an integer). This value must be less than the `imageGCHighThresholdPercent` value.
