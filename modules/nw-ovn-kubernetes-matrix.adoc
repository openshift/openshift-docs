...
3. IPv6 is supported only on bare metal, vSphere, {iibm-cloud-bm-reg}, and {ibm-z-reg} clusters.

4. IPv6 single stack is not supported on {iibm-cloud-bm-reg} and {ibm-z-reg} clusters.
--
