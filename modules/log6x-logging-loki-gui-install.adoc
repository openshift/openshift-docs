...
. While the operator installs, you can create the namespace where the log store will be deployed to.
...
. In the *LokiStack* tab you should now see your `LokiStack` instance.
