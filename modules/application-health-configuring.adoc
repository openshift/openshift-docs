...
<7> Specify the number of seconds to perform the probe. The default is `10`. Must be greater than `timeoutSeconds`.
<8> Specify the number of seconds between probes. The default is `10`. Must be lower than `periodSeconds`.
...
<18> Specify the number of seconds to perform the probe. The default is `10`. Must be greater than `timeoutSeconds`.
<19> Specify the number of seconds between probes. The default is `1`. Must be lower than `periodSeconds`.
+
[NOTE]
====
