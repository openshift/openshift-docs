...
= Preparing for the 1.38 to 1.39.0 upgrade

[role="_abstract"]
Before starting the upgrade process, prepare your {ServerlessLogicProductName} environment to upgrade from version 1.38 to 1.39.0.
