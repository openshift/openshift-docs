...
*_Core platform alerting rule considerations_*

* New alerting rules must be based on the default monitoring metrics.
...
Therefore, any dropped alerts still appear in the web console even though they are no longer forwarded to Alertmanager.
