...
After the {ServerlessOperatorName} is upgraded to version 1.36.0 you can optionally delete the old `ReplicaSet`.
...
. (Optional) Identify and delete the old ReplicaSet associated with version 1.35.0 by running the following command:
+
[source,terminal]
----
