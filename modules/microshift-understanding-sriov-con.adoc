...
* SR-IOV Network Operator: You install this Kubernetes component to detect and manage SR-IOV devices. This component exposes the SR-IOV devices as schedulable resources within {microshift-short}.
