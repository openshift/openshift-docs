...
[source,terminal]
----
$ oc new-app openshift/deployment-example --name=ab-example-a --lables=ab-example=true
----
+
...
[source,terminal]
----
$ oc new-app openshift/deployment-example --name=ab-example-b --lables=ab-example=true
----
+
