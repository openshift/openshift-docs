...
* Due to a link:https://bugzilla.redhat.com/show_bug.cgi?id=2213862[known issue] in {rh-openstack}, to give nodes access to the metadata service, you must set the value of `force_metadata` to `False` in the Neutron DHCP agent configuration.
