...
Audit logging holds information
...
|`deny`
|Optional field provided you must specified at least one of `allow`, `deny`, or both to enable audit logging for a namespace. The field supports `alert`, `warning`, `notice`, `info`, or `debug` values.
