...
[role="_abstract"]
To customize how your cluster monitors both the platform and user-defined projects, edit the relevant `ConfigMap` objects that define the cluster and user workload monitoring configurations.
