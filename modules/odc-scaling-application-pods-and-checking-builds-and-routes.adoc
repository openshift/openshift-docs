...
[role="_abstract"]
The *Topology* view provides the details of the deployed components in the *Overview* panel. You can use the *Overview* and *Details* tabs to scale the application pods, check build status, services, and routes.
