...
[NOTE]
====
For details of the telco RAN DU RDS KPI test results, see the link:https://access.redhat.com/articles/7137864[telco RAN DU {product-version} reference design specification KPI test results].
