...
* Plan your {rh-openstack-first} OVS-DPDK deployment by referring to link:https://docs.redhat.com/en/documentation/red_hat_openstack_services_on_openshift/18.0/html/deploying_a_network_functions_virtualization_environment/plan-ovs-dpdk-deploy_rhoso-nfv[Planning your OVS-DPDK deployment] in the Network Functions Virtualization Planning and Configuration Guide.

* Configure your {rh-openstack} OVS-DPDK deployment according to link:https://docs.redhat.com/en/documentation/red_hat_openstack_services_on_openshift/18.0/html/deploying_a_network_functions_virtualization_environment/config-dpdk-deploy_rhoso-nfv[Configuring an OVS-DPDK deployment] in the Network Functions Virtualization Planning and Configuration Guide.
