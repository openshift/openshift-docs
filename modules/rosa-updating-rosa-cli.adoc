...
.  Install the new version of the {rosa-cli} by moving the extracted file into your path. In the following example, your path includes the `/usr/local/bin` directory:
+
[source,terminal]
----
...
.Verification
* Verify the new version of the {rosa-cli} installed successfully.
+
[source,terminal]
----
$ rosa version
