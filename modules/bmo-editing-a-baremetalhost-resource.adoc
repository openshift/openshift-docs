...
[role="_abstract"]
To update hardware configurations or migrate nodes between clusters without deprovisioning, you can edit a `BareMetalHost` resource. This procedure involves detaching the node from the Ironic service to safely modify settings such as the BMC host name or IP address.
