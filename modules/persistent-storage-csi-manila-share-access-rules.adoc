...
:navtitle: Customize Manila share access rules
...
* `parameters.type`: Specifies the Manila share type. This type must match an existing share type in your {rh-openstack} environment.
