...
The `osd-managed-admin` IAM service account is created immediately after taking control of your {gcp-short} account. This is the user that will perform the {product-title} cluster installation.
