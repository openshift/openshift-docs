...
//Is manual version maintenance required for this link? The 4.22/vanilla.yaml file exists but isn't identical to 4.19. Can be we can't link to it without an SME review.
