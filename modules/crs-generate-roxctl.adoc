...
`<file_name>`:: Specifies a file name. Use `-` for standard output.
--
+
[IMPORTANT]
====
Ensure that you store this file securely because it has secrets.
You can use the same file to set up more than one secured cluster. You cannot retrieve a CRS that was generated before.
====
+
