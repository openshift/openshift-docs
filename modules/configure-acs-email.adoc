...
. Optional: Enter a hostname to use for the Simple Mail Transfer Protocol (SMTP) during the SMTP handshake. If you do not specify a hostname, `localhost` is used automatically.