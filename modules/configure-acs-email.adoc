...
[IMPORTANT]
====
If you are using {product-title-managed-short}, it blocks port number `25` by default. Configure your mail server to use port `587` or `465` to send email notifications.
====
