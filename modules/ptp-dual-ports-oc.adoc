...
You can configure PTP ordinary clocks with added redundancy on x86 architecture nodes. The nodes must feature dual-port NICs that support PTP and expose a single PTP hardware clock (PHC) per NIC, such as the Intel E810.
