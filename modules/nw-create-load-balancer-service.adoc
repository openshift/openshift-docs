...
[IMPORTANT]
====
Load balancer support depends on cloud service provider. Some are not capable of creating load balancers and will ignore this aspect of service resources.
====
