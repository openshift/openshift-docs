...
:navtitle: Create the OpenShift Update Service graph data container image
...
. Create a Dockerfile, for example, `./Dockerfile`, containing the following information:
+
[source,terminal]
----
