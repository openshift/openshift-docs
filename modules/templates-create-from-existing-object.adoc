...
[role="_abstract"]
To create a template without writing it from scratch, export existing objects from your project as YAML and add parameters and other template customizations. Use `oc get -o yaml` to capture the resources you want to include in the template.
