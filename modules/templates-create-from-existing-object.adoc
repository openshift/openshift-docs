...
[role="_abstract"]
To create a template without writing it from scratch, export existing objects from your project and add parameters and other template customizations. Reusing deployed resources helps you capture a working configuration that others can deploy consistently from the template.
