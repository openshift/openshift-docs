...
[role="_abstract"]
ifdef::hcp-preqs[]
If you created your own virtual private cloud (VPC) to create a {product-title} cluster, you must tag your VPC subnets.
endif::hcp-preqs[]
ifndef::hcp-preqs[]
Before you can use your virtual private cloud (VPC) to create a {product-title} cluster, you must tag your VPC subnets.
endif::hcp-preqs[]
