...
[NOTE]
====
The default installation of {product-title} 4.0 is designed to work for most production environments and should not need further configuring and adjusting.
==== 
