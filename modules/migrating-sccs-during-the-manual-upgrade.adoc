...
--
`kind`:: Specifies the type of Kubernetes resource, in this example, `Role`.
`metadata.name`:: Specifies the name of the role resource.
...
`kind`:: Specifies the type of Kubernetes resource, in this example, `RoleBinding`.
`metadata.name`:: Specifies the name of the role binding resource.
