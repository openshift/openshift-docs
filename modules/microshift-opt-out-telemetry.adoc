...
If your cluster is not connected to a network, or you simply do not want telemetry gathered, you can easily opt of Telemetry by disabling the parameter in the {microshift-short} configuration file.
