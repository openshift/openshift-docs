...
You specify AWS S3-compatible object storage, such as Multicloud Object Gateway, Ceph RADOS Gateway - also known as Ceph Object Gateway -  or MinIO, as a backup location.
