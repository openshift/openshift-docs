...
You specify AWS S3-compatible object storage as a backup location, such as Multicloud Object Gateway (MCG); Red Hat Container Storage; Ceph RADOS Gateway, also known as Ceph Object Gateway; {odf-full}; or MinIO.
