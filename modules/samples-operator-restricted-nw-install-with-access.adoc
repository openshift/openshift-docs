...
* link:https://docs.redhat.com/en/documentation/openshift_container_platform/4.18/html/installation_configuration/installing-customizing[Customizing nodes]

To host samples in your restricted environment, use the following instructions:

* link:https://docs.redhat.com/en/documentation/openshift_container_platform/4.18/html/images/samples-operator-alt-registry[Using the Cluster Samples Operator with an alternate registry]
