...
On clusters that support converting Machine API resources to Cluster API resources, some resources seem to have duplicate instances in the output of commands that list resources and in the {product-title} web console.
...
* One machine health check instance.
--
+
...
Due to this behavior, instances of machine set and machine resources that seem to be duplicates appear in the output of commands that list resources and in the {product-title} web console.
