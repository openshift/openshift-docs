...
. Modify the options based on link:https://github.com/kubernetes/cloud-provider-openstack/blob/release-1.25/docs/openstack-cloud-controller-manager/using-openstack-cloud-controller-manager.md#config-openstack-cloud-controller-manager[the `cloud.conf` specification].
+
