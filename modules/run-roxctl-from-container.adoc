...
----
$ docker pull registry.redhat.io/advanced-cluster-security/rhacs-roxctl-rhel9:{rhacs-version}
----
+
...
$ docker run -e ROX_API_TOKEN=$ROX_API_TOKEN \
  -it registry.redhat.io/advanced-cluster-security/rhacs-roxctl-rhel9:{rhacs-version} \
...
[source,terminal,subs=attributes+]
----
$ docker run -it registry.redhat.io/advanced-cluster-security/rhacs-roxctl-rhel9:{rhacs-version} version
----