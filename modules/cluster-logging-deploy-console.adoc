...
<10> Settings for configuring collector. Using the CR, you can configure collector CPU and memory limits. For more information, see *Configuring collector*.
+
[NOTE]
+
====
...
+
You should see several pods for OpenShift Logging, Elasticsearch, collector, and Kibana similar to the following list:
+
