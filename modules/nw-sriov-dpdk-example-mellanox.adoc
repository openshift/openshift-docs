...
. Verify that the Mellanox SR-IOV virtual function is attached to the pod with RDMA capability:
+
[source,terminal]
----
$ oc exec dpdk-app -n <target_namespace> -- ls /sys/class/infiniband/
----
+
.Example output
[source,terminal]
