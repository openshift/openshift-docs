...
. Configure the NUMA Resources Operator, you must create a single `NUMAResourcesOperator` CR on the cluster. The `nodeGroups` configuration in this CR tells the Operator which node pools to manage.
+
[NOTE]
====
