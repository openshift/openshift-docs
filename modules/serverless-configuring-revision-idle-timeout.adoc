...
* You have cluster administrator permissions on {ocp-product-title}. Alternatively, you have cluster administrator or dedicated administrator permissions on {rosa-product-title} or {dedicated-product-title}.
