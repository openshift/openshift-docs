...
* You have cluster administrator permissions on {ocp-product-title}. Alternatively, cluster administrator or dedicated administrator permissions on {rosa-product-title} or {dedicated-product-title}.
