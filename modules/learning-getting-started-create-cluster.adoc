...
[role="_abstract"]
To deploy and manage containerized applications in a cloud environment, create a {product-title} cluster. You can efficiently perform this installation process by using the {rosa-cli}.
