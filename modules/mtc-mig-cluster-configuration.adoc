...
[id="mtc-mig-cluster-configuration"]
...
|string
|No
|Image to use for Stage Pods (only applicable to IndirectVolumeMigration)
...
|string
|No
|Image to use for Rsync Pods (only applicable to DirectVolumeMigration)
...
|string
|No
|Subpath to validate exposed registry in a MigCluster (e.g. /v2)
|===
