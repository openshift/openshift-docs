...
* *{dt}* - This component is based on the open source Grafana Tempo project.
...
* *{OTELName}* - This component is based on the open source OpenTelemetry project.
...
* link:https://grafana.com/oss/tempo/[Grafana Tempo project]
