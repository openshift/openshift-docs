...
administrator with `dedicated-admin` permissions,
endif::[]
you can manually create and configure role-based access control (RBAC) policies to grant user access to extension resources by using custom role bindings.
