...
[NOTE]
====
Some of the instant app and quick start templates define a database `DeploymentConfig`. The configuration they define uses ephemeral storage for the database content. These templates should be used for demonstration purposes only as all database data is lost if the database pod restarts for any reason.
====
