...
:navtitle: Troubleshoot SSH access to cluster nodes
...
. If you have physical access to the nodes, check their console output to verify if they have successfully booted. If the nodes are still retrieving their boot configuration, there might be problems with the bootstrap VM .
