...
[role="_abstract"]
As a cluster administrator, you can add unauthenticated users to specific cluster roles by creating a cluster role binding when required for your use case.
