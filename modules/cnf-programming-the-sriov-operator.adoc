...
[id="configuring-the-sriov-fec-operator-intel-fpga-pac-n3000_{context}"]
= Configuring the SRIOV-FEC operator for Intel® FPGA PAC N3000

This section describes how to program the SRIOV-FEC Operator for Intel® FPGA PAC N3000.
...
[NOTE]
====
This output shows the N3000 and SR-IOV pods running.
====
...
<3> Create two virtual functions
