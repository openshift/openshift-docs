...
* You have installed the `buildah` strategy. You can use the following command to verify if the `buildah` strategy is installed:
+ 
[source,terminal]
----
...
[NOTE]
====
If the `buildah` strategy is not installed, see _Installing buildah strategy_ in the _Additional resources_ section.
====
