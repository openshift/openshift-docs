...
----
<1> Ensure this label matches the `machineConfigPoolSelector` in the `NUMAResourcesOperator` CR configured later in "Creating the NUMAResourcesOperator custom resource".
