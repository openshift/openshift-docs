...
[role="_abstract"]
Use the Command Line Interface (CLI) to install the necessary {builds-title} components in {ocp-product-title}. This method supports scripted and automated deployment of configurations needed to compile and containerize applications within the cluster.
