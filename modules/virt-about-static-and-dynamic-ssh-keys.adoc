...
If the image used for the VM is set to use dynamic SSH key management, the VM uses the feature by default. If not, you can enable it by updating the configuration of the VM.
