...
:navtitle: Upload the {op-system} cluster image and bootstrap Ignition config file
...
[role="_abstract"]
To make the {op-system} cluster image and bootstrap Ignition config accessible during deployment, you can upload them to an Azure storage container.
...
[role="_abstract"]
To make the {op-system} cluster image accessible during deployment, you can download and upload the image to your Azure Stack Hub environment.
