...
| Group
| The group (folder) that the virtual machine belongs to.
...
| Memory
| The amount of memory allotted to the virtual machine. Select a modifying expression, enter a value to search on, and select what that value represents.
...
. Optional: Filter the list of virtual machines by project or cluster by using the *Project* or *Cluster* list.

. Optional: Filter the list of virtual machines by group by using the *Group* list.
