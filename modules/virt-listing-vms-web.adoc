...
You can navigate all virtual machines (VMs) in your cluster by using the web console.
...
. Optional: Click the *Advanced search* button next to the search bar to further filter VMs by their name, project they belong to, their labels, or allocated vCPU and memory resources.
