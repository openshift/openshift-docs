...
Supported integrations are provided with {ObservabilityLongName}, including user-workload monitoring and distributed tracing. For more information, see "{observabilitylongname} and {ssmproductshortname}". Support is also provided for the {KialiProduct}. For more information, see "Using {KialiProduct}".