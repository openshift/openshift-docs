...
= Install the distributed tracing UI plugin

[role="_abstract"]
Create the distributed tracing UI plugin in the {ocp-product-title} web console to enable tracing views for {coo-full}.
...
. Choose the *UI Plugin* tab and click *Create UIPlugin*.
