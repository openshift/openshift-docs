...
[role="_abstract"]
Specify values for the build strategy parameters in your `Build` custom resource (CR). By specifying parameter values, you can control how the steps of the build strategy work. You can also overwrite the values in the `BuildRun` resource. 
