...
containers::
Lightweight and executable images that consist of software and all of its dependencies. Because containers virtualize the operating system, you can run containers anywhere, from a data center to a public or private cloud to your local host.
...
ifdef::openshift-dedicated,openshift-rosa[]
{product-title} supports many types of storage for cloud providers.
endif::openshift-dedicated,openshift-rosa[]
