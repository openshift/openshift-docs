...
= Get detailed information about a metrics target

[role="_abstract"]
You can use the {ocp} web console to view, search, and filter the endpoints that are currently targeted for scraping, which helps you to identify and troubleshoot problems.

For example, you can view the current status of targeted endpoints to see when {ocp} monitoring is not able to scrape metrics from a targeted component.
