...
[role="_abstract"]
As an administrator, use {olmv1} to securely manage your cluster configurations and streamline updates through GitOps-based declarative management, granular extension controls, and flexible packaging formats.
