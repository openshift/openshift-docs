...
* A load-balancer backend, for example, Octavia, is installed on the management RHOCP cluster. The load balancer is required for the `kube-api` service to be created for each hosted cluster.
