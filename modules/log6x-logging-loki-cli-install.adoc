...
To install and configure logging on your {product-title} cluster, you must first install {loki-op}, which manages the log store. This can be done from the {product-title} CLI.
