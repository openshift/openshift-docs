...
with an httpd server configured as running a pod in cluster.

.Example
----
oc login -u basicauth-xxia1 -p redhat
Login successful.

oc get user
NAME              UID                                    FULL NAME
basicauth-xxia1   3884a251-660f-46a5-a081-e21d4923d79c   Hello basicauth-xxia1

IDENTITIES
basicauth-idp:basicauth-xxia1
----
...
echo ""
echo '{"sub":"'$REMOTE_USER'", "name":"'$REMOTE_USER'"}'
exit 0
----
