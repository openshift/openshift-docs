...
The *Policies* view lists the default policies and enables you to configure the policies. 

The policy information is organized in the following groups:
...
The *Policy categories* view lists the categories and enables you to manage the categories for your policies. By default, all the categories are listed. You can optionally filter the categories by using the category name.
