...
|Optional.
Specifies he URL of the server to upload Preboot Execution Environment (PXE) assets to when you are generating an iPXE script.
...
Without specifying this flag, reports are only generated in cases of failure.
|Boolean
