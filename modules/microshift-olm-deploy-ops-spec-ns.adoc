...
----
+
Replace _<my-catalog-source.yaml>_ with your catalog source configuration file name.
...
[source,terminal,subs="+quotes"]
----
$ oc apply -f _<my-subscription_cr.yaml>_
----
+
Replace `_<my-subscription_cr.yaml>_` with the name of the Subscription CR configuration file.
+
.Example output
[source,terminal]
----
