...
+
The output shows information about cluster initialization:
+
----
...
----
+
The output includes the current cluster `VERSION` and `STATUS`:
+
----
...
----
+
The output shows the cluster Operators:
+
----
...
----
+
The output shows the Pods for all namespaces in the current cluster:
+
----
