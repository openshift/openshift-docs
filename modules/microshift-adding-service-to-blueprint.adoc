...
Adding the {microshift-short} RPM package to an image builder blueprint enables the build of a {op-system-ostree} image with {microshift-short} embedded. You can use a generated blueprint for installation. The generated blueprint includes optional RPM packages and container images. Local container references make this a faster {microshift-short} start.
