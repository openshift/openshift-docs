...
ifdef::vpc,restricted[]
<7> If you provide your own VPC, specify subnets for each availability zone that your cluster uses. If you are installing your cluster in a restricted network, you must define the subnets for the VPC your mirror registry is hosted on.
