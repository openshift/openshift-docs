...
= Creating a namespace for UserDefinedNetwork (UDN) by using the CLI

You can create a namespace to be used with primary UserDefinedNetwork (UDN) by using the {oc-first}.
