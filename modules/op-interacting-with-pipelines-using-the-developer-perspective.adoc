...
+
* Use the zoom in, zoom out, fit to screen, and reset view features by using the standard icons displayed in the lower left corner of the *Pipeline details* visualization.
* Change the zoom factor of the pipeline visualization by using the mouse wheel.
