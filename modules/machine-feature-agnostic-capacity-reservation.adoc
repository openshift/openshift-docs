...
`capacity-reservations-only`:: Use this option to require a matching capacity reservation.
...
If no matching capacity reservation is available, the instance falls back to On-Demand.
