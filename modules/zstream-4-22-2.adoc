...
+
The Helm CLI for Red{nbsp}Hat {product-title} v4.1.4 is the first supported downstream build of Helm v4, available as a standalone binary from the {product-title}  mirror repository. This release provides access to Helm v4 capabilities, enabling you to evaluate and use Helm v4 workflows on {product-title}.
+
...
+
Red{nbsp}Hat does not distribute Helm as a traditional RPM.
+
