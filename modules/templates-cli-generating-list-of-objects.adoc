...
[role="_abstract"]
To preview objects a template creates on your {product-title} cluster, use the CLI to process the template without applying it. Review the generated object list and save it to a file before you create resources in your project.
