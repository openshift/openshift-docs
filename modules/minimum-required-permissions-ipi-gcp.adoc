...
** This permission can be limited to act as the control plane and compute service accounts. Alternatively, you may apply the `iam.serviceAccountUser` role to the control plane and compute service accounts instead of granting the `actAs` permission.
...
** Alternatively, you may grant the `iam.serviceAccountTokenCreator` role to the service account you create instead.
====
