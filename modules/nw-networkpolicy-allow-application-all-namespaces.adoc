...
:navtitle: Create a {name} policy allowing traffic to an application from all namespaces
[id="nw-networkpolicy-allow-traffic-from-all-applications_{context}"]
= Create a {name} policy allowing traffic to an application from all namespaces
