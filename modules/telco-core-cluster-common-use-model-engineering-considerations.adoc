...
For a cluster configured according to the reference configuration, running a simulated workload of 3k pods as created by the kube-burner node-density test the following CPU requirements are validated:
