...
[source,terminal]
----
$ opc results pipelinerun describe <pipelinerun_name>
----
+
...
[source,terminal]
----
$ opc results pipelinerun describe --uid <pipelinerun_uuid>
----
+
...
[source,terminal]
----
$ opc results pipelinerun describe --output yaml <pipelinerun_name>
----
+
Alternatively, you can use the pipeline run UUID instead of the name:
+
[source,terminal]
----
$ opc results pipelinerun describe --output yaml --uid <pipelinerun_uuid>
----
...
[source,terminal]
----
$ opc results pipelinerun logs <pipelinerun_name>
----
+
Alternatively, you can use the pipeline run UUID instead of the name:
+
[source,terminal]
----
$ opc results pipelinerun logs --yaml --uid <taskrun_uuid>
----
