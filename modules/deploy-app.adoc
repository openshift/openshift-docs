...
. Click *Create* to open the *Create Source-to-Image application* page.
...
* link:https://docs.openshift.com/container-platform/latest/applications/creating_applications/creating-applications-using-cli.html[Creating applications using the CLI]
* link:https://docs.openshift.com/container-platform/latest/applications/creating_applications/creating-applications-using-web-console.html[Creating applications using the web console]
