...
. To open the *Create Source-to-Image application* page, click *Create*. In the *Git* section, click *Try sample*, add a unique name in the *Name* field, and confirm that *Deployment* and *Create a route* are selected.
