...
. Switch to the *Developer* perspective and select *+Add*. Verify that the selected *Project* is the one that you created.
...
. Add a unique name in the *Name* field. The value is used to name the associated resources.
