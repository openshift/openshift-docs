...
----
`-n`:: If you created additional {pac} controllers to support additional GitHub apps and you are configuring the app for an additional controller, replace `pipelines-as-code-secret` with the name that you configured in the `secretName` parameter for the controller.
