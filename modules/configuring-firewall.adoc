...
|`aws.amazon.com`
|443
|Used to install and manage clusters in an AWS environment. If you use AWS Security Token Service (STS) and the private S3 bucket, you must provide access to CloudFront.
