...
|`*.googleapis.com`
|443
|Required to access {gcp-full} services and resources. Review link:https://cloud.google.com/endpoints/[Cloud Endpoints] in the {gcp-full} documentation to find the endpoints to allow for your APIs.

|`accounts.google.com`
|443
| Required to access your {gcp-full} account.
