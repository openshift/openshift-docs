...
|443
|CDN supporting `registry.redhat.io`
...
|`ec2-\*.*.compute-1.amazonaws.com` ^[2]^
|443
|CDN supporting `quay.io`
...
2. Requests may originate from different EC2 regions, for example `ec2-10-0-0-1.ap-south-1.compute.amazonaws.com`.
--
+
