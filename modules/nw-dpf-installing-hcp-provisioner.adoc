...
----
<1> The container registry repository for BlueField {product-title} layer images. The operator queries this repository for an image tag that matches the {product-title} version.
