...
[role="_abstract"]
You can set custom buckets for build controller histogram metrics. To do this, set the related environment variable. 

The following table lists all histogram metrics, their environment variables, and default values.

.Histogram metrics
[options="header"]
|===

| Metric | Environment variable | Default values (seconds)
