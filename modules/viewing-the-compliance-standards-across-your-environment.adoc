...
[role="_abstract"]
You can view compliance scan results across all clusters, namespaces, and nodes in your environment through the compliance dashboard.
...
[NOTE]
==== 
When you open the compliance dashboard for the first time, the dashboard has no data. Perform a compliance scan to fill the dashboard with data.
====