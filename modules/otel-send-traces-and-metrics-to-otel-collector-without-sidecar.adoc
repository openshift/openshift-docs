...
[role="_abstract"]
You can set up an OpenTelemetry Collector instance to receive telemetry without sidecar injection, which involves manually setting several environment variables.
