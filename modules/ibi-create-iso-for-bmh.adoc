...
* You downloaded the `openshift-install` installation program.
...
.. Optional. Create an installation configuration template that you can use to create the installation ISO:
+
[source,terminal]
----
...
.. Configure your installation configuration file:
+
...
Using your preferred method, boot the `rhcos-ibi.iso` live installation ISO to a bare-metal host to preinstall {sno} on the machine.