...
.Workflow for using the Assisted Installer in a connected environment to install a cluster on {oci}
image::569_OpenShift_ai_install_oci_0725.png[Workflow for using the Assisted Installer in a connected environment to install a cluster on {oci}]
