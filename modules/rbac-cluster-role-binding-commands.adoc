...
[role="_abstract"]
You can manage cluster role bindings using CLI operations. The `-n` flag is not used for these operations because cluster role bindings use non-namespaced resources.
