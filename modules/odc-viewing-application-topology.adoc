...
The *Topology* view also provides you the option to monitor your applications using the *List* view. Use the (image:odc_list_view_icon.png[title="List view icon"]) icon to see a list of all your applications and use the (image:odc_topology_view_icon.png[title="Topology view icon"]) icon to switch back to the graph view.
