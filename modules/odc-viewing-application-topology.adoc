...
The *Topology* view also provides you the option to monitor your applications using the *List* view. Use the *List View* icon to see a list of all your applications and use the *Topology View* icon to switch back to the graph view.
