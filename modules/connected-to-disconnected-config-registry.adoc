...
:navtitle: Configure the cluster for the mirror registry
...
`spec.mirrors`:: Specifies the name of the mirror image registry and repository.
`spec.source`:: Specifies the online registry and repository containing the content that is mirrored.
