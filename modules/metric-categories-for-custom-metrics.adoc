...
`metrics.imageVulnerabilities.descriptors.<metric name>.labels`:: Specifies the one or more labels separated by a comma used to total and filter the metric data.
...
| `Cluster`, `Namespace`, `Deployment`, `Type`, `IsActive`, `IsSuppressed`, `IsPlatformWorkload`, `ImageID`, `ImageRegistry`, `ImageRemote`, `ImageTag`, `Component`, `ComponentVersion`, `OperatingSystem`, `CVE`, `CVSS`, `Severity`, `EPSSPercentile`, `EPSSProbability`, `IsFixable`, `Origin`, `FixAvailable`, `HasCisaKev`, `Published`, `FirstImageOccurrence`, `FirstSystemOccurrence`

| Node vulnerabilities
| `Cluster`, `Node`, `Kernel`, `OperatingSystem`, `OSImage`, `Component`, `ComponentVersion`, `CVE`, `CVSS`, `Severity`, `EPSSPercentile`, `EPSSProbability`, `IsFixable`, `IsSnoozed`, `HasCisaKev`, `Published`
