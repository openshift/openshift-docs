...
openshift-zero-trust-workload-identity-manager   zero-trust-workload-identity-manager   redhat-operators   alpha
----
...
zero-trust-workload-identity-manager.v0.10   Zero Trust Workload Identity Manager   0.1.0    Succeeded
----
...
zero-trust-workload-identity-manager-controller-manager-68x5m9z  1/1     Running   0          3m54s
----
