...
* In {pipelines-shortname} 1.4.1, the `ConsoleQuickStart` custom resource has been updated to align with {product-title} {product-version} capabilities and behavior.
