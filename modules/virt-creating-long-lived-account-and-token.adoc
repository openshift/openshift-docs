...
[role="_abstract"]
When you register an {VirtProductName} provider in the {mtv-first} web console, you must create a service account and cluster role binding, which gives MTV persistent permissions to read and create virtual machine resources during migration.
