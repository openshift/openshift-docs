...
[role="_abstract"]
You can use the {ocp-product-title} web console to split traffic between many revisions of a serverless application. Gradually roll out new versions or run different versions simultaneously for testing and production workloads.
...
image::odc-serverless-revisions.png[Serverless application revisions in the OpenShift Developer Console]
