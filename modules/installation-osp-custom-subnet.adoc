...
[NOTE]
====
The installation program does not create a private network or subnet for your {rh-openstack} machines if the `platform.openstack.machinesSubnet` value is set in the `install-config.yaml` file.
====
