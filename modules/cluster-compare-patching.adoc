...
[source,terminal]
----
$ oc cluster-compare -r <path/to/reference/config>/metadata.yaml -o 'generate-patches' --override-reason "A valid reason for the override" --generate-override-for "<template1_path>" --generate-override-for "<template2_path>" > <path/to/patches/file>
----
+
...
* `<path/to/patches/file>` specifies the filename and path for your patch.
