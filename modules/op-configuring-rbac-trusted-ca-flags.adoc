...
[id="op-configuring-rbac-trusted-ca-flags.adoc_{context}"]
= Configuring RBAC and Trusted CA flags
...
.Example TektonConfig CR for configuring RBAC and trusted CA flags
[source,yaml]
----
