...
[role="_abstract"]
View and analyze incidents in the {ocp-product-title} web console using the {coo-full} incident detection UI plugin to monitor correlated alerts grouped by severity.
