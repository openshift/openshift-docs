...
To run a cluster on {oci-c3}, you must convert your generated Agent ISO image into an {oci} image, upload it to an {oci} Home Region Bucket, and then import the uploaded image to the {oci-c3-short} system.
