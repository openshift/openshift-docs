...
[role="_abstract"]
You can use the `oc` command-line tool to manage your applications and interact with your MicroShift cluster. Use the following commands, along with their descriptions and example usage, to work with your cluster resources.

[id="microshift-oc-annotate_{context}"]
== oc annotate
...
[id="microshift-oc-api-resources_{context}"]
== oc api-resources
...
[id="microshift-oc-api-versions_{context}"]
== oc api-versions
...
[id="microshift-oc-apply_{context}"]
== oc apply
...
[id="microshift-oc-apply-edit-last-applied_{context}"]
...
[id="microshift-oc-apply-set-last-applied_{context}"]
...
[id="microshift-oc-apply-view-last-applied_{context}"]
...
[id="microshift-oc-attach_{context}"]
== oc attach
...
[id="microshift-oc-auth-can-i_{context}"]
== oc auth can-i
...
[id="microshift-oc-auth-reconcile_{context}"]
== oc auth reconcile
...
[id="microshift-oc-auth-whoami_{context}"]
== oc auth whoami
...
[id="microshift-oc-cluster-info_{context}"]
== oc cluster-info
...
[id="microshift-oc-cluster-info-dump_{context}"]
...
[id="microshift-oc-completion_{context}"]
== oc completion
...
[id="microshift-oc-config-current-context_{context}"]
...
[id="microshift-oc-config-delete-cluster_{context}"]
...
[id="microshift-oc-config-delete-context_{context}"]
...
[id="microshift-oc-config-delete-user_{context}"]
...
[id="microshift-oc-config-get-clusters_{context}"]
...
[id="microshift-oc-config-get-contexts_{context}"]
...
[id="microshift-oc-config-get-users_{context}"]
== oc config get-users
...
[id="microshift-oc-config-new-admin-kubeconfig_{context}"]
...
[id="microshift-oc-config-new-kubelet-bootstrap-kubeconfig_{context}"]
...
[id="microshift-oc-config-refresh-ca-bundle_{context}"]
...
[id="microshift-oc-config-rename-context_{context}"]
...
[id="microshift-oc-config-set_{context}"]
== oc config set
...
[id="microshift-oc-config-set-cluster_{context}"]
...
[id="microshift-oc-config-set-context_{context}"]
...
[id="microshift-oc-config-set-credentials_{context}"]
...
[id="microshift-oc-config-unset_{context}"]
== oc config unset
...
[id="microshift-oc-config-use-context_{context}"]
...
[id="microshift-oc-config-view_{context}"]
== oc config view
...
[id="microshift-oc-create_{context}"]
== oc create
...
[id="microshift-oc-create-cluster-role_{context}"]
...
[id="microshift-oc-create-cluster-role-binding_{context}"]
...
[id="microshift-oc-create-config-map_{context}"]
== oc create configmap
...
[id="microshift-oc-create-cronjob_{context}"]
== oc create cronjob
...
[id="microshift-oc-create-deployment_{context}"]
...
[id="microshift-oc-create-ingress_{context}"]
== oc create ingress
...
[id="microshift-oc-create-job_{context}"]
== oc create job
...
[id="microshift-oc-create-namespace_{context}"]
== oc create namespace
...
[id="microshift-oc-create-poddisruptionbudget_{context}"]
...
[id="microshift-oc-create-priorityclass_{context}"]
...
[id="microshift-oc-create-quota_{context}"]
== oc create quota
...
[id="microshift-oc-create-role_{context}"]
== oc create role
...
[id="microshift-oc-create-rolebinding_{context}"]
...
[id="microshift-oc-create-route-edge_{context}"]
...
[id="microshift-oc-create-route-passthrough_{context}"]
...
[id="microshift-oc-create-route-reencrypt_{context}"]
...
[id="microshift-oc-create-secret-docker-registry_{context}"]
...
[id="microshift-oc-create-secret-generic_{context}"]
...
[id="microshift-oc-create-secret-tls_{context}"]
...
[id="microshift-oc-create-service-clusterip_{context}"]
...
[id="microshift-oc-create-service-externalname_{context}"]
...
[id="microshift-oc-create-service-loadbalancer_{context}"]
...
[id="microshift-oc-create-service-nodeport_{context}"]
...
[id="microshift-oc-create-serviceaccount_{context}"]
...
[id="microshift-oc-create-token_{context}"]
== oc create token
...
[id="microshift-oc-debug_{context}"]
== oc debug
...
[id="microshift-oc-delete_{context}"]
== oc delete
...
[id="microshift-oc-describe_{context}"]
== oc describe
...
[id="microshift-oc-diff_{context}"]
== oc diff
...
[id="microshift-oc-edit_{context}"]
== oc edit
...
[id="microshift-oc-events_{context}"]
== oc events
List events
...
[id="microshift-oc-exec_{context}"]
== oc exec
...
[id="microshift-oc-explain_{context}"]
== oc explain
...
[id="microshift-oc-expose_{context}"]
== oc expose
...
[id="microshift-oc-extract_{context}"]
== oc extract
...
[id="microshift-oc-image-append_{context}"]
== oc image append
...
[id="microshift-oc-image-extract_{context}"]
== oc image extract
...
[id="microshift-oc-image-info_{context}"]
== oc image info
...
[id="microshift-oc-image-mirror_{context}"]
== oc image mirror
...
[id="microshift-oc-kustomize_{context}"]
== oc kustomize
...
[id="microshift-oc-label_{context}"]
== oc label
...
[id="microshift-oc-logs_{context}"]
== oc logs
...
[id="microshift-oc-observe_{context}"]
== oc observe
...
[id="microshift-oc-patch_{context}"]
== oc patch
...
[id="microshift-oc-plugin-list_{context}"]
== oc plugin list
...
[id="microshift-oc-policy-add-role-to-user_{context}"]
...
[id="microshift-oc-policy-scc-review_{context}"]
...
[id="microshift-oc-policy-scc-subject-review_{context}"]
...
[id="microshift-oc-port-forward_{context}"]
== oc port-forward
...
[id="microshift-oc-proxy_{context}"]
== oc proxy
...
[id="microshift-oc-rollback_{context}"]
== oc rollback
...
[id="microshift-oc-rollout-cancel_{context}"]
== oc rollout cancel
...
[id="microshift-oc-rollout-history_{context}"]
== oc rollout history
...
[id="microshift-oc-rollout-latest_{context}"]
== oc rollout latest
...
[id="microshift-oc-rollout-pause_{context}"]
== oc rollout pause
...
[id="microshift-oc-rollout-restart_{context}"]
== oc rollout restart
Restart a resource
...
[id="microshift-oc-rollout-resume_{context}"]
== oc rollout resume
...
[id="microshift-oc-rollout-retry_{context}"]
== oc rollout retry
...
[id="microshift-oc-rollout-status_{context}"]
== oc rollout status
...
[id="microshift-oc-rollout-undo_{context}"]
== oc rollout undo
...
[id="microshift-oc-rsync_{context}"]
== oc rsync
...
[id="microshift-oc-scale_{context}"]
== oc scale
...
[id="microshift-oc-secrets-link_{context}"]
== oc secrets link
...
[id="microshift-oc-secrets-unlink_{context}"]
== oc secrets unlink
...
[id="microshift-oc-set-data_{context}"]
== oc set data
...
[id="microshift-oc-set-env_{context}"]
== oc set env
...
[id="microshift-oc-set-image_{context}"]
== oc set image
...
[id="microshift-oc-set-image-lookup_{context}"]
== oc set image-lookup
...
[id="microshift-oc-set-probe_{context}"]
== oc set probe
...
[id="microshift-oc-set-resources_{context}"]
== oc set resources
...
[id="microshift-oc-set-route-backends_{context}"]
...
[id="microshift-oc-set-selector_{context}"]
== oc set selector
...
[id="microshift-oc-set-serviceaccount_{context}"]
...
[id="microshift-oc-set-subject_{context}"]
== oc set subject
...
[id="microshift-oc-set-volumes_{context}"]
== oc set volumes
...
[id="microshift-oc-version_{context}"]
== oc version
...
[id="microshift-oc-wait_{context}"]
== oc wait
