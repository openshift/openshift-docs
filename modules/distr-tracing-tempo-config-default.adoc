...
<8> Configuration for the replication factor. The replication factor is a configuration setting that determines how many ingesters must acknowledge the data from the distributors before accepting a span.
