...
Consider the following tested object maximums when you plan a {product-title} cluster installation. The table specifies the maximum limits for each tested type in a {hcp-title} cluster.
