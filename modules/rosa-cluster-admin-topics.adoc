...
[role="_abstract"]
Use the following resources to learn about, deploy, and manage {product-title} clusters.
...
link:https://www.redhat.com/en/products/interactive-demo/install-rosa[Installing {product-title} interactive demo]
