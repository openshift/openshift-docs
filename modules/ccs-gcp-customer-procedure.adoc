...
= Prepare your {gcp-short} project for Customer Cloud Subscription

[role="_abstract"]
Complete several prerequisites that Red{nbsp}Hat requires to deploy and manage {product-title} into your {gcp-first} project using the Customer Cloud Subscription (CCS) model.
...
|Used for determining what services are available in your {gcp-full} account.
...
|Used to identify governance rules applied to your {gcp-full} that might impact cluster creation or management.
