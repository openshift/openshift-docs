...
|Enables users to procure products from the {gcp-short}  Marketplace. Specifically, this permission is required to validate through API that customers have accepted the  Marketplace terms and conditions for {product-title}.
