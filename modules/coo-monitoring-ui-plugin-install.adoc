...
= Install the monitoring UI plugin
...
`spec.monitoring.acm`:: Enable {rh-rhacm} features. You must configure the Alertmanager and ThanosQuerier Service endpoints.
`spec.monitoring.clusterHealthAnalyzer`:: Enable incident detection features.