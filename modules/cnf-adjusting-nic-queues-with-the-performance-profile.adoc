...
[role="_abstract"]
Optimize network performance by adjusting NIC queue counts for specific devices using the performance profile net specification, which sets queues to the reserved CPU count.
