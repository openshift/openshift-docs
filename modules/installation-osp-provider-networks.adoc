...
You can learn more about provider and tenant networks in link:https://docs.redhat.com/en/documentation/red_hat_openstack_services_on_openshift/18.0/html/managing_networking_resources/manage-proj-network_rhoso-mngnet[the {rh-openstack} documentation].
