...
. Navigate to link: https://console.redhat.com/openshift/create/datacenter.
+
...
[IMPORTANT]
====
You can also click *Bare Metal (x86_64)* on the *Select an {product-title} cluster type to create* page. You are directed to *Create an {product-title} Cluster: Bare Metal* page.
Select *Local Agent-based* to go to the *Install {product-title} on Bare Metal locally with Agent* page.
...
. Click **Download Installer** button to download and extract the install program.
