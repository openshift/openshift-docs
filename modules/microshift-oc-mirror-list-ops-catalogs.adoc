...
Use the following example procedure to select a catalog and list {OCP} Operators to add to your oc-mirror plugin image set configuration file. Selecting a catalog and listing Operators can only be done using oc mirror v1.
