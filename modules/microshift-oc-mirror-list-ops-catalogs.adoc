...
Replace `<catalog_source>` with your catalog source, such as `quay.io/openshift-community/redhat/redhat-operator-index:v{product-version}` or `quay.io/operatorhubio/catalog:latest`.
endif::[]
