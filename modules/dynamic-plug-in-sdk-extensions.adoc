...
`BuildAdapter` contributes an adapter to adapt element to data that can be used by the Pod component.
...
This extension allows plugins to contribute an add action item to the add page of developer perspective. For example, a Serverless plugin can add a new action item for adding serverless functions<br/>to the add page of developer console.
