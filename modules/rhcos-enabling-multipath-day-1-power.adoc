...
[role="_abstract"]
During installation, you can enable multipathing for provisioned nodes on {ibm-power-name}. {op-system} supports multipathing on the primary disk, providing stronger resilience to hardware failure.
