...
[id="use-tekton-chains-to-sign-and-verify-image-and-provenance_{context}"]
= Sign and verify image and provenance
...
* xref:op-authenticating-to-an-oci-registry.adoc#authenticating-to-an-oci-registry_{context}[Authenticate to an OCI registry]
