...
where:
+
`name`:: Specifies the name of the user-defined cluster-scoped Argo CD instance.
`namespace`:: Specifies the namespace where you want to run the user-defined cluster-scoped Argo CD instance.
...
where:
+
`name`:: Specifies the namespace of the user-defined cluster-scoped Argo CD instance.
`Application`:: Specifies the target namespace for the Argo CD server to create and manage `Application` resources.
====
