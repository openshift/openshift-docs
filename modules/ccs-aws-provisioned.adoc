...
[role="_abstract"]
A deployed {product-title} cluster provisions the following AWS components. For a more detailed listing of all provisioned AWS components, see the link:https://access.redhat.com/documentation/en-us/openshift_container_platform/[{OCP} documentation].
...
[id="sample-vpc-architecture_{context}"]
