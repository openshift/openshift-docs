...
= Creating a hostpath provisioner with a single storage pool

You can configure a hostpath provisioner (HPP) with a single storage pool. The storage pool specifies the name and path used by the CSI driver.
