...
<4> If TLS configuration is not set, the default certificates will be used. For more information, run the command `oc explain clusterlogforwarders.spec.inputs.receiver`.
...
[source,terminal]
----
$ Logger –udp –server  collector-syslog-receiver.<ns>.svc:514  “test message”
----
