...
You can learn more about sidecar injection in link:otel-sending-traces-logs-and-metrics-to-otel-collector.html[OpenTelemetry Collector sidecar injection].
====
