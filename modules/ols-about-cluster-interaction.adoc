...
[NOTE]
====
If you configure filtering or redacting in the `OLSConfig` file, and you configure `introspectionEnabled` in a Model Context Protocol (MCP) server, content that tools return is not filtered and is visible to the LLM.
====
