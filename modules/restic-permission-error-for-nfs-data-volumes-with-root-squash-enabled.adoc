...
If your NFS data volumes have `root_squash` enabled, `Restic` maps set to `nfsnobody`, and does not have permission to create backups, the Restic` pod log displays the following error message:
