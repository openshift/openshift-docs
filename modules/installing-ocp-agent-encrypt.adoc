...
= Encrypt cluster node disks

[role="_abstract"]
Encrypt your cluster node disks or partitions using TPM or other encryption methods to protect sensitive data at rest during {product-title} installation.
