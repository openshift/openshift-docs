...
[role="_abstract"]
Before you install {product-title}, you must create a secondary IAM administrative user and assign permissions to create the cluster. You must set specific options when you complete AWS documentation for a secondary IAM administrative user.
