...
----
<1> The name for your cluster infrastructure that your Ignition
config files encode for the cluster.
...
section and save it as a YAML file on your computer. This template
