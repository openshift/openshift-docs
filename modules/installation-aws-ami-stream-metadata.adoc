...
[role="_abstract"]
To find the correct {op-system} boot image for your cluster, you can use stream metadata, which provides standardized information about {op-system} in the JSON format.
