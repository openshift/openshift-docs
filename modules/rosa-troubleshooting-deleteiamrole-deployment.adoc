...
= Failing to create a cluster with a `DeletingIAMRole` error
...
For more information about the list-attached-role-policies command, see https://docs.aws.amazon.com/cli/latest/reference/iam/list-attached-role-policies.html[list-attached-role-policies] in the official AWS documentation.
