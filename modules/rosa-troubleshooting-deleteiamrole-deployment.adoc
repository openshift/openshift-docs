...
= Failing to create a cluster with an `DeletingIAMRole` error
...
* List all managed policies that are attached to the specified role:
...
For more information about list-attached-role-policies command, https://docs.aws.amazon.com/cli/latest/reference/iam/list-attached-role-policies.html[list-attached-role-policies] in the official AWS documentation.
