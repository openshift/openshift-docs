...
[id="forwarding-logs-to-amazon-s3-endpoint-from-sts-enabled-clusters_{context}"]
= Forwarding logs to Amazon S3 endpoint from STS-enabled clusters

You can forward logs from {logging-title} deployed on {aws-first} {sts-first}-enabled clusters to an S3 configured endpoint. 
