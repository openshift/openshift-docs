...
An {aws-full} account must be prepared and configured to accept an {oadp-first} installation. Prepare the AWS credentials by running the following commands:
