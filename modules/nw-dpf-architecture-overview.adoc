...
[role="_abstract"]
The NVIDIA DOCA Platform Framework (DPF) v{dpf-version} deployment on {product-title} {product-version} offloads OVN-Kubernetes data plane operations to NVIDIA BlueField-3 DPUs.
