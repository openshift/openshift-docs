...
:navtitle: Prepare {aws-short} to use {oadp-short} for disaster recovery
...
* To prepare {aws-short} to use {oadp-short}, follow the steps in "Configuring the {oadp-full} with AWS S3 compatible storage".
+
