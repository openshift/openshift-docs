...
= Creating additional worker machines in {gcp-full}

You can create worker machines in {gcp-full} for your cluster
...
* Ensure you defined the variables in the _Exporting common variables_, _Creating load balancers in {gcp-full}_, and _Creating the bootstrap machine in {gcp-full}_ sections.
...
[.small]
--
1. To use a {gcp-full} Marketplace image, specify the offer to use:
