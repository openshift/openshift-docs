...
[role="_abstract"]
To customize how the `cluster-compare` plugin evaluates your environment, use the available command-line options. By configuring these parameters, you can tailor the comparison process to your specific validation requirements.
