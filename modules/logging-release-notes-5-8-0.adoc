...
https://issues.redhat.com/browse/RHELPLAN-145493
...
// https://issues.redhat.com/browse/RHELPLAN-145491

////
https://issues.redhat.com/browse/OCPBUGS-11813
////
...
[IMPORTANT]
====
In order to support multi-cluster log forwarding in additional namespaces other than the `openshift-logging` namespace, you must update the Cluster Logging Operator to watch all namespaces. This functionality is supported by default in new Cluster Logging Operator version 5.8 installations. https://issues.redhat.com/browse/RHEL-15789
====
