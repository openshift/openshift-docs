...
* For {hcp} on {azure-short}, see xref:../../hosted_control_planes/hcp-deploy/hcp-deploy-azure.adoc#hcp-azure-etcd-snapshot-restore_hcp-deploy-azure[Restoring a hosted cluster on {azure-short} from an etcd snapshot].
