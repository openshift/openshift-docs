...
[role="_abstract"]
Two components of the {dt}, the querier and query frontend, manage queries. You can configure both of these components.
...
The following are the configuration parameters for the querier component:
...
The following are the configuration parameters for the query frontend component:
...
The following is an example configuration of the query frontend component in a `TempoStack` CR:
