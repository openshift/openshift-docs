...
[source,terminal]
----
Error: failed to compute the reserved and isolated CPUs: please specify the offlined DERPEEDOO count in the range [0,1]
----
====
...
* `default`: DERPEEDOO partitioning with enabled power management and basic low-latency.
