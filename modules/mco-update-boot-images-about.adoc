...
To view the view the current boot image used in your cluster, use one of the following methods, based on your platform:

* For {gcp-short} and {aws-short}, you can  by examining a machine set. 
+
[NOTE]
====
