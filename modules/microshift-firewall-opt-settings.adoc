...
[role="_abstract"]
To enable external access to specific applications and services, configure optional port settings in {product-title}. You can customize your firewall configuration to open required ports for the API server, NodePort services, and standard web traffic.
