...
+
Multiple CRs and policies can share the same wave number. Having fewer policies can result in faster deployments and lower DERPEEDOO usage. It is a best practice to group many CRs into relatively few waves.
