...
[role="_abstract"]
While {product-title} runs on the minimum {ibm-z-name} hardware requirements, using the preferred system environment improves performance and supports production workloads.
