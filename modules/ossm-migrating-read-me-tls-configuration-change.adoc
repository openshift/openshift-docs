...
To enable mTLS strict mode in {SMProduct} 3, you must apply the corresponding `PeerAuthentication` and `DestinationRule` resources.
...
In {SMProduct} 2.6 and {SMProduct} 3, `auto mTLS` remains enabled by default.