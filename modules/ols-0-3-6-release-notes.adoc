...
[role="_abstract"]
{ols-official} 0.3.6 is now generally available for {ocp-product-title} 4.15 and later.
...
[role="_abstract"]
{ols-official} 0.3.6 includes bug fixes to improve product stability and performance.
