...
Worker node longevity is not guaranteed and may be replaced at any time as part of the normal operation and management of OpenShift.
...
* AWS EC2 instance longevity may occur at any time when AWS detects irreparable failure of the underlying hardware that hosts the instance.
