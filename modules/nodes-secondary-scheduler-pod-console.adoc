...
// * osd_cluster_admin/osd_nodes/osd_secondary_scheduler/nodes-secondary-scheduler-configuring.adoc
// * rosa_cluster_admin/rosa_nodes/rosa_secondary_scheduler/nodes-secondary-scheduler-configuring.adoc
