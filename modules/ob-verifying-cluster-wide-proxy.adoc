...
[role="_abstract"]
As a cluster administrator, you can verify the cluster-wide proxy settings to ensure that
the {builds-title} use the {ocp-product-title}'s cluster-wide proxy configuration.
