...
//Updates to this page will be required but done in a separate PR- see ROX-29608
...
Beginning with version 4.4, {product-title-short} includes two image vulnerability scanners: StackRox Scanner and Scanner V4. The StackRox Scanner is deprecated. Scanner V4 is the default image scanner as of release 4.8.
