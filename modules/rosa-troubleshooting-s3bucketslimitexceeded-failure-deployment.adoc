...
= Failing to create a cluster with an `S3BucketsLimitExceeded` error
...
* Clean unused S3 buckets. You can only delete buckets that don't have any objects in them. Make sure the bucket is empty.
.. Sign in to the **https://aws.amazon.com/console/[AWS Management]** console.
