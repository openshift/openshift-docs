...
#...
----
<1> This example applies shutdown grace periods to nodes with the `worker` role. For a kubelet config, the role must match the name of the associated machine config pool.
