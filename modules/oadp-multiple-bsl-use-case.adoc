...
[role="_abstract"]
Configure two backup storage locations with different cloud credentials to back up applications to multiple storage targets. This demonstrates how to distribute backups across different storage providers for redundancy.
