...
[role="_abstract"]
Enable private cluster settings when creating a new cluster to restrict API endpoint access to private connections only. This enhances security by preventing public internet access to your cluster's control plane.
