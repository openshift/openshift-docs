...
[role="_abstract"]
Access restored virtual machine files through SSH by using `rsync`, `scp`, or `sftp` with the `VirtualMachineFileRestore` (VMFR) CR. This helps you to transfer files from VM backups efficiently.
