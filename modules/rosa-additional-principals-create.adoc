...
= Adding additional principals while creating your ROSA cluster
...
. When the cluster creation command executes, you receive a summary of your cluster with the `--additional-allowed-principals` specified:
+
.Example output
+
[source,terminal]
