...
[role="_abstract"]
The `deletionOrder` field controls the order in which applications are deleted when ApplicationSet is deleted. {gitops-title} supports AllAtOnce and Reverse deletion strategies.
