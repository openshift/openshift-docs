...
* {rh-storage} will be updated to 4.22 when the aligned {rh-storage} version is released.
* The Cluster Logging Operator will be updated to 6.6 when the aligned version is released.
