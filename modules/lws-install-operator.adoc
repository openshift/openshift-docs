...
////
Questions/TODO:
- Will the update channel stay stable-v1.0, or will it be just 'stable'?
- Check if there is anything important to call out that we don't support and/or set default values for (https://github.com/kubernetes-sigs/lws/blob/main/api/config/v1alpha1/configuration_types.go)
////
...
+
// TODO: Check whether admin is truly needed.
