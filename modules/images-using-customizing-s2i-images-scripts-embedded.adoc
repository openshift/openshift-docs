...
[role="_abstract"]
You can create wrapper scripts to invoke standard S2I scripts embedded in builder images.
You can do this to add custom logic before or after the standard scripts while retaining their functionality.
