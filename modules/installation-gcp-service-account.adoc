...
{product-title} requires a {gcp-full} service account that provides authentication and authorization to access data in the Google APIs. If you do not have an existing IAM service account that contains the required roles in your project, you must create one.
...
. You can create the service account key in JSON format, or attach the service account to a {gcp-full} virtual machine.
