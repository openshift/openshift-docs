...
[role="_abstract"]
To upgrade {microshift-short} from {op-system-base} {op-system-version} to {op-system-version-10}, you must update both {microshift-short} and the operating system at the same time to a supported configuration. Use the procedure that matches your installation type.
