...
= Track and verify installation progress

[role="_abstract"]
Monitor the installation workflow to confirm cluster bootstrap completion and verify that all cluster components are running successfully.
