...
= Verify the supported architecture for Agent-based installation

[role="_abstract"]
Verify the processor architecture supported by your Agent-based Installer release payload to ensure compatibility with your cluster nodes.
