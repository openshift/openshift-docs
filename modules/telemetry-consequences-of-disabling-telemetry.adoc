...
Consider leaving health and usage reporting enabled for pre-production, test, and production clusters. This means that Red{nbsp}Hat can participant in qualifying {product-title} in your environments and react more rapidly to product issues.
...
In restricted networks, Telemetry and Insights data still egts gathhered through the appropriate configuration of your proxy.
