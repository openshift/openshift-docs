...
* Access Quay.io to obtain the packages that are required to install your cluster. For more information, visit the Quay.io website.
...
[id="additional-resources_cluster-entitlements_{context}"]
.Additional resources

* link:http://quay.io[Quay.io]