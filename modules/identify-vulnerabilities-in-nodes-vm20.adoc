...
** *is less than*
* *NVD CVSS*: The National Vulnerability Database (NVD) provides the severity level for the CVE. 
+
The following values are associated with the NVD severity level for the CVE: 
+
** ??
** ??
