...
[role="_abstract"]
A default {product-title} cluster consumes specific {gcp-first} resource quotas that you might need to increase before installation, depending on your region and cluster size.
...
You can increase resource quotas from the {gcp-short} console, but you might need to file a support ticket. Be sure to plan your cluster size early so that you can allow time to resolve the support ticket before you install your {product-title} cluster.

[role="_additional-resources"]
.Additional resources

* link:https://cloud.google.com/docs/quota[Manage your quotas using the console ({gcp-short} documentation)]
* link:https://console.cloud.google.com/iam-admin/quotas[{gcp-short} console]
