...
For more information about the PPC arguments, see "Performance Profile Creator arguments".
...
. On the hosted cluster create a performance profile by running the following command. The example uses sample PPC arguments and values:
+
