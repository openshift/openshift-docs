...
. Configure the custom namespace by updating the value of the `spec.workloadSources.commonBootImageNamespace` field.
+
...
where:
+
`spec.workloadSources.commonBootImageNamespace`:: Specifies the namespace to use for golden images.
