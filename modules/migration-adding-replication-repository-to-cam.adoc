...
* Google Cloud Provider ({gcp-full})
...
** *Replication repository name*: Specify the replication repository name in the {mtc-short} web console.
** *{gcp-full} bucket name*: Specify the name of the {gcp-full} bucket.
** *{gcp-full} credential JSON blob*: Specify the string in the `credentials-velero` file.
