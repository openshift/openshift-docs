...
[NOTE]
====
Argo CD Agent does not replace any existing Argo CD functionality. Instead, it introduces a different deployment model for applications in large-scale, multi-cluster environments.
====
