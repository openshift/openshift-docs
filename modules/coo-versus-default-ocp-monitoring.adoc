...
The key differences between {coo-short} and the default in-cluster monitoring stack are shown in the table:
...
| Built-in configurations with limited customization options. You can set alerting and notification methods but you cannot adjust storage or retention policies.
