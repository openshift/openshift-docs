...
= Configure OpenShift Monitoring with Service Mesh ambient mode

[role="_abstract"]

Integrate {SMProductName} ambient mode with user-workload monitoring, a feature of the Monitoring stack for Red{nbsp}Hat OpenShift. Kiali requires this feature to run the dedicated console for {istio}.
