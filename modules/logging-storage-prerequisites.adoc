...
* link:https://docs.redhat.com/en/documentation/red_hat_openshift_logging/{logging-major-version}/html/configuring_logging/configuring-lokistack-storage#loki-sizing_configuring-the-log-store[Loki deployment sizing]
