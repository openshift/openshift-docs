...
* Access to an *S3-compatible object store* for log data. Supported providers include {aws-short} S3, {azure-short}, {gcp-short}, S3 Compatible storage (MinIO, NetApp StorageGRID, and others), {rh-storage}, and Swift.
