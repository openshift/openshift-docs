...
For scenarios where the `cluster-compare` plugin's default matching does not work as expected, or to enable complex edge cases, you can manually match a custom resource (CR) to a template. 
