...
:navtitle: Secure egress traffic
...
Likewise, a cluster administrator can prevent egress traffic from going outside of an {product-title} cluster by using an egress firewall.
