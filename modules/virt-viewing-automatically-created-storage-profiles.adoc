...
`status.dataImportCronSourceFormat`:: `Data Import Cron Source Format` indicates whether boot source images on this storage are stored as PVCs or volume snapshots.
