...
[role="_abstract"]
By default, the `HostUpdatePolicy` disables live updates to firmware settings and firmware updates. To enable live updates with `onReboot` behavior, create the `HostUpdatePolicy` resource.
