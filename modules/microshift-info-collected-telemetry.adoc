...
* The {op-system-base-full} deployment type.
//OCP collects information about unsupported configurations. Do we? Doesn't look like we collect the rhel version anywhere? Should we?

//the following are all OCP based; it doesn't look like we collect these? LMK if I am wrong?
...
//is the OS type here a repeat of what is in the system info?
...
Red{nbsp}Hat may engage certain third parties to assist in the collection, analysis, and storage of the Telemetry data.
