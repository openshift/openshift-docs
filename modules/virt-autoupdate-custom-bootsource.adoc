...
= Managing automatic updates for custom boot sources
...
. Optional: To disable automatic updates, remove the custom boot source from the `spec.dataImportCronTemplates` stanza.