...
<2> The CPU request is now `250m` because the `cpuRequestToLimit` is set to `25` in the `ClusterResourceOverride`. As such, 25% of the 1 CPU core is 250m.
