...
ifndef::ash[]
//CLI shows: modules/installation-user-infra-exporting-common-variables.adoc:58:1:AsciiDocDITA.TaskStep:Content other than a single list cannot be mapped to DITA tasks.
//nothing in VSC
