...
<3> Optional: The resource group name of the cluster. This lets you narrow down the scope of the credential within the account.
+
--
[NOTE]
====
...
[source,terminal]
----
$ cat <installation_directory>/manifests/cluster-infrastructure-02-config.yml | grep resourceGroupName: | cut -d':' -f2
----
====
--
