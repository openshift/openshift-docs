...
[role="_abstract"]
To ensure internal traffic from your pods can pass through the network gateway, allow specific network traffic through the firewall in {product-title}. You can configure trusted IP address ranges to securely route essential pod communication and load balancer traffic.
