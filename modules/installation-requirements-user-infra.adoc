...
If you use IBM Z hardware, you can install {product-title} version {product-version} if you use z13 or later. If you use IBM LinuxONE hardware, you can install it on LinuxONE z13 or later.
