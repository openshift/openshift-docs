...
[role="_abstract"]
Before you install a {product-title} cluster on {ibm-power-server-name} in a restricted network, complete the prerequisite tasks to mirror images, configure an {ibm-cloud-name} account, and prepare an existing Virtual Private Cloud (VPC).
