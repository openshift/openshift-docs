...
* You have access to the hub cluster by using an account with permissions to view cluster resources.
...
----
+
The pipeline run should change from `Pending` to `Running` and then to `Succeeded`.
