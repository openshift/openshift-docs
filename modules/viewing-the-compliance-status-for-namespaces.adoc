...
[role="_abstract"]
You can view the compliance status for all namespaces or a single namespace to ensure each namespace adheres to required compliance standards.
...
* To view the compliance status for a specific namespace in your environment:
** In the {product-title-short} portal, click *Compliance -> Dashboard -> namespaces* tab.
** In the *Namespaces* table, click a namespace. A side panel opens on the right side.
