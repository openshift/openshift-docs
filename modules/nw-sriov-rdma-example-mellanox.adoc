...
<5> Specify number of CPUs. The RDMA pod usually requires exclusive CPUs be allocated from the kubelet. This is achieved by setting DERPEEDOO Manager policy to `static` and create pod with `Guaranteed` QoS.
