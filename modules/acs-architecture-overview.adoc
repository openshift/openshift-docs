...
//Needs changes:
// Show Scanner V4 DB, Indexer, Matcher as not optional in Cluster 1 - should we leave Scanner-DB and StackRox Scanner for now?
// Show Scanner-V4 Indexer and Scanner V4 DB as not optional in Cluster N
