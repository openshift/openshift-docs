...
[role="_abstract"]
You can identify and resolve configuration drift across your cluster when the actual state of a node differs from its intended machine configuration. This approach maintains consistent operating system configurations across your cluster nodes.
