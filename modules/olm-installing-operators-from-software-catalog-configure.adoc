...
Please note that the Red Hat Operators catalog is not available in {product-title}. According to the subscription agreement, these operators can be used only on {product-title} clusters.
