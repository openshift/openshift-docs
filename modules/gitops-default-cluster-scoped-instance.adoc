...
[role="_abstract"]
After you install the {gitops-shortname} Operator, by default, it instantiates a cluster-scoped instance in the `openshift-gitops` namespace. This instance is configured in a very opinionated way and is intended to allow cluster administrators to manage certain cluster configuration resources.
