...
[role="_abstract"]
Configure an LDAP identity provider for your {product-title} cluster. Users can log in with credentials validated against your LDAPv3 directory using simple bind authentication.
...
|===
+
When doing searches, the attribute, filter, and provided username are combined
