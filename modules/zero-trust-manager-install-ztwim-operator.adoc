...
----
+
The following is an example of the expected output after the installation process is complete:
+
[source,terminal]
----
...
* To verify that the Operator pod is running, run the following command:
+
[source,terminal]
----
