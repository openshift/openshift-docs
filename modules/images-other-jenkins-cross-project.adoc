...
. Identify the secret for the service account that has appropriate permissions to access the project Jenkins must access by entering the following command:
+
[source,terminal]
----
