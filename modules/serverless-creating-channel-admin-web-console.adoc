...
[role="_abstract"]
After installing the Knative Eventing on your cluster, you can create a channel by using the Administrator perspective.
...
. In the *Create* list, select *Channel*. The web console opens the *Channel* page.
