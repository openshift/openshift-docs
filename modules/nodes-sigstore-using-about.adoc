...
* Cluster image policy. A cluster image policy object enables a cluster administrator to configure sigstore support for the entire cluster.

* Image policy. An image policy enables a cluster administrator or application developer to configure sigstore support for a specific namespace.  
