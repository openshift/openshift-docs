...
scanner=registry.redhat.io/advanced-cluster-security/rhacs-scanner-rhel9:{rhacs-version}
----
...
db=registry.redhat.io/advanced-cluster-security/rhacs-scanner-db-rhel9:{rhacs-version} \
init-db=registry.redhat.io/advanced-cluster-security/rhacs-scanner-db-rhel9:{rhacs-version}
----
