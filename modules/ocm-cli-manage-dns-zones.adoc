...
[role="_abstract"]
Managing your domain infrastructure is a key part of maintaining a healthy cluster environment. With the {cluster-manager} CLI (`ocm`), you can easily view and manage your existing managed Domain Name System (DNS) zones associated with your account. This allows you to keep track of your DNS configurations, make necessary updates, and ensure that your cluster's network settings are always up to date and secure.
