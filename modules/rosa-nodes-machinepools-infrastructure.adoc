...
[id="rosa-nodes-machinepools-infrastructure-machines_{context}"]
== Machines
A machine is a fundamental unit that describes the host for a worker node.

[id="rosa-nodes-machinepools-infrastructure-machine-sets_{context}"]
== Machine sets
...
[id="rosa-nodes-machinepools-infrastructure-machine-pools_{context}"]
== Machine pools
