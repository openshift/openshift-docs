...
[NOTE]
====
For private clusters, you do not need to set `platform.azure.baseDomainResourceGroupName`. The installation program does not create public DNS records in your base domain.
====
endif::[]
