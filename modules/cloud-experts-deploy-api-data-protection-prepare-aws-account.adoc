...
[role="_abstract"]
Create the AWS Identity and Access Management (IAM) policy, trust policy, and role to grant {oadp-full} access to Amazon S3 and Amazon EC2 resources required for backup and restore operations.

.Procedure
. Create an IAM policy to enable S3 access:
+
[source,terminal]
----
