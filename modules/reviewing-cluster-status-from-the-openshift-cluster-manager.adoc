...
[NOTE]
====
Alternatively, you can navigate to the link:https://cloud.redhat.com/openshift/[{cloud-redhat-com}] directly and select your cluster ID from the list of available clusters.
====
