    ...
    - name: default
      velero:
        ...
        config:
          ...
          profile: "default"
----
<1> The `openshift` plug-in is mandatory in order to back up and restore namespaces on an {product-title} cluster.
...
<3> The `openshift` plug-in is mandatory in order to back up and restore namespaces on an {product-title} cluster.
