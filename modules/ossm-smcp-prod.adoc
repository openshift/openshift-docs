...
For production deployments you _must_ customize the default template. Follow this procedure to find and save your staging `ServiceMeshControlPlane` resource by using the CLI.
