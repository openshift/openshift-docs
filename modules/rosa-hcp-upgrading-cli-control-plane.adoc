...
. Get the channel version that your cluster is currently on:
+
[source,terminal]
----
$ rosa describe cluster --channel name
----

. Specify the channel that you want to switch to.
+
[source,terminal]
----
$ rosa switch channel stable-4.14
----
