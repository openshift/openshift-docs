...
:navtitle: Balanc ignored labels in a hosted cluster
...
. After you scale up the node pools, check that all compute nodes are in the `Ready` status by running the following command:
+
[source,terminal]
----
