...
To resolve this issue, use entitlement certificates to create the {op-system-base} Content Delivery Network (CDN) repository files in the `/etc/yum.repos.d/` directory, and reinstall {microshift-short}. For more information, see _Creating repository files for RHEL 9 systems_.