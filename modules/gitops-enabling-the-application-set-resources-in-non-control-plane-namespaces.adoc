...
where:
+
`ApplicationSet`:: Specifies the list of non-control plane namespaces for creating and managing `ApplicationSet` resources.
`ApplicationSet`:: Specifies the name of the target namespace for the Argo CD server to create and manage `ApplicationSet` resources.
+
[NOTE]
====
