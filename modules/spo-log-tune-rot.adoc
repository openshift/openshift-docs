...
[role="_abstract"]
Configure audit log file size, retention and rotation for the JSON log enricher so Advanced Audit Logging files stay within the space and retention limits you need. These options are similar to link:https://kubernetes.io/docs/tasks/debug/debug-cluster/audit/[Kubernetes API server log settings].
