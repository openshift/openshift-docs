...
[id="installation-creating-aws-bootstrap-{context}"]
...
is to create an S3 bucket in your cluster's region and upload the Ingition
config file to it.
+
[IMPORTANT]
====
...
<3> Current {op-system-first} AMI to use for the boostrap node.
