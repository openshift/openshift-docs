...
[role="_abstract"]
The {product-title-managed-short} Disaster Recovery strategy includes encrypted backups of database and customizations, with annual testing of disaster recovery plans.
