...
= Supported parameters for {tekton-chains}
...
+
If you enable the `docdb` storage method for any artifacts, configure docstore storage options. For more information about the go-cloud docstore URI format, see the docstore package documentation. {pipelines-title} supports the following docstore services:
+
--
** `firestore`
** `dynamodb`
...
* link:https://docs.sigstore.dev/cosign/key_management/overview/#providers[Providers (Sigstore documentation)]
* link:https://github.com/sigstore/cosign#specifying-registry[Cosign documentation for specifying registry]
* link:https://gocloud.dev/howto/docstore/[Docstore package documentation]
* link:https://github.com/grafeas/grafeas/blob/master/docs/grafeas_concepts.md[Grafeas concepts]
