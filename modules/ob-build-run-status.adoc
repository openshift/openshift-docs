...
= BuildRun status fields

[role="_abstract"]
Monitor the progress and completion of your image builds by checking the status of the `BuildRun` custom resource (CR). A `BuildRun` CR stores status information in the `status.conditions` field.
