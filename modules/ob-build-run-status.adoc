...
[role="_abstract"]
Track build progress and completion by monitoring status updates on the `BuildRun` custom resource (CR).

The `BuildRun` CR updates whenever the image building status changes, as shown in the following examples:
