...
[id="ossm-cluster-wide-migration-migration-methods_{context}"]
== Cluster-wide migration methods

Migrating from {SMProductName} {SMv2Version} to {SMProduct} 3.0 can be performed by using one of the following methods:
...
[NOTE]
====
This method might introduce traffic disruptions.
====
