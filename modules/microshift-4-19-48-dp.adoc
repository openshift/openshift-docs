...
[id="microshift-4-19-48-dp_{context}"]
= RHBA-2026:69076 - {microshift-short} 4.19.48 fixed issues

Issued: 23 September 2026

[role="_abstract"]
{product-title} release 4.19.48 is now available. Fixed issues are listed in the link:https://access.redhat.com/errata/RHBA-2026:69076[RHBA-2026:69076] advisory. Release notes for fixed issues are provided in this documentation. The images that are included in the update are provided by the {OCP} link:https://access.redhat.com/errata/RHSA-2026:68540[RHSA-2026:68540] advisory.
...
[id="microshift-4-19-48-dp-bug-fixes_{context}"]
== Fixed issues
