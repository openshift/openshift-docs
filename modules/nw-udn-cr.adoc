...
{product-title} administrators and users can create a custom resource that is either cluster-scoped (`ClusterUserDefinedResource`) or namespace-scoped (`UserDefinedResource`) 


custom resource can be used to create a user-defined network that is either 
