...
[role="_abstract"]
Create a `UserDefinedNetwork` CR using the CLI to enable namespace-scoped network segmentation and isolation, allowing you to define custom Layer 2 or Layer 3 network topologies for pods within specific namespaces.
