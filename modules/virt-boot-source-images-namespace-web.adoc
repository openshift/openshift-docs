...
[id="virt-boot-source-images-namespace-web_{context}"]
= Configuring a custom namespace for boot source images by using the web console

[role="_abstract"]
You can configure a custom namespace for boot source images in your cluster by using the {product-title} web console.
