...
[id="installation-creating-aws-dns-{context}"]
...
. Obtain the Hosted Zone ID for the the Route53 zone that you specified in the
...
<3> The name for your cluster infrastructure that is encoded in your Ingition
