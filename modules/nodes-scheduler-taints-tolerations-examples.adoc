...
[id='nodes-scheduler-taints-tolerations-examples-user-{context}']
== Dedicating a Node for a User
...
[id='nodes-scheduler-taints-tolerations-examples-binding-{context}']
== Binding a User to a Node
...
[id='nodes-scheduler-taints-tolerations-examples-special-{context}']
