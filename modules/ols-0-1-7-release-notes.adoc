...
[role="_abstract"]
{ols-official} 0.1.7 is now generally available for {ocp-product-title} 4.15 and later.

[id="ols-0-1-7-enhancements_{context}"]
== Enhancements

[role="_abstract"]
{ols-official} 0.1.7 introduces fields in the `OLSConfig` custom resource to configure additional Certificate Authorities for secure large language model (LLM) provider authentication.
