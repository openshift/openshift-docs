...
The Argo CD Operator manages local users by:
...
For more information on local users, see the link:https://argo-cd.readthedocs.io/en/stable/operator-manual/user-management/[Argo CD user management documentation].