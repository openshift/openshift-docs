...
[role="_abstract"]
You can configure the Image Registry Operator to use private endpoints on Azure, enabling private storage accounts when {product-title} is deployed on private Azure clusters.
