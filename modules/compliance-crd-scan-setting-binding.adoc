...
:navtitle: ScanSettingBind object
...
`profiles`:: Specifies the details of `Profile` or `TailoredProfile` object to scan your environment.
`settingsRef`:: Specifies the operational constraints, such as schedule and storage size.
