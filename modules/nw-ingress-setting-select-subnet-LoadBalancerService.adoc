...
.Procedure
To create an Ingress Controller with manually specified load balancer subnets, you can follow these steps:
        ...
        aws:
          ...
          classicLoadBalancer:
            subnets:
              ...
              - <updated_subnet>
----
<1> Specify updated subnet IDs (or names if you using `names`).
