...
<path_to_ccoctl_output_dir>/serviceaccount-signer.public:: Specifies the path to the public key file that the `ccoctl aws create-key-pair` command generated.
+
.Example output
[source,text]
----
