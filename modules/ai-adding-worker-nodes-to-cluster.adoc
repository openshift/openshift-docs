...
.. Download the pull secret file from Red Hat OpenShift Cluster Manager at link:https://console.redhat.com/openshift/install/pull-secret[console.redhat.com].
...
----
<1> Replace `<path_to_pull_secret_file>` with the path to the local file containing the downloaded pull secret from Red Hat OpenShift Cluster Manager at link:https://console.redhat.com/openshift/install/pull-secret[console.redhat.com].
