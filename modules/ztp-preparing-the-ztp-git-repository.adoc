...
----
$ podman pull registry.redhat.io/openshift5/ztp-site-generate-rhel9:v{product-version}
----
+
[source,terminal]
----
...
[source,terminal,subs="attributes+"]
----
$ podman run --log-driver=none --rm registry.redhat.io/openshift5/ztp-site-generate-rhel9:v{product-version} extract /home/ztp --tar | tar x -C ./out
----
...
+
--
`extra-manifests/`:: Contains reference manifests from the `ztp-container`.
`custom-manifests/`:: Contains custom manifests.
--
