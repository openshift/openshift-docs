...
* You have access to the {hybrid-console} at link:https://console.redhat.com/openshift/create[console.redhat.com].
* You have the OpenShift CLI (`oc`) installed.

.Procedure

. Navigate to link:https://console.redhat.com/openshift/create[console.redhat.com/openshift/create] and create a cluster with control-plane nodes only.
