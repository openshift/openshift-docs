...
. In the *vCenter* field, enter the network address of the vSphere vCenter server. This can be either a domain name or an IP address. It is displayed in the vSphere web client URL; for example `https://[your_vCenter_address]/ui`.
