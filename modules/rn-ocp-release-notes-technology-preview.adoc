...
[id="ocp-release-notes-ai-apps-tech-preview_{context}"]
...
|MCP server for Red Hat {product-title}
|Not Available
|Not Available
|Technology Preview
...
|{olmv1} `deploymentConfig` API for cluster extension customization
|Not Available
|Not Available
|Technology Preview
|====
...
|OpenShift zones support for {vmw-short} host groups
|Technology Preview
|Technology Preview
|General Availability
...
|SR-IOV Network Operator support for s390x
|
|
|
|General Availability
