...
[role="_abstract"]
While Red Hat and Amazon Web Services (AWS) manage the {product-title} service, the customer shares responsibility with respect to certain aspects. The {product-title} services are accessed remotely, hosted on public cloud resources, and have underlying platform and data security that is owned by Red Hat.
