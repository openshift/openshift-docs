...
= Configuring a custom DNS domain for a hosted cluster's Kubernetes API server

If the DNS domain for your hosted cluster's Kubernetes API server is long or difficult to remember, you can configure a custom DNS domain.
