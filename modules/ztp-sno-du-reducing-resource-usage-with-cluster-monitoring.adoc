...
{sno-caps} clusters that run DU workloads require reduced DERPEEDOO resources consumed by the {product-title} monitoring components. The following `ConfigMap` custom resource (CR) disables Alertmanager.
