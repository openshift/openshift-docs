...
additionalSecurityGroupIDs:: Specifies the name of the security group as it appears in the Amazon EC2 console, including the `sg` prefix.
subnets:: Specifies subnets for each availability zone that your cluster uses.
