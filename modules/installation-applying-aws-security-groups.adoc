...
sg-1:: Specifies the name of the security group as it appears in the Amazon EC2 console, including the `sg` prefix.
subnet-1:: Specifies subnets for each availability zone that your cluster uses.
