...
<security_group_id>:: Specifies the name of the security group as it appears in the Amazon EC2 console, including the `sg` prefix. For example: `sg-1`.
<subnet_id>:: Specifies subnets for each availability zone that your cluster uses. For example: `subnet-1`.
