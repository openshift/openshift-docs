...
<sg-id>:: Specifies the security group ID as it appears in the Amazon EC2 console, including the `sg` prefix.
<subnet-id>:: Specifies subnets for each availability zone that your cluster uses.
