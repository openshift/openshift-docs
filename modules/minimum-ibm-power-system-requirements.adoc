...
* {ibm-power-name}9, {ibm-power-name}10 or {ibm-power-name}11 processor-based systems for {op-system-base}9 based {op-system} nodes
* {ibm-power-name}10 or {ibm-power-name}11 processor-based systems for {op-system-base}10 based {op-system} nodes
