...
:navtitle: Install the File Integrity Operator using the web console
...
[role="_abstract"]
Install the File Integrity Operator from the {product-title} web console by using the Software Catalog.
