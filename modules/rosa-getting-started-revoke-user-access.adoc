...
* link:https://access.redhat.com/documentation/en-us/red_hat_openshift_service_on_aws/4/html/installing_accessing_and_deleting_rosa_clusters/rosa-sts-deleting-access-cluster[Revoking access to a cluster]
