...
[role="_abstract"]
The AWS Load Balancer Operator is used to install, manage, and configure an instance of `aws-load-balancer-controller` in a {product-title} cluster. To deploy Application Load Balancers (ALBs) in {product-title}, you must first deploy the AWS Load Balancer Operator.
