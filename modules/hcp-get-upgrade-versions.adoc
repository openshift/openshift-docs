...
= Updates of the {product-title} version in a hosted cluster
...
To keep your hosted cluster fully operational during an update process, the control plane and the node versions must be compatible. For more information, see "Hosted cluster and node pool version skew policy" in the _Additional resources_ section.
...
See the support matrixes for the {mce-short} versions in the _Additional resources_ section.
