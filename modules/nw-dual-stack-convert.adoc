...
[IMPORTANT]
====
Before proceeding, make sure your OpenShift cluster uses version 4.12.5 or later. Otherwise, the conversion can fail due to the bug link:https://issues.redhat.com/browse/OCPBUGS-6040[ovnkube node pod crashed after converting to a dual-stack cluster network].
====
