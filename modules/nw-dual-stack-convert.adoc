...
[IMPORTANT]
====
After converting your cluster to use dual-stack networking, only newly created pods are assigned IPv6 addresses. For any pods created before the conversion, you must re-create the pods for them to receive IPv6 addresses.
====
