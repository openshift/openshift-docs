...
. On installer-provisioned infrastructure only, specify IPv6 VIPs for API and Ingress services for your cluster, create a YAML configuration patch file that has a similar configuration to the following example:
+
[source,yaml]
----
- op: add
