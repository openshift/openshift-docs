...
====
* We recommend that you use CSI storage that supports ReadWriteMany (RWX), cloning and snapshots to enable live migration, fast VM creation, and VM snapshots capabilities.
--