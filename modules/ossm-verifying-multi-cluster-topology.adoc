...
= Verify a multi-primary multi-network mesh with sidecar deployment
...
----
+
Verify that you see responses from both clusters, displaying both version 1 and version 2 of the service.
