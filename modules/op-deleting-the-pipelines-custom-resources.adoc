...
. Repeat these steps, searching for `TektonResult` and then `TektonConfig` in the *Filter by name* box. If any instances are found for these custom resource definitions (CRDs), delete these instances.
