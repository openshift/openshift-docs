...
= Change the update channel for an Operator

[role="_abstract"]
You can change the update channel for an Operator by using the {product-title} web console to receive newer versions or align with your organization update policy.
