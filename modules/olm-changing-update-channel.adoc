...
:navtitle: Change the update channel for an Operator
[id="olm-changing-update-channel_{context}"]
= Changing the update channel for an Operator

[role="_abstract"]
To change the update channel for an installed Operator, you can use the {product-title} web console. The update channel determines which Operator versions your subscription tracks and receives.
