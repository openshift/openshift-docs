...
[NOTE]
====
On Google Cloud Dedicated sovereign cloud infrastructure, private clusters are mandatory.
Unlike standard {gcp-short} where private clusters are an optional configuration, Google Cloud Dedicated enforces private-only clusters at the infrastructure level.
For more information, see xref:../../installing/installing_gcp/installing-gcp-dedicated.adoc#gcp-dedicated-private-cluster-requirement_installing-gcp-dedicated[Private cluster requirement on Google Cloud Dedicated].
====
