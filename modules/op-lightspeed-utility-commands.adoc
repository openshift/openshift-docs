...
Use the {pipelines-shortname} Client (opc) to access generative AI-powered diagnostics. These commands use {ols-official} to analyze pipeline failures and provide actionable troubleshooting guidance.
