...
:navtitle: Install from the software catalog by using the web console
...
[role="_abstract"]
To install and subscribe to an Operator from the software catalog, you can use the {product-title} web console. The console guides you through selecting an install mode, namespace, and approval strategy.
