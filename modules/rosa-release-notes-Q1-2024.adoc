...
Machine pool update::
+
You can now upgrade machine pools that are configured on {product-title} clusters. For more information, see link:https://docs.redhat.com/en/documentation/red_hat_openshift_service_on_aws/4/html-single/cli_tools/#rosa-upgrade-machinepool_rosa-managing-objects-cli[upgrade machinepool].
