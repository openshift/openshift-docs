...
A control plane (master) node might report an error such as:
...
----
+
Replace `<bare_metal_nic>` with the wired connection corresponding to the `baremetal` network by running the following command.
