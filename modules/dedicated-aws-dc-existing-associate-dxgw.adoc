...
After the Association Proposal has been sent, you must accept it. Follow the final steps you must perform are available in the link:https://docs.aws.amazon.com/directconnect/latest/UserGuide/multi-account-associate-vgw.html[Associate a Direct Connect virtual private gateway across accounts] (AWS documentation).
