...
. Use your preferred text editor to edit the `VirtualMachine` manifest file. Setting the interface state to `absent` detaches the network interface from the guest, but the interface still exists in the pod.
+
