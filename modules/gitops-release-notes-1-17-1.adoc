...
{gitops-title} 1.17.1 is now available on {OCP} 4.12, 4.14, 4.15, 4.16, 4.17, and 4.18.

[id="errata-updates-1-17-1_{context}"]
== Errata updates

[id="RHSA-XXXX:NNNN-gitops-1-17-1-security-update-advisory_{context}"]
=== RHSA-XXXX:NNNN - {gitops-title} 1.17.1 security update advisory
