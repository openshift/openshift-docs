...
[role="_abstract"]
To configure hybrid networking with OVN-Kubernetes, you can set `hybridOverlayConfig` during installation or patch the Cluster Network Operator (CNO) after installation. Hybrid networking supports running Linux and Windows nodes in the same cluster.
