...
[role="_abstract"]
The DOCA Telemetry Service (DTS) exposes DPU hardware telemetry as Prometheus metrics that you can view using the {product-title} web console or a Grafana dashboard.
