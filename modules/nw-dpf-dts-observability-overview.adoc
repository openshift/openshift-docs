...
Red Hat does not offer a certified Grafana Operator - the community Grafana Operator from OperatorHub is the standard way to run Grafana on {product-title}.
====
...
[NOTE]
====
In a standard DPF installation, these objects are applied automatically during the postinstallation step.
