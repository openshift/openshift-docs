...
For more information about disaster recovery practices, see the "Additional resources".
...
**Compute:** Provide Amazon EC2 features that support data resiliency such as Amazon EBS snapshots and Amazon EC2 Auto Scaling. For more information, see _Resilience in Amazon EC2_ in the "Additional resources".
...
**Storage:** For information about Amazon S3 features that support data resiliency, see _Resilience in Amazon S3_ in the "Additional resources".

**Networking:** For information about Amazon VPC features that support data resiliency, see _Resilience in Amazon Virtual Private Cloud_ in the "Additional resources".
