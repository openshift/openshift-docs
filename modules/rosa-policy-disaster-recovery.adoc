...
For more information about disaster recovery practices, see _Additional resources_.
...
- Take a full snapshot of the control plane etcd database every hour and retain the snapshot for 24 hours. This snapshot schedule supports the Recovery Point Objective (RPO) of 1 hour.

- Commit to a Recovery Time Objective (RTO) of up to 1 hour, covering complete cluster restoration and post-validation checks.
