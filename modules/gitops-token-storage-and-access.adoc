...
As an example, you can use the retrieved token with the Argo CD CLI to list applications by running the following command. The token can also be used with other Argo CD CLI commands in a similar way:
