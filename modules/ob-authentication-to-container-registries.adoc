...
To push images to a private container registry, you must define a secret in the required namespace and then reference it in your `Build` custom resource (CR).
