...
Resource quotas that only use requests automatically work with VMs. Resource limits can be set, but must be at least 100 MiB larger than resource requests.
