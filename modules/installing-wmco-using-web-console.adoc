...
. From the *Administrator* perspective in the {product-title} web console, navigate to the *Ecosystem* -> *Software Catalog* page.
...
[NOTE]
====
The WMCO is installed automatically into the namespace you defined, such as `openshift-windows-machine-config-operator`.
====
