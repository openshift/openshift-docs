...
* At most one VLAN ID can be configured on the `br-ex` uplink path.
...
* The resulting routing table must not have routes that overlap or conflict with the default route via the configured gateways.
