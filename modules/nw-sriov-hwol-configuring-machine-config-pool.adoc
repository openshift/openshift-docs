...
master-0   Ready    master                  2d    v1.36.3
master-1   Ready    master                  2d    v1.36.3
worker-0   Ready    worker                  2d    v1.36.3
worker-1   Ready    worker                  2d    v1.36.3
worker-2   Ready    mcp-offloading,worker   47h   v1.36.3
----
--
