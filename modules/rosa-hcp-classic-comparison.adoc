...
[role="_abstract"]
{hcp-title-first} and {rosa-classic-title} differ in how they host the control plane, deploy infrastructure, and handle upgrades.
...
| Worker nodes communicate with the control plane over AWS PrivateLink. For more details, see the _Additional resources_.
...
* link:https://docs.aws.amazon.com/vpc/latest/privatelink/what-is-privatelink.html[AWS PrivateLink]
