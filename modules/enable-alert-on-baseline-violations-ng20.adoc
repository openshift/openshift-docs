...
[role="_abstract"]
You can configure {product-title-short} to detect anomalous network flows and trigger violations for traffic that is not in the baseline. This can help you decide if the network has unwanted traffic before you block traffic with a network policy.
...
. In the network graph, click a deployment to view the information panel.
