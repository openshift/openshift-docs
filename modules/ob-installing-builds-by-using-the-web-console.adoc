...
Use the {ocp-product-title} web console to install the {builds-title} components. The web console provides a graphical interface to set up the infrastructure necessary for compiling source code and containerizing applications directly within your cluster.
