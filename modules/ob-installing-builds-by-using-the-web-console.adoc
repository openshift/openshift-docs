...
.. Check that the *Installation Mode* is set to *All namespaces on the cluster (default)*. This mode installs the Operator in the `openshift-builds` namespace to watch and be available to all namespaces in the cluster.
