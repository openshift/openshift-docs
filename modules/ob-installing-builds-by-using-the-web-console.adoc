...
Use the {ocp-product-title} web console to install the {builds-title} components. This provides a guided graphical interface to set up the infrastructure necessary for compiling source code and containerizing applications directly within your cluster.
