...
ip-10-0-143-125.us-east-2.compute.internal   Ready    master   46m   v1.17.1
----
+
[NOTE]
====
...
$ oc get nodes -l node-role.kubernetes.io/master
NAME                                         STATUS   ROLES    AGE   VERSION
ip-10-0-143-125.us-east-2.compute.internal   Ready    master   50m   v1.17.1
ip-10-0-156-255.us-east-2.compute.internal   Ready    master   92s   v1.17.1
ip-10-0-162-178.us-east-2.compute.internal   Ready    master   70s   v1.17.1
----
