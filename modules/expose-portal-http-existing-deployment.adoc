...
[role="_abstract"]
Enable the HTTP server on an existing {product-title-short} deployment for development environments or in troubleshooting scenarios where TLS is not required.
