...
You can check the status of a {microshift-short} node or see active pods. You can choose to run one, two, or all of the following commands to help you get the information you need to troubleshoot the node.
