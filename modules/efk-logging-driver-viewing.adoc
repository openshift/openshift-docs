...
Fluentd uses the *journald* logging driver as the system log source. These are log messages from the operating system, the container runtime, and {product-title}.
