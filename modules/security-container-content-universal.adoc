...
You can search the Red Hat Ecosystem Catalog to both find and check the health of different UBI images.
...
`ubi8/ubi`, and `ubi9/ubi`), as well as minimal images based on those systems (`ubi7/ubi-minimal`, `ubi8/ubi-minimal`, and `ubi9/ubi-minimal`). All of these images are preconfigured to point to free
...
See the Red Hat Enterprise Linux documentation on using Red Hat Universal Base Images for information on how to use and build on standard, minimal and init UBI images.
