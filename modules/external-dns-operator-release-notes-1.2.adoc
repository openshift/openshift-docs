...
[role="_abstract"]
The External DNS Operator 1.2 release notes summarize all new features and enhancements, notable technical changes, major corrections from the previous version, and any known bugs upon general availability. 
...
* The External DNS Operator now supports {aws-short} shared VPC. For more information, see "Creating DNS records in a different {aws-short} Account using a shared VPC".
