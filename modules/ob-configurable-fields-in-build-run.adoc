...
| `spec.nodeSelector` | Specifies which nodes {builds-shortname} should run on.

| `spec.tolerations` | Specifies the tolerations for the {builds-shortname} pod.

| `spec.schedulerName` | Specifies the scheduler for the {builds-shortname} pod
