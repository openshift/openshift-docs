...
----
+
The machine pool is scheduled to begin an upgrade at the specified time and date in Coordinated Universal Time (UTC). This initiates a rolling replacement of all nodes in the specified machine pool, beginning at the specified time.
