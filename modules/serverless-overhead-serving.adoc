...
These components introduce an additional hop in networking and perform additional tasks, for example, adding observability and request queuing. Following are the measured latency overheads:
