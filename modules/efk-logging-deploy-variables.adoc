...
= Specifying Ansible variables for deploying cluster logging

When deploying cluster logging into {product-title} you can specify parameters for the EFK deployment in the 
...
The following tables describe the Ansible variables you can use to configure your cluster logging.
