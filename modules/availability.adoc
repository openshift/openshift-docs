...
The {product-title-managed-short} includes Red{nbsp}Hat Standard and Premium support, which you can access using the link:https://access.redhat.com/support[Red Hat Customer Portal].
