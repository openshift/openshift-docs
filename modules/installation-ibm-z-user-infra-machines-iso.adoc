...
ifdef::ibm-power[]
. Download the Red Hat Enterprise Linux CoreOS installation files from the link:https://mirror.openshift.com/pub/openshift-v4/ppc64le/dependencies/rhcos/[{op-system} image mirror].
endif::ibm-power[]
+
[IMPORTANT]
====
