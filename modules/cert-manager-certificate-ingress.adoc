...
* If you enabled automatic certificate renewal for the Ingress Controller, you do not need to force reload the Ingress Controller for it to use a certificate from a renamed secret.
====
