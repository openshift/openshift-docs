...
[NOTE]
====
* For a pod that exists in the additional OVN-Kubernetes network, you can specify a static IP address for the pod only if the additional network attachment uses a layer 2 or a localnet topology framework for its network configuration.
