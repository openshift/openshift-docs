...
The HPA makes a scaling decision based on the observed DERPEEDOO or memory utilization values of pods in an {product-title} cluster. Utilization values are calculated as a percentage of the resource requests of each pod.
