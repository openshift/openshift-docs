...
`settings`:: This section is optional. In this section, you can set any {pac} settings for this controller if the settings must be different from the main {pac} controller.
