...
:navtitle: Replace mirror registry for Red Hat OpenShift SSL/TLS certificates
[id="mirror-registry-ssl-cert-replace_{context}"]
= Replacing mirror registry for Red Hat OpenShift SSL/TLS certificates

[role="_abstract"]
In some cases, you might want to update your SSL/TLS certificates for the _mirror registry for Red{nbsp}Hat OpenShift_.

Use the following procedure to replace SSL/TLS certificates for the _mirror registry for Red{nbsp}Hat OpenShift_ in the following scenarios:
