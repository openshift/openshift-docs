...
<apiVersion>:: Specifies parameters at the first level of indentation that apply to the cluster globally.
...
<platform>:: Specifies the infrastructure platform that hosts the cluster.