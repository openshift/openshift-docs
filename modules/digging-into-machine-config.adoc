...
----
+
Be sure to give the machine config file a later name (such as `10-worker-container-runtime`). Remember that the content of each file is in URL-style data. You can then apply the new machine config to the cluster.
