...
= OpenShift Service Mesh version 3.4 new features and enhancements
...
* _OpenShift Service Mesh component version tables_
...
{SMProduct} supports Gateway API 1.5.1::
The following features are now stable:
+
--
