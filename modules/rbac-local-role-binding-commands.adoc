...
[role="_abstract"]
You can manage local role bindings for users and groups using CLI operations. A project may be specified with the `-n` flag. If it is not specified, then the current project is used.
