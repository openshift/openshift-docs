...
----
+
NOTE:  The `DNSPolicy` will use the DNS Provider `Secret` that you defined earlier. The `geo` in this example is `GEO-NA`, but you can change this to suit your requirements. 
