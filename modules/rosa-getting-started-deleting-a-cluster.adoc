...
* link:https://access.redhat.com/documentation/en-us/red_hat_openshift_service_on_aws/4/html/introduction_to_rosa/rosa-understanding#rosa-understanding-aws-sts_rosa-understanding[Understanding AWS Security Token Service]
* link:https://access.redhat.com/documentation/en-us/red_hat_openshift_service_on_aws/4/html/installing_accessing_and_deleting_rosa_clusters/rosa-sts-deleting-cluster[Deleting a ROSA cluster]
