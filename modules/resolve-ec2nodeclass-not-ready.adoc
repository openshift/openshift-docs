...
. If `SubnetsReady` shows `False` with the message "SubnetSelector did not match any Subnets", private subnets in your VPC are missing the required discovery tag.
