...
. Select an operational control plane host to use as the recovery host.
You must perform the restore operation on a control plane node that is currently powered on and running.
