...
[role="_abstract"]
To encrypt data on managed disks at rest, you can supply an encryption key to {azure-first}. You can enable server-side encryption with customer-managed keys by using the Machine API.
