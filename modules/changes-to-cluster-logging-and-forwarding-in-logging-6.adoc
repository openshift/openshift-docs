...
[id="application-inputs_{context}"]
=== Application Inputs
...
.Logging 6.x output using service account token
[source,yaml]
----
...
spec:
...
.Logging 6.x output authentication and TLS  using secrets example
[source,yaml]
----
...
spec:
...
.Logging 6.x output authentication and TLS using configmap
[source,yaml]
----
...
spec:
