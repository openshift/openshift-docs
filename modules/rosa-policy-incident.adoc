...
Red Hat is also available to assist with customer incidents when raised through a support case. 
Red Hat is able to assist with activities including but not limited to:
