...
//
// * welcome/oke-about.adoc

:_mod-docs-content-type: CONCEPT
[id="oke_similarities_and_differences_{context}"]
= {oke} and {product-title} comparison

[role="_abstract"]
To help decide whether to use {oke} or {product-title}, you should understand the similarities and differences between the two platforms. 
...
2+h|{ServerlessProductName} (Knative)
|
| Yes

2+h|{pipelines-shortname} (Jenkins and Tekton)
|
| Yes
...
* Build strategies, builder pods, or Tekton container
deployments.
...
| Existing {op-system-base} manual attach to cluster (BYO) | Included | Included | N/A
...
| {op-system-base} Software Collections and RHT SSO Common Service (included) | Included | Included | N/A
...
| Web Terminal provided by Red Hat | Not Included | Included | {web-terminal-op}
| {pipelines-title} | Not Included | Included | {pipelines-shortname} Operator
| Embedded Component of {ibm-cloud-name} Pak and RHT MW Bundles | Not Included | Included | N/A
| {gitops-title} | Not Included | Included | {gitops-title} Operator
