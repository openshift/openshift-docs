...
Beyond basic field extraction and restructuring, JSONata provides advanced capabilities that enable more powerful event transformations. Two common advanced features are array processing and built-in functions.
