...
* *Scanner V4 Component Settings*: Settings for Scanner V4 scanner, available in version 4.4 and later. See the "Scanner V4" table in the "Public configuration file" section in "Installing Central services for {product-title-short} on {osp}".
+
...
//I think elsewhere we don't say this is *required* but do we now want to say this is required since Scanner V4 is installed by default?
