...
= Enable multipathing with kernel arguments on {op-system}
...
ip-10-0-136-161.ec2.internal   Ready                      worker   28m   v1.36.3
ip-10-0-136-243.ec2.internal   Ready                      master   34m   v1.36.3
ip-10-0-141-105.ec2.internal   Ready,SchedulingDisabled   worker   28m   v1.36.3
ip-10-0-142-249.ec2.internal   Ready                      master   34m   v1.36.3
ip-10-0-153-11.ec2.internal    Ready                      worker   28m   v1.36.3
ip-10-0-153-150.ec2.internal   Ready                      master   34m   v1.36.3
----
+
