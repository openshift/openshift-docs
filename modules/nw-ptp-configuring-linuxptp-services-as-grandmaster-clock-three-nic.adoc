...
|===
| Log entry | Sample output | Description

| **Clock Update**
a|
[source,text]
----
ts2phc[2527.586]: adding tstamp 1742826342.000000000 to clock /dev/ptp14
----
...
[source,text]
----
/dev/ptp14 offset 0 s2 freq +0
----
| Shows the estimated offset between the PTP device and the reference. An offset of **0** and state **s2** indicates the clock is fully synchronized.

| **Grandmaster Status**
a|
[source,text]
----
GM[1742826305]: ens4f0 T-GM-STATUS s2
----
