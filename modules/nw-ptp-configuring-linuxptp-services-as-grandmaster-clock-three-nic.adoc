...
`/dev/ptp<N> offset 0 s2 freq +0`:: Shows the estimated offset between the PTP device and the reference. An offset of `0` and state `s2` indicates the clock is fully synchronized.
