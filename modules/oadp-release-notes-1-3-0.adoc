...
For backup, specify the path during the installation through the uploader-type flag, the valid value is either `restic` or `kopia`, or defaults to Kopia if the value is not specified. The selection cannot be changed after the installation.
...
Applications on managed clusters were deleted and re-created upon restore activation. {oadp-first} (OADP 1.2) backup and restore process is faster than the older versions. The OADP performance change caused this behavior when restoring ACM resources. Therefore, some resources were restored before other resources, which caused the removal of the applications from managed clusters.

* To resolve the issue, it is necessary to first restore the whole managed cluster related resources in the following order:
+
[source,terminal]
----
...
* link:https://issues.redhat.com/browse/OADP-2886[OADP-2886]
* link:https://issues.redhat.com/browse/OADP-2895[OADP-2895]
* link:https://issues.redhat.com/browse/OADP-2869[OADP-2869]
* link:https://issues.redhat.com/browse/OADP-2898[OADP-2898]
* link:https://issues.redhat.com/browse/OADP-2904[OADP-2904]
* link:https://issues.redhat.com/browse/OADP-2907[OADP-2907]
* link:https://issues.redhat.com/browse/OADP-2910[OADP-2910]
* link:https://issues.redhat.com/browse/OADP-2889[OADP-2889]
* link:https://issues.redhat.com/browse/OADP-2892[OADP-2892]
* link:https://issues.redhat.com/browse/OADP-2901[OADP-2901]
...
When restoring 30k resources for the first time, without an existing-resource-policy, it takes twice as long to restore them, than it takes during the second and third try with an existing-resource-policy set to `update`. link:https://issues.redhat.com/browse/OADP-3071[OADP-3071]
