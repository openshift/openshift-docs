...
Scanner can check for vulnerabilities in images that use the following package formats (installed by the following package managers):

* apk (apk)
* dpkg (apt, dpkg)
* rpm (dnf, microdnf, yum, rpm)
