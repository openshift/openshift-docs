...
* Provides sequenced updates of cluster configurations and upgrades (OpenShift and Operators) as defined by cluster policies
...
* Allows for per-cluster actions by adding `ztp-done` or similar user configurable labels to clusters
