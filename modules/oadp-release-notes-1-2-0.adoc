...
The OADP 1.2.0 release notes include information about product recommendations, new features, resolved issues, known issues, and worarounds.
...
//The following workarounds are examples
