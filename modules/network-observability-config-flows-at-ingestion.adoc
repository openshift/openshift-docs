...
You can configure flowlogs-pipeline filters in the `spec.processor.filters` parameter of the `FlowCollector` resource in the Network Observability Operator. For example:
