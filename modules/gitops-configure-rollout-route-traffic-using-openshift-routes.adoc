...
//
// * extend/routing-traffic-by-using-argo-rollouts.adoc
...
`spec.to.weight`:: Specifies the traffic weight for the stable service. The Route Rollout plugin automatically modifies this field to the stable weight.
`spec.alternateBackends.name`:: Specifies the name of the targeted canary service.
`spec.alternateBackends.weight`:: Specifies the traffic weight for the canary service. The Route Rollout plugin automatically modifies this field to the canary weight.
-- 
