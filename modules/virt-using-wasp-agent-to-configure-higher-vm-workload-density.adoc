...
+
The current memory density is now displayed.
. Expand the *Current memory density* line.
. Choose the desired density by moving the *Requested memory density* slider. You can increase the density from 100% up to 400% in increments of 25%.
+
This section also displays the actual vs. requested memory density across the cluster.
. Click *Save*.
