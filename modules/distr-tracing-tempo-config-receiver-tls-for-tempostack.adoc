...
= Configuring the receiver TLS for a TempoStack instance

* You can provide a TLS certificate in a secret and configure it in the `TempoStack` custom resource.
+
[NOTE]
====
