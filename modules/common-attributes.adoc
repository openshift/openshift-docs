...
[role="_abstract"]
This file defines common AsciiDoc attributes used across Red Hat Advanced Cluster Security for Kubernetes documentation.
...
:ocp-virt-first: Red{nbsp}Hat OpenShift Virtualization (RHOCPV)
:ocp-virt: RHOCPV
