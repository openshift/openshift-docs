...
When you install the {pipelines-shortname} Operator, it adds reusable pipeline cluster tasks to your cluster.
You can use the *Pipeline builder* to configure pipelines, or construct a pipeline flow using existing tasks and cluster tasks.
