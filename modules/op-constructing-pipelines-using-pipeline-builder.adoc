...
* Configure pipelines by using either the *Pipeline builder* or the *YAML view*.
...
* Search and add tasks from {artifact-hub}.
...
[NOTE]
====
The search list has tasks from {artifact-hub} and tasks available in the cluster. Also, if a task is already installed, the list shows *Add* to add the task, whereas it shows *Install and add* to install and add the task. It shows *Update and add* when you add the same task with an updated version.
====
