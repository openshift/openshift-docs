...
[source,terminal]
----
$ oc -n openshift-logging patch daemonset/logging-collector -p '{"spec":{"template":{"spec":{"nodeSelector":{"logging-infra-collector": "false"}}}}}'
----
...
[source,terminal]
----
$ oc -n openshift-logging patch daemonset/logging-collector -p '{"spec":{"template":{"spec":{"nodeSelector":{"logging-infra-collector": "true"}}}}}'
----
