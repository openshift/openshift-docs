...
This release of the Custom Metrics Autoscaler Operator 2.13.1-421 provides a new feature and a bug fix for running the Operator in an {product-title} cluster. The following advisory is available for the Custom Metrics Autoscaler: link:https://access.redhat.com/errata/RHBA-2024:4837[RHBA-2024:4837].
