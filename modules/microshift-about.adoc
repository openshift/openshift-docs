...
[role="_abstract"]
Use {microshift-short} to run single-node Kubernetes workloads directly on resource-constrained edge devices. Integrating {microshift-short} with edge-optimized operating systems overcomes severe networking and physical constraints.
