...
:navtitle: Access the node metrics dashboard
[id="nodes-dashboard-using-accessing_{context}"]
= Accessing the node metrics dashboard

[role="_abstract"]
You can access the node metrics dashboard from the *Administrator* perspective of the {product-title} web console.
