...
[role="_abstract"]
You can partition a single, high-speed dual port NIC into multiple virtual functions (VFs) on physical functions (PFs) and enable Single Root I/O Virtualization (SR-IOV) with LACP bond support.
