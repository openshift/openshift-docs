...
[role="_abstract"]
You must create a `MustGather` custom resource (CR) from the command-line interface (CLI) to automate the collection of diagnostic data from your cluster. This process also optionally uploads the data to a Red{nbsp}Hat Support case.
...
* If you want to persist the archive, you have created a persistent volume claim (PVC) in the CR namespace.
