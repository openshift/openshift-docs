...
[role="_abstract"]
Use the following information to learn about `tkn` task run commands.
...
----
where::
`--keep 5`:: Replace `5` with the number of most recently executed task runs you want to retain.
