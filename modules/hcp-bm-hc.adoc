...
- For best security and management practies, create a hosted cluster separate from other hosted clusters. 

- Ensure that you apply the same name to the hosted cluster and the namespace that exists in that hosted cluster. This configuration ensures that hosted cluster and `NodePool custom resources (CRs) remain in that hosted cluster.
