...
allowedAddressPairs:: Specify allowed address pairs for the API and ingress ports.
<machines_subnet_UUID>:: Specify the machines network and subnet.
<machines_network_UUID>:: Specify the machines network and subnet.
<compute_security_group_UUID>:: Specify the compute machines security group.
