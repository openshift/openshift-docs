...
+
Use the following YAML for an `OperatorGroup` object in `SingleNamespace` install mode:
+
[source,yaml]
----
...
+
Use the following YAML for a `Subscription` object:
+
[source,yaml]
----
...
+
... Use the following YAML for a `Subscription` object with a specific starting Operator version:
+
[source,yaml]
----
apiVersion: operators.coreos.com/v1alpha1
...
+
Use the following YAML for a `Subscription` object with manual update approvals:
+
[source,yaml]
----
kind: Subscription
...
+
Use the following YAML for a `Subscription` object with {aws-short} {sts-short} variables:
+
[source,yaml]
----
kind: Subscription
...
+
Use the following YAML for a `Subscription` object with {entra-short} variables:
+
[source,yaml]
----
kind: Subscription
...
+
Use the following YAML for a `Subscription` object with {gcp-wid-short} variables:
+
[source,yaml]
----
kind: Subscription
