...
//
// * cli_reference/odo/creating-a-single-component-application-with-odo
// * cli_reference/odo/using-odo-in-a-restricted-environment/creating-and-deploying-a-component-to-the-restricted-cluster
...
----
+
Your component is now deployed to your cluster.
