...
[IMPORTANT]
====
You can only select this option when the host cluster is a {hcp-title} cluster version 4.18 and above, the instance type is bare metal EC2, and the region is `us-west-2`.
====
