...
{microshift-short} is supported on {op-system-base-full} {op-system-version-10}. This Technology Preview capability supports upgrading {microshift-short} 4.20 and 4.21 to {microshift-short} 4.22 on {op-system-base-full} {op-system-version-10}.