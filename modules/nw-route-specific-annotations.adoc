...
This value is applicable to re-encrypt and edge routes only.
...
* link:https://developer.mozilla.org/en-US/docs/Web/HTTP/Headers/Set-Cookie/SameSite[Attributes (mdn documentation)]
