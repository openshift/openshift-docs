...
ifndef::openshift-dedicated[]
* Configuring a dedicated Multus network for live migration is highly recommended. A dedicated network minimizes the effects of network saturation on tenant workloads during migration. For more information, see "Configuring a dedicated network for live migration" in the Additional resources section.
endif::openshift-dedicated[]