...
* You installed the link:https://access.redhat.com/documentation/en-us/red_hat_openshift_data_foundation/4.17[{rh-storage} Operator] to provide object storage and Ceph RGW object storage.
