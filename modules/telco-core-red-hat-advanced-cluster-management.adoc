[id="telco-core-red-hat-advanced-cluster-management"]
= Red Hat Advanced Cluster Management

New in this release::
* Using Red Hat Advanced Cluster Management (RHACM) and PolicyGenerator CRs is the recommended approach for managing and deploying policies to managed clusters.
