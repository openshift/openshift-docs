...
[NOTE]
====
Do not tag all existing security groups with the `kubernetes.io/cluster/<name>,Value=<clusterid>` tag, or the Elastic Load Balancer (ELB) will not be able to create a load balancer.
====
