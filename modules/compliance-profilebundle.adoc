...
spec:
  contentFile: ssg-rhcos4-ds.xml # Location of the file containing the compliance content
  contentImage: registry.redhat.io/compliance/openshift-compliance-content-rhel8@sha256:900e... # Content image location
----
* **contentFile**: Location of the file containing the compliance content.
* **contentImage**: Content image location.
