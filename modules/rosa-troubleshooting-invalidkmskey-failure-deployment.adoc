...
. Start by checking if EBS encryption is enabled in the EC2 settings. You can check the status by following the steps in https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/EBSEncryption.html#encryption-by-default[AWS Check EBS Encryption].
