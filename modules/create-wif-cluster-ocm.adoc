...
+
. To create a new WIF configuration, run the following OCM CLI command. To use a previously configured WIF configuration, skip to the following step.
+
// [NOTE]
// ====
...
----
+
. Select a previously configured WIF configuration from the *WIF configuration* drop-down list.
+
[NOTE]
====
