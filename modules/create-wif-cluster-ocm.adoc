...
You can significantly reduce these permissions by using a custom role with minimal permissions. For more information, see _Configure reduced permissions for a Shared VPC host project on {gcp-short}_ in the _Additional resources_ section.
