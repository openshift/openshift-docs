...
{ols-official} 1.0.9 resolves issues with pod replica management, consolidates TLS security configurations, and improves assistant reliability by isolating failing Model Context Protocol (MCP) servers. These fixes simplify administrative tasks and ensure continued tool availability.
