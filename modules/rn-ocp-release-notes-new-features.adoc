...
Updated libraries for the {secrets-store-operator}::
+
The {secrets-store-operator} version 4.21 is now based on the upstream version 1.5.4 release of secrets-store-csi-driver
