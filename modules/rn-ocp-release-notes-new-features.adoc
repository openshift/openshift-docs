...
+
You can add bare-metal compute machines to an existing {product-title} cluster on {vmw-short}. This capability enables you to migrate workloads to physical hardware without reinstalling the cluster.
+
