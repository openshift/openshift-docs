...
+
This release adds support for the following Gateway API version 1.5.1 features:
+
--
...
--
+
For more information, see xref:../networking/ingress_load_balancing/configuring_gateway_api/understand-gateway-api.adoc#understand-gateway-api_understand-gateway-api[Understand Gateway API].
