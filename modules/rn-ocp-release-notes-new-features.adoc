...
{op-system} uses {op-system-base-full} 9.8 packages in {product-title} 4.22. These packages ensure that your {product-title} instances receive the latest fixes, features, enhancements, hardware support, and driver updates.

{op-system} {op-system-base} 10.2 support (Technology Preview)::

You can configure your cluster to use {op-system} 10.2, which uses {op-system-base} packages, in {product-title} 4.22 as a technology preview feature. You can update the nodes in an existing non-production test cluster to  or install a new non-production test cluster. For more information, see xref:../machine_configuration/mco-image-streams.adoc#mco-image-streams[Setting the RHCOS version in a cluster] 

Ignition update to version 2.25.1::
+
With this release, {op-system-first} introduces version 2.25.1 of Ignition. With this release, ignition-validate binaries are signed with the Fedora 42 key.

Butane update to version 0.26.0::
+
With this release, {op-system-first} now includes Butane version 0.26.0.

Afterburn update to version 5.10.0::
+
With this release, {op-system-first} now includes Afterburn version 5.10.0. This release adds support for UpCloud.

coreos-installer update to version 0.25.0::
+
With this release, the coreos-installer utility is updated to version 0.25.0. 
