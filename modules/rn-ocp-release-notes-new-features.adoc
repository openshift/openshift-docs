...
Installing a cluster with RHEL9 and RHEL10 on Nutanix::
+
With this update, you can install and update a {product-title} cluster on Nutanix with machines using {op-system-base-full} 9, RHEL 10, or a mix of both.
+
