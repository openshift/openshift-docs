...
+
Before this update, the OpenShift Console introduced the unified view in 4.19, and the *Helm* UI displayed in the *Administrator* view but outside the *Ecosystem* menu. With this update, the OpenShift Console displays *Helm* under *Ecosystem*, centralizing software management navigation in one location within the unified view.
