...
+
he `ConsoleLink` Custom Resource Definition supports `mailto:` links. The contact email link displays in the **User menu** under the **username** and opens the default email client with the email address prefilled.
+
[source,yaml]
----
