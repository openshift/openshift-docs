...
+
With this update, for clusters installed on {aws-first}, you can configure the maximum throughput for gp3 drives of EBS devices.
You enable this by setting the `throughputMib` spec for your compute machine sets.
