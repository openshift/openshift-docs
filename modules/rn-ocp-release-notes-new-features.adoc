...
+
You can now place compute machines on {aws-first} Dedicated Hosts. Dedicated Hosts are physical servers that are fully dedicated to your use, which enables you to use your existing per-socket, per-core, or per-VM software licenses and comply with corporate policies that require physical CPU assignment.
+
