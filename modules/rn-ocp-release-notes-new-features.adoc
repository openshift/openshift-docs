...
=======
>>>>>>> d655e5f7de (OSDOCS-19034-RN BMaaS OCI Release note)
...
Expanding bare-metal clusters using OCI images and {bmaas-first}::
+
With this update, you can expand your bare-metal cluster using {bmaas-first} with images from an OCI registry. You can use images from public OCI registries or from the built-in cluster registry. For more information, see xref:../installing/installing_bare_metal/bare-metal-using-bare-metal-as-a-service.adoc[Using Red Hat Bare Metal as a Service for OpenShift].
