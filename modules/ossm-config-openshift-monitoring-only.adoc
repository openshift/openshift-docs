...
. Create a `Telemetry` resource in the Istio Control Plane namespace to ensure Prometheus is a metrics provider, similar to the following example:
+
[source,yaml]
----
