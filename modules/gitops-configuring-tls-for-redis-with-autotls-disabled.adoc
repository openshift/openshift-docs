...
//
// * secure/configuring-secure-communication-with-redis.adoc
...
.. Search for `argocds.argoproj.io` and click `ArgoCD`.
...
`<namespace>`:: Specifies the namespace where the Argo CD instance is running, for example `openshift-gitops`.
