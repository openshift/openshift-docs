...
:context: installation-rhv-verifying-the-rhv-environment
:rhv-version: 4.3.9
...
----
curl -k -u <ovirt-admin>:<password> \ <1>
https://<engine-fqdn>/ovirt-engine/api <2>
----
<1> For <ovirt-admin> and <password>, specify the username and password of an oVirt user with `SuperUser` or `ClusterAdmin` privileges.
