...
[id="secondary-scheduler-operator-release-notes-1.5.2_{context}"]
= Release notes for {secondary-scheduler-operator-full} 1.5.2
...
The following advisory is available for the {secondary-scheduler-operator-full} 1.5.2:

* link:https://access.redhat.com/errata/RHBA-2026:65924[RHBA-2026:65924]

[id="secondary-scheduler-1.5.2-new-features_{context}"]
== New features and enhancements

* This release rebuilds the base image for the {secondary-scheduler-operator} to improve its image grade.

[id="secondary-scheduler-operator-1.5.2-known-issues_{context}"]
== Known issues
