...
= The HostFirmwareComponents resource

[role="_abstract"]
Use the `HostFirmwareComponents` resource to identify and update BIOS, BMC, and NIC firmware components, ensuring your bare-metal hosts run current firmware versions for security, performance, and compatibility.
