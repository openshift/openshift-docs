...
----
+
For example, to move monitoring components for core {product-title} projects to pre-defined infrastructure nodes, use:
+
[source,yaml,subs=quotes]
----
apiVersion: v1
...
----
+
For example, to move monitoring components for user-defined projects to pre-defined infrastructure nodes, use:
+
[source,yaml,subs=quotes]
----
apiVersion: v1
