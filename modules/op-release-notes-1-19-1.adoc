...
* Before this update, installing the {pipelines-title} 1.19 Operator displayed the Tekton Pruner API in the console. With this update, this issue is fixed and the API is no longer displayed.
