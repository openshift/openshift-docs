...
= LokiStack sizing versus component scaling
...
You can override the default replica count for specific components by using `spec.template.<component>.replicas`. This provides fine-grained control for workload-specific optimizations.
...
Example: Scaling distributors and ingesters for write-heavy workload:
