...
= About Insights Advisor recommendations for workloads

You can use the Insights for OpenShift advisor service to view and manage information about recommendations that affect not only your clusters, but also your workloads. Insights advisor takes advantage of deployment validation and allows OpenShift cluster administrators to see all runtime violations of deployment policies. You can see recommendations for workloads at link:https://console.redhat.com/openshift/insights/advisor/workloads[OpenShift > Advisor > Workloads] on the {hybrid-console}. For more information, see these additional resources:
