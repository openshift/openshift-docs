...
[NOTE]
====
The policy count and policy list view include only policies in the Deploy lifecycle phase.
====

You can use the drop-down menus in the header to switch between entities.
For example, you can:
