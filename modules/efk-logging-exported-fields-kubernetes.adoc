...
[id='efk-logging-exported-fields-kubernetes-{context}']
= Kubernetes exported fields

These are the Kubernetes fields exported by the {product-title} EFK logging system and available for searching
