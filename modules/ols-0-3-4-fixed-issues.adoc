...
[role="_abstract"]
{ols-official} 0.3.4 resolves issues with UI stability during log attachments, credential validation for {azure-official} {entra-id}, and custom CA certificate support for secure LLM connections.
