...
[source,terminal]
----
$ export BMC_IP=<bmc_ip_address> <1>
$ export BMC_USER=<bmc_username> <2>
$ export BMC_PASSWORD=<bmc_password> <3>
$ export WORKER_NAME=<worker_name> <4>
$ export BOOT_MAC=<management_interface_mac> <5>
$ export ROOT_DEVICE=<root_device_path> <6>
----
+
where:
+
...
<management_interface_mac>:: Specifies the MAC address of the out-of-band management interface, such as `aa:bb:cc:dd:ee:01`.
