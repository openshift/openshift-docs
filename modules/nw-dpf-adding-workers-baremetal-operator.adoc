...
baremetal   4.22.11   True        False         False      ...
----
...
[source,terminal]
----
secret/worker-01-bmc-secret created
----

. Create a file named `baremetalhost.yaml`. The `userData` secret determines the node type:
+
--
...
[source,terminal]
----
baremetalhost.metal3.io/worker-01 created
----
