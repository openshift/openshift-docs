...
| `contextTab`
| String
| The context tab in which the alert appears. Valid values include `netobserv`, `ovn`, `kiali`, or other third-party context identifiers. If not specified, the alert appears in the default NetObserv tab.
