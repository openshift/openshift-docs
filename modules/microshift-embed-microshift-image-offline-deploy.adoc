...
----
+
Replace `_<release_version>_` with the numerical value of the release you are deploying, using the entire version number, such as `4.22.1`.
...
[source,terminal,subs="+quotes"]
----
microshift-release-info-4.22.1.-202512101230.p0.g7dc6a00.assembly.4.22.1.el9.noarch.rpm
----
