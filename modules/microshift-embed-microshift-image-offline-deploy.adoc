...
= Embed {microshift-short} containers for offline deployments
...
----
+
Replace `_<release_version>_` with the numerical value of the release you are deploying, using the entire version number, such as `5.0.0`.
...
[source,terminal,subs="+quotes"]
----
microshift-release-info-5.0.0.-202605191402.p0.g4f61957.assembly.rc.0.el9.noarch.rpm
----
