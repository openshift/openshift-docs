...
[WARNING]
====
Importing a virtual machine whose disk size is larger than the available storage space will fail without an error message. There is no way to remove the virtual machine and PVC.
