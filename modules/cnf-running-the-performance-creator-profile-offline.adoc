...
[NOTE]
====
`must-gather` must be run with the `performance-addon-operator-must-gather` image and the output compressed.
====
For more information see xref:../support/gathering-cluster-data.adoc#nodes-nodes-managing[Gathering data about your cluster].
...
Flags:
  ...
  -h, --help                              help for performance-profile-creator
      --mcp-name string                   MCP name corresponding to the target machines (required) (default "worker-cnf")
      --must-gather-dir-path string       Must gather directory path (default "must-gather")
      --power-consumption-mode string     The power consumption mode.  [Valid values: default, low-latency, ultra-low-latency] (default "default")
      --profile-name string               Name of the performance profile to be created (default "performance")
      --reserved-cpu-count int            Number of reserved CPUs (required)
      --rt-kernel                         Enable Real Time Kernel (required) (default true)
