...
ifndef::aws-china,aws-gov,aws-secret,azure-gov,ash,aws-private,azure-private,gcp-private,ash-default,ash-custom[]
For user-provisioned installations of {product-title}, you manually generate your installation configuration file.
endif::aws-china,aws-gov,aws-secret,azure-gov,ash,aws-private,azure-private,gcp-private,ash-default,ash-custom[]
...
ifndef::aws-china,aws-gov,aws-secret,azure-gov,ash,ash-default,ash-custom[]
[NOTE]
====
...
====
endif::aws-china,aws-gov,aws-secret,azure-gov,ash,ash-default,ash-custom[]
ifdef::ash[]
+
...
ifdef::ash-custom[]
.. Update one or more of the default configuration parameters to customize the installation.
endif::ash-custom[]
endif::ash-default,ash-custom[]
+
