...
ifdef::aws-private,azure-private,gcp-private,ibm-cloud-private,ibm-power-reg-vs-private[]
When installing a private {product-title} cluster, you must manually generate the installation configuration file.
endif::aws-private,azure-private,gcp-private,ibm-cloud-private,ibm-power-reg-vs-private[]
...
ifndef::aws-china,aws-gov,aws-secret,azure-gov,ash,ash-default,ash-network,gcp-shared,ibm-cloud-private,ibm-power-reg-vs-private[]
+
[NOTE]
====
...
====
endif::aws-china,aws-gov,aws-secret,azure-gov,ash,ash-default,ash-network,gcp-shared,ibm-cloud-private,ibm-power-reg-vs-private[]
ifdef::ash[]
+
