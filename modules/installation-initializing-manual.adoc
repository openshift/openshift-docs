...
----
+
For `<mirror_host_name>`, specify the registry domain name from your mirror registry certificate. For `<credentials>`, specify the base64-encoded user name and password for your mirror registry.
+
