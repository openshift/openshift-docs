...
ifndef::aws-china,aws-gov,azure-gov,ash,aws-private,azure-private,gcp-private,ash-default[]
For user-provisioned installations of {product-title}, you manually generate your installation configuration file.
endif::aws-china,aws-gov,azure-gov,ash,aws-private,azure-private,gcp-private,ash-default[]
...
ifndef::aws-china,aws-gov,ash,ash-default,ash-custom[]
[NOTE]
====
...
====
endif::aws-china,aws-gov,ash,ash-default,ash-custom[]
ifdef::ash[]
+
