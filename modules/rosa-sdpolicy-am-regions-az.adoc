...
The following AWS regions are supported by Red Hat OpenShift 4 and are supported for {product-title}. Note: China regions are not supported, regardless of their support on OpenShift 4.
...
[id="rosa-sdpolicy-regions-az-aws-govcloud_{context}"]
