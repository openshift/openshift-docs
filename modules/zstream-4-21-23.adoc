...
= RHSA-2026:34764 - {product-title} {product-version}.23 fixed issues advisory

Issued: 07 July 2026

[role="_abstract"]
{product-title} release {product-version}.23 is now available. The list of fixed issues that are included in the update is documented in the link:https://access.redhat.com/errata/RHSA-2026:34764[RHSA-2026:34764] advisory. There are no RPM packages for this release.
