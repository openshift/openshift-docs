...
You can use the following example to match the `pipeline-bug-or-defect` pipeline run when you add either the `bug` label or the `defect` label to a pull request, and also when you update a pull request with this label with a new commit:
