...
* To enable the acpi_idle CPUIdle driver (e.g. for Intel FlexRAN), add `intel_idle.max_cstate=0` to the `additionalKernelArgs` list in the `PerformanceProfile` resource.
