...
[role="_abstract"]
You can use a mirror registry to host the required container images for your cluster. The mirror registry must be on a host that has access to both your network and the internet.
...
[id="installation-about-mirror-registry-additional-resources_{context}"]
