...
[role="_abstract"]
To remove custom configurations and return your network to its default state, restore the networking settings in {product-title}. This procedure utilizes a built-in clean-up script to safely undo changes made by the OVN-Kubernetes plugin.
