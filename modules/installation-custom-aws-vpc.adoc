...
In addition, by deploying {product-title} into an existing AWS VPC, you might be able to avoid limit constraints in new accounts or more easily abide by the operational constraints that your company's guidelines set.
endif::aws-outposts[]
...
* link:https://docs.aws.amazon.com/vpc/latest/userguide/working-with-vpcs.html[Create a VPC ({aws-full} documentation)]
* link:https://docs.aws.amazon.com/vpc/latest/userguide/VPC_Networking.html[VPC networking components ({aws-full} documentation)]
* link:https://docs.aws.amazon.com/vpc/latest/userguide/VPC_Route_Tables.html[Route tables for your VPC ({aws-full} documentation)]
ifdef::public[]
* link:https://docs.aws.amazon.com/vpc/latest/userguide/VPC_Scenario2.html[VPC with public and private subnets (NAT) ({aws-full} documentation)]
* link:https://docs.aws.amazon.com/managedservices/latest/userguide/find-subnet.html[Finding a subnet ID ({aws-full} documentation)]
endif::public[]
ifdef::aws-outposts[]
* link:https://docs.aws.amazon.com/vpc/latest/userguide/VPC_Scenario2.html[VPC with public and private subnets (NAT) ({aws-full} documentation)]
* link:https://docs.aws.amazon.com/managedservices/latest/userguide/find-subnet.html[Finding a subnet ID ({aws-full} documentation)]
* link:https://docs.aws.amazon.com/outposts/latest/userguide/outposts-local-gateways.html#vpc-associations[VPC associations ({aws-full} documentation)]
endif::aws-outposts[]
* link:https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/Using_Tags.html#tag-restrictions[Tag Restrictions ({aws-full} documentation)]
* link:https://docs.aws.amazon.com/vpc/latest/userguide/vpc-dns.html#vpc-dns-support[DNS Support in Your VPC ({aws-full} documentation)]
