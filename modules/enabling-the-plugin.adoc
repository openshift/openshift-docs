...
The {product-title-short} Operator enables the {rh-rhacs-console-plugin} dynamic plugin by default when you install it on a cluster. You can disable the plugin if you do not want to use it. For upgrades, depending on the version you are upgrading from, you might need to enable the plugin during or after the installation of the {product-title-short} Operator.
