...
+
If you are mirroring image sets in a fully disconnected environment, ensure that you have installed the oc-mirror plugin on the host with internet access and the host in the disconnected environment with access to the mirror registry.
