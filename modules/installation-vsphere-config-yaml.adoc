...
ifndef::ipi[]
    folder: "/<datacenter_name>/vm/<folder_name>/<subfolder_name>" <17>
    resourcePool: "/<datacenter_name>/host/<cluster_name>/Resources/<resource_pool_name>" <18>
    diskType: thin <19>
endif::ipi[]
ifndef::restricted[]
...
ifndef::restricted[]
ifndef::openshift-origin[]
<13> The pull secret that you obtained from {cluster-manager-url}. This pull secret allows you to authenticate with the services that are provided by the included authorities, including Quay.io, which serves the container images for {product-title} components.
<14> The public portion of the default SSH key for the `core` user in
{op-system-first}.
endif::openshift-origin[]
ifdef::openshift-origin[]
<12> You obtained the {cluster-manager-url-pull}. This pull secret allows you to authenticate with the services that are provided by the included authorities, including Quay.io, which serves the container images for {product-title} components.
