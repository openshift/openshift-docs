...
+
The following is an example `OpenTelemetryCollector` custom resource for the edge clusters:
+
[source,yaml]
----
...
+
The following is an example `OpenTelemetryCollector` custom resource for the central cluster:
+
[source,yaml]
----
apiVersion: opentelemetry.io/v1beta1
