...
//CLI shows: modules/automatically-scaling-machines-to-available-bare-metal-hosts.adoc:28:1:AsciiDocDITA.TaskStep:Content other than a single list cannot be mapped to DITA tasks.
//nothing in VSC
[NOTE]
====
