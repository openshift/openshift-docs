...
[role="_abstract"]
Back up files and directories from within your virtual machine by using the VM data protection (VMDP) CLI. This helps you to protect user data, including data accessible over network file systems such as CIFS and NFS shares.
