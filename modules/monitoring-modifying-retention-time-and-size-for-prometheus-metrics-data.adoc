...
// tag::CPM[]
By default, Prometheus retains metrics data for core platform monitoring for the following durations:

* {ocp} and {product-rosa-hcp}: 15 days.
* {product-rosa} and {product-dedicated}: 11 days.
