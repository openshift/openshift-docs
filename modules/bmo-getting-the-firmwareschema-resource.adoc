...
[role="_abstract"]
Get the `FirmwareSchema` resource to identify valid BIOS settings for your host model before configuring firmware, preventing configuration errors from invalid settings.
