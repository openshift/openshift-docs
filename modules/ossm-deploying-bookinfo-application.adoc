...
= Deploy Bookinfo with namespace labels

[role="_abstract"]

Deploy the Bookinfo sample application to a sidecar mesh by labeling the namespace for automatic sidecar injection and applying the application YAML file.
