...
Description::
For a full list of components that you can disable using the cluster capabilities feature, see xref:../installing/overview/cluster-capabilities.adoc#cluster-capabilities[Cluster capabilities].
