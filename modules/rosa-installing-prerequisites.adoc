...
.. Download the link:https://github.com/openshift/rosa/releases[latest release] of `rosa` for your operating system.
...
----
+
.. (Optional) Run the `rosa completion` command to generate a bash completion file.
+
[source,terminal]
----
