...
[role="_abstract"]
Operators are the foundational control plane extensions of {product-title}. Use Operators as the preferred method to package, deploy, and manage services on the control plane, and to support your applications.
