...
= Example remote write authentication settings (CPM)
// end::CPM[]

// tag::UWM[]
[id="example-remote-write-authentication-settings-uwm_{context}"]
= Example remote write authentication settings (UWM)
// end::UWM[]
...
//commenting this ID out for the build to not break. Will be uncommented after the migration.
