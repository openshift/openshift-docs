...
[role="_abstract"]
{product-title-short} automatically identifies platform components by built-in definitions. However, with {product-title-short} 4.8 and newer, you can view and customize these definitions, providing more granular control over how {product-title-short} categorizes security findings.
