...
= Install {microshift-short} from an RPM package
...
. Download your installation pull secret to a temporary folder, for example, `$HOME/openshift-pull-secret`. This pull secret allows you to authenticate with the container registries that serve the container images used by {product-title}.
