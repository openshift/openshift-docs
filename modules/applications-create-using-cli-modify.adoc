...
[source,terminal]
----
$ oc new-app openshift/postgresql-92-centos9 \
...
[source,terminal]
----
$ oc new-app openshift/postgresql-92-centos9 --env-file=postgresql.env
----
...
[source,terminal]
----
$ cat postgresql.env | oc new-app openshift/postgresql-92-centos9 --env-file=-
----
...
[source,terminal]
----
$ oc new-app openshift/ruby-23-centos9 \
...
[source,terminal]
----
$ oc new-app openshift/ruby-23-centos9 --build-env-file=ruby.env
----
...
[source,terminal]
----
$ cat ruby.env | oc new-app openshift/ruby-23-centos9 --build-env-file=-
----
