...
. Select the *Install {VirtProductName}* and *Install OpenShift Data Foundation* checkboxes in the *Assisted Installer* options.
...
[NOTE]
====
By default, clusters use self-signed certificates. This may cause your browser to display a message that says *Connection not private* or a similar warning. You can dismiss this warning and continue.
====
.. Navigate to the URL.
