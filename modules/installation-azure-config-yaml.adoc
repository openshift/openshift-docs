...
[NOTE]
====
Generation 2 VMs in Azure are supported and can be used to provision VMs with disk sizes that exceed 2000 GB. You must use a VM from a series that has link:https://docs.microsoft.com/en-us/azure/virtual-machines/generation-2#generation-2-vm-sizes[generation 2 support], such as `Standard_D2s_v3`.
====
