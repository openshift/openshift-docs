...
[source,terminal]
----
$ watch "oc get backup -n openshift-adp <backup_resource_name> -o jsonpath='{.status}' | jq"
----
...
[source,terminal]
----
$ watch "oc get restore -n openshift-adp <backup_resource_name> -o jsonpath='{.status}' | jq"
----
...
. Observe all of the {oadp-short} objects by running the following command:
+
[source,terminal]
----
