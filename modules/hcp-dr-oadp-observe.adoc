...
:navtitle: Observe the backup and restore process
[id="hcp-dr-oadp-observe_{context}"]
= Observing the backup and restore process

[role="_abstract"]
When you use {oadp-first} to back up and restore a hosted cluster, you can monitor and observe the process.
