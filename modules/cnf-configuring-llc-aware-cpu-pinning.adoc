...
[NOTE]
====
The node will restart after you applying the `MachineConfig` resource.
====
...
. Check that the enablement file was created on the target node by running the following commands:
+
[source,terminal]
----
