...
See link:https://docs.openshift.com/container-platform/4.14/telco_ref_design_specs/ran/telco-ran-ref-design-spec.html#telco-ran-ref-design-features_ran-ref-design-spec[{product-title} 4.14 {rds} features] for more information.
