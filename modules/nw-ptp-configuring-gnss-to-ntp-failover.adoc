...
kind: PtpConfig
metadata:
  name: grandmaster-gnss-failover
...
spec:
  ...
  - name: "grandmaster"
    ...
    # Use wildcard for interface name in phc2sys
    ...
    # ts2phc holdover time: 14440 seconds (approximately 4hrs) before switching to NTP
    # Note: Using the holdover value from the current doc'd config (14440s).
    ts2phcOpts: "--ts2phc.holdover 14440"
    ...
    plugins:
      # E810 Hardware-Specific Configuration (from PtpConfigGmWpc.yaml)
      e810:
        ...
        ublxCmds:
          - args: #ubxtool -P 29.20 -z CFG-HW-ANT_CFG_VOLTCTRL,1
            ...
            reportOutput: false
          # Disabled other constellations to focus on GPS (from PtpConfigGmWpc.yaml)
      ...
      # NTP Failover Plugin (from current doc'd config)
      ntpfailover:
        gnssFailover: true
    ...
    ts2phcConf: |
      ...
      # Use wildcard for serial port (from PtpConfigGmWpc.yaml)
      ts2phc.nmea_serialport (?<gnss_serialport>[/\w\s/]+)
      leapfile  /usr/share/zoneinfo/leap-seconds.list
      # Use wildcard for interface name (from PtpConfigGmWpc.yaml)
      [(?<iface_timeTx>[[:alnum:]]+)]
    ...
    ptp4lConf: |
      # Wildcard interface sections (from PtpConfigGmWpc.yaml)
      [(?<iface_timeTx>[[:alnum:]]+)]
      masterOnly 1
      ...
      masterOnly 1
      [global]
      # ... (Rest of the detailed [global] settings from PtpConfigGmWpc.yaml)
      twoStepFlag 1
      priority1 128
      priority2 128
      domainNumber 24
