...
In that case, you can acknowledge the faulty DIMM and continue rebooting provided that the remaining memory is sufficient.
...
//Question: How do we check the log files for DIMM? Is it something that users can only see when rebooting and the message comes up?
// Yes it can
