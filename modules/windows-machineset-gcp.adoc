...
This sample YAML file defines a Windows `MachineSet` object running on {gcp-full} that the Windows Machine Config Operator (WMCO) can use.
...
<6> Specify the {gcp-full} project that this cluster was created in.
