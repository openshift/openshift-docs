...
:navtitle: Us network namespaces
[id="security-network-namespaces_{context}"]
= Using network namespaces

[role="_abstract"]
You can use software-defined networking (SDN) in {product-title} to give a unified cluster network that enables communication between containers across the cluster.
