...
+
--
`includedClusterScopedResources:`:: To restore the persistent volumes for your application, you must configure this section as shown.
--
...
+
--
`restorePVs: true`:: To preserve the persistent volumes for your application, you must set `restorePVs` to `true`.
