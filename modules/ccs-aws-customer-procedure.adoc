...
[role="_abstract"]
The Customer Cloud Subscription (CCS) model allows Red{nbsp}Hat to deploy and manage {product-title} into a customer's Amazon Web Services (AWS) account. Red{nbsp}Hat requires several prerequisites to provide these services.
