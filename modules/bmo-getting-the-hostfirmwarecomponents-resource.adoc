...
[role="_abstract"]
Get the `HostFirmwareComponents` resource to view current BIOS and BMC firmware versions, enabling you to identify outdated components that need updates for security or compatibility.
