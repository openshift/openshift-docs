...
[role="_abstract"]
To verify the current BIOS and baseboard management controller (BMC) versions for a physical host, review the `HostFirmwareComponents` resource. This resource provides the specific firmware versions and status for your host hardware.
