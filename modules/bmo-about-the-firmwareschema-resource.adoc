...
[role="_abstract"]
The `FirmwareSchema` resource provides read-only information about valid BIOS settings for your bare-metal host model, including enumeration values, integer bounds, and string length constraints.
