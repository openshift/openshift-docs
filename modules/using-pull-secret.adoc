...
* By defining `imagePullSecrets` directly in workload configurations, which is useful for environments like GitOps or AroCD.
...
metadata:
  annotations:
    openshift.io/internal-registry-pull-secret-ref: default-dockercfg-123456
