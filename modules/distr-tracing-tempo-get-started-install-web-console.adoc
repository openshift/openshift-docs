...
[id="get-started-distr-tracing-tempo-install-web-console_{context}"]
= Install the {TempoOperator} for the demo

[role="_abstract"]
Install the {TempoOperator} from the {ocp-product-title} web console.
...
[TIP]
====
On {ocp-product-title} 4.19 or earlier, go to *Operators* -> *OperatorHub*.

On {ocp-product-title} 4.20 or later, go to *Ecosystem* -> *Software Catalog*.
====
