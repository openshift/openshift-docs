...
[source,terminal]
----
AA:BB:CC:00:00:00-FD:FF:FF:FF:FF:FF
----
...
[source,yaml]
----
macAddress: AA:BB:CC:00:00:00:01
----
+
If you have successfully applied the configuration changes, the `macAddress` field in the VM interface starts with the prefix you specified in your `macPoolRange`.
