...
[role="_abstract"]
The GitOps Console plugin provides comprehensive details of Argo Rollouts instances in the cluster. You can view and create Rollout resources directly from the {OCP} web console.
