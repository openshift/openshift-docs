...
[role="_abstract"]
The GitOps Console plugin displays details of Argo Rollouts instances in the cluster. You can view and create Rollout resources directly from the OpenShift web console.
