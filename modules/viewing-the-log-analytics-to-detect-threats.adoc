...
[role="_abstract"]
By creating a Microsoft Sentinel integration in {product-title-short} and configuring a schema in Microsoft Sentinel, you can view the log analytics to detect threats.
...
+
--
`TimeGenerated`:: Specifies the timestamp for the alert.
`msg`:: Specifies the message details.
`id`:: Specifies the payload of the message, either alert or audit log.
--
