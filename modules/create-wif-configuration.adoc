...
|{gcp-short} predefined roles and Red Hat custom roles
...
// OSDOCS-21049: Machine API row updated for Milestone-2.
// SME review needed: Confirm iam.serviceAccountUser is scoped to osd-worker
// and osd-control-plane service accounts per managed-cluster-config 4.22.
