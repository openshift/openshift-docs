...
[id="built-for-openshift_{context}"]
== Built for {ocp-product-title}

{SMProductShortName} is built for {ocp-product-title} and integrates with the platform's existing monitoring stack, web console, and security infrastructure.