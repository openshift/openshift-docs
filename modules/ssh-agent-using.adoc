...
// NOTE: CQA Remediation - Extracted from installing-ibm-cloud-customizations.adoc
ifdef::installing-ibm-cloud-customizations[]
.Prerequisites
...
* You configured the `ccoctl` utility before you installed the cluster. For more information, see the {ibm-cloud-name} IAM configuration documentation.
endif::installing-ibm-cloud-customizations[]
