...
Generate a SSH key pair and add it to your `ssh-agent`. Later, you provide the SSH public key to the installation program. These actions are essential for debugging your installation and performing disaster recovery on your cluster.
[NOTE]
====
