...
Generate an SSH key pair and add it to your `ssh-agent`. Later, when you run the installer, provide the SSH public key to the installation program. These actions are essential for debugging your installation and performing disaster recovery on your cluster.
[NOTE]
====
...
following command:
+
// TBD - Consider backing up the keys before you overwrite them.
----
