...
{ocp-product-title} protects log data by using role-based access control (RBAC). To allow the collector to "see" logs, you *must* create `ClusterRoleBindings` that connect your service account to the following predefined roles:
