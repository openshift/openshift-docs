...
* You have set up {gcp-full} service account with a desired role for {gcp-full}DNS. For more information, see link:https://cert-manager.io/docs/configuration/acme/dns01/google/[{gcp-full}DNS] in the upstream cert-manager documentation.
+
[NOTE]
====
