...
[role="_abstract"]
You can use the hub resolver to specify a remote pipeline, task, or `StepAction` definition from a public Tekton catalog on link:https://artifacthub.io/[{artifact-hub}].
