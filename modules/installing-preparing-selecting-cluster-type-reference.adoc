...
:navtitle: a cluster installation type configuration
:chunk-to-content:
[id="installing-preparing-selecting-cluster-type_{context}"]
...
[id="installing-preparing-install-manage_{context}"]
...
[id="installing-preparing-migrate_{context}"]
...
[id="installing-preparing-existing-components_{context}"]
...
[id="installing-preparing-security_{context}"]
...
////
[id="installing-preparing-single-node_{context}"]
