...
=======
The Terraform interface asks four questions to create your cluster, similiar to the following:
...
=======
. Then, the Terraform interface lists the resources to be created or changed and prompts for confirmation. Enter `yes` to proceed or `no` to cancel:
>>>>>>> d33b1bcb23 (POC: Created the general structure for Terraform tutorials)
+
ifdef::tf-rosa-hcp[]
.Example output
