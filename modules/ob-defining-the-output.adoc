...
[role="_abstract"]
Specify an output location to push the image in your `Build` custom resource (CR). When using an external private registry as your output location, you must specify a secret to access the image. You can also specify the annotations and labels for the output image. 
