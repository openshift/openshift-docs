...
[role="_abstract"]
There are specific operational constraints to consider when deploying or removing the {external-secrets-operator}, that may require manual intervention or strict dependency ordering.
