...
1. If the supporting service has its own eventing system configuration, using either the Data Index eventing system or the Jobs Service eventing system configuration, then supporting service configuration takes precedence.
...
4. If none of the previous configurations exist, the supporting service delivers events by direct HTTP calls.