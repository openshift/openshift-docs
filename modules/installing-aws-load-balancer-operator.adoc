...
You can install the AWS Load Balancer Operator from the OperatorHub by using the {product-title} web console. You can also install using the command line.
...
.Installing through OperatorHub
...
You need to create aws-load-balancer-operator namespace: oc new-project aws-load-balancer-operator and the created OperatorGroup and Subscription:
