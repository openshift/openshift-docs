...
[id="ztp-sndu-container-mountspace-configuration_{context}"]
= Container mountspace configuration

To reduce the overall management footprint of the platform, a machine configuration is provided to
contain the mount points.  No customization is required for this configuration. It is configured as follows:
