...
example-compute1.example.com   Ready    worker   13m   v1.35.0+bb8d50a
example-compute2.example.com   Ready    worker   13m   v1.35.0+bb8d50a
example-compute4.example.com   Ready    worker   14m   v1.35.0+bb8d50a
example-control1.example.com   Ready    master   52m   v1.35.0+bb8d50a
example-control2.example.com   Ready    master   55m   v1.35.0+bb8d50a
example-control3.example.com   Ready    master   55m   v1.35.0+bb8d50a
----
