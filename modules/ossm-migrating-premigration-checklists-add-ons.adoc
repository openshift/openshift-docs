...
If you did not disable and configure add on replacements when you upgraded from {SMProduct} 2.5 to {SMProduct} 2.6, you must disable them in your `ServiceMeshControlPlane` resource and configure the add on replacements.
