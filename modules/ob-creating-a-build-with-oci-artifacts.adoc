...
[id="Creating-a-build-with-OCI-artifact_{context}"]
= Creating a build with OCI artifact
...
`<registry_path>/<image_name>:<tag>`:: Specifies with the build location for the container image.
