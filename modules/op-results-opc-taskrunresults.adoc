...
* You have the name or universally unique identifier (UUID) of the task run. You can use the `opc results taskrun list` command to view names or UUIDs of task runs for which results are available.
