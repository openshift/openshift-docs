...
* You have created a service account and assigned the appropriate role-based access controls (RBAC) to install, update, and manage your extension. For more information, see _Creating a service account to manage a cluster extension_.
...
`<service-account>`:: Specifies the name of the service account you created to install, update, and manage your extension.
