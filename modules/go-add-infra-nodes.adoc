...
//
// * upgrade/running-gitops-control-plane-workloads-on-infrastructure-nodes.adoc
...
[role="_abstract"]
Move the {gitops-shortname} control plane workloads installed by the {gitops-title} to the infrastructure nodes. The control plane workloads that you can move include:
