...
[id='efk-logging-exported-fields-aushape-{context}']
= Aushape exported fields

These are the Aushape fields exported by the {product-title} EFK logging system and available for searching
