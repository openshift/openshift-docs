...
+
--
* `<rdma_mode>` specifies the RDMA network namespace mode. Set to `exclusive`.
--
...
+
--
* `<is_rdma>` specifies whether to activate RDMA mode. Set to `true`.
--
...
+
--
* `<plugin_type>` specifies the type of meta plugin. Set to `rdma` to create the RDMA plugin.
--
