...
[source,terminal]
----
$ oc get secrets -n openshift-etcd | grep <unhealthy-node>
----
+
Replace `<unhealthy-node>` with the name of the unhealthy etcd member that you took note of earlier in this procedure.
+
