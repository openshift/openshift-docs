...
.Supported platforms
[cols=".^4s,.^1,.^1,.^1,.^1,.^2",options="header"]
|====
|Platform|Installer-provisioned infrastructure ^[1]^|User-provisioned infrastructure ^[2]^|Agent-Based Installer|Assisted Installer|Notes
