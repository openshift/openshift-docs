...
3. For {rh-openstack-first}: For complete {rh-openstack} release compatibility, see the link:https://access.redhat.com/articles/4679401[{product-title} on OpenStack support matrix].
