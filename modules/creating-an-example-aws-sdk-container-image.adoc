...
[role="_abstract"]
You can create a container image that includes an AWS SDK.

AI:
[role="_abstract"]
To deploy pods that can run AWS SDK operations in your cluster, you can build and publish a custom container image containing an AWS SDK. Hosting this image in a public repository ensures your application dependencies are available for workload deployment.
