...
|String. For example: `quay.io/openshift-community/ubi8/ubi:latest`
endif::[]
...
ifdef::openshift-origin[]
|String. For example: `quay.io/openshift-community/redhat/redhat-operator-index:v{product-version}`.
endif::[]
