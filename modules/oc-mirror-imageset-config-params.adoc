...
|String. For example: `registry.redhat.io/redhat/redhat-operator-index:v4.18`.
...
|String. For example: `fast` or `stable-v4.18`.
...
|String. For example: `stable-4.18`
