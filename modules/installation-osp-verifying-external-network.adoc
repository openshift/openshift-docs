...
// FIXME: Links target RHOSP 13 docs. Update when RHOSO equivalents are available.
...
// FIXME: Links target RHOSP 16.0 docs. Update when RHOSO equivalents are available.
