...
* link:https://cloud.ibm.com/docs/vpc?topic=vpc-quotas[{ibm-cloud-name} quotas and service limits]
* link:https://cloud.ibm.com/docs/vpc?topic=vpc-profiles[{ibm-cloud-name} supported profiles]
