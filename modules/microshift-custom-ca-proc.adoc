...
//Q: is this procedure still valid, or should we use
//https://docs.redhat.com/en/documentation/red_hat_build_of_microshift/4.19/html/configuring/microshift-ingress-controller#microshift-ingress-control-config_microshift-ingress-controller
//and https://docs.redhat.com/en/documentation/red_hat_build_of_microshift/4.19/html/configuring/microshift-ingress-controller#microshift-ingress-controller-create-cert-secret_microshift-ingress-controller
