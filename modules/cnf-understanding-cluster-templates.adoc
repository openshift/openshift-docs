...
Cluster templates define the set of installation artifacts that are generated from the `ClusterInstance` CR.
You can create multiple sets based on the different installation methods or cluster topologies.

The {sco} supports the inclusion of Golang text templates in the object definitions, which allows you to determine how the data from the `ClusterInstance` CR is used to populate fields in the cluster templates.
