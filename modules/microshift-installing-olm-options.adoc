...
= Determine your OLM installation type
...
* See "Installing the Operator Lifecycle Manager (OLM) from an RPM package" and "Adding other packages to a blueprint" for specifics on each installation type.
