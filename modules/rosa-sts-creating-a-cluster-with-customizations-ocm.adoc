...
----
<1> Specify the prefix to include in the OpenShift Cluster Manager role name. The default is `ManagedOpenShift`. You can create only one OpenShift Cluster Manager role per AWS account for your Red Hat organization.
