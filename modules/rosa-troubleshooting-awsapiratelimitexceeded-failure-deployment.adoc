...
= Failing to create a cluster with an `AWSAPIRateLimitExceeded` error
...
[source,terminal]
----
Failed to create cluster: OCM3008 : AWSAPIRateLimitExceeded.
----

This error indicates that the AWS API rate limit has been exceeded waiting for the Route 53 hosted zone.

.Procedure

* To address this issue, reattempt the installation.
