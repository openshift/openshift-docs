...
= Configure Loki to tolerate memberlist creation failure

[role="_abstract"]
Configure the LokiStack CR to use pod IP addresses for memberlist networking in non-private IP network ranges.
