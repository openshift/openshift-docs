...
//how about TLS for ingress control? is that separate? OCP lists the control plane, ingress controller, and kubelet separately, https://docs.openshift.com/container-platform/4.16/security/tls-security-profiles.html#tls-profiles-understanding_tls-security-profiles
