...
[role="_abstract"]
You can start the migration from the OpenShift Software-Defined Networking (SDN) network plugin to the OVN-Kubernetes network plugin by using the {cluster-manager-first} CLI (`ocm`).
