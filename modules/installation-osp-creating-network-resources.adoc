...
[source,yaml]
----
include::https://raw.githubusercontent.com/openshift/installer/release-4.4/upi/openstack/01_security-groups.yaml[]
----
. Insert the following content into a local file that is called `02_network.yaml`
+
[source,yaml]
----
include::https://raw.githubusercontent.com/openshift/installer/release-4.4/upi/openstack/02_network.yaml[]
----
