...
:FeatureName: Technology Preview features in this table
...
[options="header"]
|===
|{gitops-shortname} |Argo CD CLI |Helm |Kustomize |Argo CD |Argo Rollouts |Dex |Argo CD Agent |Argo CD Image Updater |GitOps Promoter |{ocp}

|1.22.0 |3.4.3 GA |4.2.4 GA |5.8.1 GA |3.5.3 GA |1.10.0 GA |2.45.1 GA |0.10.0 GA |1.3.0 GA |0.35.0 TP |4.18-4.22
