...
:navtitle: Access a Windows node using SSH
...
`<username>`:: Specifies the cloud provider username, such as `Administrator` for Amazon Web Services (AWS) or `capi` for Microsoft Azure.
