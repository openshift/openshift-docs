...
--
+
A native abort capability for servicing operations might be planned for a future release.(link:https://issues.redhat.com/browse/OCPBUGS-64846[OCPBUGS-64846])