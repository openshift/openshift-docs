...
[role="_abstract"]
Uninstall {lvms} when it's no longer needed or before upgrading to a different storage solution by using the {product-title} web console after removing all provisioned storage resources.
