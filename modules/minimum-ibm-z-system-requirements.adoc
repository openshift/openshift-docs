...
[IMPORTANT]
====
Installing {product-title} {product-version} on {ibm-name} z17 or {ibm-linuxone-name} 5 requires a minimum kernel version 5.14.0-427.81.1 or later. The basic supported kernel level for {product-title} is 4.16.64 or later, with 4.16.46 as the minimum version supported on {ibm-name} z17.
====
