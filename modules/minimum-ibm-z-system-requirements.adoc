...
[id="minimum-ibm-z-reg-system-requirements_{context}"]
= Minimum {ibm-z-reg} system environment
...
* {ibm-linux-one-reg} 4 (all models), {ibm-linux-one-reg} III (all models), {ibm-linux-one-reg} Emperor II, {ibm-linux-one-reg} Rockhopper II
...
[discrete]
== {ibm-z-reg} network connectivity requirements

To install on {ibm-z-reg} under z/VM, you require a single z/VM virtual NIC in layer 2 mode. You also need:
