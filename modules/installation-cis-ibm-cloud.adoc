...
----
<1> At a minimum, a `Standard Next` plan is required for CIS to manage the cluster subdomain and its DNS records.

[NOTE]
====
After you configure your registrar or DNS provider, it can take up to 24 hours for the changes to take effect.
====
