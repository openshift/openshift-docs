...
. Open the CIS web console, navigate to the *Overview* page, and note your CIS name servers. These name servers will be used in the next step. For more information, see "CIS web console".
