...
* If you create an `ImageDigestMirrorSet` or `ImageContentSourcePolicy` object, the MCO does not drain or reboot the node. 
* If you create an `ImageTagMirrorSet` object, the MCO drains and reboots the node. 
* If you delete an `ImageTagMirrorSet`, `ImageDigestMirrorSet`, or `ImageContentSourcePolicy` object, the MCO drains and reboots the node.  
* If you modify an `ImageTagMirrorSet`, `ImageDigestMirrorSet`, or `ImageContentSourcePolicy` object, the MCO drains and reboots the node.
