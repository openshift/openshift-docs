...
To configure a hardware pin on the Intel E810 NIC, you use the following command format:
[source,terminal]
----
export ETH=enp1s0f0
...
`<connector ID>` is an internal numeric identifier for the physical connector:
