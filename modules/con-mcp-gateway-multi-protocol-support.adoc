...
* The {mcpg} checks this against its connected upstream servers and picks the most recent supported version they both share. If the client and the {mcpg} share a common version, {mcpg} uses the most recent one.
* The {mcpg} presents matching stateless-compatible tools.
...
* The {mcpg} presents stateful-compatible tools.
