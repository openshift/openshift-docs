...
:navtitle: Change namespace exclusions for the default ingress on your cluster in the CLI
...
* You installed the `ocm` CLI and logged in with credentials that can change clusters in {cluster-manager-first}.
