...
.Sample {gcp-full} `providerSpec` values
[source,yaml]
----
...
+
To use a {gcp-full} Marketplace image, specify the offer to use:
+
--
...
<4> Specifies the name of the {gcp-full} project that you use for your cluster.
