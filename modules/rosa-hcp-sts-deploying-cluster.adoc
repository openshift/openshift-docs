...
** Red{nbsp}Hat uses AWS Identity and Access Management (IAM) Security Token Service (STS) to send the required permissions to AWS that allow AWS to create and attach the corresponding AWS-managed Operator policies.
