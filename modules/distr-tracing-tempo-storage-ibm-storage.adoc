...
= Installing the IBM Object Store

You can install the IBM Cloud storage on the command line.

.Prerequisites

* You have installed the latest version of the IBM Cloud Command Line Interface (AWS CLI). For more information, see link:https://cloud.ibm.com/docs/cli?topic=cli-getting-started[Getting started with the IBM Cloud CLI] (IBM Cloud Docs).

* You have installed the latest version of the OpenShift CLI. For more information, see xref:../../../cli_reference/openshift_cli/get_started_cli.adoc#cli-getting-started[Getting started with the OpenShift CLI].
...
* link:https://cloud.ibm.com/docs/cli?topic=cli-getting-started[Getting started with the IBM Cloud CLI] (IBM Cloud Docs)
* xref:../../../cli_reference/openshift_cli/get_started_cli.adoc#cli-getting-started[Getting started with the OpenShift CLI]
