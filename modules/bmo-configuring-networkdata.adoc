...
[id="bmo-configuring-networkdata_{context}"]
= Configuring networkData
...
[NOTE]
====
For the link:https://docs.fedoraproject.org/en-US/fedora-coreos/sysconfig-network-configuration/#_via_ignition[Fedora CoreOS] operating system, use Ignition instead.
====
