...
[role="_abstract"]
To ensure essential communication between your host network pods and the API server, configure the required firewall settings in {product-title}. You must enable the internal pod and service IP ranges to properly route traffic within the node and maintain secure service access.
