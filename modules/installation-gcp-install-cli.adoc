...
= Installing and configuring CLI tools for {gcp-full}

To install {product-title} on {gcp-full} using user-provisioned
infrastructure, you must install and configure the CLI tools for {gcp-full}.
...
+
See link:https://cloud.google.com/sdk/docs/authorizing#authorizing_with_a_service_account[Authorizing with a service account] in the {gcp-full} documentation.
