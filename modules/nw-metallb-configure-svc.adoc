...
spec:
  ...
  - port: 80
    targetPort: 8080
----
<1> Specify the name of the `IPAddressPool` resource. If you do not set this annotation, MetalLB automatically assigns an IP address from any pool that has `autoAssign` set to `true`.
