...
= Workspaces, parameters, and results

[role="_abstract"]
The `buildah-ns` task builds source code into a container image and pushes it to a registry using Buildah. This reference describes the workspace, parameters, and results for the task.
