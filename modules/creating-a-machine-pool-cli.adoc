...
You can create additional machine pools for your {product-title} cluster by using the {product-title} CLI (`rosa`).

.Prerequisites

* You installed and configured the latest {product-title} CLI, (`rosa`), on your workstation.
* You logged in to your Red{nbsp}Hat account using the {product-title} CLI (`rosa`).
