...
. Describe the available machine pools in your cluster:
+
[source,terminal]
----
$ rosa describe machinepools --cluster=<cluster_name>
----
// +
// .Example output
// [source,terminal]
...
[source,terminal]
----
ID             Cluster ID  AUTOSCALING  REPLICAS  INSTANCE TYPE  LABELS  TAINTS  AVAILABILITY ZONES  SUBNET                   SPOT INSTANCES  DISK SIZE  SCHEDULED UPGRADE
Worker         Cluster1    No           3         m5.xlarge                      us-east-1a          subnet-0e3a4046c1c2f1078                            scheduled 4.13.10 on 2023-08-30 08:00 UTC
mymachinepool  Cluster2    Yes          3-6       m5.xlarge                      us-west-2e
----

. Verify that the machine pools are included in the output and the configuration is as expected.
