...
[id="use-remote-pipeline-annotations-with-pipelines-as-code_{context}"]
...
[NOTE]
====
You can reference only one pipeline definition by using the annotation.
====
...
* xref:../integrate/connect-git-repositories-to-trigger-pipeline-automation.adoc#pipelines-as-code-resolver-annotations_connect-git-repositories-to-trigger-pipeline-automation[{pac} resolver annotations]
* xref:../integrate/connect-git-repositories-to-trigger-pipeline-automation.adoc#use-remote-task-annotations-with-pipelines-as-code_connect-git-repositories-to-trigger-pipeline-automation[Remote task annotations]
