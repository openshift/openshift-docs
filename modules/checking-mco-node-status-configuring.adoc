...
[role="_abstract"]
Monitor the progress of the nodes in your cluster and troubleshoot issues during machine configuration pool updates by using command-line tools to query the machine config node custom resource.
