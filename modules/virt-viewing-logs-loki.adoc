...
[role="_abstract"]
You can use the Loki logging component to view aggregated logs for {VirtProductName} pods and containers in the web console. This is useful for troubleshooting issues and monitoring your {VirtProductName} environment.
