...
The following table describes this set of metrics and commands for getting specific logs.
ifndef::openshift-rosa,openshift-dedicated[]
However, the most comprehensive set of logs is available using the `oc adm must-gather` command.
