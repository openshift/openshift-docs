...
.. To enable {product-title}, go to the link:https://console.aws.amazon.com/rosa/[{product-title} service] and select *Enable OpenShift*.
...
. Install the OpenShift CLI (`oc`), version 4.7.9 or greater, from the {rosa-cli}.
