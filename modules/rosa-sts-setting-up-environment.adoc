...
[NOTE]
====
These steps require Go version 1.15 or greater installed on your machine. See link:https://golang.org/dl/[Go Downloads] for more information.
====
+
[source,terminal]
----
...
.Create roles 
After completing these prerequisite steps, you are ready to set up IAM and OIDC access-based roles.
