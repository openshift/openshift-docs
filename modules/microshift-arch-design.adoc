...
[role="_abstract"]
{microshift-short} uses a single-node architecture optimized for edge and low-resource environments. Understanding this design helps you identify which Kubernetes capabilities are available and determine where you can deploy {microshift-short} effectively.
