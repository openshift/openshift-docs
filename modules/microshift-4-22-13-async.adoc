...
= RHBA-2026:xxxx - {microshift-short} 4.22.13 fixed issue update

Issued: 8 September 2026

[role="_abstract"]
{product-title} release 4.22.13 is now available. Fixed issues are listed in the link:https://access.redhat.com/errata/RHBA-2026:xxxx[RHBA-2026:xxxx] advisory. The images that are included in the update are provided by the {OCP} link:https://access.redhat.com/errata/RHSA-2026:63096[RHSA-2026:63096] advisory.
...
[id="microshift-4-22-13-fixed-issues_{context}"]
== Fixed issues
