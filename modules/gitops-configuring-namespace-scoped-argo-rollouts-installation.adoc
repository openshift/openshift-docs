...
//
// * extend/enable-support-for-namespace-scoped-argo-rollouts-installation.adoc
...
[role="_abstract"]
A namespace-scoped Argo Rollouts installation limits Argo Rollouts access to a specific namespace instead of granting cluster-wide permissions.
...
.. Click *Save*.
+
The {gitops-title} Operator helps with the reconciliation of the Argo Rollouts custom resource within a namespace-scoped installation.
