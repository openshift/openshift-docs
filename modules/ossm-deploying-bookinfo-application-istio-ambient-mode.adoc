...
[source,terminal]
----
$ oc apply -n bookinfo -f https://raw.githubusercontent.com/istio/istio/release-1.26/samples/bookinfo/platform/kube/bookinfo.yaml
----
...
[source,terminal]
----
$ oc apply -n bookinfo -f https://raw.githubusercontent.com/istio/istio/release-1.26/samples/bookinfo/platform/kube/bookinfo-versions.yaml
----
...
----
+
You can add the `istio.io/dataplane-mode=ambient` label to individual pods to include specific workloads.
+
[NOTE]
====
