...
[role="_abstract"]
Using your AWS account and the `aws` command-line interface (CLI) tool, you can create an AWS Key Management Service (KMS) encryption key to encrypt your resources.

.Procedure

. Set the AWS region where you installed your virtual private cloud (VPC) by running the following command:
+
[NOTE]
====
