...
= Collector Features
The features currently supported by the collectors vary. These are compared in the tables below. The Vector collector is in development, with additional features forthcoming.
