...
. Run the following command to upload the resource to the namespace where the service is located. It must match the `namespace` field in the Policy resource you just created.
[source,terminal]
----
