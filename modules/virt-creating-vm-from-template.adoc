...
* A focused view, which presents a condensed navigation menu specific to the {VirtProductName} perspective
* A general view, which provides access to the various web console options, including {VirtProductName}

.Procedure

. From the {product-title} web console, choose your view:
** For a focused view, select *Administrator* -> *Virtualization* -> *Catalog*.
+
