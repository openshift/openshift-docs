...
. Click the applicable options in the *Architecture Type* section to filter on templates associated with a particular architecture. This is only available in heterogeneous clusters.
