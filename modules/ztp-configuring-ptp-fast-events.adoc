...
* Extract the contents of the `/home/ztp` folder from the `quay.io/openshift-kni/ztp-site-generator:latest` reference architecture container image, and review the changes.
