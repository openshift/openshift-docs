...
[id="op-use-ssh-authentication-in-git-type-tasks_{context}"]
...
* link:https://github.com/openshift-pipelines/pipelines-examples/blob/main/v1/taskruns/authenticating-git-commands.yaml[authenticating-git-commands.yaml]
