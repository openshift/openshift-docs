...
= Optimize alerting rules for core platform monitoring

[role="_abstract"]
If you customize core platform alerting rules to meet your organization's specific needs, consider the following guidelines to ensure that the custom rules are efficient and effective.
