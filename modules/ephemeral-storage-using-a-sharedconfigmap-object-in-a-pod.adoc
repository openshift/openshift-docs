...
[NOTE]
====
If you are unable to complete the last two prerequisites, the cluster administrator can grant you the required role-based access control (RBAC) to enable the service accounts to use the `SharedConfigMap` CR.
====
