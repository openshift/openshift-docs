...
To access a `SharedConfigMap` CR instance from a pod, you grant a given service account role-based access control (RBAC) permission to use that `SharedConfigMap` CR instance.
