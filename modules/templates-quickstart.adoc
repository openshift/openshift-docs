...
[role="_abstract"]
To browse sample instant-app and quickstart templates on your {product-title} cluster, review the default templates in the `openshift` project. Use these templates to deploy example applications for common languages and frameworks.
