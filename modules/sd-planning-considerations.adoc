...
is 180.
ifdef::openshift-rosa[]
For ROSA with HCP clusters, the limit increases to 500. 
endif::[]
--
...
[NOTE]
====
The maximum number of compute nodes on ROSA is 180. For ROSA with HCP clusters, the limit increases to 500. 
====
...
ifdef::openshift-rosa[]
For ROSA HCP clusters, the compute node limit increases to 500.  
endif::[]
====
