...
= Resolving incorrect AWS credentials issue

The `credentials-velero` file used to create the `Secret` object is incorrectly formatted leading to the following errors:
