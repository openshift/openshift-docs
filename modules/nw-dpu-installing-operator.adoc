...
dpu-operator-controller-manager-0         2/2     Running   0          2m
----

[id="install-operator-web-console_{context}"]
== Web console: Installing the DPU Operator

As a cluster administrator, you can install the DPU Operator using the web console.
