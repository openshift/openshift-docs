...
The following diagram shows how ZTP deploys clusters within a far edge framework.

image::217_OpenShift_Zero_Touch_Provisioning_updates_0222_1.png[ZTP cluster deployment in a far edge framework]
