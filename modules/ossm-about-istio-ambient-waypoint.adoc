...
= Waypoint proxies in Istio ambient mode
...
You can lower resource usage in {SMProductName} by using waypoint proxies to serve many workloads within a shared security boundary, such as a namespace, instead of running a separate proxy for every pod.
