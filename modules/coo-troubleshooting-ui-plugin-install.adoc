...
= Install the troubleshooting UI plugin

[role="_abstract"]
Create the troubleshooting panel UI plugin in the {ocp-product-title} web console to enable correlation-based troubleshooting and signal analysis for the {coo-full}.
