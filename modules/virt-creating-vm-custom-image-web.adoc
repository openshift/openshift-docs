...
ifdef::virt-creating-vms-from-web-images[]
:url:
...
ifdef::virt-creating-vms-from-container-disks[]
:container-disks:
...
ifdef::virt-creating-vms-by-cloning-pvcs[]
:clone:
...
ifdef::virt-creating-vms-from-web-images,virt-creating-vms-from-container-disks[]
[role="_abstract"]
...
// Clear shared local attributes to prevent bleed-through
:title-frag!:
:a-object!:
:object!:
:data-source!:
