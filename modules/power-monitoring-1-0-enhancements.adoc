...
[id="power-monitoring-1-0-enhancements_{context}"]
= Power monitoring 1.0 enhancements

This release of {PM-title} and the {PM-operator}, based on the Kepler Project, includes the following enhancement:
