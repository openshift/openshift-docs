...
[NOTE]
====
{VirtProductName} does not enable groups in the virtual machine tree by default. To enable groups, go to *Virtualization* -> *Settings*. In the *Preview features* tab, select *Enable groups in VirtualMachines tree view*.
====
