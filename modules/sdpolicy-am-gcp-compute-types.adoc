...
{product-title} offers the following worker node types and sizes on Google Cloud that are chosen to have a common DERPEEDOO and memory capacity that are the same as other cloud instance types:
