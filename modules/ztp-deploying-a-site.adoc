...
[NOTE]
====
You require {rhacm-first} version 2.12 or later to install the SiteConfig Operator and use the `ClusterInstance` CR.
====
...
====
//// TODO: Is this wave annotation still relevant?
