...
. Push your changes to your Git repository and the ArgoCD pipeline will detect the changes and begin the site
deployment. The `SiteConfig` and `PolicyGenTemplate` CRs can be pushed simultaneously.
+
The `SiteConfig` CR results in the following CRs created on the hub cluster:
