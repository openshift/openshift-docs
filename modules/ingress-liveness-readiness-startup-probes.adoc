...
[role="_abstract"]
To ensure accurate health monitoring for your router deployments, configure the timeout values for liveness, readiness, and startup probes. By doing this task, you can adjust the default settings used by the {product-title} Ingress Controller to better suit your environment.
