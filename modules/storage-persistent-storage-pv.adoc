...
See link:https://access.redhat.com/documentation/en-us/red_hat_openshift_container_storage/4.4/html-single/managing_openshift_container_storage/index#available-plug-ins_rhocs[Available dynamic provisioning plug-ins] for more information.
| `ceph-rbd` | - | `ceph-fs`
|VMware vSphere | ✅ | - |  -
|===
