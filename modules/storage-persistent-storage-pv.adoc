...
|===
--
1. RWOP uses the SELinux mount feature. This feature is driver dependent, and enabled by default in ODF, AWS EBS, Azure Disk, GCP PD, {ibm-title} VPC Block, Cinder, and vSphere. For third-party drivers, please contact your storage vendor.
--
endif::microshift[]
