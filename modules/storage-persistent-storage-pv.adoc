...
Red Hat OpenShift Container Storage 4.2 provides the following backends for these
access modes:

* ReadWriteOnce: ceph-rbd (block mode)
* ReadWriteMany: cephfs (file mode)

See
link:https://access.redhat.com/documentation/en-us/red_hat_openshift_container_storage/4.2/html-single/managing_openshift_container_storage/index#available-plug-ins_rhocs[Available dynamic provisioning plug-ins] 
