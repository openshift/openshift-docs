...
By default, the Operator creates an Argo CD instance in the `openshift-gitops` namespace. After installation, you can use the {OCP} web console to analyze the default instance configuration. This analysis helps you to customize the behavior of this instance later. This instance is intended for the cluster configuration use case and has elevated privileges. 
...
. Click the name of the default instance to view its details on a new page.
