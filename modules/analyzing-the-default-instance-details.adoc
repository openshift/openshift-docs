...
= Analyze the default Argo CD instance

[role="_abstract"]
By default, the Operator creates an Argo CD instance in the `openshift-gitops` namespace. Use the {OCP} web console to view the **Operator details** page and analyze the default instance configuration.
