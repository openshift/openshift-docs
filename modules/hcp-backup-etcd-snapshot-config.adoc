...
** For {hcp} on {azure-first}, see the requirements and steps in xref:../../hosted_control_planes/hcp-deploy/hcp-deploy-azure.adoc#hcp-azure-etcd-snapshot_hcp-deploy-azure[Backup and restore for {hcp} on {azure-short}].
