...
[role="_abstract"]
Configure a Google identity provider for your {product-title} cluster. Users can log in with their Google credentials after you complete the configuration.
