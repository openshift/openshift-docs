...
| Verify that account and operator roles have been created and are correct. For more information, see _AWS STS and {product-title} explained_ in the _Additional resources_ section.
