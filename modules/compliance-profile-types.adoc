...
[role="_abstract"]
Compliance Operator profiles target either Platform components or Node configurations. Understanding these profile types helps you select the correct profiles to achieve comprehensive compliance coverage for your cluster.
