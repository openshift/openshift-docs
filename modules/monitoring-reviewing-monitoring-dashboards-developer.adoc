...
= Review monitoring dashboards as a developer
...
. In the *Developer* perspective of the {product-title} web console, click *Observe* and go to the *Dashboard* tab.
+
[NOTE]
====
The Observe view in the Developer perspective provides seven tabs for monitoring: *Events*, *Alerting Rules*, *Alerts*, *Dashboard*, *Logs*, *Metrics*, and *Silences*. You can use these tabs to access different monitoring capabilities for your project.
====
