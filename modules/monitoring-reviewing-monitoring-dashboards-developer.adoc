...
[role="_abstract"]
In the *Developer* perspective, review project dashboards to gain insights into your applications by visualizing key metrics and resource data for a selected project.
