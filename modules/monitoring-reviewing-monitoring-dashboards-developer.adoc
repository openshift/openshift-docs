...
[role="_abstract"]
Use dashboards for projects or namespaces to monitor application health and resource consumption. You can see those projects that you have permissions for.
