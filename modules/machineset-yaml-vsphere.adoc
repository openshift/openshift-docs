...
ifndef::infra[]
          dataDisk: <11>
          - name: "<disk_name>"
            provisioningMode: "<mode>" <12>
            sizeGiB: 20
endif::infra[]
ifdef::infra[]
          dataDisk: <12>
          - name: "<disk_name>"
            provisioningMode: "<mode>" <13>
            sizeGiB: 20
endif::infra[]
          diskGiB: 120
...
<11> Specify all data disks to add to the virtual machines.
<12> Specify the provisioning mode to use for the data disk. This value defaults to the vSphere default storage policy if not set. Valid values are "Thin", "Thick", "EagerlyZeroed"
endif::infra[]
ifdef::infra[]
...
<12> Specify all data disks to add to the virtual machines.
<13> Specify the provisioning mode to use for the data disk. This value defaults to the vSphere default storage policy if not set. Valid values are "Thin", "Thick", "EagerlyZeroed"
endif::infra[]
