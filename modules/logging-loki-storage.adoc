...
[role="_abstract"]
The {loki-op} supports AWS S3 and other S3-compatible object stores such as S3 Compatible storage (MinIO, NetApp StorageGRID, and others) and {rh-storage}. Azure, Google Cloud Storage (GCS), and Swift are also supported.
