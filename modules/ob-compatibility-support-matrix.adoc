...
[role="_abstract"]
This matrix shows the compatibility between {builds-shortname} versions, component versions, OpenShift Pipelines, and OpenShift Container Platform. Components are marked as either link:https://access.redhat.com/support/offerings/techpreview[Technology Preview] (TP) or General Availability (GA).
