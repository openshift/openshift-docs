...
= How custom documentation extends {ols-long} answers
...
The Offline Knowledge Portal provides {ocp-product-title} documentation, and {product-rosa} (ROSA) documentation on ROSA clusters. To add knowledge that it does not cover, such as layered products like OpenShift Pipelines (Tekton), OpenShift GitOps, or Red Hat OpenShift Service Mesh, or your own internal documentation, use the BYO Knowledge tool.
