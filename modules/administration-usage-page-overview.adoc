...
Currently secured:: 
CPU units::: The number of Kubernetes CPU units that your {product-title-short} secured clusters uses, as of the latest metrics collection.
Node count::: The number of Kubernetes nodes that {product-title-short} secures, as of the latest metrics collection.
Maximum secured:: 
CPU units::: The maximum number of CPU units that your {product-title-short} secured clusters use, measured hourly and aggregated for the time period that you specified.
Node count::: The maximum number of Kubernetes nodes that {product-title-short} secures, measured hourly and aggregated for the time period that you specified.
