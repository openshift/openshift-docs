...
+
If you do not use `--namespace` and you log in to an {ocp-product-title} cluster, the command creates the descriptor file in the current namespace. If you do not log in to a cluster, the command creates the descriptor file in the default namespace.
...
+
If you do not use `--namespace` and you log in to an {ocp-product-title} cluster, `kn` searches for the service in the subdirectory that matches the current namespace. Otherwise, `kn` searches in the `default/` subdirectory.
