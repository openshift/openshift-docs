...
+
If you do not use `--namespace`, and you are logged in to an {ocp-product-title} cluster, the descriptor file is created in the current namespace. Otherwise, the descriptor file is created in the `default` namespace.
...
+
If you do not use `--namespace`, and you are logged in to an {ocp-product-title} cluster, `kn` searches for the service in the subdirectory that is named after the current namespace. Otherwise, `kn` searches in the `default/` subdirectory.
