...
For an {ibm-cloud-name} IAM overview, see the "{ibm-cloud-name} IAM overview" documentation.
...
2. Optional: This access policy is only required if you want the installation program to create a resource group. For more information about resource groups, see the "{ibm-name} resource groups documentation".
--
