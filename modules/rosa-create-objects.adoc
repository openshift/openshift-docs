...
{product-title} clusters must be in the **Ready** state in order to create an image mirror configuration.
====
...
|The ID of a Capacity Reservation already purchased with AWS.
endif::openshift-rosa-hcp[]
