...
The Whereabouts runs the IP reconciler daily in order to clean up any stranded IP allocations that may result in exhausting IPs and hence prevent new Pods from getting an IP allocated to them.

You may want to change how frequent the IP reconciler runs.

.Procedure

. Create a `ConfigMap` named `whereabouts-config` where you provide a Cron expression. For example, set it to every 15 minutes:
+
[source,terminal]
----
...
. Verify that the `whereabouts-reconciler` daemon set runs the IP reconciler per the desired interval:
+
[source,terminal]
----
$ oc -n openshift-multus logs whereabouts-reconciler-w64hq
2024-01-22T17:03:13Z [debug] event not relevant: "/cron-schedule/..2024_01_22_17_03_13.3355330451": CREATE
2024-01-22T17:03:13Z [debug] event not relevant: "/cron-schedule/..2024_01_22_17_03_13.3355330451": CHMOD
2024-01-22T17:03:13Z [debug] event not relevant: "/cron-schedule/..data_tmp": RENAME
2024-01-22T17:03:13Z [verbose] using expression: */15 * * * *
2024-01-22T17:03:13Z [verbose] configuration updated to file "/cron-schedule/..data". New cron expression: */1 * * * *
2024-01-22T17:03:13Z [verbose] successfully updated CRON configuration id "b9e0888a-e578-4914-a95c-9c38b0a0751f" - new cron expression: */15 * * * *
2024-01-22T17:03:13Z [debug] event not relevant: "/cron-schedule/config": CREATE
2024-01-22T17:03:13Z [debug] event not relevant: "/cron-schedule/..2024_01_22_17_01_54.3931931372": REMOVE

2024-01-22T17:18:00Z [verbose] starting reconciler run
2024-01-22T17:18:00Z [debug] NewReconcileLooper - inferred connection data
2024-01-22T17:18:00Z [debug] listing IP pools
2024-01-22T17:18:00Z [debug] no IP addresses to cleanup
2024-01-22T17:18:00Z [verbose] reconciler success
----
