...
[role="_abstract"]
You can update the cloud provider credential secret when your provider credentials change so that the Cloud Credential Operator can continue managing credentials for cluster components.
