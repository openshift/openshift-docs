...
Cluster introspection features use specific authentication mechanisms managed by the Model Context Protocol (MCP) server rather than standard cluster RBAC.

.Additional resources

* xref:ols-con-authentication-flow-for-cluster-introspection_{context}[Authentication flow for cluster introspection]
