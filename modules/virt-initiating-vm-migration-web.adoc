...
+
* Open the *VM details* of the VM you want to migrate, click the *Actions* menu, hover over the *Migrate* option and select *Compute*.
. In the *Migrate Virtual Machine to a different Node* dialog box, select either the *Automatically Selected Node* or the *Specific Node* option.
. If you selected the *Automatically Selected Node* option, click *Migrate Virtual Machine*.
+
If you selected the *Specific Node* option, choose the required node from the list displayed in the dialog box and click *Migrate Virtual Machine*.
