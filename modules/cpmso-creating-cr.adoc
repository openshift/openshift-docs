...
<4> Specify your cloud provider platform name. The allowed values are `AWS`, `Azure`, and `GCP`.
...
For {vmw-short} clusters, do not specify a `failureDomains` stanza in the `machines_v1beta1_machine_openshift_io` section.
====
