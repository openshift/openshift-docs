...
= Add a real-time kernel to nodes
...
ip-10-0-143-147.us-east-2.compute.internal  Ready   worker   103m  v1.36.3
ip-10-0-146-92.us-east-2.compute.internal   Ready   worker   101m  v1.36.3
