...
[source,terminal]
----
servicemeshoperator.v2.0.2          Red Hat OpenShift Service Mesh     2.0.2-0    servicemeshoperator.v2.0.1.1        Succeeded
----
...
[source,terminal]
----
$ oc edit clusterserviceversion -n openshift-operators servicemeshoperator.v2.0.2 
----
