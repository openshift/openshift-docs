...
<3> Required only for {iibm-cloud-bm-reg} and {ibm-z-reg} images: Operator Registry base image with the tag that matches the target {product-title} cluster major and minor version.
