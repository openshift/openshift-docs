...
* Optionally, you can create and use a `NonAdminBackupStorageLocation` (NABSL) CR to store the backup data. If you do not use a NABSL CR, then backup is stored in the default backup storage location configured in the DPA.
