...
= Query control plane metrics in hosted clusters by using the web console
...
----
+
This query is available on {product-title} 4.22 and later with metrics forwarding enabled.
+
