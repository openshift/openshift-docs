...
+
In the *Virtual memory allocation* field, enter the maximum memory capacity in GiB (gibibytes) permitted for all combined VMs in this project. This measurement excludes pod runtime resource consumption.
