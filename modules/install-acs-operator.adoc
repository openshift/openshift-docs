...
** for *Installed namespace* choose a specific namespace in which to install the Operator. Red Hat recommends installing the {product-title} Operator in the *rhacs-operators* namespace.
** for *Approval strategy* you can choose automatic or manual updates.
+
...
+
If you select manual updates, when a newer version of the Operator is available, OLM creates an update request. As a cluster administrator, you must then manually approve that update request to have the Operator updated to the new version.
