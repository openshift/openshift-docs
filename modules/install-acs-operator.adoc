...
After you installed the Operator into the *rhacs-operator* project, you can install, configure, and deploy the `Central` custom resource (CR) into the `stackrox` project by using the installed Operator.