...
//
// *administer/mcp-gateway-register-virtual-mcp-servers.adoc
...
[role="_abstract"]
When you aggregate all your model context (MCP) servers centrally, you solve for authentication, authorization, and configuration management. At the same time, this aggregation can overwhelm large-language models (LLMs) and AI agents with too many tool and prompt choices.

You can create virtual MCP servers to curate tools and prompts for each situation.
