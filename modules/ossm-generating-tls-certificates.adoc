...
= Generate TLS certificates to secure an ingress gateway

[role="_abstract"]

Generate Transport Layer Security (TLS) certificates and create a secret to secure ingress traffic for a service mesh gateway. This procedure uses sample domain names and the HTTPbin application.
