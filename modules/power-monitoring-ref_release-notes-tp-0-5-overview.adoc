...
This release of power monitoring and the Power Monitoring Operator is supported only on {product-title} 4.17+ and installations using Bare Metal.

//this will likely need to be wordsmithed.
