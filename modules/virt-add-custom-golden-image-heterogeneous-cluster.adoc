...
Adding a custom golden image in a heterogeneous cluster requires the use of the `ssp.kubevirt.io/dict.architectures` annotation in the `annotations` section of the `DataImportCronTemplate` object. This annotation lists the architectures supported by the image.
