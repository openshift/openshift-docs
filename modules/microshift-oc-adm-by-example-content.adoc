...
[role="_abstract"]
You can use the `oc adm` command-line tool to perform administrative tasks on your MicroShift cluster. Use the following commands, along with their descriptions and example usage, to manage and troubleshoot your cluster.

[id="microshift-oc-adm-inspect_{context}"]
== oc adm inspect
...
[id="microshift-oc-adm-release-extract_{context}"]
...
[id="microshift-oc-adm-release-info_{context}"]
== oc adm release info
...
[id="microshift-oc-adm-taint_{context}"]
== oc adm taint
