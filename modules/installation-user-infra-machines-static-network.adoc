...
[discrete]
=== Optional: You can configure the maximum transmission unit (MTU) on a BOND interface by adding `bond0:none:9000` to the `ip=` parameter to specify the MTU, for example: 
