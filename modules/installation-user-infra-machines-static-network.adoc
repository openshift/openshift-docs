...
[source,terminal]
----
bond=bond0:enp1s0,enp2s0:mode=active-backup
ip=10.10.10.2::10.10.10.254:255.255.255.0:core0.example.com:bond0:none ip=enp1s0:none::00:1A:4A:16:01:5A ip=enp2s0:none::00:1A:4A:16:01:5A
----
...
bond=bond0:enp1s0,enp2s0:mode=active-backup
ip=bond0:dhcp
ip=:::::enp1s0:none:00:1A:4A:16:01:5A
ip=:::::enp2s0:none:00:1A:4A:16:01:5A
----
...
[source,terminal]
----
bond=bond0:eno1f0,eno2f0:mode=active-backup,fail_over_mac=0
ip=bond0:dhcp ip=enp1s0:none::00:1A:4A:16:01:5A ip=enp2s0:none::00:1A:4A:16:01:5A
----
