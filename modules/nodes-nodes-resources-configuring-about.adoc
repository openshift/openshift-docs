...
[id='nodes-nodes-resources-configuring-about-{context}']
...
[id='allocate-node-enforcement-{context}']
...
[id='allocate-eviction-thresholds-{context}']
...
[id='allocate-scheduler-policy-{context}']
