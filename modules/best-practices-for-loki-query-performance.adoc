...
//
// * troubleshooting/loki-query-performance-troubleshooting.adoc
...
[role="_abstract"]
Improve the Loki query performance by using the latest operator version, v13 schema, and fast object storage.
...
* If you use the OpenTelemetry Protocol (OTLP) data model, you can configure additional stream labels in LokiStack.
...
* link:https://docs.redhat.com/en/documentation/red_hat_openshift_logging/latest/html/configuring/configuring-the-log-store#best-practices-for-loki-labels_loki-query-performance-troubleshooting[Best practices for Loki labels]
