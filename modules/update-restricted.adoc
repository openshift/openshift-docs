...
[NOTE]
====
If you have xref:../update_service/installing-update-service.adoc#installing-update-service[a local OpenShift Update Service], you can update by using the connected xref:../updating/updating-cluster.adoc#updating-cluster[web console] or xref:../updating/updating-cluster-cli.adoc#updating-cluster-cli[CLI] instructions.

This section explains the update procedure in the absence of an available OpenShift Update Service.
====
