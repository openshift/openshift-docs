...
To install {product-title}, the {gcp-full} account you use must
...
registrar or obtain a new one through {gcp-full} or another source.
+
[NOTE]
====
...
. Create a public hosted zone for your domain or subdomain in your {gcp-full} project. See
...
. If you migrated your root domain to Google Cloud DNS, migrate your DNS records. See link:https://cloud.google.com/dns/docs/migrating[Migrating to Cloud DNS] in the {gcp-full} documentation.
