...
* To verify vNUMA status in a GUI, check if the VM has a *vNUMA* badge in the {product-title} web console. Go to *VirtualMachines* -> *Virtual machines* -> *VirtualMachine details*, and check either the *Overview* or the *Configuration* tabs.
