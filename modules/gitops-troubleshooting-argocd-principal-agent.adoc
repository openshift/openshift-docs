...
You may see the following warning in the Agent pod logs:
...
[WARNING]
====
This setting disables TLS verification and is insecure. Do not use it in production environments.
====
...
You may view the following error in the Argo CD Web UI:
+
[source,terminal]
----
...
----
+
In addition, you may view an error in the Managed or Autonomous Agent pod logs:
+
[source,terminal]
----
