...
[id="ibm-z-reg-network-connectivity_{context}"]
== {ibm-z-reg} network connectivity requirements

To install on {ibm-z-reg} under {op-system-base} KVM, you need:
...
[id="preferred-ibm-z-reg-system-requirements_{context}"]
== Preferred {ibm-z-reg} system environment
