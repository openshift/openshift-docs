...
[IMPORTANT]
====
// TODO: Investigate options for equivalent RHOSO documentation links to replace the RHOSP 16.0 storage guide link.
...
[IMPORTANT]
====
// TODO: Investigate options for whether this RHOSP 17-specific Ceph RGW issue still applies to RHOSO.
...
// TODO: Investigate options for equivalent RHOSO documentation link to replace the RHOSP 16.0 Ceph RGW link.
