...
----
$ oc apply -f ./_<v2_workspace>_/working-dir/cluster-resources/catalogSource-cs-redhat-operator-index.yaml <1>
----
...
spec:
  sourceType: grpc
  image: registry.example.com/redhat/redhat-operator-index:v{ocp-version}
  updateStrategy:
    registryPoll:
      interval: 60m
----
