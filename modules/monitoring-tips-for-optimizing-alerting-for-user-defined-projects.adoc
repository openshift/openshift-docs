...
[id="tips-for-optimizing-alerting-for-user-defined-projects_{context}"]
= Tips for optimizing alerting for user-defined projects

[role="_abstract"]
Optimize alerting for your own projects by considering the following recommendations when creating alerting rules.
