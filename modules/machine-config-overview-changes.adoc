...
[id="machine-config-overview-changes_{context}"]
= What can you change with machine configs?

[role="_abstract"]
You can modify specific files, services, and extensions by using the Machine Config Operator to configure operating system features, kernel settings, and node configurations.
