...
* The customer might not impose {gcp-short} usage restrictions on Red{nbsp}Hat activities. Imposing restrictions severely hinders Red{nbsp}Hat's ability to respond to incidents.
...
* The customer must not use the {gcp-short} account to elevate their permissions within the {product-title} cluster.
