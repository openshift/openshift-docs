...
* After an upgrade, the Operator can delete versioned tasks and step actions earlier than the previous minor release. When you install a new version of {openshift-pipelines} and the versioned tasks or step actions from an earlier version are deleted, pipelines that use the versioned tasks from the earlier version stop working.
|
|===
