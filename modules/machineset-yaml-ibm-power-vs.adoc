...
`rhcos-<infrastructure_id>`:: The custom {op-system-first} image that was used for cluster installation.
`<ibm_power_vs_service_instance_id>`:: The infrastructure ID within your region to place machines on.