...
//
// * machine_management/creating_machinesets/creating-machineset-ibm-power-reg-vs.adoc

:_mod-docs-content-type: REFERENCE
[id="machineset-yaml-ibm-power-reg-vs_{context}"]
= Sample YAML for a compute machine set custom resource on {iibm-cloud-bm-reg} Virtual Server

This sample YAML file defines a compute machine set that runs in a specified {iibm-cloud-bm-reg} Virtual Server zone in a region and creates nodes that are labeled with `node-role.kubernetes.io/<role>: ""`.
