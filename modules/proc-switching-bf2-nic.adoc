...
= Switching Bluefield-2 from DERP mode to NIC mode
...
[IMPORTANT]
====
Currently, only switching Bluefield-2 from DERP to NIC mode is supported. Switching from NIC mode to DERP mode is unsupported.
====
