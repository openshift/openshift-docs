...
On {gcp-full}, AWS, and Azure you can configure the following `endpointPublishingStrategy` fields:
...
For most platforms, the `endpointPublishingStrategy` value can be updated. On {gcp-full}, you can configure the following `endpointPublishingStrategy` fields:
