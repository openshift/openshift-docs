...
[role="_abstract"]
Use the OVS-DPDK performance profile template to configure optimized settings for clusters deployed on OpenStack with Data Plane Development Kit networking.
