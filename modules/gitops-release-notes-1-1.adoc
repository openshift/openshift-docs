...
.GitOps Technology Preview features
[cols="1,1",options="header"]
|===
| {gitops-title} Product | Release
| Argo CD
| GA
...
In addition to the new features, the following sections highlight the fixes and stability improvements in {gitops-title} 1.1:
