...
[role="_abstract"]
You can exchange a valid OpenID Connect (OIDC) identity token for a short-lived {product-title-short}-issued access token by sending a POST request to the API.
