...
//
// getting_started_moa/moa-faq.adoc


[id="moa-faq-installing_{context}"]
= Installation troubleshooting

[id="moa-faq-install-uninstall-logs_{context}"]
...
[source,terminal]
----
$ moactl logs install <my_cluster_name>
----
+
...
[source,terminal]
----
$ moactl logs uninstall <my_cluster_name>
----
+
* To watch the logs, include the `--watch` flag:
+
[source,terminal]
----
$ moactl logs uninstall <my_cluster_name> --watch
----

[id="moa-faq-verify-SCP_{context}"]
...
[id="moa-faq-verify-aws-quota_{context}"]
...
[id="moa-faq-deployment-failures_{context}"]
== Deployment failures
...
[source,terminal]
----
$ moactl describe cluster -c <my_cluster_name> --debug
----
[id="moa-faq-aws-notification-emails_{context}"]
