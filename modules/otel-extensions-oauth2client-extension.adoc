...
Client authentication for the OAuth2Client Extension is configured in a separate section in the `OpenTelemetryCollector` custom resource.
...
The following `OpenTelemetryCollector` custom resource configures client authentication for the OAuth2Client Extension:
