...
[role="_abstract"]
You can upgrade the {ServerlessLogicOperatorName} from version 1.38 to 1.39.0 by performing the following steps.
...
* You have version 1.38 of {ServerlessLogicOperatorName} installed.
...
logic-operator.v1.39.0   OpenShift Serverless Logic Operator   1.39.0    logic-operator.v1.38.0   Succeeded
----
