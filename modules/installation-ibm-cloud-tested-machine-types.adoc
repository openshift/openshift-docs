...
[role="_abstract"]
When installing {product-title} on {ibm-cloud-name}, you can select from a variety of supported instance types depending on the needs of your cluster.
...
[%collapsible]
====
include::https://raw.githubusercontent.com/openshift/installer/release-4.22/docs/user/ibmcloud/tested_instance_types_x86_64.md[]
====