...
See link:https://docs.openshift.com/container-platform/4.18/web_console/adding-user-preferences.html[Adding User Preferences] for more information on changing perspectives.
