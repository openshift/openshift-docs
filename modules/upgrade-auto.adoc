...
= Schedule recurring upgrades for your cluster

[role="_abstract"]
You can use {cluster-manager} to schedule recurring, automatic upgrades for z-stream patch versions for your {product-title} cluster. Recurring upgrades keep your cluster secure and up to date without manual effort.
