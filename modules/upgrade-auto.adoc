...
[IMPORTANT]
====
Before upgrading a Workload Identity Federation (WIF)-enabled {product-title} on {GCP} cluster, you must update the wif-config. For more information, see xref:../upgrading/osd-upgrades#wif-upgrades_osd-upgrades[Cluster upgrades with Workload Identity Federation (WIF)].
====
+
