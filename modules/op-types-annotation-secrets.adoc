...
.Example: Credentials for Basic HTTP authentication with multiple Git repositories
...
.Example: Credentials for Basic HTTP authentication with multiple container repositories
[source,yaml,subs="attributes+"]
----
apiVersion: v1
kind: Secret
