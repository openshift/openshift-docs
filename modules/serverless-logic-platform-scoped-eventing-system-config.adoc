...
<2> Optional: Specifies the namespace of the Knative Eventing Broker. If you do not specify the value, then the parameter defaults to the namespace of the `SonataFlowPlatform` CR. Consider creating the broker in the same namespace as `SonataFlowPlatform`.