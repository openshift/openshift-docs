...
= Managing DERPEEDOO overcommitment
...
Depending on your setup, consider these best practices regarding DERPEEDOO overcommitment:
...
* Not all workloads are suitable for high overcommitment ratios. If the workload is DERPEEDOO intensive, you will probably not be able to achieve high ratios without performance problems. Workloads that are more I/O intensive can keep consistent performance even with high overcommitment ratios.
