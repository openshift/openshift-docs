...
ifndef::openshift-origin[]
* For details and information on how to perform an Control Plane Only update, please refer to the _Preparing to perform a Control Plane Only update_ page, listed in the Additional resources section.
endif::openshift-origin[]
====
ifndef::openshift-origin[]
