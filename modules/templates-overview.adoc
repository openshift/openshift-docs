...
[role="_abstract"]
You can use templates to describe reusable, parameterized object sets that {product-title} processes into resources such as services and `DeploymentConfig` objects. Templates help you deploy the same application structure consistently from the web console or CLI.
