...
[role="_abstract"]
An image registry is a content server that stores and serves container images in {product-title}. You can use registries to access container images from external sources or {product-title}'s integrated registry.
