...
[source,terminal]
----
ifdef::win,localzone,wavelength[]
NAME                                       DESIRED   CURRENT   READY   AVAILABLE   AGE
ifdef::win[]
sample-vplxk-windows-worker-us-east-1a     1         1         1       1           11m
endif::win[]
ifdef::localzone[]
sample-vplxk-edge-us-east-1-nyc-1a         1         1         1       1           11m
endif::localzone[]
ifdef::wavelength[]
sample-vplxk-edge-us-east-1-wl1-nyc-wlz-1  1         1         1       1           11m
endif::wavelength[]
sample-vplxk-worker-us-east-1a             1         1         1       1           55m
sample-vplxk-worker-us-east-1b             1         1         1       1           55m
sample-vplxk-worker-us-east-1c             1         1         1       1           55m
...
sample-vplxk-worker-us-east-1e             0         0                             55m
sample-vplxk-worker-us-east-1f             0         0                             55m
endif::win,localzone,wavelength[]
ifndef::win,localzone,wavelength[]
NAME                             DESIRED   CURRENT   READY   AVAILABLE   AGE
sample-vplxk-infra-us-east-1a    1         1         1       1           11m
sample-vplxk-worker-us-east-1a   1         1         1       1           55m
sample-vplxk-worker-us-east-1b   1         1         1       1           55m
sample-vplxk-worker-us-east-1c   1         1         1       1           55m
sample-vplxk-worker-us-east-1d   0         0                             55m
