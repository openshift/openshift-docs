...
The controlplane is also distributed over the availability zones.
====
...
agl030519-vplxk-infra-germanywestcentral2   1         1         1       1           11m
agl030519-vplxk-infra-germanywestcentral3   1         1         1       1           11m
agl030519-vplxk-worker-germanywestcentra1   1         1         1       1           55m
