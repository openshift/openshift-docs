...
* *Stage*: A conceptually distinct subset of tasks performed in a pipeline. Plug-ins or user interfaces often use this block to display status or progress of tasks.
