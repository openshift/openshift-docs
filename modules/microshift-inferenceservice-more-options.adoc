...
* For complete `InferenceService` specifications, see the link:https://kserve.github.io/website/latest/reference/api/[KServe API Reference](https://kserve.github.io/website/latest/reference/api/).
