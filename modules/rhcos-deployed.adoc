...
= How to deploy {op-system}

[role="_abstract"]
Differences between {op-system} installations for {product-title} are based on whether if you are deploying on an installer-provisioned or user-provisioned infrastructure.
