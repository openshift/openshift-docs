...
[id="bmo-getting-the-baremetalhost-resource_{context}"]
= Getting the BareMetalHost resource

[role="_abstract"]
To review the properties of a physical host, retrieve its `BareMetalHost` resource. Use the {oc-first} to list all hosts or view the detailed specifications of a host in your cluster.
