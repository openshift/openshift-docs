...
The Telemetry service runs automatically and your cluster is registered to {cluster-manager-first}. In {product-title}, remote health reporting is always enabled and you cannot opt out. The Red Hat SRE team requires the information to provide effective support for your {product-title} cluster.
