...
To learn about options for assets you can create when you build and deploy containerized Kubernetes applications in {OCP}, see xref:../architecture/understanding-development.adoc#understanding-development[Understanding {OCP} development].
