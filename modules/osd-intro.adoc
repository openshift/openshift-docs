...
To learn about options for assets you can create when you build and deploy containerized Kubernetes applications in {OCP}, see link:https://access.redhat.com/documentation/en-us/openshift_container_platform/4.6/html/architecture/understanding-development[Understanding OpenShift Container Platform development] in the {OCP} documentation.
...
[id="telemtry_{context}"]
== Internet and Telemtry access for {product-title}
