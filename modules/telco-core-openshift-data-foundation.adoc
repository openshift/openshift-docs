...
* Workload requirements must be scoped before attaching multiple OpenShift clusters to an external {rh-storage} cluster to ensure enough throughput, bandwidth, and performance KPIs.
