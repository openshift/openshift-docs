...
<role>:: Specifies the role you have defined in the machine config file.
<encoded_base64_string>:: Specifies the Base64 encoded string that you have generated in the previous step.
<udev_rules_path>:: Specifies the path where the udev rule is located.
