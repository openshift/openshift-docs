...
[role="_abstract"]
Configure NC-SI and `DisablePowerOff` settings in the `BareMetalHost` resource to support shared NICs between the BMC and host, verified using Redfish or IPMI.
