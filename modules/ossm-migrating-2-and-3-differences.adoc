...
= Differences between OpenShift Service Mesh 2.6 and version 3.2

[role="_abstract"]

If you are a current {SMProductName} user, there are several important differences you need to understand between {SMProduct} 2.6 and {SMProduct} 3.2 before you migrate, including the following:
...
You must be using {SMProduct} 2.6 to migrate to {SMProduct} 3.2.