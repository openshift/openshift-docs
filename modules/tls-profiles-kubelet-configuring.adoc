...
<4> Optional: Specify the machine config pool label for the nodes you want to apply the TLS security profile. For a kubelet config, the role must match the name of the associated machine config pool.
