...
[role="_abstract"]
You can run `network-tools` to retrieve configuration status from logical switches and routers. Executing these diagnostics helps you isolate internal routing loops and troubleshoot active cluster network issues.
