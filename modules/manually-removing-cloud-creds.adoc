...
[role="_abstract"]
To reduce the risk of exposing administrator-level credentials after installation, you can remove the root cloud provider secret from a cluster that uses the Cloud Credential Operator (CCO) in mint mode.
