...
[NOTE]
====
If installation fails or the `State` field does not change to `ready` after 40 minutes, check the FAQ for more details.
====
...
[source, terminal]
----
$ moactl logs install rh-moa-test-cluster1 --watch
----
