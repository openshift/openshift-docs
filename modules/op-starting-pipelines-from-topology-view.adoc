...
. In *Pipeline Runs*, click *Start Last Run* to start a new pipeline run with the same parameters and resources as the earlier one. This option is disabled if you have not initiated a pipeline run. You can also start a pipeline run when you create it.
+
