...
[role="_abstract"]
To ensure that Bare Metal as a Service (BMaaS) can effectively provision and manage your hardware, you must configure your network, bare-metal hosts, cluster privileges, and web server images. Meeting these requirements allows the Metal^3^ API and Bare Metal Operator to communicate with your hosts and deploy images from your web server.
