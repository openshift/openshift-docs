...
and click *Update*.
The *Update Status* changes to `Update to <product-version> in progress`, and you can review the progress of the cluster update by watching the progress bars for the Operators and nodes.
