...
//
// * service-mesh-docs-main/observability/kiali/ossm-console-plugin-assembly.adoc
...
You can install the {SMPlugin} by using the {ocp-short-name} web console.
...
. To use the {SMPluginShort}, refresh the web console.