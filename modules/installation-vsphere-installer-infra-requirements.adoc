...
ifdef::ipi[]
|vSphere vCenter data center
|The installation program creates the folder
|True
|Listed required privileges
endif::ipi[]
...
|vSphere vCenter data center
|Install the object in an existing folder
|False
|`ReadOnly` permission
endif::ipi[]
...
|vSphere vCenter data center
|The installation program creates the virtual machine folder. If your cluster does use the Machine API and you want to set the minimum set of permissions for the API, see the "Minimum permissions for the Machine API" table.
|
[%hardbreaks]
`Folder.Create`
`Folder.Delete`
