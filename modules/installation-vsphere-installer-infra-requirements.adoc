...
The `api.<cluster_name>.<base_domain>` DNS record relates to control plane machines, so you must ensure that all nodes in your installed {product-title} cluster can access these DNS records.
====
