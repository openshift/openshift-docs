...
[role="_abstract"]
The Bidirectional Forwarding Detection (BFD) implementation that Red Hat supports uses FRRouting (FRR) in the `frr-k8s` pods in the `metallb-system` namespace.
