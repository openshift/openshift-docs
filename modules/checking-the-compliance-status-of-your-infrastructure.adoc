...
* After data collection is complete, Central performs checks on the data to determine the results. You can view the results in the compliance dashboard and create compliance reports based on the results.
...
+
To display information on specific standards only, perform the following steps:
