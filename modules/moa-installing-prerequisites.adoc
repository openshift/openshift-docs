...
.. Optional: Rename the executable file you downladed to `moactl`. This documentation uses `moactl` to refer to the executable file. 
...
? Copy the token and paste it here: <my_offline_access_token>
