...
----
+
.. Optional: You can run `moactl completion` command to generate a bash completion file. Add this file to the correct location for your operating system. For example, on a Linux machine run the following command to enable moactl bash completion:
+
[source,terminal]
----
