...
[role="_abstract"]
To free up system resources and avoid unnecessary costs when an environment is no longer needed, you can delete your {product-title} cluster. You can easily perform this complete removal process by using the {rosa-cli-first}.
