...
[role="_abstract"]
If you need to comply with strict government security regulations and data protection standards, you can create a Federal Information Processing Standards (FIPS) enabled hosted cluster.
