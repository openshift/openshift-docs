...
= {aws-short} component secret permissions requirements

[role="_abstract"]
You should familiarize yourself with the permissions required by the {product-title} components. These values are in the `CredentialsRequest` custom resource (CR) for each component.

{product-title} components require the following permissions:
