...
. Log in to the {product-title} web console as a user with the `cluster-admin` role, or if you are using {product-dedicated}, the `dedicated-admin` role.
...
. Log in to the {product-title} CLI as a user with the `cluster-admin` role, or if you are using {product-dedicated}, the `dedicated-admin` role..
+
[source,terminal]
----
