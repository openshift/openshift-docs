...
* The ingress controller also advertises default TLS curves. When the node does not run in FIPS mode, the default curves are `X25519MLKEM768`, `X25519`, `P-256`, `P-384`, and `P-521`. If the node runs in FIPS mode, the curves are `P-256`, `P-384`, and `P-521`. You cannot configure TLS curves in the `config.yaml` file.
