...
* Address capacity warnings promptly as recovery can be difficult in case of storage capacity exhaustion, see link:https://access.redhat.com/documentation/en-us/red_hat_openshift_data_foundation/4.21/html-single/planning_your_deployment/index#capacity_planning[Capacity planning].
