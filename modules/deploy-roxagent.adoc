...
[role="_abstract"]
To use {product-title} ({product-title-short}) to scan virtual machines (VMs), you must run `roxagent`, an executable program. It runs inside VMs, scans for installed packages, and creates index reports.
