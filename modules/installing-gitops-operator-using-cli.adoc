...
where:
+
`name`:: Specifies the specify the channel name from where you want to subscribe the Operator.
`namespace`:: Specifies the specify the name of the Operator to subscribe to.
`channel`:: Specifies the specify the name of the CatalogSource that provides the Operator.
`openshift-marketplace`:: Specifies the namespace of the CatalogSource. Use `openshift-marketplace` for the default OperatorHub CatalogSources.
