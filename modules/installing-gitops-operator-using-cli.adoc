...
[role="_abstract"]
You can install {gitops-title} Operator from the software catalog using the CLI.
...
<4> The namespace of the CatalogSource. Use `openshift-marketplace` for the default software catalog CatalogSources.
+
