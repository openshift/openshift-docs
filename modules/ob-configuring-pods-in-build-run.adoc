...
[role="_abstract"]
Configure pod scheduling and placement for {builds-shortname} builds using optional BuildRun custom resource (CR) fields.

Use the following optional `BuildRun` CR fields to configure {builds-shortname} pods:
