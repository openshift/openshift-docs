...
[id="installation-azure-regions-gov_{context}"]
...
//* `usgoviowa` (US Gov Iowa) //retired 2020.04.30
* `usgovtexas` (US Gov Texas)
* `usgovvirginia` (US Gov Virginia)
//* `` (US Sec Central) //"coming soon"
//* `usseceast` (US Sec East) //"2020"
//* `ussecwest` (US Sec West) //"2020"
