...
For more information, see xref:../secure/rhcl-using-x509-crypt-id-verify.adoc#rhcl-using-x509-crypt-id-verify[Using X.509 cryptographic identity verification].
...
For more information see xref:../secure/mcp-gateway-vault.adoc#mcp-gateway-vault[Using credentials to access external APIs with Vault].
