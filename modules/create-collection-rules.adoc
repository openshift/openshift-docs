...
[role="_abstract"]
Configure collection rules to select resources by deployment names, labels, namespace criteria, or cluster criteria by using exact matches or regular expressions.
