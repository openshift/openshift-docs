...
[IMPORTANT]
====
The `podDisruptionBudget` configuration and automatic PDB generation are supported only for the Data Index service. Any `podDisruptionBudget` configuration defined for the Jobs Service is ignored by the {ServerlessLogicOperatorName}.
====
