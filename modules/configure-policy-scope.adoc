...
====
* *Exclude images*: For policies configured for the build lifecycle stage, you can exclude images from the policy. Select the images that you do not want to trigger a violation for.
+
[NOTE]
====
