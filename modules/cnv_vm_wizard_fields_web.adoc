...
|Name
|
|Name of the virtual machine. The name can contain lower-case letters (`a-z`), numbers (`0-9`), periods (`.`), and hyphens (`-`), up to a maximum of 63 characters. The first and last characters must be a letter or number. The name may not contain spaces or special characters.
