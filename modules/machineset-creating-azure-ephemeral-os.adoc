...
`providerSpec.value.osDisk.diskSettings`:: Enables the use of Ephemeral OS disks.
`providerSpec.value.osDisk.diskSettings.ephemeralStorageLocation`:: Enables the use of Ephemeral OS disks.
`providerSpec.value.osDisk.cachingType`:: Enables the use of Ephemeral OS disks.
