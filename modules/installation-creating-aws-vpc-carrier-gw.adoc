...
<stack_name>:: Specifies the name for the CloudFormation stack. You need the name of this stack if you remove the cluster. For example: `clusterName-vpc-carrier-gw`.
