...
= Configure the {TempoOperator} metrics and alerts

[role="_abstract"]
When installing the {TempoOperator} from the web console, you can select the *Enable Operator recommended cluster monitoring on this Namespace* checkbox, which enables the creation of metrics and alerts for the {TempoOperator}.
