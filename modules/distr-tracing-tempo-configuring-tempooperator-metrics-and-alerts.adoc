...
= Configure {TempoOperator} metrics and alerts

[role="_abstract"]
When you install the {TempoOperator} from the {ocp-product-title} web console, you can select the *Enable Operator recommended cluster monitoring on this Namespace* checkbox, which enables the creation of metrics and alerts for the {TempoOperator}.
...
You can verify successful configuration in the {ocp-product-title} web console:
