...
create a `ClusterLogging` custom resource (CR) to schedule cluster logging pods and other resources necessary
...
You can configure cluster logging by modifying the `ClusterLogging` custom resource (CR), named `instance`.
