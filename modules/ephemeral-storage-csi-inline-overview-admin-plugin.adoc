...
[id="overview-admission-plugin_{context}"]
...
[id="security-profile-enforcement_{context}"]
...
[id="security-profile-warning_{context}"]
...
[id="security-profile-audit_{context}"]
...
[id="admission-plugin-default-behavior_{context}"]
