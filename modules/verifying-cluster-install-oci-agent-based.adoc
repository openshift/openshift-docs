...
authentication {product-version}.0-0    True       False          False      6m18s
baremetal      {product-version}.0-0    True       False          False      2m42s
network        {product-version}.0-0    True       True           False      5m58s  Progressing: …
    …
----
