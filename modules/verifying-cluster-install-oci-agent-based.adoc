...
* You uploaded the agent ISO image to Oracle’s default Object Storage bucket, and you created a compute instance on {oci}. See the "Running a cluster on OCI" section.
