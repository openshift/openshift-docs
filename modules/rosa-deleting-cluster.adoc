...
External ID:                6edf74e6-2abf-43c1-9f41-c8b6e879235b
OpenShift Version:          
Channel Group:              stable
DNS:                        mycluster.23xb.p1.openshiftapps.com
AWS Account:                <aws_account_id>
API URL:                    https://mycluster.23xb.p1.openshiftapps.com:6443
Console URL:                https://console-openshift-console.apps.mycluster.23xb.p1.openshiftapps.com
Region:                     us-east-1
Multi-AZ:                   false
Nodes:
 - Control plane:           3
...
Instance IAM Roles:
 - Control plane:           arn:aws:iam::<aws_account_id>:role/ManagedOpenShift-ControlPlane-Role
