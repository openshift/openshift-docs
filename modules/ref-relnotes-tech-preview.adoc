...
For more information, see xref:../configure/deployment.adoc#con-about-grpc-support_rhcl-config-deploy-gateway-policies[About GRPCRoute policy attachment support].
