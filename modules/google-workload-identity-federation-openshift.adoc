...
.Procedure
. Follow the "Manage workload identity pools" instructions to create a workload identity pool. For example:
+
[source,terminal]
----
...
. Follow the "Manage workload identity pool providers" instructions to create a workload identity pool provider. For example:
+
[source,terminal]
----
