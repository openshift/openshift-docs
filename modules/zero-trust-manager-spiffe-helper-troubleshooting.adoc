...
Confirm your cluster can pull `quay.io/openshift-community/zero-trust-workload-identity-manager/spiffe-helper-rhel9:<version>`. If you use a custom image, verify the registry credentials and image reference in the deployment manifest.
endif::[]
