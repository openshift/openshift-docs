...
If you do not configure LokiStack forwarding for logging information, {tekton-results} does not store this information or provide it via the command-line interface or API.
