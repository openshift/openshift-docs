...
:navtitle: Use skopeo to verify signatures of Red Hat container images
[id="containers-signature-verify-skopeo_{context}"]
= Using skopeo to verify signatures of Red Hat container images

[role="_abstract"]
You can verify the signatures for container images included in an {product-title} release image by pulling those signatures from the {product-title} release mirror site. 
