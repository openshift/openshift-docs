...
[role="_abstract"]
Configure an htpasswd identity provider by using the {cluster-manager} web user interface (UI). Add static user credentials in the console when you configure cluster access without the CLI or a file upload.
