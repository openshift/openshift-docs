...
[id="cluster-compare-create-patch-manually_{context}"]
...
. Create a patch file to match your use case. The following example shows the structure of a patch configuration file:
+
[source,yaml]
----
- apiVersion: v1
