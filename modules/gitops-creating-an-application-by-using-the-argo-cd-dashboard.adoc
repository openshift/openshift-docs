...
//
// * get_started/deploying-a-spring-boot-application-with-argo-cd.adoc
...
= Create app by using Argo CD dashboard

[role="_abstract"]
Use the Argo CD dashboard to create and deploy applications.
