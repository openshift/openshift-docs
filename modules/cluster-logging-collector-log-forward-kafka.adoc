...
<10> Optional. Configure multiple outputs to forward logs to other external log aggregtors of any supported type.
<11> Specify `default` to forward logs to the internal Elasticsearch instance.
