...
. Edit the virtual machine instance configuration file to include the details of the interface and network. If you use the WebUI to create the virtual machine, you must manually edit the YAML configuration to add the `bootOrder` parameter to the disks and interfaces.
