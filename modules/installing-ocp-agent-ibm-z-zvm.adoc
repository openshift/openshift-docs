...
This procedure is necessary only for {ibm-z-name} clusters with with z/VM.
...
+
For more information, see link:https://www.ibm.com/docs/en/zvm/latest?topic=commands-punch[PUNCH] (IBM Documentation).
+
[TIP]
====
...
----
+
For more information, see link:https://www.ibm.com/docs/en/zvm/latest?topic=commands-ipl[IPL] (IBM Documentation).