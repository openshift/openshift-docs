...
[id="nodes-cluster-resource-configure-jdk-{context}"]
...
[id="nodes-cluster-resource-configure-jdk-heap-{context}"]
...
[id="nodes-cluster-resource-configure-jdk-unused-{context}"]
...
specified on the JVM command line. By default, the {product-title} Jenkins
