...
<3> Exposes a specific USB device by Vendor ID and Product ID.
<4> For example, the Product ID for a CH340 serial converter
<5> For example, the Vendor ID for a CH340 serial converter.
<6> Default domain for the GDP.
+
[IMPORTANT]
====
