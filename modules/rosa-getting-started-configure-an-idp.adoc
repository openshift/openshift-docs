...
* link:https://docs.github.com/en/developers/apps/building-oauth-apps[GitHub OAuth apps documentation]
* link:https://access.redhat.com/documentation/en-us/red_hat_openshift_service_on_aws/4/html/installing_accessing_and_deleting_rosa_clusters/rosa-sts-config-identity-providers[Configuring identity providers for STS]
