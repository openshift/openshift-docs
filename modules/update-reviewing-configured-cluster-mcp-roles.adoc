<<<<<<< HEAD:modules/telco-update-reviewing-configured-cluster-mcp-roles.adoc
...
>>>>>>> af0e63c3cd (TELCODOCS-2171#Generalize Day2Ops Lifecycle management):modules/update-reviewing-configured-cluster-mcp-roles.adoc
