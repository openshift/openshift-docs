...
* Review and complete the AWS prerequisites and {product-title} policies.
...
* Configure your AWS account and enable the {product-title} service in your AWS account.
...
[NOTE]
====
This command verifies permissions only for {product-title} clusters that do not use the AWS Security Token Service (STS).
====
