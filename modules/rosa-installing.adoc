...
Install and configure the ROSA CLI (`rosa`). You can also Install the {oc-first} and verify if the required AWS resource quotas are available by using the ROSA CLI.
