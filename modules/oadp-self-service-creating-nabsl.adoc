...
[role="_abstract"]
Create a `NonAdminBackupStorageLocation` (NABSL) custom resource (CR) to define backup storage locations in your authorized namespace. This enables you to store backups in cloud storage that meets your application requirements.
