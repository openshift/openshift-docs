...
----
1. In this example, the `Secret` name is `cloud-credentials`. Specify a cloud key name and the cloud credentials file name. Also, note that the namespace in this example is `test-nac-ns`, which is your authorized namespace.
