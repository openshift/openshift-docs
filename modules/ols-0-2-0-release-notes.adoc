...
* Existing Developer Preview installations of {ols-offical} version 0.1.6 and earlier using the preview Operator Lifecycle Manager channel cannot update to the 0.2.0 Technology Preview version. You must uninstall the existing {ols-long} Operator and then install the new version.
