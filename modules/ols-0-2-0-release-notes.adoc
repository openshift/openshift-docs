...
* Existing Developer Preview installations of {ols-offical} version 0.1.6 and earlier that use the preview {olm} (OLM) channel cannot update to the 0.2.0 Technology Preview version. You must switch the update channel to *alpha* and then install the 0.2.0 Technology Preview version.
