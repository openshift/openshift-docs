...
This release introduces support for the {k8s} traffic distribution feature, part of the {k8s} Service API, within {SMProduct}. As of {product-title} 4.19, this is a Beta feature and requires enabling the `ServiceTrafficDistribution` feature.
