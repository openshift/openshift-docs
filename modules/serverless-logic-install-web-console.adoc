...
You can install the {ServerlessLogicOperatorName} from the OperatorHub by using the {ocp-product-title} web console. Installing this Operator enables you to install and use serverless workflows.
...
+
* The *stable* channel enables installation of the latest stable release of the {ServerlessLogicOperatorName}. The *stable* channel is the default.
