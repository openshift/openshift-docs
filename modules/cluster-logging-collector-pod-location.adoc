...
You can view the logging collector pods and the corresponding nodes that they are running on. The logging collector pods run only in the `openshift-logging` project.

.Procedure

* Run the following command in the `openshift-logging` project to view the logging collector pods and their details:
