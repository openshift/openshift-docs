...
You can view the collector logging collector pods and the corresponding nodes that they are running on. The collector logging collector pods run only in the `openshift-logging` project.

.Procedure

* Run the following command in the `openshift-logging` project to view the collector logging collector pods and their details:
