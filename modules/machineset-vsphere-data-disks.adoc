...
--
// A one liner note is required as below

Note: Changes to MachineSet specifications, such as adding data disks, require scaling the existing MachineSet down to 0 or for new vm in existing machine set scale-up for the changes to take effect.
