...
`customize.envVars.value.name:<NO_PROXY>`:: Specifies the value of the `NO_PROXY` variable. This variable defines which hostnames or IP addresses bypass the proxy server.
--