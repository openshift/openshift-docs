...
+
--
`customize.envVars.value`:: Specifies the value of the `HTTP_PROXY` variable. This is the proxy server used for HTTP connections.
`customize.envVars.value`:: Specifies the value of the `HTTPS_PROXY` variable. This is the proxy server used for HTTPS connections.
`customize.envVars.value`:: Specifies the value of the `NO _PROXY` variable. This variable is used to define the hostname or IP address that should not be accessed through the proxy server.
--