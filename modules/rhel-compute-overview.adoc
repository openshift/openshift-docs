...
* The installation of package-based {op-system-base} has been deprecated. {op-system-base} will be removed in a future release. {op-system} image layering will replace this feature and it supports installing additional packages on the base operating system of your compute nodes.
====