...
The following `OpenTelemetryCollector` custom resource configures the Span Processor to rename a span:
...
The following `OpenTelemetryCollector` custom resource configures the Span Processor to extract attributes from a span name:
...
The following `OpenTelemetryCollector` custom resource configures the Span Processor to change the status:
