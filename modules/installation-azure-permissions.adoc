...
[role="_abstract"]
Before you create the identity for an {product-title} cluster on {azure-short}, verify that your environment meets the role and permission requirements for the identity type you plan to use.
