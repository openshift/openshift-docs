...
Enable a custom Model Context Protocol (MCP) server that you build yourself to expose resources, often proprietary, so that the large language model (LLM) obtains more precise answers to questions. 
