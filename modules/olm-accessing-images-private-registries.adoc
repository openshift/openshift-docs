...
[role="_abstract"]
To install Operators from private registries by using Operator Lifecycle Manager (OLM) in {product-title}, you can create pull secrets and reference them from catalog sources.
