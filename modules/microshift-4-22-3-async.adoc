...
[role="_abstract"]
{product-title} release 4.22.3 is now available. Fixed issues are listed in the link:https://access.redhat.com/errata/RHBA-2026:29956[RHBA-2026:29956] advisory. The images that are included in the update are provided by the {OCP} link:https://access.redhat.com/errata/RHBA-2026:29797[RHBA-2026:29797] advisory.
...
[id="microshift-4-22-3-fixed_issues_{context}"]
== Fixed issues
