...
* Changing only the value of the `machineNamePrefix` parameter does not cause an automatic update for clusters that use the default `RollingUpdate` update strategy.
