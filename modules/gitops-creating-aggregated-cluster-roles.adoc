...
[role="_abstract"]
Aggregated cluster roles let you combine multiple smaller cluster roles into a single role that the Application Controller uses. You create aggregated cluster roles in two stages:
