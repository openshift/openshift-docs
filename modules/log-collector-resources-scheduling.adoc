...
Administrators can modify the resources or scheduling of the collector by configuring the `collector` field in a `ClusterLogForwarder` custom resource (CR).

.Prerequisites

* You have administrator permissions.
* You have installed {clo}.
* You have created a a `ClusterLogForwarder` CR.
