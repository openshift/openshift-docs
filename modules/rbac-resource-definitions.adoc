...
| Create, change, or delete SSO configurations and configured RBAC rules.
...
* Image scanner integrations (create/change/delete)
...
| Add new secured clusters and change or delete existing clusters.
...
| Add, change, and delete integrations and their configurations, and API tokens.
...
| Add, change, or delete resource collections.

| Role
| View existing {product-title} RBAC roles and their permissions.
| Add, change, or delete roles and their permissions.
...
| Approve or deny any pending deferral or false positive requests and move any before approved requests back to observed.

| VulnerabilityManagementRequests
| View all pending deferral or false positive requests for vulnerabilities.
| Request a deferral on a vulnerability, mark it as a false positive, or move a pending or before approved request made by the same user back to observed.
...
| WorkflowAdministration
| View all resource collections.
| Create, change, or delete resource collections.
