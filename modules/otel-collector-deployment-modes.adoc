...
= Choose a Collector deployment mode

[role="_abstract"]
The `OpenTelemetryCollector` custom resource allows you to specify one of these deployment modes for the OpenTelemetry Collector.
