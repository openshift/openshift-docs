...
[role="_abstract"]
Create a `BareMetalHost` resource to register a bare-metal server with the cluster, enabling automated provisioning and lifecycle management through the Bare Metal Operator.
