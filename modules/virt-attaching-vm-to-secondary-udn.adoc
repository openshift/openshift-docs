...
You can connect a virtual machine (VM) to multiple secondary user-defined networks (UDNs) by requesting the pod network attachment, and configuring the interface binding.
