...
By building your containers from Red Hat Universal Base Images (UBI), you are
...
can alert you when an image you are using has vulnerabilities. OpenSCAP image scanning is
available in {op-system-base} and the {rhq-cso} can be added
to check container images used in {product-title}.

[role="_additional-resources"]
.Additional resources
* link:https://access.redhat.com/articles/4238681[Red Hat Universal Base Images (UBI)]
