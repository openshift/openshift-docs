...
You can schedule upgrades for a {rosa-classic} or a {hcp-title} cluster manually either one time or on a recurring schedule by using {cluster-manager} console.
