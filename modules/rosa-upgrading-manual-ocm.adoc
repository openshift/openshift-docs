...
You can schedule upgrades for a R{openshift-rosa} {openshift-rosa-hcp} cluster manually either one time or on a recurring schedule by using {cluster-manager} console.
