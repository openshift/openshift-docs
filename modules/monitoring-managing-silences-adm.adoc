...
[id="managing-silences-adm_{context}"]
= Managing silences

[role="_abstract"]
Create a silence for an alert in the {ocp} web console in the *Administrator* perspective.
After you create a silence, you do not receive notifications about an alert when the alert fires.
