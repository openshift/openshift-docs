...
[role="_abstract"]
You can use the following `05_control_plane.py` Deployment Manager template to deploy the control plane machines that you need for your {product-title} cluster:
