...
// Bare metal
// * installing/installing_bare_metal/ipi-install-installation-workflow.adoc
// * installing/installing_bare_metal/ipi-install-post-installation-configuration.adoc
// OpenStack
