...
[role="_abstract"]
You can enable audit logging for `BaselineAdminNetworkPolicy` custom resources in {product-title} by annotating each policy with the `k8s.ovn.org/acl-logging` key.
