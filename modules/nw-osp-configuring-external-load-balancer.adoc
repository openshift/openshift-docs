...
[role="_abstract"]
Configure a user-managed load balancer such as MetalLB to replace the default load balancer, enabling access to the OpenShift API on TCP ports 6443 and 22623 using your existing load balancing infrastructure or to meet specific networking requirements.
