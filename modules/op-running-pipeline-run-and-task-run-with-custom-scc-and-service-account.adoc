...
[id="op-run-pipeline-run-and-task-run-with-custom-scc-and-service-account_{context}"]
= Run pipeline/task run with custom SCC and SA
...
* link:https://bugzilla.redhat.com/show_bug.cgi?id=1995779[BZ#1995779 - Pod timeouts with pipelines-scc SCC]
