...
[role="_abstract"]
The OpenTelemetry Collector exposes these metrics about the data volumes it has processed.
...
`port`:: Port at which the internal collector metrics are exposed. Defaults to `:8888`.
