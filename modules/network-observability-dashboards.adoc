...
[role="_abstract"]
The network observability dashboards in the {product-title} console provide cluster traffic pattern monitoring, metric filtering, and Network Observability Operator health tracking.
