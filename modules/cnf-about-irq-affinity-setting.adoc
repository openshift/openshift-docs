...
[role="_abstract"]
Some IRQ controllers and hardware drivers lack support for IRQ affinity settings and always expose all online CPUs as the IRQ mask, effectively running on CPU 0.
