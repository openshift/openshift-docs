...
. Click the {ProductName} Operator. In the *Istio Service Mesh Control Plane* column, click the name of your `ServiceMeshControlPlane`, for example `default`.
...
default   9/9     InstallSuccessful   default    v2.0      4m25s
----
