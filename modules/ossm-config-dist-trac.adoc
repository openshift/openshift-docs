...
{ProductName} uses Jaeger to allows developers to visualize call flows in a microservice application. Understanding the sequence of calls, how many calls occur in serial versus how many occur in parallel, and sources of latency is useful when maintaining a distributed system.
