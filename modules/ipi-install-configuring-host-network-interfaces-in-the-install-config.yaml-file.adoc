...
[WARNING]
====
Do not set the unsupported `rotate` option in the DNS resolver settings for your cluster, because the option disrupts the DNS resolution function of the internal API.
====
