...
<13> Specifies the trigger to use as the basis for scaling. For more information, see "Understanding the custom metrics autoscaler triggers".
<14> Optional: Specifies a trigger authentication or a cluster trigger authentication. For more information, see "Understanding the custom metrics autoscaler trigger authentication".
