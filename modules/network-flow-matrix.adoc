...
* `9000-9999`: Host level services. The cluster does not function without these ports.
* `30000-32767`: Kubernetes node ports. These ports are needed if you use node ports.
* `32768–60999`: Dynamic or private ports.
