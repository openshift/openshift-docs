...
[%header,format=csv]
|===
include::snippets/communication-matrix-common-master.csv[]
|===
...
[%header,format=csv]
|===
include::snippets/communication-matrix-common-worker.csv[]
|===
...
[%header,format=csv]
|===
include::snippets/communication-matrix-bm.csv[]
|===
...
[%header,format=csv]
|===
include::snippets/communication-matrix-bm-sno.csv[]
|===
...
[%header,format=csv]
|===
include::snippets/communication-matrix-aws-sno.csv[]
|===
