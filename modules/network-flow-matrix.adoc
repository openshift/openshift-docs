...
[role="_abstract"]
View the network flow matrixes that describe the ingress flows to {product-title} services for certain environments.

These environments are listed as follows:
...
* link:https://raw.githubusercontent.com/openshift-kni/commatrix/release-4.22/docs/stable/raw/bm.csv[{product-title} on bare metal]

* link:https://raw.githubusercontent.com/openshift-kni/commatrix/release-4.22/docs/stable/raw/none-sno.csv[{sno-caps} with other platforms]

* link:https://raw.githubusercontent.com/openshift-kni/commatrix/release-4.22/docs/stable/raw/aws.csv[{product-title} on {aws-short}]

* link:https://raw.githubusercontent.com/openshift-kni/commatrix/release-4.22/docs/stable/raw/aws-sno.csv[{sno-caps} on {aws-short}]
...
[%header,format=csv]
|===
include::https://raw.githubusercontent.com/openshift-kni/commatrix/release-4.22/docs/stable/unique/common-master.csv[]
|===

.Worker node base flows
[%header,format=csv]
|===
include::https://raw.githubusercontent.com/openshift-kni/commatrix/release-4.22/docs/stable/unique/common-worker.csv[]
|===
...
[%header,format=csv]
|===
include::https://raw.githubusercontent.com/openshift-kni/commatrix/release-4.22/docs/stable/unique/bm.csv[]
|===
...
[%header,format=csv]
|===
include::https://raw.githubusercontent.com/openshift-kni/commatrix/release-4.22/docs/stable/unique/none-sno.csv[]
|===
...
[%header,format=csv]
|===
include::https://raw.githubusercontent.com/openshift-kni/commatrix/release-4.22/docs/stable/unique/aws.csv[]
|===
...
[%header,format=csv]
|===
include::https://raw.githubusercontent.com/openshift-kni/commatrix/release-4.22/docs/stable/unique/aws-sno.csv[]
|===
