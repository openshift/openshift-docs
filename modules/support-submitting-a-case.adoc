...
[role="_abstract"]
You can submit a support case to Red Hat when you need help with {ocp-product-title} or {ServerlessLogicProductName} issues. The support case process guides you through providing problem details, diagnostic data, and cluster information to help Red Hat support engineers resolve your issue efficiently.
...
+
* It is also possible to open a new support case through the {ocp-product-title} web console and have your cluster ID autofilled.
