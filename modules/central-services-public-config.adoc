...
== StackRox Scanner
The following table lists the configurable parameters for the StackRox Scanner. Before release 4.8, the StackRox Scanner was the default scanner used for node, platform, and image scanning. Beginning with release 4.8, Scanner V4 is the default scanner. See the next table for Scanner V4 parameters.
...
* `true`: Scanner V4 will not be deployed.

* `false`: Scanner V4 will be deployed.

If no value is specified, the following behavior occurs:

* New installations: Scanner V4 will be deployed.

* Upgrades: Scanner V4 will not be deployed.
