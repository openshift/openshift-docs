...
[discrete]
[id="meaning-virtapiresterrorshigh_{context}"]
== Meaning

More than 5% of REST calls have failed in the `virt-api` pods in the last 60 minutes.

[discrete]
[id="impact-virtapiresterrorshigh_{context}"]
== Impact
...
[discrete]
[id="diagnosis-virtapiresterrorshigh_{context}"]
== Diagnosis
...
[discrete]
[id="mitigation-virtapiresterrorshigh_{context}"]
== Mitigation

Based on the information obtained during the diagnosis procedure, try to identify the root
