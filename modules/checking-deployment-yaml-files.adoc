...
`--verbose`:: Specifies that by enabling the --verbose flag, you receive additional information for each deployment during the policy check, including the RBAC permission level and a comprehensive list of applied network policies.
--
+
