...
//
// * extend/using-cluster-scoped-rollouts-instance-to-manage-rollouts-resources.adoc
...
[role="_abstract"]
To configure which namespaces a cluster-scoped Argo Rollouts instance manages, set the `CLUSTER_SCOPED_ARGO_ROLLOUTS_NAMESPACES` environment variable in the {gitops-title} Operator Subscription to a comma-separated list of namespaces.
