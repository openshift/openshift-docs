...
. Store a test credential at a per-identity Vault path by running the following command:
+
[source,terminal]
----
...
----
+
The path follows the pattern `secret/egress/<namespace>/<service-account-name>`.
