...
//CLI shows: modules/installation-configure-proxy.adoc:217:1:AsciiDocDITA.TaskStep:Content other than a single list cannot be mapped to DITA tasks.
//problem here looks like concept info dropped into the procedure free-form
