...
ifdef::aws-upi,aws-restricted-upi,gcp-upi[]

When the cluster-wide proxy is enabled, you must manually create the Ingress DNS records.

// TODO: xref: https://docs.openshift.com/container-platform/4.2/installing/installing_aws_user_infra/installing-aws-user-infra.html#installation-create-ingress-dns-records_installing-aws-user-infra
endif::aws-upi,aws-restricted-upi,gcp-upi[]
