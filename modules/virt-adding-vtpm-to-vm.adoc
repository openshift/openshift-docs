...
[IMPORTANT]
====
When you add a virtual Trusted Platform Module (vTPM) device to a Windows VM, the BitLocker Drive Encryption system check will pass even if the vTPM device is not persistent.
====
