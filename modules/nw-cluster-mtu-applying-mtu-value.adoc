...
// * installing/installing_aws/aws-compute-edge-zone-tasks.adoc <-- not included
// * installing/installing_aws/ipi/installing-aws-outposts.adoc <-- not included

:_mod-docs-content-type: PROCEDURE
[id="nw-cluster-mtu-applying-mtu-value_{context}"]
= Apply the new hardware MTU value

Use the following procedure to apply the new hardware MTU value.
