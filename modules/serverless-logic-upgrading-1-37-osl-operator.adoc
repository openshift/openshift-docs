...
+
a. Delete the existing Operator subscription by running the following command:
+
[source,terminal]
----
...
====
+
b. Delete the existing `ClusterServiceVersion` (CSV) by running the following command:
+
[source,terminal]
----
...
+
a. Create the following `Subscription` resource:
+
[source,yaml]
----
...
+
a. Query the pending install plan by running the following command:
+
[source,terminal]
----
...
----
+
b. Approve the install plan by running the following command:
+
[source,terminal]
----
