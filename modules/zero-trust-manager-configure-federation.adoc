...
To establish mutual TLS (mTLS) and ensure secure communication, follow this cross-cluster trust exchange process:

. Fetch cluster 1's bundle.

. Fetch cluster 2's bundle.

. Give cluster 1's bundle to cluster 2's bundle so cluster 1 can trust cluster 2.

. Give cluster 2's bundle to cluster 1's bundle so cluster 2 can trust cluster 1.
