...
[role="_abstract"]
{tekton-hub} provided a catalog of prebuilt Tekton tasks and pipelines. This service is deprecated. Use _{artifact-hub}_, a centralized catalog for Tekton resources, instead.
