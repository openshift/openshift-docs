...
The following example displays how to configure the `SonataFlowPlatform` CR for a workflow-scoped outgoing eventing system:

.Example of workflow-scoped outgoing eventing system configuration 
[source,yaml]
----
...
The following example displays how to configure the `SonataFlowPlatform` CR for a workflow-scoped incoming eventing system:
...
.Example of workflow-scoped incoming eventing system configuration 
[source,yaml]
----
apiVersion: sonataflow.org/v1alpha08
kind: SonataFlow
...
<3> Optional: Defaults to the SonataFlow namespace. We recommend creating the Broker in the same namespace as the workflow.
...
<6> Optional: Defaults to the SonataFlow namespace. We recommend creating the Broker in the same namespace as the workflow.
