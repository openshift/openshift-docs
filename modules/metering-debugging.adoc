...
[source,bash]
----
$ kubectl -n openshift-metering logs -f "$(kubectl -n openshift-metering get pods -l app=reporting-operator -o name | cut -c 5-)" -c reporting-operator
----
...
[source,bash]
----
$ kubectl -n openshift-metering exec -it "$(kubectl -n openshift-metering get pods -l app=presto,presto=coordinator -o name | cut -d/ -f2)"  -- /usr/local/bin/presto-cli --server https://presto:8080 --catalog hive --schema default --user root --keystore-path /opt/presto/tls/keystore.pem
----
...
[source,bash]
----
$ kubectl -n openshift-metering exec -it $(kubectl -n openshift-metering get pods -l app=hive,hive=server -o name | cut -d/ -f2) -c hiveserver2 -- beeline -u 'jdbc:hive2://127.0.0.1:10000/default;auth=noSasl'
----
...
[source,bash]
----
$ kubectl -n openshift-metering port-forward hive-server-0 10002
----
...
[source,bash]
----
$ kubectl -n openshift-metering port-forward hdfs-namenode-0 9870
----
...
[source,bash]
----
$ kubectl -n openshift-metering port-forward hdfs-datanode-0 9864
----
...
[source,bash]
----
$ kubectl -n openshift-metering logs $(kubectl -n openshift-metering get pods -l app=metering-operator -o name | cut -d/ -f2) -c ansible
----
...
[source,bash]
----
$ kubectl -n openshift-metering get meteringconfig operator-metering -o json | jq '.status'
----
