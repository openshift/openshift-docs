...
`<interface>`:: Specifies the primary network interface name. An example of a supported value is `bond0`. VLANs, bridges, and bonded links inherit from this primary interface.
+
[IMPORTANT]
====
