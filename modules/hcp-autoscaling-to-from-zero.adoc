...
+
Configure scale-to-zero only on {aws-short} or {azure-short} hosted clusters running {product-title} 4.18 or later with a HyperShift Operator release that includes the backport.
