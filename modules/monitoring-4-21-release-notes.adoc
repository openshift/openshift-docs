...
* link:https://access.redhat.com/errata/RHBA-2026:1481[RHBA-2026:1481]
...
The UTF-8 character support is added for metric and label names::
With this release, support for UTF-8 characters in metric and label names is added to the Prometheus Operator. As a result, you can now use UTF-8 characters in your monitoring configurations without compatibility issues.
