...
[role="_abstract"]
You can combine file path, operations, and process name criteria to create file activity monitoring policies that give you alerts with fewer false positives.
