...
[role="_abstract"]
Create a `DPUServiceCredentialRequest` custom resource and role bindings to enable OVN-Kubernetes DPU service authentication with the management cluster API server.
