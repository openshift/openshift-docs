...
This dashboard provides QPS metrics for sizing decisions. The LokiStack sizing table shows average QPS at 200ms query latency, which corresponds to the query-frontend latency metrics in this dashboard.
