...
* xref:../discover/loki-deployment-sizing.adoc#what-is-qps_loki-deployment-sizing[What is QPS (Queries Per Second)?]
* xref:../discover/loki-deployment-sizing.adoc#calculating-sizing-after-installation_loki-deployment-sizing[Calculating sizing after installation]
* xref:../troubleshoot/loki-query-performance-troubleshooting.adoc#loki-query-performance-troubleshooting[Loki query performance troubleshooting]
