...
= Understand LokiStack dashboards
...
* *Read QPS (queries per second)*: The rate of query requests through the gateway, query front-end, and querier components.
* *Query latency*: The time to run queries at each component (p50, p99, p999 percentiles).
...
This dashboard provides QPS metrics for sizing decisions. The LokiStack sizing table shows average QPS at 200ms query latency, which corresponds to the query front-end latency metrics in this dashboard.
...
* xref:../../plan/size-your-lokistack-deployment.adoc#what-is-qps_size-your-lokistack-deployment[What is QPS (Queries Per Second)?]
* xref:../../plan/size-your-lokistack-deployment.adoc#calculating-sizing-after-installation_size-your-lokistack-deployment[Calculating sizing after installation]
