...
[role="_abstract"]
The Kubernetes Attributes Processor enables automatic attachment of Kubernetes metadata to spans, metrics, and log resource attributes.
...
# ...
----
<1> Optional: Filters which resource objects are cached for metadata extraction, reducing API requests and memory usage.
