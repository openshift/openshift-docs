...
You can either manually create the application namespace on the workload cluster or enable the `createNamespace` field to allow the Agent to create application namespaces automatically when they don't exist.
