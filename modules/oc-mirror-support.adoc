...
[role="_abstract"]
Before you mirror images, verify that your {product-title} version is compatible with the oc-mirror plugin. You can mirror payload images and Operator catalogs for {product-title} versions 4.12 and later.
