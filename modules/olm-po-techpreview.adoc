...
During the Technology Preview release of the platform Operators feature in {product-title} {product-version}, the following restrictions determine whether an Operator can be installed through the platform Operators mechanism:
