...
[role="_abstract"]
If you have AWS Capacity Reservations for an instance type and Availability Zone (AZ), you can apply them to {product-title} worker nodes. On-Demand Capacity Reservations and Capacity Blocks for machine learning (ML) workloads are supported.
