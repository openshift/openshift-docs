...
----
+
Replace `<Encoded <mykey>.private>` with the content of the `b64.private` file. Replace `<Encoded passphrase>` with the content of the `b64.passphrase` file. Replace `<Encoded <mykey>.pub>` with the content of the `b64.pub` file.
