...
name (metadata):: Specify the name for the secret provider class.
namespace:: Specify the namespace for the secret provider class.
provider:: Specify the provider as `azure`.
parameters:: Specify the provider-specific configuration parameters.
...
name (metadata):: Specify the name for the deployment.
namespace:: Specify the namespace for the deployment. This must be the same namespace as the secret provider class.
secretProviderClass:: Specify the name of the secret provider class.
name (nodePublishSecretRef):: Specify the name of the Kubernetes secret that contains the service principal credentials to access Azure Key Vault.
