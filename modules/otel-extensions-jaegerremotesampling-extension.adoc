...
The following `OpenTelemetryCollector` custom resource configures the Jaeger Remote Sampling Extension:
...
The following example shows a Jaeger Remote Sampling strategy file:
