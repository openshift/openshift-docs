...
To maintain compatibility with Kubernetes 1.34, update openshift/coredns on {product-title} {product-version} to version 1.13.1. Some user have previously experienced intermittent DNS resolution issues. Updating openshift/coredns to version 1.13.1 resolves these issues and also includes upstream performance fixes and security patches.
