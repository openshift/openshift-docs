...
* Examine the pod to view detailed information about the pod by using a command similar to the following:
+
[source,terminal]
----
...
Events:
  ...
  ----    ------          ----               ----               -------
# ...
  Normal  Pulling         46s                kubelet            Pulling image "quay.io/crio/artifact:v2" <2>
