...
//
// * observe/mcp-gateway-observe.adoc

:_mod-docs-content-type: PROCEDURE
[id="proc-mcp-gateway-create-telemetry-cr-audit-logs_{context}"]
= Enable the access log on the Gateway pods workload
...
* You created `AuthPolicy` audit CRs for both {mcpg} listeners.
...
----
+
Replace `_<mcp_audit_logging.yaml>_` with the name of your audit logging YAML.
