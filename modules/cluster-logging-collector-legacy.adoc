...
* appName: The APP-NAME part of the syslog-msg header that. It identifies the device or application that originated the message. Must be specified for `RFC5424`.
* msgID: The MSGID part of the syslog-msg header. It identifies the type of message. Must be specified for `RFC5424`.
* procID: The PROCID part of the syslog-msg header. It is the process name or process ID of the syslog application that sent the message. Must be specified for `RFC5424`.
