...
Additionally, you can only switch to the EUS channel when your cluster is running a supported version of {product-title} 4.6.
...
// EUS repositories are available by doing XYZ.
