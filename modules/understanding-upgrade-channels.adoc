...
upgrade channels will never include an upgrade to a 4.3 release. This ensures
...
of {product-title}.
A release candidate is any build (e.g. 4.2.0-rc.3, 4.2.0) that is available in the candidate
channel.
