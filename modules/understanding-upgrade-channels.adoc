...
This update process does not apply for updates coming from the `eus-4.6` channel. Upgrading to the next EUS channel from `eus-4.6` requires a serial set of version updates, from 4.6 to 4.7 to 4.8.
