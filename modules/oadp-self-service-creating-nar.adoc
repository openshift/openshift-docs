...
As a namespace admin user, to restore a backup, you can create a `NonAdminRestore` (NAR) CR. The backup is restored to your authorized namespace.
...
<2> The field `fileSystemPodVolumeRestores` indicates the number of volumes that are restored.
