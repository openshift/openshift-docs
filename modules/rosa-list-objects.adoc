...
Describes the machinepools configured on a cluster.

.Syntax
[source,terminal]
----
$ rosa describe machinepools --cluster=<cluster_name> | <cluster_id> [arguments]
----
...
.Example
Describe all of the machinepools on a cluster named `mycluster`.
[source,terminal]
----
$ rosa describe machinepools --cluster=mycluster
----
