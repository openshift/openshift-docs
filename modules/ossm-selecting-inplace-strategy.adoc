...
= When to use the InPlace strategy
...
Running the {istio} resource in High Availability mode to minimize traffic disruptions requires additional property settings. For more information, see "Istio High Availability (HA) mode".