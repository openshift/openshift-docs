...
image::362_OpenShift_update_duration_0526.png[A diagram displaying the periods during which cluster Operators update themselves during an OpenShift Container Platform update]
...
For more information, see "Understanding how manifests are applied during an update".
====