...
* `spec.persistentVolumeClaimName`: Specifies the name of the source PVC. {lvms} creates a snapshot of this PVC.
* `spec.volumeSnapshotClassName`: Set this field to the name of a volume snapshot class.
+
[NOTE]
====
