...
[role="_abstract"]
Use the AWS CLI to create your AWS secret and configure Identity and Access Management (IAM) access policies and roles to allow your {product-title} workloads to retrieve the secret securely using the Security Token Service (STS).
