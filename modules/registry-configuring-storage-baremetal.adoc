...
ifndef::ibm-z-reg,ibm-power-reg[]
= Configuring registry storage for bare metal and other manual installations
endif::ibm-z-reg,ibm-power-reg[]
ifdef::ibm-z-reg[]
= Configuring registry storage for {ibm-z-reg}
endif::ibm-z-reg[]
ifdef::ibm-power-reg[]
...
* You have a cluster
ifndef::ibm-z-reg,ibm-power-reg[that uses manually-provisioned {op-system-first} nodes, such as bare metal.]
ifdef::ibm-z-reg[on {ibm-z-reg}.]
ifdef::ibm-power-reg[on IBM Power.]
