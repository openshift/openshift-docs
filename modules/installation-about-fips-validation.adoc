...
For more information, see "{op-system-base} core crypto components" in the _Additional resources_ section. For example, when users use SSH to connect to {product-title} clusters and containers, those connections are properly encrypted.
