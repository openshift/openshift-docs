...
//link:https://docs.redhat.com/en/documentation/red_hat_openshift_service_on_aws/4/html/rosa_govcloud/rosa-govcloud-getting-started#rosa-govcloud-getting-started[Getting started with ROSA GovCloud].
//endif::openshift-rosa-hcp[]
//ifdef::openshift-rosa[]
//link:https://docs.redhat.com/en/documentation/red_hat_openshift_service_on_aws_classic_architecture/4/html/rosa_govcloud/rosa-govcloud-getting-started#rosa-govcloud-getting-started[Getting started with ROSA GovCloud].
