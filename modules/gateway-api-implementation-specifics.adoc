...
[role="_abstract"]
The Ingress Operator manages Gateway API custom resource definitions (CRDs) in {product-title} to ensure vendor interoperability. By understanding how these CRDs are managed, you can prevent disrupted workloads and security issues caused by incompatible vendor fields.
