...
= Installing the Knative CLI (`kn`) using the {product-title} web console

Once the {ServerlessOperatorName} is installed, you will see a link to download the `kn` CLI for Linux (x86_64, amd64, s390x, ppc64le), macOS, and Windows from the *Command Line Tools* page in the {product-title} web console.
