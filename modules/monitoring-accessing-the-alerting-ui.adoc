...
[NOTE]
====
In the *Developer* perspective, you can select from core {ocp-product-title} and user-defined projects that you have access to in the *Project* list. However, alerts, silences, and alerting rules relating to core {ocp-product-title} projects are not displayed if you are not logged in as a cluster administrator.
====
