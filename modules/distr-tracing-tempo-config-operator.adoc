...
The following is an example Subscription CR with Operator configuration:
...
The following are the feature gates:
...
The following are the general configuration environment variables:
...
The following are the built-in certificate management environment variables:
...
The following are the controller manager environment variables:
