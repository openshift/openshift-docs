...
[NOTE]
====
If you plan to migrate an {aws-short} machine template that uses this feature to a Machine API compute machine set, you must set the `httpPutResponseHopLimit` and `httpTokens` fields to their default values.
====
