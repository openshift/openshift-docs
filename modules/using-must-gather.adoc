...
[source,terminal,subs="attributes+"]
----
$ oc adm must-gather --image={must-gather-v1-5} -- /usr/bin/gather --request-timeout 15s --skip-tls
----
+
...
. Verify that the Markdown output file is generated at the following location: `must-gather.local.89...054550/quay.io/openshift-community/oadp/oadp-mustgather-rhel9:v1.5-sha256-0...84/clusters/a4...86/oadp-must-gather-summary.md`
endif::[]
