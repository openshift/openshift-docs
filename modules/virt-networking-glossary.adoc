...
UserDefinedNetwork (UDN):: A namespace-scoped CRD introduced by the user-defined network API that tenant owners can use to create a network that isolates their namespace from other namespaces.
