...
* You have a sigstore-supported public key infrastructure (PKI), a link:https://docs.sigstore.dev/cosign/[Cosign public and private key pair], or a bring your own public key infrastructure (BYOPKI) for signing operations.
...
<5> Specifies the policy types that define the root of trust, either a public key, a link:https://docs.sigstore.dev/certificate_authority/overview/[Fulcio certifice], or a BYOPKI. Here, a public key with Rekor verification.
...
<3> Specifies the parameters that define how the images are verified.
<4> Defines a root of trust for the policy.
<5> Specifies the policy types that define the root of trust, either a public key, a link:https://docs.sigstore.dev/certificate_authority/overview/[Fulcio certificate], or a BYOPKI. Here, a Fulcio certificate with required Rekor verification.
...
<3> Specifies the parameters that define how the images are verified.
<4> Defines a root of trust for the policy.
<5> Specifies the policy types that define the root of trust, either a public key, a link:https://docs.sigstore.dev/certificate_authority/overview/[Fulcio certificate], or a BYOPKI. Here, a BYOPKI.
...
* `email`. Specifies the certificate subject email address.
* `hostname`. Specifies the certificate subject hostname. 
