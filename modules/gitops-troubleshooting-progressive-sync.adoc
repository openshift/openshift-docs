...
= Progressive Sync troubleshooting

[role="_abstract"]
When working with Progressive Sync in {gitops-title}, you might encounter issues related to the visibility of the Progressive Sync status panel or application states.
