...
+
Wait for the Cluster Network Operator to detect the modification and redeploy the `kuryr-controller` and `kuryr-cni` pods. This process may take several minutes.
