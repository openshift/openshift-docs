...
+
--
`--identity-name`:: Specifies that the managed identity must have all the permissions for federation.
`--issuer`:: Specifies that the issuer must match the service account token issuer of the {ocp} cluster.
--
+
