...
* You have created a {product-title} cluster with external authentication enabled. For more information, see _Creating a {product-title} cluster that uses external authentication providers_.
