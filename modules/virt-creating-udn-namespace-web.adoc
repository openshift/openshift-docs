...
= Creating a namespace for UserDefinedNetwork (UDN) by using the web console

You can create a namespace to be used with primary UserDefinedNetwork (UDN) by using the {product-title} web console.
