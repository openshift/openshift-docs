...
If you have previously deployed images using the oc-mirror plugin v2, you must delete these images before you mirror images again.
oc-mirror plugin v2 does not automatically prune images that are not included in the Image Set Configuration file.
...
.Example `DeleteImageSetConfig` file
[source,yaml]
----
