...
* link:https://github.com/rhobs/observability-data-model/blob/main/cluster-logging.md[OpenTelemetry attributes for cluster logging] <!--vale RedHat.GitLinks = NO-->
