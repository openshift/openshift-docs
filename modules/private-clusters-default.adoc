...
ifndef::ibm-power-reg-vs-private[]
* Use existing networking that meets your requirements. Your cluster resources might be shared between other clusters on the network.
endif::ibm-power-reg-vs-private[]
ifdef::ibm-power-reg-vs-private[]
* Use existing networking that meets your requirements.
endif::ibm-power-reg-vs-private[]
ifdef::ibm-cloud-private,ibm-power-reg-vs-private[]
...
endif::ibm-cloud-private,ibm-power-reg-vs-private[]
