...
The following bulleted items provide a basic overview of the Workload Identity Federation process:
...
* This workload identity pool is configured to authenticate requests using an Identity Provider (IdP) that the user defines.
