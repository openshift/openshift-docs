...
* For {iibm-cloud-bm-reg}: `quay.io/ibm/operator-registry-ppc64le:release-4.9`
* For {ibm-z-reg} and {ibm-linux-one-reg}: `quay.io/ibm/operator-registry-s390x:release-4.8`
