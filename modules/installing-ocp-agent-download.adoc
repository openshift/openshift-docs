...
= Download the Agent-based Installer

[role="_abstract"]
Download the Agent-based Installer and command-line tools from the Red Hat Hybrid Cloud Console to provision and manage your cluster installation.
...
* link:https://console.redhat.com/openshift/create/datacenter[Red Hat Hybrid Cloud Console - Datacenter]
