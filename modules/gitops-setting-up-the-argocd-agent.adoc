...
//
// * argocd-agent-installation/gitops-setting-up-the-argocd-agent.adoc

:_mod-docs-content-type: PROCEDURE
[id="gitops-setting-up-the-argocd-agent_{context}"]
= Setting up the Argo CD Agent
...
where:
+
`<AGENT_NAME>`:: Assigns a unique name to identify each agent managed by the principal.
