...
:navtitle: Create a VNet in {cp}
[id="installation-creating-azure-vnet_{context}"]
= Creating a VNet in {cp}

[role="_abstract"]
To provide network connectivity for your cluster on Microsoft {cp}, you can create a virtual network (VNet) by using the Azure Resource Manager (ARM) template.
