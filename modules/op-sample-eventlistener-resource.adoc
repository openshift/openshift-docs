...
[role="_abstract"]
This section uses the link:https://github.com/openshift/pipelines-tutorial[pipelines-tutorial] example to show creation of a sample EventListener resource using a secure HTTPS connection.
