...
[role="_abstract"]
Migrate your `br-ex` bridge configuration from the `configure-ovs.sh` shell script to NMState using `MachineConfig` resources to gain declarative, idempotent bridge management and easier configuration updates.
