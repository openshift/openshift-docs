...
* xref:set-up-log-forwarding.adoc#adding-a-drop-filter_{context}[Adding a drop filter]
* xref:set-up-log-forwarding.adoc#adding-a-prune-filter_{context}[Adding a prune filter]
