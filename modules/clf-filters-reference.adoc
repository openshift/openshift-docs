...
* xref:../../configure/configure-log-forwarding.adoc#adding-a-drop-filter_{context}[Adding a drop filter]
* xref:../../configure/configure-log-forwarding.adoc#adding-a-prune-filter_{context}[Adding a prune filter]
