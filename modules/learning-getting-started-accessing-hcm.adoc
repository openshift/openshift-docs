...
[role="_abstract"]
You can access your cluster by using the {hybrid-console-second}, which serves as a primary portal for managing {product-title} environments. Use {hybrid-console-second} to access tools for cluster provisioning, registration, and health monitoring.
