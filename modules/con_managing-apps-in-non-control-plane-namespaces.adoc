...
. xref:../deploy/manage-applications-across-namespaces.adoc#gitops-creating-and-configuring-user-defined-appproject-instance-with-target-namespaces_manage-applications-across-namespaces[Creating and configuring a user-defined `AppProject` instance in the `openshift-gitops` control plane namespace and specify the target namespaces in the `.spec.sourceNamespaces` field of the user-defined `AppProject` instance].
. xref:../deploy/manage-applications-across-namespaces.adoc#gitops-creating-and-configuring-the-app-cr-to-reference-the-target-namespace-and-user-defined-appproject-instance_manage-applications-across-namespaces[Configuring the `metadata.namespace` and `.spec.project` fields of the `Application` CR to reference the target namespaces and user-defined `AppProject` instance].
