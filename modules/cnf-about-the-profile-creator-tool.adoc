...
[role="_abstract"]
Use the Performance Profile Creator tool to process cluster data and generate optimized performance profiles tailored to your hardware, topology, and workload requirements.
...
To generate an optimized performance profile, run the PPC tool and provide configuration arguments tailored to your specific hardware, topology, and use case.
