...
* The `authorino-oauth-client` `Secret` must be applied in the namespace of your {prodname} deployment for the `AuthPolicy` CR to work. Replace `_<kuadrant_system>_` with the namespace of your {prodname} deployment.
