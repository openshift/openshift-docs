...
where:
+
`name`:: Specifies the name of the first Argo CD instance.
`namespace`:: Specifies the namespace used for the first Argo CD instance.
`installationID`:: Specifies the name of the `installationID` object for the first Argo CD instance.
+
...
where:
+
`name`:: Specifies the name of the second Argo CD instance.
`namespace`:: Specifies the namespace used for the second Argo CD instance.
`installationID`:: Specifies the name of the `installationID` object for the second Argo CD instance.
...
where:
+
`name`:: Specifies the name of the first application.
`namespace`:: Specifies the namespace used for the first application.
+
...
where:
+
`name`:: Specifies the name of the second application that is created with the same name as the first application.
`namespace`:: Specifies the namespace used for the second application.
