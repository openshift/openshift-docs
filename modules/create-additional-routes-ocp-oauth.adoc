...
+
--
`<namespace>`:: Specifies the name of the project that contains the Central custom resource.
`<custom-resource>`:: Specifies the name of the Central custom resource.
--
