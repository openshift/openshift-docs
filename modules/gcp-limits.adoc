...
[role="_abstract"]
The {product-title} cluster uses several {gcp-first} components, but the default quotas do not affect your ability to install an {product-title} cluster. For more information about the default quotas, see "View and manage quotas" in the __Additional resources__.
...
You can increase resource quotas from the *Quotas & System Limits* page in the {gcp-short} console, linked in the __Additional resources__, but you might need to file a support ticket. Be sure to plan your cluster size early so that you can allow time to resolve the support ticket before you install your {product-title} cluster.

[role="_additional-resources"]
.Additional resources
* link:https://docs.cloud.google.com/docs/quotas/view-manage[View and manage quotas]
* link:https://console.cloud.google.com/iam-admin/quotas[Quotas & System Limits in the {gcp-short} console]
