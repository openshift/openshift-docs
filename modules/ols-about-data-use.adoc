...
By using the {ols-long} service, you agree that Red{nbsp}Hat may use all of the messages that you exchange with the LLM provider for any purpose. The transcript recording data uses the back end of the Red{nbsp}Hat{nbsp}Insights system, and is subject to the same access restrictions and other security policies. 

You may email mailto:openshift-lightspeed-alpha@redhat.com[Red Hat] and request that your data be deleted.