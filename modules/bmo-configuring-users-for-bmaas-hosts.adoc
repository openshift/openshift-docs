...
[role="_abstract"]
Configure bare-metal host users with SSH authorized keys and sudo privileges in the user data configuration to establish SSH access and administrative accounts during host provisioning, enabling remote management and troubleshooting.
