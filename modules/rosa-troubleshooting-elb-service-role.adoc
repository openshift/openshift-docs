...
= Creating the Elastic Load Balancer (ELB) service-linked role

If you have not created a load balancer in your AWS account, it is possible that the service-linked role for Elastic Load Balancer (ELB) might not exist yet. You may receive the following error:
