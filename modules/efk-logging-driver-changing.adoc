...
[id='efk-logging-driver-changing_{context}']
= Changing the cluster logging driver

For cluster logging, you should use the *json-file* driver. If your cluster is using the *journald* driver and want to use cluster logging,
...
----
+
... For each node, delete the Fluentd pods:
+
----
$ oc delete pod logging-fluentd-v3.6.173.0.21
----
+
