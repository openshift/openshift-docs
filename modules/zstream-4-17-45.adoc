...
{product-title} release {product-version}.45 is now available. The list of fixed issues that are included in the update is documented in the link:https://access.redhat.com/errata/RHBA-2025:22266[RHBA-2025:22266] advisory. The RPM packages that are included in the update are provided by the link:https://access.redhat.com/errata/RHBA-2025:22264[RHBA-2025:22264] advisory.
