...
[role="_abstract"]
The Machine Config Operator uses the node drain and reboot process to apply new configuration changes across your cluster while maintaining workload availability.
