...
[role="_abstract"]
You can use environment variables in your `BuildRun` custom resource (CR) based on your needs. The following example shows how to define environment variables:
