...
[role="_abstract"]
Using the {ocp-product-title} web console provides a streamlined and intuitive user interface to create a trigger. After installing the Knative Eventing on your cluster and you have created a broker, you can create a trigger by using the web console.
