...
*Assigning values to parameters in a `Build` custom resource*
...
*Creating a `ConfigMap` to control a parameter centrally*
...
*Assigning value to a parameter of the type `array` in a `Build` CR*
...
*Referencing a secret in a `Build` CR*
