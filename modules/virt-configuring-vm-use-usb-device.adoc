...
* You have attached the required USB device as a resource at the cluster level. For instructions, see xref:virt-enabling-usb-host-passthrough.adoc#virt-enabling-usb-host-passthrough[Enabling USB host passthrough].
