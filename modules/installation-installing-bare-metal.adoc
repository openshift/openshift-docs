...
+
----
$ ./openshift-install --dir=/root/manual_installation/installation_directory wait-for bootstrap-complete \
    --log-level=info
INFO Waiting up to 30m0s for the Kubernetes API at https://api.m3559ocp.lnxne.boe:6443...
INFO API v1.16.2 up
