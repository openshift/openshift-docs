...
:navtitle: Record the subscription and tenant IDs
[id="installation-azure-subscription-tenant-id_{context}"]
= Recording the subscription and tenant IDs

[role="_abstract"]
To record the subscription and tenant IDs that the installation program requires for your {azure-short} account, you can use the {azure-short} CLI.
