...
[role="_abstract"]
You must have an AWS Virtual Private Cloud (VPC) to create a {product-title} cluster. You can create a VPC by using the {rosa-cli}, or you can manually create the VPC resources in the AWS console.
