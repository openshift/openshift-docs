...
[NOTE]
====
If a cluster administrator removes all chart repositories then the user cannot view the Helm option in the *+Add* view, *Developer Catalog*, and left navigation panel.
====
