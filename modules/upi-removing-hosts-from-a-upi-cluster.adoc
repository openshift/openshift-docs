...
[NOTE]
====
You can run this step without running the previous step. It might take some time for the `BareMetalHost` state to change from `deprovisioning` to `available`. 
====
