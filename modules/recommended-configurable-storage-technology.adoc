...
* The storage technology must ensure read-after-write consistency. File storage is
not recommended for {product-title} registry cluster deployment with production
workloads.
