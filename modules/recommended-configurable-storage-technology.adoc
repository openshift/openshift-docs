...
* Red Hat OpenShift Data Foundation (ODF), Amazon Simple Storage Service (Amazon S3), {gcp-full} Storage (GCS), Microsoft Azure Blob Storage, and OpenStack Swift are supported.
