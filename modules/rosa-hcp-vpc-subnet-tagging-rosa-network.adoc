...
[role="_abstract"]
Before you can use your virtual private cloud (VPC) to create a {product-title} cluster, you must tag your VPC subnets. Automated service preflight checks verify that these resources are tagged correctly.
