...
= {oadp-short} VMDP configuration

[role="_abstract"]
Review the environment variables and file locations for the {oadp-short} VM data protection (VMDP) CLI. This helps you to configure credentials, logging, and behavioral settings.
