...
WARNING Making control-plane schedulable by setting MastersSchedulable to true for Scheduler cluster settings <1>
----
+
<1> Because you create your own compute machines later in the installation process,
