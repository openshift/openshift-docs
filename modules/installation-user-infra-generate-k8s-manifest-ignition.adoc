...
ifdef::baremetal,baremetal-restricted,ibm-z-reg,ibm-power-reg,three-node-cluster[]
+
[WARNING]
====
...
====
endif::baremetal,baremetal-restricted,ibm-z-reg,ibm-power-reg,three-node-cluster[]
