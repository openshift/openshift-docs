...
central=registry.redhat.io/advanced-cluster-security/rhacs-main-rhel9:{rhacs-version}
----
...
central-db=registry.redhat.io/advanced-cluster-security/rhacs-central-db-rhel9:{rhacs-version} \
init-db=registry.redhat.io/advanced-cluster-security/rhacs-central-db-rhel9:{rhacs-version}
----
...
manager=registry.redhat.io/advanced-cluster-security/rhacs-main-rhel9:{rhacs-version}
----
