...
= Installing OpenShift Logging and {es-op}s
...
[NOTE]
====
The OpenShift Logging solution requires that you install both the {clo} and {es-op}. When you deploy an instance
of the {clo}, it also deploys an instance of the {es-op}.
====
...
.. Ensure that *Red Hat OpenShift Logging* and the *{es-op}* are listed in the *openshift-logging* project with a *Status* of *InstallSucceeded*.
+
[NOTE]
====
