...
:navtitle: {red-hat-lightspeed} Advisor for {product-title}
[id="insights-operator-advisor-overview_{context}"]
= About {red-hat-lightspeed} Advisor for {product-title}

[role="_abstract"]
You can use the {red-hat-lightspeed} advisor service to assess and monitor the health of your {product-title} clusters. 
