...
If the cluster has the Deployment Validation Operator installed the recommendations also highlight workloads whose configuration could lead to cluster health issues.

The results of the Insights analysis are available in the Insights Advisor service on {hybrid-console}. In the Console, you can perform the following actions:


* See clusters and workloads affected by specific recommendations.
