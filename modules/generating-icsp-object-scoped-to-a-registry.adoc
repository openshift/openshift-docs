...
+
--
<local_registry>:: is the fully qualified domain name (FQDN) for the local registry you have configured for your disconnected cluster, for example, `local.registry:5000`.
