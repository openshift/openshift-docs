...
`data.runtime_config.yaml.networking.externalIps.enabled`:: Specifies whether to enable or disable external IPs for networking. You can set this parameter to `ENABLED` or `DISABLED`.
