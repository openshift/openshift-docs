...
= Switching or reverting the management service for security groups

[role="_abstract"]
You can switch an existing NLB from a CCM-managed security group to a BYO security group.
Alternatively, you can revert from a BYO security group back to a CCM-managed security group.
