...
* You have created your OpenShift Cluster Manager role and user role.

.Procedure

To associate an additional AWS account, first create a profile in your local AWS configuration. Then, associate the account with your Red Hat organization by creating the OpenShift Cluster Manager, user, and account roles in the additional AWS account.
