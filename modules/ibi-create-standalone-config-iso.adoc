...
[NOTE]
====
For more information about the specifications for the `image-based-config.yaml` manifest, see the section _Reference specifications for the image-based-config.yaml manifest_.
====
...
sshKey: 'ssh-rsa AAAAB3…REDACTED…'
----
