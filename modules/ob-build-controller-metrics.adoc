...
[role="_abstract"]
Build controller metrics expose the internal state and activity of the build controller in OpenShift.

[IMPORTANT]
====
Red{nbsp}Hat does not provide support for the build controller metrics.
====
