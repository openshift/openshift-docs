...
{product-title} Identity and Access Management (IAM) Security Token Service (STS) policies grant the cluster's automation software limited, short-term access to resources in your AWS account.
