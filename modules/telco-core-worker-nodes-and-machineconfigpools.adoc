...
Consider the following engineering considerations regarding MCPs before beginning initial deployment:
...
**Planning your MCP labeling strategy:** Plan your MCP labeling with an appropriate strategy to split your worker nodes depending on parameters
such as:
