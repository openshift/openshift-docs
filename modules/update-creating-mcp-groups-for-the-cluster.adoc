<<<<<<< HEAD:modules/telco-update-creating-mcp-groups-for-the-cluster.adoc
...
>>>>>>> af0e63c3cd (TELCODOCS-2171#Generalize Day2Ops Lifecycle management):modules/update-creating-mcp-groups-for-the-cluster.adoc
