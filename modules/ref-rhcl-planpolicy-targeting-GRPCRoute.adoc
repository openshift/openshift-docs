...
[id="ref-rhcl-deploying-authpolicy-targeting-GRPCroutes_{context}"]
= Targeting a GRPCRoute in a PlanPolicy
...
.Example enforcement of plan-based rate limits on GRPCRoute traffic 
