...
----
+
.. Create the objects using the following commans:
+
[source, terminal]
----
...
+
For the `RevisionBased` strategy, you need to specify all the istio revisions to your link:https://github.com/cert-manager/istio-csr/tree/main/deploy/charts/istio-csr#appistiorevisions0--string[`istio-csr` deployment].
+
