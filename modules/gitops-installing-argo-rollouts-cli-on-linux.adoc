...
`BuildDate`:: Specifies the version of the Go language used for building the Argo Rollouts binary.
`GitCommit`:: Specifies the platform used for building the Argo Rollouts binary.