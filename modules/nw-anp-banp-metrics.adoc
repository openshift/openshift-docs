...
[role="_abstract"]
You can use the following OVN-Kubernetes metrics in {product-title} to monitor `AdminNetworkPolicy` and `BaselineAdminNetworkPolicy` resource counts, rules by direction and action, and northbound database objects.
