...
ifndef::outposts[<stack_name>:: Specifies the name for the CloudFormation stack. You need the name of this stack if you remove the cluster. For example: `cluster-wl-<local_zone_shortname>` for Local Zones and `cluster-wl-<wavelength_zone_shortname>` for Wavelength Zones.]
ifdef::outposts[<stack_name>:: Specifies the name for the CloudFormation stack. You need the name of this stack if you remove the cluster. For example: `cluster-<outpost_name>`.]
