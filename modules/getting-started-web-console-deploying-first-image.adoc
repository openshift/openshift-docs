...
// TODO: best way? + button on top right only way  i found. Pinged Robb Hamilton to check
// . From the *+Add* view in the *Developer* perspective, click *Container images* to open a dialog.
. From the quick create (+) dropdown in the upper right corner, click *Container images*.
...
. In the *Name* field, ensure the value is `parksmap`.
