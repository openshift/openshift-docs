...
[IMPORTANT]
====
If you set `baselineCapabilitySet` to `None`, you must explicitly enable the Ingress capability feature, because installation of a cluster fails if Ingress capability is disabled.
====
endif::cluster-caps[]
