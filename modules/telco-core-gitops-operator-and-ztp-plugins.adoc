...
This enables deploying and managing multiple versions of the {product-title} platform and configuration versions to clusters simultaneously and through upgrades.
