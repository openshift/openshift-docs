...
* You have access to a {hcp-title} cluster with external authentication enabled. For more information, see _Creating a {hcp-title} cluster with direct authentication with an external OIDC identity provider_.
