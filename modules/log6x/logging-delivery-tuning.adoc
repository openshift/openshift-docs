...
//TO-FIX: Does this admonition need to go?
[IMPORTANT]
====
...
[options="header"]
|===
|Compression algorithm |Splunk |Amazon Cloudwatch |LokiStack |Apache Kafka |HTTP |Syslog |Google Cloud |Microsoft Azure Monitoring
