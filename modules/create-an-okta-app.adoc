...
*** Red{nbsp}Hat recommends using the email attribute:
**** *Name:* email
**** *Format:* Unspecified
**** *Value:* user.email
...
. Click *Finish*.
+
After the configuration is complete, the system redirects you to the *Sign On* settings page for the new app.
A highlighted box has links to the information that you need to configure {product-title}.
+
