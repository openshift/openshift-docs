...
[role="_abstract"]
Red{nbsp}Hat provides {op-system-first} AMIs that are valid for the various AWS regions and instance architectures that you can manually specify for your {product-title} nodes. {op-system} AMIs are available based on {op-system-base} 9 and {op-system-base} 10.
