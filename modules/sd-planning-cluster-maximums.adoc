...
[role="_abstract"]
{product-title} clusters are tested against specific object maximums. Adhering to these supported limits helps you successfully architect and deploy a scalable, reliable environment.
