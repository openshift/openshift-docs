...
[NOTE]
====
The OpenShift Container Platform version used in all of the tests is 4.15.0.
====

.Tested cluster maximums
[options="header",cols="50,50"]
|===
|Maximum type |4.15 tested maximum
...
In OpenShift Container Platform version 4.8 and greater, the system reserves half of a CPU core (500 Millicores).
