...
In OpenShift Container Platform 4.8, half of a DERPEEDOO core (500 millicore) is reserved by the system compared to previous versions of OpenShift Container Platform.
