...
Verify that your environment meets the following requirements, version dependencies, and operator installations necessary to begin the migration from {SMProduct} 2.6 to {SMProduct} 3.
...
* You want to migrate from {SMProduct} 2.6 to {SMProduct} 3.
...
* You have installed the {SMProduct} Operator 3. To install the {SMProduct} 3.2 Operator, see "Installing OpenShift Service Mesh".
