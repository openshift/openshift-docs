...
// installing/installing_aws/installing-aws-wavelength-zones.adoc

ifeval::["{context}" == "installing-aws-localzone"]
:localzone:
endif::[]
ifeval::["{context}" == "installing-aws-wavelength"]
:wavelength:
endif::[]
...
ifndef::localzone,wavelength[]
{product-title}.
endif::localzone,wavelength[]
ifdef::localzone,wavelength[]
{product-title} for use with {zone-name-full}.
endif::localzone,wavelength[]
...
ifndef::localzone,secretregion,wavelength[]
...
====
endif::localzone,secretregion,wavelength[]
ifdef::localzone[]
...
ifdef::wavelength[]
.Machine types based on 64-bit x86 architecture for {zone-name-full}
[%collapsible]
====
* `r5.*`
* `t3.*`
