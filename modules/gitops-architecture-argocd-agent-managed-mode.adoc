...
The Applications are mapped to the workload clusters using:

* *Namespace-based mapping (default)*: The application namespace on the control plane determines which Agent handles it.
