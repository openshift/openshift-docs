...
.  After applying the MachineConfig, verify that the changes have been applied to the target node specified by <node_role> in the MachineConfig YAML by the following this procedure: 
