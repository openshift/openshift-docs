...
* You have a Red Hat subscription that includes {op-system-rt-kernel}. For example, your host machine is registered and {op-system-base-full} ({op-system-base}) is attached to a {op-system-base} for Real Time subscription.
