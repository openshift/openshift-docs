...
[NOTE]
====
{product-title} version {product-version} does not support VMware vSphere version 8.0.
====
...
|vSphere 6.5U3 or vSphere 6.7U2+ are required for {product-title}. For more information about the compatibility of NSX and {product-title}, see the Release Notes section of VMware's link:https://docs.vmware.com/en/VMware-NSX-Container-Plugin/index.html[NSX container plugin documentation].
endif::vmc[]
|===
