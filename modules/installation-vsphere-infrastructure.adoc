...
[IMPORTANT]
====
Ensure that the option stealclock.enable is set to true i.e stealclock.enable = "TRUE" within the VMware management software for control-planes and for the nodes running router pods.  
====
