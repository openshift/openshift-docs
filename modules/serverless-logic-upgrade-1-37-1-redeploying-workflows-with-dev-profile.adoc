...
[id="serverless-logic-upgrade-1-37-1-redeploying-workflows-with-dev-profile_{context}"]
= Redeploying workflows with the dev profile

[role="_abstract"]
After upgrading the {ServerlessLogicOperatorName} to version 1.37.1, you must redeploy workflows that use the `dev` profile to complete the upgrade process.
