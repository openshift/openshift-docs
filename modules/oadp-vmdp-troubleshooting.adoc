...
= Troubleshooting {oadp-short} VMDP

[role="_abstract"]
Troubleshoot common issues and solutions for the {oadp-short} VMDP CLI. This helps you to resolve connection and configuration problems.

== Not connected to a backup storage location

If you receive a "Not connected to a Backup Storage Location" error, check the connection status and reconnect:
