...
= Creating cluster-wide firewall rules for a shared VPC in {gcp-full}
...
* You created the networking and load balancing components in {gcp-full} that your cluster requires.
