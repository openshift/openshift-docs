...
[id="speccancel-pipeline-run-use-pipelines-as-code_{context}"]
...
* xref:../install/install-openshift-pipelines.adoc#customizing-pipelines-as-code-configuration_install-openshift-pipelines[Install {pipelines-shortname}]
