...
//
// * configuring/forward-to-amazon-cloudwatch.adoc
...
The log collector sends logs to CloudWatch by using the `PutLogEvents` API. Each log record becomes a CloudWatch `LogEvent` with two main components:
