...
Similarly, all {gcp-full} load balancers and public IP addresses used by {product-title} on {gcp-full} are protected against DDoS attacks with link:https://cloud.google.com/armor/docs/managed-protection-overview[Google Cloud Armor Standard].
