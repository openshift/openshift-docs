...
Updating from {product-title} 4.12 to 4.14 is a Control Plane Only update. To understand the ramifications for this type of update and how to perform it, see the _Control Plane update_ link in the _Additional resources_ section below.
