...
After installing the {builds-operator}, you must create a `OpenShiftBuild` resource for proper functioning of the build controller.
...
* A controller pod must have been created in the `openshift-builds` namespace.
