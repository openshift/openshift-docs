...
[role="_abstract"]
Configure Loki to store logs in Azure Blob Storage.

.Prerequisites

* You installed the {loki-op}.
* You installed the {oc-first}.
* You created a link:https://docs.microsoft.com/en-us/azure/storage/blobs/storage-blobs-introduction[container] on Azure.
