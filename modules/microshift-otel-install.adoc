...
[NOTE]
====
Restart {microshift-short} after the initial installation. Changing {microshift-short} Observability configuration requires a restart of {microshift-short} Observability, but does not require a restart of {microshift-short}.
====
