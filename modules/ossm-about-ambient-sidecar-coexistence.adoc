...
[role="_abstract"]
Operating a dual-mode mesh requires a single {istio} control plane configured with the ambient profile. Review the following capabilities, limitations, and operational guidelines for managing this architecture.
