...
[NOTE]
====
Ambient and sidecar coexistence requires {SMProductName} 3.2 or later.
====
...
* **Unsupported `VirtualService` features:** Ambient mode does not yet support a gateway API required by the following features. Workloads that rely on these features must remain in sidecar mode:
+
** `HTTPFaultInjection`
