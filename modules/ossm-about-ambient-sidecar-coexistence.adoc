...
* **Unsupported `VirtualService` features:** Workloads that rely on features lacking a gateway API equivalent in ambient mode must remain in sidecar mode. These features include:
+
** `HTTPFaultInjection`
