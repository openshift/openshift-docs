...
ifdef::outposts[]
      ...
      - Key: <kubernetes_io_cluster_unmanaged_tag>
        Value: true
endif::outposts[]
...
<kubernetes_io_cluster_unmanaged_tag>:: Specifies the `kubernetes.io/cluster/unmanaged` tag, which you must include in the public and private subnet configurations for AWS Outposts.
endif::outposts[]
====
