...
|The total number of services of type load balancer that can exist in the project.

|`services.nodeports`
|The total number of services of type node port that can exist in the project.
