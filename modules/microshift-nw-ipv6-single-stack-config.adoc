...
. Replace the default values in the `network` section of the {microshift-short} YAML with your desired valid values.
+
.Example single-stack `IPv6` configuration
[source,yaml]
----
apiServer:
# ...
