...
* You have the {SMProduct} 3.2 Operator installed.
...
* `spec.values` specifies the configuration values for the 3.2 control plane. If you are migrating metrics and tracing, update the `extensionProviders` fields according to your tracing and metrics configurations.
+
[NOTE]
====
