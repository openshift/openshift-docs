...
ifdef::ossm-cluster-wide-istio-injection[* You are running a cluster-wide Service Mesh control plane resource.]
ifdef::ossm-cert-manager-istio-injection[* You are using the cert-manager and istio-csr tools in a cluster-wide deployment.]
ifdef::ossm-cert-manager-istio-injection[* Your {SMProduct} {SMv2Version} `ServiceMeshControlPlane` resource is configured with the cert-manager tool.]
* You have installed the `bookinfo` application.

.Procedure

ifdef::ossm-cert-mangager-istio-injection[]
