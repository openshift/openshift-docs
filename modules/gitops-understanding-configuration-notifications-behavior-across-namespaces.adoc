...
* If no namespace-specific configuration exists, the controller falls back to the central configuration resources (ConfigMap and Secret) defined in the control plane namespace.
