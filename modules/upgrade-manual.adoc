...
= Schedule individual upgrades for your cluster

[role="_abstract"]
You can use {cluster-manager} to manually upgrade your {product-title} cluster one time, either immediately or at a scheduled future date and time. Individual upgrades give you full control over the update process by letting you choose the exact target version and timing.
