...
namespace:: Enter the namespace `openshift-image-registry`. This namespace allows the Cluster Image Registry Operator to consume the PVC.
storage:: Optional: Adjust the volume size.
storageClassName:: Enter the name of the storage class that you created.
