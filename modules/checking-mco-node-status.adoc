...
[role="_abstract"]
You can use the machine config nodes custom resource to gather detailed progress information about node updates and troubleshoot potential issues when modifying a machine config pool.
