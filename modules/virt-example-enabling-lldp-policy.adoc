...
# ...
----
** `metadata.name` specifies the name of the node network configuration policy.
** `spec.capture.ethernets-lldp` specifies that LLDP is enabled for all ethernet ports that have the interface state set to `up`.
