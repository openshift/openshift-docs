...
.Procedure
. Create a new {gc} project, see the Google documentation topic link:https://cloud.google.com/resource-manager/docs/creating-managing-projects[creating and managing projects].
