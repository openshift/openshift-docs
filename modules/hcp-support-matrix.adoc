...
[role="_abstract"]
Learn about supported clusters, platforms, and architectures for {hcp}, as well as information about updates and technology preview features.

Because the {mce} includes the HyperShift Operator, releases of {hcp} align with releases of {mce-short}. For more information, see "OpenShift Operator Life Cycles".
...
For example, if you have an {product-title} 4.18 hosted cluster on the management cluster and you update {mce-short} 2.8 to 2.9, the hosted cluster can continue to run.
