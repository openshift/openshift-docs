...
[role="_abstract"]
You can deploy an {product-title} cluster to specific {gcp-first} regions, which determine the physical location and available machine types for your cluster infrastructure.

You can deploy to the following {gcp-first} regions:
