...
== Mirror registry update use cases
...
You want to prune the existing version and mirror with the specific version of `4.13.1`.
A local storage backend contains images of a  specific version.
  ...
  platform:
    channels:
      - name: stable-4.13 #<1>
        ...
        maxVersion: 4.13.1
----
<1> Replacing by `stable-4.13` prunes the existing version.
