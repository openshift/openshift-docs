...
However, OLM does not always resolve everything, it is best for the users to include the dependencies in the image set configuration file as well. This is to ensure everything is included in the file. 
====
