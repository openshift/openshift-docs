...
If your {rh-openstack-first} deployment supports link:https://docs.redhat.com/en/documentation/red_hat_openstack_services_on_openshift/18.0/html/deploying_a_network_functions_virtualization_environment/plan-sriov-deploy_rhoso-nfv[single root I/O virtualization (SR-IOV)], you can provision SR-IOV networks that compute machines run on.
