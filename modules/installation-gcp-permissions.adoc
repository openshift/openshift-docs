...
The following roles are required for the installation program:
...
The following roles are required for creating network resources during installation:

* DNS Administrator

The following roles are required for using the Cloud Credential Operator in passthrough mode:

* Compute Load Balancer Admin
* Tag User

ifdef::template[]
The following roles are required for user-provisioned {gcp-short} infrastructure:
