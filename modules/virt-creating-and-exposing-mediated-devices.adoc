...
As an administrator, you can create mediated devices and expose them to the cluster by editing the `HyperConverged` custom resource (CR). The values you enter vary depending on the Graphics Processing Units (GPUs) that are in use.
