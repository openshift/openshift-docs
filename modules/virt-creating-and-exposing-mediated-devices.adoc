...
+
For example, the name file for the `nvidia-745` type contains the selector string `A2-AQ`. Using `A2-AQ` as the `mdevNameSelector` value allows nodes to use the `nvidia-745` type.
