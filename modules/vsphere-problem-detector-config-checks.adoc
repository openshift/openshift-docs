...
|`CheckPVs`
|Verifies that the fully qualified path to each persistent volume is less than 255 characters.

If this check fails, rename the VDMK file to use a shorter name.
