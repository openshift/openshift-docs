...
* Add a `cluster-api/accelerator` label to the machine set that you want to create machines for the cluster autoscaler to use to deploy GPU-enabled nodes:
+
--
[source,yaml]
----
...
For more information, see _Cluster autoscaler resource definition_.
====
--