...
* You must configured the MCG object storage for Velero. This is either using the defaults of the buckets created or by applying appropriate settings to the buckets allowing the Velero application using it.
