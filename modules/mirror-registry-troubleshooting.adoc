...
:navtitle: Troubleshoot mirror registry for Red Hat OpenShift
[id="mirror-registry-troubleshooting_{context}"]
= Troubleshooting mirror registry for Red Hat OpenShift

[role="_abstract"]
To assist in troubleshooting _mirror registry for Red{nbsp}Hat OpenShift_, you can gather logs of systemd services installed by the mirror registry.
