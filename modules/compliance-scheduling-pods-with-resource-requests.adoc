...
`requests`:: Specifies that the container is requesting 64 Mi of memory and 250 m CPU.
`limits`:: Specifies the container's limits are 128 Mi of memory and 500 m CPU.
