...
`<spec.namespaceManagement.name>`:: Specifies the `<tenant_ns>` with the namespace that you want Argo CD to manage. You can also use a glob pattern, for example, use asterisks as wildcards for pattern matching.
--
