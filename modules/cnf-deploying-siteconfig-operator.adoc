...
[source,terminal]
----
$ oc get pod -n siteconfig-system
----
...
siteconfig-controller-manager-f6df7c4d4-crl6z   2/2     Running   0          3h37m
----
--
...
[source,terminal]
----
$ oc logs -n siteconfig-system --selector app.kubernetes.io/name=siteconfig-controller -c manager --follow --tail=-1
----