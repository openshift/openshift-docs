...
{gitops-title} 1.6.2 is now available on {OCP} 4.8, 4.9, 4.10 and 4.11.
...
* From {OCP} 4.12, it is optional to install the console. This fix updates the {gitops-title} Operator to prevent errors with the Operator if the console is not installed. link:https://issues.redhat.com/browse/GITOPS-2352[GITOPS-2352]
