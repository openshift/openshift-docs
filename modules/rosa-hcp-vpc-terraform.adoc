...
ifeval::["{context}" == "rosa-hcp-disconnected-install"]
:disconnected-rosa:
endif::[]
...
ifndef::disconnected-rosa[]
+
[source,terminal]
----
$ cd terraform-vpc-example
----
endif::disconnected-rosa[]
ifdef::disconnected-rosa[]
+
[source,terminal]
----
...
[IMPORTANT]
====
You may only use `ap-southeast-1`, `eu-central-1`, or `us-west-2` for the AWS regions.
====
