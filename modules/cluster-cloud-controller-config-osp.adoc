...
//  * `member-subnet-id`
 ...
 These options behavior is identical to what is described in the identically named load balancer options in the load balancer section of the CCM config file.
