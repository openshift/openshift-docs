...
master.example.com  Ready    master   171m   v1.35.4   10.0.129.108   <none>        Red Hat Enterprise Linux CoreOS 48.83.202103210901-0 (Ootpa)   4.21.0-240.15.1.el8_3.x86_64   cri-o://1.35.4-30.rhaos4.10.gitf2f339d.el8-dev
node1.example.com   Ready    worker   72m    v1.35.4   10.0.129.222   <none>        Red Hat Enterprise Linux CoreOS 48.83.202103210901-0 (Ootpa)   4.21.0-240.15.1.el8_3.x86_64   cri-o://1.35.4-30.rhaos4.10.gitf2f339d.el8-dev
node2.example.com   Ready    worker   164m   v1.35.4   10.0.142.150   <none>        Red Hat Enterprise Linux CoreOS 48.83.202103210901-0 (Ootpa)   4.21.0-240.15.1.el8_3.x86_64   cri-o://1.35.4-30.rhaos4.10.gitf2f339d.el8-dev
----
