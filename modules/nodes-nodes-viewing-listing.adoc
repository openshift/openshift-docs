...
master.example.com     Ready     master    7h        v1.36.3
...
NAME                   STATUS                      ROLES     AGE       VERSION
master.example.com     Ready                       master    7h        v1.36.3
node1.example.com      NotReady,SchedulingDisabled worker    7h        v1.36.3
node2.example.com      Ready                       worker    7h        v1.36.3
----
+
...
master.example.com  Ready    master   171m   v1.36.3   10.0.129.108   <none>        Red Hat Enterprise Linux CoreOS 48.83.202103210901-0 (Ootpa)   4.22.0-240.15.1.el8_3.x86_64   cri-o://1.36.3-30.rhaos4.10.gitf2f339d.el8-dev
node1.example.com   Ready    worker   72m    v1.36.3   10.0.129.222   <none>        Red Hat Enterprise Linux CoreOS 48.83.202103210901-0 (Ootpa)   4.22.0-240.15.1.el8_3.x86_64   cri-o://1.36.3-30.rhaos4.10.gitf2f339d.el8-dev
node2.example.com   Ready    worker   164m   v1.36.3   10.0.142.150   <none>        Red Hat Enterprise Linux CoreOS 48.83.202103210901-0 (Ootpa)   4.22.0-240.15.1.el8_3.x86_64   cri-o://1.36.3-30.rhaos4.10.gitf2f339d.el8-dev
----
...
System Info:
 ...
 Architecture:                            amd64
 Container Runtime Version:               cri-o://1.36.3-0.6.dev.rhaos4.3.git9ad059b.el8-rc2
 Kubelet Version:                         v1.36.3
 Kube-Proxy Version:                      v1.36.3
