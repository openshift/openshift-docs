...
[source,terminal]
----
$ sudo crictl ps | grep kube-apiserver | grep -v "operator|gaurd"
----
+
...
[source,terminal]
----
$ sudo mv /var/lib/etcd/member /home/core/assets/backup/
----
+
...
[source,terminal]
----
$ sudo cp /home/core/assets/backup/<snapshot_yyyy-mm-dd_hhmmss>.db /var/lib/etcd
----
...
[source,terminal]
----
$ sudo podman run --rm --authfile=/var/lib/kubelet/config.json -it --entrypoint="/bin/bash" -v /var/lib/etcd:/var/lib/etcd:z registry.redhat.io/openshift4/ose-etcd:latest
----
...
[source,terminal]
----
$ sudo ETCDCTL_API=3 /usr/bin/etcdctl snapshot restore /var/lib/etcd/<snapshot_yyyy-mm-dd_hhmmss>.db \
  --name "<ETCD_NAME>" \
...
[source,terminal]
----
$ sudo mv /var/lib/etcd/restore-<UUID>/member /var/lib/etcd
----
...
[source,terminal]
----
$ sudo restorecon -vR /var/lib/etcd/
----
...
[source,terminal]
----
$ sudo rm -rf /var/lib/etcd/restore-<UUID>
----
+
[source,terminal]
----
$ sudo rm /var/lib/etcd/<snapshot_yyyy-mm-dd_hhmmss>.db
----
+
[IMPORTANT]
====
...
.. RRepeat these steps on the other control plane hosts.
...
[source,terminal]
----
$ sudo mv /tmp/etcd-pod.yaml /etc/kubernetes/manifests
----
...
[source,terminal]
----
$ sudo mv /tmp/kube-apiserver-pod.yaml /etc/kubernetes/manifests
----
