...
With this update, the {gitops-title} Console Plugin integrates Argo CD Image Updater into the {OCP} Developer Console. You can view and manage Argo CD Image Updater resources directly in the Developer Console UI, providing a unified experience for managing GitOps resources.
+
link:https://redhat.atlassian.net/browse/GITOPS-8288[GITOPS-8288]
...
With this update, {gitops-title} automatically masks sensitive annotations, such as cleartext tokens in `kubernetes.io/dockercfg` Secrets, in the Argo CD web UI and CLI. This eliminates the need to manually configure `resource.sensitive.mask.annotations` and helps prevent sensitive information from being exposed.
+
link:https://redhat.atlassian.net/browse/GITOPS-10230[GITOPS-10230]
...
+
link:https://redhat.atlassian.net/browse/GITOPS-9963[GITOPS-9963]
...
+
link:https://redhat.atlassian.net/browse/GITOPS-9948[GITOPS-9948]
...
====
+
link:https://redhat.atlassian.net/browse/GITOPS-11441[GITOPS-11441]
