...
[id="create-a-github-application-in-administrator-perspective_{context}"]
...
.Procedure
. In the administrator perspective, navigate to *Pipelines* by using the navigation pane.
