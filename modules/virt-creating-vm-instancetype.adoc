...
You can create a virtual machine (VM) from an instance type by using the {product-title} web console. You can also create a VM by copying an existing snapshot.
endif::[]
ifdef::static-key[]
...
include::modules/virt-creating-vm-from-snapshot-web.adoc[leveloffset=+2]
