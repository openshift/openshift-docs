...
[role="_abstract"]
{logging} components use specific container images defined by environment variables in the cluster-logging-operator deployment.
...
[source,terminal]
----
FLUENTD_IMAGE=registry.redhat.io/openshift-logging/fluentd-rhel8:latest@sha256:ffdf79da7386871d2bc24cd937e02284b30f85a9979dc8c635fb73021cbca2f3
----
