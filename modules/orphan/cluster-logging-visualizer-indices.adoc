...
[role="_abstract"]
An index pattern defines the Elasticsearch indices you want to visualize in Kibana.

To explore and visualize data in Kibana, you must create an index pattern.
