...
//
// * extend/routing-traffic-by-using-argo-rollouts-for-openshift-service-mesh.adoc
...
* You installed xref:../install/set-up-gitops-for-application-deployment.adoc#installing-openshift-gitops_set-up-gitops-for-application-deployment[{gitops-title}] on your {OCP} cluster.
* You installed xref:../extend/understand-and-set-up-argo-rollouts.adoc#gitops-creating-rolloutmanager-custom-resource_understand-and-set-up-argo-rollouts[Argo Rollouts] on your {OCP} cluster.
* You installed the xref:../extend/understand-and-set-up-argo-rollouts.adoc#gitops-installing-argo-rollouts-cli-on-linux_understand-and-set-up-argo-rollouts[Argo Rollouts CLI] on your system.
...
`spec.selector`:: Specifies the selector to match pods. Ensure that the contents of the `selector` field are the same in the stable service and Rollout CR.
--
...
`spec.ports`:: Specifies the name of the port used by the application for running inside the container.
`spec.selector`:: Specifies the selector to match pods. Ensure that the contents of the `selector` field are the same in the canary service and `Rollout` CR.
--
...
`spec.selector`:: Specifies the selector to match pods. Ensure that the contents of the selector field are the same as in the canary and stable services.
--
