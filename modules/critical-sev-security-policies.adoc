...
[role="_abstract"]
The following table lists the default security policies in {product-title} that are of critical severity. The policies organize by lifecycle stage.
