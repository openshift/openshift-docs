...
. Type *Red Hat build of OpenTelemetry* into the filter to locate the {OTELOperator}.

. Click the *{OTELOperator}* provided by Red Hat to display information about the Operator.
