...
[role="_abstract"]
The `console-plugin-template` plugin template demonstrates how you can translate messages with link:https://www.i18next.com/[react-i18next].
...
. Include a comment in a TypeScript file for the `i18next-parser` tool to add the message from `console-extensions.json` to your message catalog. For example:
+
[source,tsx,subs="+quotes,+macros"]
----
