...
----
* With this update, usage of external databases, such as the Crunchy PostgreSQL is not supported on {iibm-cloud-bm-reg}, {ibm-z-reg}, and {ibm-linux-one-reg}. Instead, use the default {tekton-hub} database.
