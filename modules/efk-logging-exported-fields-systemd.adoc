...
[id='efk-logging-exported-fields-systemd_{context}']
...
[discrete]
[id='exported-fields-systemd.k-{context}']
=== `systemd.k` Fields
...
[discrete]
[id='exported-fields-systemd.t-{context}']
=== `systemd.t` Fields
...
[discrete]
[id='exported-fields-systemd.u-{context}']
=== `systemd.u` Fields
