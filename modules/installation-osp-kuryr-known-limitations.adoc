...
During the {rh-openstack} upgrade process, two of the things that are relevant to a Kuryr deployment are:

* Changes to the Octavia API.

* An upgrade to the Amphora image used for load balancers might be required.
