...
`bf3-p0-vfs`:: Reserves VF indices 2-45 on PF0 for workload traffic with RDMA enabled. The `pfIndex: 0` value refers to the first physical function of the BlueField-3 DPU.
