...
You can use the VPA with built-in resources such as deployments or stateful sets and also custom resources that manage pods. For more information on useing the VPA with custom resources, see _Using the Vertical Pod Autoscaler Operator with Custom Resources_.
