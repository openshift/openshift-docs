...
[id="cloud-experts-deploying-application-lab-overview_{context}"]
= Lab resources
...
+
Example of the `ostoy-frontend-deployment.yaml` file
+
[source,yaml]
----
apiVersion: v1
...
----
+
Example of the `ostoy-microservice-deployment.yaml` file
+
[source,yaml]
----
apiVersion: apps/v1
...
+
Example of the `s3-bucket.yaml` file
+
[source,yaml]
----
