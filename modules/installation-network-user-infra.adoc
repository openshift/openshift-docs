...
[IMPORTANT]
====
Ensure you enable the `disk.EnableUUID` parameter on all virtual machines in your cluster. See "Installing RHCOS and starting the {product-title} bootstrap process" in the _Additional resources_ section.
====
