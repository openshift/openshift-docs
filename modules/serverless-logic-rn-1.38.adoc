...
= Red{nbsp}Hat OpenShift Serverless Logic 1.38

[role="_abstract"]
{ServerlessLogicProductName} 1.38 is now available. New features and fixed issues that pertain to {ServerlessLogicProductName} on {ocp-product-title} are included in the following notes:
