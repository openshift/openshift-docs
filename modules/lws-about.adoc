...
// TODO: Confirm the why
[IMPORTANT]
====
The {cert-manager-operator} must be installed before installing the {lws-operator}. The {cert-manager-operator} is required to configure services and manage metrics collection.
====
