...
[role="_abstract"]
For an {ServerlessLogicProductName} installation, the following types of events are generated:

* Outgoing and incoming events related to workflow business logic.

* Events sent from workflows to the Data Index and Jobs Service.

* Events sent from the Jobs Service to the Data Index Service.
