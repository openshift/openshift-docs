...
[role="_abstract"]
{ols-official} 0.2.1 is now generally available for {ocp-product-title} 4.15 and later.

[id="ols-0-2-1-enhancements_{context}"]
== Enhancements

[role="_abstract"]
{ols-official} 0.2.1 introduces event previews, expanded YAML and log attachment support for Virtualization and Storage, and enhanced TLS configuration options.
