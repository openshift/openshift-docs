...
<local_zone_name>:: Specifies the {zone-type} names. The list of {zone-type} names that you use must exist in the same AWS Region specified in the `platform.aws.region` field.
ifdef::wavelength-zone[]
<wavelength_zone_name>:: Specifies the {zone-type} names. The list of {zone-type} names that you use must exist in the same AWS Region specified in the `platform.aws.region` field.
endif::wavelength-zone[]
+
