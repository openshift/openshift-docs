...
<local_zone_name>:: Specifies the list of {zone-type} names that you use. The zones must exist in the same AWS Region specified in the `platform.aws.region` field.
endif::local-zone[]
ifdef::wavelength-zone[]
+
[source,yaml]
...
<region_name>:: Specifies the AWS Region name.
<wavelength_zone_name>:: Specifies the list of {zone-type} names that you use. The zones must exist in the same AWS Region specified in the `platform.aws.region` field.
endif::wavelength-zone[]
+
