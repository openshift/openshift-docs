...
<local_zone_name>:: Specifies the list of {zone-type} names that you use. The names must exist in the same AWS Region specified in the `platform.aws.region` field.
+
