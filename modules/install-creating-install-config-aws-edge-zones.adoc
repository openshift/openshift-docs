...
<local_zone_name>:: Specifies the Local Zone name. The list of {zone-type} names that you use must exist in the same AWS Region specified in the `platform.aws.region` field.
<wavelength_zone_name>:: Specifies the Wavelength Zone name. The list of {zone-type} names that you use must exist in the same AWS Region specified in the `platform.aws.region` field.
+
