...
[role="_abstract"]
Argo CD Image Updater automatically updates container image versions for workloads managed by Argo CD by monitoring registries for new tags matching configured version constraints.
