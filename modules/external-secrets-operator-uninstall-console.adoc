...
. Uninstall the {external-secrets-operator-short} Operator using the following steps:

.. Navigate to *Operators* -> *Installed Operators*.

.. Click the Options menu {kebab} next to the *{external-secrets-operator-short}* entry and click *Uninstall Operator*.
