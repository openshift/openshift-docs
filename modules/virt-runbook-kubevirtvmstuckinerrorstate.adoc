...
[id="virt-runbook-KubeVirtVMStuckInErrorState"]
= KubeVirtVMStuckInErrorState

[discrete]
[id="meaning-kubevirtvmstuckinerrorstate"]
== Meaning
...
[discrete]
[id="impact-kubevirtvmstuckinerrorstate"]
== Impact
...
[discrete]
[id="diagnosis-kubevirtvmstuckinerrorstate"]
== Diagnosis
...
[discrete]
[id="mitigation-kubevirtvmstuckinerrorstate"]
== Mitigation
