...
ifdef::ossm-cluster-wide[= Migrating a cluster-wide deployment by using the Istio revision label]
ifdef::ossm-cert-manager[= Migrating a cluster-wide deployment by using the Istio revision label with cert-manager]
