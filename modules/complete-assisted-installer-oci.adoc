...
* You created and applied the Terraform stack in {oci} Resource Manager. For details, see "Provisioning {oci} infrastructure for your cluster".
...
* You copied the `dynamic_custom_manifest.yml` file from the Terraform stack in OCI Resource Manager. For details, see "Provisioning {oci} infrastructure for your cluster". 
