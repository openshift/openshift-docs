...
[id="microshift-5-0-additional-release-notes_{context}"]
= Additional release notes

[role="_abstract"]
Release notes for related components and products are available in the following documentation:

[id="microshift-5-0-additional-release-notes-gitops_{context}"]
...
[id="microshift-5-0-additional-release-notes-ocp_{context}"]
== {OCP} release notes
...
[id="microshift-5-0-additional-release-notes-rhel_{context}"]
...
[id="microshift-5-0-additional-release-notes-rhoai_{context}"]
== {rhoai} release notes
