...
[NOTE]
====
Red Hat deprecated the public instance of {tekton-hub} (`hub.tekton.dev`) and will remove it in a future release. Use {artifact-hub} as an alternative for Tekton `Pipeline` and `Task` resources, including Tekton Catalog Tasks and Tekton Catalog Pipelines.
