...
* classpath: Use this for files located in the `<project_application_dir>/specs` folder of the application project. `classpath` is the default URI scheme. If you do not define a URI scheme, the file location is `<project_root_dir>/specs/myopenapifile.yaml`.
