...
[role="_abstract"]
{ServerlessLogicProductName} allows the workflows to interact with remote services by using an OpenAPI specfication reference in a function. 

The following example displays OpenAPI function definition:
