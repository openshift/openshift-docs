...
[role="_abstract"]
You can install {sno} on {ibm-z-name} and {ibm-linuxone-name} using z/VM by generating the installation ISO and booting the server from the ISO.
...
+
The following example shows how to set the SCPDATA:
+
[source,terminal]
----
