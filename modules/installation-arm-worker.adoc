...
----
ifndef::ash[]
include::https://raw.githubusercontent.com/openshift/installer/release-4.18/upi/azure/06_workers.json[]
endif::ash[]
ifdef::ash[]
include::https://raw.githubusercontent.com/openshift/installer/release-4.18/upi/azurestack/06_workers.json[]
endif::ash[]
----
====
