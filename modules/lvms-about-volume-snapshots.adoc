...
:navtitle: Volume snapshots
[id="lvms-about-volume-snapshots_{context}"]
= About volume snapshots

[role="_abstract"]
You can create volume snapshots of persistent volume claims (PVCs) provisioned by {lvms} to back up application data or revert to a previous state, providing data protection and recovery capabilities.
...
[id="lvms-about-volume-snapshots-limits_{context}"]
