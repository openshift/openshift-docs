...
[id='nodes-scheduler-pod-affinity-example-affinity-{context}']
== Pod Affinity
...
[id='nodes-scheduler-pod-affinity-example-antiaffinity-{context}']
== Pod Anti-affinity
...
[id='nodes-scheduler-pod-affinity-example-no-labels-{context}']
