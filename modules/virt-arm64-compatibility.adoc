...
[id="virt-arm64-compatibility_{context}"]
= ARM64 compatibility
...
* All virtualization limitations for {op-system-base} also apply to {VirtProductName}. For more information, see "How virtualization on ARM64 differs from AMD64 and Intel 64" in the Additional resources section.
