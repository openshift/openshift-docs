...
[source,terminal]
----
$ oc get pods -n netobserv -l app=flowlogs-pipeline-informers
----
+
.Example output
[source,terminal]
...
flowlogs-pipeline-informers-7d9f8b5c4d-abc12   1/1     Running   0          5m
flowlogs-pipeline-informers-7d9f8b5c4d-xyz34   1/1     Running   0          5m
----
+
...
[source,terminal]
----
$ oc logs -n netobserv -l app=flowlogs-pipeline-informers --tail=50 | grep -i "leader"
----
+
...
[source,terminal]
----
$ oc logs -n netobserv <flowlogs-pipeline-informers-pod-name>
----
+
...
[source,terminal]
----
$ oc get svc -n netobserv flowlogs-pipeline-informers
----
+
...
[source,terminal]
----
$ oc describe clusterrolebinding flowlogs-pipeline-informers
----
+
The ClusterRoleBinding should grant the `flowlogs-pipeline-informers` ServiceAccount the necessary permissions to watch Kubernetes resources.
