...
[role="_abstract"]
To install {product-title}, the {aws-first} account you use must
...
[NOTE]
====
If you purchase a new domain through {aws-short}, it takes time for the relevant DNS
...
. Update the registrar records for the {aws-short} Route 53 name servers that your domain
uses. For example, if you registered your domain to a Route 53 service in a
different accounts, see the following topic in the {aws-short} documentation:
