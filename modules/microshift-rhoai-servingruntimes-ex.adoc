...
* The `microshift-ai-model-serving-release-info` RPM is installed.
...
----
$ oc create -n _<ai-demo>_ -f ./ovms-kserve.yaml <1>
----
<1> Replace _<ai-demo>_ with the name of your namespace.
