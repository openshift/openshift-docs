...
nodeVMSize:: Optional: Specifies the size of the compute node VM. Use a VM size compatible with your specified architecture. If this value is not defined, the default value from the template is set.
endif::azure[]
ifdef::ash[]
[source,terminal]
----
