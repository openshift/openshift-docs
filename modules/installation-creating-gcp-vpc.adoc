...
= Creating a VPC in {gcp-full}

You must create a VPC in {gcp-full} for your {product-title}
...
. Set up the shared VPC. See link:https://cloud.google.com/vpc/docs/provisioning-shared-vpc#setting_up[Setting up Shared VPC] in the {gcp-full} documentation.
endif::shared-vpc[]
