...
$ oc create secret generic my-github-ssh-credentials \ # <1>
  --from-file=id_ed25519=/path/to/.ssh/id_ed25519 \ # <2>
  --from-file=known_hosts=/path/to/.ssh/known_hosts # <3>
----
<1> The name of the secret, in this case, `my-github-ssh-credentials`
<2> The name and full path name of the private key file
<3> The name and full path name of the known hosts file
