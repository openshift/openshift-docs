...
[NOTE]
====
This section about creating scrape sample alerts applies to the following distributions:
...
.. In the web console, go to *Observe* -> *Targets* and select an endpoint with a `Down` status that you want to check.
+
