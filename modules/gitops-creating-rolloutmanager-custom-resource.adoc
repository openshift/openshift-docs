...
[role="_abstract"]
To manage progressive delivery with Argo Rollouts, create and configure a `RolloutManager` custom resource (CR) in the namespace of your choice. By default, a new `argo-rollouts` instance manages resources only in its deployed namespace.
