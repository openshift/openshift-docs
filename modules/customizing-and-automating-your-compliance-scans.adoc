...
*** *Frequency*: From the drop-down list, select how often you want to perform the scan. If you do not select a frequency, `Daily` is selected automatically.
+
...
*** *Time*: Start to type the time in `hh:mm` at which you want to run the scan. From the list that is displayed, select a time. You can proceed to the next step only after you specify the time at which you want to run the scan.

. Click *Next*.
. In the *Clusters* page, select one or more clusters that you want to include in the scan. You can proceed to the next step only after you select at least one cluster which is in a healthy state.
. Click *Next*.
. In the *Profiles* page, select one or more profiles that you want to include in the scan. You can proceed to the next step only after you select at least one profile which you want to include in the scan.
. Click *Next*.
