...
[role="_abstract"]
Filter alerts, silences, and alerting rules in the Alerting UI to quickly find relevant items and focus on specific monitoring criteria that matter to your role.

The following lists provide a description of each of the available filtering options.

[id="understanding-alert-filters_{context}"]
== Understanding alert filters

The *Alerts* page in the Alerting UI provides details about alerts relating to default  and user-defined projects. The page includes a summary of severity, state, and source for each alert. The time at which an alert went into its current state is also shown.
...
* *Source* filters:
** *Platform*. Platform-level alerts relate only to default platform projects. These projects provide core platform functionality.
...
The *Silences* page in the Alerting UI provides details about silences applied to alerts in default platform and user-defined projects. The page includes a summary of the state of each silence and the time at which a silence ends.
...
The *Alerting rules* page in the Alerting UI provides details about alerting rules relating to default platform and user-defined projects. The page includes a summary of the state, severity, and source for each alerting rule.
...
* *Source* filters:
** *Platform*. Platform-level alerting rules relate only to default platform projects. These projects provide core platform functionality.
