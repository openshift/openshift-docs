...
[role="_abstract"]
You can filter the alerts, silences, and alerting rules that are displayed in the Alerting UI. The following lists provide a description of each of the available filtering options.
