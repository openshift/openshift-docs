...
[id='service-catalog-design-{context}']
...
[id='service-catalog-deleting-resources-{context}']
=== Deleting resources
...
[id='service-catalog-concepts-terminology-{context}']
...
[NOTE]
====
{product-title} also has a core concept called _services_,
...
[id='service-catalog-provided-cluster-brokers-{context}']
== Provided Cluster Service Brokers

{product-title} provides the Template Service Broker and the OpenShift Ansible
Broker for use with the service catalog.