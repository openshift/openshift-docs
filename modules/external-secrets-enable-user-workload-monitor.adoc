...
[role="_abstract"]
By default, the {product-title} monitoring stack does not scrape metrics from user-installed applications like the {external-secrets-operator-short}. You can enable user workload monitoring to collect Operator metrics such as synchronization status, API error rates, and controller performance.
