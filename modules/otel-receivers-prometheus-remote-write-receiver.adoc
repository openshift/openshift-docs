...
The following `OpenTelemetryCollector` custom resource configures the Prometheus Remote Write Receiver:
...
The following prerequisites apply for using this receiver with Prometheus:
