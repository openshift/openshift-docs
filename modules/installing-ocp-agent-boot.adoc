...
= Create and boot the agent image

[role="_abstract"]
Generate the Agent-based Installer ISO image and boot it on your cluster nodes to initiate the automated installation process.
...
* xref:../../installing/installing_with_agent_based_installer/installing-with-agent-based-installer.adoc#installing-ocp-agent-tui_installing-with-agent-based-installer[Verify host connectivity and image access]