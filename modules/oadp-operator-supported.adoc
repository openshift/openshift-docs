...
[role="_abstract"]
Review the {oadp-short} support matrix for version compatibility with {product-title} releases and lifecycle policy information, including Extended Update Support (EUS) options.
...
EUS must be on {product-title} 4.21
a|
EUS Term 2 must be on {product-title} 4.21
...
EUS must be on {product-title} 4.16
a|
27 Jun 2027

EUS Term 2 must be on {product-title} 4.16
...
EUS must be on {product-title} 4.14
a|
31 Oct 2026

EUS Term 2 must be on {product-title} 4.14
|===
