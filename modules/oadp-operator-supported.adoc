...
7+|Previous versions of the {oadp-short} Operator which are no longer supported
...
For more details, about EUS, see link:https://access.redhat.com/support/policy/updates/openshift#eus[Extended Update].
