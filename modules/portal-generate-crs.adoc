...
. Enter a name for the CRS and click *Download* to generate and download the file. You can use it to secure all of your clusters if you are using the same installation method.
+
[IMPORTANT]
====
