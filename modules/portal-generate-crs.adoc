...
. Log in to the {product-title-short} portal. If you do not have secured clusters or an existing CRS, the *Platform Configuration* -> *Clusters* page is displayed.
. Click *Create cluster registration secret*.
. Enter a name for the CRS and click *Download* to generate and download the CRS as a YAML file. You can use it to secure all of your clusters if you are using the same installation method.
+
[IMPORTANT]
====
Store this file securely because it has secrets.
====
