...
| `statefulset-ordinals` | Enable StatefulSet ordinals for workload distribution as an alternative to leader election. When enabled, workload is distributed evenly across replicas using pod ordinals. | `false`
