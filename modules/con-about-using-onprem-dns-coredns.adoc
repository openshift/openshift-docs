...
[role="_abstract"]
You can self-manage your on-premise DNS by integrating CoreDNS with your DNS infrastructure through access control and zone delegation. {prodname} combines the DNS Operator with CoreDNS to simplify your management and security for on-premise DNS servers. 

You can use CoreDNS in both single-cluster and multicluster scenarios.
