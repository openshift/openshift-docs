...
+
where:
`kind:`:: variable refers to the kind of the profile.
`name:`:: variable refers to the name of the profile.
`image:`:: You can enable a default security profile by using a wildcard in the image attribute: `image: "*"`
