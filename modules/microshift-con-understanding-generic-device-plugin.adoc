// microshift-con-understanding-generic-device-plugin.adoc
...
* Specialized hardware that needs additional drivers or kernel modules. Examples of this specialized hardware include GPUs (Graphics Processing Units) and FPGAs (Field-Programmable Gate Arrays). These types of devices typically require their own specialized device plugins.