...
* You have created the required firewall rules in your {gcp-short} project if you are installing a cluster by using {product-title} version 4.21 or later. For more information, see _Creating firewall rules for reduced Workload Identity Federation permissions on {gcp-short}_ in the _Additional resources_ section.
