...
* You have created the required firewall rules in your {gcp-short} project if you are installing a cluster by using {product-title} version 4.21 or later. For more information, see _Create firewall rules for reduced Workload Identity Federation permissions on {gcp-short}_ .
...
+
For more information about supported versions for WIF configurations, see "Create a Workload Identity Federation configuration".
