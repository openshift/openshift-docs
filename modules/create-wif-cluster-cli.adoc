...
--channel-group <channel_group> <14>
----
...
<14> Optional: Replace `<channel_group>` with the name of the channel group you want to assign the cluster to. Channel group options include `fast`, `stable`, and `eus`.
