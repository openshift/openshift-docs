...
[IMPORTANT]
====
Adding bare-metal nodes is generally available for {product-title} 4.22.13 and later. However, this feature is Technology Preview for 4.22 through 4.22.12.
====
