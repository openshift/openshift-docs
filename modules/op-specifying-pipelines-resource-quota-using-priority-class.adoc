...
// * optimize/optimize-pipeline-operations.adoc

:_mod-docs-content-type: PROCEDURE
[id="specifying-pipelines-resource-quota-use-priority-class_{context}"]
= Specify resource quota using priority class
...
For more information about setting limit ranges, see _Restrict resource consumption with limit ranges_.
====
+
[NOTE]
====
