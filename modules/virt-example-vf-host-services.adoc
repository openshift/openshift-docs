...
<7> ID of the VLAN. This example uses hardward offloading to define a VLAN directly on the VF.
...
<15> In this example, this VLAN network interface is added as an additional interface to the bonded network interface.
