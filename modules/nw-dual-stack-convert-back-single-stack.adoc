...
. Remove the IPv4 or IPv6 configuration that you added to the `cidr` and `hostPrefix` parameters from completing the "Converting to a dual-stack cluster network " procedure steps.
