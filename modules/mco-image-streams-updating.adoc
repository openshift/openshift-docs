...
[role="_abstract"]
For an existing {product-title} 5.0 cluster that is using {op-system-first} 9.x, you can move the nodes in your machine config pools to {op-system} 10.x. For 4.22.x clusters, you must first update to {product-title} 5.0, then update to {op-system} 10.x.
