...
You cannot update the {op-system} version in a cluster that is using the runC container runtime, because runC is deprecated in {product-title} 5.0. You must configure your cluster to use the crun container runtime. For information, see "Configuring the container runtime".
