...
[IMPORTANT]
====
Running a cluster with a mixture of {op-system} 9.x and 10.x nodes is not supported. You must move all of your nodes to {op-system} 10.x.
====
...
* Update all of the nodes in your cluster to {op-system} 10:
+
...
* Update all machine config pools to {op-system} 10:
+
--
.. Update the worker machine config pool to {op-system} 10 by using the following command:
+
[source,terminal]
----
...
.. Update the control plane machine config pool to {op-system} 10 by using the following command:
+
[source,terminal]
----
...
.. Update all custom machine config pools to {op-system} 10 by using the following command with the name of the machine config pool to update:
+
[source,terminal]
----
