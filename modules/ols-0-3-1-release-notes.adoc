...
[role="_abstract"]
{ols-official} 0.3.1 is now generally available for {ocp-product-title} 4.15 and later.
...
[role="_abstract"]
{ols-official} 0.3.1 introduces large language model (LLM) response streaming to provide faster response times and an improved user experience.

The following enhancement is made with {ols-official} 0.3.1:
