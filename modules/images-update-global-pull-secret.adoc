...
The global pull secret is a HostedControlPlane feature only and is not an RHOCP standalone feature.
endif::openshift-enterprise[]
ifdef::openshift-rosa-hcp[]
The global pull secret is a HostedControlPlane feature only and is not an RHOCP standalone feature and is also only available on {product-title} version 4.20.6 and later.
endif::openshift-rosa-hcp[]
