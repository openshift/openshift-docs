...
:navtitle: Create the Azure resource group
[id="installation-azure-create-resource-group-and-identity_{context}"]
= Creating the Azure resource group

ifdef::azure[]
[role="_abstract"]
You must create a Microsoft Azure resource group and an identity for that resource group. Both are used when you install your {product-title} cluster on Azure.

For more information, see "Azure resource groups".
endif::azure[]
ifdef::ash[]
[role="_abstract"]
You must create a Microsoft Azure resource group. The resource group is used when you install your {product-title} cluster on Azure Stack Hub.
