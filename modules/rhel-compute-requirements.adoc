...
[IMPORTANT]
====
Minimum 7.6 is supported version (This means 7.7 is also in the support scope) {product-title} {product-version}. You must not upgrade your compute machines to RHEL 8.
====
