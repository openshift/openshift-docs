...
** Base OS: link:https://access.redhat.com/documentation/en-us/red_hat_enterprise_linux/8/html/performing_a_standard_rhel_installation/index[{op-system-base} 8.6 or 8.7] with "Minimal" installation option.
+
[IMPORTANT]
====
