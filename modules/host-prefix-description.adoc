...
[id="additional-resources_host-prefix-description_{context}"]
[role="_additional-resources"]
== Additional resources

* link:https://access.redhat.com/labs/ocpnc/[Red Hat OpenShift Network Calculator: calculate the maximum number of nodes for your cluster]
