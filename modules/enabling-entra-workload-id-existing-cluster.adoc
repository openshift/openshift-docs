...
[NOTE]
====
The following command does not show all available options. For a complete list of options, including those that may be necessary for your specific use case, run `$ ccoctl azure create-managed-identities --help`.
====
+
[source,terminal]
----
