...
= Troubleshoot by using the Network Observability Operator
...
. In the {ocp-product-title} web console, go to *Observe* -> *Network Traffic* -> *Topology*.
...
* link:https://docs.redhat.com/en/documentation/openshift_container_platform/latest/html-single/network_observability/index#installing-network-observability-operators[Installing the Network Observability Operator]

* link:https://docs.redhat.com/en/documentation/openshift_container_platform/latest/html-single/network_observability/#nw-observe-network-traffic[Observing the network traffic from the Topology view]
