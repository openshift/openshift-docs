...
This delay appears to the virtual machine as steal time (CPU time lost when the host runs other workloads) and can affect performance, often indicating CPU overcommitment or contention on the host.  
Type: Counter
