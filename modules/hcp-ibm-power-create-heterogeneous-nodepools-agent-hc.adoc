...
This explains how to create heterogeneous nodepools on an agent platform. Please refer to set up the environment using Agent Platform from section 4.6.1, this section only covers the things needed to configure to have heterogeneous nodepools.
