...
include::hcp-ibm-power-create-heterogeneous-nodepools-agent-hc-con.adoc[leveloffset=+2]

.Procedure

* Configure the `AgentServiceConfig` CR with two heterogeneous architecture operating system (OS) images by running the following command:
+
[source,terminal]
----
