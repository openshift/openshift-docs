...
Flyway is managed by `kie-addons-quarkus-flyway` runtime module and it is disabled by default. To enable Flyway, you must configure it using one of the following methods:
...
To execute the DDL scripts, you must perform the following procedures:
