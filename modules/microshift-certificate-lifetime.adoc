...
[IMPORTANT]
====
If the rotated certificate is a {microshift-short} Certificate Authority, all of the certificates it signed rotate. If you created any Custom Certificate Authorities, they must be rotated manually.
====
