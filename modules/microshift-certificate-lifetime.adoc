...
[NOTE]
====
If the rotated certificate is a Certificate Authority, all of the certificates it signed rotate. Custom Certificate Authorities must be rotated manually.
====
...
* xref:../../microshift_troubleshooting/modules/microshift-custom-ca-con.adoc#microshift-custom-ca-con[Configuring custom certificate authorities]