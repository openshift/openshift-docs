...
[IMPORTANT]
====
* During the recreation of network policies from {SMProduct} 2.6 to {SMProduct} 3, both control planes must have access to all workloads and all workloads must have access to control planes.
