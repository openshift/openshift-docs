...
mirror:
  ...
  - catalog: registry.redhat.io/redhat/redhat-operator-index:v4.17
    ...
    - name: amq-broker-rhel8
      ...
      - name: 7.11.x
----
registry.redhat.io/redhat/redhat-operator-index:v4.17:: Specifies the value to use in the `mirror.catalog` catalog image reference for the follwing `jq` command to get the image digest. In this example, _<registry.redhat.io/redhat/redhat-operator-index:v4.17>_.
...
----
registry.redhat.io/redhat/redhat-operator-index:v4.17:: Specifies the value to use in the `mirror.catalog` catalog image reference for the `jq` command to get the image digest. In this example, _<registry.redhat.io/redhat/redhat-operator-index:v4.17>_.
+
.Example output
[source,terminal]
----
