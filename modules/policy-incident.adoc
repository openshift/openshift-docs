...
* Customers should deploy multi-availability zone (AZ) clusters with workloads that follow Kubernetes best practices to ensure high availability within a region.
