...
[NOTE]
====
Compliance Operator releases are *asynchronous*: version numbers and feature availability are not aligned with {product-title} minor or patch releases. See xref:../security/compliance_operator/co-support.adoc#co-lifecycle_co-support[Compliance Operator lifecycle].
====
