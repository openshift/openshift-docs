...
[id="additional-resources-installation-minimum-resource-requirements_{context}"]
...
ifdef::vsphere[]
* link:https://access.redhat.com/articles/7074533[Memory Ballooning and OpenShift (Red Hat Knowledgebase article)]
endif::vsphere[]
