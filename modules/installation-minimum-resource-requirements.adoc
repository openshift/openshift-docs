...
For more information, see the Architectures section in the {op-system-base} 9.2 release notes.
====
...
For more information, see the Red Hat Knowledgebase article about memory ballooning and {product-title}.
====
endif::vsphere[]
