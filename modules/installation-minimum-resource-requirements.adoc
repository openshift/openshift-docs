...
|Storage
ifndef::ibm-z-reg,ibm-cloud-vpc[]
|Input/Output Per Second (IOPS)^[2]^
endif::ibm-z-reg,ibm-cloud-vpc[]
ifdef::ibm-z-reg,ibm-cloud-vpc[]
|Input/Output Per Second (IOPS)
endif::ibm-z-reg,ibm-cloud-vpc[]

|Bootstrap
|{op-system}
ifdef::ibm-power-reg[|2]
ifndef::ibm-power-reg[|4]
|16 GB
|100 GB
ifndef::ibm-z-reg[]
|300
...
|Compute
ifdef::ibm-z-reg,ibm-power-reg,ibm-cloud-vpc[|{op-system}]
ifndef::ibm-z-reg,ibm-power-reg,ibm-cloud-vpc[|{op-system}, {op-system-base} 8.6, {op-system-base} 8.7, or {op-system-base} 8.8 ^[3]^]
|2
|8 GB
|100 GB
ifndef::ibm-z-reg[]
...
ifndef::ibm-z-reg,bare-metal,ibm-cloud-vpc[]
1. One vCPU is equivalent to one physical core when simultaneous multithreading (SMT), or hyperthreading, is not enabled. When enabled, use the following formula to calculate the corresponding ratio: (threads per core × cores) × sockets = vCPUs.
endif::ibm-z-reg,bare-metal,ibm-cloud-vpc[]
ifndef::ibm-z-reg,ibm-power-reg,ibm-cloud-vpc[]
...
endif::ibm-z-reg,ibm-power-reg,ibm-cloud-vpc[]
ifdef::ibm-power-reg[]
