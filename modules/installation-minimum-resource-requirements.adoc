...
For more information, see "{op-system-base} Architectures".
====
...
* link:https://access.redhat.com/documentation/en-us/red_hat_enterprise_linux/9/html-single/9.2_release_notes/index#architectures[{op-system-base} Architectures]

ifdef::vsphere[]
* link:https://access.redhat.com/articles/7074533[Memory Ballooning and OpenShift]
endif::vsphere[]
