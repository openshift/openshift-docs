...
[NOTE]
====
For {product-title} version {product-version}, {op-system} is based on {op-system-base} version 10.2, which has the micro-architecture requirements. The following list contains the minimum instruction set architectures (ISA) that each architecture requires:

* x86-64 architecture requires x86-64-v2 ISA
* ARM64 architecture requires ARMv8.0-A ISA
* ppc64le architecture and {op-system}-10.2 requires {ibm-name} Power10 ISA or higher
* ppc64le architecture and {op-system}-9.8 requires {ibm-name} Power9 ISA or higher
* s390x architecture requires {ibm-name} z14 ISA

If a customer had installed {product-title} with {op-system-base} 9, you may use `ppc64le` architecture with {ibm-name} Power9 ISA.

For more information, see link:https://access.redhat.com/documentation/en-us/red_hat_enterprise_linux/9/html-single/9.8_release_notes/index#architectures[Architectures] in the {op-system-base} documentation.
====
...
For more information, see the Red{nbsp}Hat Knowledgebase article link:https://access.redhat.com/articles/7074533[Memory Ballooning and OpenShift].
====
endif::vsphere[]
