...
[NOTE]
====
Releases of the {otel} and the distributed tracing share the same version numbers. There was a 3.9.1 release of the distributed tracing, but no 3.9.1 release of the {otel}.
====
