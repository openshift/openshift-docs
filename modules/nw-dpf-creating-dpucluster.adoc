...
The DPF HCP Provisioner Operator (`dpf-hcp-provisioner-operator`) automatically injects the kubeconfig into this resource after the hosted cluster is created.
