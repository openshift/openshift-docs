...
//current release is 2.6/2.5.3/2.4.9 is scheduled for July 10, 2024
//support for 2.3.12 may drop with 2.6. Confirmation pending as of June 24, 2024.

* https://issues.redhat.com/browse/OSSM-6602[OSSM-6602]
