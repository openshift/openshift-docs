...
* In the {product-title-short} portal, go to *Platform Configuration* -> *Policy Management*. Default policies are indicated by the *System* label in the *Origin* column. For a list of default policies, organized by severity, see "Security policy reference".
+
[NOTE]
====
