...
[role="_abstract"]
Use the following information to learn about `tkn` pipeline run commands.
...
`--keep 5`:: Replace `5` with the number of most recently executed pipeline runs you want to retain.
