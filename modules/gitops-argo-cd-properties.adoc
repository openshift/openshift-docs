...
[role="_abstract"]
The Argo CD custom resource provides properties that control the configuration and behavior of your Argo CD instance.
...
|`version` |The tag to use with the container image for all Argo CD components.|NA | Latest {gitops-shortname} Version
|===
