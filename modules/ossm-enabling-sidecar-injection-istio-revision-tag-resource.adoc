...
----
+
In this example, the new tag is referencing your active revision `default-v1-23-2`. Now you can use the `istio-injection=enabled` label as if your revision was called `default`.
