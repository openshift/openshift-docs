...
[role="_abstract"]
You can view the compliance status for a specific control within a selected standard to ensure your environment meets detailed compliance requirements.
...
. In the *Controls* table, click a control. A side panel opens on the right side.
