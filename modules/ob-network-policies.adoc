...
[role="_abstract"]
Starting with {builds-shortname} 1.9, the Operator enforces a zero-trust network model in the `openshift-builds` namespace by automatically creating and managing NetworkPolicy resources.
