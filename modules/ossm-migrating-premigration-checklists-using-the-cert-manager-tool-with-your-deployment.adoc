...
= Check for the cert-manager tool in your 2.6 mesh

[role="_abstract"]

You must check if your deployment uses the cert-manager tool. If you are using the cert-manager tool with {SMProduct} 2.6, you must perform additional configurations before you can start migrating your deployments and workloads.
