...
[role="_abstract"]
To uninstall {lvms} that you installed by using {rh-rhacm}, delete the RHACM Policy custom resource (CR) that you created for installation after removing all provisioned storage resources.
