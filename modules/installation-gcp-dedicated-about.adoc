...
[role="_abstract"]
Google Cloud Dedicated (GCD) is a sovereign cloud platform that provides {gcp-short} technology in a fully isolated environment with strict data and operational sovereignty guarantees.
