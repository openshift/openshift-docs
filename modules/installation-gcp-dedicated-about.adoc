...
GCD is part of Google's sovereign cloud strategy, which addresses data residency, administrative access control, and operational sovereignty. Google's sovereign cloud portfolio includes multiple tiers:
