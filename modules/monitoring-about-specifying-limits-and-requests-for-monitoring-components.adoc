...
// tag::CPM[]
You can configure resource limits and request settings for the following core platform monitoring components:
...
// tag::UWM[]
You can configure resource limits and request settings for the following components that monitor user-defined projects:
