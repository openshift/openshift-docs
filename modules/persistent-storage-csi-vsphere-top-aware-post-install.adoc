...
:navtitle: Create vSphere storage topology postinstallation
...
.Procedure
. In the VMware vCenter vSphere client GUI, define appropriate zone and region categories and tags.
+
...
. In {product-title}, create failure domains. For more information, see "Specifying multiple regions and zones for your cluster on vSphere".
