...
You can use a tool such as Perses to display charts based on these metrics. For example, you can create a Perses dashboard to use in the {ocp} console that displays {product-title-short} data.