...
----
<1> Specifies the name of the {azure-short} Key Vault to be create.
<2> Specifies the name of the encryption key you to be created.
...
+
. Enable host-level encryption in {Azure}:
+
[source,terminal]
----
