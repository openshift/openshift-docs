...
<2> Information on the collector pods.
...
A status message similar to the following indicates that the collector pods cannot be scheduled because the node selector did not match any nodes:
