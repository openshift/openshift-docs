...
[NOTE]
====
* You can use the authenticated SCM API to configure Git connections for your cluster. This configuration allows you to provide a security token that enables all cluster users to access the repository. Additionally, you can choose different SCM providers and tokens for specific pipelines or tasks.
