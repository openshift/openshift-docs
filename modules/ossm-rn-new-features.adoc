...
//Check if this ends support for 2.3
...
//OSSM 2.6 supports both Istio 1.19 and Istio 1.20
...
//verify if this is still true for 2.6
//Asked in forum-ocp-tracing channel 06/24/2024
[NOTE]
====
{DTProductName} (Tempo) Stack is not supported on {ibm-z-title}.
====

//Update for 2.6 https://issues.redhat.com/browse/OSSM-5854
