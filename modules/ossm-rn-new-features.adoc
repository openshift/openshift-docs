...
* Native sidecars is supported only on {product} 4.16.
+
...
//Gateway API Update for 2.6 https://issues.redhat.com/browse/OSSM-5854 waiting for "Release Note Text" field to contain a summary of what users need to know for 2.6 vs 2.5
