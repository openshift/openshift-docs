...
:FeatureName: Single stack IPv6 support
...
This enhancements introduces an updated Technology Preview version of the {product-title} Gateway API. By default, the {product-title} Gateway API is disabled.
...
* xref:../../service_mesh/v2x/ossm-create-smcp.adoc#ossm-config-control-plane-infrastructure-node_ossm-create-smcp[Configuring all {SMProductShortName} control plane components to run on infrastructure nodes]
* xref:../../service_mesh/v2x/ossm-create-smcp.adoc#ossm-config-individual-control-plane-infrastructure-node_ossm-create-smcp[Configuring individual {SMProductShortName} control plane components to run on infrastructure nodes]
