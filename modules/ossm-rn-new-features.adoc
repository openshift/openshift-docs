...
Service Mesh 2.6 is based on Istio 1.1x, which brings in new features and product enhancements. While {SMProductName} supports many Istio 1.1x features, the following exceptions should be noted:
...
=== Integration with OTEL {DTProductName} (Tempo) Stack

 - final release of OSSM that includes support for Jaeger and ES - it will be removed in the next release. Customers should migrate to OTEL + Tempo.
- with this release Jaeger is disabled by default
