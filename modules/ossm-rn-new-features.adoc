...
This release of {ProductName} addresses Common Vulnerabilities and Exposures (CVEs) and bug fixes. This release upgrades Istio to version 1.4.10.
...
This release also added support for configuring cipher suites. For more information, see xref:../service_mesh/service_mesh_user_guide/ossm-security.adoc#ossm-security-cipher_ossm-security[Configuring cipher suites and ECDH curves].
