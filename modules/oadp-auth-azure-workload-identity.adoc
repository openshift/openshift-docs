...
= Authenticating OADP with Azure AD Workload Identity

[role="_abstract"]
You can use the following steps to authenticate the {oadp-short} Operator by using Azure Active Directory (AD) Workload Identity.
