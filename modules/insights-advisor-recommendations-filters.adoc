...
[role="_abstract"]
The {red-hat-lightspeed} advisor service can return a large number of recommendations. To focus on your most critical recommendations, you can apply filters to the advisor recommendations list on the {hybrid-console-second} to remove low-priority recommendations.
