...
:navtitle: OpenID Connect authentication
...
The Authentication Operator in {product-title} requires that the configured OIDC identity provider implements the OIDC discovery specification. For more information, see "OpenID Connect Discovery".
