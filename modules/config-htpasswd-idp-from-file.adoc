...
[role="_abstract"]
Configure an htpasswd identity provider by uploading a user file in the {cluster-manager} web user interface (UI). Add multiple static users from a preconfigured htpasswd file when you configure cluster access without the CLI.
