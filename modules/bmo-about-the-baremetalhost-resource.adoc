...
[role="_abstract"]
Use the `BareMetalHost` resource to manage bare-metal server lifecycle, including provisioning, firmware configuration, power state management, and hardware inventory. The resource contains two sections:
