...
[role="_abstract"]
You can install the External DNS Operator by using the {product-title} OperatorHub. You can then manage the Operator lifecycle directly from the web console.
