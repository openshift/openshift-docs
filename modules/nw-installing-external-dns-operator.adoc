...
[role="_abstract"]
You can install the External DNS Operator by using the {product-title} Software Catalog. The Operator can then manage its lifecycle directly from the web console.
