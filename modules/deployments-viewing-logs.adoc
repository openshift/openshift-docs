...
You can view the deployment logs to examine the information and records generated during a deployment.

.Procedure

. Stream the logs of the latest revision for a given `DeploymentConfig` object:
+
[source,terminal]
----
$ oc logs -f dc/<name>
