...
The procedure for adding kernel arguments described here
is a day-two operation and cannot be done at {product-title} installation.
Adding kernel arguments should only be done with caution and clear understanding
of the implications of the arguments you set.

[WARNING]
====
Improper use of kernel arguments can result in your systems becoming unbootable
and possibly destroying your cluster.
====
...
See link:https://access.redhat.com/solutions/rhel-smt[Simultaneous Multithreading] for general details
and link:https://bugzilla.redhat.com/show_bug.cgi?id=1752144[Bug 1752144] for
information on CPU capacity.
