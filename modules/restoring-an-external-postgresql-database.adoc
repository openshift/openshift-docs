...
This procedure focuses on restoring the database that has your {product-title-short} system data. You can perform a PostgreSQL database restore by using the vendor-recommended `pg_restore` command.
