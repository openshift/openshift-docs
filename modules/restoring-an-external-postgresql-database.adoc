...
By restoring an external PostgreSQL database, you can recover your {rh-rhacs-first} instance from a back up while maintaining your existing database setup. 
