...
For the NUMA Resources Operator to be fully operational you need to deploy the NUMAResourcesOperator custom resource and the NUMA-aware secondary pod scheduler. 