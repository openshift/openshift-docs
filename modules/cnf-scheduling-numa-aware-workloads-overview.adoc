...
For the NUMA Resources Operator to be fully operational you need to deploy the NUMAResourcesOperator custom resource with the `kind: NUMAResourcesOperator` and the NUMA-aware secondary pod scheduler with the `kind: NUMAResourcesScheduler`.  