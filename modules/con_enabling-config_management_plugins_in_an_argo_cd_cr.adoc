...
In Argo CD, the Config Management Plugin (CMP) is specified as a sidecar container for the Argo CD repo server container. For more information, see _Config Management Plugins_.
...
<3> Specify the name of volume mounts used in the repo server.