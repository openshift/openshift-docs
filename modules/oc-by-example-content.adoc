...
----
  ...
  oc new-app centos/ruby-25-centos9~https://github.com/sclorg/ruby-ex.git
...
----
  ...
  oc new-build centos/nodejs-8-centos9~https://github.com/sclorg/nodejs-ex.git
  ...
  oc new-build https://github.com/openshift/ruby-hello-world --source-image=openshift/jenkins-1-centos9 --source-image-path=/var/lib/jenkins:tmp
----
