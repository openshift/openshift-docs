...
[IMPORTANT]
====
If you configured a user-managed load balancer for your network, ensure that the timeout value for the user-managed load balancer is higher than the timeout value for the route service. This configuration prevents network congestion issues over the network.
====
