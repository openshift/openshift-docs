...
Sources for vulnerabilities depend on the scanner that is used in your system. {product-title-short} contains two scanners: StackRox Scanner and Scanner V4. Before release 4.8, the StackRox Scanner was the default scanner. Scanner V4 was introduced in release 4.4, and beginning with release 4.8 is the recommended image scanner.
