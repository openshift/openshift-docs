...
[role="_abstract"]
Unlike the `UserDefinedNetwork` (UDN) CR, the `ClusterUserDefinedNetwork` CR gives you more control over how pod traffic is carried on the cluster infrastructure and how it relates to networks outside the cluster.
