...
* You have created the link:https://docs.redhat.com/en/documentation/red_hat_openshift_service_on_aws/4/html/introduction_to_rosa/rosa-hcp-about-iam-resources#rosa-sts-ocm-roles-and-permissions-iam-basic-role_rosa-sts-about-iam-resources[ocm-role IAM role].
endif::openshift-rosa-hcp[]
ifdef::openshift-rosa[]
* You have created the link:https://docs.redhat.com/en/documentation/red_hat_openshift_service_on_aws_classic_architecture/4/html/introduction_to_rosa/rosa-sts-about-iam-resources#rosa-sts-ocm-roles-and-permissions-iam-basic-role_rosa-sts-about-iam-resources[ocm-role IAM role].
