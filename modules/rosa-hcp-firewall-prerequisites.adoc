...
* If you are using a firewall to control egress traffic from {product-title}, your VPC must be able to complete requests from the cluster to the Amazon S3 service, for example, via an Amazon S3 gateway.
