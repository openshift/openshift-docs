...
Before this update, uploading source code using the command-line interface (CLI) from a local machine caused file ownership permissions to change, which lead to build failures. With this update, file ownership permissions remain unchanged during source code upload, improving the build success rate.