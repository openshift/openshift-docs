...
= Using 3 Intel E810 NICs as PTP grandmaster clock
...
The second and third NICs receive the timing information from the first using the SMA1 Tx/Rx connections on the E810 NIC faceplate.
