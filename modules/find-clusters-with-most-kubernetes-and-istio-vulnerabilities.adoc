...
. Click one of the clusters from the list to view details about the cluster.
...
** *Related Entities* section, which shows the number of namespaces, deployments, policies, images, components, and CVEs the cluster has.
You can click these entities to view more details.
