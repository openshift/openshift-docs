...
= Use Red Hat entitlements by sharing the secret using the Shared Resources CSI Driver Operator
...
* You have logged in to your {OCP} cluster by using the `oc` command line utility as a user with cluster administrator permissions.
