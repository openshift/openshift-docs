...
The {cgu-operator-first} extends {rh-rhacm} with features to manage the rollout of upgrades or configuration throughout the lifecycle of the fleet of clusters.
