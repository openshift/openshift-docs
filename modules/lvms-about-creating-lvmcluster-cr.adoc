...
[role="_abstract"]
You can create an `LVMCluster` custom resource (CR) to configure {lvms} deployment and provision storage for your workloads by using the OpenShift CLI (oc), {product-title} web console, or {rh-rhacm-first}.
