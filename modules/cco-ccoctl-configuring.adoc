...
[role="_abstract"]
To create and manage cloud credentials outside of the cluster when the Cloud Credential Operator (CCO) operates in manual mode, extract and prepare the Cloud Credential Operator utility (`ccoctl`) binary.
