...
| If this setting is not specified, by default during installation, Scanner V4 is enabled. Disabling Scanner V4 negatively impacts the ability of {product-title-scan} to provide thorough and accurate scanning results.
