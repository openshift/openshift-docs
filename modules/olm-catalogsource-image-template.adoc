...
For an {product-title} {product-version} cluster, which uses Kubernetes 1.29, the `olm.catalogImageTemplate` annotation in the preceding example resolves to the following image reference:
