...
* Create the machine pool and define the instance type, worker node count, and Capacity Reservation ID:
...
* Describe the information of a specific machine pool in your cluster. The output should include the Capacity Reservation ID and type.
+
[source,terminal]
----
