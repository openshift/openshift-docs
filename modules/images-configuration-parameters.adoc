...
The `images.config.openshift.io/cluster` resource holds cluster-wide information
...
The `status` field of the `images.config.openshift.io/cluster` resource holds
