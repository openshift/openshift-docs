...
----
+
'data.caCertFileName': Specifies the CA certificates required to connect to your LLM provider. You can include one or more certificates.
...
----
+
'ols.additionalCAConfigMapRef.name': Specifies the name of `ConfigMap` object.
