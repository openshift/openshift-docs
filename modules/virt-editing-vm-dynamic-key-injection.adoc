...
The key is added to the VM by the QEMU guest agent, which is installed with {op-system-base-full} 9 and later. 

.Prerequisites

* The guest operating system is {op-system-base} 9 or later.
