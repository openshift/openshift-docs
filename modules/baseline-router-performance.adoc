...
[role="_abstract"]
To establish a performance baseline, review the role of the {product-title} Ingress Controller. As the router for your cluster, this component serves as the entry point for ingress traffic, directing requests to applications and services configured by using routes and ingresses.
