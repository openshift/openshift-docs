...
<azure_infra_name>:: Specifies the user-defined name for Azure resources. This value must match the name that was specified with the `--name` argument of the `ccoctl azure create-all` command.
