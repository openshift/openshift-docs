...
|Build or Deploy |Red Hat Package Manager in Image |Alerts when a deployment includes components of the Red{nbsp}Hat, Fedora, or CentOS package management system. |Enabled
