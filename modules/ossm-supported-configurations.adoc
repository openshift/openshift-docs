...
* Configurations where all {ProductShortName} components are contained in the {product-title} cluster in which the {ProductShortName} operates. {ProductName} does not support management of microservices that reside outside of the cluster.
