...
If you are on macOS and using link:https://brew.sh/[Homebrew] package manager, you can install link:https://formulae.brew.sh/formula/openshift-cli[openshift-cli] with;
...
Or you can install the OpenShift CLI (`oc`) binary on macOS by using the following procedure.
