...
[role="_abstract"]
Installing {product-title} on a single node alleviates some of the requirements for high availability and large scale clusters. However, you must still address several requirements.
