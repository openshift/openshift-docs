...
. Optional: The page defaults to a list of observed CVEs. If the feature to snooze CVEs is enabled, you can click *Show snoozed CVEs* to view them.
...
a|
* *ID*: The cluster ID.
//need more info - is this assigned by ACS or?
