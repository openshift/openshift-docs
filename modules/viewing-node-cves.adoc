...
[role="_abstract"]
You can view and filter vulnerabilities in nodes by using the {product-title-short} portal, including vulnerabilities in core Kubernetes components and container runtimes.
