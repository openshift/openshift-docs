...
. Click the *Elasticsearch Operator* provided by Red Hat to display information about the Operator.  Do not install Community versions of the Operators. Community Operators are not supported.
