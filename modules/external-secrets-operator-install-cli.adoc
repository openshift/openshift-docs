...
//content to be added
----
. Verify that the status of {external-secrets-operator} is `Running` by running the following command:
+
[source, terminal]
----
...
// content to be added
----
. Verify that the status of external-secrets pods is `Running` by running the following command:
+
[source, terminal]
----
