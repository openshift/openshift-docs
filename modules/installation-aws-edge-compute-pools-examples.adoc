...
<security_group_id>:: Specifies the name of the security group as it is displayed on the Amazon EC2 console. Ensure that you include the `sg` prefix. For example: `sg-1`.
