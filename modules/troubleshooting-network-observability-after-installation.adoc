...
[role="_abstract"]
Restore a missing network traffic menu entry in the *Observ* menu of the {product-title} console by manually registering the console plugin in the `FlowCollector` resource and the console operator configuration.
