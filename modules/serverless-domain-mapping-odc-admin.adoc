...
If you have cluster administrator permissions, you can create a `DomainMapping` custom resource (CR) by using the *Administrator* perspective in the {ocp-product-title} web console.
endif::[]

ifdef::openshift-dedicated,openshift-rosa[]
If you have cluster or dedicated administrator permissions, you can create a `DomainMapping` custom resource (CR) by using the *Administrator* perspective in the {ocp-product-title} web console.
endif::[]
