...
. Re-create necessary network policies in the new {SMProduct} 3.2 control plane namespace.

. Re-create network policies for each namespace that was part of the {SMProduct} 2.6 mesh.
