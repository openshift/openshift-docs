...
In the {gitops-shortname} context, you can have a control plane for every Argo CD you install. A {gitops-shortname} control plane is any namespace where you can install Argo CD. This control plane allows you to provision, manage, and operate Argo CD across networks, instances, and clusters.
+
