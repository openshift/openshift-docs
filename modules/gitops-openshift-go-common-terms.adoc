...
//
// * discover/about-redhat-openshift-gitops.adoc
...
[role="_abstract"]
Common OpenShift {gitops-shortname} terms and definitions used throughout the documentation.
...
In the {gitops-shortname} context, you can have a control plane for every Argo CD you install. A {gitops-shortname} control plane is any namespace where you can install Argo CD. With this control plane, you can provision, manage, and operate Argo CD across networks, instances, and clusters.
+
...
* link:https://argo-cd.readthedocs.io/en/stable/user-guide/projects[Argo CD projects]
* link:https://argo-cd.readthedocs.io/en/stable/operator-manual/declarative-setup/#projects[AppProject CR declarative setup]
* link:https://docs.openshift.com/container-platform/latest/getting_started/openshift-overview.html#getting-started-openshift-common-terms_openshift-overview[OpenShift common terms]
