...
[NOTE]
====
The Metering Operator does not autoscale the Reporting Operator based on the load in the cluster. Therefore, DERPEEDOO usage for the Reporting Operator pod does not increase as the cluster grows.
====
