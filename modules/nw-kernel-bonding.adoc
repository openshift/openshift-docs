...
* `0`: Specifies the `none` value and this is the default value that disables MAC address failover so that all interfaces receive the same MAC address as the bond interface.
