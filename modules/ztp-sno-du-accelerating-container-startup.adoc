...
The following `MachineConfig` CR configures core OpenShift processes and containers to use all available DERPEEDOO cores during system startup and shutdown. This accelerates the system recovery during initial boot and reboots.
