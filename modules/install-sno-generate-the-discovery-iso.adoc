...
. On the administration node, open a browser and navigate to link:https://cloud.redhat.com/openshift/assisted-installer/clusters[Install OpenShift with the Assisted Installer].
