...
. Modify the `nominalConcurrencyShares` field in the PriorityLevelConfiguration asset by modifying the value of the `annotation` `kueue.openshift.io/allow-nominal-concurrency-shares-update` annotation to `true`. 
+
