...
spec:
  ...
  - name: pingsource-mt-adapter
    annotations:
      ...
      "sidecar.istio.io/rewriteAppHTTPProbers": "true"
----
<1> Enables sidecar injection for Knative Eventing pods.
+
:FeatureName: The Knative Eventing integration with {SMProductShortName}
[IMPORTANT]
====
{FeatureName} is not supported for InMemoryChannel and KafkaChannel.
====
+
include::snippets/developer-preview.adoc[leveloffset=+2]
...
spec:
  ...
  - name: kafka-sink-receiver
    annotations:
      ...
      "sidecar.istio.io/rewriteAppHTTPProbers": "true"
----
<1> Enables sidecar injection for Knative Kafka pods.
+
:FeatureName: The Knative Kafka integration with {SMProductShortName}
[IMPORTANT]
====
{FeatureName} is not supported for InMemoryChannel and KafkaChannel.
====
