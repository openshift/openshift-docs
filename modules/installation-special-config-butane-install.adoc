...
+
.. To save the latest version of Butane, save the `butane` image to your current directory:
+
[source,terminal]
----
...
----
+
.. Optional: For a specific architecture, such as aarch64 or ppc64le, indicate the appropriate URL:
+
[source,terminal]
----
