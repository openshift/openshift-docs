...
[IMPORTANT]
====
This method applies to {ocp-product-title} 4.10 and later. For older versions, see the following section.
====
...
* Upgrade {ocp-product-title} 4.10 or later.
...
. After you add the annotation, verify that the `appProtocol` value of the Kourier service is `h2c`:
+
[source,terminal]
----
