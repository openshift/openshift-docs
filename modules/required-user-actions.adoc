...
|No action needed. The Operator fully automates rotation.
...
[NOTE]
====
Central switches to certificates signed by the new CA and older clusters can not trust the certificates.
====
