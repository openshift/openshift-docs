...
[role="_abstract"]
Review the available commands for managing backup storage locations with the VMDP CLI. This helps you to connect, disconnect, and manage your BSL connections.
