...
[role="_abstract"]
The etcd Operator deploys and manages the etcd cluster for the {product-title} control plane by observing state, analyzing differences, and correcting drift.
