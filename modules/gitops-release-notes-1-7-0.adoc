...
{gitops-title} 1.7.0 is now available on {OCP} 4.10, 4.11, and 4.12.
...
* With this update, to use the *Environments* page in the *Developer* perspective, you must upgrade if you are using a {gitops-title} version prior to 1.7 and {OCP} 4.15 or above. link:https://issues.redhat.com/browse/GITOPS-2415[GITOPS-2415] 
