...
[role="_abstract"]
You can manage the resources on your AWS Outpost similarly to those on a cloud-based AWS cluster if you configure your {product-title} cluster to accommodate several requirements and limitations.
