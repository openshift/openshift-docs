...
[source,terminal]
----
kubectl apply -f argocd.yaml -n <any-namespace>
----
+
** You can view that the following `host name` attribute is added in the `keycloak` route. 
+
.Example output of the `host name` attribute
+
[source,yaml]
----
kind: Route
