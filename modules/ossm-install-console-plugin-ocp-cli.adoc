...
= Install the OSSMC plugin with the CLI

[role="_abstract"]

Create an `OSSMConsole` resource from the command line to add {SMProductShortName} observability views to the {ocp-short-name} web console.
