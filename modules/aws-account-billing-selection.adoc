...
* When using the web interface to deploy {product-title}, verify that the *AWS billing account* drop-down is set to the AWS account that accepted the private offer if the purchased quota is intended for the cluster you are creating.
