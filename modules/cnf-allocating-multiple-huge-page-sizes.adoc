...
[role="_abstract"]
Configure multiple huge page sizes within the same container to support pods with different memory requirements by defining various size and count combinations in the performance profile.
