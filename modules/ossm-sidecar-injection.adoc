...
Automatic injection using annotation removes the need to label projects. The webhook checks the configuration of pods deploying into all projects to see if they are opting in to injection with the appropriate annotation.
