...
+
You can also access this option by opening the Options menu {kebab} for a selected VM, then selecting *Migration* -> *Storage*.
+
The *Migrate VirtualMachine storage* page opens.

. To review the VMs you want to migrate, click the link that identifies the number of VMs and volumes. Click *View more* to see the full list.
