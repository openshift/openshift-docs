...
[role="_abstract"]
Enable Dex to use the GitHub connector for SSO authentication with Argo CD by registering the application and configuring the connector in the Argo CD CR.
