...
ifdef::installing-oadp-azure,installing-oadp-gcp,installing-oadp-mcg,installing-oadp-ocs,oadp-backing-up-vms,virt-installing-configuring-oadp[]
...
ifdef::oadp-backing-up-vms,virt-installing-configuring-oadp[]
+
[source,yaml,subs="attributes+"]
----
apiVersion: oadp.openshift.io/v1alpha1
