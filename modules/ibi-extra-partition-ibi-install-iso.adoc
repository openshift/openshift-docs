...
[NOTE]
====
The `var/lib/containers` partition requires at least 500 GB to ensure adequate disk space for precached images.
====

.Procedure

. Edit the `image-based-installation-config.yaml` to configure additional partitions:
+
...
<7> Specify the size of parition in Mbs. 
<8> Specify the starting position on the disk in Mbs for the additional partition. You must specify a starting point larger that the partition for `var/lib/containers`.
...
[source,terminal]
----
vda    252:0    0  140G  0 disk 
├─vda1 252:1    0    1M  0 part 
├─vda2 252:2    0  127M  0 part 
├─vda3 252:3    0  384M  0 part /var/mnt/boot
├─vda4 252:4    0  120G  0 part /var/mnt
├─vda5 252:5    0  500G  0 part /var/lib/containers
└─vda6 252:6    0  380G  0 part 
----
