...
.. Navigate to the dynamic plugins configuration file in your {rh-rhdh} setup, for example, `app-config.yaml`.
...
[NOTE]
====
To display the vulnerability data, each entity in the {rh-rhdh} catalog must reference the {product-title-short} deployments.
