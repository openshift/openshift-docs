...
+
For more information, see "Installing dynamic plugins by using the Helm chart" in the {rh-rhdh} documentation.
...
The entities in the {rh-rhdh} catalog can have the following values:
...
. Click an entity and verify that the *{product-title-short}* tab is displayed.
