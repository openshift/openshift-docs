...
* You have Grafana installed and configured on your {ocp} cluster. For a community-based example, see https://kuadrant.io/blog/grafana-on-openshift-for-kuadrant[Installing Grafana on OpenShift for Kuadrant Observability].
