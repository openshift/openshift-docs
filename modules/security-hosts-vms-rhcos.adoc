...
:navtitle: Secure containers on {op-system-first}
[id="security-hosts-vms-rhcos_{context}"]
= Securing containers on {op-system-first}

[role="_abstract"]
You should understand the security enhancements you can make to the containers in your {product-title} clusters.
