...
See the Red Hat Enterprise Linux 9 container documentation for details on the types of namespaces.
endif::[]
...
* link:https://docs.redhat.com/en/documentation/red_hat_enterprise_linux/9/html-single/building_running_and_managing_containers/index[Building, running, and managing RHEL 9 containers]
* link:https://www.redhat.com/en/resources/openshift-security-guide-ebook[Red Hat OpenShift security guide book]
