...
// * [UNUSED] secure/using-tekton-chains-for-openshift-pipelines-supply-chain-security.adoc
...
The {pipelines-title} Operator does not give the following functions to limit potential security issues:
