...
[NOTE]
====
{product-rosa} does not let you create the Kiali resource in a Red Hat managed namespace. See _Restrictions on Kiali configuration_ in the following section.
====
...
[NOTE]
====
{product-dedicated} does not let you create the Kiali resource in a Red Hat managed namespace. See _Restrictions on Kiali configuration_ in the following section.
====
