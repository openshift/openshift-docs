...
[NOTE]
====
If you are unable to complete the last two prerequisites, the cluster administrator can establish the necessary RBAC so that you can enable service accounts to use the `SharedConfigMap` CR.
====
