...
[role="_abstract"]
You do not usually need to override the detected MTU. During installation, the cluster network MTU is set automatically based on the primary network interface MTU of cluster nodes.
