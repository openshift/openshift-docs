...
If you want to trigger the pipeline run again when using the `body` field for event matching, you can close and reopen the pull request or merge request, or or add a new SHA commit. You can add a new SHA commit by using the following command:
