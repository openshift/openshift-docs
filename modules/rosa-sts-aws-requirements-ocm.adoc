...
To use {cluster-manager}, you must link the roles in your Red Hat user organization and your Red Hat account to your AWS account. This linking concept is also known as account association.