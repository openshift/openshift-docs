...
[role="_abstract"]
{ols-official} 1.0.3 resolves a technical limitation that prevented BYO Knowledge images with floating tags from updating correctly. This fix ensures that {ols-long} pulls the latest version of custom knowledge images upon service restart, eliminating issues with stale data.
