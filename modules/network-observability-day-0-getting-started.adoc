...
[IMPORTANT]
====
This Technology Preview feature is intended for testing and development environments with {product-title} 4.22. The feature gate requirement is temporary and will be removed when this feature reaches General Availability (GA).
...
Network Observability Operator Day 0 configuration is a Technology Preview feature that requires the `NetworkObservabilityInstall` feature gate. To use this feature during cluster installation, you must:
