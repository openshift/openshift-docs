...
:navtitle: Configure image registry repository mirroring
...
** link:https://docs.redhat.com/en/documentation/red_hat_quay/3/html/manage_red_hat_quay/arch-mirroring-intro#enabling-repository-mirroring-quay[{quay} Repository Mirroring]
