...
[role="_abstract"]
Use customizable Zero Touch Provisioning (ZTP) custom resource (CR) examples to define advanced cluster configurations, networking, and storage settings for {product-title} installations with the Agent-based Installer.
