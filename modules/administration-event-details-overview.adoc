...
[role="_abstract"]
The administration event details page provides log information about errors and events, including resource details, timestamps, and occurrence counts to help you diagnose and fix issues.

The administration event provides log information that describes the error or event.

The logs offer the following information:
...
* *Event ID*: A unique identifier composed of alphanumeric characters that {product-title-short} assigns to each event. Event IDs can be useful in identifying, tracking, and managing events over time.
