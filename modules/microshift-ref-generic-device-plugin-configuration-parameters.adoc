// microshift-ref-generic-device-plugin-configuration-parameters.adoc
...
[cols="1,2"]
|===
|Parameter|Descriptionort} `GenericDevicePlugin` API. All of the following parameters in this table are subsections in the `genericDevicePlugin` section of the {microshift-short} configuration.
