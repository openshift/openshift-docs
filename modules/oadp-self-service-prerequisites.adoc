...
** Created a namespace admin user account. See "Configuring an htpasswd identity provider", for more details.
...
* Optionally, the cluster administrator can create a `NonAdminBackupStorageLocation` (NABSL) for the namespace admin user.
