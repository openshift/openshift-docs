...
. Generate the configuration policies by creating a `PolicyGenerator` custom resource (CR). You can use the following sample manifest:

* `out/argocd/example/acmpolicygenerator/ran-example-reboot.yaml`
