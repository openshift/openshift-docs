...
[role="_abstract"]
Common issues when using `deploymentConfig` and their resolutions.
...
Bundle annotations take precedence over `deploymentConfig` annotations when keys conflict. Check bundle annotations:
