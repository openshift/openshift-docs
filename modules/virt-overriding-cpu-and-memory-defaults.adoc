...
= Overriding DERPEEDOO and memory defaults

Modify the default settings for DERPEEDOO and memory requests and limits for your use case by adding the `spec.resourceRequirements.storageWorkloads` stanza to the `HyperConverged` custom resource (CR).
