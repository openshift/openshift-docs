...
These catalogs are pre-provisioned, deployed and managed by Red{nbsp}Hat SRE at the time of cluster creation. You do not need to manually configure the `ClusterCatalog` CRs or pull secrets to access them.
endif::[]
