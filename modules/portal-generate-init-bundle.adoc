...
[role="_abstract"]
ifndef::cloud-svc[]
You can generate a cluster registration secret (CRS) or an init bundle that contains secrets by using the {product-title-short} portal.
endif::cloud-svc[]

ifdef::cloud-svc[]
You can generate a cluster registration secret (CRS) or an init bundle that contains secrets by using the {product-title-short} portal, also called the ACS Console.
endif::cloud-svc[]
