...
where:
+
`<module_name>`:: Specifies the name of the kmod to load.
`<container_image_name>`:: Specifies the name of the container image. For example, `quay.io/myuser/my-driver:<kernelversion`.
`<unsigned_image_name>`:: Specifies the name of the unsigned image. For example, `quay.io/myuser/my-driver:<kernelversion`.
