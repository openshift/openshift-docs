...
* Enable integration with third-party data services (such as Amazon Relational Database Service (RDS) or {gcp-full} SQL) to store and manage data outside of the cluster and/or cloud provider.
