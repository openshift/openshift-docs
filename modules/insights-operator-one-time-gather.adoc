...
insights-operator image:: Specifies your `insights-operator` image version.
...
insights-operator image:: Specifies your `insights-operator` image version. Replace any existing value with your `insights-operator` image version.
