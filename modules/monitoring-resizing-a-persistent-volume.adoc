...
[role="_abstract"]
// tag::CPM[]
Resize a persistent volume (PV) for monitoring components, such as Prometheus or Alertmanager to meet your capacity requirements.
// end::CPM[]
// tag::UWM[]
You can resize a persistent volume (PV) for the instances of Prometheus, Thanos Ruler, and Alertmanager to meet your capacity requirements.
// end::UWM[]
...
[NOTE]
====
This section about resizing a persistent volume applies to the following distributions:
...
* You have configured at least one PVC for core monitoring components.
// end::CPM[]
// tag::UWM[]
