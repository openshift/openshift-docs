...
. Open the OpenShift metrics explorer available at
`https://<cluster_fqdn>/monitoring/query-browser` in a browser window.
. Obtain a list of VirtualMachines with incorrectly configured storage classes
