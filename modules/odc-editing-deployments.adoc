...
[role="_abstract"]
To change the strategy, images, environment variables, or advanced options for a deployment in {product-title}, you can edit the deployment in the *Developer* perspective. 
