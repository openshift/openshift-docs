...
See link:https://docs.redhat.com/en/documentation/openshift_container_platform/4.19/html/networking/hardware-networks#supported_devices_configuring-hardware-offloading[Supported devices] for more information.
...
See link:https://docs.redhat.com/en/documentation/openshift_container_platform/4.19/html/networking/hardware-networks#nw-sriov-nic-mlx-secure-boot_configuring-sriov-device[Configuring an SR-IOV network device] for more information.
