...
[IMPORTANT]
====
When you use an external database:

* Its infrastructure manages persistent storage for Central DB. Therefore, do not configure persistence settings for the Central DB within the {product-title-short} installation configuration.
