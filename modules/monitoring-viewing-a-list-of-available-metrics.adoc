...
[NOTE]
====
This section about viewing a list of available metrics applies to the following distributions:
...
* You have obtained the cluster API route for Thanos Querier.
...
. If you have not obtained the cluster API route for Thanos Querier, run the following command:
+
[source,terminal]
----
...
----
+
Replace `<thanos_querier_route>` with the cluster API route for Thanos Querier.
