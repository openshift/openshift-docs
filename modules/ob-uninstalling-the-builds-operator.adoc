...
* link:https://docs.redhat.com/en/documentation/openshift_container_platform/4.21/html/operators/administrator-tasks#olm-deleting-operators-from-a-cluster[Deleting Operators from a cluster]