...
. Enter a name for the integration. You can save the integration only after you specify a name for the integration.
...
** You can save the integration only after you specify a name and value for the public key.
====
...
** You can save the integration only after you specify a certificate OpenID Connect (OIDC) issuer and certificate identity for the certificate verification.
====
