...
[id='security-context-constraints-about-{context}']
...
- Whether a pod can run rivileged containers.
...
The cluster contains seven default SCCs:
...
[id='authorization-SCC-strategies-{context}']
== SCC Strategies
...
[id='authorization-controlling-volumes-{context}']
== Controlling volumes
