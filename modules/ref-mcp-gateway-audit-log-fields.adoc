...
[role="_abstract"]
Understand the {mcpg} audit log fields by using the reference table for descriptions of each field and the source and type of information that each provides.
