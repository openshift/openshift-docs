...
[NOTE]
====
The `spec.operand.image` setting now requires a `-rhel9` image to be defined for use with the 4.16 release of {product-title}. The following example shows the use of `-rhel9` to acquire the correct image.
====
