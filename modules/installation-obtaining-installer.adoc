...
ifndef::restricted[]
ifdef::ibm-z-reg,ibm-z-reg-kvm[ your provisioning machine.]
ifndef::ibm-z-reg,ibm-z-reg-kvm,private[ the host you are using for installation.]
ifdef::private[]
...
ifndef::ibm-z-reg,ibm-z-reg-kvm,private,vsphere[* You have a computer that runs Linux or macOS, with 500 MB of local disk space.]
