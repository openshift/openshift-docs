...
ifdef::openshift-origin[]
+
If you do not have a pull secret from the Red Hat OpenShift Cluster Manager site, you can use a pull secret for another private registry. If you do not need the cluster to pull images from private repositories, you can use `{"auths":{"fake":{"auth":"aWQ6cGFzcwo="}}}`.
+
