...
. Navigate to the link:https://access.redhat.com/downloads/content/290/[OpenShift Container Platform downloads page] on the Red{nbsp}Hat Customer Portal.
. Select your *Product Variant* and *Version* from the dropdown menus.
. Download the installation program that corresponds with your host operating system and architecture, and place the file in the directory where you will store the installation configuration files.
endif::[]
