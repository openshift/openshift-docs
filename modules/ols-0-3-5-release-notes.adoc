...
[role="_abstract"]
{ols-official} 0.3.5 is now generally available for {ocp-product-title} 4.15 and later.
...
[role="_abstract"]
{ols-official} 0.3.5 introduces persistent conversation history using PostgreSQL and a Technology Preview feature for LLM cluster interaction.
