...
To prepare for your migration to {SMProduct} 3, you must disable legacy add-ons in your {SMProduct} 2.6 `ServiceMeshControlPlane` resource and reconfigure replacements for the features that those add-ons provided.
