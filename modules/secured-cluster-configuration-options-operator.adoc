...
| The name of the storage class to use for the PVC. If your cluster is not configured with a default storage class, and no value is provided for this parameter, ephemeral storage will be used.
