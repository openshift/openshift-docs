...
[role="_abstract"]
Provide secure connections with OpenShift routes by using re-encrypted TLS termination to protect data in transit between external services and your cluster.
