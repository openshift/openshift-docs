...
[role="_abstract"]
You can specify values for the build strategy parameters in your `BuildRun` custom resource (CR). If you have provided a value for a parameter that is also defined in the `Build` resource with the same name, then the value defined in the `BuildRun` resource takes priority.
