...
[role="_abstract"]
When troubleshooting telemetry generation by the instrumentation libraries, check the endpoint, look for errors in your application logs, and verify that the Collector is receiving the telemetry.
