...
[role="_abstract"]
You can add either an allowlist of registries or an individual repository within a registry for image pull and push actions by editing the `image.config.openshift.io/cluster` custom resource (CR).
