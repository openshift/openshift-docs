...
The following policy indicates that only images from the `example.com`, `quay.io`, and `quay.io/openshift-community` registries are accessible for image pulls and pushes:
endif::[]
+
