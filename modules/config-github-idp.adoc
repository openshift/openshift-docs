...
[role="_abstract"]
Configure a GitHub identity provider to validate usernames and passwords against the OAuth authentication server of GitHub or GitHub Enterprise and access your {product-title} cluster. OAuth facilitates a token exchange flow between {product-title} and GitHub or GitHub Enterprise.
