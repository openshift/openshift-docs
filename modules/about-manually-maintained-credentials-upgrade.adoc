...
image::334_OpenShift_cluster_updating_and_CCO_workflows_0523_4.10_B.png[Decision tree showing the possible update paths for your cluster depending on the configured CCO credentials mode.]
