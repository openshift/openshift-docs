...
spec:
  ...
  startingCSV: multiarch-tuning-operator.v{mto-version}
----
...
multiarch-tuning-operator.v1.1.0   Multiarch Tuning Operator   1.1.0     multiarch-tuning-operator.v1.0.0      Succeeded
----
+
