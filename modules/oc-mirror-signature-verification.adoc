...
:navtitle: Enable signature verification for oc-mirror plugin v2
[id="oc-mirror-about-sig-mirroring-verification_{context}"]
= Enabling signature verification for oc-mirror plugin v2

[role="_abstract"]
Starting with {product-title} 4.19, the oc-mirror plugin v2 supports signature verification, which is disabled by default.
