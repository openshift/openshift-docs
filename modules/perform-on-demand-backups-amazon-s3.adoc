...
[role="_abstract"]
Use the {product-title-short} portal to trigger manual backups of {product-title} on Amazon S3.
...
[NOTE]
====
Currently, when you select the *Trigger Backup* option, there is no notification. However, {product-title} begins the backup task in the background.
====
