...
== Manifest removal scenario for OSTree systems
Use the following procedure in the data removal scenario for OSTree systems to completely delete the resource defined in the kustomize manifests.
