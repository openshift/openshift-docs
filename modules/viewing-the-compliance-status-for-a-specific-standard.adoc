...
[role="_abstract"]
You can view all compliance controls for a single compliance standard to ensure your environment adheres to industry and regulatory requirements.
...
. Click a standard to view information about all the controls for that standard.