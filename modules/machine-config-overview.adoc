...
* Machine configs are processed by name in alphabetic order. The render controller uses the first machine config in the list as the base and appends the rest to the base machine config.
