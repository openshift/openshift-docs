...
MCO uses Ignition as the configuration format. {product-title} 4.6 moved from Ignition config specification version 2 to version 3. For more information, see "Configuration Specification v3.5.0 (Ignition documentation)".
