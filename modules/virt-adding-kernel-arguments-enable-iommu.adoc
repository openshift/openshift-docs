...
----
* If IOMMU is enabled, output as shown in the following example is displayed:
+
.Example output

[source,terminal]
----
[root@xxx]# ls -l /sys/kernel/iommu_groupstotal
total 0
drwxr-xr-x. 3 root root 0 Jul  2 23:06 xx
drwxr-xr-x. 3 root root 0 Jul  2 23:06 xx
drwxr-xr-x. 3 root root 0 Jul  2 23:06 xx
drwxr-xr-x. 3 root root 0 Jul  2 23:06 xx
drwxr-xr-x. 3 root root 0 Jul  2 23:06 xx
----
* If IOMMU is not enabled, output as shown in the following example is displayed:
+
.Example output

[source,terminal]
----
[root@xxx~]# ls -l /sys/kernel/iommu_groups
total 0
----
