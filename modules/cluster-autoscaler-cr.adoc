...
* `Enabled`: The autoscaler cordons the node and drains any pods before deleting that node. This is the default.

* `Disabled`: The autoscaler does not cordon the node before deleting that node. 
