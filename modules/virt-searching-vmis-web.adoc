...
. To open advanced search options manually, click the sliders icon next to the search bar. You can specify one or more of the following filters: *Name*, *Project*, *Description*, *IP*, *Date created*, *vCPU*, and *Memory*.
