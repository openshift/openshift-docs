...
[NOTE]
====
When you hide the auto-discovered CIDR blocks, the system hides the auto-discovered CIDR blocks for all clusters, and not only for the selected cluster in the network graph.
====
