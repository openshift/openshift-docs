...
+
NOTE: At this point in the sequence, the installer begins creating the cluster. Optionally, in the {rh-virtualization} Administration Portal, watch the installer create the virtual machines in *Compute* -> *Cluster*.
+
. While the installer is running, visit the {rh-virtualization} Administration Portal and verify that the installer creates and runs the virtual machines for the {product-title} nodes.
