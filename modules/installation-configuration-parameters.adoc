...
// IPv4-only on platforms whose vendors do not provide IPv6: Azure Stack Hub (ash), IBM Cloud VPC (ibm-cloud), IBM Power Virtual Server (ibm-power-vs). All other platforms get dual-stack / IPv6 guidance.
ifdef::ash,ibm-cloud,ibm-power-vs[]
...
endif::ash,ibm-cloud,ibm-power-vs[]

ifndef::ash,ibm-cloud,ibm-power-vs[]
