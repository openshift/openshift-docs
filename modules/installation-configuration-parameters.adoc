...
// * installing/installing_ibm_z/installation-config-parameters-ibm-z-reg.adoc
// * installing/installing_ibm_power/installation-config-parameters-ibm-power-reg.adoc
...
// * installing/installing_ibm_powervs/installation-config-parameters-ibm-power-reg-vs.adoc
...
ifeval::["{context}" == "installation-config-parameters-ibm-z-reg"]
:ibm-z-reg:
endif::[]
ifeval::["{context}" == "installation-config-parameters-ibm-power-reg"]
:ibm-power-reg:
endif::[]
...
ifeval::["{context}" == "installation-config-parameters-ibm-power-reg-vs"]
:ibm-power-reg-vs:
endif::[]
...
|The PowerVSResourceGroup is the resource group in which {iibm-cloud-bm-reg} Virtual Server resources are created. If using an existing VPC, the existing VPC and subnets should be in this resource group.
...
ifndef::bare,ibm-power-reg,ibm-z-reg,vsphere[]
Only IPv4 addresses are supported.
endif::bare,ibm-power-reg,ibm-z-reg,vsphere[]

ifdef::bare,ibm-power-reg,ibm-z-reg,vsphere[]
...
|
Required if you use `networking.machineNetwork`. An IP address block. The default value is `10.0.0.0/16` for all platforms other than libvirt and {iibm-cloud-bm-reg} Virtual Server. For libvirt, the default value is `192.168.126.0/24`. For {iibm-cloud-bm-reg} Virtual Server, the default value is `192.168.0.0/24`.
ifdef::ibm-cloud[]
...
ifndef::bare,ibm-power-reg-vs[]
For example, `10.0.0.0/16`.
endif::bare,ibm-power-reg-vs[]
ifdef::bare[]
...
ifndef::aws,bare,gcp,ibm-power-reg,ibm-z-reg,azure,ibm-power-reg-vs[]
...
|String
endif::aws,bare,gcp,ibm-power-reg,ibm-z-reg,azure,ibm-power-reg-vs[]
...
ifdef::ibm-power-reg,ibm-power-reg-vs[]
|`compute.architecture`
...
|String
endif::ibm-power-reg,ibm-power-reg-vs[]
endif::openshift-origin[]
...
ifndef::openshift-origin[]
ifndef::aws,bare,gcp,ibm-z-reg,ibm-power-reg,azure,ibm-power-reg-vs[]
|`controlPlane.architecture`
|Determines the instruction set architecture of the machines in the pool. Currently, clusters with varied architectures are not supported. All pools must specify the same architecture. Valid values are `amd64` (the default).
|String
endif::aws,bare,gcp,ibm-z-reg,ibm-power-reg,azure,ibm-power-reg-vs[]
...
ifndef::openshift-origin,ibm-power-reg-vs[]
|`fips`
...
====
|`false` or `true`
endif::openshift-origin,ibm-power-reg-vs[]
|`imageContentSources`
...
|The ClusterOSImage is a pre-created {iibm-cloud-bm-reg} Virtual Server boot image that overrides the default image for cluster nodes.
|String. For example, `existing_cluster_os_image`.

|`platform.powervs.defaultMachinePlatform`
|The DefaultMachinePlatform is the default configuration used when installing on {iibm-cloud-bm-reg} Virtual Server for machine pools that do not define their own platform configuration.
