...
Optional {rh-openstack} parameters for the failure domains feature are described in the following table:
...
|`platform.openstack.failuredomains.portTargets.networkID`
|
|

|`platform.openstack.failuredomains.portTargets.fixedIP`
|
|

|`platform.openstack.failuredomains.portTargets.tags`
|
|
|====
endif::osp[]
