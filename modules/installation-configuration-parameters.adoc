...
|platform:
  gcp:
    dns:
      privateZone:
        name:
|The name of the private DNS zone. This parameter is only used during shared VPC installations. You can use a private DNS zone in a second service project that is distinct from the projects specified by `projectID` or `networkProjectID`.
|String.
...
|platform:
  gcp:
    dns:
      privateZone:
        projectID:
|The ID of the project that contains the private zone from the preceding parameter.
|String.
