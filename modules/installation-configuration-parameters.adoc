...
|platform:
  vsphere:
    vcenters:
|Configures the connection details so that services can communicate with a vCenter server. Currently, you can specify up to three vCenters; however, multiple vCenters is only supported in Tech Preview.
