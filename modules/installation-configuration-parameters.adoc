...
* The `baremetal` Operator allows {product-title} to manage baremetal machines in your cluster.
* The `marketplace` Operator populates OperatorHub with a default set of Operator catalogs. If you disable this Operator, you must take additional steps to populate OperatorHub.
* The `openshift-samples` Operator provides a catalog of sample content for building applications.
|String
