...
If set, it leaves the cluster in a not functional state. For more information, refer to link:https://bugzilla.redhat.com/show_bug.cgi?id=1953035[BZ#1953035].
endif::[]
endif::[]
