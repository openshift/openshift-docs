...
* All machines in a dual-stack cluster must be Nitro-based and support IPv6 addressing. For example, the default instance type `m6i.xlarge` is supported for dual-stack clusters.
