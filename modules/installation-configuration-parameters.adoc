...
|platform:
  gcp:
    sovereignCloud:
      region:
|The Google Cloud Dedicated sovereign cloud region name. This value must match the value in `platform.gcp.region`. This parameter is required when installing on Google Cloud Dedicated.

*Value:* String. The Google Cloud Dedicated region name provided by your local operating partner, such as `u-germany-northeast1`.
...
|platform:
  gcp:
    sovereignCloud:
      apiEndpoints:
        compute:
|The custom Compute Engine API endpoint URL for Google Cloud Dedicated. This parameter is required when installing on Google Cloud Dedicated.

*Value:* String. The URL format is `https://compute.<universe_domain>/compute/v1/`, where `<universe_domain>` is the universe domain provided by your local operating partner.
...
|The custom Cloud Resource Manager API endpoint URL for Google Cloud Dedicated. This parameter is required when installing on Google Cloud Dedicated.

*Value:* String. The URL format is `https://cloudresourcemanager.<universe_domain>/`, where `<universe_domain>` is the universe domain provided by your local operating partner.
