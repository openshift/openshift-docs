...
* If your infrastructure uses IPv6 in a Dynamic Host Configuration Protocol (DHCP) server and your cluster does not support IPv6, you can disable IPv6 on your infrastructure.
