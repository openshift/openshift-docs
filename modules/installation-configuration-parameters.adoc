...
ifndef::aws,bare,ibm-power,ibm-z,azure-mixed-arch[]
...
|String
endif::aws,bare,ibm-power,ibm-z,azure-mixed-arch[]
...
ifdef::azure-mixed-arch[]
|`compute.architecture`
|Determines the instruction set architecture of the machines in the pool. Currently, heterogeneous clusters are in technology preview. Valid values are `amd64` and `arm64`.

:FeatureName: Heterogeneous clusters for {product-title} on Azure installer-provision infrastructure installations
include::snippets/technology-preview.adoc[leveloffset=+1]

|String
endif::azure-mixed-arch[]
...
ifndef::aws,bare,ibm-z,ibm-power,azure-mixed-arch[]
|`controlPlane.architecture`
|Determines the instruction set architecture of the machines in the pool. Currently, clusters with varied architectures are not supported. All pools must specify the same architecture. Valid values are `amd64` (the default).
|String
endif::aws,bare,ibm-z,ibm-power,azure-mixed-arch[]
...
ifdef::azure-mixed-arch[]
|`controlPlane.architecture`
|Determines the instruction set architecture of the machines in the pool. Currently, heterogeneous clusters are in technology preview. Valid values are `amd64` (the default).
