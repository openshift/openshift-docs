...
[id="support-generating-a-sosreport-archive-9_{context}"]
= Generating a sosreport archive for an {product-title} cluster node in {op-system} 9.x
...
* Your cluster is running {op-system-first} 9.x.
