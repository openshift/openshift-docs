...
Where:
+
`<machine_set_name>`:: Specify a name for the compute machine set.
...
----
`spec`:: Specify the details for your environment. These parameters are provider specific. For more information, see the sample Cluster API compute machine set YAML for your provider.
--
