...
* Before this update, if you used {pac}, in the *Repository details* page of the web console the list of pipeline runs did not display correctly. With this update, the list of pipeline runs displays correctly.
