...
ifdef::infra[]
      ...
      providerSpec:
        value:
          ...
          vcpuSockets: <vcpu_sockets>
          vcpusPerSocket: <vcpus_per_socket>
ifdef::infra[]
      taints:
...
`<memory_amount>`:: Specifies the amount of memory for the cluster in Gi.
...
`<system_disk_size>`:: Specifies the size of the system disk in Gi.
...
`<vcpu_sockets>`:: Specifies the number of vCPU sockets.
`<vcpus_per_socket>`:: Specifies the number of vCPUs per socket.
ifdef::infra[]
