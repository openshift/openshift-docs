...
[role="_abstract"]
Configure an htpasswd identity provider by using the OCM CLI (`ocm`). Use this method to log in as a local user when you troubleshoot cluster access problems.
