...
|VM status conditions (*Critical*, *Warning*, or *Healthy*) and volume snapshot status

If *Critical* or *Warning* conditions are present, the *Diagnostics* tab displays a badge with their number.
|====
