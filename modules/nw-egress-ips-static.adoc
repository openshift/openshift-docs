...
----
+
You can set `egressIPs` to two or more IP addresses on different nodes to provide high availability. If multiple egress IP addresses are set then pods use all egress IP addresses roughly equally.
