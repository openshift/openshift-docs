...
where:
+
`name`:: Specifies the name of the environment variable for the Argo CD Application Controller component.
`namespace`:: Specifies the name of the environment variable for the Argo CD server component.
