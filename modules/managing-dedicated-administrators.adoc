...
= Manage {product-title} administrators

[role="_abstract"]
You can manage administrator roles by using the `cluster-admin` or `dedicated-admin` group on the cluster. Existing members of this group can edit membership through {cluster-manager-url}.
