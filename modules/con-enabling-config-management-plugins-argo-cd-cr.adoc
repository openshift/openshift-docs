...
`<my_argocd>`:: Specifies the name of an Argo CD CR instance.
`<my_cmp>`:: Specifies the name of a sidecar container used in the repo server.
`volumeMounts`:: Specifies the name of volume mounts used in the repo server.