...
gp2:: Specifies the EBS volume type. AWS Outposts requires gp2 volumes.
m5.xlarge:: Specifies the AWS instance type. You must use an instance type that is configured in your Outpost.
