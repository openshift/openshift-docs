...
The deprecated `azureMonitor` output type uses the Data Collector API. Microsoft will disable this API on September 14, 2026. Existing deployments by using `azureMonitor` should migrate to `azureLogsIngestion` before this date.
