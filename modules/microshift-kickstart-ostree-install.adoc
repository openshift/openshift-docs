...
= Creating a Kickstart file for a {microshift-short} RHEL for Edge installation

Use the Kickstart file provided with the {microshift-short} RPM to provision an RHEL for Edge-based virtual machine.
