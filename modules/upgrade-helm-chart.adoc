...
[NOTE]
====
You might use the `--reuse-values` option to preserve the Helm values that were configured before the upgrade. If you do that, you must turn off `central-db` creation before you upgrade to the next version.
