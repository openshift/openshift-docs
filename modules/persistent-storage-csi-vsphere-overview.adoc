...
vSphere CSI driver:: 
The driver enables you to create and mount vSphere PVs. In {product-title} 4.20, the driver version is 3.6.0 The vSphere CSI driver supports all of the file systems supported by the underlying {op-system-first} release, including XFS and Ext4. For more information about supported file systems, see "Overview of available file systems".
