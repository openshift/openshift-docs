...
[role="_abstract"]
To update an application with minimal downtime in {product-title}, you can create a rolling deployment. Use the CLI to deploy an example application, expose it, and trigger a new rollout so pods are gradually replaced.
