...
* Two clusters are required, and they must be connected to the same L2 network segment.

* Configuring a dedicated Multus network for cross-cluster live migration is highly recommended.
