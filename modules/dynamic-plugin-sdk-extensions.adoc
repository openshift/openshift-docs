...
Adds a new page to the web console router. See the React Router documentation.
...
Adds a new standalone page, rendered outside the common page layout, to the web console router. See the React Router documentation.
...
|`sortWeight`
|`number` |yes |An optional sort weight, relative to all other details items in the same column. Represented by any valid JavaScript Number. Items in each column are sorted independently, lowest to highest. Items without sort weights are sorted after items with sort weights.
