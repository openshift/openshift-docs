...
[role="_abstract"]
Service control policy (SCP) management is your responsibility. These policies are maintained in the AWS Organization and control what services are available within the attached AWS accounts.
