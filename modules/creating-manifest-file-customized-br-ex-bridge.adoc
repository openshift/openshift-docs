...
[role="_abstract"]
You can create a customized `br-ex` bridge configuration to override the default Open vSwitch behavior for advanced networking requirements such as MTU changes, DNS updates, or LLDP enablement.
