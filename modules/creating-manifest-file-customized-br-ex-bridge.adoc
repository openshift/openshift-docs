  ...
  config:
    ...
    storage:
      ...
      - contents:
        ...
        mode: 0644
        overwrite: true
        path: /etc/nmstate/openshift/worker-0.yml <4>
      - contents:
