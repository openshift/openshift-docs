...
Override the default Open vSwitch (OVS) `br-ex` bridge configuration by creating a `MachineConfig` object with an NMState configuration file, enabling you to customize the bridge for advanced networking requirements such as MTU, QoS, and LLDP.
