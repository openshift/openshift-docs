...
= Configure {gcp-short} firewall prerequisites

[role="_abstract"]
If you are using a firewall to control egress traffic from {product-title} on {GCP}, you must configure your firewall to grant access to certain domains and port combinations listed in the tables. {product-title} requires this access to provide a fully managed {OCP-short} service.
