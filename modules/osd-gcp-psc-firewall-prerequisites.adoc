...
= {gcp-full} firewall prerequisites
...
| `accounts.google.com`
| 443
| Used to access your {gcp-full} account.
...
| 443
| Used to access {gcp-full} services and resources. Review link:https://cloud.google.com/endpoints/docs[Cloud Endpoints] in the {gcp-full} documentation to determine the endpoints to allow for your APIs.
|===
+
[NOTE]
====
