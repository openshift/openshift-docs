...
= Migrate policies to GRPCRoute support
...
. Delete your `HTTPRoute` CRs. You must remove the `HTTPRoute` CR must before you can use the `GRPCRoute` CR on the same hostname.
