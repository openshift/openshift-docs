...
For example, if it detects a `setup.py` file at the repository root, the link:https://artifacthub.io/packages/tekton-task/tekton-catalog-tasks/pylint[pylint task] is automatically added to the generated pipeline run.
