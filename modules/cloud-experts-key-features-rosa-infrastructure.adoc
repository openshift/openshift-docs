...
== AMI
{product-title} worker nodes use a different AMI from OSD and {product-title}. Control Plane and Infra node AMIs are common across products in the same version.
