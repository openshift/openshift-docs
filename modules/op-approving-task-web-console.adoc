...
[id="op-approve-task-web-console_{context}"]
= Approve using the web console
...
* xref:../develop/develop-and-extend-pipelines.adoc#op-enable-plugin_develop-and-extend-pipelines[Enable the {pipelines-shortname} console plugin]
