...
= Approve a manual approval task by using the web console
...
* xref:../get-started/working-with-pipelines-web-console.adoc#op-enabling-plugin_working-with-pipelines-web-console[Enabling the {pipelines-shortname} console plugin]
