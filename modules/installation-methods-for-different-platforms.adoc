...
[role="_abstract"]
You can perform different types of installations on different platforms. Not all installation methods are supported for all platforms. See the "{product-title} Support Matrix" for more information.
