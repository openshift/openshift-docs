...
To use the `openshift/ruby-20-centos9:latest` container image stream with the source in a local repository:

[source,terminal]
----
$ oc new-app openshift/ruby-20-centos9:latest~/home/user/code/my-ruby-app
----
