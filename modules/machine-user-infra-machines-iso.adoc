...
:navtitle: Create {op-system} machines by using an ISO image
:chunk-to-content:
[id="machine-user-infra-machines-iso_{context}"]
= Creating {op-system} machines by using an ISO image

[role="_abstract"]
ifndef::ibm-power[]
To scale your {product-title} bare metal cluster, you can create more {op-system-first} compute machines by using an ISO image.
endif::ibm-power[]
ifdef::ibm-power[]
To scale your {product-title} cluster, you can create more {op-system-first} compute machines by using an ISO image.
endif::ibm-power[]
