...
[id="nodes-scheduler-default-predicates-{context}"]
...
[id="admin-guide-scheduler-general-predicates-{context}"]
== General Predicates
...
[id="configurable-predicates-{context}"]
