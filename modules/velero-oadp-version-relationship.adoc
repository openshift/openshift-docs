...
| 1.2.4 | link:https://{velero-domain}/docs/v1.11/[1.11] | 4.11 and later
| 1.2.5 | link:https://{velero-domain}/docs/v1.11/[1.11] | 4.11 and later
| 1.3.0 | link:https://{velero-domain}/docs/v1.12/[1.12] | 4.12 and later
| 1.3.1 | link:https://{velero-domain}/docs/v1.12/[1.12] | 4.12 and later
| 1.3.2 | link:https://{velero-domain}/docs/v1.12/[1.12] | 4.12 and later
|===
