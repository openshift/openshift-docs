...
[role="_abstract"]
{rosa-cli-first} offers the following options for interacting with your cluster.
...
Create role used by {hybrid-console}
...
Delete the {hybrid-console} role
...
== rosa list gates
List available RHOCP Gates

.Example usage
[source,bash,options="nowrap"]
----
# List all OCP gates for RHOCP version
  rosa list gates --version 4.9

# List all STS gates for RHOCP version
