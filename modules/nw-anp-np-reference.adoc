...
[role="_abstract"]
To choose the right network policy API for your cluster or namespace in {product-title}, you can compare `AdminNetworkPolicy` and `NetworkPolicy` CRs across scope, rule actions, precedence, and peer options. 
