...
[id="oadp-cli-nonadmin-restores-prereqs_{context}"]
== Prerequisites
...
[id="oadp-cli-nonadmin-restores-create_{context}"]
...
[id="oadp-cli-nonadmin-restores-list_{context}"]
...
[id="oadp-cli-nonadmin-restores-describe_{context}"]
...
[id="oadp-cli-nonadmin-restores-logs_{context}"]
...
[id="oadp-cli-nonadmin-restores-delete_{context}"]
