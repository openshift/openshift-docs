...
= Configure S3 Compatible storage for LokiStack
...
[NOTE]
====
S3 Compatible storage uses different secret parameters than AWS S3. Do not use AWS-specific parameters such as `region` for S3 Compatible storage.
====
