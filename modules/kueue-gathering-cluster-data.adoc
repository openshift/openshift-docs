...
[role="_abstract"]
You can use the `oc adm must-gather` CLI command to collect the information about your {kueue-name} instance that is most likely needed for debugging issues.
...
. Attach the compressed file to your support case on the *Customer Support* page of the Red{nbsp}Hat Customer Portal.
