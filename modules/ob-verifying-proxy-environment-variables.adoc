...
As a cluster administrator, you can verify the environment to ensure that the proxy settings are correctly configured for {builds-title} on an {ocp-product-title} cluster.
