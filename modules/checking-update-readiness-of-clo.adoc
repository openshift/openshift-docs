...
= Check update readiness of Red Hat OpenShift Logging Operator

[role="_abstract"]
Verify that {clo} has no alerts and all pods run correctly before updating to ensure a smooth update.
