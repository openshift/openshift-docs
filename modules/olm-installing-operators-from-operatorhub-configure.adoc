...
In {product-title}, Red Hat Operators are not available by default. You can access and install these Operators if you have a pull secret from Red Hat OpenShift Cluster Manager by editing the `OperatorHub` custom resource (CR). 

.Prerequisites

* Ensure that you have downloaded the link:https://console.redhat.com/openshift/install/pull-secret[pull secret from Red Hat OpenShift Cluster Manager] as shown in the installation procedure.
