...
[role="_abstract"]
After you set up the Principal component, you can connect it to one or more Agents. This connection allows the principal to securely manage Argo CD Applications on each Agent cluster.
