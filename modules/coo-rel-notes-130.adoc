...
= Cluster Observability Operator 1.3

[role="_abstract"]
Review the release notes for {coo-full} version 1.3, including new features, enhancements, bug fixes, and security advisories for each minor release.
