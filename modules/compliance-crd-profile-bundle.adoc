...
status:
  dataStreamStatus: VALID # Parsing state of the input content files
----
* **dataStreamStatus**: Indicates whether the Compliance Operator was able to parse the content files.
