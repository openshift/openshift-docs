...
[role="_abstract"]
The OVN-Kubernetes network plugin has the following IPv6 and dual-stack limitations. These limitations can affect gateway configuration, routing, and cluster stability.
