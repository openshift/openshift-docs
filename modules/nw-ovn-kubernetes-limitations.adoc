...
[role="_abstract"]
The OVN-Kubernetes network plugin has specific IPv6 and dual-stack networking configuration limitations. Understanding these limitations prevents gateway misconfigurations, routing failures, and cluster instability.
