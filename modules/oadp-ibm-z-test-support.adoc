...
[role="_abstract"]
Review the tested and supported {oadp-short} and {product-title} version combinations for {ibm-z-name} against S3 backup location targets. This helps you verify that your {ibm-z-name} environment and {oadp-short} version are supported for backup operations.
