...
. Update Elasticsearch Operator to the latest version of 4.4, then update to 4.6.
...
* Update Elasicsearch Operator from 4.4 to 4.6, then update Cluster Logging Operator from 4.4. to 4.6.
