...
[role="_abstract"]
Evidence reports contain comprehensive compliance-related data in CSV format, tailored for technical roles such as compliance auditors, DevOps engineers, or security practitioners.

You can export comprehensive compliance-related data from {rh-rhacs-first} in CSV format as an evidence report. This evidence report contains detailed information about the compliance assessment and targets technical roles, such as compliance auditors, DevOps engineers, or security practitioners.
