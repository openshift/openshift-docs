...
[role="_abstract"]
To remove an {product-title} cluster that uses installer-provisioned infrastructure, you can run the `openshift-install destroy cluster` command. Use the installation files from your original deployment to uninstall the cluster from your cloud platform.
