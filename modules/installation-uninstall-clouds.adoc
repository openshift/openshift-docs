...
// * installing/installing_ibm_powervs/uninstalling-cluster-ibm-power-reg-vs.adoc
...
ifeval::["{context}" == "uninstalling-cluster-ibm-power-reg-vs"]
:ibm-power-reg-vs:
endif::[]
...
cluster.
ifdef::ibm-cloud,ibm-power-reg-vs[]
...
endif::ibm-cloud,ibm-power-reg-vs[]
