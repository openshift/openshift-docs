...
[id="ob-builds-controller-metrics_{context}"]
= Builds controller metrics

[role="_abstract"]
Builds controller metrics expose the internal state and activity of the builds controller in {ocp-product-title}.

[IMPORTANT]
====
Red{nbsp}Hat does not provide support for the builds controller metrics.
====
