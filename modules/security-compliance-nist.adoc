...
:navtitle: Compliance and risk management
:chunk-to-content:
...
To understand Red Hat's view of {product-title} compliance frameworks, refer to the Risk Management and Regulatory Readiness chapter of the OpenShift Security Guide Book.
