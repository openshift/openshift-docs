...
Generally network sysctls are namespaced and can be enabled by using the `kubeletconfig.experimental` annotation in the `PerformanceProfile` resource as a string of JSON in the form `allowedUnsafeSysctls`.
