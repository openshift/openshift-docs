...
= Provisioning a RHEL for Edge machine for {microshift-short}
...
. You have created a {op-system-ostree} Installer (ISO) image containing your {op-system-ostree} commit with {microshift-short}.
...
For more information, see the "Additional resources" links.
