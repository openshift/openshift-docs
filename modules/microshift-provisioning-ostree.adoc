...
You can provision a machine with your {op-system-ostree} image by using the Kickstart provided with the {microshift-short} RPM, or you can update an {op-system-ostree} Installer (ISO) Kickstart file to meet the provisioning requirements.
