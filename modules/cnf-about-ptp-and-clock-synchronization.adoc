...
[NOTE]
====
PTP fast event notifications are available for network interfaces configured to use PTP ordinary clocks or PTP cnf-about-ptp-and-clock-synchronization_dary clocks.
====
