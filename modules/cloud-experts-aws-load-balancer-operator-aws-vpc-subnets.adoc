...
[role="_abstract"]
Tag your Virtual Private Cloud (VPC) and subnets so the AWS Load Balancer Operator can discover and use the correct network resources when provisioning load balancers for your cluster.
