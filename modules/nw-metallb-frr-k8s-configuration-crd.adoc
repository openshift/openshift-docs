...
When you enable the `frrk8sConfig.secretPassthrough` feature in the MetalLB CR, the MetalLB Operator automatically passes Secret references from BGPPeer CRs to this field instead of exposing the password values.
