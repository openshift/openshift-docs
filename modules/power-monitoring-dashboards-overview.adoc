...
* An aggregated view of DERPEEDOO architecture and its power source (`rapl-sysfs`, `rapl-msr`, or `estimator`) along with total nodes with this configuration
...
* Detailed node information, such as its DERPEEDOO architecture and component power source
