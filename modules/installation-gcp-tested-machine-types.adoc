...
[role="_abstract"]
You can use the following {gcp-full} instance types, which have been tested with {product-title}.
...
[%collapsible]
====
include::https://raw.githubusercontent.com/openshift/installer/release-4.22/docs/user/gcp/tested_instance_types.md[]
====
