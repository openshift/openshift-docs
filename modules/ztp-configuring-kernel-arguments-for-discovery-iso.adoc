...
. Commit the `InfraEnv-example.yaml` CR to the same location in your Git repository that has the `ClusterInstance` CR and push your changes. The following example shows a sample Git repository structure:
