...
// TODO: check config or default differences: https://redhat-internal.slack.com/archives/C087LPW0VDZ/p1755502508848329
...
<5> Specify the number of pods to create for each group, including the leader pod. For example, a value of `3` will create 1 leader pod and 2 worker pods. The default value is `1`.
...
+
// Do we need to list the character limit for LWS name here or as a known issue? https://lws.sigs.k8s.io/docs/troubleshooting/#3-unable-to-create-lws-object-with-a-name-exceeding-51-characters
