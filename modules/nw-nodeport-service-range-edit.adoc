...
You can expand the node port range for your cluster. You can extend the range on either side but you must preserve the default port range of `29000-32768` within your new range.
