...
----
<1> Note the name used for the service account `logging-collector` you will need it when creating the `ClusterLogForwarder` resource.
...
.Verification
. In the *ClusterLogForwarder* tab you should now see your `ClusterLogForwarder` instance.
