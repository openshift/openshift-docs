...
** Use the *Actions* menu to rebuild rules from active traffic or revert rules to a before applied YAML. For more information, see "Generating network policies in the network graph".
