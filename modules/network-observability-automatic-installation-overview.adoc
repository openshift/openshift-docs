...
[NOTE]
====
To enable flow persistence and features that require flow records, you must configure a LokiStack. Without LokiStack, flow data is not stored for historical analysis.
====
