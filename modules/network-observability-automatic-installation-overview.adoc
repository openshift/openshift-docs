...
:FeatureName: Automatic network observability installation
include::snippets/technology-preview.adoc[]

[IMPORTANT]
====
The `NetworkObservabilityInstall` feature gate is required to use this Technology Preview feature in {product-title} 5.0. Clusters created with this feature gate cannot be upgraded when the feature becomes generally available. You must create a new cluster to use the GA version.
====
