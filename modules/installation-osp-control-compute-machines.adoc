...
ifdef::osp-sr-iov[]
// TODO: Investigate options for equivalent RHOSO documentation links to replace the RHOSP 16.1 compute/huge pages links.
...
// TODO: Investigate options for equivalent RHOSO documentation link to replace the RHOSP 16.1 compute performance link above.
endif::osp-sr-iov[]
