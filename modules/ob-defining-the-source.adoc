...
*Configuring a build by specifying your credentials*
...
*Configuring a build with path in Git*
...
*Configuring a build with tag in Git*
...
*Configuring a build with environment variables*
