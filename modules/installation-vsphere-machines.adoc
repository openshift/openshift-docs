...
+
----
$ base64 <path_to_installation_directory>/bootstrap.ign > <path_to_installation_directory>/bootstrap.64
$ base64 <path_to_installation_directory>/master.ign > <path_to_installation_directory>/master.64
$ base64 <path_to_installation_directory>/worker.ign > <path_to_installation_directory>/worker.64
----
...
+
----
$ base64 <path_to_installation_directory>/append-bootstrap.ign > <path_to_installation_directory>/append-bootstrap.64
----
