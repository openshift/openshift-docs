...
vSphere, you must create {op-system} machines on vSphere hosts for it to use.
...
is named `<installation_directory>/bootstrap.ign`, created to your HTTP
server. Note the URL of this file.
+
...
upload date in the format `rhcos-<version>-<date>-vmware.ova`.
