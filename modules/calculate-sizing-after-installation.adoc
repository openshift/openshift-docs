...
* xref:../configure/tune-loki-for-performance-and-scalability.adoc#loki-sizing-vs-component-scaling_tune-loki-for-performance-and-scalability[LokiStack sizing versus component scaling]
