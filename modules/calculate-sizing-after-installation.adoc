...
* xref:../configure_lokistack/advanced-deployment-scalability-for-loki.adoc#loki-sizing-vs-component-scaling_advanced-deployment-scalability-for-loki[LokiStack sizing versus component scaling]
