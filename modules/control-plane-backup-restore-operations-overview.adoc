...
[id="control-plane-backup-restore-operations-overview_{context}"]
= Control plane backup and restore operations

[role="_abstract"]
As a cluster administrator, you might need to stop an {product-title} cluster for a period and restart it later.
