...
* You have installed {product-title-short} 4.11 or later.
* You understand which files require monitoring based on security and compliance requirements.
* You understand which processes make legitimate changes to monitored files.
* You have enabled the file activity monitoring setting in the *Per Node Settings* section during secured cluster configuration.
...
. In *File operation*, select the operations you want to alert on that indicate security risks. For example, select *Change permissions* and *Change ownership* to detect unauthorized attempts to escalate privileges or change file access controls.
