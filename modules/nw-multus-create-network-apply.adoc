...
[role="_abstract"]
Create a primary network attachment by directly applying a `NetworkAttachmentDefinition` YAML manifest, giving you full control over the network configuration without relying on the Cluster Network Operator to manage the resource automatically.
