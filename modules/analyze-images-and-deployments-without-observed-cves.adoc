...
|Namespace
a|
* *ID*: The alphanumeric ID for the namespace.
//need more info about this - is this an ACS assigned ID or where does it come from?
* *Name*: The name of the namespace.
* *Label*: The label for the namespace.
* *Annotation*: The annotation for the namespace.
|Cluster
a|
* *ID*: The alphanumeric ID for the cluster.
//need more info about this - is this an ACS assigned ID or where does it come from?
