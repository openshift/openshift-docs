...
in the Amazon Web Services (AWS) documentation, {product-title} has specific
AWS account limits and requirements.
...
components, and if you run multiple clusters from your account, you might need
...
|0 to 1
|5 EIPs per account
|To provision the cluster in a highly available configuration, the installer
