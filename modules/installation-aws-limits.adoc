...
[role="_abstract"]
The {product-title} cluster uses a number of {aws-first}
...
cluster configurations, deploy your cluster in certain {aws-short} regions, or
run multiple clusters from your account, you might need
to request additional resources for your {aws-short} account.

The following table summarizes the {aws-short}  components whose limits can impact your
...
{product-title} clusters per {aws-short} account.
