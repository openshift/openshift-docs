...
----
+
Output similar to the following example is displayed, typically after a few minutes, with {VirtProductName} listed under `DISPLAY` if the CSV creation is successful:
+
