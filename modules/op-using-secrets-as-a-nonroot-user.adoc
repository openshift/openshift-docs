...
[id="op-use-secrets-as-a-nonroot-user_{context}"]
...
* link:https://github.com/openshift-pipelines/pipelines-examples/blob/main/v1/taskruns/authenticating-git-commands.yaml[Example for authenticating git commands]
