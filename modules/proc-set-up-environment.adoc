...
[role="_abstract"]
You can set up your environment variables and deploy a sample application on your {ocp} cluster. In this example, a demonstration application is used.
...
. Set the following environment variable by running the following command:
+
[source,terminal]
----
