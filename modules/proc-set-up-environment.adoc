...
+
NOTE: This guide uses environment variables for convenience only. Alternatively, if you know the environment variable values, 
you can set up the required `.yaml` files to suit your environment.
