...
[discrete]
[id="meaning-noreadyvirtcontroller_{context}"]
== Meaning
...
[discrete]
[id="impact-noreadyvirtcontroller_{context}"]
== Impact
...
[discrete]
[id="diagnosis-noreadyvirtcontroller_{context}"]
== Diagnosis
...
[discrete]
[id="mitigation-noreadyvirtcontroller_{context}"]
== Mitigation
