...
. Approve the pending certificate signing requests (CSRs) for the new node by running the following command:
+
[source,terminal]
----
...
----
+
The new node generates CSRs that are not automatically approved.
