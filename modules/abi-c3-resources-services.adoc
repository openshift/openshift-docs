...
+
For more information, see "Terraform Script Execution" in link:https://docs.oracle.com/en-us/iaas/Content/openshift-on-oci/agent-installer.htm[Agent-based Installer for {product-title} (Oracle Documentation)].

// The link above is a placeholder until I receive a specific live link