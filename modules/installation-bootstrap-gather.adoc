...
<installation_directory>:: Specifies the directory you specified when you ran `./openshift-install create cluster`. This directory contains the {product-title} definition files that the installation program creates.
+
...
<master_*_address>:: Specifies the fully qualified domain name or IP address for each control plane, or master, machine in your cluster.
+
[NOTE]
====
