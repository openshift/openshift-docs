...
[role="_abstract"]
Red Hat provides support resources through the Customer Portal, including searchable knowledge base articles, case submission, and product documentation access for troubleshooting {product-title} issues.
...
* link:https://issues.redhat.com/secure/CreateIssueDetails!init.jspa?pid=12332330&summary=Documentation_issue&issuetype=1&components=12367614&priority=10200&versions=12385624[Submit a documentation issue]
