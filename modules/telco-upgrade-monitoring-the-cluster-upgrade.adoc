...
[source,terminal]
----
oc get clusterversion; echo; oc get co | head -1; oc get co | grep 4.14; oc get co | grep 4.15; echo; oc get no; echo; oc get po -A ...  utility.daytwops.bos2.lab: Wed Feb 21 15:44:58 2024
