...
[NOTE]
====
For {odo-title}{nbsp}{odo-ver} Java and Note.js are the officialy supported component types.
Run `odo catalog list components` to verify the officialy supported component types.
====
