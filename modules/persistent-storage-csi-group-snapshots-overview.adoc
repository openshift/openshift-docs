...
These three API kinds are defined as `CustomResourceDefinitions` (CRDs). These CRDs are installed by default in the {product-title} cluster so that CSI drivers can support volume group snapshots.
