...
For more information, see "Creating a manifest object that includes a customized br-ex bridge" in the _Installing on bare metal with the IPI Installer_ document or the _Installing a user-provisioned cluster on bare metal_ document.
====
