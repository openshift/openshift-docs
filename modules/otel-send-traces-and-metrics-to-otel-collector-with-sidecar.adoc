...
= Receive telemetry with sidecar injection

[role="_abstract"]
You can configure an OpenTelemetry Collector instance to receive traces or metrics with sidecar injection. The {OTelOperator} allows sidecar injection into deployment workloads and automatic configuration of your instrumentation to send telemetry data to the OpenTelemetry Collector.
