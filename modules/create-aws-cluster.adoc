...
[role="_abstract"]
You can create an {product-title} cluster on Amazon Web Services (AWS) using a standard cloud account owned by Red Hat or with your own cloud account using the Customer Cloud Subscription (CCS) model.
