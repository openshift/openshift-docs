...
Accelerated Networking requires an {azure-short} VM size that includes at least four vCPUs. To satisfy this requirement, you can change the value of `vmSize` in your machine set. For information about {azure-short} VM sizes, see link:https://docs.microsoft.com/en-us/azure/virtual-machines/sizes[{azure-first} documentation].
