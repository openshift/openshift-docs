...
[id="compliance-operator-release-notes-0-1-44_{context}"]
...
[id="compliance-operator-0-1-44-new-features-and-enhancements_{context}"]
...
[id="openshift-compliance-operator-0-1-44-templating_{context}"]
...
[id="openshift-compliance-operator-0-1-44-bug-fixes_{context}"]
== Bug fixes
