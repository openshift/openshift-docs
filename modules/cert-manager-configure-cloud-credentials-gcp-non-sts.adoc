...
= Configuring cloud credentials for the {cert-manager-operator} on {gcp-short}

To configure the cloud credentials for the {cert-manager-operator} on a {gcp-short} cluster you must create a `CredentialsRequest` object, and allow the Cloud Credential Operator to generate the cloud credentials secret.
