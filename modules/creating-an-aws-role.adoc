...
----
+
Note down the `Arn` value of the created policy.
...
<2> Namespace and service account must match the ones that the log forwarder uses.
...
----
+
Note down the `Arn` value of the created role.
