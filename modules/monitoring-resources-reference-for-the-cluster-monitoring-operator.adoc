...
= Monitoring resource routes and services

[role="_abstract"]
This document describes the route and service resources deployed and managed by the Cluster Monitoring Operator (CMO).
