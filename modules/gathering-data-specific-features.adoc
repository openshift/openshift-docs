...
|`quay.io/openshift-community/openshift-logging/cluster-logging-rhel9-operator:v<installed_version_logging>`
endif::[]
...
ifdef::openshift-origin[]
|`quay.io/openshift-community/openshift4/ose-local-storage-mustgather-rhel9:v<installed_version_LSO>`
endif::[]
...
ifdef::openshift-origin[]
|`quay.io/openshift-community/openshift-sandboxed-containers/osc-must-gather-rhel8:v<installed_version_sandboxed_containers>`
endif::[]
...
ifdef::openshift-origin[]
|`quay.io/openshift-community/workload-availability/node-healthcheck-must-gather-rhel8:v<installed_version_NHC>`
endif::[]
...
ifdef::openshift-origin[]
|`quay.io/openshift-community/workload-availability/node-healthcheck-must-gather-rhel9:v<installed_version_NHC>`
endif::[]
|Data collection for the Red{nbsp}Hat Workload Availability Operators, including the Self Node Remediation (SNR) Operator, the Fence Agents Remediation (FAR) Operator, the Machine Deletion Remediation (MDR) Operator, the Node Health Check (NHC) Operator, and the Node Maintenance Operator (NMO).
...
ifdef::openshift-origin[]
|`quay.io/openshift-community/numaresources/numaresources-must-gather-rhel9:v<installed-version-nro>`
endif::[]
...
ifdef::openshift-origin[]
|`quay.io/openshift-community/openshift4/ptp-must-gather-rhel8:v<installed-version-ptp>`
endif::[]
...
ifdef::openshift-origin[]
|`quay.io/openshift-community/openshift-gitops-1/must-gather-rhel8:v<installed_version_GitOps>`
endif::[]
...
ifdef::openshift-origin[]
|`quay.io/openshift-community/openshift4/ose-secrets-store-csi-mustgather-rhel9:v<installed_version_secret_store>`
endif::[]
...
ifdef::openshift-origin[]
|`quay.io/openshift-community/lvms4/lvms-must-gather-rhel9:v<installed_version_LVMS>`
endif::[]
...
ifdef::openshift-origin[]
|`quay.io/openshift-community/compliance/openshift-compliance-must-gather-rhel8:<digest-version>`
endif::[]
...
ifdef::openshift-origin[]
|`quay.io/openshift-community/rhacm2/acm-must-gather-rhel9:v<ACM_version>`
endif::[]
...
ifdef::openshift-origin[]
|`quay.io/openshift-community/rhacm2/acm-must-gather-rhel8:v<ACM_version>`
endif::[]
