...
[role="_abstract"]
To upgrade an application with minimal downtime in {product-title}, you can start a rolling deployment in the *Developer* perspective. From the *Topology* view, select *Start Rollout* to spin up the new version and then terminate the old pods.
