...
. Use your preferred text editor to edit the `VirtualMachine` manifest and add the new network interface to the running VM. Editing the VM specification adds the new network interface to the VM and virtual machine instance (VMI) configuration but does not attach it to the running VM.
+
