...
If you specify it as `true`, no tolerations are applied, and the collector pods cannot schedule onto nodes with taints.
...
| `scanner.logLevel`
| Setting this parameter allows you to change the scanner log level. Use this option only for troubleshooting purposes.
