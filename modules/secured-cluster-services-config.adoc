...
#Needs updates for Scanner V4 in 4.4#
...
{product-title} does not support this feature on {ocp} 3.11. For more information, see link:https://access.redhat.com/support/policy/updates/rhacs[Red Hat Advanced Cluster Security for Kubernetes Support Policy].
