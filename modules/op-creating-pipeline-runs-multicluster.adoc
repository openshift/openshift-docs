...
[id="op-create-pipeline-runs-multicluster_{context}"]
= Create pipeline runs across clusters
...
* You have access to the hub cluster by using an account with permissions to create pipeline runs.
