...
----
+
You can verify that the IAM service accounts are created by querying GCP. For more information, refer to {gcp-short} documentation on listing IAM service accounts.
endif::google-cloud-platform[]
ifdef::azure-workload-id[]
+
.Example output
