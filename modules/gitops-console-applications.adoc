...
The graph and table show health and sync status for the Application's immediate resources only, not the full Argo CD resource tree. Use the Argo CD link in the page to open the complete owner reference hierarchy in the Argo CD UI.
