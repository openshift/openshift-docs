...
//
// * secure/managing-secrets-securely-using-sscsid-with-gitops.adoc
...
[role="_abstract"]
Configure the SSCSI Driver Operator to mount secrets from AWS Secrets Manager to a CSI volume by using {gitops-shortname} workflows.
