...
----
+
* If the command returns one or more `AgentClusterInstall` resources, follow the procedure in "Replacing a control plane node in a healthy cluster" in the {ai-full} documentation.
+
