...
[role="_abstract"]
Configure a GitLab identity provider to use GitLab.com or another GitLab instance as an authentication source. Users can log in to your {product-title} cluster with their GitLab credentials after you complete the configuration.
