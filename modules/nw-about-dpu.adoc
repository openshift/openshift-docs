...
* link:https://access.redhat.com/articles/7120276[Accelerating Confidential AI on OpenShift with the Intel E2100 IPU, DPU Operator, and F5 NGINX (Red{nbsp}Hat Knowledgebase)]
