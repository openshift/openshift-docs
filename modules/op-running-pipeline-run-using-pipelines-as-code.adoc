...
If the pull request author does not meet the requirements, another user who meets them can comment `/ok-to-test` on the pull request. This comment can also be posted in a discussion thread reply.
