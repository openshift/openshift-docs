...
compute-1.example.com         Ready    worker   33m   v1.36.3
control-plane-1.example.com   Ready    master   41m   v1.36.3
control-plane-2.example.com   Ready    master   45m   v1.36.3
compute-2.example.com         Ready    worker   38m   v1.36.3
compute-3.example.com         Ready    worker   33m   v1.36.3
control-plane-3.example.com   Ready    master   41m   v1.36.3
----
