...
[id="logging-clusterlogging-cr-config_{context}"]
= Configuring the ClusterLogging CR

You can adjust the configuration of the {logging} components by editing the `ClusterLogging` CR.
