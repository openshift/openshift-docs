...
//
// * installing/installing_oci/installing-oci-assisted-installer.adoc [The Assisted Installer for cluster installation on Oracle Cloud Infrastructure]
...
* You uploaded a generated discovery ISO image to {oci}. See the "Using the Assisted Installer to generate an OCI-compatible discovery ISO image" section.
