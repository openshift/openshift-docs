...
//Should this be deleted? If not, this needs to be split into sections and fit into the documentation in more appropriate places.
...
Red{nbsp}Hat recommends that you schedule the admission control service on the control plane and not on worker nodes.
