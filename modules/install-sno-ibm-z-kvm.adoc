...
[role="_abstract"]
You can install {sno} on {ibm-z-name} and {ibm-linuxone-name} using {op-system-base} KVM by generating the installation ISO and booting the server from the ISO.
