...
[role="_abstract"]
For details on what happens during an {VirtProductName} update, including expected completion time and preservation of data, see below.
...
[role="_abstract"]
For details on how the {VirtProductName} Operator is managed and updated by using the Operator Lifecycle Manager (OLM), see below.
