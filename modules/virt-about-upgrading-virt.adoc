...
[role="_abstract"]
This topic helps you understand what happens during an {VirtProductName} update, including expected completion time and preservation of data.
...
[role="_abstract"]
This topic helps you understand how the {VirtProductName} Operator is managed and updated using the Operator Lifecycle Manager (OLM).
