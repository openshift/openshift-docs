...
Other managed properties include Kubernetes service discovery settings, Data Index location properties, Jobs Service location properties, and Knative Eventing system configurations.