...
* You have xref:../../authentication/index.adoc#configuring-identity-providers[configured an identify provider].
...
----
namespace::
<1> Replace <namespace> with the namespace name that you want to use.
