...
quay.io/openshift-release-dev/ocp-v4.0-art-dev@sha256:76db3c86554ad7f581ba33844d6a6ebc891236f7db64f2d290c3135ba81c264c
----
...
spec:
  ...
  template:
    ...
    spec:
      ...
      containers:
      - name: prometheus-adapter
        image: openshift-release-dev/ocp-v4.0-art-dev <1>
        args:
        - --secure-port=6443
      ...
      - name: tmp-vol
        emptyDir: {}
----
<1> `image: openshift-release-dev/ocp-v4.0-art-dev` specifies the Prometheus Adapter image found in the previous step.
