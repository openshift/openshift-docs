...
[role="_abstract"]
In the *Administrator* perspective, review monitoring dashboards to gain insights into cluster operations by visualizing key infrastructure metrics and component status.
...
. In the *Administrator* perspective in the {ocp} web console, navigate to *Observe* -> *Dashboards*.
