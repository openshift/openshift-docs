...
= Review cluster monitoring dashboards

[role="_abstract"]
As an administrator, review monitoring dashboards to gain insights into cluster operations by visualizing key infrastructure metrics and component status.
...
. In the {ocp} web console, go to *Observe* -> *Dashboards*.
