...
= Review monitoring dashboards as a cluster administrator

[role="_abstract"]
View pre-built dashboards for core {product-title} cluster components to monitor system health and performance.
