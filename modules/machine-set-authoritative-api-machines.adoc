...
Cluster API machine sets do not include these fields and instead use the value in their corresponding nonauthoritative Machine API machine set to determine which API is authoritative.
