...
* Deploy the following YAML, which creates both a VM definition and a data volume containing the Fedora operator system:
...
<2> Use `running: true` indicates the VM should be started after creation.
