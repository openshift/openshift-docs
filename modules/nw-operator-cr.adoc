...
The default value is `InstallAndEnable` for standard multi-node clusters and Hosted Control Plane clusters. {sno} clusters default to `DoNotInstall` due to resource constraints.
