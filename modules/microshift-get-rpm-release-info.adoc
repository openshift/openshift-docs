...
[source,terminal]
----
$ sudo dnf repoquery microshift-release-info-0:4.19.1 # <1>
----
<1> Replace the example value `4.19.1` with the major and minor release numbers you are interested in.
+
.Example output
[source,terminal]
----
