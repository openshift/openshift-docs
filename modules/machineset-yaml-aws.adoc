...
=======
<<<<<<<< HEAD:modules/machineset-yaml-aws.adoc
[id="machineset-yaml-aws_{context}"]
========
[id="machineset-yaml_{context}"]
>>>>>>>> osdocs-478 machine support GCP:modules/machineset-yaml.adoc
>>>>>>> osdocs-478 machine support GCP
...
spec:
  ...
  selector:
    matchLabels:
      machine.openshift.io/cluster-api-cluster: <infrastructureID> <1>
      machine.openshift.io/cluster-api-machineset: <infrastructureID>-<role>-us-east-1a <2>
  template:
    metadata:
      labels:
        machine.openshift.io/cluster-api-cluster: <infrastructureID> <1>
...
=======
<<<<<<<< HEAD:modules/machineset-yaml-aws.adoc
<1> Specify the the infrastructure ID that is based on the cluster ID that
========
<1> Specify the infrastructure ID that is based on the cluster ID that
>>>>>>>> osdocs-478 machine support GCP:modules/machineset-yaml.adoc
>>>>>>> osdocs-478 machine support GCP
