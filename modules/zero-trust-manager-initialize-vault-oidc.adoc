...
== Enabling the KV secrets engine and store a test secret
...
== Configuring JWT authentication with SPIRE

You need to set up JWT authentication so your applications can securely log in to Vault by using SPIFFE identities.
