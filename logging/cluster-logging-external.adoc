...
For clusters with AWS Security Token Service (STS) enabled, you can create an AWS service account manually or create a credentials request using the 
...
* xref:../logging/cluster-logging-exported-fields.adoc#cluster-logging-exported-fields-kubernetes[Log Record Fields].
...
ifdef::openshift-rosa,openshift-dedicated[]
link:https://docs.openshift.com/container-platform/latest/networking/ovn_kubernetes_network_provider/logging-network-policy.adoc#logging-network-policy[Logging for egress firewall and network policy rules]
endif::[]

ifdef::openshift-enterprise,openshift-origin[]
* xref:../networking/network_policy/logging-network-policy.adoc#nw-networkpolicy-audit-concept[Network policy audit logging]
endif::[]
ifdef::openshift-rosa,openshift-dedicated[]
link:https://docs.openshift.com/container-platform/latest/networking/network_policy/logging-network-policy.adoc#nw-networkpolicy-audit-concept_logging-network-policy[Network policy audit logging]
endif::[]
