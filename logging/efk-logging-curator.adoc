...
The Cluster Logging Operator installation creates a Curator configuration map, `logging-curator`, which incorporates the Curator configuration file, *_curator5.yaml_* and an {product-title} custom configuration file, *_config.yaml_*. 
...
include::modules/efk-logging-curator-actions[leveloffset=+2]
