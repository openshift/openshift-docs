...
The Cluster Logging CR is based on the `ClusterLogging` custom resource Definition (CRD), which defines a complete cluster logging deployment
...
include::modules/cluster-logging-configuring-image-about.adoc[leveloffset=+1]
