...
* *actions.yaml*. The Curator `actions` file.
...
* *config.yaml*. A legacy {product-title} configuration file for Curator. Supports only the Curator *delete_indices* action
