...
The Cluster Logging Operator installation creates a *Curator* ConfigMap in the `openshift-logging` project, which contains three sections: a `config.yaml` file, a `curator5` file, and the link:https://www.elastic.co/guide/en/elasticsearch/client/curator/5.2/actionfile.html[Curator *action* file].  
