...
* *curator5.yaml*. The Curator configuration file for general config, such as the Elasticsearch hostname, client connection details, and the path to certificates.
