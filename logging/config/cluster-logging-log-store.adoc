...
For more information on the Log Forward API, see xref:../../logging/cluster-logging-external.adoc#cluster-logging-collector-log-forward_cluster-logging-external[Forwarding logs using the Log Forwarding API].
