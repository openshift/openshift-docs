...
include::modules/cluster-logging-view-cluster-dashboards.adoc[leveloffset=+1]

include::modules/cluster-logging-dashboards-access.adoc[leveloffset=+1]

For information on the dashboard charts, see xref:../../logging/visualization/cluster-logging-dashboards.adoc#cluster-logging-dashboards-logging_cluster-logging-dashboards[About the OpenShift Logging dashboard] and xref:../../logging/visualization/cluster-logging-dashboards.adoc#cluster-logging-dashboards-es_cluster-logging-dashboards[About the Logging/Elastisearch Nodes dashboard].
