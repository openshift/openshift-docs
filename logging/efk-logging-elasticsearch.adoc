...
You can configure storage for your Elasticsearch cluster, define how shards are replicated across data nodes in the cluster, 
from full replication to no replication, or make Elasticsearch accessible from outside the cluster.
