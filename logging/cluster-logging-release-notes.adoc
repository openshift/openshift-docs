...
include::logging_tech_previews/cluster-logging-vector-tech-preview.adoc[leveloffset=+3]

include::logging_tech_previews/cluster-logging-loki-tech-preview.adoc[leveloffset=+3]
