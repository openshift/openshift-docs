...
[id="openshift-logging-5-1-0-about-this-release"]
== About this release

The following advisories are available for {ProductName} 5.1:

* link:https://access.redhat.com/errata/RHSA-2021:2112[RHSA-2021:2112 OpenShift Logging Bug Fix Release 5.1.0]
...
[id="openshift-logging-5-1-0-inclusive-language"]
