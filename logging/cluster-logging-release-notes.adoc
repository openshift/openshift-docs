...
= OpenShift Logging 5.0 release notes
...
(link:https://errata.devel.redhat.com/docs/show/66974[RHBA-2020:66974-04 Errata Advisory for Openshift Logging 5.0.0]) is now available. New features, changes, and known issues that pertain to {ProductName} 5.0 are included in this topic.
...
// UNUSED IN THIS 5.0.0 RELEASE - KEEP THIS BOILERPLATE FOR FUTURE RELEASES
