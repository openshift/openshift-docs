...
// For information on scaling your Elasticsearch cluster, see ../logging/config/efk-logging-elasticsearch.adoc#efk-logging-elasticsearch-add-remove_efk-logging-elasticsearch[Scaling your Elasticsearch cluster].
