...
//Eng-Feedback-Req: with the name change to 'logging subsystem for Red Hat OpenShift', is the Logging Operator still called 'Red Hat OpenShift Logging Operator'?
