...
* Before you can develop functions, you must complete the setup steps in xref:../functions/serverless-functions-setup.adoc#serverless-functions-setup[Setting up {FunctionsProductName}].
