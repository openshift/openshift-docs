...
include::modules/changes-in-logging-6-0.adoc[leveloffset=+1]
...
* link:https://github.com/openshift/cluster-logging-operator/blob/master/docs/reference/operator/api_observability_v1.adoc[`observability.openshift.io` API]
