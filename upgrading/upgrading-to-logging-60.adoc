...
If you use Red Hat managed Elasticsearch or Kibana deployment with Logging 5, you must migrate to Lokistack. For more information, see xref:modules/migrating-storage-from-elasticsearch-to-lokistack.adoc# migrating-storage-from-elasticsearch-to-lokistack_upgrading-to-logging-6[Migrating storage from Elasticsearch to LokiStack]. If you use Lokistack with Logging 5, then update the {loki-op}. For more information, see xref:modules/logging-upgrading-loki.adoc#logging-upgrading-loki_upgrading-to-logging-6[Updating the {loki-op}].
