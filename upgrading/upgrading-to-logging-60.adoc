...
* {clo} manages collections and forwarding.
...
* `ClusterLogForwarder` and `ClusterLogging` have been combinded under the `ClusterLogForwarder` resource in the new API.

[id="steos-for-upgrading-logging-5-to-6_{context}"]
