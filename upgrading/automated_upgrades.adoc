...
xref:../release_notes/ocp_3_7_release_notes.adoc#ocp-37-asynchronous-errata-updates[asynchronous errata updates]
...
. When you have finished updating your inventory file, follow the instructions in
<<<<<<< HEAD:install_config/upgrading/automated_upgrades.adoc
...
=======
xref:../install_config/cluster_metrics.adoc#deploying-the-metrics-components[Deploying the Metrics Deployment] to run the *_openshift_metrics.yml_* playbook and
>>>>>>> f977aeb... Move upgrading/downgrading topics to new guide:upgrading/automated_upgrades.adoc
