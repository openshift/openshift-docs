...
to do so, set the `openshift_schedulable=true` variable for each master host
listed in the `[nodes]` group of your inventory file:
+
----
[nodes]
...
The same *_v3_9_* upgrade playbooks can be used for either of the following
scenarios:

- Upgrading existing {product-title} 3.7 clusters to 3.8
