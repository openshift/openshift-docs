...
link:https://docs.openshift.com/container-platform/3.10/release_notes/ocp_3_10_release_notes.html#ocp-3-10-34[latest asynchronous release of version 3.10].
...
steps in
xref:../install_config/configuring_red_hat_registry.adoc#install-config-configuring-red_hat_registry[Accessing and Configuring the Red Hat Registry].
...
master1.example.com      Ready     master       47d       v1.11.0+b81c8f8
master2.example.com      Ready     master       47d       v1.11.0+b81c8f8
master3.example.com      Ready     master       47d       v1.11.0+b81c8f8
infra-node1.example.com  Ready     infra        47d       v1.11.0+b81c8f8
infra-node2.example.com  Ready     infra        47d       v1.11.0+b81c8f8
node1.example.com        Ready     compute      47d       v1.11.0+b81c8f8
node2.example.com        Ready     compute      47d       v1.11.0+b81c8f8
----
