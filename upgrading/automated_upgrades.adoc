...
. Add the `openshift_image_tag` variable to your inventory file. Set its value
to the full release version, for example `v3.11.98`, which you can obtain from
the errata.
+
[IMPORTANT]
====
You must define the `openshift_image_tag` variable before you upgrade {product-title}.
====
