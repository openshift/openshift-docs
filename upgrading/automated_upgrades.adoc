...
+
- xref:../release_notes/ocp_3_10_release_notes.adoc#ocp-310-schedulable-masters[Masters Marked as Schedulable Nodes by Default]
- xref:../release_notes/ocp_3_10_release_notes.adoc#ocp-310-default-node-selector[Default Node Selector Set By Default and Automatic Node Labeling]
endif::[]
