...
xref:../install_config/logging/aggregate_logging_deploy.html#aggregate-logging-ansible-variables[Specifying Logging Ansible Variables] in the
xref:../install_config/logging/aggregate_logging.adoc#install-config-aggregate-logging[Aggregating Container Logs] topic and update your Ansible inventory file to at least set the
...
xref:../install_config/logging/aggregate_logging_deploy.html#aggregate-logging-ansible-variables[Specifying Logging Ansible Variables].

. When you have finished updating your inventory file, follow the instructions in
xref:../install_config/logging/aggregate_logging_deploy.html#deploying-the-efk-stack[Deploying
