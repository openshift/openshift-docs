...
[NOTE]
====
You can see the {product-title} 3.10 Release Notes for more information on how
...
See the xref:../release_notes/ocp_3_10_release_notes.adoc#release-notes-ocp-3-10-release-notes[{product-title} 3.9 Release Notes] to review the latest release notes.
