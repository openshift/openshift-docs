...
. Configure Dnsmasq. You need to perform the following steps to configure dnsmasq
...
include::upgrading/automated_upgrades.adoc[tag=automated-service-catalog-upgrade-steps]
