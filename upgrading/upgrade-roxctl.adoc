...
** For troubleshooting the problems with the automatic cluster upgrader refer to the xref:../upgrading/upgrade-roxctl.adoc#troubleshooting_upgrader_{context}[Troubleshooting guide]
