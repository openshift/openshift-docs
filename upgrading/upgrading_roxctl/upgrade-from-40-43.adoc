...
include::modules/upgrade-central-40.adoc[leveloffset=+2]
...
include::modules/upgrade-scanner-40.adoc[leveloffset=+2]
...
include::modules/update-other-images-40.adoc[leveloffset=+2]
