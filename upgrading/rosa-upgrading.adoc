...
[IMPORTANT]
====
You can only use the ROSA CLI (`rosa`) or the {cluster-manager} console to upgrade ROSA clusters. You cannot upgrade ROSA clusters with OpenShift Container Platform native commands such as `oc adm`.
====
