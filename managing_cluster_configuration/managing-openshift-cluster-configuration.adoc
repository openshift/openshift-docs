...
[role="_abstract"]
{gitops-title} uses Git repositories as the foundation for your infrastructure and application definitions, enabling declarative management of your {OCP} cluster configuration.

Managing your {OCP} cluster configuration declaratively provides the following benefits:
...
* Single source of truth: Git is the definitive source for the desired state of your {OCP} cluster.
...
* xref:../deploy/configuring-an-openshift-cluster-by-deploying-an-application-with-cluster-configurations.adoc#gitops-inbuilt-permissions-for-cluster-config_configuring-an-openshift-cluster-by-deploying-an-application-with-cluster-configurations[Default set of Kubernetes permissions]
