...
* xref:../declarative_clusterconfig/gitops-inbuilt-permissions-for-cluster-config.adoc#configuring-an-openshift-cluster-by-deploying-an-application-with-cluster-configurations[Default set of Kubernetes permissions]
