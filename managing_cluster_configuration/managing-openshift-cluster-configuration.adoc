...
* xref:../declarative_clusterconfig/gitops-inbuilt-permissions-for-cluster-config.adoc#gitops-inbuilt-permissions-for-cluster-config_configuring-an-openshift-cluster-by-deploying-an-application-with-cluster-configurations[Default set of Kubernetes permissions]
