...
[id="prerequisites_install-gitops"]
== Prerequisites
...
[id="additional-resources_installing-openshift-gitops"]
== Additional resources
* xref:../argocd_instance/setting-up-argocd-instance.adoc#setting-up-argocd-instance[Setting up an Argo CD instance]