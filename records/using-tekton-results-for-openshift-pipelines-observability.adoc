...
= Using {tekron-results} for {pipelines-shortname} observability
...
[id="preparing-to-enable_using-tekton-results-for-openshift-pipelines-observability"]
== Preparing to enable {tekton-results}

You must complete several preparatory steps before enabling {tekton-results}.
...
//Enable and configure Tekton Results
include::modules/op-enabling-results.adoc[leveloffset=+1]
