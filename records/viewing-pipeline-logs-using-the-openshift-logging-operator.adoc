...
[role="_abstract"]
Pipeline runs, task runs, and event listeners store their logs in their respective pods. It is useful to review and analyze logs for troubleshooting and audits.
