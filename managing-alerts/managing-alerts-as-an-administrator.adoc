...
* xref:../about-ocp-monitoring/key-concepts.adoc#managing-core-platform-alerting-rules_key-concepts[Managing alerting rules for core platform monitoring]
* xref:../about-ocp-monitoring/key-concepts.adoc#tips-for-optimizing-alerting-rules-for-core-platform-monitoring_key-concepts[Tips for optimizing alerting rules for core platform monitoring]
