...
= Configure alerts and notifications for core platform monitoring
...
include::modules/monitoring-configuring-alert-notifications.adoc[leveloffset=+1]
...
include::modules/monitoring-enabling-alert-routing-for-user-defined-projects.adoc[leveloffset=+2]
