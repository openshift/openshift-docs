...
* xref:../configuring-monitoring/configuring-user-workload-monitoring.adoc#enabling-monitoring-for-user-defined-projects_configuring-user-workload-monitoring[Enable monitoring for user-defined projects]
endif::openshift-dedicated,openshift-rosa,openshift-rosa-hcp[]

* xref:../configuring-monitoring/set-up-alerting-and-notification-routing.adoc#understanding-alert-routing-for-user-defined-projects_set-up-alerting-and-notification-routing[Understand alert routing for user-defined projects]

* xref:../configuring-monitoring/set-up-alerting-and-notification-routing.adoc#sending-notifications-to-external-systems_set-up-alerting-and-notification-routing[Send notifications to external systems]
