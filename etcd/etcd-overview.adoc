...
[role="_abstract"]
etcd is the primary Kubernetes data store on {product-title}. Knowing how disk, network, and consensus latency affect etcd helps you keep the control plane reliable.
