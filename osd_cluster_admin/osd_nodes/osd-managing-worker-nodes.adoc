...
[role="_abstract"]
Manage compute (also known as worker) nodes in {product-title} clusters to optimize workload placement and resource allocation. Configure machine pools to control node scaling, apply labels for workload targeting, and add taints to control pod scheduling.
