...
* For more information about custom additional security group requirements, see xref:../../../osd_planning/aws-ccs.adoc#osd-security-groups-custom_aws-ccs[Security groups].
