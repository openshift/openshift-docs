...
* xref:../../osd_architecture/osd_policy/osd-service-definition.adoc#gcp-regions-availability-zones_osd-service-definition[{gcp-full} regions and availability zones]
