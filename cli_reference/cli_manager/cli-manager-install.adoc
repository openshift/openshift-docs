...
[NOTE]
====
Krew will work with {oc-first} without the {cli-manager} installed. You can use the same commands to use Krew with `oc`. For more information, see link:https://krew.sigs.k8s.io/docs/[Krew documentation].
====
