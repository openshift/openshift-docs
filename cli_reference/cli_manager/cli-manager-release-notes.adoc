...
The following advisory is available for the {cli-manager} 0.2.0: (link:https://access.redhat.com/errata/RHEA-2025:XXXX[RHEA-2025:XXXX])
//Link will be provided the day of the release.
