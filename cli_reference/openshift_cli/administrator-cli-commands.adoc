...
This reference provides descriptions and example commands for {oc-first} administrator commands. You must have `cluster-admin` or equivalent permissions to use these commands.
