...
== Projects
A xref:../dev_guide/projects.adoc#dev-guide-projects[project] in OpenShift contains multiple
xref:../architecture/core_concepts/index.adoc#architecture-core-concepts-index[objects] to make up a logical
"xref:../whats_new/applications.adoc#whats-new-applications[application]".
...
can xref:../dev_guide/new_app.adoc#dev-guide-new-app[create a new application] and explore some
