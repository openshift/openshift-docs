...
// AMQ docs link to this "installing-the-cli" anchor; do not change
...
. Enable the repositories required by {product-title} 3.11:
+
[source,terminal]
----
...
. Install the `atomic-openshift-clients` package:
+
[source,terminal]
----
