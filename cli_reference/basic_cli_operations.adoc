...
xref:../dev_guide/deployment_configs.adoc#dev-guide-deployments[deployment configurations] using standard
...
=== deploy
View a xref:../dev_guide/deployment_configs.adoc#dev-guide-deployments[deployment], or manually start,
...
=== rollback
Perform a
xref:../dev_guide/deployment_configs.adoc#rolling-back-a-deployment[rollback]:
----
...
xref:../architecture/core_concepts/deployments.adoc#replication-controllers[replication
controller] or a xref:../dev_guide/deployment_configs.adoc#dev-guide-deployments[deployment configuration] to
