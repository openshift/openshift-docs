...
=== autoscale
Setup an autoscaler for your application. Needs metrics to be enabled in the cluster, see [link](https://docs.openshift.org/latest/install_config/cluster_metrics.html).
----
$ oc autoscale dc/myapp [--options]
----
