...
* Devfile support. With {odo-title}, you can create and deploy your applications using the devfiles. To learn more, see xref:../../cli_reference/developer_cli_odo/creating-applications-by-using-devfiles.adoc#creating-a-java-application-by-using-a-devfile[Creating applications by using devfiles]. To access this feature, you must enable Experimental Mode with `odo preference set experimental true`.
+
