...
You can find the global settings for `odo` in the `preference.yaml` file, which is located by default in your `$HOME/.odo` directory, for example:

Linux:: `/home/userName/.odo/preference.yaml`
Windows:: `C:\\Users\userName\.odo\preference.yaml`
Mac:: `/Users/userName/.odo/preference.yaml`
...
include::modules/developer-cli-odo-managing-defile-registries.adoc[leveloffset=+1]

include::modules/developer-cli-odo-advanced-config.adoc[leveloffset=+1]