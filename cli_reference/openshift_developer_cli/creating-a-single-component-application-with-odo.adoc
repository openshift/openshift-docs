...
* You have xref:../../cli_reference/openshift_developer_cli/creating-a-project-in-odo.adoc#creating-a-project[created a project] 
* Download example application using `$ git clone \https://github.com/openshift/nodejs-ex`
