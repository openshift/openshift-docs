...
If you are creating quick start tutorials for the {product-title} web console, follow these guidelines to keep a consistent user experience across all quick starts.
endif::openshift-rosa,openshift-rosa-hcp,openshift-dedicated[]
ifdef::openshift-rosa,openshift-rosa-hcp,openshift-dedicated[]
Quick start tutorials guide you through completing tasks in the {product-title} web console.
endif::openshift-rosa,openshift-rosa-hcp,openshift-dedicated[]
