...
* For style and structural guidelines, refer to link:https://www.uxd-hub.com/entries/resource/best-practices-for-writing-quick-starts[Best practices for writing quick starts] on the UXD Hub.
