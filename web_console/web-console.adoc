...
To access your web console please refer to the xref:../getting_started_rosa/creating-first-rosa-cluster.html#rosa-accessing-your-cluster[accessing your cluster] section in the guide to creating your first cluster.
