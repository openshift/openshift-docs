...
ifdef::openshift-moa[]
To access your web console please refer to the xref:../getting_started_moa/creating-first-moa-cluster.html#moa-accessing-your-cluste    r[accessing your cluster] section in the guide to creating your first cluster.
endif::openshift-moa[]
