...
* For information about using {cgu-operator} to construct your own `ClusterGroupUpgrade` CR, see xref:../scalability_and_performance/cnf-talo-for-cluster-upgrades.adoc#talo-about-cgu-crs_cnf-topology-aware-lifecycle-operator[About the ClusterGroupUpgrade CR].
...
[role="_additional-resources"]
.Additional resources
* For information about the {cgu-operator-first}, see xref:../scalability_and_performance/cnf-talo-for-cluster-upgrades.adoc#cnf-about-topology-aware-lifecycle-operator-config_cnf-topology-aware-lifecycle-operator[About the {cgu-operator} configuration].
...
* For more information about the {cgu-operator-first}, see xref:../scalability_and_performance/cnf-talo-for-cluster-upgrades.adoc#cnf-about-topology-aware-lifecycle-operator-config_cnf-topology-aware-lifecycle-operator[About the {cgu-operator-first}].

include::modules/cnf-topology-aware-lifecycle-operator-autocreate-cgu-cr-ztp.adoc[leveloffset=+2]

include::modules/cnf-topology-aware-lifecycle-operator-preparing-for-updates.adoc[leveloffset=+1]
