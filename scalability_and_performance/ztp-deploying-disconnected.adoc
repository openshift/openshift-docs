...
include::modules/cnf-topology-aware-lifecycle-operator-installation-web-console.adoc[leveloffset=+3]

include::modules/cnf-topology-aware-lifecycle-operator-installation-cli.adoc[leveloffset=+3]
