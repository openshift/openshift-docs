...
include::quotas/quota.adoc[tag=admin_quota_overview]
...
include::quotas/quota.adoc[tag=admin_quota_viewing]
...
include::quotas/quota.adoc[tag=admin_quota_sample_definitions]

[id=managed-by-quota]
=== Resources Managed by Quota

include::quotas/quota.adoc[tag=admin_quota_resources_managed]

[id=quota-scopes]
=== Quota Scopes

include::quotas/quota.adoc[tag=admin_quota_scopes]

[id=quota-enforcement]
=== Quota Enforcement

include:: ../quotas/quota.adoc[tag=admin_quota_enforcement]
...
include::quotas/quota.adoc[tag=admin_quota_requests_vs_limits]
...
include::quotas/limits.adoc[tag=admin_limits_overview]
...
include::quotas/limits.adoc[tag=admin_limits_viewing]
...
include::quotas/limits.adoc[tag=admin_limits_sample_definitions]

[id=container-limits]
=== Container Limits

include::quotas/limits.adoc[tag=admin_limits_container_limits]

[id=pod-limits]
=== Pod Limits

include::quotas/limits.adoc[tag=admin_limits_pod_limits]
...
xref:quotas/limits.adoc#admin-guide-limits[Resource limits can be set per-project] by cluster administrators. Developers do not have the ability to create, edit, or delete these limits, but can
xref:quotas/limits.adoc#admin_limits_viewing[view them] for projects they have access to.
