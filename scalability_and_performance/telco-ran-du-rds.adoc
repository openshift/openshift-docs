...
include::modules/telco-ran-arm-platform-support.adoc[leveloffset=+1]

[role="_additional-resources"]
.Additional resources

* xref:../scalability_and_performance/telco-ran-du-rds.adoc#telco-ran-node-tuning-operator_telco-ran-du[CPU partitioning and performance tuning]
