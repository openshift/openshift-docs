...
//* xref:../observability/logging/logging-6.2/log6x-about-6.2.adoc#log6x-about-6-2[Logging 6.2]
* xref:../observability/logging/logging-6.2/log6x-release-notes-6.2.adoc#log6x-release-notes-6-2[Logging 6.2]
