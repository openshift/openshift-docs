...
* xref:../scalability_and_performance/cnf-tuning-low-latency-nodes-with-perf-profile.adoc#about_irq_affinity_setting_cnf-tuning-low-latency-nodes-with-perf-profile[Finding the effective IRQ affinity setting for a node]
