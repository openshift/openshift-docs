...
* For details of the telco RAN RDS KPI test results, see link:https://access.redhat.com/articles/7076937[Telco RAN DU reference design specification KPI test results].
