...
[id="sno-du-creating-workload-partitioning-manually-on-single-node-openshift"]
= Creating workload partitioning manually on single node OpenShift
include::modules/common-attributes.adoc[]
:context: sno-du-creating-workload-partitioning-manually-on-single-node-openshift

toc::[]

This procedure tells you how to manually install workload partitioning in a standalone
setting. 
