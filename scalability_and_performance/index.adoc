...
xref:../scalability_and_performance/telco_reference_design_specs/telco-ran-du-rds.adoc#telco-ran-du-ref-design-specs[Telco RAN DU reference design specification for {product-title} {product-version}]

xref:../scalability_and_performance/telco_reference_design_specs/telco-core-rds.adoc#telco-core-ref-design-specs[Telco core reference design specification]
