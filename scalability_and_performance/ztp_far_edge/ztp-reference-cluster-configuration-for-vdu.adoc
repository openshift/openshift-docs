...
* To deploy a fleet of cluster using GitOps zero touch provisioning (ZTP), see xref:../../scalability_and_performance/ztp_far_edge/ztp-deploying-far-edge-sites.adoc#ztp-deploying-far-edge-sites[Deploying far edge sites with ZTP].
