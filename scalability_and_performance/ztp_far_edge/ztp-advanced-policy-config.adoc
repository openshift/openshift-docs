...
* For more information about how to install the AMQ Interconnect Operator, see xref:../../scalability_and_performance/using-rfhe.adoc#hw-installing-amq-interconnect-messaging-bus_using-rfhe[Installing the AMQ messaging bus].
...
* For more information about how to install the {redfish-operator}, see xref:../../scalability_and_performance/using-rfhe.adoc#nw-rfhe-installing-operator-cli_using-rfhe[Installing the {redfish-operator} using the CLI].

[role="_additional-resources"]
.Additional resources

* For more information about how to create the username, password, and host IP address for the BMC secret, see xref:../../scalability_and_performance/using-rfhe.adoc#nw-rfhe-creating-hardware-event_using-rfhe[Creating the bare-metal event and Secret CRs].
