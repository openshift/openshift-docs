...
For edge cases, or scenarios where you want to allow temporary deviations from the reference design, you can apply more advanced customizations. 
...
Some advanced tasks to customize your reference configuration include the following:
...
* *Patching the reference*: Patch a reference to dynamically configure a reference configuration by using a patch option with the `cluster-compare` command.
