...
* xref:../../scalability_and_performance/telco_ran_du_ref_design_specs/telco-ran-du-rds.adoc#telco-ran-du-ref-design-specs[Telco RAN DU reference design specification for {product-title}]
