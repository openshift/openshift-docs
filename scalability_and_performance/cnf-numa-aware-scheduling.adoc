...
include::modules/cnf-understanding-scheduler-image-validation.adoc[leveloffset=+2]

include::modules/cnf-extending-trusted-scheduler-images.adoc[leveloffset=+2]

include::modules/cnf-disabling-scheduler-image-validation.adoc[leveloffset=+2]
