...
include::modules/cnf-understanding-numa-image-validation.adoc[leveloffset=+2]

include::modules/cnf-extending-trusted-numa-images.adoc[leveloffset=+2]

include::modules/cnf-disabling-numa-image-validation.adoc[leveloffset=+2]
