...
include::modules/cnf-understanding-rte-image-validation.adoc[leveloffset=+2]

include::modules/cnf-extending-trusted-rte-images.adoc[leveloffset=+2]

include::modules/cnf-disabling-rte-image-validation.adoc[leveloffset=+2]
