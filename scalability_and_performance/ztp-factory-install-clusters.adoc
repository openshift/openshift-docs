...
For more information about the supported flags and arguments supported see, xref:../scalability_and_performance/ztp-factory-install-clusters.adoc#ztp-factory-install-pipelines-flags-arguments_ztp-factory-install[ZTP factory install pipelines flags and arguments].
