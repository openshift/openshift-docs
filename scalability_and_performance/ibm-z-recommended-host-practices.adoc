...
[id="ibm-z-reg-recommended-host-practices"]
= Recommended host practices for {ibm-z-reg} & {ibm-linux-one-reg} environments
include::_attributes/common-attributes.adoc[]
:context: ibm-z-reg-recommended-host-practices

toc::[]

This topic provides recommended host practices for {product-title} on {ibm-z-reg} and {ibm-linux-one-reg}.
...
[NOTE]
====
Unless stated otherwise, these practices apply to both z/VM and {op-system-base-full} KVM installations on {ibm-z-reg} and {ibm-linux-one-reg}.
====

include::modules/ibm-z-reg-managing-cpu-overcommitment.adoc[leveloffset=+1]
...
include::modules/ibm-z-reg-disable-thp.adoc[leveloffset=+1]

include::modules/ibm-z-reg-boost-networking-performance-with-rfs.adoc[leveloffset=+1]

[role="_additional-resources"]
.Additional resources

* link:https://developer.ibm.com/tutorials/red-hat-openshift-on-ibm-z-reg-tune-your-network-performance-with-rfs/[{product-title} on IBM Z: Tune your network performance with RFS]
...
include::modules/ibm-z-reg-choose-networking-setup.adoc[leveloffset=+1]
...
include::modules/ibm-z-reg-ensure-high-disk-performance-hyperpav.adoc[leveloffset=+1]
...
include::modules/ibm-z-reg-rhel-kvm-host-recommendations.adoc[leveloffset=+1]
...
* link:https://access.redhat.com/documentation/en-us/red_hat_enterprise_linux/8/html/configuring_and_managing_virtualization/getting-started-with-virtualization-in-rhel-8-on-ibm-z-reg_configuring-and-managing-virtualization[Getting started with virtualization on IBM Z]
