...
[NOTE]
====
You must create the service accouint in the namespace in which you create pipelines and other Custom Resources (CRs) for {pipelines-shortname}.
====
