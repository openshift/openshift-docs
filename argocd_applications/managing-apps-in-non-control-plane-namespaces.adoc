...
* xref:../declarative_clusterconfig/configuring-an-openshift-cluster-by-deploying-an-application-with-cluster-configurations.adoc#creating-an-application-by-using-the-argo-cd-dashboard_configuring-an-openshift-cluster-by-deploying-an-application-with-cluster-configurations[Create app by using Argo CD dashboard]
* xref:../argocd_application_sets/managing-app-sets-in-non-control-plane-namespaces.adoc#managing-app-sets-in-non-control-plane-namespaces[Manage ApplicationSets]
