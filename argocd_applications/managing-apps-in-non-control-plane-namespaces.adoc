...
This functionality is particularly useful in multitenancy environments when you want to manage deployments of Argo CD applications for your isolated teams. This functionality is called the _Applications in any namespace_ feature in the Argo CD open source project.
