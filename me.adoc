...
* When pointing to a section that exists in the same documentation set, create an _Additional resources_ section in the assembly file and then place the xref as a bulleted item under this section. For example:
+
[source,text]
----
[role="_additional-resources"]
...
----
* When pointing to a link in a section that exists in another customer product document, use the following format:
+
[source,text]
----
For more information on <topic>, see "<section_name>" in _<document_name>_.
----
+
