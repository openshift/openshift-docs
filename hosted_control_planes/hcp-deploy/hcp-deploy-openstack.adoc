...
include::modules/hosted-clusters-openstack-prepare-etcd.adoc[leveoffset=+1]

include::modules/hosted-clusters-openstack-create-floating-ip.adoc[leveoffset=+1]

include::modules/hosted-clusters-openstack-upload-rhcos.adoc[leveoffset=+1]
