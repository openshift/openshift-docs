...
[role="_additional-resources"]
.Additional resources
* xref:../../disconnected/oc_mirror_v2/about-installing-oc-mirror-v2.adoc#oc-mirror-workflows-partially-disconnected-v2_about-installing-oc-mirror-v2[Mirroring an image set in a partially disconnected environment]
* xref:../../disconnected/oc_mirror_v2/about-installing-oc-mirror-v2.adoc#oc-mirror-workflows-fully-disconnected-v2_about-installing-oc-mirror-v2[Mirroring an image set in a fully disconnected environment]
...
[role="_additional-resources"]
.Additional resources
* xref:../../disconnected/oc_mirror_v2/about-installing-oc-mirror-v2.adoc#about-installing-oc-mirror-v2[Mirroring images for a disconnected installation by using the oc-mirror plugin v2]
