...
* xref:../../disconnected/installing-mirroring-creating-registry.adoc#mirror-registry-introduction_installing-mirroring-creating-registry[Mirror registry for Red{nbsp}Hat OpenShift introduction]
