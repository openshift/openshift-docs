...
[id="disconnected-install-ibmz_{context}"]
...
The `ImageContentSourcePolicy` (ICSP) for the data plane is managed through the `ImageContentSources` API in the hosted cluster manifest. 
