...
include::modules/hcp-metrics-sets-ref.adoc[leveloffset=+2]
...
* xref:../hosted_control_planes/hcp-observability.adoc#hcp-customize-dashboards_hcp-observability[Dashboard customization]
...
include::modules/hcp-customize-dashboards.adoc[leveloffset=+2]
...
include::modules/hcp-hostedcluster-annotations.adoc[leveloffset=+1]
...
// Per-cluster metrics forwarding
include::modules/hcp-metrics-forwarding-about.adoc[leveloffset=+1]

include::modules/hcp-metrics-forwarding-per-cluster-configure.adoc[leveloffset=+2]

include::modules/hcp-metrics-forwarding-migrate-from-annotation.adoc[leveloffset=+2]

include::modules/hcp-metrics-forwarding-api-reference.adoc[leveloffset=+2]
