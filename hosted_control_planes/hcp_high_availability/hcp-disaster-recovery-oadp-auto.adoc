...
For information about automated disaster recovery for hosted clusters on {azure-first}, see "Automated disaster recovery for {hcp} on {azure-short}".
...
include::modules/hcp-dr-oadp-dpa-bm.adoc[leveloffset=+2]

include::modules/hcp-dr-oadp-dpa-aws.adoc[leveloffset=+2]
...
[role="_additional-resources"]
[id="additional-resources_hcp-azure-auto-dr"]
== Additional resources

* xref:../../hosted_control_planes/hcp-deploy/hcp-deploy-azure.adoc#hcp-azure-automated-dr_hcp-deploy-azure[Automated disaster recovery for {hcp} on {azure-short}]