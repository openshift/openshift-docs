...
* You xref:../../oadp/installing/oadp-installing-operator.adoc#oadp-installing-operator[installed the {oadp-short} Operator].
...
* xref:../../oadp/installing/installing-oadp-aws.adoc#installing-oadp-aws[Configuring the {oadp-full} with Multicloud Object Gateway]
...
* xref:../../oadp/installing/installing-oadp-mcg.adoc#installing-oadp-mcg[Configuring the {oadp-full} with AWS S3 compatible storage]
