...
==== Deleting resource manifests now documented
With this release, you can delete the resource manifests. For more information, see
//xref:../microshift_running_apps/microshift-deleting-resource-manifests.adoc#microshift-deleting-resource-manifests[Deleting resource manifests]
