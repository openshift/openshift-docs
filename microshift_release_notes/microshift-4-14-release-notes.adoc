...
[id="microshift-4-14-39-dp_{context}"]
=== RHBA-2024:8237 - {microshift-short} 4.14.39 bug fix and security update advisory
...
[id="microshift-4-14-43-dp_{context}"]
=== RHBA-2024:11033 - {microshift-short} 4.14.43 bug fix and security update advisory
...
[id="microshift-4-14-45-dp_{context}"]
=== RHBA-2025:0366 - {microshift-short} 4.14.45 bug fix and security update advisory
...
[id="microshift-4-14-53-dp_{context}"]
=== RHBA-2025:9874 - {microshift-short} 4.14.53 bug fix and enhancement advisory

Issued: 2 July 2025

{product-title} release 4.14.53 is now available, see the link:https://access.redhat.com/errata/RHBA-2025:9874[RHBA-2025:9874] advisory. The images that are included in the update are provided by the link:https://access.redhat.com/errata/RHSA-2025:9759[RHSA-2025:9759] advisory.
