...
With this release, workload partitioning is supported in {microshift-short}. For more information, see xref:../microshift_configuring/microshift-workload-partitioning.adoc#microshift-enabling-workload-partitioning_microshift-workload-partitioning[Workload partitioning].
