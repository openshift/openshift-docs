...
==== Collecting metrics using the {microshift-short} Observability service
 ...
 // For more information, see xref:../microshift_running_apps/microshift-observability-service.adoc#microshift-observability-service-checks[{microshift-short} Observability service].
