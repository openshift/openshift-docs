...
With this release, you can configure the {microshift-short} Observability service to collect performance and usage metrics for monitoring resources. The amount of collected data depends on one of three predefined configurations that differ in the amount of collected data. The configuration defaults to the maximum amount of collected data.
