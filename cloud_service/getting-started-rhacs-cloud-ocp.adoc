...
* In the ACS Console, use the xref:../cloud_service/installing_cloud_ocp/install-secured-cluster-cloud-ocp.adoc#install-secured-cluster-cloud-ocp[legacy installation method] to generate a cluster bundle.
* From a system that has access to the monitored cluster, xref:../cloud_service/installing_cloud_ocp/install-secured-cluster-cloud-ocp.adoc#install-secured-cluster-cloud-ocp[generate the configuration and extract and run the sensor script from the cluster bundle].
. xref:../cloud_service/installing_cloud_ocp/verify-installation-cloud-ocp.adoc#verify-installation-cloud-ocp[Verify installation] by ensuring that your secured clusters can communicate with the ACS instance.
...
. Complete only one of the following steps:
* In the ACS Console, use the xref:../cloud_service/installing_cloud_other/install-secured-cluster-cloud-other.adoc#install-secured-cluster-cloud-other[legacy installation method] to generate a cluster bundle.
* From a system that has access to the monitored cluster, xref:../cloud_service/installing_cloud_ocp/install-secured-cluster-cloud-ocp.adoc#install-secured-cluster-cloud-ocp[generate the configuration and extract and run the sensor script from the cluster bundle].
. xref:../cloud_service/installing_cloud_ocp/verify-installation-cloud-ocp.adoc#verify-installation-cloud-ocp[Verify installation] by ensuring that your secured clusters can communicate with the ACS instance.
