...
You are responsible for regularly upgrading the version of {product-title-short} on your secured clusters to ensure compatibility with {product-title-managed-short}.
...
//does this apply to Cloud Service? Or only updating Central components?
