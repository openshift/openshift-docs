...
= Traffic routing with OpenShift Service Mesh
...
* xref:../extend/routing-traffic-by-using-argo-rollouts.adoc#routing-traffic-by-using-argo-rollouts[Traffic routing with OpenShift Routes]
