...
= Traffic routing with OpenShift Routes
...
* You have installed the xref:../install/installing-argocd-gitops-cli.adoc#installing-argocd-gitops-cli[{gitops-title} CLI] on your system.
...
* xref:../configure/configuring-argocd-gitops-cli.adoc#configuring-argocd-gitops-cli[Shell environment productivity features]
* xref:../extend/argo-rollouts-overview.adoc#gitops-argo-rollouts-cli-overview_argo-rollouts-overview[Argo Rollouts CLI capabilities and usage]
