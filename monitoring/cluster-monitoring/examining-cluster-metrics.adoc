...
See the xref:../../monitoring/monitoring-your-own-services.adoc#monitoring-your-own-services[User workload monitoring documentation]. It includes details on accessing non-cluster metrics as a developer or a privileged user.
