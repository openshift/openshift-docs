...
* For documentation on the new interface for Alertmanager, see xref:../cluster-monitoring/managing-cluster-alerts.adoc#managing-cluster-alerts[Managing cluster alerts].
