...
ifndef::openshift-dedicated,openshift-rosa,openshift-origin[]
* xref:../support/getting-support.adoc#support-submitting-a-case_getting-support[Submitting a support case]
endif::openshift-dedicated,openshift-rosa,openshift-origin[]
...
* xref:../osd_architecture/osd-support.adoc#support_osd-getting-support[Submitting a support case]
