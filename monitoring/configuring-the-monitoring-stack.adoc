...
.Additional resources
* See the link:https://prometheus.io/docs/alerting/latest/alertmanager/[Prometheus Alertmanager documentation] for more information about Alertmanager.
* See xref:../monitoring/managing-alerts.html[Managing alerts] for more information about managing and configuring alerts in the {product-title} monitoring stack.
