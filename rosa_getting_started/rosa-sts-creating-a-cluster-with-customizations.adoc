...
* xref:../rosa_getting_started/rosa-sts-accessing-cluster.adoc#rosa-sts-accessing-cluster[Accessing a ROSA cluster]

[role="_additional-resources"]
[id="additional-resources_rosa-sts-creating-a-cluster-with-customizations"]
== Additional resources

* For more information about the AWS Identity Access Management (IAM) resources required to deploy {product-title} with STS, see xref:../rosa_getting_started/rosa-sts-about-iam-resources.adoc#rosa-sts-about-iam-resources[About IAM resources for clusters that use STS].
* For an overview of the options that are presented when you create a cluster using interactive mode, see xref:../rosa_getting_started/rosa-sts-interactive-mode-reference.adoc#rosa-sts-understanding-interactive-mode-options_rosa-sts-interactive-mode-reference[Interactive cluster creation mode reference].
