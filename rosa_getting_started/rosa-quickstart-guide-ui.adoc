...
* You reviewed the xref:../rosa_architecture/rosa-understanding.adoc#rosa-understanding[introduction to {product-title} (ROSA)], and the documentation on ROSA xref:../architecture/rosa-service-architecture.adoc[architecture models] and xref:../architecture/architecture.adoc[architecture concepts].
