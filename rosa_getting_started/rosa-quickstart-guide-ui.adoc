...
//
* You have reviewed the detailed xref:../rosa_planning/rosa-hcp-prereqs.adoc#rosa-hcp-prereqs[AWS prerequisites for ROSA clusters] or xref:../rosa_planning/rosa-classic-prereqs.adoc#rosa-classic-prereqs[AWS prerequisites for ROSA (classic architecture) clusters].
...
//
* For more information about setting up accounts and ROSA clusters using AWS STS, see xref:../rosa_planning/rosa-hcp-prereqs.adoc#rosa-sts-overview-of-the-deployment-workflow[Understanding the ROSA deployment workflow] or xref:../rosa_planning/rosa-classic-prereqs.adoc#rosa-sts-overview-of-the-deployment-workflow[Understanding the ROSA (classic architecture) deployment workflow].
