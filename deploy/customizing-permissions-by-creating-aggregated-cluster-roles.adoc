...
* xref:../deploy/customizing-permissions-by-creating-user-defined-cluster-roles-for-cluster-scoped-instances.adoc#customizing-permissions-by-creating-user-defined-cluster-roles-for-cluster-scoped-instances[User-defined cluster role permissions]
...
* xref:../configure/setting-up-argocd-instance.adoc#setting-up-argocd-instance[Argo CD instance deployment]
