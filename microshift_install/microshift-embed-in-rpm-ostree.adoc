...
Plan to use a supported version of {op-system-base} paired with your version of {microshift-short} as described in the following table.

[id="embed-ostree-rhde-compatibility-table"_{context}]
== Compatibility table
