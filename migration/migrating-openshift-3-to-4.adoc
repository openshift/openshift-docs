...
[IMPORTANT]
====
Before you begin your migration, be sure to review the information on xref:../migration/planning-migration-3-to-4.adoc#planning-migration-3-to-4[planning your migration].
====
