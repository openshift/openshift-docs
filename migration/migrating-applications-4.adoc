[id='migrating-applications-4']
= Migrating your applications
include::modules/common-attributes.adoc[]
:context: migrating-applications-4
...
* xref:../migration/about-mtc-4.adoc#migration-about-migration-hooks_about-mtc-4[About migration hooks]
* xref:../migration/migrating-applications-4.adoc#mighook_migrating-applications-4[MigHook custom resource]
* xref:../migration/migrating-applications-4.adoc#migplan_migrating-applications-4[MigPlan custom resource]
...
* xref:../migration/about-mtc-4.adoc#file-system-copy-method_about-mtc-4[{mtc-short} file system copy method]
* xref:../migration/about-mtc-4.adoc#snapshot-copy-method_about-mtc-4[{mtc-short} snapshot copy method]
* xref:../migration/troubleshooting-4.adoc#migration-viewing-migration-crs_troubleshooting-4[Viewing migration custom resources]
