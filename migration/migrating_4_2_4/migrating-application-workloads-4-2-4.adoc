...
[NOTE]
====
You can migrate between {product-title} clusters of the same version, for example, from 4.2 to 4.2, as long as the source and target clusters are configured correctly.
====
