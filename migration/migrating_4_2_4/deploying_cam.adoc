...
You can deploy the CAM tool on a xref:../../migration/migrating_4_2_4/deploying_cam.adoc#installing-cam-operator-on-restricted-network_migrating-4_2-4_x[restricted network].
...
:context: migrating-4_2-4_x
:migrating-4_2-4_x:
include::modules/migration-installing-cam-operator-on-restricted-network.adoc[leveloffset=+1]
:!migrating-4_2-4_x:
