...
You can migrate application workloads from {product-title} 3.7 (and later) to {product-title} {product-version} with the {mtc-first}. {mtc} enables you to control the migration and to minimize application downtime.
