...
You can build a custom Operator catalog image for {product-title} 4, push it to a local mirror image registry, and configure the Operation Lifecycle Manager to install the Cluster Application Migration Operator from the local registry.
