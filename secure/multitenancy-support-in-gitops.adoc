...
* xref:../reference/gitops-terminology-reference.adoc#gitops-openshift-go-common-terms_gitops-terminology-reference[Glossary of common terms for OpenShift {gitops-shortname}]
