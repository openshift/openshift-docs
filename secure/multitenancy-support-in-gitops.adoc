...
= Multitenancy and namespace management
...
[role="_additional-resources"]
== Additional resources
* xref:../deploy/managing-apps-in-non-control-plane-namespaces.adoc#managing-apps-in-non-control-plane-namespaces[Applications in non-control plane namespaces]
...
* xref:../deploy/configuring-an-openshift-cluster-by-deploying-an-application-with-cluster-configurations.adoc#configuring-an-openshift-cluster-by-deploying-an-application-with-cluster-configurations[Cluster configuration with application deployment]
