...
include::modules/rosa-capacity-reservations-overview.adoc[leveloffset=+1]
...
include::modules/creating-a-machine-pool-cli-autoscaling.adoc[leveloffset=+2]
...
* xref:../../rosa_cluster_admin/rosa_nodes/rosa-nodes-about-autoscaling-nodes.adoc#nodes-enabling-autoscaling-nodes_rosa-nodes-about-autoscaling-nodes[Enabling autoscaling]
* xref:../../rosa_cluster_admin/rosa_nodes/rosa-nodes-about-autoscaling-nodes.adoc#rosa-nodes-about-autoscaling-nodes-disabling_rosa-nodes-about-autoscaling-nodes[Disabling autoscaling]
