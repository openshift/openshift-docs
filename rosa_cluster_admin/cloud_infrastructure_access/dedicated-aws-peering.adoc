...
[role="_abstract"]
Configure an AWS Virtual Private Cloud (VPC) containing your {product-title} cluster to peer with another AWS VPC network.
...
* link:https://docs.aws.amazon.com/AmazonVPC/latest/PeeringGuide/Welcome.html[AWS VPC Peering]
