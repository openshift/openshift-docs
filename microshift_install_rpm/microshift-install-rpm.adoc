...
* xref:../microshift_security/microshift-cis-level-2.adoc#microshift-cis-level-2[Preparing {microshift-short} for CIS Level 2 compliance]
* link:https://console.redhat.com/openshift/install/pull-secret[Pull secret from {cluster-manager-first}]
