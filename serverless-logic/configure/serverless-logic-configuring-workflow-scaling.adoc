...
* xref:serverless-logic-managing-persistence.adoc#serverless-logic-managing-persistence[Managing workflow persistence]
* xref:../operate/serverless-logic-managing-supporting-services.adoc#serverless-logic-managing-supporting-services[Managing supporting services]
