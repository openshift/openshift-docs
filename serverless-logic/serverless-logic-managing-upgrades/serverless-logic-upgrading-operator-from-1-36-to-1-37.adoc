...
include::modules/serverless-logic-upgrade-1-37-restoring-workflows-with-preview-profile.adoc[leveloffset=+2]

include::modules/serverless-logic-upgrade-1-37-redeploying-workflows-with-gitops-profile.adoc[leveloffset=+2]

include::modules/serverless-logic-verifying-the-1-37-0-upgrade.adoc[leveloffset=+1]
