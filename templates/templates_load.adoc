...
because the default templates operate on the default *openshift*
...
In addition to the default {product-title} project, you can add the templates to specific projects.
