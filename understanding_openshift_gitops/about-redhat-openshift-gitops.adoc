...
Documentation for specific versions is available using the version selector dropdown, or directly by adding the version to the URL, for example, link:https://docs.redhat.com/en/documentation/red_hat_openshift_gitops/1.18[].
