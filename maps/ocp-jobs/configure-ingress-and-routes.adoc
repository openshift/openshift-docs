...
include::modules/configure-ingress-and-routes-con.adoc[leveloffset=+0]
...
include::understand-ingress-architecture.adoc[leveloffset=+1]

include::configure-ingress-controller-parameters.adoc[leveloffset=+1]

include::configure-advanced-ingress-features.adoc[leveloffset=+1]

// TODO: backport -- the configuring_gateway_api book does not exist; re-add this sub-job on enterprise-4.20
//include::understand-gateway-api.adoc[leveloffset=+1]

// TODO: backport -- the configuring_gateway_api book does not exist; re-add this sub-job on enterprise-4.20
//include::configure-gateway-resources.adoc[leveloffset=+1]

// TODO: backport -- the configuring_gateway_api book does not exist; re-add this sub-job on enterprise-4.20
//include::configure-httproute-resources.adoc[leveloffset=+1]
