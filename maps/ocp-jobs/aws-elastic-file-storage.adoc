...
:context: aws-elastic-file-storage

include::modules/persistent-storage-csi-efs-overview.adoc[leveloffset=+0]
...
include::modules/persistent-storage-csi-efs-driver-install.adoc[leveloffset=+1]
...
include::modules/persistent-storage-csi-efs-one-zone-procedure.adoc[leveloffset=+1]
...
include::modules/persistent-storage-csi-efs-metrics-procedure-gui.adoc[leveloffset=+1]

include::modules/persistent-storage-csi-efs-metrics-procedure-cli.adoc[leveloffset=+1]
