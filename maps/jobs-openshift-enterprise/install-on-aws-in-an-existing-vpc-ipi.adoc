...
include::modules/installation-aws-permissions-iam-shared-vpc.adoc[leveloffset=+1]
...
include::modules/allocating-load-balancers.adoc[leveloffset=+1]

include::modules/nw-allocating-load-balancers-to-subnets.adoc[leveloffset=+1]

include::modules/nw-allocate-load-balancers-to-subnets-procedure.adoc[leveloffset=+1]
