...
include::modules/k8s-nmstate-deploying-nmstate-CLI.adoc[leveloffset=+1]

include::modules/viewing-stats-collected-kubernetes-nmtate-op.adoc[leveloffset=+1]
...
include::modules/nw-metallb-operator-setting-pod-priority-affinity.adoc[leveloffset=+1]

include::modules/nw-metallb-operator-setting-pod-CPU-limits.adoc[leveloffset=+1]
