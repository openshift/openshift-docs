...
include::modules/enabling-entra-workload-id-existing-cluster.adoc[leveloffset=+1]

include::modules/enabling-aws-sts-existing-cluster.adoc[leveloffset=+1]
...
include::modules/troubleshooting-certs-manual-proxy.adoc[leveloffset=+1]
