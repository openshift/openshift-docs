...
include::modules/network-observability-custom-health-rule-configuration.adoc[leveloffset=+1]

include::modules/network-observability-health-rules-recording-rules-performance-optimization.adoc[leveloffset=+1]

include::modules/network-observability-recording-rule-custom-configuration.adoc[leveloffset=+1]
