...
You can configure fair sharing by xref:../install/install-kueue.adoc#create-kueue-cr_install-kueue[setting the `preemptionPolicy` value in the `Kueue` custom resource (CR) to `FairSharing`].
