...
* For information about enabling console attributes, see xref:../configure/configure-lokistack-otlp.adoc#configuring-lokistack-otlp-data-ingestion_configure-lokistack-otlp[Configure LokiStack for OTLP data ingestion].
* For information about the attributes, see xref:../configure/opentelemetry-data-model.adoc#attributes_opentelemetry-data-model[OpenTelemetry data model attributes].
