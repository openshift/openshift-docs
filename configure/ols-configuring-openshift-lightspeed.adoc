...
include::modules/ols-granting-user-group-access-by-using-cli.adoc[leveloffset=+2]
...
include::modules/ols-configuring-query-system-prompt.adoc[leveloffset=+1]

include::modules/ols-about-the-offline-knowledge-portal.adoc[leveloffset=+1]
...
include::modules/ols-con-authentication-flow-for-cluster-introspection.adoc[leveloffset=+2]
