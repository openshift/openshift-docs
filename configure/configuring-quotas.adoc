...
The cluster queue is not ready for use until a xref:../configure/configuring-quotas.adoc#resource-groups-flavors_configuring-quotas[`ResourceFlavor` object] has also been configured.
