...
* xref:../../reference/opentelemetry-data-model.adoc#opentelemetry-data-model[OpenTelemetry data model]
...
* xref:../../reference/opentelemetry-data-model.adoc#attributes_opentelemetry-data-model[OpenTelemetry data model attributes]
