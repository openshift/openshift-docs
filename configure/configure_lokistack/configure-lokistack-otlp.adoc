...
* xref:../configure/configure-lokistack-otlp.adoc#configuring-lokistack-otlp-data-ingestion_configure-lokistack-otlp[Configure LokiStack for OTLP data ingestion]
