...
Using cohorts can help to optimize resource utilization by preventing under-utilization and ensuring fair allocation based on priority.
// check this is true about priority
