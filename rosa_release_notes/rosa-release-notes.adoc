...
See xref:../rosa_govcloud/rosa-govcloud-getting-started#rosa-govcloud-getting-started[Getting started with ROSA GovCloud].
endif::openshift-rosa-hcp[]
ifdef::openshift-rosa[]
See xref:../rosa_govcloud/rosa-govcloud-getting-started#rosa-govcloud-getting-started#rosa-govcloud-getting-started[Getting started with ROSA GovCloud].
