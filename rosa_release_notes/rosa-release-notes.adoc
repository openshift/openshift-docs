...
ifdef::openshift-rosa-hcp[]See xref:../rosa_hcp/rosa_govcloud/rosa-govcloud-getting-started#rosa-govcloud-getting-started[Getting started with ROSA GovCloud]
endif::openshift-rosa-hcp[]
ifdef::openshift-rosa[]
See xref:../rosa/rosa_govcloud/rosa-govcloud-getting-started#rosa-govcloud-getting-started#rosa-govcloud-getting-started[Getting started with ROSA GovCloud].
