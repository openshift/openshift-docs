...
* link:https://access.redhat.com/documentation/en-us/openshift_container_platform/4.12/html/backup_and_restore/application-backup-and-restore#installing-oadp-aws[Installing and configuring the OpenShift API for Data Protection with Amazon Web Services]
