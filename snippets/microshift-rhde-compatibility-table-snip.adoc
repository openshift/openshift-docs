...
[id="compatibility-matrix_{context}"]
= Compatibility matrix

You must pair a supported version of {op-system-base} with the {microshift-short} version you are using as described in the following compatibility matrix.
