...
[TIP]
====
An insights rule on `console.redhat.com` alerts you to update to {product-title} {product-version}.{olm-np-z-stream} or later, if the currently installed version of OLM does not support tailored network policies.
====
