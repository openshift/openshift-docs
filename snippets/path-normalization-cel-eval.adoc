...
Make that you configure your upstream service so that you do not unintentionally bypass your own security. For more information, see link:https://istio.io/latest/docs/ops/best-practices/security/#customize-your-system-on-path-normalization[Customize your system on path normalization].
====
