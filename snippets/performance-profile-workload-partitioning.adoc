...
[IMPORTANT]
====
The reserved and isolated DERPEEDOO pools must not overlap and together must span all available cores. DERPEEDOO cores that are not accounted for cause an undefined behaviour in the system.
====
