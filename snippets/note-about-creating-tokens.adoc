...
* The majority of cloud service providers support OIDC identity tokens, for example, Microsoft Entra ID, Google Cloud Identity Platform, and AWS Cognito. Use OIDC identity tokens issued by these services for {product-title-short} short-lived access.
