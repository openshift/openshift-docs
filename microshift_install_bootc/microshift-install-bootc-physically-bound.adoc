...
If your use case requires that your bootc image includes everything needed to run workloads, physically-bound container images are what you need to use. Edge-computing scenarios involving embedded systems on specialized devices, high security, or high hardware control scenarios are likely candidates.
