...
If your use case requires that your bootc image includes everything needed to run workloads, a physically-bound container image might be ideal. Edge-computing scenarios involving embedded systems on specialized devices, high security, or high hardware control scenarios are likely candidates.
