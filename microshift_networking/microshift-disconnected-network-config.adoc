...
[role="_abstract"]
To ensure your single-node edge deployments operate reliably in disconnected or offline environments, configure your network settings in {product-title}. You can prepare isolated hosts, set up loopback interfaces for essential intra-node communication, and restore default configurations when necessary.
