...
Ruby on Rails is a web framework written in Ruby. This guide covers
using Rails 4 on {product-title}.

[WARNING]
====
Go through the whole tutorial to have an overview of all
...
* Running instance of {product-title} v4.
endif::[]
ifdef::openshift-online[]
* Provisioned account in OpenShift Online.
endif::[]
* Make sure that an instance of {product-title} is running and is available. Also
make sure that your `oc` CLI client is installed and the command is accessible
