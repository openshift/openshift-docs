...
* xref:../openshift_images/configuring-samples-operator.adoc#images-samples-operator-deprecated-image-stream_configuring-samples-operator[Remove deprecated image stream tags from the Cluster Samples Operator]
