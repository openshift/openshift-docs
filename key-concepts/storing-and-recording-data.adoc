...
* xref:../key-concepts/preparing-to-configure-the-monitoring-stack.adoc#preparing-to-configure-the-monitoring-stack[Prepare to configure core platform monitoring stack]
