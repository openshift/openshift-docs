...
== Find the load balancer IP of the load balancer in your cluster
...
== Update the component routes and TLS secret using the OCM CLI
...
== Reset the component routes to the default using the OCM CLI
