...
include::modules/support-generating-a-sosreport-archive.adoc[leveloffset=+2]
include::modules/support-generating-a-sosreport-archive-9.adoc[leveloffset=+2]
...
include::modules/support-collecting-network-trace-10.adoc[leveloffset=+2]
include::modules/support-collecting-network-trace-9.adoc[leveloffset=+2]
endif::openshift-origin[]
...
include::modules/installing-packages-to-a-toolbox-container-9.adoc[leveloffset=+2]
...
include::modules/support-starting-an-alternative-image-with-toolbox-9.adoc[leveloffset=+2]
