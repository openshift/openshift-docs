...
* xref:../support/troubleshooting/troubleshooting-operating-system-issues.adoc#troubleshooting-operating-system-issues[Operating system issues]: {product-title}  runs on {op-system-first}. If you experience operating system issues, you can investigate kernel crash procedures. Ensure the following:
