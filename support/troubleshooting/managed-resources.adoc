...
If you are experiencing issues, see more information here: xref:../../rosa_architecture/rosa_policy_service_definition/sd-managed-resources.adoc#sd-managed-resources[Red Hat Managed resources]