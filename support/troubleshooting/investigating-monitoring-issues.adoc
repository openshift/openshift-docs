...
You can follow these procedures if your own metrics are unavailable, if Prometheus is consuming a lot of disk space, or if the `KubePersistentVolumeFillingUp` alarm is firing for Prometheus.
