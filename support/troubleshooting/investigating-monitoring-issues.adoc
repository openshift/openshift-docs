...
* See link:https://docs.redhat.com/en/documentation/monitoring_stack_for_red_hat_openshift/4.15/html/configuring_user_workload_monitoring/configuring-metrics-uwm#specifying-how-a-service-is-monitored_configuring-metrics-uwm[Specifying how a service is monitored] for details on how to create a service monitor or pod monitor
* See link:https://docs.redhat.com/en/documentation/monitoring_stack_for_red_hat_openshift/4.15/html/accessing_metrics/accessing-metrics-as-an-administrator#getting-detailed-information-about-a-target_accessing-metrics-as-an-administrator[Getting detailed information about a metrics target]
endif::openshift-rosa,openshift-dedicated[]
...
.Additional resources
ifdef::openshift-rosa,openshift-dedicated[]
* See xref:../../observability/monitoring/configuring-the-monitoring-stack.adoc#setting-scrape-sample-and-label-limits-for-user-defined-projects_configuring-the-monitoring-stack[Setting a scrape sample limit for user-defined projects]
endif::openshift-rosa,openshift-dedicated[]
ifndef::openshift-rosa,openshift-dedicated[]
* link:https://docs.redhat.com/en/documentation/monitoring_stack_for_red_hat_openshift/4.15/html/configuring_user_workload_monitoring/configuring-performance-and-scalability-uwm#setting-scrape-and-evaluation-intervals-limits-for-user-defined-projects_configuring-performance-and-scalability-uwm[Setting a scrape sample limit for user-defined projects]
endif::openshift-rosa,openshift-dedicated[]
