...
If you are experiencing issues, see more information here: xref:../../rosa_architecture/rosa_policy_service_definition/rosa-policy-responsibility-matrix.adoc#sd-managed-resources-overview_sd-managed-resources[Red Hat Managed resources]
endif::openshift-rosa[]
