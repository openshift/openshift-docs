...
* For information about the prerequisites to installing {hcp-title} clusters, see xref:../../rosa_planning/rosa-hcp-prereqs.adoc#rosa-hcp-prereqs[AWS prerequisites for ROSA].
