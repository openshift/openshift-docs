...
* For more information about creating a VPC, see xref:../../rosa_hcp/rosa-hcp-sts-creating-a-cluster-quickly.adoc#rosa-hcp-creating-vpc[Creating a Virtual Private Cloud for your ROSA with HCP clusters].
