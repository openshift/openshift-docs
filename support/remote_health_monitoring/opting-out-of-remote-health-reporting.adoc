...
[id="opting-out-remote-health-reporting-next-steps"]
== Next steps

* xref:../../support/remote-health-monitoring-with-connected-clusters.adoc#images-update-global-pull-secret_opting-out-remote-health-reporting[Updating the global cluster pull secret]
