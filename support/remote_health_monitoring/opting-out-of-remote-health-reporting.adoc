...
Alternatively, you can obfuscate the IPv4 addresses and cluster base domains Insights Operator sends to link:https://cloud.redhat.com[cloud.redhat.com]. This feature is disabled by default. See xref:../../support/remote_health_monitoring/opting-out-of-remote-health-reporting.adoc#insights-operator-enable-obfuscation_opting-out-remote-health-reporting[Enabling Insights Operator data obfuscation] for details.
...
include::modules/insights-operator-enable-ofuscation.adoc[leveloffset=+1]
