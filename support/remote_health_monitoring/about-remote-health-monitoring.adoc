...
* Telemetry is installed and enabled by default. If you need to disable remote health reporting, see xref:../../support/remote_health_monitoring/remote-health-reporting.adoc#remote-health-reporting[Remote health reporting].
endif::[]
...
* The Insights Operator is installed and enabled by default. If you need to disable remote health reporting, see xref:../../support/remote_health_monitoring/remote-health-reporting.adoc#remote-health-reporting[Remote health reporting].
