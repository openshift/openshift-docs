...
* See xref:../../monitoring/cluster_monitoring/about-cluster-monitoring.adoc#about-cluster-monitoring[About Cluster Monitoring] for more information about the {product-title} monitoring stack.
