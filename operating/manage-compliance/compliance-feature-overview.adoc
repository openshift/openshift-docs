...
* *Schedules* and *Coverage (Tech preview)*, formerly known as _Compliance 2.0_, summarizes the compliance information in a single  interface after the scheduled scans by using the Compliance Operator.
+
[IMPORTANT]
====
...
For more information, see xref:../../operating/manage-compliance/scheduling-compliance-scans-and-assessing-profile-compliance.adoc#scheduling-compliance-scans-and-assessing-profile-compliance[Scheduling compliance scans and assessing profile compliance (Technology preview)].
====
