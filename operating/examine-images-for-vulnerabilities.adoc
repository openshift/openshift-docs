...
include::modules/enabling-scanner-v4-helm.adoc[leveloffset=+2]
...
include::modules/enabling-scanner-v4-after-operator-installation.adoc[leveloffset=+2]

include::modules/enabling-scanner-v4-after-helm-installation.adoc[leveloffset=+2]
