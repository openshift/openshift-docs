...
The StackRox Scanner originates from a fork of the Clair v2 open source scanner and is deprecated. Scanner V4, built on ClairCore, is the default scanner as of release 4.8.
