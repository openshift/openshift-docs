...
[id="understanding-policy-rules"]
= Understanding policy rules
include::modules/common-attributes.adoc[]
:context: understanding-policy-rules
...
ADD SOME BACKGROUND/OVERALL INFORMATION ABOUT POLICY RULES BEFORE LAUNCHING IN TO DESCRIPTIONS OF ATTRIBUTES.
