...
* xref:../create-use-collections.adoc#create-use-collections[Creating and using collections]
...
include::modules/scope-rule-evaluation-logic.adoc[leveloffset=+3]

include::modules/ref-policy-scope-label-syntax.adoc[leveloffset=+3]
