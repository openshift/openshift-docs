...
`data.runtime_config.yaml.networking.externalIps.direction`:: Specifies whether to collect both ingress and egress connections. If you do not specify a value, it defaults to `BOTH`. This field
--