...
Connect an Azure Active Directory (AD) to {product-title-short} using SSO configuration. For more information, see xref:../manage-user-access/configuring-identity-providers/connecting-azure-ad-to-rhacs-using-sso-configuration.adoc#connecting-azure-ad-to-rhacs-using-sso-configuration[Connecting Azure AD to {product-title-short} using SSO configuration].
