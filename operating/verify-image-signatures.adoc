...
* {product-title-short} supports discovering Cosign signatures by using the link:https://github.com/opencontainers/distribution-spec/blob/v1.1.1/spec.md#listing-referrers[OCI 1.1 referrers API] and the link:https://github.com/sigstore/cosign/blob/v3.1.3/specs/SIGNATURE_SPEC.md[tag-based discovery method].
