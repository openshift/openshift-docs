...
* For Cosign signature verification, {product-title-short} supports communication with the transparency log link:https://docs.sigstore.dev/logging/overview/[Rekor] (Sigstore documentation).
* For Cosign signature verification, {product-title-short} supports keyless verification of the signatures by using {rh-rhtas-first}.
