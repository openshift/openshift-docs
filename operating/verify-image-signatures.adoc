...
For more information, see xref:../operating/manage_security_policies/custom-security-policies.adoc#enable-admission-controller_custom-security-policies[Enabling admission controller enforcement].
