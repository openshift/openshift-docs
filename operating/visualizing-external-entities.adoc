...
You can view external entities in the Network Graph by selecting the External Entities graph node or in a deployment flows tab.

External entities can also be queried by using the API.
