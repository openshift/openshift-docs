...
For more information, see xref:../operating/manage-compliance/performing-and-monitoring-compliance-scans.adoc#checking-the-compliance-status-of-your-infrastructure_performing-and-monitoring-compliance-scans[Checking the compliance status of your infrastructure].
====
