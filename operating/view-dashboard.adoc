...
[NOTE]
====
The *Compliance* widget shows details only after you run a xref:../operating/manage-compliance/managing-compliance-10.adoc#run-compliance-scan_managing-compliance-10[compliance scan].
====
