...
{product-title} (Field Trial) uses the PostgreSQL database by default. Other {product-title-short} customers can migrate to the PostgreSQL database with help from Red Hat.
...
* xref:../operating/manage-vulnerabilities/vulnerability-management.adoc#vulnerability-management-scheduled-report_acs-operating-manage-vulnerabilities[Vulnerability reporting]
