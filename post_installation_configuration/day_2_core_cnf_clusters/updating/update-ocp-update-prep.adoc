...
* xref:../../../post_installation_configuration/day_2_core_cnf_clusters/updating/update-completing-the-control-plane-only-update.adoc#update-updating-all-the-olm-operators_completing-the-update[Updating all the OLM Operators]
