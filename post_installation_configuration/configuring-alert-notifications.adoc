...
[role="_abstract"]
To notify teams outside the cluster when alerting rules fire, configure {product-title} to send alert notifications to external systems such as PagerDuty, Slack, or email.
