...
* link:https://docs.redhat.com/en/documentation/monitoring_stack_for_red_hat_openshift/4.16/html/configuring_core_platform_monitoring/configuring-alerts-and-notifications[Configuring alerts and notifications for core platform monitoring]
* link:https://docs.redhat.com/en/documentation/monitoring_stack_for_red_hat_openshift/4.16/html/configuring_user_workload_monitoring/configuring-alerts-and-notifications-uwm[Configuring alerts and notifications for user workload monitoring]
