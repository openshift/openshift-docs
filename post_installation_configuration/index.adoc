...
[role="_abstract"]
After installing {product-title}, a cluster administrator can configure and customize machine, bare metal, cluster, node, network, storage, user, and alert and notification components.

The following components are available for postinstallation configuration:
