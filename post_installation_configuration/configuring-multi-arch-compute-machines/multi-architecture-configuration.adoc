...
[IMPORTANT]
====
Review the information in the "guidelines for deploying {product-title} on non-tested platforms" before you attempt to install an {product-title} cluster in virtualized or cloud environments.
====
...
[IMPORTANT]
====
Autoscaling from zero is currently not supported on {gcp-first}.
====
