...
* In installer-provisioned installations, you are restricted to using the infrastructure provided by a single cloud provider. It is not possible to add external nodes, regardless of their architecture, to these clusters.
