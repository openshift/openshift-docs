...
[NOTE]
====
In the following examples, the image names are truncated. Use the full path and name in your Containerfile, such as: `FROM quay.io/openshift-release/ocp-release@sha256:6499bc69a0707fcad481c3cb73225b867d`. 
====
