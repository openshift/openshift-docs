...
As an administrator, you can specify multiple regions and zones for your {product-title} cluster that runs on a {vmw-first} instance. This configuration reduces the risk of a hardware failure or network outage causing your cluster to fail.
