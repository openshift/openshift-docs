...
* xref:../installing/installing_bare_metal/ipi/ipi-install-expanding-the-cluster.adoc#preparing-the-bare-metal-node_ipi-install-expanding-the-cluster[Manually adding a worker node to an installer-provisioned infrastructure cluster]
