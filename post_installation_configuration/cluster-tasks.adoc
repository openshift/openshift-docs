...
|Controls the link:https://docs.redhat.com/en/documentation/monitoring_stack_for_red_hat_openshift/4.15/html/configuring_core_platform_monitoring/configuring-alerts-and-notifications[Alertmanager] deployment parameters.
