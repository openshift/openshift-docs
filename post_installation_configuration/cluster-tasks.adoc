...
include::snippets/post-install-cpms-setup-intro.adoc[]

// Adding a control plane node to your cluster
include::modules/creating-control-plane-node.adoc[leveloffset=+2]

include::snippets/post-install-creating-infrastructure-machinesets-production-intro.adoc[]
...
include::snippets/assigning-machine-set-resources-to-infra-nodes-intro.adoc[]
...
include::snippets/moving-resources-to-infrastructure-machinesets-intro.adoc[]
...
include::snippets/custer-tasks-applying-autoscaling-intro.adoc[]

include::snippets/post-install-tp-tasks-intro.adoc[]
...
include::snippets/post-install-etcd-tasks-intro.adoc[]
...
include::snippets/post-install-pod-disruption-budgets-intro.adoc[]
