...
include::modules/post-install-rotating-cloud-provider-credentials.adoc[leveloffset=+1]
...
* xref:../operators/operator-reference.adoc#cloud-credential-operator_cluster-operators-ref[Cloud Credential Operator (CCO)]

include::modules/post-install-removing-cloud-provider-credentials.adoc[leveloffset=+1]
...
include::modules/post-install-enabling-token-based-authentication.adoc[leveloffset=+1]
