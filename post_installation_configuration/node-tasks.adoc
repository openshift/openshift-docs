...
[id="post-install-config-adding-fcos-upi-vsphere-cluster"]
== Adding {op-system} compute machines to an {product-title} cluster on the UPI vSphere

You can add more {op-system-first} compute machines to your {product-title} cluster on the User-provisioned Infrastructure (UPI) vSphere.

//Prerequisites also in adding-vsphere-compute-user-infra.adoc
=== Prerequisites

* You installed a cluster on vSphere.
* You have installation media and {op-system-first} images that you used to create your cluster. If you do not have these files, you must obtain them by following the instructions in the xref:../installing/installing_vsphere/installing-vsphere-installer-provisioned.html[installation procedure].

include::modules/machine-user-infra-machines-iso-vsphere.adoc[leveloffset=+2]

installing/installing_vsphere/installing-vsphere-installer-provisioned.html

[id="post-install-config-adding-fcos-compute"]
== Adding {op-system} compute machines to an {product-title} cluster on bare metal
...
* You have installation media and {op-system-first} images that you used to create your cluster. If you do not have these files, you must obtain them by following the instructions in the xref:../installing/installing_bare_metal/installing-bare-metal.html[installation procedure].
