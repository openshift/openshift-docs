...
[role="_additional-resources"]
.Additional resources
* xref:../installing/installing_vsphere/ipi-vsphere-installation-reqs.adoc#installation-vsphere-installer-infra-requirements_ipi-vsphere-installation-reqs[Static IP addresses for vSphere nodes]
