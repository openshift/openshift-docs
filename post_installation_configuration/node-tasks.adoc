...
* You have installation media and {op-system-first} images that you used to create your cluster. If you do not have these files, you must obtain them by following the instructions in the xref:../installing/installing_bare_metal/upi/upi/installing-bare-metal.adoc#installing-bare-metal[installation procedure].
...
* For more information on how {product-title} uses disk partitioning, see xref:../installing/installing_bare_metal/upi/upi/installing-bare-metal.adoc#installation-user-infra-machines-advanced_disk_installing-bare-metal[Disk partitioning].
