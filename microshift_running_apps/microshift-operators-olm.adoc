...
{microshift-short} documentation::
...
[role="_additional-resources"]
.Additional resources
* link:https://access.redhat.com/documentation/en-us/openshift_container_platform/{ocp-version}/html/operators/administrator-tasks#olm-restricted-networks[Imageset configuration examples]
...
include::modules/microshift-oc-mirror-config-cluster.adoc[leveloffset=+2]

//Using OLM offline
include::modules/microshift-olm-deploy-op-offline-con.adoc[leveloffset=+1]

//OCP module, edit with conditionals and care
include::modules/oc-mirror-dry-run.adoc[leveloffset=+2]

include::modules/microshift-oc-mirror-embed-ops-offline-use.adoc[leveloffset=+2]

//additional resources for embedding operators into rhel for edge offline
[role="_additional-resources"]
.Additional resources
...
* link:https://access.redhat.com/documentation/en-us/red_hat_build_of_microshift/{ocp-version}/html/installing/microshift-embed-in-rpm-ostree-for-offline-use#microshift-embed-microshift-build-image-offline-deployment-prereqs_microshift-embed-rpm-ostree-offline-use[Additional prerequisites for offline deployments]
* link:https://access.redhat.com/documentation/en-us/red_hat_build_of_microshift/{ocp-version}/html/networking/microshift-disconnected-network-config[Configuring network settings for fully disconnected hosts]
