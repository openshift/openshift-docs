...
[id="additional-resources_microshift-observability-service_{context}"]
== Additional resources

* xref:microshift-enhanced-metrics.adoc#microshift-enhanced-metrics[Using enhanced metrics in {microshift-short}]
