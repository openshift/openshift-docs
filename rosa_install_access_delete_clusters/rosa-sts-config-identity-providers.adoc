...
The following topics describe how to configure an identity provider by using {cluster-manager} console. Alternatively, you can use the {rosa-cli-first} to configure an identity provider and access the cluster.
