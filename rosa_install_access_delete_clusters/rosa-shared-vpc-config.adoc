...
image::372_OpenShift_on_AWS_persona_workflows_0923_all.png[Diagram showing the shared VPC configuration workflow between VPC Owner and Cluster Creator personas]
...
* You created all of the required account-wide roles and policies for creating a cluster.
...
* link:https://docs.aws.amazon.com/vpc/latest/userguide/vpc-sharing.html[AWS documentation on sharing your AWS resources]
ifdef::openshift-rosa[]
* xref:../rosa_install_access_delete_clusters/rosa-sts-creating-a-cluster-quickly.adoc#rosa-sts-creating-account-wide-sts-roles-and-policies_rosa-sts-creating-a-cluster-quickly[Creating account-wide STS roles and policies]
endif::openshift-rosa[]
ifdef::openshift-rosa-hcp[]
* xref:../rosa_hcp/rosa-hcp-sts-creating-a-cluster-quickly.adoc#rosa-sts-creating-account-wide-sts-roles-and-policies_rosa-hcp-sts-creating-a-cluster-quickly[Creating account-wide STS roles and policies]
