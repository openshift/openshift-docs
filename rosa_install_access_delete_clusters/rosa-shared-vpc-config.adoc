...
* Make sure you included a domain name.
* Make sure the domain name does not include any spaces or capital letters.
* Make sure the custom DNS server is able to resolve the R53 private hosted zones.
