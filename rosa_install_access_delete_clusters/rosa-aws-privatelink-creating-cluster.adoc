...
[role="_abstract"]
You can create a {product-title} cluster by using AWS PrivateLink.

include::modules/rosa-classic-prerequisites.adoc[leveloffset=+1]
...
ifdef::openshift-rosa[]
* xref:../rosa_getting_started/rosa-sts-getting-started-workflow.adoc#rosa-sts-overview-of-the-deployment-workflow[Overview of the {product-title} deployment workflow]
