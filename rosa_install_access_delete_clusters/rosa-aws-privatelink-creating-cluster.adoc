...
* xref:../rosa_planning/rosa-hcp-prereqs.adoc#osd-aws-privatelink-firewall-prerequisites_rosa-hcp-prereqs[AWS PrivateLink firewall prerequisites for ROSA clusters]
* xref:../rosa_planning/rosa-classic-prereqs.adoc#osd-aws-privatelink-firewall-prerequisites_rosa-classic-prereqs[AWS PrivateLink firewall prerequisites for ROSA (classic architecture) clusters]
