...
Create a {product-title} (ROSA) cluster with the AWS Security Token Service (STS) using customizations. You can deploy your cluster through the ROSA CLI (`rosa`) or {cluster-manager-first}.
...
include::modules/rosa-sts-creating-a-cluster-with-customizations-cli.adoc[leveloffset=+1]
include::modules/rosa-sts-creating-a-cluster-with-customizations-ocm.adoc[leveloffset=+1]
