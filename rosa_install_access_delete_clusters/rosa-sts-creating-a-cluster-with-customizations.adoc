...
* For information about the prerequisites to installing ROSA with STS, see xref:xref:../rosa_planning/rosa-classic-prereqs.adoc#rosa-classic-aws-preqs[AWS prerequisites for ROSA (classic architecture) clusters] and xref:../rosa_planning/rosa-hcp-prereqs.adoc#rosa-hcp-prereqs[AWS prerequisites for ROSA clusters]../rosa_planning/rosa-sts-aws-prereqs.adoc#rosa-sts-aws-prereqs[AWS prerequisites for ROSA with STS].
