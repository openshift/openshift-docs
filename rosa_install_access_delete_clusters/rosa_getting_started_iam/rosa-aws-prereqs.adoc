...
You must ensure that the prerequisites are met before installing {product-title}. This requirements document does not apply to AWS Security Token Service (STS). If you are using STS, see the _STS-specific requirements_ in the _Additional resources_ section.
...
include::modules/rosa-aws-scp-preq.adoc[leveloffset=+2]
...
* xref:../../rosa_planning/rosa-sts-aws-prereqs.adoc#rosa-aws-prereqs_rosa-sts-aws-prereqs[STS-specific requirements]
