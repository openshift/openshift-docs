...
[role="_abstract"]
After you set up your environment and install {product-title}, create a cluster. For additional security, you can create a {product-title} cluster with AWS PrivateLink instead.
