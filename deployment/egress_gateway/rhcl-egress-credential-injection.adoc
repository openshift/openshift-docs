...
[role="_abstract"]
You can use `AuthPolicy` with an egress gateway to inject credentials into requests to external services. This guide demonstrates credential injection by using HashiCorp Vault as the credential source.
