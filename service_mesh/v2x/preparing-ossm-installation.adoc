...
** xref:../../installing/installing_ibm_z/installing-ibm-z-reg.adoc#installing-ibm-z-reg[Install {product-title} {product-version} on {ibm-z-reg} and {ibm-linux-one-reg}]
** xref:../../installing/installing_ibm_power/installing-ibm-power-reg.adoc#installing-ibm-power-reg[Install {product-title} {product-version} on {iibm-cloud-bm-reg}]
endif::[]
