...
[NOTE]
====
Mixer’s policy enforcement is disabled by default. You must enable it to run policy tasks. See xref:../../service_mesh/v2x/prepare-to-deploy-applications-ossm.adoc#ossm-mixer-policy-1x_deploying-applications-ossm[Update Mixer policy enforcement] for instructions on enabling Mixer policy enforcement.
====
...
* xref:../../service_mesh/v2x/customizing-installation-ossm.adoc#customize-installation-ossm[Customize the {ProductName} installation].
