...
* See xref:../../service_mesh/v2x/ossm-custom-resources.adoc#ossm-custom-resources-v2x[Custom resources] for more information about all the configurable fields in your `ServiceMeshControlPlane` resource.
