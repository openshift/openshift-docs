...
If you configured a xref:../../installing/installing_restricted_networks/installing-restricted-networks-preparations.adoc[mirror registry in OpenShift], you can include metadata to automatically pull containers for {ProductName}.
