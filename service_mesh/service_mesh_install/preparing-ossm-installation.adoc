...
you can add metadata to automatically pull containers for {ProductName}. Cluster administrators can configure OLM and OperatorHub to use local content in restricted network environments.

Prerequisites

* Cluster administrator access to the cluster and its internal registry.
