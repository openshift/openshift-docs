...
If you configured a xref:../../installing/installing_restricted_networks/installing-restricted-networks-preparations.adoc#installing-restricted-networks-preparations[mirror registry in OpenShift], you can include metadata to automatically pull containers for {ProductName}.

.Containers

The following containers are required for {ProductName}:

* item
* item 
* item

include::modules/ossm-mirror-repository.adoc[leveloffset=+1]
