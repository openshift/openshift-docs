...
For more information about configuring Elasticsearch with {product-title}, see  xref:../../logging/config/efk-logging-elasticsearch.adoc[Configuring Elasticsearch].
