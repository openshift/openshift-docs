...
For more information about configuring an {product-title} wildcard policy, see xref:../../networking/networking_operators/ingress-operator.adoc#using-wildcard-routes[Using wildcard routes].
endif::[]
