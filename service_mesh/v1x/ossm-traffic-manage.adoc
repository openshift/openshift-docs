...
For more information about configuring an {product-title} wildcard policy, see ../../networking/ingress-operator.adoc#using-wildcard-routes_configuring-ingress[Using wildcard routes].
endif::[]
