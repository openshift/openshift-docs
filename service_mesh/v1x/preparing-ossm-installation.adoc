...
[NOTE]
====
If you are installing {ProductName} on a xref:../../installing/install_config/installation-types.adoc[restricted network], follow the instructions for your chosen {product-title} infrastructure.
====
+
...
[WARNING]
====
Please see xref:../../logging/config/cluster-logging-elasticsearch.adoc[Configuring Elasticsearch] for details on configuring the default Jaeger parameters for Elasticsearch in a production environment.
====
