...
[NOTE]
====
If you are installing {SMProductName} on a xref:../../installing/overview/installing-preparing.adoc#installing-preparing-supported-installation-methods-reference_installing-preparing[restricted network], follow the instructions for your chosen {product-title} infrastructure.
====
+
endif::[]
