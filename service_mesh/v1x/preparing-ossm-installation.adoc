...
== Prerequisites
adding-vsphere-compute-user-infra.adocpreparing-ossm-installation.adoc* Possess an active {product-title} subscription on your Red Hat account. If you do not have a subscription, contact your sales representative for more information.
