...
Cluster administrators can refer to "Using wildcard routes" in xref:../../networking/networking_operators/ingress-operator.adoc#using-wildcard-routes[Ingress Operator in {product-title}] for instructions on how to enable subdomains.
endif::[]
