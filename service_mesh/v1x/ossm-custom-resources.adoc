...
Cluster administrators can refer to xref:../../networking/networking_operators/ingress-operator.adoc#using-wildcard-routes[Using wildcard routes] for instructions on how to enable subdomains.
endif::[]
