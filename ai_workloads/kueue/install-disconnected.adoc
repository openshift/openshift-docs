...
[role="_abstract"]
You can install {kueue-name} on a disconnected {product-title} cluster after enabling {olm-first} in your disconnected environment.

Before you can install {kueue-name}, you must complete the following steps:
