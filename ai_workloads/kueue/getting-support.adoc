...
* link:https://access.redhat.com[Red{nbsp}Hat Customer Portal]
* link:https://access.redhat.com/knowledgebase[Red{nbsp}Hat Knowledgebase]
* link:https://access.redhat.com/solutions/5280291[How to find the cluster-id or name on OpenShift cluster]
* link:https://access.redhat.com/support/cases/#/case/list[Customer Support page]
