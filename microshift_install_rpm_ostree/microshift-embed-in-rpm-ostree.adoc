...
[role="_additional-resources"]
.Additional resources
* xref:../microshift_configuring/microshift-node-access-kubeconfig.adoc#microshift-generating-additional-kubeconfig-files_microshift-node-access-kubeconfig[Generating additional kubeconfig files for remote access]
