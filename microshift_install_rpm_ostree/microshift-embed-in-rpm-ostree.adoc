...
include::modules/microshift-rhel-kickstart-con.adoc[leveloffset=+1]

include::modules/microshift-provisioning-ostree.adoc[leveloffset=+2]
...
//Here we should have something about using the VM and getting the ISO up and running, then starting MicroShift, yes?
