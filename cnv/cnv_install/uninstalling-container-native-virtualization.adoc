...
xref:../../cnv/cnv_virtual_machines/cnv-manage-virtual-machine-instances.adoc#cnv-deleting-vmis-web_cnv-manage-virtual-machine-instances[virtual machine instances],
