...
// CNV-3881 Release note to announce SVVP Certification
* {CNVProductNameStart} is certified in Microsoft's Windows Server
Virtualization Validation Program (SVVP) to run Windows workloads.
** SVVP Certification applies to Intel and AMD CPUs.
** SVVP Certificate names for workers are as follows:
*** RHCOS workers: _Red Hat OpenShift Container Platform 4 on RHEL CoreOS 8_
*** RHEL 7 workers: _Red Hat OpenShift Container Platform 4 with RHEL 7.7 compute
nodes_
