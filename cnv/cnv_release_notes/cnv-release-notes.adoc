...
* A new option to view and configure dedicated resources for virtual machines is
available in the web console *Virtual Machine Details* view. When you enable dedicated
