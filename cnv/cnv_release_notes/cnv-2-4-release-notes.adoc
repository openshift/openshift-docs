...
* You can now view and configure xref:../../cnv/cnv_virtual_machines/cnv_advanced_vm_management/cnv-dedicated-resources-vm.adoc#cnv-dedicated-resources-vm[dedicated resources for virtual machines] in
