...
xref:../../cnv/cnv-virtual-machines/cnv-importing-vms/cnv-importing-virtual-machine-images-datavolumes.adoc#cnv-importing-vm-datavolume_cnv-importing-virtual-machine-images-datavolumes[importing an ISO into a data volume] 
and attaching it to the virtual machine.

include::modules/cnv-understanding-virtio-drivers.adoc[leveloffset=+1]

See also: xref:../../cnv/cnv-virtual-machines/cnv-installing-virtio-drivers-on-existing-windows-vm.adoc#cnv-installing-virtio-drivers-on-existing-windows-vm[Installing VirtIO driver on an existing Windows virtual machine].
