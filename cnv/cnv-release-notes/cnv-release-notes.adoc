...
before upgrading {product-title} as upgrading {product-title} may trigger
(link:https://bugzilla.redhat.com/show_bug.cgi?id=1785661[VM deletion *BZ#1785661*]).
...
----
+
This command points your subscription to upgrade channel `2.2` and enables automatic
updates.
