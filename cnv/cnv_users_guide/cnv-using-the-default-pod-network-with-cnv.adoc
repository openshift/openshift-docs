...
= Using the default Pod network with {ProductName}
include::modules/cnv-document-attributes.adoc[]
:context: cnv-using-the-default-pod-network-with-cnv
toc::[]

You can use the default Pod network with {ProductName}. To do so,
...
If you create a virtual machine from the {ProductName}
...
include::modules/cnv-template-vmi-pxe-config.adoc[leveloffset=+2]
