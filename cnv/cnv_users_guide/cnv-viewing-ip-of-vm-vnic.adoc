...
----
+
. If the guest agent is not installed and running, xref:../../cnv/cnv_users_guide/cnv-installing-qemu-guest-agent.adoc#cnv-installing-qemu-guest-agent[install and run the guest agent on the virtual machine].
