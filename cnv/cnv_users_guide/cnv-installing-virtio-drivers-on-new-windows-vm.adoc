...
xref:../../cnv/cnv_users_guide/cnv-importing-virtual-machine-images-datavolumes.adoc#cnv-importing-vm-datavolume_cnv-importing-virtual-machine-images-datavolumes[importing an ISO into a data volume] 
