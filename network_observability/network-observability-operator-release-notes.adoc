...
//NOTE: this link will be broken until the live errata is available on 1.4.2 GA, 10/30/23

* link:https://access.redhat.com/errata/RHSA-2023:122668[2023:122668 Network Observability Operator 1.4.2]
