...
* For more information about Loki object storage configuration, see xref:../../logging/log_storage/installing-log-storage.adoc#logging-loki-storage[Loki object storage].
