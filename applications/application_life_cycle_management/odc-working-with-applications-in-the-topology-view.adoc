[id="odc-working-with-applications-in-the-topology-view"]
= Working with applications in the Topology view
include::modules/common-attributes.adoc[]
:context: odc-working-with-applications-in-the-topology-view
toc::[]
