...
* *Getting Started resources*: Use these resources to help you get started with the Console. You can choose to hide the header using the *Options* menu {kebab}.
** *Creating applications using sample*: Use the existing code samples to get started with creating applications on the OpenShift Container Platform.
...
[NOTE]
====
Managed services options are also available if the RHOAS Operator is installed.
====

* *Git repository*: Import an existing codebase from your Git repository to build and deploy an application on OpenShift Container Platform.
** *From Git*: Select a Git repository to import code to build and deploy an application.
** *From Devfile*: Select a Git repository to import a Devfile to build and deploy an application.
** *From Dockerfile*: Select a Git repository to import a Dockerfile to build and deploy an application.
