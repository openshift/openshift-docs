...
[role="_abstract"]
You can build and deploy a Ruby on Rails 4 application on {product-title}. Develop the application locally, configure it for {product-title}, store the source in Git, and deploy database, frontend, and route services.
