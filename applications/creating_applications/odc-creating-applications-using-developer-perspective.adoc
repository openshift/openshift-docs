...
* *Pipelines*: Use {pipelines-title} to create CI/CD pipelines for your software delivery process on the {product-title}. See xref:../../cicd/pipelines/web_console_pipelines/odc-creating-pipelines.adoc#odc-creating-pipelines[Creating pipelines] in the _Using {pipelines-title} in the web console_ documentation.
