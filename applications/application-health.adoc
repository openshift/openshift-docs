...
[role="_abstract"]
To keep applications available when containers fail, configure readiness, liveness, and startup probes that detect unhealthy workloads and recover from transient connectivity, configuration, or dependency problems.
