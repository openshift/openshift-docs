...
include::modules/deployments-blue-green-setting-up.adoc[leveloffset=+2]

include::modules/deployments-ab-testing.adoc[leveloffset=+1]

include::modules/deployments-ab-testing-lb.adoc[leveloffset=+2]

include::modules/deployments-ab-testing-lb-web.adoc[leveloffset=+3]

include::modules/deployments-ab-testing-lb-web-new-route.adoc[leveloffset=+3]

include::modules/deployments-ab-testing-lb-cli.adoc[leveloffset=+3]

include::modules/deployments-ab-one-service-multi-dc.adoc[leveloffset=+3]
