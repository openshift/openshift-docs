...
[id="getting-started-with-service-binding-ibm-power-reg-ibm-z-reg"]
= Getting started with service binding on {iibm-cloud-bm-reg}, {ibm-z-reg}, and {ibm-linux-one-reg}
include::_attributes/common-attributes.adoc[]
include::_attributes/servicebinding-document-attributes.adoc[]
:context: getting-started-with-service-binding-ibm-power-reg-ibm-z-reg
...
[id="additional-resources_getting-started-with-service-binding-ibm-power-reg-ibm-z-reg"]
