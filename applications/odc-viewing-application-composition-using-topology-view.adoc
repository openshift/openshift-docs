...
[id="prerequisites_odc-viewing-application-composition-using-topology-view"]
== Prerequisites
...
[id="additional-resources_odc-viewing-application-composition-using-topology-view"]
...
* See xref:../applications/odc-importing-exporting-applications.adoc#odc-importing-codebase-from-git-to-create-application_odc-importing-exporting-applications[Importing a codebase from Git to create an application] for more information on creating an application from Git.
* See xref:../applications/odc-importing-exporting-applications.adoc#odc-exporting-an-application-to-another-project-or-cluster_odc-importing-exporting-applications[Exporting an application to another project or cluster]
