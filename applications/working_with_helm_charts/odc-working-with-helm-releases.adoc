...
* You have logged in to the web console and have switched to the xref:../web_console/web-console-overview.adoc#about-developer-perspective[*Developer* perspective].
