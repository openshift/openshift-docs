...
[NOTE]
====
In {product-title} 4.11, Helm is disabled for the xref:../../release_notes/ocp-4-11-release-notes.adoc#ocp-4-11-multicluster-console-technology-preview[Multicluster Console] (Technology Preview).
