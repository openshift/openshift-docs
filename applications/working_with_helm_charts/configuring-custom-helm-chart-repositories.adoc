...
You can use Helm by xref:../../web_console/web_terminal/using-web-terminal.adoc#access-web-terminal_using-web-terminal[Accessing the web terminal] in the *Developer* perspective of the web console.
