...
// This sets the context to build the tasks for migration using the Istio revision label 
:context: tbd
...
// This sets the context to build the tasks for migration using the Istio revision label with cert-manager tasks
:context: tbd2
...
// This sets the context to build the tasks for migration using the Istio injection label
:context: tbd3
...
// This sets the context to build the tasks for migration using the Istio injection label with cert-manager
:context: tbd4
