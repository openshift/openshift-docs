...
* xref:../../migrating/checklists/ossm-migrating-network-policies-assembly.adoc[Migrating network policies from Service Mesh 2 to Service Mesh 3]

* xref:../../install/ossm-installing-openshift-service-mesh#ossm-scoping-service-mesh-with-discoveryselectors_ossm-creating-istiocni-resource[Scoping the mesh with discoverySelectors]
