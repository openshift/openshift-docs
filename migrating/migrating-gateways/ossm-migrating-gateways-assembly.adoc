...
There are two methods for migrating gateways from {SMProductName} 2 to {SMProduct} 3:
...
* xref:../done/ossm-migrating-complete-assembly.adoc[Complete your migration]
