...
* [ ] Disable network policy management in your {SMProduct} 2 `ServiceMeshControlPlane`: `spec.security.manageNetworkPolicy=false`.

* [ ] Continue to the next checklist.

.Next step if you must recreate network policies first

* [ ] Recreate your network policies: [Migrating network policies].
...
* Cluster-wide migration methods with the cert-manager tool
