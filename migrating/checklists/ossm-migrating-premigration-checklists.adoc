...
Complete these premigration checklists to prepare your {SMProduct} 2.6 environment for an upgrade by disabling traditional add-ons, migrating gateway configurations, and validating resource compatibility for {SMProduct} 3.2.

Additionally, read the knowledgebase article link:https://access.redhat.com/articles/7139757[Red Hat ServiceMesh 2 migration towards 3 known caveats].
