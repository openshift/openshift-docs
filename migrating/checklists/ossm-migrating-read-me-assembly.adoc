...
.Next steps
You can install the Istioctl tool.

* xref:../../install/ossm-istioctl-tool.adoc#ossm-installing-the-istioctl-tool_ossm-istioctl-tool[Installing the Istioctl tool]
