...
Identify the architectural and functional differences between {SMProductName} 2.6 and {SMProductName} 3.2 to prepare for the specific installation and configuration changes required for a successful migration.
...
* link:https://istio.io/[Istio project]
...
* xref:../../install/ossm-istioctl-tool.adoc#ossm-installing-the-istioctl-tool_ossm-istioctl-tool[Istioctl tool]
