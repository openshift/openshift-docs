...
If you have a multitenant deployment with the cert-manager tool, update the `istio-csr` deployment to include your {SMProduct} 3 control plane by running the following command:
