...
If you are using {SMProductName} with cert-manager, there are configurations you must perform first before you can migrate your deployment and workloads to {SMProduct} 3.
