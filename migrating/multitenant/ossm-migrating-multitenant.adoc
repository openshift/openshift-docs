...
* xref:../modules/ossm-migrating-read-me-new-resources.adoc#ossm-istio-resource-replaces-smcp[The Istio resource replaces the ServiceMeshControlPlane resource]
