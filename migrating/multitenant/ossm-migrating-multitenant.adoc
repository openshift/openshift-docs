...
* xref:../checklists/ossm-migrating-read-me.adoc#ossm-istio-resource-replaces-smcp_ossm-migrating-read-me[The Istio resource replaces the ServiceMeshControlPlane resource]
