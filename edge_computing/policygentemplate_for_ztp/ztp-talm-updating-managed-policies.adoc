...
include::modules/cnf-topology-aware-lifecycle-manager-cluster-logging-6x-update-policygentemplate.adoc[leveloffset=+1]

[role="_additional-resources"]
.Additional resources

* link:https://docs.redhat.com/en/documentation/openshift_container_platform/4.17/html-single/logging/index#log6x-upgrading-to-6[Upgrading to Logging 6.0]
