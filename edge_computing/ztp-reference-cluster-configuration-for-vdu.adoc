...
= Recommended {sno} cluster configuration for DU application workloads
include::_attributes/common-attributes.adoc[]
:context: sno-configure-for-vdu

toc::[]

Use the following reference information to understand the {sno} configurations required to deploy distributed unit (DU) applications in the cluster. Configurations include cluster optimizations for high performance workloads, enabling workload partitioning, and minimizing the number of reboots required postinstallation.

[IMPORTANT]
====
For the complete list of recommended RAN DU cluster configurations, see xref:../scalability_and_performance/telco_reference_design_specs/telco-ran-du-rds.adoc#telco-ran-du-ref-design-specs[Telco RAN DU reference design specifications].
====
...
[IMPORTANT]
====
For the complete list of cluster installation and postinstallation manifests, see xref:../scalability_and_performance/telco_reference_design_specs/telco-ran-du-rds.adoc#telco-ran-du-reference-design-components_telco-ran-du[Telco RAN DU reference design components].
====
