...
* xref:../../edge_computing/image_based_upgrade/cnf-preparing-for-image-based-upgrade.adoc#cnf-image-based-upgrade-shared-container-directory_preparing-for-image-based-upgrade[Configuring a shared container directory between ostree stateroots]
