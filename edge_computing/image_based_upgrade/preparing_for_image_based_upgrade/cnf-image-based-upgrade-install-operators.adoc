...
* xref:../../../oadp/installing/oadp-installing-operator.adoc#oadp-installing-operator-doc[Installing the {oadp-short} Operator]

* xref:../../../oadp/installing/installing-oadp-ocs.adoc#oadp-about-backup-snapshot-locations_installing-oadp-ocs[About backup and snapshot locations and their secrets]

* xref:../../../oadp/backing_up_and_restoring/oadp-creating-backup-cr.adoc#oadp-creating-backup-cr-doc[Creating a Backup CR]

* xref:../../../oadp/backing_up_and_restoring/restoring-applications.adoc#oadp-creating-restore-cr_restoring-applications[Creating a Restore CR]
