...
include::modules/cnf-talm-events-overview.adoc[leveloffset=+1]

[role="_additional-resources"]
.Additional resources

* link:https://access.redhat.com/articles/7120537[Integrating {cgu-operator} events with Event Driven Ansible]

include::modules/cnf-talm-events-reference.adoc[leveloffset=+2]
