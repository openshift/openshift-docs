...
`openshift-install` program:: Creates the installation and configuration ISO, and embeds the seed image URL in the live installation ISO. Attach the configuration ISO to a preinstalled host to complete the deployment.
