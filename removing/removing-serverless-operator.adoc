...
After you have removed Knative Serving and Knative Eventing, you can remove the {ServerlessOperatorName}. You can do this by using the {ocp-product-title} web console or the `oc` CLI.
