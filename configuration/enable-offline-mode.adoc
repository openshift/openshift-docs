...
However, if you are using {product-title-short} in offline mode, you must manually update the vulnerability data. To manually update the vulnerability data, you must upload a bundle to Central, which Scanner then retrieves.
