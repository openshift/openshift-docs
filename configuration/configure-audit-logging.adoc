...
[role="_abstract"]
{product-title} has audit logging features that you can use to check all the changes made in {product-title}.
...
* link:https://kubernetes.io/docs/tasks/access-application-cluster/create-external-load-balancer/#preserving-the-client-source-ip[Preserving the client source IP]
* link:https://datatracker.ietf.org/doc/html/rfc7239#section-5.2[X-Forwarded-For header]