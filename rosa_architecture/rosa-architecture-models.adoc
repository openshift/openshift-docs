...
[role="_abstract"]
Understanding the {product-title} architecture helps you plan your cluster deployment and choose the right configuration for your needs. In {product-title}, the control plane is hosted in a Red{nbsp}Hat account while the worker nodes are deployed in your AWS account.
...
* xref:../rosa_cluster_admin/rosa_nodes/rosa-nodes-machinepools-configuring.adoc#rosa-nodes-machinepools-configuring[Configuring machine pools in Local Zones]
endif::openshift-rosa-hcp[]
