...
[role="_abstract"]
Learn about {product-title} architecture models and cluster topologies.

include::modules/rosa-architecture-topology-overview.adoc[leveloffset=+1]
...
[role="_additional-resources"]
[id="additional-resources-classic_{context}"]
.Additional resources
