...
- **xref:../observability/logging/logging-6.1/log6x-about-6.1.adoc#log6x-about[About Logging]**: Learn about logging and configure different logging components, such as log storage, log collectors, and the logging web console plugin.
