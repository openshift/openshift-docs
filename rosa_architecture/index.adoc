...
- **xref:../installing/installing_vsphere/installing-vsphere-installer-provisioned.adoc#installing-vsphere-installer-provisioned[Install a cluster on {vmw-full}]**: You can install {product-title} on supported versions of {vmw-short}.
...
xref:../installing/installing_aws/installing-aws-vpc.adoc#installing-aws-vpc[{aws-first}] or
...
xref:../installing/installing_aws/installing-aws-private.adoc#installing-aws-private[{aws-first}],
xref:../installing/installing_azure/installing-azure-private.adoc#installing-azure-private[{azure-full}],
