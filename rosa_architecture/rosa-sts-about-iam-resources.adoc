...
{hcp-title-first} uses the AWS Security Token Service (STS). This means that before you deploy your cluster,
...
* If you deploy ROSA by using {cluster-manager}, you must create the following additional resources:
