...
//
//
// Content for OSDOCS-3201 and OSDOCS-3203 starts here.
//
// These modules explain concept of the ocm-role IAM role. the process to create that role, and then creating AWS Operator roles and linking those roles to the policies
//
//
