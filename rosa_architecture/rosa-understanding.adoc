...
Customers can upgrade to the newest version of OpenShift and use the features from that version of OpenShift. Review the xref:../rosa_architecture/rosa_policy_service_definition/rosa-service-definition.adoc#rosa-service-definition[Service Definition] for more information.
