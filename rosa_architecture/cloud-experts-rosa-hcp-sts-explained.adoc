...
* The {product-title}-specific AWS managed policies are tightly scoped to only allow actions on {product-title}-specific AWS resources in your account, within the limits of the AWS API.
