...
[id="rosa-sts-about-iam-resources-managed"]
= About managed IAM resources for ROSA clusters that use STS 
include::_attributes/attributes-openshift-dedicated.adoc[]
:context: rosa-sts-about-iam-resources-managed

toc::[]

[TIP]
====
This page introduces managed IAM resource information for {product-title} (ROSA) clusters that use the AWS Security Token Service (STS).
====
