...
* For more information about ROSA and its components, see the xref:../policies-and-service-definition/rosa-service-definition.adoc#rosa-service-definition[ROSA Service Definition].
