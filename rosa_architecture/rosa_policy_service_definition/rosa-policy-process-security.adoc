...
* For more information about security and compliance, see the xref:../../security/audit-log-view.adoc#audit-log-view[Viewing audit logs].
...
* For more information about security and compliance, see the xref:../../security/rosa-adding-additional-constraints-for-ip-based-aws-role-assumption.adoc#rosa-adding-additional-constraints-for-ip-based-aws-role-assumption_[Adding additional constraints for IP-based AWS role assumption].
endif::openshift-rosa-hcp[]
