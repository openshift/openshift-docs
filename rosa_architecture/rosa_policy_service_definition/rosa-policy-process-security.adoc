...
* For more information about ROSA and its components, see the xref:../introduction_to_rosa/policies-and-service-definition.adoc#rosa-service-definition[ROSA Service Definition].
