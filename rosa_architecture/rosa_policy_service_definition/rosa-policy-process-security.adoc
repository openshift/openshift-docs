...
* For more information about ROSA and its components, see xref:../../rosa_architecture/rosa_policy_service_definition/rosa-hcp-service-definition.adoc#rosa-hcp-service-definition[{rosa-short} Service Definition].
