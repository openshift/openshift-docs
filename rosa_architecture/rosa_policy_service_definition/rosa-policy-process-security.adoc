...
* For more information about ROSA and its components, see the link:https://access.redhat.com/documentation/en-us/red_hat_openshift_service_on_aws/4/html/introduction_to_rosa/policies-and-service-definition#rosa-service-definition[ROSA Service Definition].
