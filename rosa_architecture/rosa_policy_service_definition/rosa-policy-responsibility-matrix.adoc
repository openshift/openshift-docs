...
* xref:../../rosa_planning/rosa-classic-prereqs.adoc#osd-aws-privatelink-firewall-prerequisites_rosa-classic-aws-preqs[AWS firewall prerequisites for ROSA (classic architecture) clusters] 
* xref:../../rosa_planning/rosa-hcp-prereqs.adoc#osd-aws-privatelink-firewall-prerequisites_rosa-hcp-preqs[AWS firewall prerequisites for ROSA clusters]
