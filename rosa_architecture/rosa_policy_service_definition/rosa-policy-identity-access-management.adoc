...
[id="rosa-policy-identity-access-management"]
= Identity and access management {product-title}
include::_attributes/attributes-openshift-dedicated.adoc[]
:context: rosa-policy-identity-access-management
...
Red Hat personnel do not access AWS accounts in the course of routine {product-title} operations. For emergency troubleshooting purposes (for example, when standard SRE access is insufficient to diagnose or remediate an ongoing incident affecting a customer’s ROSA cluster), the SREs have well-defined and auditable procedures to access cloud infrastructure accounts.
