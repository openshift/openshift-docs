...
[role="_abstract"]
The {product-title} service definition describes the platform capabilities and supported configurations for account management, logging, monitoring, networking, storage, platform, and security. Review this information to understand what the managed service provides.
