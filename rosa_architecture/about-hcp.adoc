...
You subscribe to the service directly from your AWS account. After you create clusters, you can operate your clusters with the {OCP-short} web console, the `rosa` CLI, or through {cluster-manager-first}.
