...
{SMProductName} supports the {SMProduct} 3 Operator, {SMProduct} `Istio` control plane resource, Envoy proxy, and `IstioCNI` resource on supported versions of {ocp-product-title}.
