...
* xref:../observability/ossm-observability-service-mesh-assembly.adoc#ossm-observability-service-mesh-assembly[{observabilitylongname} and {ssmproductshortname}]
