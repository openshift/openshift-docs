...
Before installing TempoStack a tenant or tenants needs to be defined, and proper permission configurations needs to be performed

include::modules/distr-tracing-tempo-install-gateway-permissions.adoc[leveloffset=+2]
