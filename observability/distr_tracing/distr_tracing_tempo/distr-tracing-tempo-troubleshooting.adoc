...
include::modules/distr-tracing-tempo-getting-the-tempostack-instance-logs.adoc[leveloffset=+2]
include::modules/distr-tracing-tempo-troubleshooting-issues-ingesting-traces.adoc[leveloffset=+2]
include::modules/distr-tracing-tempo-troubleshooting-issues-with-quering-traces.adoc[leveloffset=+2]
