...
[IMPORTANT]
====
// this content is not supported on this branch. If you have not already updated your {es-op} as described in xrf:../../../observability/logging/cluster-logging-upgrading.adoc#cluster-logging-upgrading[Updating OpenShift Logging], complete that update before updating your {JaegerName} Operator.
====
...
// this content is not supported on this branch. * xrf:../../../observability/logging/cluster-logging-upgrading.adoc#cluster-logging-upgrading[Updating OpenShift Logging]
