...
[IMPORTANT]
====
If you have not already updated your {es-op} as described in xref:../../../observability/logging/logging-6.0/log6x-upgrading-to-6.adoc#log6x-upgrading-to-6[Upgrading to Logging 6.0], complete that update before updating your {JaegerName} Operator.
====
...
* xref:../../../observability/logging/logging-6.0/log6x-upgrading-to-6.adoc#log6x-upgrading-to-6[Upgrading to Logging 6.0]
