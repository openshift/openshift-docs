...
.Additional resources
* xref:../../observability/network_observability/installing-operators.adoc#network-observability-multi-tenancy_network_observability[Enable multi-tenancy in network observability]
