...
[role="_abstract"]
Cluster administrators and developers use the Network Observability Operator for {product-title} to observe network traffic using eBPF technology. This helps provide insights and troubleshooting data via Prometheus metrics or Loki logs.
