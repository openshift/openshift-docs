...
include::modules/network-observability-ebpf-manager.adoc[leveloffset=+2]

[role="_additional-resources"]
.Additional resources
* xref:../networking/networking-operators#nw-bpfman-operator-installing-cli_bpfman-operator-install.adoc[Installing the eBPF Manager Operator]
