...
////
06/11/2026
Commenting out for JTBD.
UDN, Networking events are not applicable to OCP 4.16.
OCP 4.16 docs are still slated for migration so will need to balance JTBD work for these files btwn OCP 4.16 and other versions where they are applicable.
// JOB (prep): UDN
...
////
06/11/2026:
ebpft-manager-operator.adoc not applicable to OCP 4.16
OCP 4.16 docs are still slated for migration so will need to balance JTBD work for these files btwn OCP 4.16 and other versions where it is applicable.
