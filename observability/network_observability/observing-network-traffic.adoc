...
include::modules/con_network-observability-ipsec.adoc[leveloffset=+2]

[role="_additional-resources"]
.Additional resources
*xref:../../networking/network_security/configuring-ipsec-ovn.adoc[Configuring IPsec encryption]
