...
[role="_abstract"]
Scale your network flow collection by using the Kafka Operator to manage high-volume telemetry.
...
include::modules/network-observability-kafka-exporter-parameters.adoc[leveloffset=+1]

[role="_additional-resources"]
[id="additional-resources_{context}"]
== Additional resources

* link:https://access.redhat.com/documentation/en-us/red_hat_amq_streams/2.2[Red Hat AMQ Streams documentation]
