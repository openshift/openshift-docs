...
You can now use network observability in the *Developer* perspective. For more information, see xref:../../observability/network_observability/network-observability-overview.doc#network-observability-openshift-console-integration_network-observability-overview[{product-title} console integration].
