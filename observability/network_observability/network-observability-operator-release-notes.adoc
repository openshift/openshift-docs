...
//based on previous New features and enhancements, each gets its own heading
//==== Feature 1 for 1.9
//==== Feature 2 for 1.9

[id="user-defined-networks_{context}"]
==== User-defined networks observability
...
=== CVEs
//* link:<insert> [CVE-year-ref]  might be CVE-2025-26791. See NETOBSERV-2121
//* link:<insert> [CVE-year-ref]
