...
[id="notable-technical-change-1-9_{context}"]
=== Notable technical change
//https://issues.redhat.com/browse/OSDOCS-13236
* The `NetworkEvents` feature in Network Observability 1.9 has been updated to work with the newer Linux kernel of {product-title} 4.19, which breaks the compatibility with older kernels. As a result, the `NetworkEvents` feature can only be used with {product-title} 4.19. If you were using this feature in Network Observability 1.8 with {product-title} 4.18, you may prefer to avoid upgrading Network Observability, or upgrade to both Network Observability 1.9 and {product-title} 4.19.
