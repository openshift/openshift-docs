...
* eBPF pods of Network Observability are stuck in a `ContainerCreating` state on ARM clusters when running with the eBPF Manager feature enabled. No workaround is currently available. (link:https://issues.redhat.com/browse/OCPBUGS-58096[*OCPBUGS-58096*])
