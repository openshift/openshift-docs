...
* xref:../../networking/hardware_networks/sriov-configure-device.adoc#cnf-creating-an-additional-sriov-network-with-vrf-plug-in_configuring-sriov-device[Configuring an SR-IOV network device]
