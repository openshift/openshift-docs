...
[NOTE]
====
The {loki-op} can also be used for Configuring LokiStack storage. The Network Observability Operator requires a dedicated LokiStack separate from the {logging}.
====
