...
//moved to network-observability-operator-release-notes.adoc as part of new IA from modularization effort of all prior NETOBSERV release notes.
...
//move 1.10 modules to network-observability-operator-release-notes.adoc once the stub pages have been updated on each OCP version.
