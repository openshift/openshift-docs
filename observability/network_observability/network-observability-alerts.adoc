...
* link:https://docs.redhat.com/en/documentation/monitoring_stack_for_red_hat_openshift/4.16/html/about_monitoring/monitoring-stack-architecture[Monitoring stack architecture]
