...
ifndef::openshift-dedicated,openshift-rosa[]
For more information, see link:https://docs.redhat.com/en/documentation/monitoring_stack_for_red_hat_openshift/4.17/html/about_monitoring/about-ocp-monitoring[About {product-title} monitoring] and xref:../../support/remote_health_monitoring/about-remote-health-monitoring.adoc#about-remote-health-monitoring[About remote health monitoring].
endif::openshift-dedicated,openshift-rosa[]
...
For more information, see xref:../../observability/distr_tracing/distr-tracing-tempo-architecture.adoc#distr-tracing-tempo-architecture[Distributed tracing architecture].
