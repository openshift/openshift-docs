...
* TP>GA&removedTPnote https://docs.openshift.com/container-platform/4.17/observability/otel/otel-collector/otel-collector-extensions.html#bearertokenauth-extension_otel-collector-extensions
* TP>GA&removedTPnote https://docs.openshift.com/container-platform/4.17/observability/otel/otel-collector/otel-collector-processors.html#kubernetes-attributes-processor_otel-collector-processors
* TP>GA&removedTPnote https://docs.openshift.com/container-platform/4.17/observability/otel/otel-collector/otel-collector-connectors.html#spanmetrics-connector_otel-collector-connectors
* ???.
* ???.
* ???.
* ???.
...
* Currently, ???. (link:https://issues.redhat.com/browse/TRACING-????[TRACING-????])
* Currently, ???. (link:https://issues.redhat.com/browse/TRACING-????[TRACING-????])
* Currently, ???. (link:https://issues.redhat.com/browse/TRACING-????[TRACING-????])
* Currently, ???. (link:https://issues.redhat.com/browse/TRACING-????[TRACING-????])
