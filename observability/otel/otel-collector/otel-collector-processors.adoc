...
# ...
----
<1> The Cumulative-to-Delta Processor requires a stateful collector deployment, therefore we recommend to deploy it as a sidecar to the application that emits the delta temporality metrics.
