...
<2> The client-side TLS configuration. Defines paths to TLS certificates. For more information, see the xref:otel-collector-tls.adoc#otel-collector-tls[TLS configuration for the OpenTelemetry Collector].
<3> Headers are sent for every request performed during an established connection.
...
<3> The server-side TLS configuration. Defines paths to TLS certificates. For more information, see the xref:otel-collector-tls.adoc#otel-collector-tls[TLS configuration for the OpenTelemetry Collector].
