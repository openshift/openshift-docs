...
* link:https://docs.redhat.com/en/documentation/monitoring_stack_for_red_hat_openshift/4.16/html/accessing_metrics/accessing-monitoring-apis-by-using-the-cli#monitoring-querying-metrics-by-using-the-federation-endpoint-for-prometheus_accessing-monitoring-apis-by-using-the-cli[Querying metrics by using the federation endpoint for Prometheus]
