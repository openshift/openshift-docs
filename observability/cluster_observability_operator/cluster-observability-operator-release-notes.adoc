...
* OTEL model support for logs has been added. (link:https://issues.redhat.com/browse/COO-816[*COO-816*])

* Accelerators Perses dashboards are included by default. (link:https://issues.redhat.com/browse/COO-942[*COO-942*]) 

* Multiple results per graph node are displayed. (link:https://issues.redhat.com/browse/COO-785[*COO-785*]) 

* Direct navigation to individual incident detail is supported, which enables the Incidents overview in ACM 2.14. (link:https://issues.redhat.com/browse/COO-977[*COO-977*], link:https://issues.redhat.com/browse/ACM-18751[*ACM-18751*])

[id="cluster-observability-operator-1-2-bug-fixes_{context}"]
=== Bug fixes

* Previously, you could not successfully install the logging UI plugin if you had not already installed LokiStack. This release resolves the issue. (link:https://issues.redhat.com/browse/COO-760[*COO-760*])
