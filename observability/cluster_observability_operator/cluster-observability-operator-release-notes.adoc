...
|===
| COO Version   | OCP Versions       | Distributed Tracing   | Logging   | Troubleshooting Panel | Monitoring | Incident detection
| 1.1           | 4.12 - 4.14        | ✔                     | ✔         | ✘                     | ✘          | ✘
| 1.1           | 4.15               | ✔                     | ✔         | ✘                     | ✔          | ✘
| 1.1           | 4.16 - 4.17        | ✔                     | ✔         | ✔                     | ✔          | ✘
| 1.1           | 4.18+              | ✔                     | ✔         | ✔                     | ✔          | ✔
...
* Previously, the logging UI plugin did not support setting a namespace or a default value. This release resolves the issue. (link:https://issues.redhat.com/browse/COO-332[*COO-332*])
