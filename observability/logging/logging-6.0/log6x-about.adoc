...
You can select either of these data models based on your requirements. The ViaQ data model is the default and fully supported option, while OTEL uses the OpenTelemetry standards and is not fully supported.
...
[NOTE]
====
The ViaQ data model is now deprecated and is planned to be removed in a future logging releases.
====
