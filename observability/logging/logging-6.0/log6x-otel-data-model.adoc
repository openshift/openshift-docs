...
[NOTE]
====
Logs are forwarded using OTLP over HTTP, as defined by the OpenTelemetry Observability Framework, with Protobuf payloads encoded in JSON format.
====
...
// The Cluster Logging OTEL Support link should be updated.