...
* link:https://docs.redhat.com/en/documentation/monitoring_stack_for_red_hat_openshift/4.15/html/managing_alerts/managing-alerts-as-an-administrator#modifying-core-platform-alerting-rules_managing-alerts-as-an-administrator[Modifying core platform alerting rules]
endif::openshift-dedicated,openshift-rosa[]
