...
// this content is not supported on this branch. * xrf:../../../observability/logging/log_collection_forwarding/configuring-log-forwarding.adoc#logging-audit-filtering_configuring-log-forwarding[Overview of API audit filter]
