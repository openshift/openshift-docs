...
// this content is not supported on this branch. You can use an internal Loki or Elasticsearch log store on your cluster for storing logs, or you can use a xrf:../../../observability/logging/log_collection_forwarding/configuring-log-forwarding.adoc#logging-create-clf_configuring-log-forwarding[`ClusterLogForwarder` custom resource (CR)] to forward logs to an external store.
