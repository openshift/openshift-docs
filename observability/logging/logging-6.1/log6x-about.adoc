...
.Additional resources
* xref:../../../observability/logging/logging-6.0/log6x-upgrading-to-6.adoc#secrets-and-tls-configuration[Secrets and TLS Configuration]
* xref:../../../observability/logging/logging-6.1/log6x-configuring-lokistack-otlp.adoc#log6x-configuring-lokistack-otlp-data-ingestion_log6x-configuring-lokistack-otlp[Configuring LokiStack for OTLP data ingestion]