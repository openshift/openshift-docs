...
[id="log6x-release-notes-6-1-0-removal-notice"]
== Removal notice
...
[id="log6x-release-notes-6-1-0-enhancements"]
...
* With this release, the responsibility for deploying the {logging} view plugin shifts from the {clo} to the {coo-first}. For new log storage installations that need visualization, the {coo-full} and the associated `UIPlugin` resource must be deployed. For more information, see xref:../../../observability/logging/logging-6.1/log6x-visual-6.1.adoc#log6x-visual[Visualization for logging]. (link:https://issues.redhat.com/browse/LOG-5461[LOG-5461])
+
--
...
[id="log6x-release-notes-6-1-0-technology-preview-features"]
...
[id="log6x-release-notes-6-1-0-bug-fixes"]
== Bug fixes
...
[id="log6x-release-notes-6-1-0-CVEs"]
== CVEs
