...
// * link:https://docs.redhat.com/en/documentation/red_hat_openshift_service_on_aws/4/html/monitoring/reviewing-monitoring-dashboards#reviewing-monitoring-dashboards[Reviewing monitoring dashboards]
