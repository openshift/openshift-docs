...
// this content is not supported on this branch. * xrf:../../../observability/logging/log_collection_forwarding/logging-output-types.adoc#logging-output-types[Log output types]
