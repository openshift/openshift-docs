...
include::modules/power-monitoring-ref_release-notes-tp-0-5-enhancements.adoc[leveloffset=+1]
include::modules/power-monitoring-ref_release-notes-tp-0-5-removed-features.adoc[leveloffset=+1]
include::modules/power-monitoring-ref_release-notes-tp-0-5-support-tables.adoc[leveloffset=+1]
