...
* xref:../../../applications/odc-monitoring-project-and-application-metrics-using-developer-perspective.adoc#odc-monitoring-project-and-application-metrics-using-developer-perspective_odc-monitoring-project-and-application-metrics-using-developer-perspective[Monitoring project and application metrics by using the Developer perspective]
