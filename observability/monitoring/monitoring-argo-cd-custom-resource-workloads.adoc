...
[role="_abstract"]
You can monitor the availability of Argo CD custom resource workloads and receive alerts when component pods fail to start or ready replicas do not match the desired count. Enable or disable workload monitoring for individual Argo CD instances.
