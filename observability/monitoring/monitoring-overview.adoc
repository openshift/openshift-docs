...
In the *Observe* section of {product-title} web console, you can access and manage monitoring features such as xref:../../observability/monitoring/managing-metrics.adoc#managing-metrics[metrics], xref:../../observability/monitoring/managing-alerts.adoc#managing-alerts[alerts], xref:../../observability/monitoring/reviewing-monitoring-dashboards.adoc#reviewing-monitoring-dashboards[monitoring dashboards], and xref:../../observability/monitoring/managing-metrics-targets.adoc#managing-metrics-targets[metrics targets].
...
* xref:../../observability/monitoring/managing-metrics-targets.adoc#getting-detailed-information-about-a-target_managing-metrics-targets[Getting detailed information about a target]
