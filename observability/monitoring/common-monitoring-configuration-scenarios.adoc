...
* xref:../../observability/monitoring/managing-alerts.adoc#configuring-alertmanager-to-send-notifications-for-user-defined-alert-routing_managing-alerts[Configure the Alertmanager to send notifications for user-defined alert routing].
