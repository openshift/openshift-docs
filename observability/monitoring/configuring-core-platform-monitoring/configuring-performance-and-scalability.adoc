...
* xref:../../../observability/monitoring/about-ocp-monitoring/key-concepts#about-performance-and-scalability_key-concepts[About performance and scalability]
...
* xref:../../../observability/monitoring/about-ocp-monitoring/key-concepts#about-specifying-limits-and-requests-for-monitoring-components-cpm_key-concepts[About specifying limits and requests for core monitoring components]
...
* xref:../../../observability/monitoring/about-ocp-monitoring/key-concepts#configuring-metrics-collection-profiles_key-concepts[About metrics collection profiles]
