...
* xref:../../../observability/monitoring/configuring-core-platform-monitoring/before-you-begin.adoc#preparing-to-configure-the-monitoring-stack_before-you-begin[Preparing to configure the monitoring stack]
...
* xref:../../../observability/monitoring/configuring-user-workload-monitoring/before-you-begin-uwm.adoc#enabling-alert-routing-for-user-defined-projects_before-you-begin-uwm[Enabling alert routing for user-defined projects]
