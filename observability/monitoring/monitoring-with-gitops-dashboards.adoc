...
[role="_abstract"]
The {gitops-shortname} monitoring dashboards display instance health, application status, component performance, and rollout metrics. Use these dashboards to track deployments and troubleshoot synchronization issues.
