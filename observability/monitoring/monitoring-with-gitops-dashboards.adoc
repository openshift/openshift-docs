...
* xref:../../observability/monitoring/monitoring-the-gitops-operator-performance.adoc#monitoring-the-gitops-operator-performance[Monitor the GitOps Operator performance]
