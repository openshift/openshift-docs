...
* xref:../../../observability/monitoring/configuring-user-workload-monitoring/before-you-begin-uwm.adoc#granting-users-permission-to-monitor-user-defined-projects_before-you-begin-uwm[Granting users permissions for monitoring for user-defined projects]
