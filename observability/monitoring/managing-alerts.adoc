...
You can configure the Alertmanager to send notifications by editing the 
ifndef::openshift-dedicated,openshift-rosa[]
...
ifndef::openshift-dedicated,openshift-rosa[]
include::modules/monitoring-configuring-alertmanager-to-send-notifications-for-default-platform-alerts.adoc[leveloffset=+2]
endif::openshift-dedicated,openshift-rosa[]

// Configuring the Alertmanager to send notifications for user-defined alert routing
include::modules/monitoring-configuring-alertmanager-to-send-notifications-for-user-defined-alert-routing.adoc[leveloffset=+2]

[role="_additional-resources"]
[id="additional-resources_configuring-alertmanager-to-send-notifications"]
== Additional resources

* link:https://www.pagerduty.com/[the PagerDuty official site] for more information on PagerDuty.
* link:https://www.pagerduty.com/docs/guides/prometheus-integration-guide/[the PagerDuty Prometheus Integration Guide]
