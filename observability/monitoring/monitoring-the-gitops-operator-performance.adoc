...
[role="_abstract"]
The {gitops-title} Operator exposes performance metrics that the OpenShift monitoring stack collects and displays in the {OCP} web console. You can track the following metrics:
