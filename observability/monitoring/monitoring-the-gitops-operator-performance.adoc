...
[role="_abstract"]
Monitor the {gitops-title} Operator performance by tracking metrics that the OpenShift monitoring stack collects and displays in the {OCP} web console. You can track the following metrics:
