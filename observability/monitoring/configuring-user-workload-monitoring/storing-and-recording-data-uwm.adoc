...
* xref:../../../observability/monitoring/about-ocp-monitoring/key-concepts#retention-time-and-size-for-prometheus-metrics-data_key-concepts[The retention time and size for Prometheus metrics]
