...
* xref:../../../observability/monitoring/about-ocp-monitoring/key-concepts#understanding-alert-routing-for-user-defined-projects_key-concepts[Understanding alert routing for user-defined projects]
