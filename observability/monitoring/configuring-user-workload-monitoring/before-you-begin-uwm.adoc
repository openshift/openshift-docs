...
* xref:../../../observability/monitoring/configuring-user-workload-monitoring/before-you-begin-uwm.adoc#granting-users-permission-to-configure-monitoring-for-user-defined-projects_before-you-begin-uwm[Granting users permission to configure monitoring for user-defined projects]
* xref:../../../observability/monitoring/configuring-user-workload-monitoring/before-you-begin-uwm.adoc#granting-users-permission-to-configure-alert-routing-for-user-defined-projects_before-you-begin-uwm[Granting users permission to configure alert routing for user-defined projects]
