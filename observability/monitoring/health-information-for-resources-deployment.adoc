...
The *Application environments* page in the *Developer* perspective of the {OCP} web console displays the health status of application resources, such as routes, synchronization status, deployment configurations, and deployment history.
