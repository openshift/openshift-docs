...
To use the {oc-first} tool, you must download and install it separately from your {product-title} installation.

[id="installing-the-openshift-cli"]
== Installing the OpenShift CLI

You can install the {oc-first} either by downloading the binary or by using Homebrew.
