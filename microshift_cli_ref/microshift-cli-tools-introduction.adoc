...
* link:https://access.redhat.com/documentation/en-us/openshift_container_platform/{ocp-version}/html/cli_tools/openshift-cli-oc[Detailed description of the OpenShift CLI (oc)].
