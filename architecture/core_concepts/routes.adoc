...
An OpenShift administrator can deploy _routers_ in an OpenShift cluster, which
enable routes link:../../dev_guide/routes.html#creating-routes[created by
developers] to be used by external clients. The routing layer in OpenShift is
pluggable, and two available link:#available-router-plug-ins[router plug-ins]
are provided and supported by default.

ifdef::openshift-enterprise,openshift-origin[]
[NOTE]
====
See the link:../../install_config/install/deploy_router.html[Installation and
...
|===
|Variable | Default
|HAPROXY_ROUTER_SYSLOG_ADDRESS | "" 
|HAPROXY_ROUTER_LOG_LEVEL | warning
|HAPROXY_ROUTER_BACKEND_CHECK_INTERVAL | 5000ms
|===
...
ifdef::openshift-enterprise,openshift-origin[]
You can
link:../../install_config/install/deploy_router.html#creating-router-shards[create]
and
link:../../install_config/install/deploy_router.html#modifying-router-shards[modify]
