...
link:../../architecture/infrastructure_components/image_registry.html#integrated-openshift-registry[Docker
registry].
...
[NOTE]
====
See the link:../../dev_guide/managing_images.html[Developer Guide] for details
