...
* You can xref:../../admin_guide/manage_authorization_policy.adoc#admin-guide-manage-authorization-policy[configure security] around who can view and use the images through permissions on the image stream objects. 
