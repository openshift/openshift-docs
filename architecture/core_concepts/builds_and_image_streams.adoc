...
pipeline execution.  For more information on the Jenkins image provided with {product-title},
see xref:../../dev_guide/openshift_pipeline.adoc[OpenShift Pipeline], the xref:../../using_images/other_images/jenkins.adoc[Jenkins Image]
documentation, and the ../../dev_guide/dev_tutorials/openshift_pipeline.adoc[Pipeline build tutorial].
