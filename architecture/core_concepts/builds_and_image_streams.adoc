...
[IMPORTANT]
====
Avoid tagging internally managed images (those built and pushed locally to
an internal registry). There's a
link:../../install_config/install/docker_registry.html#registry-known-issues[known issue]
