...
link:https://github.com/GoogleCloudPlatform/kubernetes/blob/master/docs/pods.md[Kubernetes pod documentation]
...
The
https://github.com/GoogleCloudPlatform/kubernetes/blob/master/docs/services.md[Kubernetes documentation] has more information on services.
