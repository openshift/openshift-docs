...
Every user must link:../additional_concepts/authentication.html[authenticate] in
...
link:../additional_concepts/authorization.html[authorized] to do.

== Namespaces

A Kubernetes namespace provides a mechanism to scope resources in a cluster.
In {product-title}, a link:#projects[project] is a Kubernetes namespace with
