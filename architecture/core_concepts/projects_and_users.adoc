...
and create pods within 5 days, your account is automatically deprovisioned. For
all new accounts, there is a 2-day grace period before monitoring begins. Once
