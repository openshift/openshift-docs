...
[role="_abstract"]
Understand the architecture of the {product-title} and Kubernetes so that you can learn how to effectively develop and run containerized applications. 
Containerized applications offer many advantages over using traditional deployment methods.
