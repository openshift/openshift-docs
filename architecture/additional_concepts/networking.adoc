...
xref:../../architecture/additional_concepts/nuagesdn.adoc#architecture-additional-concepts-nuagesdn[Nuage
...
xref:nuagesdn.adoc#operations-workflow[operations workflow] where a policy group
