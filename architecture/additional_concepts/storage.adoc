...
link:https://github.com/kubernetes/community/blob/master/contributors/design-proposals/resources.md[Kubernetes Resource Model] to understand the units expected by `capacity`.
...
link:https://github.com/kubernetes/community/blob/master/contributors/design-proposals/scheduling/resources.md#the-resource-model[Kubernetes Resource Model] applies to both volumes and claims.
