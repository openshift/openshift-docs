...
- xref:../../install_config/persistent_storage/using_hostpath.adoc#using_hostpath[hostPath]
...
xref:../../install_config/persistent_storage/pod_security_context.html#selinuxoptions[SELinux labels] are also changed recursively. A user cannot prevent recursive changes to SELinux labels.
