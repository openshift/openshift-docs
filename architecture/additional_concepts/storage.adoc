...
xref:pv-capacity[storage capacity] and xref:pv-access-modes[access modes]
...
- xref:../../admin_guide/persistent_storage_nfs.adoc#admin-guide-persistent-storage-nfs[NFS]
...
- xref:../../rest_api/kubernetes_v1.adoc#v1-iscsivolumesource[iSCSI]
- xref:../../rest_api/kubernetes_v1.adoc#v1-rbdvolumesource[RBD (Ceph Block
Device)]
endif::[]
