...
- link:../../admin_guide/persistent_storage/persistent_storage_glusterfs.html[GlusterFS]
- link:../../admin_guide/persistent_storage/persistent_storage_cinder.html[OpenStack
Cinder]
