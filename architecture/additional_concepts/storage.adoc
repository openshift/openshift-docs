...
Both of these storage technologies rely on the Azure storage infrastructure. The {product-title} Service does not back up persistent volumes and recommends using external Services for storing sensitive data or application state.
====
endif::[]
