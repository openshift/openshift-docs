...
See the xref:../../dev_guide/quota.adoc#dev-guide-quota[Developer's Guide] and
...
See the xref:../../dev_guide/limits.adoc#dev-guide-limits[Developer's Guide] and
...
xref:../../admin_guide/configuring_authentication.adoc#identity-providers[identity
