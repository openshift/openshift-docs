...
perform a given xref:action[action] within a project. This allows platform
...
platform itself and all projects. It also allows developers to use
xref:cluster-and-local-rbac[local roles and bindings] to control who has access
...
verbs that can be performed on a set of resources. {product-title}
