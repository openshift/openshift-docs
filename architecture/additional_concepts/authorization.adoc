...
[[architecture-additional-concepts-authorization-overview]]
== Overview
...
== Security Context Constraints
In addition to xref:architecture-additional-concepts-authorization-overview[authorization policies] that control what a user
