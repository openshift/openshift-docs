...
xref:../../admin_guide/custom_resource_definitions.adoc#create-aggregated-cluster-role-crd-admin-guide-custom-resources[Learn how to use cluster role aggregation].
endif::openshift-enterprise,openshift-origin[]
