...
Refer to the link:http://kubernetes.io/docs/admin/kubelet/[Kubelet
configuration] and
link:https://github.com/kubernetes/kubernetes/blob/release-1.4/docs/design/seccomp.md[Kubernetes
seccomp design] documentation for more information on configuring seccomp.
