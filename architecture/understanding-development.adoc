...
S2I images are available for you to use directly from the {product-title} web UI. In the Developer perspective, navigate to the *+Add* view and from the *Developer Catalog* tile, click *All Services* to view all of the available services in the Developer Catalog.
