...
OPENSHIFT_OAUTH_AUTHORIZE_TOKEN_MAX_AGE_SECONDS=300 <7>
OPENSHIFT_OAUTH_ACCESS_TOKEN_MAX_AGE_SECONDS=3600 <8>
```
...
<7> Let authorize tokens be valid for 5 minutes
<8> Let access tokens be valid for 1 hour
