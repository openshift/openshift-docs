...
[role="_abstract"]
You can use admission plugins to regulate how {product-title} functions. The default set of admission plugins for {product-title} ensures proper functioning for your cluster.
...
* xref:../nodes/pods/nodes-pods-priority.adoc#admin-guide-priority-preemption-names_nodes-pods-priority[Including pod priority in pod scheduling decisions]
