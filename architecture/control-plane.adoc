...
include::modules/architecture-machine-config-pools-custom.adoc[leveloffset=+2]
...
[role="_additional-resources"]
.Additional resources
* xref:../machine_configuration/machine-config-pool-custom.adoc#machine-config-pool-custom[Using custom machine config pools to configure nodes]
...
* xref:../nodes/nodes/nodes-nodes-creating-infrastructure-nodes.adoc#nodes-nodes-creating-infrastructure-nodes[Creating infrastructure nodes]
