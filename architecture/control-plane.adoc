...
[role="_additional-resources"]
.Additional resources
* xref:../machine_configuration/machine-configs-configure.adoc#machine-configs-configure[Configure nodes by using machine config objects]
...
include::modules/machine-config-pools-custom.adoc[leveloffset=+2]
