...
* xref:../machine_configuration/index.adoc#machine-config-drift-detection_machine-configs-configure[Understanding configuration drift detection].
...
[role="_additional-resources"]
.Additional resources
* For more information about detecting configuration drift, see xref:../machine_configuration/index.html#machine-config-drift-detection_machine-config-overview[Understanding configuration drift detection].
