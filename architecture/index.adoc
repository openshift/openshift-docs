...
ifndef::openshift-rosa-hcp[]
* For more information on authentication, see link:https://docs.openshift.com/rosa/authentication/index.html{product-title} authentication].
* For more information on Operator Lifecycle Manager (OLM), see link:https://docs.openshift.com/rosa/operators/understanding/olm/olm-understanding-olm.html[OLM].
* For more information on logging, see link:https://docs.openshift.com/rosa/observability/logging/cluster-logging.html[About Logging].
endif::openshift-rosa-hcp[]
// Topic not included in the OSD/ROSA docs
ifndef::openshift-dedicated,openshift-rosa,openshift-rosa-hcp[]
