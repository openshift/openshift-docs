...
// this content is not supported on this branch. * For more information on logging, see xrf:../observability/logging/cluster-logging.adoc#cluster-logging[About Logging].
// Topic not included in the OSD/ROSA docs
ifndef::openshift-dedicated,openshift-rosa[]
