...
several xref:../../architecture/networking/assembly_available_router_pluging.adoc#architecture-additional-concepts-router-plugins[router plug-ins] are provided and
