...
|Affected Topic |Description of Change
//Wed Sep 06 2017
|xref:../architecture/networking/routes.adoc#architecture-core-concepts-routes[Core Concepts -> Routes]
|Added the xref:../architecture/networking/routes.adoc#alternateBackends[Alternate Backends] section, and various information about multiple deployments.
...
|Affected Topic |Description of Change
//Tue Aug 29 2017
|xref:../architecture/networking/sdn.adoc#architecture-additional-concepts-sdn[Additional Concepts -> OpenShift SDN]
|Corrected `vxlan0` to `vxlan_sys_4789` in the xref:../architecture/networking/sdn.adoc#sdn-design-on-nodes[Design on Nodes] section.
...
|Affected Topic |Description of Change
//Tue Aug 22 2017
|xref:../architecture/networking/network_plugins.adoc#architecture-additional-concepts-f5-big-ip[Additional Concepts -> F5 BIG-IP® Router Plug-in]
...
|Affected Topic |Description of Change
//Wed Aug 09 2017
.5+.^|xref:../architecture/networking/routes.adoc#architecture-core-concepts-routes[Core Concepts -> Routes]
...
|Added the xref:../architecture/networking/routes.adoc#ciphers[Router Cipher Suite] section and various changes about ciphers.
|Added the xref:../architecture/networking/routes.adoc#strict-sni[HAProxy Strict SNI] section
|Added the xref:../architecture/networking/routes.adoc#whitelist[Route-specific IP Whitelists] section.
