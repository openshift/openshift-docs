...
// tag::architecture_mon_may_09_2016[]
...
|Added an link:../architecture/core_concepts/builds_and_image_streams.html#adding-tag[Important box] advising against tagging internally managed images.
...
|Updated the Web Console Project Overview screenshot.
...
|Added the *system:authenticated:oauth* virtual group.



|===

// end::architecture_mon_may_09_2016[]
== Tue May 03 2016
