...
http://clusterlabs.org/quickstart-redhat.adoc[CentOS 7] and
...
https://docs.openshift.com/enterprise/3.1/install_config/install/advanced_install.adoc[OpenShift
