...
ifdef::openshift-origin,openshift-online,openshift-enterprise,openshift-dedicated,openshift-aro[]
toc::[]
...
// TODO: These callouts are generating asciidoctor build warnings
...
endif::openshift-origin,openshift-online,openshift-enterprise,openshift-dedicated,openshift-aro[]
