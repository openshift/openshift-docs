...
ifdef::openshift-rosa-hcp[]
* link:https://docs.openshift.com/rosa/rosa_cluster_admin/rosa_nodes/rosa-nodes-machinepools-configuring.html[Configuring machine pools in Local Zones]
endif::openshift-rosa-hcp[]