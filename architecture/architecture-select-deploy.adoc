...
[id="architecture-select-deploy"]
= {product-title} Selecting and deploying OCP models
include::_attributes/common-attributes.adoc[]
:context: architecture

toc::[]

include:: modules/architecture-select-deploy-introduction.adoc[leveloffset=+1]
