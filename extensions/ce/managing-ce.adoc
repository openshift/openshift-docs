...
* xref:../../extensions/ce/upgrade-paths.adoc#olmv1-about-target-versions_upgrade-edges[Example custom resources (CRs) that specify a target version]
* xref:../../extensions/ce/upgrade-paths.adoc#olmv1-version-range-support_upgrade-edges[Support for version ranges]

include::modules/olmv1-updating-an-operator.adoc[leveloffset=+1]

[role="_additional-resources"]
.Additional resources
* xref:../../extensions/ce/upgrade-paths.adoc#upgrade-edges[Upgrade paths]
