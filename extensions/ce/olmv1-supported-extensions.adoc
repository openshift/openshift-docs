...
However, an extension cannot install or execute if its `AllNamespaces` scope attempts to modify or interact with Red{nbsp}Hat SRE protected system namespaces or host-level nodes.
endif::[]
