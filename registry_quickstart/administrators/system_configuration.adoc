...
* Configure authentication by integrating with an identity provider
...
xref:../../install_config/install/docker_registry.adoc#securing-the-registry[secure the registry]
for TLS.
