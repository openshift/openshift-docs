...
include::modules/cloud-experts-using-cloudfront-and-waf-configure-aws-waf.adoc[leveloffset=+1]
...
* link:https://aws.amazon.com/waf/[AWS Web Application Firewall (WAF)]
* link:https://www.youtube.com/watch?v=-HorEsl2ho4[Adding Extra Security with AWS WAF, CloudFront and ROSA | Amazon Web Services on YouTube]
