...
// this content is not supported on this branch. * Set up a logging solution before viewing your logs. See the xrf:../../observability/logging/cluster-logging-deploying.adoc#cluster-logging-deploying[Installing logging] documentation for more information.
