...
== Prerequisites
* xref:../cloud-experts-tutorials/rosa-mobb-prerequisites-tutorial.adoc#rosa-mobb-prerequisites-tutorial[If this is your first time deploying ROSA, follow these prerequisite instructions].
