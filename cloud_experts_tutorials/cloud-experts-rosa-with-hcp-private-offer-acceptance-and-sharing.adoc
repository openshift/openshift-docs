...
+
The account linking and initial cluster deployment steps are described in more detail in xref:../cloud_experts_tutorials/cloud-experts-rosa-hcp-activation-and-account-linking-tutorial.adoc#cloud-experts-rosa-hcp-activation-and-account-linking-tutorial[AWS and Red{nbsp}Hat account and subscription linking].
