...
[role="_abstract"]
Accept a private offer for {product-title} and share the offer entitlement with team members in your Red{nbsp}Hat organization to ensure they can use the offer for the clusters they provision.
