...
The maximum number of worker nodes in ROSA clusters with OVN-Kubernetes version 4.14.14 and later is 249. For earlier versions, the limit is 180 nodes. See xref:../../rosa_planning/rosa-limits-scalability.adoc#rosa-limits-scalability[limits and scalability] for more details on node counts.
