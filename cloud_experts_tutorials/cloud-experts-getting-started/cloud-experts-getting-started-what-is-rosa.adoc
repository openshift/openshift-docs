...
//
ROSA uses several different cloud services such as virtual machines, storage, and load balancers. You can see a defined list in the xref:../../rosa_planning/rosa-hcp-prereqs.adoc#rosa-aws-policy-provisioned_rosa-hcp-prereqs[AWS prerequisites for ROSA clusters] and xref:../../rosa_planning/rosa-classic-prereqs.adoc#rosa-aws-policy-provisioned_rosa-classic-prereqs[AWS prerequisites for ROSA (classic architecture) clusters].
