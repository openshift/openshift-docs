...
//
* For more about VPC requirements, see the xref:../../../rosa_planning/rosa-hcp-prereqs.adoc#rosa-vpc_rosa-hcp-prereqs[VPC documentation for ROSA clusters] or xref:../../../rosa_planning/rosa-classic-prereqs.adoc#rosa-vpc_rosa-classic-prereqs[VPC documentation for ROSA (classic architecture) clusters].
