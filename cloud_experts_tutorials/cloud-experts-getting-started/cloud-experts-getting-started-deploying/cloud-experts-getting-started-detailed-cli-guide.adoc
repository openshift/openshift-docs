...
//
** See the documentation on xref:../../../rosa_planning/rosa-hcp-prereqs.adoc#rosa-ec2-instances_rosa-hcp-prereqs[ec2 instances for ROSA clusters] or xref:../../../rosa_planning/rosa-classic-prereqs.adoc#rosa-ec2-instances_rosa-classic-prereqs[ec2 instances for ROSA (classic architecture) clusters] for more details.
