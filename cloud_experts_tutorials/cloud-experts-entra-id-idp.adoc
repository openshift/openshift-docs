...
[role="_abstract"]
Configure Microsoft Entra ID (formerly Azure Active Directory) as the cluster identity provider to enable single sign-on and group-based access control for your {product-title} cluster by using OpenID Connect (OIDC).
