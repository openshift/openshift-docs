...
Now that you have some understanding of critical {product-title} terms, take a xref:../../openshit-tutorial#openshift-tutorial-walk[quick walkthrough of {product-title}].  
