...
Event processing should typically complete within a short time frame, such as a few minutes. This ensures that the HTTP connection remains open and the service does not scale down prematurely.
