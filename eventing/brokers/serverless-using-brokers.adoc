...
== Next steps
* Configure event delivery parameters that are applied in cases where an event fails to be delivered to an event sink. See xref:../../eventing/brokers/serverless-event-delivery.adoc#serverless-configuring-event-delivery-examples_serverless-event-delivery[Examples of configuring event delivery parameters].
...
xref:../../eventing/event-sources/knative-event-sources.adoc#knative-event-sources[Event sources]
* xref:../../eventing/brokers/serverless-event-delivery.adoc#serverless-event-delivery[Event delivery]
