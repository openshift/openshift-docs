...
+
In {VirtProductName} 4.17.0, not all the required feature gates are enabled. To use the storage live migration feature, you must enable the feature gate. You can enable the feature gate by running the following command:
+
[source,terminal]
----
