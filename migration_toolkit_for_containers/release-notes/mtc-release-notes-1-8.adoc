...
The release notes for {mtc-full} ({mtc-short}) 1.8 describe new features and enhancements, deprecated features, and known issues.
...
include::modules/migration-mtc-release-notes-1-8-0.adoc[leveloffset=+1]
