...
Direct Migration is available from {mtc-full} ({mtc-short}) 1.4.0.
...
* The `spec.exposedRegistryPath` is only required for Direct Image Migration and not Direct Volume Migration.
====
