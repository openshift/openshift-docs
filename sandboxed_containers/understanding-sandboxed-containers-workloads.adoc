...
[id="understanding-sandboxed-containers-workloads"]
= Understanding {sandboxed-containers-first} workloads
include::_attributes/common-attributes.adoc[]
:context: understanding-sandboxed-containers-workloads

toc::[]

[role="_abstract"]

{sandboxed-containers-first} support for {product-title} provides you with built-in support for running Kata Containers as an additional optional runtime. This is particularly useful for performing the following tasks:
...
{sandboxed-containers-first} also provides the ability to choose from the type of workload that they want to run to cover a wide variety of use cases.
...
include::modules/sandboxed-containers-workloads-overview.adoc[leveloffset=+1]
...
include::modules/sandboxed-containers-workload-management.adoc[leveloffset=+1]
include::modules/sandboxed-containers-virtualization.adoc[leveloffset=+1]
