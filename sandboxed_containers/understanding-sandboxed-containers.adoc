...
{sandboxed-containers-first} also provides users the ability to choose from the type of workload they want to run to cover a wide variety of use cases.

The {sandboxed-containers} enables users to manage the lifecycle of sandboxed containers on a cluster. The operator allows you to perform tasks such as installation and removal, updates, and status monitoring.
