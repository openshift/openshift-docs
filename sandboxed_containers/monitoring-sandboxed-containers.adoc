...
* For more information about creating PromQL queries to view metrics, see xref:../observability/monitoring/managing-metrics.adoc#about-querying-metrics_managing-metrics[Querying metrics].
