...
[id="sandboxed-containers-1-3-3"]
=== RHBA-2023:0485 - {sandboxed-containers-first} {sandboxed-containers-version}.3 bug fix advisory

Issued: 2023-01-30

{sandboxed-containers-first} release {sandboxed-containers-version}.3 is now available. This advisory contains an update for {sandboxed-containers-first} with bug fixes and container updates.

The list of bug fixes included in the update is documented in the link:https://access.redhat.com/errata/RHBA-2023:0485[RHBA-2023:0485] advisory.