[id='op-working-with-pipelines-using-the-developer-perspective']
...
////
* You have cluster administrator privileges to install operators and have link:TBD[installed the OpenShift Pipelines Operator].
////
