...
// what components is it enabled for by default, is this still true? When installing KS in the console the HA field is blank
// HA also applies for eventing now and kafka it seems - let's rethink how we're structuring these docs?
// create Jira to document gaps in install docs
