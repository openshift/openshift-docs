...
= Monitoring {ServerlessProductName} components
:context: monitoring-serverless
include::modules/common-attributes.adoc[]

toc::[]

As a cluster administrator, you can deploy the {product-title} monitoring stack and monitor the metrics of {ServerlessProductName} components.
