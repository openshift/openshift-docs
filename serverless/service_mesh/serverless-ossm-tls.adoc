...
====
* Complete the configuration steps in xref:../../serverless/service_mesh/serverless-ossm.adoc#serverless-ossm[Using Service Mesh with OpenShift Serverless].
* Configure a custom domain. See xref:../../serverless/service_mesh/serverless-ossm-custom-domains.adoc#serverless-ossm-custom-domains[Using custom domains for Knative services with Service Mesh].
