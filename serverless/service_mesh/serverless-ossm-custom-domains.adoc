...
* Complete the configuration steps in xref:../../serverless/service_mesh/serverless-ossm.adoc#serverless-ossm[Using {ProductShortName} with {ServerlessProductName}].
