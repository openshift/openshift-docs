...
[id="serverless-about-kafka"]
= About Knative Kafka
include::_attributes/common-attributes.adoc[]
:context: serverless-about-kafka
...
In addition to the Knative Eventing components that are provided as part of a core {ServerlessProductName} installation, administrators can install the `KnativeKafka` custom resource (CR).
...
[id="additional-resources_serverless-about-kafka"]
