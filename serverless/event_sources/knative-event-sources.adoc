...
xref:../../serverless/knative_eventing/serverless-sinkbinding.adoc#serverless-sinkbinding[Sink binding] is also supported, which allows you to connect core Kubernetes resources such as `Deployment`, `Job`, or `StatefulSet` with a sink.
...
* Create an xref:../../serverless/event_sources/serverless-apiserversource.adoc#serverless-apiserversource[ApiServerSource] object.
* Create a xref:../../serverless/event_sources/serverless-pingsource.adoc#serverless-pingsource[PingSource] object.
// add others
