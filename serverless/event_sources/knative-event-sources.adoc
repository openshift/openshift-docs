...
Sink binding:: Allows you to connect core Kubernetes resource objects such as a `Deployment`, `Job`, or `StatefulSet` with a sink.
Kafka source:: Connect a Kafka cluster to a sink as an event source.
