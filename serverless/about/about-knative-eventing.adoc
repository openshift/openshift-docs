...
* xref:../../serverless/admin_guide/serverless-kafka-admin.adoc#serverless-kafka-admin[Cluster administrator documentation for the Knative Broker implementation for Apache Kafka]