...
Brokers can be used in combination with xref:../../serverless/event_workflows/serverless-subs.adoc#serverless-subs[subscriptions] and xref:../../serverless/event_workflows/serverless-triggers.adoc#serverless-triggers[triggers] to deliver events from an xref:../../serverless/event_sources/knative-event-sources.adoc#knative-event-sources[event source] to an event sink.
