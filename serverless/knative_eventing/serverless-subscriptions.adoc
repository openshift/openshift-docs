...
* If you do not have an existing sink that you wish to use, create a Service to use as a sink by following the documentation on xref:../../serverless/getting_started/serving-creating-managing-apps.adoc#serving-creating-managing-apps[Creating and managing serverless applications].
