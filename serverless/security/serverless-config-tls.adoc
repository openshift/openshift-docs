...
TLS is the only supported method of traffic encryption for the Knative Broker implementation for Apache Kafka.  Red Hat recommends using both SASL and TLS together for Kafka resources.
