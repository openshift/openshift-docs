...
* See xref:../../service_mesh/service_mesh_arch/understanding-ossm.adoc#understanding-ossm[Understanding {ProductName}].
* For more information about verifying Knative services and using `curl` requests, see xref:../../serverless/serving-creating-managing-apps.adoc#verifying-serverless-app-deployment[Verifying your serverless application deployment].
