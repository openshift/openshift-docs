...
* xref:../../serverless/develop/serverless-brokers.adoc#serverless-brokers[brokers] and xref:../../serverless/develop/serverless-triggers.adoc#serverless-triggers[triggers].
