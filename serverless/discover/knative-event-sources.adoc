...
xref:../../serverless/knative_kafka/serverless-kafka-source.adoc#serverless-kafka-source[Kafka event source]:: Connects a Kafka cluster to a sink as an event source.
