...
For more information about Kafka channels, see the xref:../../serverless/knative_kafka/serverless-kafka-channel.adoc#serverless-kafka-channel[Knative Kafka] documentation.
