...
* For more information about configuring high availability, see xref:../serverless/knative_serving/serverless-HA.adoc#serverless-HA[High availability on {ServerlessProductName}].
