...
* Install the Knative CLI to use `kn` commands with Knative Serving. For example, `kn service` commands. See the documentation on xref:../installing_serverless/installing-kn#installing-kn[Installing the Knative CLI].
