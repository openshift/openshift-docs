...
[id="installing-openshift-serverless-additional-resources"]
== Additional resources

* For more information on installing Operators, see the {product-title} documentation on xref:../../operators/olm-adding-operators-to-cluster.adoc#olm-adding-operators-to-cluster[Adding Operators to a cluster].
