...
----
+
The previous command should return the latest version of Knative Serving. See the xref:../serverless/serverless-release-notes.adoc#serverless-release-notes[OpenShift Serverless release notes] for the latest version information.
