...
* For more information about configuring high availability, see xref:../../serverless/admin/serverless-HA.adoc#serverless-HA[High availability on {ServerlessProductName}].
