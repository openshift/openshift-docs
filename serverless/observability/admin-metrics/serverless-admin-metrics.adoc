...
ifdef::openshift-enterprise[]
* See the {product-title} documentation on link:https://docs.redhat.com/en/documentation/monitoring_stack_for_red_hat_openshift/4.21/html/accessing_metrics/accessing-metrics-as-an-administrator[Accessing metrics as an administrator] for information about enabling metrics for your cluster.
