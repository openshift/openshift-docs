...
* xref:../registry/configuring-registry-storage/configuring-registry-storage-baremetal.adoc#configuring-registry-storage-baremetal[Configuring registry storage for bare metal]
