...
Use transport layer protocols (TLS) to help prevent known insecure protocols, ciphers, or algorithms to access the applications you run on {microshift-short}.
...
* xref:../../microshift_configuring/microshift-using-config-yaml.adoc#microshift-config-snippets_microshift-using-config-yaml[Using configuration snippets].
