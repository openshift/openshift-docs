...
* link:https://docs.redhat.com/container-platform/latest/networking/networking_operators/ingress-operator.adoc#configuring-ingress[Enabling HTTP/2 Ingress connectivity] ({OCP} documentation)
