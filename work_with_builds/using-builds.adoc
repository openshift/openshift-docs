...
[role="_abstract"]
After installing {builds-shortname}, you can create builds using `buildah` or `source-to-image` build strategies. You can also delete custom resources that are not required for a build.
