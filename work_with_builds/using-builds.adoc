...
[role="_abstract"]
After installing {builds-shortname}, you can create builds using `buildah`, `source-to-image`, or `buildpacks` depending on your development workflow. Additionally, you can also delete custom resources that are not required for a build.
