...
[role="_abstract"]
After installing {builds-shortname}, you can create builds using `buildah` or `source-to-image`. You can also use an Open Container Initiative (OCI) to create your build. You can also delete custom resources that are not required for a build.
