...
After installing {builds-shortname}, you can create a `buildah`, `source-to-image`, `buildpacks` builds for use. You can also use an Open Container Initiative (OCI) to create your build. You can also delete custom resources that are not required for a build.
