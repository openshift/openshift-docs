...
include::modules/ob-enabling-builds-in-a-network-restricted-environment-using-the-buildah-build.adoc[leveloffset=+2]

include::modules/ob-creating-a-s2i-build.adoc[leveloffset=+1]

include::modules/ob-enabling-builds-in-a-network-restricted-environment-using-the-source-to-image-build.adoc[leveloffset=+2]
