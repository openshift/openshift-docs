...
After installing {builds-shortname}, you can create a `buildah`, `source-to-image` build. You can also use an Open Container Initiative(OCI) artifact to create a build.
...
include::modules/ob-deleting-custom-resources.adoc[leveloffset=+1]
