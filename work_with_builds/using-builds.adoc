...
After installing {builds-shortname}, you can create a `buildah`, `source-to-image`, or `buildpacks` build. You can also use an Open Container Initiative(OCI) artifact to create a build.
...
include::modules/ob-editing-a-resource.adoc[leveloffset=+1]

include::modules/ob-deleting-resources.adoc[leveloffset=+1]
