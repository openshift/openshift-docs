...
[role="_abstract"]
After installing {builds-shortname}, you can create builds using `buildah`, `source-to-image`. You can also delete custom resources that are not required for a build.
