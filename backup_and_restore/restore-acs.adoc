...
. *Restore an external PostgreSQL database*: Use this to restore your {product-title-short} instance when you are utilizing an external PostgreSQL database. You can recover your system data while maintaining your existing database setup.
