...
* xref:../../../operators/users/olm-creating-apps-from-installed-operators.adoc#olm-creating-apps-from-installed-operators[Installing from OperatorHub using the web console].
