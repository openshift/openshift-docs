...
:velero-link: https://{velero-domain}/docs/v{velero-version}/[Velero {velero-version}]

toc::[]

[role="_abstract"]
You install the {oadp-first} with {aws-first} by installing the OADP Operator. The Operator installs link:velero-link.
