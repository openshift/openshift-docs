...
After you create your clusters, you can operate your clusters with the OpenShift web console or through link:https://docs.openshift.com/dedicated/ocm/ocm-overview.html[{cluster-manager-first}]. You can also use ROSA service with OpenShift APIs and command-line interface (CLI) tools.
