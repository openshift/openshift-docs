...
[role="_abstract"]
ifdef::openshift-rosa,openshift-rosa-hcp[]
Use {oadp-first} with {product-title} clusters to back up and restore application data.
endif::openshift-rosa,openshift-rosa-hcp[]
...
After you create your clusters, you can operate your clusters with the {product-title} web console or through {cluster-manager-first}. You can also use ROSA with OpenShift APIs and command-line interface (CLI) tools.
