...
ifndef::openshift-rosa,openshift-rosa-hcp[]
* xref:../../../operators/user/olm-installing-operators-in-namespace.adoc#olm-installing-from-software-catalog-using-web-console_olm-installing-operators-in-namespace[Installing from OperatorHub using the web console].
endif::openshift-rosa,openshift-rosa-hcp[]
