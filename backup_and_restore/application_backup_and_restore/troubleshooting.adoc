...
* xref:../../backup_and_restore/application_backup_and_restore/installing/about-installing-oadp.adoc#oadp-velero-cpu-memory-requirements_oadp-troubleshooting[CPU and memory requirements]
...
// will move this page after rebasing
include::modules/oadp-velero-cpu-memory-requirements.adoc[leveloffset=+2]
