...
//* xref:../../backup_and_restore/application_backup_and_restore/velero/velero-troubleshooting-install-installing.adoc#velero-obtaining-by-downloading_[Downloading the Velero CLI tool]
