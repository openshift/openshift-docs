...
* link:https://docs.redhat.com/en/documentation/{3scaleDocInfoProductName}/{3scaleProductVersion}/html/installing_red_hat_3scale_api_management/install-threescale-on-openshift-guide[Installing 3scale API Management on OpenShift]

* link:https://docs.redhat.com/en/documentation/red_hat_3scale_api_management[Red Hat 3scale API Management]
