...
You can restore the 3scale by restoring the backed up 3scale Operator resources, and databases such as MySQL and Redis. Once the data has been restored, you can scale up the 3scale Operator and deployment. 
