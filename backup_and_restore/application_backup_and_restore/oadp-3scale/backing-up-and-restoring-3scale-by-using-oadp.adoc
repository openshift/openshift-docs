...
You can xref:../oadp-3scale/backing-up-3scale-by-using-oadp.adoc[back up 3scale] and xref:../oadp-3scale/restoring-3scale-by-using-oadp.adoc[restore 3scale] by using OADP.
