...
You can delete backups by deleting the `Backup` custom resource (CR). See xref:../../../backup_and_restore/application_backup_and_restore/backing_up_and_restoring/oadp-deleting-backups-doc.adoc#oadp-deleting-backups-doc[Deleting backups].
