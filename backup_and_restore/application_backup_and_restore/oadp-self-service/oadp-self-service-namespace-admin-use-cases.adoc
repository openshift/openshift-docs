...
[role="_abstract"]
Use {oadp-short} Self-Service as a namespace administrator to create backup storage locations, perform backup and restore operations, and review operation logs for your authorized namespaces. This enables you to manage data protection independently without cluster admin access.
