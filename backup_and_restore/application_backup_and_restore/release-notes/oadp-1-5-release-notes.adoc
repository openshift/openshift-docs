...
include::modules/oadp-backing-up-dpa-configuration-1-5-0.adoc[leveloffset=+3]
include::modules/oadp-upgrading-oadp-operator-1-5-0.adoc[leveloffset=+3]
...
To upgrade from OADP 1.4 to 1.5, no Data Protection Application (DPA) changes are required. The {oadp-first} 1.4 is not supported on {OCP-short} 4.19.
