...
* {oadp-short} {oadp-version-1-4} was tested successfully against {product-title} 4.13, 4.14, 4.15, and 4.16 for both {ibm-power-name} and {ibm-z-name}. The sections that follow give testing and support information for {oadp-short} {oadp-version-1-4} in terms of backup locations for these systems.
