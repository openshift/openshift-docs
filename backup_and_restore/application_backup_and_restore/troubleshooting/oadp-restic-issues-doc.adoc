...
[id="restic-permission-error-nfs-root-squash-enabled-doc"]
...
[id="restic-backup-cannot-be-recreated-after-s3-bucket-emptied-doc"]
...
* Remove the related Restic repository from the namespace by running one of the following commands:

** For OADP 1.1 and earlier:
+
[source,terminal]
----
$ oc delete resticrepository openshift-adp <name_of_the_restic_repository>
----
//@Shahaf: is this what you meant:
+
** For OADP 1.2 and later:
+
[source,terminal]
----
$ oc delete BackupRepository openshift-adp <name_of_the_restic_repository>
----
+
