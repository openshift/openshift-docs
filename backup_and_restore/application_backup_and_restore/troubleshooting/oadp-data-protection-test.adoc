...
[role="_abstract"]
The `DataProtectionTest` (DPT) is a custom resource (CR) that provides a framework to validate your {oadp-short} configuration in the following ways. The DPT CR checks and reports information for the following parameters:
