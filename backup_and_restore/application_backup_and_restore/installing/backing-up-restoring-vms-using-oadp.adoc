...
. {oadp-short} operator installed on an {OCP} cluster. For more information, see xref:../../../backup_and_restore/application_backup_and_restore/installing/about-installing-oadp.adoc#about-installing-oadp[{oadp-short} Operator].
