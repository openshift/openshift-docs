...
Installation and configuration of OADP can be found in the OADP documentation, I have followed the setup for OADP with AWS as the s3 provider (based on this doc [up to and excluding the backing up section]).
