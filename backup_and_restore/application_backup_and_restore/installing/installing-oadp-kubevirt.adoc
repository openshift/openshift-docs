...
{oadp-full} excludes the following storage options:
...
include::modules/oadp-configuring-priority-class.adoc[leveloffset=+1]
...
* xref:../../../backup_and_restore/index.adoc#application-backup-restore-operations-overview_backup-restore-overview[Application backup and restore operations]
...
* link:https://velero.io/docs/v{velero-version}[Velero {velero-version}]
