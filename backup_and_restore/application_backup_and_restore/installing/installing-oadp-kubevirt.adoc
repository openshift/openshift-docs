...
For more information, see xref:../../oadp/backing_up_and_restoring/oadp-backing-up-applications-restic-doc.adoc#oadp-backing-up-applications-restic-doc[Backing up applications with File System Backup: Kopia or Restic].
====
...
* xref:../../oadp/oadp-features-plugins.adoc#oadp-plugins_oadp-features-plugins[{oadp-short} plugins]
* xref:../../oadp/backing_up_and_restoring/backing-up-applications.adoc#backing-up-applications[`Backup` custom resource (CR)]
* xref:../../oadp/backing_up_and_restoring/restoring-applications.adoc#restoring-applications[`Restore` CR]
