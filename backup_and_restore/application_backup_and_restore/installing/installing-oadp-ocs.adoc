...
You can configure xref:../../oadp/installing/installing-oadp-mcg.adoc#installing-oadp-mcg[Multicloud Object Gateway] or any AWS S3-compatible object storage as a backup location.
...
For more details, see xref:../../oadp/installing/installing-oadp-ocs.adoc#oadp-configuring-node-agents_installing-oadp-ocs[Configuring node agents and node labels].
