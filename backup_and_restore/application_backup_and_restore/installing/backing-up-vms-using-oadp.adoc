...
* Restore the Backup CR by creating a Restore CR. For more details, see xref:restoring-vms-using-oadp.adoc#oadp-creating-restore-cr_restoring-vms-using-oadp[Creating a Restore CR].
