...
* Back up virtual machines by creating a Backup custom resource (CR). For more details, see xref:oadp-creating-backup-cr_backing-up-vms-using-oadp[Creating a `Backup` custom resource (CR)].
