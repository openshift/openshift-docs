...
* xref:../../oadp/installing/installing-oadp-aws.adoc#installing-oadp-aws[Amazon Web Services]
* xref:../../oadp/installing/installing-oadp-azure.adoc#installing-oadp-azure[Microsoft Azure]
* xref:../../oadp/installing/installing-oadp-gcp.adoc#installing-oadp-gcp[Google Cloud Platform]
* xref:../../oadp/installing/installing-oadp-mcg.adoc#installing-oadp-mcg[Multicloud Object Gateway]
...
* xref:../../oadp/installing/installing-oadp-azure.adoc#installing-oadp-azure[Microsoft Azure]
* xref:../../oadp/installing/installing-oadp-gcp.adoc#installing-oadp-gcp[Google Cloud Platform]
* CSI snapshot-enabled cloud provider, such as xref:../../oadp/installing/installing-oadp-ocs.adoc#installing-oadp-ocs[OpenShift Data Foundation]

include::snippets/oadp-ocp-compat.adoc[]

If your cloud provider does not support snapshots or if your storage is NFS, you can back up applications with xref:../../oadp/backing_up_and_restoring/oadp-backing-up-applications-restic-doc.adoc#backing-up-applications[Backing up applications with File System Backup: Kopia or Restic] on object storage.
