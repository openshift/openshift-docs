...
You configure Azure for Velero, create a default `Secret`, and then install the Data Protection Application. For more details, see xref:../../oadp/installing/oadp-installing-operator.adoc#oadp-installing-operator-doc[Installing the OADP Operator].
...
For more details, see xref:../../oadp/installing/installing-oadp-azure.adoc#oadp-configuring-node-agents_installing-oadp-azure[Configuring node agents and node labels].
