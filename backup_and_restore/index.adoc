...
// fred When you want to get your cluster running again, xref:../../backup_and_restore/graceful-cluster-restart.adoc#graceful-restart-cluster[restart the cluster gracefully].
