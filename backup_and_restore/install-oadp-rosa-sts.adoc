...
[id="install-oadp-rosa-sts"]
= Installing OADP on ROSA with STS
include::_attributes/common-attributes.adoc[]
:context: install-oadp-rosa-sts
...
* xref:../backup_and_restore/install-oadp-rosa-sts.adoc#oadp-preparing-aws-credentials_install-oadp-rosa-sts[Preparing AWS credentials]
