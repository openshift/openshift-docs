...
* xref:../../../installing/installing_bare_metal/modules/ipi-install-provisioning-the-bare-metal-node.adoc[Installing a user-provisioned cluster on bare metal]
...
* xref:../../../backup_and_restore/control_plane_backup_and_restore/disaster_recovery/modules/ipi-install-replacing-a-bare-metal-control-plane-node.adoc#ipi-install-replacing-a-bare-metal-control-plane-node[Replacing a bare-metal control plane node]
