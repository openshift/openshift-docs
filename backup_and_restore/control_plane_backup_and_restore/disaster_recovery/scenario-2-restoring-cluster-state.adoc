...
* xref:../../installing_on_bare_metal/user-provisioned-infrastructure#installing-bare-metal[Installing a user-provisioned cluster on bare metal]
...
* xref:../../installing_on_bare_metal/index#replacing-a-bare-metal-control-plane-node_ipi-install-expanding[Replacing a bare-metal control plane node]
