...
ifndef::openshift-rosa,openshift-dedicated,openshift-enterprise[]
 ...
 * link:https://docs.redhat.com/en/documentation/openshift_container_platform/4.15/html/hosted_control_planes/high-availability-for-hosted-control-planes#hosted-cluster-etcd-backup-restore-on-premise_hcp-backup-restore-on-premise[Backing up and restoring etcd on a hosted cluster in an on-premise environment]
 endif::[]
