...
blocking action. Backing up the cluster is done with a single invocation of the
backup script. Taking backups of all master nodes separately is not recomended.
