...
[id="run-once-duration-override-operator-release-notes-1-3-0"]
== {run-once-operator} 1.3.0

Issued: 9 July 2025
//Advisory link provided the day of the release.
The following advisory is available for the {run-once-operator} 1.3.0: (link:https://access.redhat.com/errata/RHSA-2024:TBD[RHSA-2024:TBD])

[id="run-once-duration-override-operator-1-3-0-bug-fixes"]
=== Bug fixes
