...
[role="_abstract"]
To run your application containers in {product-title}, you must use pods. Pods allow you to group tightly coupled containers together on a single host for shared networking and storage.
...
* xref:../../post_installation_configuration/node-tasks.adoc#post-install-huge-pages_post-install-node-tasks[Huge pages]
