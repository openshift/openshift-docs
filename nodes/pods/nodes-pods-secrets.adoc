...
* link:https://github.com/kubernetes/kubernetes/blob/v1.0.0/docs/design/identifiers.md[Identifiers and Names in Kubernetes (Kubernetes documentation)]

* link:https://access.redhat.com/articles/7058801[Long-lived service account API tokens in {product-title} (Red Hat Knowledgebase article)]
