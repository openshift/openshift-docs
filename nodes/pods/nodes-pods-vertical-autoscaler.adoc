...
* xref:../../nodes/pods/nodes-pods-vertical-autoscaler.html#nodes-pods-vertical-autoscaler-in-place_nodes-pods-vertical-autoscaler.adoc[About the in place or recreate mode]
