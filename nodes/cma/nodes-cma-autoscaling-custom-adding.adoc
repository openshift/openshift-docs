...
* xref:../../nodes/cma/nodes-cma-autoscaling-custom-trigger.adoc#nodes-cma-autoscaling-custom-overview-trigger[Understanding custom metrics autoscaler triggers]
