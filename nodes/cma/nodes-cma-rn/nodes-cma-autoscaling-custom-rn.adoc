...
[id="nodes-pods-autoscaling-custom-rn-2151-TBD_{context}"]
== Custom Metrics Autoscaler Operator 2.15.1-TDB release notes

This release of the Custom Metrics Autoscaler Operator 2.15.1-TDB provides a CVE and a bug fix for running the Operator in an {product-title} cluster. The following advisory is available for the link:https://access.redhat.com/errata/RHSA-2024:7348[RHSA-2024:7348].
...
[id="nodes-pods-autoscaling-custom-rn-2151-TBD-new-features_{context}"]
=== New features and enhancements

CMA multi-arch builds
https://issues.redhat.com/browse/PODAUTO-210

[id="nodes-pods-autoscaling-custom-rn-2151-TBD-bugs_{context}"]
=== Bug fixes

* Previously,  (link:https://issues.redhat.com/browse/OCPBUGS-37989[*OCPBUGS-37989*])
