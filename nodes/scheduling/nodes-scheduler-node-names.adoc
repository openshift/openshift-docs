...
[id="nodes-scheduler-node-names-{context}"]
...
For information about changing node labels, see xref:../../nodes/nodes/nodes-nodes-working.html#nodes-nodes-working-updating-nodes-nodes-working[Understanding how to update labels on nodes].
