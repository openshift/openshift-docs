...
[id="descheduler-operator-release-notes-5.2.1"]
== Release notes for {descheduler-operator} 5.2.1

Issued: 4 December 2025

The following advisory is available for the {descheduler-operator} 5.2.1:

* link:https://access.redhat.com/errata/RHBA-2025:22736[RHBA-2025:22736]

[id="descheduler-operator-5.2.1-new-features"]
