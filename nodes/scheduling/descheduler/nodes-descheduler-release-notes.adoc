...
// Release notes for Kube Descheduler Operator 5.0.6
include::modules/nodes-descheduler-rn-5.0.6.adoc[leveloffset=+1]

// Release notes for Kube Descheduler Operator 5.0.5
include::modules/nodes-descheduler-rn-5.0.5.adoc[leveloffset=+1]
...
[id="descheduler-operator-5.0.3-notable-changes"]
