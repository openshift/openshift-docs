...
// Release notes for Kube Descheduler Operator 5.1.6
include::modules/nodes-descheduler-rn-5.1.6.adoc[leveloffset=+1]

// Release notes for Kube Descheduler Operator 5.1.5
include::modules/nodes-descheduler-rn-5.1.5.adoc[leveloffset=+1]
