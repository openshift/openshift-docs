...
// Release notes for Kube Descheduler Operator 5.0.3
include::modules/nodes-descheduler-rn-5.0.3.adoc[leveloffset=+1]

// Release notes for Kube Descheduler Operator 5.0.2
include::modules/nodes-descheduler-rn-5.0.2.adoc[leveloffset=+1]

// Release notes for Kube Descheduler Operator 5.0.1
include::modules/nodes-descheduler-rn-5.0.1.adoc[leveloffset=+1]

// Release notes for Kube Descheduler Operator 5.0.0
include::modules/nodes-descheduler-rn-5.0.0.adoc[leveloffset=+1]
