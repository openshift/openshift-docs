...
include::modules/nodes-descheduler-rn-5.3.4.adoc[leveloffset=+1]

// Release notes for Kube Descheduler Operator 5.3.3
include::modules/nodes-descheduler-rn-5.3.3.adoc[leveloffset=+1]
...
include::modules/nodes-descheduler-rn-5.2.3.adoc[leveloffset=+1]

// Release notes for Kube Descheduler Operator 5.2.2
include::modules/nodes-descheduler-rn-5.2.2.adoc[leveloffset=+1]

// Release notes for Kube Descheduler Operator 5.2.1
include::modules/nodes-descheduler-rn-5.2.1.adoc[leveloffset=+1]
