...
* link:https://access.redhat.com/errata/RHEA-2024:6341[RHEA-2024:6341]
...
* For the `CompactAndScale` profile, you can use the Technology Preview field `devHighNodeUtilizationThresholds` to adjust the the underutilized threshold value.
