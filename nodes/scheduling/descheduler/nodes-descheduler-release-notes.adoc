...
* link:https://access.redhat.com/errata/RHEA-2024:TODO[RHEA-2024:TODO]

[id="descheduler-operator-5.1.2-new-features"]
=== New features and enhancements

* This release of the {descheduler-operator} adds a new Technology Preview descheduler profile called `RelieveAndMigrate`. This profile is only available for use with {VirtProductName}.
+
