...
= Controlling pod placement on nodes using affinity rules in {product-title}
...
In {product-title}_node affinity_ is a set of rules used by the scheduler to determine where a pod can be placed. 
