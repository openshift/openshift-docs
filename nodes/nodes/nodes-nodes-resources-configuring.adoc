...
include::modules/nodes-nodes-resources-adding-storage.adoc[leveloffset=+1]
...
* xref:../../installing/installing_bare_metal/installing-bare-metal.adoc#installation-user-infra-machines-advanced_vardisk_installing-bare-metal[Creating a separate /var partition]
