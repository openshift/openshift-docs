...
* link:https://access.redhat.com/solutions/5504291[How to retrieve Master or Worker Ignition Configuration from OpenShift Container Platform 4?] (Red{nbsp}Hat KCS article)
