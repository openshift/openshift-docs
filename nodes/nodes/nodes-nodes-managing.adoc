...
= Managing nodes
include::_attributes/common-attributes.adoc[]nodes-nodes-managing.adoc
...
// Created new assembly for these. Delete with team thumbs-up
...
// include::modules/mco-update-boot-images-configuring.adoc[leveloffset=+2]
