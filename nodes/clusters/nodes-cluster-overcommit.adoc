...
xref:../../applications/deployments/managing-deployment-processes.adoc#deployments-triggers_deployment-operations[project memory and CPU limits and defaults], you can adjust the resource limit and request to achieve the desired level of overcommit.
