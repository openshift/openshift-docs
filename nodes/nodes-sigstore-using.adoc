...
You can use the link:https://www.sigstore.dev/[sigstore project] with {product-title} to improve supply chain security.
...
xref:../nodes/nodes-sigstore-using.adoc#nodes-sigstore-configure-parameters_nodes-sigstore-using[About image policy parameters]
