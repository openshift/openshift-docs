...
* xref:../../nodes/rosa-machinepools-nodes/rosa-nodes-machinepools-about.adoc#rosa-nodes-machinepools-about[About machinepools]
ifdef::openshift-rosa[]
* xref:../../nodes/rosa-machinepools-nodes/rosa-managing-worker-nodes.adoc#rosa-managing-worker-nodes[Managing worker nodes]
