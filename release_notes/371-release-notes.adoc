...
*Release date:* Version 3.71.0: 25 July 2022 +
*Updated:* 30 August 2022 +
*Release date:* Version 3.71.1: 5 October 2023
...
- systemd-resolved: use-after-free when dealing with DnsStream in resolved-dns-stream.c link:https://access.redhat.com/security/cve/cve-2022-2526[(*CVE-2022-2526*)]

- rsync: remote arbitrary files write inside the directories of connecting peers link:https://access.redhat.com/security/cve/cve-2022-29154[(*CVE-2022-29154*)]
