...
** link:https://access.redhat.com/security/cve/CVE-2023-3899[CVE-2023-3899]: Fixed by addressing JavaScript white-space character handling issue in Golang, ensuring proper cleanup of templates.
...
a| `registry.redhat.io/advanced-cluster-security/rhacs-main-rhel8:4.0.4`

| Scanner
| Scans images and nodes.
a|`registry.redhat.io/advanced-cluster-security/rhacs-scanner-rhel8:4.0.4`

| Scanner DB
| Stores image scan results and vulnerability definitions.
a|`registry.redhat.io/advanced-cluster-security/rhacs-scanner-db-rhel8:4.0.4`

| Collector
| Collects runtime activity in Kubernetes or {ocp} clusters.
a| * `registry.redhat.io/advanced-cluster-security/rhacs-collector-rhel8:4.0.4`
* `registry.redhat.io/advanced-cluster-security/rhacs-collector-slim-rhel8:4.0.4`
|===
