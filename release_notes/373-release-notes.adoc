...
[id="resolved-in-version-3734"]
=== Resolved in version 3.73.4
...
[id="resolved-in-version-3735"]
=== Resolved in version 3.73.5

Release date: 31 May 2023

* This release of {product-title-short} includes a fix for link:https://access.redhat.com/security/cve/cve-2023-24540[CVE-2023-24540] by building {product-title-short} with updated Golang.
