...
* The certificate expiry checker has been backported to the {product-title} 3.3 playbooks. (link:https://bugzilla.redhat.com/show_bug.cgi?id=1417682[*BZ#1417682*])
