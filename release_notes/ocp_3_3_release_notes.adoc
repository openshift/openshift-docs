...
To apply the {product-title} 3.3.0.34 update to an existing {product-title} 3.3
cluster, use the automated upgrade playbook. See
xref:../install_config/upgrading/automated_upgrades.adoc#upgrading-to-ocp-3-3-asynchronous-releases[Upgrading to {product-title} 3.3 Asynchronous Releases] for instructions.

[IMPORTANT]
====
If you have previously deployed aggregated logging or cluster metrics, ensure
that you also follow the related instructions in
xref:../install_config/upgrading/automated_upgrades.adoc#upgrading-to-ocp-3-3-asynchronous-releases[Upgrading to {product-title} 3.3 Asynchronous Releases].
====

If you are upgrading from {product-title} 3.2, you can use the same upgrade
playbook as described in the
xref:../install_config/upgrading/automated_upgrades.adoc#upgrading-to-ocp-3-3[Upgrading to {product-title} 3.3] automated cluster upgrade steps to upgrade all the
way to the latest {product-title} 3.3 asynchronous release at once.
