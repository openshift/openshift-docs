...
For more information on how to access these certificates, see xref:../post_installation_configuration/machine-configuration-tasks.adoc#checking-mco-status-certs[Viewing and interacting with certificates].
