...
{product-title} {product-version} is supported on {op-system-base-full} 8.6 and any subsequent version of {op-system-base-full} 8 which is released before End of Life of {product-title} {product-version} as well as on {op-system-first} 4.14.
