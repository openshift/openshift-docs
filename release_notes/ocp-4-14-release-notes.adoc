...
Starting with {product-title} {product-version}, Extended Update Support (EUS) is extended to 64-bit ARM, {ibm-power-title} (ppc64le), and {ibm-z-title} (s390x) platforms.  For more information, see the link:https://access.redhat.com/support/policy/updates/openshift-eus[OpenShift EUS Overview].
...
With this release, {ibm-z-name} and {ibm-linuxone-title} are now compatible with {product-title} {product-version}. The installation can be performed with z/VM or {op-system-base-full} Kernel-based Virtual Machine (KVM). For installation instructions, see the following documentation:

* xref:../installing/installing_ibm_z/installing-ibm-z.adoc#installing-ibm-z[Installing a cluster with z/VM on {ibm-z-name} and {ibm-linuxone-title}]
* xref:../installing/installing_ibm_z/installing-restricted-networks-ibm-z.adoc#installing-restricted-networks-ibm-z[Installing a cluster with z/VM on {ibm-z-name} and {ibm-linuxone-title} in a restricted network]
* xref:../installing/installing_ibm_z/installing-ibm-z-kvm.adoc#installing-ibm-z-kvm[Installing a cluster with {op-system-base} KVM on {ibm-z-name} and {ibm-linuxone-title}]
* xref:../installing/installing_ibm_z/installing-restricted-networks-ibm-z-kvm.adoc#installing-restricted-networks-ibm-z-kvm[Installing a cluster with RHEL KVM on {ibm-z-name} and {ibm-linuxone-title} in a restricted network]
...
[discrete]
==== {ibm-z-name} and {ibm-linuxone-title} notable enhancements
...
The {ibm-z-name} and {ibm-linuxone-title} release on {product-title} {product-version} adds improvements and new capabilities to {product-title} components and concepts.

This release introduces support for the following features on {ibm-z-name} and {ibm-linuxone-title}:
...
{product-title} now supports configuring {op-system-first} nodes for IBM Secure Execution on {ibm-z-name} and {ibm-linuxone-title} (s390x architecture).
...
* xref:../installing/installing_ibm_power/installing-ibm-power.adoc#installing-ibm-power_installing-ibm-power[Installing a cluster on {ibm-power-title}]
* xref:../installing/installing_ibm_power/installing-restricted-networks-ibm-power.adoc#installing-restricted-networks-ibm-power_installing-restricted-networks-ibm-power[Installing a cluster on {ibm-power-title} in a restricted network]
...
[discrete]
==== {ibm-power-name} notable enhancements
...
* {ibm-power-title} Virtual Server Block CSI Driver Operator (Technology Preview)
* Installing on a single node
//* Hosted control planes (Technology Preview)
* Multi-architecture compute nodes
* oc-mirror plugin
...
[discrete]
=== {ibm-power-name}, {ibm-z-name}, and {ibm-linuxone-title} support matrix

.{product-title} features
[cols="3,1,1",options="header"]
|====
|Feature |{ibm-power-name} |{ibm-z-name} and {ibm-linuxone-title}
...
|Installer-provisioned Infrastructure Enablement for {ibm-power-title} Virtual Server (Technology Preview)
|Supported
|Unsupported
...
|====
|Feature |{ibm-power-title} |{ibm-z-title} and {ibm-linuxone-title}
...
|{ibm-power-title} AC922 (`ppc64le`)
|Deprecated
|Removed
|Removed

|{ibm-power-title} IC922 (`ppc64le`)
|Deprecated
|Removed
|Removed

|{ibm-power-title} LC922 (`ppc64le`)
|Deprecated
|Removed
|Removed
...
|{ibm-linuxone-title} Emperor (`s390x`)
|Deprecated
|Removed
|Removed

|{ibm-linuxone-title} Rockhopper (`s390x`)
|Deprecated
|Removed
|Removed
...
|{ibm-power-title} Virtual Server Block CSI Driver Operator
|Not Available
|Technology Preview
|Technology Preview
...
|IBM Secure Execution on {ibm-z-title} and {ibm-linuxone-title}
|Technology Preview
|General Availability
|General Availability

|{ibm-power-title} Virtual Server using installer-provisioned infrastructure
|Not Available
|Technology Preview
|Technology Preview
