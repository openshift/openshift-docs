...
==== Deprectaion of fields in SiteConfig
With this update, the `apiVIP` and `ingressVIP` fields in the `SiteConfig` CRD are deprecated in favor of the plural versions `apiVIPs` and `ingressVIPs`.
