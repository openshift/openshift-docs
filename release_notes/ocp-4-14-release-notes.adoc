...
Previously, container image references that have both tag and digest were not correctly interpreted by oc-mirror and resulted in an error message like the one below:
...
This behavior has been fixed and such references are now accepted and correctly mirrored. 
