...
For more information, see xref:../networking/ingress-operator.adoc#nw-configure-ingress-access-logging_configuring-ingress[Allowing IngressController to modify the HAProxy log length when using a sidecar].
