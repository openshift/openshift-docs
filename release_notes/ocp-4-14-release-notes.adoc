...
In previous releases, the monitoring and updating of node networking were achieved through the utilization of the NodeNetworkConfigurationPolicy object by using the CLI. With this release, you can now administrate the `NodeNetworkConfigurationPolicy` directly from the web console. This page enables you to xrefcreate, xrefupdate, xrefview, and xrefdelete the policies by using either a user-friendly form or with YAML updates.
