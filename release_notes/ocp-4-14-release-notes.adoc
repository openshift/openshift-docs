...
For clusters upgrading to OpenShift 4.14, IP forwarding configuration will remain untouched to avoid disruption of existing workloads. You can disable global IP forwarding if you do not need to harden security. (link:https://issues.redhat.com/browse/OCPBUGS-16051[*OCPBUGS-16051*])
