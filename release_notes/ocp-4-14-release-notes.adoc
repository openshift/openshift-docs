...
[id="ocp-4-14-openshift-default-registry-deprecated"]
=== OpenShift Default Registry is now deprecated

As of {product-title} 4.14, the OpenShift Default Registry is deprecated. 
