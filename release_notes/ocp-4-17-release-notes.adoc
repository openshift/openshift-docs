...
== Installing a cluster on {aws-first} with compute nodes on AWS Outposts is deprecated

With this release, installing a cluster on {aws-short} with compute nodes on {aws-short} Outposts is deprecated. Support for this feature will be removed in a future release.
