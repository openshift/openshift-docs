...
* Detects pods and namespaces that use the link:https://access.redhat.com/articles/7065170[deprecated OpenShiftSDN CNI plugin] and generates a recommendation for the possible actions you should take depending on the data collected from your deployment.
