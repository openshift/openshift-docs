...
#To view bug fixes for {hcp} on {product-title} 4.17, see xref:../hosted_control_planes/hosted-control-planes-release-notes.adoc#hcp-rn-4-17[Release notes for {hcp} on {product-title} 4.17].
...
[NOTE]
====
#To know the status of the {hcp} features on {product-title} 4.17, see xref:../hosted_control_planes/hosted-control-planes-release-notes.adoc#hcp-tech-preview-features[Generally Available and Technology Preview features] in {hcp} release notes.
====
