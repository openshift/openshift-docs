...
This feature is available as a Technology Preview. For more information about using dual-port NICs to improve redundancy for PTP ordinary clocks, see xref:../networking/advanced_networking/ptp/about-ptp.adoc#ptp-dual-ports-oc_about-ptp[Using dual-port NICs to improve redundancy for PTP ordinary clocks].
