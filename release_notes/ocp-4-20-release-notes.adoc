...
* Currently, the SuperMicro ARS-111GL-NHR server is unable to access virtual media during boot when the virtual media image is served via an IPv6 address. In consequence, users cannot utilize virtual media functionality on this specific server model under these network conditions. (link:https://issues.redhat.com/browse/OCPBUGS-60070[*OCPBUGS-60070*])
