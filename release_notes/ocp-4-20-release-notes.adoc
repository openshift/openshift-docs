...
// For more information, see xref:../networking/advanced_networking/ptp/configuring-ptp.adoc#cnf-configuring-log-reduction-for-linuxptp_configuring-ptp[Configuring enhanced PTP logging].
>>>>>>> d366d14590 (TELCODOCS-2271-RN RN for PTP enhanced logging 1)
