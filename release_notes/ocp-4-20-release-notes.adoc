...
[id="ocp-4-20-support-log-gather_{context}"]
==== Gathering cluster data using {support-log-gather}

The new Operator, {support-log-gather}, simplifies the collection of debugging data, including service logs and resource definitions, by creating a `.tar` package and uploading it to a Red{nbsp}Hat support case. For more information, see.
