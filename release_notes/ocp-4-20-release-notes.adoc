...
==== Support for {vmw-full} Foundation 9.0 and VMware Cloud Foundation 9.0

With this release, you can install an {product-title} cluster on {vmw-full} Foundation 9.0 and VMware Cloud Foundation (VCF) 9.0.
