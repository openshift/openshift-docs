...
With this release, the PTP Operator now supports enhanced log reduction. This feature lets you receive a periodic summary of filtered logs, and you can optionally configure the summary interval and a threshold for master offset logs.
