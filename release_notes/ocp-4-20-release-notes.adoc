...
==== Installing a cluster on {gcp-full} into a shared VPC specifying a DNS zone in a third project

With this release, you can specify the location of a DNS zone when installing a cluster on {gcp-short} into a shared VPC. The DNS zone can be located in a second service project that is distinct from the host project or main service project.
