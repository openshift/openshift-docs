...
{product-title} (link:https://access.redhat.com/errata/RHSA-202X:XXXX[RHSA-2024:11038]) is now available. This release uses link:https://github.com/kubernetes/kubernetes/blob/master/CHANGELOG/CHANGELOG-1.32.md[Kubernetes 1.32] with CRI-O runtime. New features, changes, and known issues that pertain to {product-title} {product-version} are included in this topic.
...
[id="ocp-4-20-edge-computing_pg-ztp-rhacm_{context}"]
...
[id="ocp-4-20-edge-computing-coordinating-reboots_{context}"]
...
[id="ocp-4-20-installation-and-update-remove-terraform-ibm-cloud_{context}"]
...
[id="ocp-4-20-installation-and-update-aws-malaysia-thailand_{context}"]
...
[id="ocp-4-20-installation-and-update-remove-terraform-azure-stack-hub_{context}"]
...
[id="ocp-4-20-installation-and-update-support-azure-instance-types_{context}"]
...
[id="ocp-4-20-installation-and-update-azure-outbound-access-vms_{context}"]
...
[id="ocp-4-20-installation-and-update-gcp-confidential-computing-expansion_{context}"]
...
[id="ocp-4-20-GCP-custom-dns_{context}"]
...
[id="ocp-4-20-installation-and-update-vsphere-multidisk_{context}"]
...
[id="ocp-4-20-installation-and-update-azure-boot-diagnostics_{context}"]
...
{product-title} 4.20 uses Kubernetes 1.32, which removed several xref:../release_notes/ocp-4-19-release-notes.adoc#ocp-4-19-removed-kube-1-32-apis_{context}[deprecated APIs].
...
[id="ocp-4-20-vsphere-host-groups_{context}"]
...
[id="ocp-4-20-capi-mapi-migration_{context}"]
...
[id="ocp-4-20-cpms-prefix_{context}"]
...
[id="ocp-4-20-aws-capacity-reservations_{context}"]
...
[id="ocp-4-20-vmw-multi-disk_{context}"]
...
[id="ocp-4-20-monitoring-prometheus-v3-upgrade"]
...
[id="ocp-4-20-monitoring-metrics-collection-profiles-ga"]
...
[id="ocp-4-20-monitoring-added-cluster-proxy-support-for-external-alertmanager-instances"]
...
[id="ocp-4-20-monitoring-strict-validation-for-cmo-is-improved"]
...
[id="ocp-4-20-networking-support-load-secrets_{context}"]
...
[id="ocp-4-20-networking-gateway-api-controller_{context}"]
...
[id="ocp-4-20-networking-gateway-api-crd-lifecycle_{context}"]
...
[id="ocp-4-20-networking-balance-slb-mode_{context}"]
...
[id="ocp-4-20-networking-allocate-load-balancers-to-specific-subnets_{context}"]
...
For more information, see xref:../installing/installing_aws/installation-config-parameters-aws.adoc#installation-configuration-parameters-network_installation-config-parameters-aws[Installation configuration parameters on AWS] and xref:../networking/configuring_ingress_cluster_traffic/allocating-load-balancers.adoc#allocating-load-balancers[Allocating load balancers to specific subnets].

[id="ocp-4-20-networking-ptp-dual-oc_{context}"]
...
[id="ocp-4-20-networking-conditional-webhook_{context}"]
...
[id="ocp-4-20-dpu-device-management-with-dpu-operator_{context}"]
...
[id="ocp-4-20-cluster-user-defined-networks-localnet_{context}"]
...
[id="ocp-4-20-port-isolation-linux-bridge_{context}"]
...
[id="ocp-4-20-whereabouts-ipam_{context}"]
...
[id="ocp-4-20-metallb-unnumbered-bgp-peering_{context}"]
...
[id="ocp-4-20-custom-dns-host-name-disconnected_{context}"]
...
[id="ocp-4-20-ptp-fast-events-rest-api-v2_{context}"]
...
[id="ocp-4-20-sr-iov-arm_{context}"]
...
[id="ocp-4-20-route-external-cert-feature-gate_{context}"]
...
[id="ocp-4-20-rhcos-rhel-9-6_{context}"]
...
{product-title} 4.20 introduces a new command to view persistent volume claim usage. This feature has Technology Preview status.
...
[id="ocp-4-20-notable-technical-changes_{context}"]
== Notable technical changes

[discrete]
[id="ocp-4-20-notable-technical-changes-readonlyrootfilesystem_{context}"]
...
[discrete]
[id="ocp-4-20-notable-technical-changes-loopback-cert_{context}"]
...
[id="ocp-4-20-deprecated-removed-features_{context}"]
...
[id="ocp-4-20-oc-adm-pod-network-removed_{context}"]
...
[id="ocp-4-20-useModal-dynamic-plugin-removed_{context}"]
==== useModal hook for dynamic plugin SDK
...
[id="ocp-4-20-removed-features_{context}"]
=== Removed features

[id="ocp-4-20-rhel-worker-nodes-removed_{context}"]
==== Package-based {op-system-base} compute machines
...
For information on how to identify and remove {op-system-base} nodes in your cluster, see xref:../updating/preparing_for_updates/updating-cluster-prepare-past-4-20.adoc#updating-cluster-prepare-past-4-18[Preparing to update from {product-title} 4.18 to a newer version]. For more information on image layering, see xref:../machine_configuration/mco-coreos-layering.adoc#mco-coreos-layering[{op-system} image layering].

[id="ocp-4-20-removed-kube-1-32-apis_{context}"]
...
[id="ocp-4-20-removed-osdk_{context}"]
...
[id="ocp-4-20-bug-fixes_{context}"]
== Bug fixes
...
[id="ocp-4-20-known-issues_{context}"]
== Known issues
...
[id="ocp-storage-core-4-20-known-issues_{context}"]
...
[id="ocp-4-20-asynchronous-errata-updates_{context}"]
