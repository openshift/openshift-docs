...
To enhance usability and provide both Security Token Service (STS) and non-STS support, the Amazon Web Serivces (AWS) Elastic File Service (EFS) cross account support procedure has been revised.
