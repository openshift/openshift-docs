...
This enhancement allows the NUMA Resources Operator to ensure that your NUMA-aware pods are scheduled on a node with the best NUMA topology, regardless of whether it's a worker or control plane node. 
