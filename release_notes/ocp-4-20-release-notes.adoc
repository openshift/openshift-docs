...
For more information, see xref:../networking/advanced_routing/route_advertisements/about-route-advertisements.adoc#about-route-advertisements[About route advertisements].
