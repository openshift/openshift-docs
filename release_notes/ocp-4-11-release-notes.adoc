...
* Enabling the pre-caching feature of {cgu-operator-full} blocks the `ClusterGroupUpgrades` custom resource (CR). As a workaround, do not enable the pre-caching feature. (link:https://issues.redhat.com/browse/OCPBUGS-1772[*OCPBUGS-1772*])
