...
* When deploying a Bare Metal machine on {rh-openstack}, customers must set the value of the `force_metadata` option to `False` in the Neutron DHCP agent configuration. (link:https://bugzilla.redhat.com/show_bug.cgi?id=2213862[*BZ2213862*])
