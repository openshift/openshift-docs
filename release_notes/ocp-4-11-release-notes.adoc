...
* Previously, the number of supported user defined tags was 8 and reserved {product-title} tags was 2 for AWS resources. With this release, the number of supported user defined tags is now 25 and reserved {product-title} tags is 25 for AWS resources  You can now add upto 25 user tags during installation.   
