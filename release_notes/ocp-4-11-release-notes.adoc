...
[id="ocp-4-11-networking-linuxptp"]
==== Dual NIC boundary clock and PTP events enhancements to linuxptp services
...
For more information, see xref:../networking/using-ptp.html#cnf-fast-event-notifications-api-refererence_using-ptp[Subscribing DU applications to PTP events REST API reference].
