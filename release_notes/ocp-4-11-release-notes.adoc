...
{product-title} release 4.11.20, which includes security updates, is now available. There is no IBM powerbuild for this release. The list of bug fixes that are included in the update is documented in the link:https://access.redhat.com/errata/RHSA-2022:8893[RHSA-2022:8893] advisory. The RPM packages that are included in the update are provided by the link:https://access.redhat.com/errata/RHBA-2022:8892[RHBA-2022:8892] advisory.
...
* Previously, the {product-title} used a hard-coded list to display regions in the installer survey, which resulted in several supported regions being excluded. With this update, all supported regions are included in the installer survey. (link:https://issues.redhat.com/browse/OCPBUGS-3023[*OCPBUGS-3023*])
...
To update an existing {product-title} 4.11 cluster to this latest release, see xref:../updating/updating-cluster-cli.adoc[Updating a cluster using the CLI] for instructions.
>>>>>>> cf7ad9bfc4 (OSDOCS-4669:adds zstream update)
