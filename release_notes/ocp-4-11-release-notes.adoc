...
* Previously, the ratio of user defined tags to the reserved {product-title} tags was 8:2. With this release, the new ratio is 25:25. You can now add upto 25 user tags during installation.      
