...
{product-title} {product-version} is supported on {op-system-base-full} 8.5—8.9, as well as on {op-system-first} 4.11.
...
You can use the oc-mirror {oc-first} plugin to mirror images in a disconnected environment. This feature was previously introduced as a Technology Preview in {product-title} 4.10 and is now generally available in {product-title} 4.11.
...
For more information, see xref:../web_console/dynamic-plugin/dynamic-plugin-overview.adoc#overview-of-dynamic-plugins[Overview of dynamic plugins].
...
Using {op-system-base-full} 9 with the {oc-first} is now supported.

[NOTE]
====
It is not supported to install the {oc-first} as an RPM for {op-system-base-full} 9. You must install the OpenShift CLI for {op-system-base} 9 by downloading the binary.
====
...
{product-title} 4.11 supports Operator SDK 1.22.2. See xref:../cli_reference/osdk/cli-osdk-install.adoc#cli-osdk-install[Installing the Operator SDK CLI] to install or update to this latest version.
...
|-
|GA
|xref:../release_notes/ocp-4-11-release-notes.adoc#ocp-4-11-1-pod-level-bonding-ga[GA]
...
[id="ocp-4-11-1-features"]
==== Features

[id="ocp-4-11-1-pod-level-bonding-ga"]
...
{product-title} release 4.11.26, which includes security updates, is now available. The list of bug fixes that are included in the update is documented in the link:https://access.redhat.com/errata/RHSA-2023:0565[RHSA-2023:0565] advisory. The RPM packages that are included in the update are provided by the link:https://access.redhat.com/errata/RHBA-2023:02564[RHBA-2023:0564] advisory.
...
[id="ocp-4-11-26-known-issues"]
==== Known issues

* This release regresses functionality where SR-IOV secondary network interfaces configured with static MAC address attached to pods might not provide full network connectivity. This issue only impacts SR-IOV virtual functions based on Intel Ethernet Network Adapter X710 products (i40e/iavf Linux kernel drivers). For more information, see link:https://issues.redhat.com/browse/OCPBUGS-5139[*OCPBUGS-5139*].

[id="ocp-4-11-26-bug-fixes"]
==== Bug fixes

* Previously, the `cluster-image-registry-operator` would default to using a persistent volume claim (PVC) when it failed to reach Swift. With this update, failure to connect to {rh-openstack-first} API or other incidental failures cause the `cluster-image-registry-operator` to retry the probe. During the retry, the default to PVC only occurs if the {rh-openstack} catalog is correctly found, and it does not contain object storage; or alternatively, if {rh-openstack} catalog is there and the current user does not have permission to list containers. (link:https://issues.redhat.com/browse/OCPBUGS-5578[*OCPBUGS-5578*])

* Previously due to a missing definition for `spec.provider`, the *Operator details* page failed when trying to show `ClusterServiceVersion`. With this update, the user interface works without `spec.provider` and the *Operator detail page* does not fail. (link:https://issues.redhat.com/browse/OCPBUGS-6689[*OCPBUGS-6689*])
...
{product-title} release 4.11.28, which includes security updates, is now available. The list of bug fixes that are included in the update is documented in the link:https://access.redhat.com/errata/RHSA-2023:0774[RHSA-2023:0774] advisory. The RPM packages that are included in the update are provided by the link:https://access.redhat.com/errata/RHBA-2023:0773[RHBA-2023:0773] advisory.
...
{product-title} release 4.11.31, which includes security updates, is now available. The list of bug fixes that are included in the update is documented in the link:https://access.redhat.com/errata/RHSA-2023:1158[RHSA-2023:1158] advisory. The RPM packages that are included in the update are provided by the link:https://access.redhat.com/errata/RHBA-2023:1157[RHBA-2023:1157] advisory.
...
{product-title} release 4.11.32, which includes security updates, is now available. The list of bug fixes that are included in the update is documented in the link:https://access.redhat.com/errata/RHBA-2023:1296[RHBA-2023:1296] advisory. The RPM packages that are included in the update are provided by the link:https://access.redhat.com/errata/RHBA-2023:1295[RHBA-2023:1295] advisory.
...
{product-title} release 4.11.33 is now available. The list of bug fixes that are included in the update is documented in the link:https://access.redhat.com/errata/RHBA-2023:1396[RHBA-2023:1396] advisory. The RPM packages that are included in the update are provided by the link:https://access.redhat.com/errata/RHBA-2023:1395[RHBA-2023:1395] advisory.
...
{product-title} release 4.11.34 is now available. The list of bug fixes that are included in the update is documented in the link:https://access.redhat.com/errata/RHSA-2023:1504[RHSA-2023:1504] advisory. The RPM packages that are included in the update are provided by the link:https://access.redhat.com/errata/RHSA-2023:1503[RHSA-2023:1503] advisory.
...
All {product-title} 4.11 users are advised that the only defect fixed in this release is limited to install time; therefore, there is no need to update previously installed clusters to this version.
...
{product-title} release 4.11.38 is now available. Bug fixes included in the update are listed in the link:https://access.redhat.com/errata/RHBA-2023:1863[RHBA-2023:1863] advisory. RPM packages included in the update are provided by the link:https://access.redhat.com/errata/RHBA-2023:1862[RHBA-2023:1862] advisory.
...
{product-title} release 4.11.41 is now available. Bug fixes included in the update are listed in the link:https://access.redhat.com/errata/RHBA-2023:3213[RHBA-2023:3213] advisory. RPM packages included in the update are provided by the link:https://access.redhat.com/errata/RHBA-2023:3212[RHBA-2023:3212] advisory.
...
{product-title} release 4.11.42 is now available. Bug fixes included in the update are listed in the link:https://access.redhat.com/errata/RHSA-2023:3309[RHSA-2023:3309] advisory. RPM packages included in the update are provided by the link:https://access.redhat.com/errata/RHBA-2023:3308[RHBA-2023:3308] advisory.
...
{product-title} release 4.11.44, which includes security updates, is now available. This update includes a Red Hat security bulletin for customers who run {product-title} in FIPS mode. For more information, see link:https://access.redhat.com/security/vulnerabilities/RHSB-2023-001[RHSB-2023:001].

Bug fixes included in the update are listed in the link:https://access.redhat.com/errata/RHSA-2023:3915[RHSA-2023:3915] advisory. RPM packages included in the update are provided by the link:https://access.redhat.com/errata/RHSA-2023:3914[RHSA-2023:3914] advisory.
...
{product-title} release 4.11.46, which includes security updates, is now available. Bug fixes included in the update are listed in the link:https://access.redhat.com/errata/RHSA-2023:4310[RHSA-2023:4310] advisory. RPM packages included in the update are provided by the link:https://access.redhat.com/errata/RHSA-2023:4312[RHSA-2023:4312] advisory.
...
[comment]
--
No 4.11.51 z-stream release as this release was skipped.
--

[id="ocp-4-11-52"]
=== RHSA-2023:5697 {product-title} 4.11.52 bug fix update and security update

Issued: 2023-10-18

{product-title} release 4.11.52, which includes security updates, is now available. Bug fixes included in the update are listed in the link:https://access.redhat.com/errata/RHSA-2023:5697[RHSA-2023:5697] advisory. RPM packages included in the update are provided by the link:https://access.redhat.com/errata/RHSA-2023:5717[RHSA-2023:5717] advisory.
...
[id="ocp-4-11-54"]
=== RHSA-2023:7479 {product-title} 4.11.54 bug fix update and security update

Issued: 2023-11-29

{product-title} release 4.11.54, which includes security updates, is now available. Bug fixes included in the update are listed in the link:https://access.redhat.com/errata/RHSA-2023:7479[RHSA-2023:7479] advisory. RPM packages included in the update are provided by the link:https://access.redhat.com/errata/RHSA-2023:7481[RHSA-2023:7481] advisory.
...
[id="ocp-4-11-54-features"]
==== Features

[id="ocp-4-11-54-APIserver-tracked-by-insights-operator"]
...
[id="ocp-4-11-54-bug-fixes"]
==== Bug fixes

* Previously, when users copied files between containers the timestamp was not preserved. With this release, the `-p` flag is added to preserve timestamps when copying files between containers. (link:https://issues.redhat.com/browse/OCPBUGS-23041[*OCPBUGS-23041*])

[id="ocp-4-11-54-upgrading"]
==== Updating

To update an existing {product-title} 4.11 cluster to this latest release, see xref:../updating/updating-cluster-cli.adoc#updating-cluster-cli[Updating a cluster using the CLI].

[id="ocp-4-11-55"]
=== RHSA-2023:7691 {product-title} 4.11.55 bug fix update and security update

Issued: 2023-12-14

{product-title} release 4.11.55, which includes security updates, is now available. Bug fixes included in the update are listed in the link:https://access.redhat.com/errata/RHSA-2023:7691[RHSA-2023:7691] advisory. RPM packages included in the update are provided by the link:https://access.redhat.com/errata/RHBA-2023:7693[RHBA-2023:7693] advisory.
...
[id="ocp-4-11-55-bug-fixes"]
==== Bug fixes

* Previously, upgrading to 4.12 on the OpenStack platform could fail if the master nodes were attached to additional networks. During the upgrade, both providers are active at the same time for a short period and can report different node IPs. This behavior is due to a known race condition when switching from an in-tree cloud provider to an external cloud provider. With this release, an annotation is added that causes both providers to report the same primary node IP, which prevents node IP flapping. (link:https://issues.redhat.com/browse/OCPBUGS-20122[*OCPBUGS-20122*])

[id="ocp-4-11-55-upgrading"]
==== Updating
...
[id="ocp-4-11-58"]
=== RHSA-2024:0682 {product-title} 4.11.58 bug fix update and security update

Issued: 2024-02-08

{product-title} release 4.11.58, which includes security updates, is now available. Bug fixes included in the update are listed in the link:https://access.redhat.com/errata/RHSA-2024:0682[RHSA-2024:0682] advisory. RPM packages included in the update are provided by the link:https://access.redhat.com/errata/RHSA-2024:0684[RHSA-2024:0684] advisory.
