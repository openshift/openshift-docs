...
* During ZTP cluster deployments on certain Lenovo models, for example the SE450, bare-metal host image provisioning might fail with the following HTTP error code:
+
[source,terminal]
----
