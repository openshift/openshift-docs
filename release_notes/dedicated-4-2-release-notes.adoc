...
To work with OperatorHub in {product-title} 4.2, cluster administrators
...
In {product-title} 4.2 the default global catalog namespace, where
...
If you have installed an Operator from OperatorHub on an {product-title} 4.2
