[[release-notes-osd-3-11-release-notes]]
...
[[osd-311-asynchronous-errata-updates]]
...
[[osd-3-11-RHBA-2018-3688-upgrading]]
==== Upgrading
...
With this release, xref:osd-311-kuryr[Kuryr] is now moved out of
xref:osd-311-technology-preview[Technology Preview] and now generally available.

[[osd-3-11-88-upgrading]]
==== Upgrading
