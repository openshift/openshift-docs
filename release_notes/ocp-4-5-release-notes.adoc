...
[id="ocp-4-5-restricted-network-upgrade"]
==== Updating a restricted network cluster

You can upgrade a cluster in a restricted network.

//For more information, see ../updating/updating-restricted-network-cluster.adoc#updating-restricted-network-cluster[Updating a restricted network cluster].
