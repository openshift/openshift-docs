...
{product-title} release 4.5.6 is now available. The list of container images and
bug fixes included in the update are documented in the
...
{product-title} release 4.5.7 is now available. The list of container images and
bug fixes included in the update are documented in the
...
{product-title} release 4.5.8 is now available. The list of container images and
bug fixes included in the update are documented in the
...
used by the CCO to process `CredentialRequests` in the cluster and create new
...
information about locating the permissions specified in the `CredentialRequests`
...
needed by the cluster. This could result in the BareMetalHost entering a state
of continuous flux where affected BareMetalHosts would be subject to longer
...
{product-title} release 4.5.9 is now available. The list of container images and
bug fixes included in the update are documented in the
...
{product-title} release 4.5.16 is now available. The list of container images and bug fixes included in the update are documented in the link:https://access.redhat.com/errata/RHBA-2020:4268[RHBA-2020:4268] advisory. The RPM packages included in the update are provided by the link:https://access.redhat.com/errata/RHBA-2020:4269[RHBA-2020:4269] advisory.
...
{product-title} release 4.5.17 is now available. The list of container images and bug fixes included in the update are documented in the link:https://access.redhat.com/errata/RHBA-2020:4325[RHBA-2020:4325] advisory. The RPM packages included in the update are provided by the link:https://access.redhat.com/errata/RHBA-2020:4326[RHBA-2020:4326] advisory.
...
{product-title} release 4.5.18 is now available. The list of container images and bug fixes included in the update are documented in the link:https://access.redhat.com/errata/RHBA-2020:4425[RHBA-2020:4425] advisory. The RPM packages included in the update are provided by the link:https://access.redhat.com/errata/RHBA-2020:4426[RHBA-2020:4426] advisory.
...
{product-title} release 4.5.19 is now available. The list of container images and bug fixes included in the update are documented in the link:https://access.redhat.com/errata/RHBA-2020:5051[RHBA-2020:5051] advisory. The RPM packages included in the update are provided by the link:https://access.redhat.com/errata/RHBA-2020:5052[RHBA-2020:5052] advisory.
...
{product-title} release 4.5.20, which includes a security update for `golang`, is now available. The list of container images and bug fixes included in the update are documented in the link:https://access.redhat.com/errata/RHSA-2020:5118[RHSA-2020:5118] advisory. The RPM packages included in the update are provided by the link:https://access.redhat.com/errata/RHSA-2020:5119[RHSA-2020:5119] advisory.
...
{product-title} release 4.5.21, which includes a security update for `openshift-enterprise-hyperkube`, is now available. The list of container images and bug fixes included in the update are documented in the link:https://access.redhat.com/errata/RHSA-2020:5194[RHSA-2020:5194] advisory. The RPM packages included in the update are provided by the link:https://access.redhat.com/errata/RHBA-2020:5193[RHBA-2020:5193] advisory.
