...
* The infrastructure logs that were previously in the *.opertions-* indices are now in the *infra-* indices. 
* The audit logs are stored in the *audit-* indices.

Because of the new data model, you must update your Kibana index patterns and visualizations to match the new indices.
