...
[id="ocp-4-5-vertical-pod-autoscaler"]
...
==== The terminationGracePeriod Parameter is now properly supported

The `terminationGracePeriodseconds` parameter now works with the CRI-O
container runtime.
