...
=== RHSA-2024:10147 - {product-title} {product-version}.24 bug fix
...
* Previously, HyperShift-based ROKS clusters were unable to authenticate through `oc login`. The web browser displayed an error when it attepted to retrieve the the token after selecting *Display Token*. with this release, `cloud.ibm.com` and other cloud-based endpoints are no longer proxied and authentication is successful. (link:https://issues.redhat.com/browse/OCPBUGS-44277[*OCPBUGS-44277*])
