...
Ingress capability is now a configurable cluster capability and is optional for Red{nbsp}Hat Hypershift. It is not configurable and always enabled for standalone {product-title}.
...
For more information, see xref:../networking/network_security/configuring-egress-firewall-ovn.adoc#nw-coredns-egress-firewall[Improved DNS resolution and resolving wildcard domain names].
