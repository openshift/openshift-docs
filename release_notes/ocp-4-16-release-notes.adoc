...
* In {hcp} for {product-title}, if you disable the xref:../installing/cluster-capabilities.adoc#ingress-operator_cluster-capabilities[Ingress capability], the Console Operator returns the following error message:
+
[source,text]
----
