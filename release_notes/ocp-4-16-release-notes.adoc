...
* If you plan to deploy the NUMA Resources Operator, avoid using OpenShift Container Platform versions 4.16.25 or 4.16.26. (link:https://issues.redhat.com/browse/OCPBUGS-45983[*OCPBUGS-45983*])
