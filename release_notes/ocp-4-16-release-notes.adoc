...
[id="ocp-4-16-installation-and-update-aws-malaysia_{context}"]
==== Installing a cluster on {aws-short} in the Malaysia region

You can now install an {product-title} cluster on {aws-short} in the Malaysia region (`ap-southeast-5`).

For more information, see xref:../installing/installing_aws/installing-aws-account.adoc#installation-aws-regions_installing-aws-account[Supported {aws-short} regions].
