...
[id="known-issue"]
== Known issue
When the same software package is installed in multiple layers in a docker image {product-title-short} might incorrectly identify the state of that package.
