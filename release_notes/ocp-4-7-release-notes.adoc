...
[id="ocp-4-7-59"]
=== RHSA-2022:6322 - {product-title} 4.7.59 bug fix and security update

Issued: 2022-09-13

{product-title} release 4.7.59 is now available. The bug fixes that are included in the update are listed in the link:https://access.redhat.com/errata/RHSA-2022:6322[RHSA-2022:6322] advisory. The RPM packages that are included in the update are provided by the link:https://access.redhat.com/errata/RHBA-2022:6321[RHBA-2022:6321] advisory.
...
[id="ocp-4-7-59-updating"]
==== Updating

To update an existing {product-title} 4.7 cluster to this latest release, see xref:../updating/updating-cluster-cli.adoc[Updating a cluster within a minor version by using the CLI] for instructions.

[id="ocp-4-7-60"]
=== RHBA-2022:7302 - {product-title} 4.7.60 bug fix update

Issued: 2022-11-10

{product-title} release 4.7.60 is now available. The bug fixes that are included in the update are listed in the link:https://access.redhat.com/errata/RHBA-2022:7302[RHBA-2022:7302] advisory. The RPM packages that are included in the update are provided by the link:https://access.redhat.com/errata/RHBA-2022:7301[RHBA-2022:7301] advisory.
