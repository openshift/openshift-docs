...
* Technology preview badges were displayed on the OSP GA installed cluster. The Technology preview badges are now removed. (link:https://bugzilla.redhat.com/show_bug.cgi?id=1945153[*BZ#1945153*])
