...
* After you have the Quay {rhq-cso} installed on your cluster:
...
See xref:../monitoring/monitoring-overview.adoc#monitoring-overview[Monitoring overview] for more information on monitoring user defined projects.
...
[id="ocp-4-7-1-updating"]
==== Updating

To update an existing {product-title} 4.7 cluster to this latest release, see xref:../updating/updating-cluster-cli.adoc#update-upgrading-cli_updating-cluster-cli[Updating a cluster using the CLI] for instructions.
...
[id="ocp-4-7-18-updating"]
==== Updating

To upgrade an existing {product-title} 4.7 cluster to this latest release, see xref:../updating/updating-cluster-cli.adoc#update-upgrading-cli_updating-cluster-cli[Updating a cluster using the CLI] for instructions.
...
[id="ocp-4-7-37-updating"]
==== Updating

To update an existing {product-title} 4.7 cluster to this latest release, see xref:../updating/updating-cluster-cli.adoc[Updating a cluster using the CLI] for instructions.

[id="ocp-4-7-38"]
=== RHBA-2021:4802 - {product-title} 4.7.38 bug fix and security update

Issued: 2021-12-01

{product-title} release 4.7.38, which includes security updates, is now available. The bug fixes that are included in the update are listed in the link:https://access.redhat.com/errata/RHBA-2021:4802[RHBA-2021:4802] advisory. The RPM packages that are included in the update are provided by the link:https://access.redhat.com/errata/RHSA-2021:4801[RHSA-2021:4801] advisory.
...
[id="ocp-4-7-38-updating"]
==== Updating

To update an existing {product-title} 4.7 cluster to this latest release, see xref:../updating/updating-cluster-cli.adoc[Updating a cluster using the CLI] for instructions.

[id="ocp-4-7-39"]
=== RHBA-2021:4885 - {product-title} 4.7.39 bug fix update

Issued: 2021-12-08

{product-title} release 4.7.39 is now available. The bug fixes that are included in the update are listed in the link:https://access.redhat.com/errata/RHBA-2021:4885[RHBA-2021:4885] advisory. The RPM packages that are included in the update are provided by the link:https://access.redhat.com/errata/RHBA-2021:4884[RHBA-2021:4884] advisory.

Space precluded documenting all of the container images for this release in the advisory. See the following article for notes on the container images in this release:

link:https://access.redhat.com/solutions/6564591[{product-title} 4.7.39 container image list]

[id="ocp-4-7-39-updating"]
==== Updating
...
[id="ocp-4-7-41-updating"]
==== Updating

To update an existing {product-title} 4.7 cluster to this latest release, see xref:../updating/updating-cluster-cli.adoc[Updating a cluster using the CLI] for instructions.

[id="ocp-4-7-42"]
=== RHSA-2022:0283 - {product-title} 4.7.42 bug fix and security update

Issued: 2022-02-02

{product-title} release 4.7.42, which includes security updates, is now available. The bug fixes that are included in the update are listed in the link:https://access.redhat.com/errata/RHSA-2022:0283[RHSA-2022:0283] advisory. The RPM packages that are included in the update are provided by the link:https://access.redhat.com/errata/RHBA-2022:0280[RHBA-2022:0280] advisory.

Space precluded documenting all of the container images for this release in the advisory. See the following article for notes on the container images in this release:

link:https://access.redhat.com/solutions/6683011[{product-title} 4.7.42 container image list]

[id="ocp-4-7-42-bug-fixes"]
==== Bug fixes

* Previously, the `ovnkube-node` and `-master` pods failed to start when the config file contained an unknown field or section. This caused failures on `ovn-kubernetes` updates. With this update, `ovn-kube` logs a warning in config files so `ovn-kube` updates do not fail if a config file contains an unknown field or section. (link:https://bugzilla.redhat.com/show_bug.cgi?id=2034506[*BZ#2034506*])

[id="ocp-4-7-42-updating"]
==== Updating
...
[id="ocp-4-7-48-upgrading"]
==== Upgrading

To update an existing {product-title} 4.7 cluster to this latest release, see xref:../updating/updating-cluster-cli.adoc[Updating a cluster using the CLI] for instructions.

[id="ocp-4-7-49"]
=== RHBA-2022:1337 - {product-title} 4.7.49 bug fix and security update

Issued: 2022-04-21

{product-title} release 4.7.49, which includes security updates, is now available. The bug fixes that are included in the update are listed in the link:https://access.redhat.com/errata/RHBA-2022:1337[RHBA-2022:1337] advisory. The RPM packages that are included in the update are provided by the link:https://access.redhat.com/errata/RHSA-2022:1336[RHSA-2022:1336] advisory.

Space precluded documenting all of the container images for this release in the advisory. See the following article for notes on the container images in this release:

link:https://access.redhat.com/solutions/6936721[{product-title} 4.7.49 container image list]

[id="ocp-4-7-49-upgrading"]
==== Upgrading

To update an existing {product-title} 4.7 cluster to this latest release, see xref:../updating/updating-cluster-cli.adoc[Updating a cluster using the CLI] for instructions.

[id="ocp-4-7-50"]
=== RHBA-2022:1698 - {product-title} 4.7.50 bug fix

Issued: 2022-05-12

{product-title} release 4.7.50 is now available. The bug fixes that are included in the update are listed in the link:https://access.redhat.com/errata/RHBA-2022:1698[RHBA-2022:1698] advisory. The RPM packages that are included in the update are provided by the link:https://access.redhat.com/errata/RHBA-2022:1697[RHBA-2022:1697] advisory.

Space precluded documenting all of the container images for this release in the advisory. See the following article for notes on the container images in this release:

link:https://access.redhat.com/solutions/6957908[{product-title} 4.7.50 container image list]

[id="ocp-4-7-50-upgrading"]
==== Upgrading

To update an existing {product-title} 4.7 cluster to this latest release, see xref:../updating/updating-cluster-cli.adoc[Updating a cluster using the CLI] for instructions.

[id="ocp-4-7-51"]
=== RHSA-2022:2268 - {product-title} 4.7.51 bug fix and security update

Issued: 2022-05-25

{product-title} release 4.7.51 is now available. The bug fixes that are included in the update are listed in the link:https://access.redhat.com/errata/RHSA-2022:2268[RHSA-2022:2268] advisory. The RPM packages that are included in the update are provided by the link:https://access.redhat.com/errata/RHBA-2022:2267[RHBA-2022:2267] advisory.

Space precluded documenting all of the container images for this release in the advisory. See the following article for notes on the container images in this release:

link:https://access.redhat.com/solutions/6959299[{product-title} 4.7.51 container image list]

[id="ocp-4-7-51-features"]
==== Features

[id="ocp-kubernetes-1-21-14-updates"]
===== Updates from Kubernetes 1.20.14

This update contains changes from Kubernetes 1.20.14 up to 1.20.15. More information can be found in the following changelog: link:https://github.com/kubernetes/kubernetes/blob/master/CHANGELOG/CHANGELOG-1.20.md#v12015[1.20.15].

[id="ocp-4-7-51-updating"]
==== Updating

To update an existing {product-title} 4.7 cluster to this latest release, see xref:../updating/updating-cluster-cli.adoc[Updating a cluster within a minor version by using the CLI] for instructions.

[id="ocp-4-7-52"]
=== RHBA-2022:4909 - {product-title} 4.7.52 bug fix and security update

Issued: 2022-06-10

{product-title} release 4.7.52 is now available. The bug fixes that are included in the update are listed in the link:https://access.redhat.com/errata/RHBA-2022:4910[RHBA-2022:4910] advisory. The RPM packages that are included in the update are provided by the link:https://access.redhat.com/errata/RHSA-2022:4909[RHSA-2022:4909] advisory.

Space precluded documenting all of the container images for this release in the advisory. See the following article for notes on the container images in this release:

link:https://access.redhat.com/solutions/6962609[{product-title} 4.7.52 container image list]

[id="ocp-4-7-52-updating"]
==== Updating

To update an existing {product-title} 4.7 cluster to this latest release, see xref:../updating/updating-cluster-cli.adoc[Updating a cluster within a minor version by using the CLI] for instructions.

[id="ocp-4-7-53"]
=== RHSA-2022:4965 - {product-title} 4.7.53 bug fix and security update

Issued: 2022-06-16

{product-title} release 4.7.53 is now available. The bug fixes that are included in the update are listed in the link:https://access.redhat.com/errata/RHSA-2022:4965[RHSA-2022:4965] advisory. The RPM packages that are included in the update are provided by the link:https://access.redhat.com/errata/RHSA-2022:4965[RHSA-2022:4965] advisory.

There are no images for {product-title} 4.7.53.

[id="ocp-4-7-53-bug-fixes"]
==== Bug fixes
...
[id="ocp-4-7-53-updating"]
==== Updating

To update an existing {product-title} 4.7 cluster to this latest release, see xref:../updating/updating-cluster-cli.adoc[Updating a cluster within a minor version by using the CLI] for instructions.

[id="ocp-4-7-54"]
=== RHBA-2022:5505 - {product-title} 4.7.54 bug fix

Issued: 2022-07-14

{product-title} release 4.7.54 is now available. The bug fixes that are included in the update are listed in the link:https://access.redhat.com/errata/RHBA-2022:5505[RHBA-2022:5505] advisory. The RPM packages that are included in the update are provided by the link:https://access.redhat.com/errata/RHBA-2022:5504[RHBA-2022:5504] advisory.

Space precluded documenting all of the container images for this release in the advisory. See the following article for notes on the container images in this release:

link:https://access.redhat.com/solutions/6967341[{product-title} 4.7.54 container image list]

[id="ocp-4-7-54-updating"]
==== Updating

To update an existing {product-title} 4.7 cluster to this latest release, see xref:../updating/updating-cluster-cli.adoc[Updating a cluster within a minor version by using the CLI] for instructions.

[id="ocp-4-7-55"]
=== RHBA-2022:5660 - {product-title} 4.7.55 bug fix

Issued: 2022-07-25

{product-title} release 4.7.55 is now available. The bug fixes that are included in the update are listed in the link:https://access.redhat.com/errata/RHBA-2022:5660[RHBA-2022:5660] advisory. There are no RPM packages for this release.

Space precluded documenting all of the container images for this release in the advisory. See the following article for notes on the container images in this release:

link:https://access.redhat.com/solutions/6969245[{product-title} 4.7.55 container image list]

[id="ocp-4-7-55-updating"]
==== Updating

To update an existing {product-title} 4.7 cluster to this latest release, see xref:../updating/updating-cluster-cli.adoc[Updating a cluster within a minor version by using the CLI] for instructions.

[id="ocp-4-7-56"]
=== RHSA-2022:6053 - {product-title} 4.7.56 bug fix and security update

Issued: 2022-08-22

{product-title} release 4.7.56 is now available. The bug fixes that are included in the update are listed in the link:https://access.redhat.com/errata/RHSA-2022:6053[RHSA-2022:6053] advisory. The RPM packages that are included in the update are provided by the link:https://access.redhat.com/errata/RHBA-2022:6052[RHBA-2022:6052] advisory.

Space precluded documenting all of the container images for this release in the advisory. See the following article for notes on the container images in this release:

link:https://access.redhat.com/solutions/6972374[{product-title} 4.7.56 container image list]

[id="ocp-4-7-56-updating"]
==== Updating
