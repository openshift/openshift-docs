...
The `EnsureCloudSecretPropagated` phase is skipped and logs a warning due to a
known docker bug. This issue is resolved in `docker-1.13.1-88` and later, as
described in link:https://access.redhat.com/solutions/3734981[(this KCS article)].
link:https://bugzilla.redhat.com/show_bug.cgi?id=1753356[(*BZ#1753356*)]
