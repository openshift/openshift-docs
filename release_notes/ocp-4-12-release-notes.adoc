...
[id="ocp-4-12-RCOS-deprecations"]
==== Machine Config Operator annotation and SSHAuthorized field are deprecated

The `machineconfiguration.openshift.io/ssh` annotation will no longer be supported.
