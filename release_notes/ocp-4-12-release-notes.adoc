...
To use application credentials with your cluster, as a {rh-openstack} administrator, create the credentials. Then, use them in a `clouds.yaml` file when you install a cluster, or create the `clouds.yaml` file and rotate it into an existing cluster.
