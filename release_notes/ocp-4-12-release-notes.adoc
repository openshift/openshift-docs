...
{product-title} {product-version} is supported on {op-system-base-full} 8.6 and a later version of {op-system-base} 8 that is released before End of Life (EoL) of {product-title} {product-version} 4.12.
