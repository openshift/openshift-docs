...
[id="ocp-4-12-about-this-release_{context}"]
== About this release
...
[id="ocp-4-12-add-on-support-status_{context}"]
...
[id="ocp-4-12-new-features-and-enhancements_{context}"]
== New features and enhancements

This release adds improvements related to the following components and concepts.

[id="ocp-4-12-rhcos_{context}"]
=== {op-system-first}

[id="ocp-4-12-default-graphical-console_{context}"]
...
[id="ocp-4-12-rhcos-rhel-8-6-packages_{context}"]
...
[id="ocp-4-12-installation-and-upgrade_{context}"]
=== Installation and upgrade

[id="nutanix-machine-api-post-installation-configuration_{context}"]
...
[id="ocp-4-12-aws-load-balancer-customization_{context}"]
...
[id="ocp-4-12-installation-and-upgrade-gcp-marketplace_{context}"]
...
[id="ocp-4-12-gcp-azure-serial-console-logs_{context}"]
...
For more information, see xref:../installing/validation_and_troubleshooting/installing-troubleshooting.adoc#installation-bootstrap-gather_installing-troubleshooting[Troubleshooting installation issues].

[id="ocp-4-12-ibm-cloud-vpc_{context}"]
...
[id="ocp-4-12-admin-ack-upgrading_{context}"]
...
[id="ocp-4-12-feature-set_{context}"]
...
[id="ocp-4-12-arm-on-azure_{context}"]
...
[id="ocp-4-12-oc-mirror-oci_{context}"]
...
[id="ocp-4-12-gcp-shared-vpc_{context}"]
...
[id="ocp-4-12-consistent-address-for-ironicapi_{context}"]
...
[id="ocp-4-12-gcp-service-account-installation_{context}"]
...
[id="ocp-4-12-aws-user-tag_{context}"]
...
[id="ocp-4-12-ironic-base-image-rhel-9_{context}"]
...
[id="ocp-4-12-openstack-external-cloud-control-upgrade_{context}"]
...
[id="ocp-4-12-install-shiftstack-deployments-on-dcn_{context}"]
...
[id="ocp-4-12-aws-outposts_{context}"]
...
[id="ocp-4-12-agent-based-install-fips_{context}"]
...
[id="ocp-4-12-agent-based-install-disconnected_{context}"]
...
[id="ocp-4-12-graph-true-field-disconnected_{context}"]
...
[id="ocp-4-12-agent-based-install-dual-stack_{context}"]
...
[id="ocp-4-12-agent-based-install-mce_{context}"]
...
[id="ocp-4-12-agent-based-install-validations_{context}"]
...
[id="ocp-4-12-agent-based-install-static-networking_{context}"]
...
[id="ocp-4-12-agent-based-install-automated-deployment_{context}"]
...
[id="ocp-4-12-agent-based-install-host-specific_{context}"]
...
[id="ocp-4-12-agent-based-install-dhcp_{context}"]
...
[id="ocp-4-12-nutanix-restricted-install_{context}"]
...
[id="ocp-4-12-post-installation_{context}"]
=== Post-installation configuration

[id="ocp-4-12-csi-driver-install-vsphere_{context}"]
...
[id="ocp-4-12-cluster-capabilities_{context}"]
...
[id="ocp-4-12-ocp-with-multi-arch-compute-machines_{context}"]
...
[id="ocp-4-12-web-console_{context}"]
=== Web console

[id="ocp-4-12-Administrator-perspective_{context}"]
...
[id="ocp-4-12-multi-arch-console_{context}"]
...
[id="ocp-4-12-dynamic-plug-in-updates_{context}"]
...
[id="ocp-4-12-developer-perspective_{context}"]
...
[id="ocp-4-12-helm-page-improvements_{context}"]
...
[id="ocp-4-12-negativematcher-alert_{context}"]
...
[id="ocp-4-12-oc_{context}"]
=== OpenShift CLI (oc)

[id="ocp-4-12-cli-krew_{context}"]
...
[id="ocp-4-12-ibm-power_{context}"]
=== IBM Power
...
[id="ocp-4-12-security_{context}"]
=== Security and compliance

[id="ocp-4-12-spo_{context}"]
...
[id="ocp-4-12-networking_{context}"]
=== Networking

[id="support-for-dual-stack-addressing-for-the-API-VIP-and-Ingress-VIP_{context}"]
...
[id="ocp-4-12-redhat-openshift-networking_{context}"]
...
[id="ocp-4-12-ovn-kubernetes-default-network-plug-in_{context}"]
...
[id="ocp-4-12-ingress-node-firewall-operator_{context}"]
...
[id="ocp-4-12-networking-metrics_{context}"]
...
[id="ocp-4-12-multi-zone-ipi-vsphere-installation_{context}"]
...
[id="ocp-4-12-k8s-nmstate-support-for-vsphere_{context}"]
...
[id="ocp-4-12-k8s-nmstate-support-for-openstack_{context}"]
...
[id="ocp-4-12-nw-external-dns-operator_{context}"]
...
[id="ocp-4-12-ingressclassname-ingressClassName-required_{context}"]
==== The ingressClassName field is required for each ingress object

Beginning with {product-title} 4.12, you must specify a class name in the `ingressClassName` field for each ingress object to ensure proper routing and functionality.

[id="ocp-4-12-nw-metrics-telemetry_{context}"]
...
[id="ocp-4-12-nw-aws-load-balancer-operator_{context}"]
...
[id="ocp-4-12-nw-ingress-autoscaling_{context}"]
...
[id="ocp-4-12-nw-ingress-haproxy-maxconn-default_{context}"]
...
[id="ocp-4-12-nw-configure-dns-management_{context}"]
...
[id="ocp-4-12-networking-supported-hardware-for-sr-iov_{context}"]
...
[id="ocp-4-12-networking-supported-hardware-for-ovs_{context}"]
...
[id="ocp-4-12-multi-network-policy-supported-for-sr-iov_{context}"]
...
[id="ocp-4-12-switch-aws-load-balancer_{context}"]
...
[id="ocp-4-12-ipv6-gratuitous-ARPs-default-SR-IOV_{context}"]
...
[id="ocp-4-12-coredns-cache-tuning_{context}"]
...
[id="ocp-4-12-ovn-kubernetes-supports-configuration-internal-subnet_{context}"]
...
[id="ocp-4-12-egress-ip-support_{context}"]
...
[id="ocp-4-12-openshift-sdn-ovn-kubernetes-feature-migration-support_{context}"]
...
[id="ocp-4-12-egress-firewall-audit-logging_{context}"]
...
[id="ocp-4-12-announce-IP-from-node-subset-metallb_{context}"]
...
[id="ocp-4-12-ne-metallb-deployment-specs_{context}"]
...
[id="ocp-4-12-ne-coredns-bump_{context}"]
...
[id="ocp-4-12-ne-reload-interval_{context}"]
...
For more information, see xref:../scalability_and_performance/optimization/routing-optimization.adoc#configuring-haproxy-interval_routing-optimization[Configuring HAProxy reload interval].

[id="ocp-412-nw-network-observability-updates_{context}"]
...
[id="ocp-4-12-nw-shiftstack-ipv6-secondary_{context}"]
...
For more information,see xref:../installing/installing_openstack/installing-openstack-network-config.adoc#nw-osp-pod-connections-ipv6_installing-openstack-network-config[Enabling IPv6 connectivity to pods on {rh-openstack}].

[id="ocp-4-12-nw-shiftstack-udp-load-balancing_{context}"]
...
[id="ocp-4-12-hcp-sr-iov-operator_{context}"]
...
[id="ocp-4-12-nw-api-ingress-ipv6-support_{context}"]
...
[id="ocp-4-12-bf2-switching-dpu-nic_{context}"]
...
[id="ocp-4-12-configure-hybrid-networking-post-install_{context}"]
...
[id="ocp-4-12-networking-networkapi_{context}"]
...
[id="ocp-4-12-storage_{context}"]
=== Storage

[id="ocp-4-12-storage-google-cloud-file-csi-driver_{context}"]
...
[id="ocp-4-12-storage-aws-ebs-auto-migration-ga_{context}"]
...
[id="ocp-4-12-storage-gce-auto-migration-ga_{context}"]
...
[id="ocp-4-12-storage-vsphere-auto-migration_{context}"]
...
[id="ocp-4-12-storage-capacity-tracking_{context}"]
...
[id="ocp-4-12-vsphere-topology-awareness_{context}"]
...
[id="ocp-4-12-local-ephemeral-storage-mgmt_{context}"]
...
[id="ocp-4-12-vol-populators_{context}"]
...
[id="ocp-4-12-vsphere-min-requirements_{context}"]
...
[id="ocp-4-12-storage-azure-file-nfs_{context}"]
...
[id="ocp-4-12-olm_{context}"]
=== Operator lifecycle

[id="ocp-4-12-platform-operators_{context}"]
...
[id="ocp-4-12-olm-operator-node-affinity_{context}"]
...
[id="ocp-4-12-olm-pod-security-label-synchronization_{context}"]
...
[id="ocp-4-12-osdk_{context}"]
=== Operator development

[id="ocp-4-12-osdk-security-context-config_{context}"]
...
[id="ocp-4-12-machine-api_{context}"]
=== Machine API

[id="ocp-4-12-mapi-control-plane-machine-sets_{context}"]
...
[id="ocp-4-12-mapi-autoscaler-verbosity_{context}"]
...
[id="ocp-4-12-azure-boot-diagnostics_{context}"]
...
[id="ocp-4-12-machine-config-operator_{context}"]
=== Machine Config Operator

[id="ocp-4-12-machine-config-operator-layering_{context}"]
...
[id="ocp-4-12-nodes_{context}"]
=== Nodes

[id="ocp-4-12-updating-interface-specific-list_{context}"]
...
[id="ocp-4-12-node-cron-job-time-zone_{context}"]
...
[id="ocp-4-12-node-cgroups-v2_{context}"]
...
[id="ocp-4-12-node-cgroups-crun_{context}"]
...
[id="ocp-4-12-self-node-remediation-operator_{context}"]
...
[id="ocp-4-12-node-health-check-operator_{context}"]
...
[id="ocp-4-12-monitoring_{context}"]
=== Monitoring

The monitoring stack for this release includes the following new and modified features.

[id="ocp-4-12-monitoring-updates-to-monitoring-stack-compnents-and-dependencies_{context}"]
...
[id="ocp-4-12-monitoring-changes-to-alerting-rule_{context}"]
...
[id="ocp-4-12-monitoring-new-option-to-specify-pod-topology-spread-constraints-for-monitoring-components_{context}"]
...
[id="ocp-4-12-monitoring-new-option-to-improve-data-consistency-for-prometheus-adapter_{context}"]
...
[id="ocp-4-12-monitoring-update-to-alertmanager-configuration-for-additional-secret-keys_{context}"]
...
[id="new-network-observability_{context}"]
...
[id="ocp-4-12-scalability-and-performance_{context}"]
=== Scalability and performance

[id="ocp-4-12-rsp-workload-hints_{context}"]
...
[id="ocp-4-12-low-latency-tuning-features-options_{context}"]
...
[id="tuning-of-power-states_{context}"]
...
[id="scalability-and-performance-sno-additional-worker-node_{context}"]
...
[id="scalability-and-performance-factory-precaching-tool_{context}"]
...
[id="scalability-and-performance-factory-precaching-tool-in-ztp_{context}"]
...
[id="ocp-4-12-hcp-node-tuning-operator_{context}"]
...
[id="ocp-4-12-hub-and-spoke_{context}"]
...
[id="scalability-and-performance-talm-updates_{context}"]
==== {cgu-operator-first}
...
[id="scalability-and-performance-mount-namespace_{context}"]
...
[id="ocp-4-12-ztp-sno-workload-partitioning_{context}"]
...
[id="ocp-4-12-ztp-hub-templates_{context}"]
...
[id="ocp-4-12-ztp-argocd-managed-cluster-limits_{context}"]
...
[id="ocp-4-12-ztp-config-policy-eval-intervals_{context}"]
...
[id="ocp-4-12-0-ironic-agent-image-ztp_{context}"]
...
[id="configuring-kernel-arguments-for-the-Discovery-ISO-by-using-GitOps-ZTP_{context}"]
...
[id="ocp-4-12-1-assisted-installer-api-mixed-arch-clusters_{context}"]
...
[id="ocp-4-12-ran-http-transport_{context}"]
...
[id="ocp-4-12-insights-operator_{context}"]
=== Insights Operator

[id="ocp-4-12-insights-alerts_{context}"]
==== Insights alerts
...
[id="ocp-4-12-insights-data-collection_{context}"]
...
[id="ocp-4-12-auth_{context}"]
=== Authentication and authorization

[id="ocp-4-12-rhosp-application-credentials_{context}"]
...
[id="ocp-4-12-hcp_{context}"]
=== Hosted control planes (Technology Preview)

[id="ocp-4-12-hcp-api_{context}"]
...
[id="ocp-4-12-hcp-versioning_{context}"]
...
The `HostedCluster` and `NodePool` API resources are available in the beta version of the API and follow a similar policy to xref:../rest_api/overview/understanding-api-support-tiers.adoc[{product-title}] and link:https://kubernetes.io/docs/concepts/overview/kubernetes-api/[Kubernetes].

[id="ocp-4-12-hcp-etcd-backup_{context}"]
...
[id="ocp-4-12-hcp-dr-in-aws-region_{context}"]
...
[id="ocp-4-12-notable-technical-changes_{context}"]
...
[discrete]
[id="ocp-4-12-auth-aws-sts-endpoints_{context}"]
...
[discrete]
[id="ocp-4-12-psa-restricted-enforcement_{context}"]
...
[discrete]
[id="ocp-4-12-olm-catalogs-and-psa-restricted-enforcement_{context}"]
...
[discrete]
[id="ocp-4-12-operator-sdk-1-25-z_{context}"]
...
[discrete]
[id="ocp-4-12-logical-volume-manager-storage_{context}"]
...
[discrete]
[id="ocp-4-12-openstack-platform-support_{context}"]
...
[id="ocp-4-12-deprecated-features_{context}"]
=== Deprecated features

[id="ocp-4-12-rhv-deprecations_{context}"]
...
[id="ocp-4-12-ne-deprecations_{context}"]
...
[id="ocp-4-12-z13-power8-x86v1-deprecations_{context}"]
...
[id="ocp-4-12-removed-features_{context}"]
=== Removed features
...
[id="ocp-4-12-empty-file-support-removed_{context}"]
...
[id="ocp-4-12-oc-rhel-7_{context}"]
...
[id="ocp-4-12-oc-commands-removed_{context}"]
...
[id="ocp-4-12-monitoring-grafana-component-removed_{context}"]
...
[id="ocp-4-12-monitoring-prometheus-and-grafana-uis-removed_{context}"]
...
[id="ocp-4-12-removed-features-virt-hw-v13_{context}"]
...
[id="ocp-4-12-removed-features-snapshot-v1beta1-api_{context}"]
...
[id="ocp-4-12-custom-scheduler_{context}"]
...
[id="ocp-4-12-openshiftsdn-sno-not-supported_{context}"]
...
[id="ocp-4-12-future-removals_{context}"]
...
[id="ocp-4-12-bug-fixes_{context}"]
== Bug fixes

[discrete]
[id="ocp-4-12-api-auth-bug-fixes_{context}"]
...
[discrete]
[id="ocp-4-12-bare-metal-hardware-bug-fixes_{context}"]
...
[discrete]
[id="ocp-4-12-builds-bug-fixes_{context}"]
==== Builds
...
[discrete]
[id="ocp-4-12-cloud-compute-bug-fixes_{context}"]
==== Cloud Compute
...
[discrete]
[id="ocp-4-12-dev-console-bug-fixes_{context}"]
==== Developer Console
...
[discrete]
[id="ocp-4-12-image-registry-bug-fixes_{context}"]
==== Image Registry
...
[discrete]
[id="ocp-4-12-installer-bug-fixes_{context}"]
==== Installer
...
[discrete]
[id="ocp-4-12-kube-controller-bug-fixes_{context}"]
...
[discrete]
[id="ocp-4-12-kube-scheduler-bug-fixes_{context}"]
...
[discrete]
[id="ocp-4-12-machine-config-operator-bug-fixes_{context}"]
==== Machine Config Operator
...
[discrete]
[id="ocp-4-12-management-console-bug-fixes_{context}"]
==== Management Console
...
[discrete]
[id="ocp-4-12-monitoring-bug-fixes_{context}"]
==== Monitoring
...
* Before this update, if Prometheus Operator failed to run or schedule Prometheus pods, the system provided no underlying reason for the failure. With this update, if Prometheus pods are not run or scheduled, the {cmo-full} updates the `clusterOperator` monitoring status with a reason for the failure, which can be used to troubleshoot the underlying issue. (link:https://bugzilla.redhat.com/show_bug.cgi?id=2043518[BZ#2043518])
...
* Previously, if you enabled an instance of Alertmanager dedicated to user-defined projects, a misconfiguration could occur in certain circumstances, and you would not be informed that the user-defined project Alertmanager config map settings did not load for either the main instance of Alertmanager or the instance dedicated to user-defined projects. With this release, if this misconfiguration occurs, the {cmo-full} now displays a message that informs you of the issue and provides resolution steps. (link:https://bugzilla.redhat.com/show_bug.cgi?id=2099939[BZ#2099939])

* Before this update, if the {cmo-first} failed to update Prometheus, the {cmo-short} did not verify whether a previous deployment was running and would report that cluster monitoring was unavailable even if one of the Prometheus pods was still running. With this update, the {cmo-short} now checks for running Prometheus pods in this situation and reports that cluster monitoring is unavailable only if no Prometheus pods are running. (link:https://bugzilla.redhat.com/show_bug.cgi?id=2039411[BZ#2039411])
...
[discrete]
[id="ocp-4-12-networking-bug-fixes_{context}"]
==== Networking
...
[discrete]
[id="ocp-4-12-node-bug-fixes_{context}"]
==== Node
...
[discrete]
[id="ocp-4-12-openshift-cli-bug-fixes_{context}"]
==== OpenShift CLI (oc)
...
[discrete]
[id="ocp-4-12-olm-bug-fixes_{context}"]
...
[discrete]
[id="ocp-4-12-openshift-operator-sdk-bug-fixes_{context}"]
==== Operator SDK
...
[discrete]
[id="ocp-4-12-file-integrity-operator-bug-fixes_{context}"]
==== File Integrity Operator
...
[discrete]
[id="ocp-4-12-compliance-operator-bug-fixes_{context}"]
==== Compliance Operator
...
[discrete]
[id="ocp-4-12-openshift-api-server-bug-fixes_{context}"]
...
[discrete]
[id="ocp-4-12-rhcos-bug-fixes_{context}"]
==== {op-system-first}
...
[discrete]
[id="ocp-4-12-scalability-and-performance-bug-fixes_{context}"]
==== Scalability and performance
...
[discrete]
[id="ocp-4-12-storage-bug-fixes_{context}"]
==== Storage
...
[discrete]
[id="ocp-4-12-web-console-developer-perspective-bug-fixes_{context}"]
...
[id="ocp-4-12-technology-preview_{context}"]
...
[id="ocp-4-12-asynchronous-errata-updates_{context}"]
...
[id="ocp-4-12-0-features_{context}"]
==== Features
...
[id="ocp-4-12-1-bug-fixes_{context}"]
==== Bug fixes
...
[id="ocp-4-12-1-updating_{context}"]
==== Updating
...
[id="ocp-4-12-2-updating_{context}"]
==== Updating

To update an existing {product-title} 4.12 cluster to this latest release, see xref:../updating/updating-cluster-cli.adoc#updating-cluster-cli[Updating a cluster using the CLI].

[id="ocp-4-12-3_{context}"]
...
[id="ocp-4-12-3-bug-fixes_{context}"]
==== Bug fixes
...
[id="ocp-4-12-3-updating_{context}"]
==== Updating

To update an existing {product-title} 4.12 cluster to this latest release, see xref:../updating/updating-cluster-cli.adoc#updating-cluster-cli[Updating a cluster using the CLI].

[id="ocp-4-12-4_{context}"]
...
[id="ocp-4-12-4-updating_{context}"]
==== Updating

To update an existing {product-title} 4.12 cluster to this latest release, see xref:../updating/updating-cluster-cli.adoc#updating-cluster-cli[Updating a cluster using the CLI].

[id="ocp-4-12-5_{context}"]
...
[id="ocp-4-12-5-bug-fixes_{context}"]
==== Bug fixes
...
[id="ocp-4-12-5-updating_{context}"]
==== Updating

To update an existing {product-title} 4.12 cluster to this latest release, see xref:../updating/updating-cluster-cli.adoc#updating-cluster-cli[Updating a cluster using the CLI].

[id="ocp-4-12-6_{context}"]
...
[id="ocp-4-12-6-updating_{context}"]
==== Updating

To update an existing {product-title} 4.12 cluster to this latest release, see xref:../updating/updating-cluster-cli.adoc#updating-cluster-cli[Updating a cluster using the CLI].

[id="ocp-4-12-7_{context}"]
...
[id="ocp-4-12-7-updating_{context}"]
==== Updating

To update an existing {product-title} 4.12 cluster to this latest release, see xref:../updating/updating-cluster-cli.adoc#updating-cluster-cli[Updating a cluster using the CLI].

[id="ocp-4-12-8_{context}"]
...
[id="ocp-4-12-8-updating_{context}"]
==== Updating

To update an existing {product-title} 4.12 cluster to this latest release, see xref:../updating/updating-cluster-cli.adoc#updating-cluster-cli[Updating a cluster using the CLI].

[id="ocp-4-12-9_{context}"]
...
[id="ocp-4-12-9-bug-fixes_{context}"]
==== Bug fixes
...
[id="ocp-4-12-9-updating_{context}"]
==== Updating

To update an existing {product-title} 4.12 cluster to this latest release, see xref:../updating/updating-cluster-cli.adoc#updating-cluster-cli[Updating a cluster using the CLI].

[id="ocp-4-12-10_{context}"]
...
[id="ocp-4-12-10-updating_{context}"]
==== Updating

To update an existing {product-title} 4.12 cluster to this latest release, see xref:../updating/updating-cluster-cli.adoc#updating-cluster-cli[Updating a cluster using the CLI].

[id="ocp-4-12-11_{context}"]
...
[id="ocp-4-12-11-features_{context}"]
==== Features

[id="ocp-4-12-11-oc-mirror-max-nested-paths_{context}"]
...
[id="ocp-4-12-11-oc-mirror-skip-pruning_{context}"]
...
[id="ocp-4-12-11-bug-fixes_{context}"]
==== Bug fixes
...
[id="ocp-4-12-11-updating_{context}"]
==== Updating

To update an existing {product-title} 4.12 cluster to this latest release, see xref:../updating/updating-cluster-cli.adoc#updating-cluster-cli[Updating a cluster using the CLI].

[id="ocp-4-12-12_{context}"]
...
[id="ocp-4-12-12-updating_{context}"]
==== Updating
...
[id="ocp-4-12-13-features_{context}"]
==== Features
...
[id="ocp-4-12-13-updating_{context}"]
==== Updating

To update an existing {product-title} 4.12 cluster to this latest release, see xref:../updating/updating-cluster-cli.adoc#updating-cluster-cli[Updating a cluster using the CLI].

[id="ocp-4-12-14_{context}"]
...
[id="ocp-4-12-14-features_{context}"]
==== Features

[id="ocp-4-12-14-cloud-provider-openstack-1-25_{context}"]
...
[id="ocp-4-12-14-updating_{context}"]
==== Updating

To update an existing {product-title} 4.12 cluster to this latest release, see xref:../updating/updating-cluster-cli.adoc#updating-cluster-cli[Updating a cluster using the CLI].

[id="ocp-4-12-15_{context}"]
...
[id="ocp-4-12-15-bug-fixes_{context}"]
==== Bug fixes
...
[id="ocp-4-12-15-updating_{context}"]
==== Updating

To update an existing {product-title} 4.12 cluster to this latest release, see xref:../updating/updating-cluster-cli.adoc#updating-cluster-cli[Updating a cluster using the CLI].

[id="ocp-4-12-16_{context}"]
...
[id="ocp-4-12-16-bug-fixes_{context}"]
==== Bug fixes
...
[id="ocp-4-12-16-updating_{context}"]
==== Updating

To update an existing {product-title} 4.12 cluster to this latest release, see xref:../updating/updating-cluster-cli.adoc#updating-cluster-cli[Updating a cluster using the CLI].

[id="ocp-4-12-17_{context}"]
...
[id="ocp-4-12-17-bug-fixes_{context}"]
==== Bug fixes
...
[id="ocp-4-12-17-updating_{context}"]
==== Updating

To update an existing {product-title} 4.12 cluster to this latest release, see xref:../updating/updating-cluster-cli.adoc#updating-cluster-cli[Updating a cluster using the CLI].

[id="ocp-4-12-18_{context}"]
...
[id="ocp-4-12-18-bug-fixes_{context}"]
==== Bug fixes
...
[id="ocp-4-12-18-updating_{context}"]
==== Updating

To update an existing {product-title} 4.12 cluster to this latest release, see xref:../updating/updating-cluster-cli.adoc#updating-cluster-cli[Updating a cluster using the CLI].

[id="ocp-4-12-19_{context}"]
...
[id="ocp-4-12-19-updating_{context}"]
==== Updating

To update an existing {product-title} 4.12 cluster to this latest release, see xref:../updating/updating-cluster-cli.adoc#updating-cluster-cli[Updating a cluster using the CLI].

[id="ocp-4-12-20_{context}"]
...
[id="ocp-4-12-20-bug-fixes_{context}"]
==== Bug fixes
...
[id="ocp-4-12-20-updating_{context}"]
==== Updating

To update an existing {product-title} 4.12 cluster to this latest release, see xref:../updating/updating-cluster-cli.adoc#updating-cluster-cli[Updating a cluster using the CLI].

[id="ocp-4-12-21_{context}"]
...
[id="ocp-4-12-21-bug-fixes_{context}"]
==== Bug fixes
...
[id="ocp-4-12-21-updating_{context}"]
==== Updating

To update an existing {product-title} 4.12 cluster to this latest release, see xref:../updating/updating-cluster-cli.adoc#updating-cluster-cli[Updating a cluster using the CLI].

[id="ocp-4-12-22_{context}"]
...
[id="ocp-4-12-22-bug-fixes_{context}"]
==== Bug fixes
...
[id="ocp-4-12-22-updating_{context}"]
==== Updating

To update an existing {product-title} 4.12 cluster to this latest release, see xref:../updating/updating-cluster-cli.adoc#updating-cluster-cli[Updating a cluster using the CLI].

[id="ocp-4-12-23_{context}"]
...
[id="ocp-4-12-23-updating_{context}"]
==== Updating

To update an existing {product-title} 4.12 cluster to this latest release, see xref:../updating/updating-cluster-cli.adoc#updating-cluster-cli[Updating a cluster using the CLI].

[id="ocp-4-12-24_{context}"]
...
[id="ocp-4-12-24-features_{context}"]
==== Features
...
[id="ocp-4-12-24-updating_{context}"]
==== Updating

To update an existing {product-title} 4.12 cluster to this latest release, see xref:../updating/updating-cluster-cli.adoc#updating-cluster-cli[Updating a cluster using the CLI].

[id="ocp-4-12-25_{context}"]
...
[id="ocp-4-12-25-updating_{context}"]
==== Updating

To update an existing {product-title} 4.12 cluster to this latest release, see xref:../updating/updating-cluster-cli.adoc#updating-cluster-cli[Updating a cluster using the CLI].

[id="ocp-4-12-26_{context}"]
...
[id="ocp-4-12-26-updating_{context}"]
==== Updating

To update an existing {product-title} 4.12 cluster to this latest release, see xref:../updating/updating-cluster-cli.adoc#updating-cluster-cli[Updating a cluster using the CLI].

[id="ocp-4-12-27_{context}"]
...
[id="ocp-4-12-27-updating_{context}"]
==== Updating

To update an existing {product-title} 4.12 cluster to this latest release, see xref:../updating/updating-cluster-cli.adoc#updating-cluster-cli[Updating a cluster using the CLI].

[id="ocp-4-12-28_{context}"]
...
[id="ocp-4-12-28-updating_{context}"]
==== Updating

To update an existing {product-title} 4.12 cluster to this latest release, see xref:../updating/updating-cluster-cli.adoc#updating-cluster-cli[Updating a cluster using the CLI].

[id="ocp-4-12-29_{context}"]
...
[id="ocp-4-12-29-bug-fixes_{context}"]
==== Bug fixes
...
[id="ocp-4-12-29-updating_{context}"]
==== Updating

To update an existing {product-title} 4.12 cluster to this latest release, see xref:../updating/updating-cluster-cli.adoc#updating-cluster-cli[Updating a cluster using the CLI].

[id="ocp-4-12-30_{context}"]
...
[id="ocp-4-12-30-updating_{context}"]
==== Updating

To update an existing {product-title} 4.12 cluster to this latest release, see xref:../updating/updating-cluster-cli.adoc#updating-cluster-cli[Updating a cluster using the CLI].


[id="ocp-4-12-31_{context}"]
...
[id="ocp-4-12-31-updating_{context}"]
==== Updating

To update an existing {product-title} 4.12 cluster to this latest release, see xref:../updating/updating-cluster-cli.adoc#updating-cluster-cli[Updating a cluster using the CLI].

[id="ocp-4-12-32_{context}"]
...
[id="ocp-4-12-32-bug-fixes_{context}"]
==== Bug fix
...
[id="ocp-4-12-32-updating_{context}"]
==== Updating

To update an existing {product-title} 4.12 cluster to this latest release, see xref:../updating/updating-cluster-cli.adoc#updating-cluster-cli[Updating a cluster using the CLI].

[id="ocp-4-12-33_{context}"]
...
[id="ocp-4-12-33-updating_{context}"]
==== Updating

To update an existing {product-title} 4.12 cluster to this latest release, see xref:../updating/updating-cluster-cli.adoc#updating-cluster-cli[Updating a cluster using the CLI].

[id="ocp-4-12-34_{context}"]
...
[id="ocp-4-12-34-bug-fixes_{context}"]
==== Bug fixes
...
[id="ocp-4-12-34-updating_{context}"]
==== Updating

To update an existing {product-title} 4.12 cluster to this latest release, see xref:../updating/updating-cluster-cli.adoc#updating-cluster-cli[Updating a cluster using the CLI].

[id="ocp-4-12-35_{context}"]
...
[id="ocp-4-12-35-updating_{context}"]
==== Updating

To update an existing {product-title} 4.12 cluster to this latest release, see xref:../updating/updating-cluster-cli.adoc#updating-cluster-cli[Updating a cluster using the CLI].

[id="ocp-4-12-36_{context}"]
...
[id="ocp-4-12-36-updating_{context}"]
==== Updating

To update an existing {product-title} 4.12 cluster to this latest release, see xref:../updating/updating-cluster-cli.adoc#updating-cluster-cli[Updating a cluster using the CLI].

[id="ocp-4-12-37_{context}"]
...
[id="ocp-4-12-37-updating_{context}"]
==== Updating

To update an existing {product-title} 4.12 cluster to this latest release, see xref:../updating/updating-cluster-cli.adoc#updating-cluster-cli[Updating a cluster using the CLI].

[id="ocp-4-12-39_{context}"]
...
[id="ocp-4-12-39-bug-fixes_{context}"]
==== Bug fixes
...
[id="ocp-4-12-39-updating_{context}"]
==== Updating

To update an existing {product-title} 4.12 cluster to this latest release, see xref:../updating/updating-cluster-cli.adoc#updating-cluster-cli[Updating a cluster using the CLI].

[id="ocp-4-12-40_{context}"]
...
[id="ocp-4-12-40-updating_{context}"]
==== Updating

To update an existing {product-title} 4.12 cluster to this latest release, see xref:../updating/updating-cluster-cli.adoc#updating-cluster-cli[Updating a cluster using the CLI].

[id="ocp-4-12-41_{context}"]
...
[id="ocp-4-12-41-updating_{context}"]
==== Updating

To update an existing {product-title} 4.12 cluster to this latest release, see xref:../updating/updating-cluster-cli.adoc#updating-cluster-cli[Updating a cluster using the CLI].

[id="ocp-4-12-42_{context}"]
...
[id="ocp-4-12-42-features_{context}"]
==== Feature
...
[id="ocp-4-12-42-bug-fixes_{context}"]
==== Bug fixes
...
[id="ocp-4-12-42-updating_{context}"]
==== Updating

To update an existing {product-title} 4.12 cluster to this latest release, see xref:../updating/updating-cluster-cli.adoc#updating-cluster-cli[Updating a cluster using the CLI].

[id="ocp-4-12-43_{context}"]
...
[id="ocp-4-12-43-updating_{context}"]
==== Updating

To update an existing {product-title} 4.12 cluster to this latest release, see xref:../updating/updating-cluster-cli.adoc#updating-cluster-cli[Updating a cluster using the CLI].

[id="ocp-4-12-44_{context}"]
...
[id="ocp-4-12-44-updating_{context}"]
==== Updating

To update an existing {product-title} 4.12 cluster to this latest release, see xref:../updating/updating-cluster-cli.adoc#updating-cluster-cli[Updating a cluster using the CLI].

[id="ocp-4-12-45_{context}"]
...
[id="ocp-4-12-45-bug-fixes_{context}"]
==== Bug fixes
...
[id="ocp-4-12-45-updating_{context}"]
==== Updating

To update an existing {product-title} 4.12 cluster to this latest release, see xref:../updating/updating-cluster-cli.adoc#updating-cluster-cli[Updating a cluster using the CLI].

[id="ocp-4-12-46_{context}"]
...
[id="ocp-4-12-46-bug-fixes_{context}"]
==== Bug fixes
...
[id="ocp-4-12-46-updating_{context}"]
==== Updating

To update an existing {product-title} 4.12 cluster to this latest release, see xref:../updating/updating-cluster-cli.adoc#updating-cluster-cli[Updating a cluster using the CLI].

[id="ocp-4-12-47_{context}"]
...
[id="ocp-4-12-47-bug-fixes_{context}"]
==== Bug fixes
...
[id="ocp-4-12-47-updating_{context}"]
==== Updating

To update an existing {product-title} 4.12 cluster to this latest release, see xref:../updating/updating-cluster-cli.adoc#updating-cluster-cli[Updating a cluster using the CLI].

[id="ocp-4-12-48_{context}"]
...
[id="ocp-4-12-48-updating_{context}"]
==== Updating

To update an existing {product-title} 4.12 cluster to this latest release, see xref:../updating/updating-cluster-cli.adoc#updating-cluster-cli[Updating a cluster using the CLI].


[id="ocp-4-12-49_{context}"]
...
[id="ocp-4-12-49-bug-fixes_{context}"]
==== Bug fixes
...
[id="ocp-4-12-49-updating_{context}"]
==== Updating

To update an existing {product-title} 4.12 cluster to this latest release, see xref:../updating/updating-cluster-cli.adoc#updating-cluster-cli[Updating a cluster using the CLI].

[id="ocp-4-12-50_{context}"]
...
[id="ocp-4-12-50-bug-fixes_{context}"]
==== Bug fixes
...
[id="ocp-4-12-50-updating_{context}"]
==== Updating

To update an existing {product-title} 4.12 cluster to this latest release, see xref:../updating/updating-cluster-cli.adoc#updating-cluster-cli[Updating a cluster using the CLI].

[id="ocp-4-12-51_{context}"]
...
[id="ocp-4-12-51-bug-fixes_{context}"]
==== Bug fixes
...
[id="ocp-4-12-51-updating_{context}"]
==== Updating

To update an existing {product-title} 4.12 cluster to this latest release, see xref:../updating/updating-cluster-cli.adoc#updating-cluster-cli[Updating a cluster using the CLI].

[id="ocp-4-12-53_{context}"]
...
[id="ocp-4-12-53-updating_{context}"]
==== Updating

To update an existing {product-title} 4.12 cluster to this latest release, see xref:../updating/updating-cluster-cli.adoc#updating-cluster-cli[Updating a cluster using the CLI].

[id="ocp-4-12-54_{context}"]
...
[id="ocp-4-12-54-updating_{context}"]
==== Updating

To update an existing {product-title} 4.12 cluster to this latest release, see xref:../updating/updating-cluster-cli.adoc#updating-cluster-cli[Updating a cluster using the CLI].

[id="ocp-4-12-55_{context}"]
...
[id="ocp-4-12-55-bug-fixes_{context}"]
==== Bug fixes
...
[id="ocp-4-12-55-updating_{context}"]
==== Updating

To update an existing {product-title} 4.12 cluster to this latest release, see xref:../updating/updating-cluster-cli.adoc#updating-cluster-cli[Updating a cluster using the CLI].

[id="ocp-4-12-56_{context}"]
...
[id="ocp-4-12-56-bug-fixes_{context}"]
==== Bug fixes
...
[id="ocp-4-12-56-updating_{context}"]
==== Updating

To update an existing {product-title} 4.12 cluster to this latest release, see xref:../updating/updating-cluster-cli.adoc#updating-cluster-cli[Updating a cluster using the CLI].

[id="ocp-4-12-57_{context}"]
...
[id="ocp-4-12-57-bug-fixes_{context}"]
==== Bug fixes
...
[id="ocp-4-12-57-updating_{context}"]
==== Updating

To update an existing {product-title} 4.12 cluster to this latest release, see xref:../updating/updating-cluster-cli.adoc#updating-cluster-cli[Updating a cluster using the CLI].

[id="ocp-4-12-58_{context}"]
...
[id="ocp-4-12-58-bug-fixes_{context}"]
==== Bug fixes
...
[id="ocp-4-12-58-known-issue_{context}"]
==== Known issue
...
[id="ocp-4-12-58-updating_{context}"]
==== Updating

To update an existing {product-title} 4.12 cluster to this latest release, see xref:../updating/updating-cluster-cli.adoc#updating-cluster-cli[Updating a cluster using the CLI].

[id="ocp-4-12-59_{context}"]
...
[id="ocp-4-12-59-bug-fixes_{context}"]
==== Bug fixes
...
[id="ocp-4-12-59-updating_{context}"]
==== Updating

To update an existing {product-title} 4.12 cluster to this latest release, see xref:../updating/updating-cluster-cli.adoc#updating-cluster-cli[Updating a cluster using the CLI].

[id="ocp-4-12-60_{context}"]
...
[id="ocp-4-12-60-bug-fixes_{context}"]
==== Bug fixes
...
[id="ocp-4-12-60-updating_{context}"]
==== Updating

To update an existing {product-title} 4.12 cluster to this latest release, see xref:../updating/updating-cluster-cli.adoc#updating-cluster-cli[Updating a cluster using the CLI].

// 4.12.61
[id="ocp-4-12-61_{context}"]
...
[id="ocp-4-12-61-bug-fixes_{context}"]
==== Bug fixes
...
* Previously, the `wait-for-ceo` command that is used during the bootstrap operation to verify etcd rollout did not report errors for some failure modes. With this release, a code fix ensures that error messages for these failure modes get reported. (link:https://issues.redhat.com/browse/OCPBUGS-35501[OCPBUGS-35501])

* Previously, the Helm Plugin index view did not display the same number of charts as the Helm CLI if the chart names varied. With this release, the Helm catalog now looks for `charts.openshift.io/name` and `charts.openshift.io/provider` so that all versions are grouped together in a single catalog title. (link:https://issues.redhat.com/browse/OCPBUGS-34933[OCPBUGS-34933])

[id="ocp-4-12-61-enhancements_{context}"]
==== Enhancements
...
[id="ocp-4-12-61-updating_{context}"]
==== Updating

To update an existing {product-title} 4.12 cluster to this latest release, see xref:../updating/updating-cluster-cli.adoc#updating-cluster-cli[Updating a cluster using the CLI].

[id="ocp-4-12-63_{context}"]
...
[id="ocp-4-12-63-updating_{context}"]
==== Updating

To update an existing {product-title} 4.12 cluster to this latest release, see xref:../updating/updating-cluster-cli.adoc#updating-cluster-cli[Updating a cluster using the CLI].

[id="ocp-4-12-64_{context}"]
...
[id="ocp-4-12-64-updating_{context}"]
==== Updating

To update an existing {product-title} 4.12 cluster to this latest release, see xref:../updating/updating-cluster-cli.adoc#updating-cluster-cli[Updating a cluster using the CLI].

[id="ocp-4-12-65_{context}"]
...
[id="ocp-4-12-65-bug-fixes_{context}"]
==== Bug fixes
...
[id="ocp-4-12-65-updating_{context}"]
==== Updating

To update an existing {product-title} 4.12 cluster to this latest release, see xref:../updating/updating-cluster-cli.adoc#updating-cluster-cli[Updating a cluster using the CLI].

[id="ocp-4-12-66_{context}"]
=== RHSA-2024:6705 - {product-title} 4.12.66 bug fix and security update

Issued: 19 September 2024

{product-title} release 4.12.66, which includes security updates, is now available. The list of bug fixes that are included in the update is documented in the link:https://access.redhat.com/errata/RHSA-2024:6705[RHSA-2024:6705] advisory. There are no RPM packages for this release.
...
[id="ocp-4-12-66-updating_{context}"]
==== Updating

To update an existing {product-title} 4.12 cluster to this latest release, see xref:../updating/updating-cluster-cli.adoc#updating-cluster-cli[Updating a cluster using the CLI].

// 4.12.67
[id="ocp-4-12-67_{context}"]
...
[id="ocp-4-12-67-bug-fixes_{context}"]
==== Bug fixes
...
[id="ocp-4-12-67-updating_{context}"]
==== Updating

To update an existing {product-title} 4.12 cluster to this latest release, see xref:../updating/updating-cluster-cli.adoc#updating-cluster-cli[Updating a cluster using the CLI].

// 4.12.68
[id="ocp-4-12-68_{context}"]
=== RHSA-2024:8692 - {product-title} 4.12.68 bug fix and security update

Issued: 07 November 2024

{product-title} release 4.12.68, which includes security updates, is now available. The list of bug fixes that are included in the update is documented in the link:https://access.redhat.com/errata/RHSA-2024:8692[RHSA-2024:8692] advisory. The RPM packages that are included in the update are provided by the link:https://access.redhat.com/errata/RHSA-2024:8694[RHSA-2024:8694] advisory.
...
[id="ocp-4-12-68-updating_{context}"]
==== Updating
...
[id="ocp-4-12-71-updating_{context}"]
==== Updating
...
// 4.12.76
[id="ocp-4-12-76_{context}"]
=== RHSA-2025:4409 - {product-title} 4.12.76 bug fix and security update

Issued: 08 May 2025

{product-title} release 4.12.76 is now available. The list of bug fixes that are included in the update is documented in the link:https://access.redhat.com/errata/RHSA-2025:4409[RHSA-2025:4409] advisory. The RPM packages that are included in the update are provided by the link:https://access.redhat.com/errata/RHBA-2025:4411[RHBA-2025:4411] advisory.

You can view the container images in this release by running the following command:

[source,terminal]
----
$ oc adm release info 4.12.76 --pullspecs
----

[id="ocp-4-12-76-bug-fixes_{context}"]
==== Bug fixes

* Previously, the *Observe* sections on the web console did not show items contributed from plugins unless certain flags related to the monitoring were set. These flags prevented other plugins, such as logging, {DTShortName}, and network observability, from adding items to the *Observe* section. With this release, the monitoring flags are removed so that other plugins can add items to the *Observe* section. (link:https://issues.redhat.com/browse/OCPBUGS-55210[OCPBUGS-55210])

[id="ocp-4-12-76-updating_{context}"]
==== Updating

To update an existing {product-title} 4.12 cluster to this latest release, see xref:../updating/updating-cluster-cli.adoc#updating-cluster-cli[Updating a cluster using the CLI].

// 4.12.77
[id="ocp-4-12-77_{context}"]
=== RHSA-2025:8303 - {product-title} 4.12.77 bug fix and security update

Issued: 05 June 2025

{product-title} release 4.12.77 is now available. The list of bug fixes that are included in the update is documented in the link:https://access.redhat.com/errata/RHSA-2025:8303[RHSA-2025:8303] advisory. The RPM packages that are included in the update are provided by the link:https://access.redhat.com/errata/RHBA-2025:8304[RHBA-2025:8304] advisory.

You can view the container images in this release by running the following command:

[source,terminal]
----
$ oc adm release info 4.12.77 --pullspecs
----

[id="ocp-4-12-77-bug-fixes_{context}"]
==== Bug fixes

* Previously, when the `openshift-host-network' namespace was modified by the user or by an upgrade, the network policy did not correctly set the VXLAN virtual network ID parameter, `VNID`, to `0`. With this release, the VNID parameter is correctly set after the namespace is modified. (link:https://issues.redhat.com/browse/OCPBUGS-56130[OCPBUGS-56130])
...
[id="ocp-4-12-77-updating_{context}"]
==== Updating
...
// 4.12.79
[id="ocp-4-12-79_{context}"]
=== RHSA-2025:12323 - {product-title} 4.12.79 bug fix and security update

Issued: 07 August 2025

{product-title} release 4.12.79 is now available. The list of bug fixes that are included in the update is documented in the link:https://access.redhat.com/errata/RHSA-2025:12323[RHSA-2025:12323] advisory. The RPM packages that are included in the update are provided by the link:https://access.redhat.com/errata/RHBA-2025:12324[RHBA-2025:12324] advisory.
...
[source,terminal]
----
$ oc adm release info 4.12.79 --pullspecs
----

[id="ocp-4-12-79-updating_{context}"]
==== Updating

To update an existing {product-title} 4.12 cluster to this latest release, see xref:../updating/updating-cluster-cli.adoc#updating-cluster-cli[Updating a cluster using the CLI].

// 4.12.80
[id="ocp-4-12-80_{context}"]
=== RHSA-2025:15332 - {product-title} 4.12.80 bug fix and security update

Issued: 11 September 2025

{product-title} release 4.12.80 is now available. The list of bug fixes that are included in the update is documented in the link:https://access.redhat.com/errata/RHSA-2025:15332[RHSA-2025:15332] advisory. The RPM packages that are included in the update are provided by the link:https://access.redhat.com/errata/RHBA-2025:15307[RHBA-2025:15307] advisory.

Space precluded documenting all of the container images for this release in the advisory. You can view the container images in this release by running the following command:

[source,terminal]
----
$ oc adm release info 4.12.80 --pullspecs
----

[id="ocp-4-12-80-updating_{context}"]
==== Updating
...
{product-title} release 4.12.81 is now available. The list of bug fixes that are included in the update is documented in the link:https://access.redhat.com/errata/RHSA-2025:17671[RHSA-2025:17671] advisory. The RPM packages that are included in the update are provided by the link:https://access.redhat.com/errata/RHSA-2025:17669[RHSA-2025:17669] advisory.
...
[id="ocp-4-12-81-enhancements_{context}"]
==== Enhancement
...
// 4.12.82
[id="ocp-4-12-82_{context}"]
=== RHSA-2025:19895 - {product-title} 4.12.82 bug fix and security update

Issued: 13 November 2025

{product-title} release 4.12.82 is now available. The list of bug fixes that are included in the update is documented in the link:https://access.redhat.com/errata/RHSA-2025:19895[RHSA-2025:19895] advisory. There are no RPM packages for this update.

You can view the container images in this release by running the following command:

[source,terminal]
----
$ oc adm release info 4.12.82 --pullspecs
----

[id="ocp-4-12-82-bug-fixes_{context}"]
==== Bug fixes

There are no notable bug fixes in this release.

[id="ocp-4-12-82-updating_{context}"]
==== Updating
...
// 4.12.88 about
include::modules/zstream-4-12-88-about.adoc[leveloffset=+2]
...
// 4.12.95 about
include::modules/zstream-4-12-95-about.adoc[leveloffset=+2]

// 4.12.95 fixes
include::modules/zstream-4-12-95-fixed-issues.adoc[leveloffset=+3]

// 4.12.95 updating
include::modules/zstream-4-12-95-updating.adoc[leveloffset=+3]

// 4.12.96 about
include::modules/zstream-4-12-96-about.adoc[leveloffset=+2]

// 4.12.96 fixes
include::modules/zstream-4-12-96-fixed-issues.adoc[leveloffset=+3]
