...
[NOTE]
====
The `operator-sdk bundle validate` command cannot determine which version of the APIs your Operator requests permission to use. As a result, your Operator might trigger warnings even if you use newer versions of the API.
====
