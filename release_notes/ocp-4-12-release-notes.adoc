...
[id="ocp-4-12-enabling-disabling-developer-catalog"]
==== Enabling or Disabling Developer catalog or one of it's sub-catalogs

* With this update, you can enable or disable a developer catalog type (sub-catalog) by using either the YAML view or the form view.
