...
Based on testing with a 50-cluster and 4900-node-environment, these improvements include:
...
* CPU utilization when using compliance pages has dropped from `4.5` vCPUs to `0.8` vCPUs.
