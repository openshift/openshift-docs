...
This release of {product-title-short} fixes the following 
bugs:
...
* link:https://access.redhat.com/security/cve/cve-2025-27144[CVE-2025-27144]: Flaw in Go JOSE versions prior to 4.0.5 had a .
* link:https://access.redhat.com/security/cve/cve-2025-22868[CVE-2025-22868]: Flaw in Golang in the token parsing component.
