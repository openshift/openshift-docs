...
* The platform definition is built-in and you cannot customize it. You can see the impact of the definition in your environment by using the global search. To do this:
