...
[NOTE]
====
For additional information about the OpenShift {gitops-shortname} life cycle and supported platforms, refer to the link:https://access.redhat.com/support/policy/updates/openshift_operators[OpenShift Operator Life Cycles] and link:https://access.redhat.com/support/policy/updates/openshift[Red{nbsp}Hat {OCP} Life Cycle Policy].
====
...
// Release notes for Red Hat OpenShift GitOps 1.13.3
include::modules/gitops-release-notes-1-13-3.adoc[leveloffset=+1]

// Release notes for Red Hat OpenShift GitOps 1.13.2
include::modules/gitops-release-notes-1-13-2.adoc[leveloffset=+1]

// Release notes for Red Hat OpenShift GitOps 1.13.1 
include::modules/gitops-release-notes-1-13-1.adoc[leveloffset=+1]

// Release notes for Red Hat OpenShift GitOps 1.13.0
include::modules/gitops-release-notes-1-13-0.adoc[leveloffset=+1]

// Release notes for Red Hat OpenShift GitOps 1.12.6
include::modules/gitops-release-notes-1-12-6.adoc[leveloffset=+1]
...
// Release notes for Red Hat OpenShift GitOps 1.12.3
include::modules/gitops-release-notes-1-12-3.adoc[leveloffset=+1]
...
// Release notes for Red Hat OpenShift GitOps 1.11.7
include::modules/gitops-release-notes-1-11-7.adoc[leveloffset=+1]

// Release notes for Red Hat OpenShift GitOps 1.11.6
include::modules/gitops-release-notes-1-11-6.adoc[leveloffset=+1]

// Release notes for Red Hat OpenShift GitOps 1.11.5
include::modules/gitops-release-notes-1-11-5.adoc[leveloffset=+1]
