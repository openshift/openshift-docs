...
[id="resolved-in-version-416_{context}"]
=== Resolved in version 4.1.6

Release date: 22 January 2024

This release of {product-title-short} fixes PostgreSQL vulnerabilities in the `central`, `central-db`, and `scanner-db` containers.
