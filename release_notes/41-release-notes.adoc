...
In {product-title-short} 4.1, you can enhance Central's security and login capabilities with the new feature of using an authentication provider to authorize `roxctl` CLI.
