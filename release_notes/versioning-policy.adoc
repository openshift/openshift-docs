...
minor releases (3.10 to 3.11 to 4.1, for example) to allow older `oc` to update.
Using new capabilities may require newer `oc`. A 4.1 server may have additional
capabilities that a 3.11 `oc` cannot use and a 4.1 `oc` may have additional
