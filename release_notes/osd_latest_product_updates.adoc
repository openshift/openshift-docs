...
See
xref:../using_images/other_images/jenkins.adoc#jenkins-configuration-and-usage[{product-title}
...
xref:../install_config/web_console_customization.adoc#install-config-web-console-customization[Configuring
...
See xref:../architecture/core_concepts/routes.adoc#wildcard-subdomain-route-policy[Creating Routes Specifying a Wildcard Subdomain Policy] for more details.
