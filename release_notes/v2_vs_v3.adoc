...
== Overview
OpenShift version 3 (v3) is a very different product than OpenShift version 2
(v2). Many of the same terms are used, and the same functions are performed, but
the terminology can be different, and behind the scenes things may be happening
very differently. Still, OpenShift remains an application platform.
...
>>>>>>> 6ba19ab... Updates and link fixes for Dedicated & Online distros
endif::[]
...
In OpenShift v3, an
link:../architecture/core_concepts/containers_and_images.html#docker-images[image]
...
(S2I)] and link:../architecture/core_concepts/templates.html[configuring the
template].
...
where link:../architecture/core_concepts/pods_and_services.html#pods[pods] bring
...
which use link:../architecture/core_concepts/pods_and_services.html#pods[pods]
...
link:../architecture/core_concepts/routes.html[routes] are first-class objects
...
A link:../architecture/core_concepts/projects_and_users.html#projects[project]
