...
|CRI-O is the default container runtime for {product-title} 4.1 on RHCOS and Red
...
{product-title} 4.1 is available. Cluster administrators can upgrade using the
...
maximums] for {product-title} 4.1 is now available.
...
[[ocp-4-1-23]]
=== RHBA-2019:3766 - {product-title} 4.1.23 Bug Fix Update

Issued: 2019-11-12

{product-title} release 4.1.23 is now available. The list of packages
included in the update are documented in the
link:https://access.redhat.com/errata/RHBA-2019:3766[RHBA-2019:3766] advisory.
The container images and bug fixes included in the update are provided by the
link:https://access.redhat.com/errata/RHBA-2019:3765[RHBA-2019:3765] advisory.

Space precluded documenting all of the container images for this release in the
advisory. See the following article for notes on the container images in this
release:

link:https://access.redhat.com/solutions/4562241[{product-title} 4.1.23 container image list]

[[ocp-4-1-23-upgrading]]
==== Upgrading
To upgrade an existing {product-title} 4.1 cluster to this latest release, see
xref:../updating/updating-cluster-cli.adoc[Updating a cluster by using the CLI]
for instructions.
...
[[ocp-4-1-24]]
=== RHBA-2019:3874 - {product-title} 4.1.24 Bug Fix Update

Issued: 2019-11-20

{product-title} release 4.1.24 is now available. The list of packages
included in the update are documented in the
link:https://access.redhat.com/errata/RHBA-2019:3874[RHBA-2019:3874] advisory.
The container images and bug fixes included in the update are provided by the
link:https://access.redhat.com/errata/RHBA-2019:3875[RHBA-2019:3875] advisory.

Space precluded documenting all of the container images for this release in the
advisory. See the following article for notes on the container images in this
release:

link:https://access.redhat.com/solutions/4591401[{product-title} 4.1.24 container image list]

[[ocp-4-1-24-upgrading]]
==== Upgrading
To upgrade an existing {product-title} 4.1 cluster to this latest release, see
xref:../updating/updating-cluster-cli.adoc[Updating a cluster by using the CLI]
for instructions.
...
[[ocp-4-1-25]]
=== RHBA-2019:3913 - {product-title} 4.1.25 Bug Fix Update

Issued: 2019-11-27

{product-title} release 4.1.25 is now available. The list of packages
included in the update are documented in the
link:https://access.redhat.com/errata/RHBA-2019:3912[RHBA-2019:3912] advisory.
The container images and bug fixes included in the update are provided by the
link:https://access.redhat.com/errata/RHBA-2019:3913[RHBA-2019:3913] advisory.

Space precluded documenting all of the container images for this release in the
advisory. See the following article for notes on the container images in this
release:

link:https://access.redhat.com/solutions/4611301[{product-title} 4.1.25 container image list]

[[ocp-4-1-25-upgrading]]
==== Upgrading
To upgrade an existing {product-title} 4.1 cluster to this latest release, see
xref:../updating/updating-cluster-cli.adoc[Updating a cluster by using the CLI]
for instructions.
...
[[ocp-4-1-26]]
=== RHBA-2019:3956 - {product-title} 4.1.26 Bug Fix Update

Issued: 2019-12-04

{product-title} release 4.1.26 is now available. The list of packages
included in the update are documented in the
link:https://access.redhat.com/errata/RHBA-2019:3954[RHBA-2019:3954] advisory.
The container images and bug fixes included in the update are provided by the
link:https://access.redhat.com/errata/RHBA-2019:3956[RHBA-2019:3956] advisory.

Space precluded documenting all of the container images for this release in the
advisory. See the following article for notes on the container images in this
release:

link:https://access.redhat.com/solutions/4626201[{product-title} 4.1.26 container image list]

[[ocp-4-1-26-upgrading]]
==== Upgrading
To upgrade an existing {product-title} 4.1 cluster to this latest release, see
xref:../updating/updating-cluster-cli.adoc[Updating a cluster by using the CLI]
for instructions.
...
[[ocp-4-1-27]]
=== RHBA-2019:4084 - {product-title} 4.1.27 Bug Fix Update

Issued: 2019-12-17

{product-title} release 4.1.27 is now available. The list of packages
included in the update are documented in the
link:https://access.redhat.com/errata/RHBA-2019:4083[RHBA-2019:4083] advisory.
The container images and bug fixes included in the update are provided by the
link:https://access.redhat.com/errata/RHBA-2019:4084[RHBA-2019:4084] advisory.

Space precluded documenting all of the container images for this release in the
advisory. See the following article for notes on the container images in this
release:

link:https://access.redhat.com/solutions/4651531[{product-title} 4.1.27 container image list]

[[ocp-4-1-27-upgrading]]
==== Upgrading
To upgrade an existing {product-title} 4.1 cluster to this latest release, see
xref:../updating/updating-cluster-cli.adoc[Updating a cluster by using the CLI]
for instructions.
...
[[ocp-4-1-28]]
=== RHBA-2019:4185 - {product-title} 4.1.28 Bug Fix Update

Issued: 2019-12-18

{product-title} release 4.1.28 is now available. The list of packages
included in the update are documented in the
link:https://access.redhat.com/errata/RHBA-2019:4185[RHBA-2019:4185] advisory.
The container images and bug fixes included in the update are provided by the
link:https://access.redhat.com/errata/RHBA-2019:4186[RHBA-2019:4186] advisory.

Space precluded documenting all of the container images for this release in the
advisory. See the following article for notes on the container images in this
release:

link:https://access.redhat.com/solutions/4657021[{product-title} 4.1.28 container image list]

[[ocp-4-1-28-upgrading]]
==== Upgrading
To upgrade an existing {product-title} 4.1 cluster to this latest release, see
xref:../updating/updating-cluster-cli.adoc[Updating a cluster by using the CLI]
for instructions.
...
[[ocp-4-1-29]]
=== RHBA-2020:0010 - {product-title} 4.1.29 Bug Fix Update

Issued: 2020-01-08

{product-title} release 4.1.29 is now available. The list of packages
included in the update are documented in the
link:https://access.redhat.com/errata/RHBA-2020:0009[RHBA-2020:0009] advisory.
The container images and bug fixes included in the update are provided by the
link:https://access.redhat.com/errata/RHBA-2020:0010[RHBA-2020:0010] advisory.

Space precluded documenting all of the container images for this release in the
advisory. See the following article for notes on the container images in this
release:

link:https://access.redhat.com/solutions/4716411[{product-title} 4.1.29 container image list]

[[ocp-4-1-29-upgrading]]
==== Upgrading
To upgrade an existing {product-title} 4.1 cluster to this latest release, see
xref:../updating/updating-cluster-cli.adoc[Updating a cluster by using the CLI]
for instructions.
...
[[ocp-4-1-30]]
=== RHBA-2020:0071 - {product-title} 4.1.30 Bug Fix Update

Issued: 2020-01-15

{product-title} release 4.1.30 is now available. The list of packages
included in the update are documented in the
link:https://access.redhat.com/errata/RHBA-2020:0070[RHBA-2020:0070] advisory.
The container images and bug fixes included in the update are provided by the
link:https://access.redhat.com/errata/RHBA-2020:0071[RHBA-2020:0071] advisory.

Space precluded documenting all of the container images for this release in the
advisory. See the following article for notes on the container images in this
release:

link:https://access.redhat.com/solutions/4728041[{product-title} 4.1.30 container image list]

[[ocp-4-1-30-upgrading]]
==== Upgrading
To upgrade an existing {product-title} 4.1 cluster to this latest release, see
xref:../updating/updating-cluster-cli.adoc[Updating a cluster by using the CLI]
for instructions.
...
[[ocp-4-1-31]]
=== RHBA-2020:0115 - {product-title} 4.1.31 Bug Fix Update

Issued: 2020-01-22

{product-title} release 4.1.31 is now available. The list of packages
included in the update are documented in the
link:https://access.redhat.com/errata/RHBA-2020:0114[RHBA-2020:0114] advisory.
The container images and bug fixes included in the update are provided by the
link:https://access.redhat.com/errata/RHBA-2020:0115[RHBA-2020:0115] advisory.

Space precluded documenting all of the container images for this release in the
advisory. See the following article for notes on the container images in this
release:

link:https://access.redhat.com/solutions/4757341[{product-title} 4.1.31 container image list]

[[ocp-4-1-31-upgrading]]
==== Upgrading
To upgrade an existing {product-title} 4.1 cluster to this latest release, see
xref:../updating/updating-cluster-cli.adoc[Updating a cluster by using the CLI]
for instructions.
...
[[ocp-4-1-34]]
=== RHBA-2020:0399 - {product-title} 4.1.34 Bug Fix Update

Issued: 2020-02-12

{product-title} release 4.1.34 is now available. The list of packages
included in the update are documented in the
link:https://access.redhat.com/errata/RHBA-2020:0398[RHBA-2020:0398] advisory.
The container images and bug fixes included in the update are provided by the
link:https://access.redhat.com/errata/RHBA-2020:0399[RHBA-2020:0399] advisory.

Space precluded documenting all of the container images for this release in the
advisory. See the following article for notes on the container images in this
release:

link:https://access.redhat.com/solutions/4815651[{product-title} 4.1.34 container image list]

[[ocp-4-1-34-upgrading]]
==== Upgrading
To upgrade an existing {product-title} 4.1 cluster to this latest release, see
xref:../updating/updating-cluster-cli.adoc[Updating a cluster by using the CLI]
for instructions.
...
[[ocp-4-1-38]]
=== RHBA-2020:0691 - {product-title} 4.1.38 Bug Fix Update

Issued: 2020-03-12

{product-title} release 4.1.38 is now available. The list of packages
included in the update are documented in the
link:https://access.redhat.com/errata/RHBA-2020:0690[RHBA-2020:0690] advisory.
The container images and bug fixes included in the update are provided by the
link:https://access.redhat.com/errata/RHBA-2020:0691[RHBA-2020:0691] advisory.

Space precluded documenting all of the container images for this release in the
advisory. See the following article for notes on the container images in this
release:

link:https://access.redhat.com/solutions/4900791[{product-title} 4.1.38 container image list]

[[ocp-4-1-38-upgrading]]
==== Upgrading
To upgrade an existing {product-title} 4.1 cluster to this latest release, see
xref:../updating/updating-cluster-cli.adoc[Updating a cluster by using the CLI]
for instructions.
...
[[ocp-4-1-41]]
=== RHBA-2020:1446 - {product-title} 4.1.41 Bug Fix Update

Issued: 2020-04-22

{product-title} release 4.1.41 is now available. The list of packages
included in the update are documented in the
link:https://access.redhat.com/errata/RHBA-2020:1443[RHBA-2020:1443] advisory.
The container images and bug fixes included in the update are provided by the
link:https://access.redhat.com/errata/RHBA-2020:1446[RHBA-2020:1446] advisory.

Space precluded documenting all of the container images for this release in the
advisory. See the following article for notes on the container images in this
release:

link:https://access.redhat.com/solutions/4995841[{product-title} 4.1.41 container image list]

[[ocp-4-1-41-upgrading]]
==== Upgrading
To upgrade an existing {product-title} 4.1 cluster to this latest release, see
xref:../updating/updating-cluster-cli.adoc[Updating a cluster by using the CLI]
for instructions.
...
[[RHSA-2020:1449]]
=== RHSA-2020:1449 - Low: {product-title} 4.1 security update

Issued: 2020-04-22

An update for podman is now available for {product-title} 4.1. Details of the
update are documented in the
link:https://access.redhat.com/errata/RHSA-2020:1449[RHSA-2020:1449] advisory.

[[RHSA-2020:1545]]
=== RHSA-2020:1545 - Moderate: {product-title} 4.1 security update

Issued: 2020-04-22

An update for openshift-enterprise-ansible-operator-container is now available
for {product-title} 4.1. Details of the update are documented in the
link:https://access.redhat.com/errata/RHSA-2020:1545[RHSA-2020:1545] advisory.
