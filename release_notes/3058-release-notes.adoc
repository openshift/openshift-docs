...
= Red Hat Advanced Cluster Security for Kubernetes version 3.0.58
...
[role="_abstract"]
{product-title} version 3.0.58 includes feature enhancements, bug fixes, scale improvements, and other changes.
