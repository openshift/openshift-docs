...
OpenShift Container Storage (OCS) provides software defined storage as a
container for use with {product-title}. Use OCS to define
xref:../architecture/additional_concepts/storage.adoc[persistent volumes] (PV)
for use with your containers.
