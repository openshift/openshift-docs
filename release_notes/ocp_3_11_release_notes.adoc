...
=== RHSA-2019:41823 -	Moderate: {product-title} 3.11 atomic-openshift security update

Issued: 2019-06-26

An update for atomic-openshift is now available for {product-title} 3.11.
Details of the update are documented in the
link:https://access.redhat.com/errata/RHSA-2019:41823[RHSA-2019:41823] advisory.

[[RHSA-2019-41823-upgrading]]
