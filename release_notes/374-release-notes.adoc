...
a| `registry.redhat.io/advanced-cluster-security/rhacs-main-rhel8:3.74.7`

| Scanner
| Scans images and nodes.
a|`registry.redhat.io/advanced-cluster-security/rhacs-scanner-rhel8:3.74.7`

| Scanner DB
| Stores image scan results and vulnerability definitions.
a|`registry.redhat.io/advanced-cluster-security/rhacs-scanner-db-rhel8:3.74.7`

| Collector
| Collects runtime activity in Kubernetes or {ocp} clusters.
a| * `registry.redhat.io/advanced-cluster-security/rhacs-collector-rhel8:3.74.7`
* `registry.redhat.io/advanced-cluster-security/rhacs-collector-slim-rhel8:3.74.7`
|===
