...
[id="resolved-in-version-3748"]
=== Resolved in version 3.74.8
...
[id="resolved-in-version-3749"]
=== Resolved in version 3.74.9

Release date: 8 February 2024

This release of {product-title-short} fixes a compatibility issue during startup between recent versions of Central and Sensors in 3.74.
...
a| `registry.redhat.io/advanced-cluster-security/rhacs-main-rhel8:3.74.9`

| Scanner
| Scans images and nodes.
a|`registry.redhat.io/advanced-cluster-security/rhacs-scanner-rhel8:3.74.9`

| Scanner DB
| Stores image scan results and vulnerability definitions.
a|`registry.redhat.io/advanced-cluster-security/rhacs-scanner-db-rhel8:3.74.9`

| Collector
| Collects runtime activity in Kubernetes or {ocp} clusters.
a| * `registry.redhat.io/advanced-cluster-security/rhacs-collector-rhel8:3.74.9`
