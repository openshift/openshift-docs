...
* IPI on OpenStack fails with 'Security group rule already exists' error when OpenStack Neutron is under heavy load (link:https://bugzilla.redhat.com/show_bug.cgi?id=1787112[*BZ#1787112*]).
