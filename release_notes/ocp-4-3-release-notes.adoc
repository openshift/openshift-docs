...
iSCSI raw block volumes, previously in Technology Preview, are now fully supported with {product-title} 4.3.
...
* The bootstrap user introduced in {product-title} 4.1
...
xref:../service_mesh/v1x/servicemesh-release-notes.adoc#ossm-rn-new-features-1x_ossm-release-notes-v1x[Updating OpenShift
...
* When upgrading an {product-title} cluster from  4.1 to 4.2 to 4.3, there is a
...
+
If you are a cluster administrator for a cluster that has been upgraded from {product-title} 4.1 to 4.3, you can either revoke or continue to allow unauthenticated access. It is recommended to revoke unauthenticated access unless there is a specific need for it. If you do continue to allow unauthenticated access, be aware of the increased risks.
+
[WARNING]
====
...
[[ocp-4-3-25]]
=== RHBA-2020:2436 - {product-title} 4.3.25 Bug Fix Update

Issued: 2020-06-16

{product-title} release 4.3.25 is now available. The list of packages included in
the update are documented in the
link:https://access.redhat.com/errata/RHBA-2020:2435[RHBA-2020:2435] advisory.
The container images and bug fixes included in the update are provided by the
link:https://access.redhat.com/errata/RHBA-2020:2436[RHBA-2020:2436] advisory.

Space precluded documenting all of the container images for this release in the
advisory. See the following article for notes on the container images in this
release:

link:https://access.redhat.com/solutions/5133131[{product-title} 4.3.25 container image list]

[[ocp-4-3-25-bug-fixes]]
==== Bug Fixes

* Previously, users could run `etc-member-add.sh` on the wrong master node,
...
node.
(link:https://bugzilla.redhat.com/show_bug.cgi?id=1804067[*BZ#1804067*])

* Previously, if a sample imagestream from an earlier release was removed in a
subsequent release, an upgrade to the subsequent release could fail if the
missing imagestream was incorrectly tracked as needing to be updated. With this
release, the upgrade process no longer attempts to update imagestreams which
existed in a prior release but not in the release being upgraded to.
(link:https://bugzilla.redhat.com/show_bug.cgi?id=1811206[*BZ#1811206*])
...
other cluster-related settings from the `openshift-config` namespace.
(link:https://bugzilla.redhat.com/show_bug.cgi?id=1825758[*BZ#1825758*])

* With the release of Red Hat OpenShift Serverless 1 Serverless Operator
version 1.7.1, the operator is generally available. The Tech Preview badge in
the Developer perspective of the web console has been removed.
(link:https://bugzilla.redhat.com/show_bug.cgi?id=1829046[*BZ#1829046*])

* With this release, users can collect anonymized data about unapproved
Certificate Service Requests to help troubleshoot issues.
(link:https://bugzilla.redhat.com/show_bug.cgi?id=1835094[*BZ#1835094*])

* Previously, the Samples operator would not finish an upgrade for the s390x
architecture because it could not locate samples content that did not exist,
which caused the overall upgrade to fail. With this release, the Samples
operator no longer attempts to retrieve samples content during upgrades for
s390x.
+
A workaround to get the Samples operator out of degraded state also exists. A
cluster admin can run `oc delete config.samples cluster` to reset the Samples
operator.
(link:https://bugzilla.redhat.com/show_bug.cgi?id=1835996[*BZ#1835996*])

* Previously, the Image Registry Operator could not be created when using IPI on
Azure because API restrictions did not allow bootstrapping a config object that
contained an empty container. In this release, the API restrictions have been
removed.
(link:https://bugzilla.redhat.com/show_bug.cgi?id=1836753[*BZ#1836753*])

* Previously, incorrect handling of certificate rotation caused Prometheus to be
unable to obtain data from the `/metrics` endpoint. The issue has been resolved
in this release.
(link:https://bugzilla.redhat.com/show_bug.cgi?id=1836939[*BZ#1836939*])
...
(link:https://bugzilla.redhat.com/show_bug.cgi?id=1839036[*BZ#1839036*])
...
release, the upgrade process no longer attempts to update templates which
existed in a prior release but not in the release being upgraded to.
(link:https://bugzilla.redhat.com/show_bug.cgi?id=1841996[*BZ#1841996*])

[[ocp-4-3-25-upgrading]]
==== Upgrading
...
[[RHSA-2020:2439]]
=== RHSA-2020:2439 - Moderate: {product-title} 4.3 Security Update

Issued: 2020-06-16

An update for `machine-config-operator-container` is now available for
{product-title} 4.3. Details of the update are documented in the
link:https://access.redhat.com/errata/RHSA-2020:2439[RHSA-2020:2439] advisory.

[[RHSA-2020:2440]]
=== RHSA-2020:2440 - Moderate: {product-title} 4.3 Security Update

Issued: 2020-06-16

An update for Kubernetes is now available for {product-title} 4.3. Details of
the update are documented in the
link:https://access.redhat.com/errata/RHSA-2020:2440[RHSA-2020:2440] advisory.

[[RHSA-2020:2441]]
=== RHSA-2020:2441 - Moderate: {product-title} 4.3 Security Update

Issued: 2020-06-16

An update for Kubernetes is now available for {product-title} 4.3. Details of
the update are documented in the
link:https://access.redhat.com/errata/RHSA-2020:2441[RHSA-2020:2441] advisory.

[[RHSA-2020:2442]]
=== RHSA-2020:2442 - Moderate: {product-title} 4.3 Security Update

Issued: 2020-06-16

An update for `openshift-enterprise-apb-tools-container` is now available for
{product-title} 4.3. Details of the update are documented in the
link:https://access.redhat.com/errata/RHSA-2020:2442[RHSA-2020:2442] advisory.

[[RHSA-2020:2443]]
=== RHSA-2020:2443 - Moderate: {product-title} 4.3 Security Update

Issued: 2020-06-16

An update for `containernetworking-plugins` is now available for
{product-title} 4.3. Details of the update are documented in the
link:https://access.redhat.com/errata/RHSA-2020:2443[RHSA-2020:2443] advisory.

[[ocp-4-3-26]]
=== RHBA-2020:2436 - {product-title} 4.3.26 Bug Fix Update

Issued: 2020-06-23

{product-title} release 4.3.26 is now available. The list of packages included
...
link:https://access.redhat.com/solutions/5168681[{product-title} 4.3.26 container image list]

[[ocp-4-3-26-features]]
==== Features

[[ocp-4-3-26-added-nodejs-jenkins-agent-v10-and-v12]]
...
[[ocp-4-3-26-bug-fixes]]
==== Bug Fixes

* Due to providing disconnected cluster support for samples in {product-title}
...
the analogous specs in `quay.io` or `registry.redhat.io`, which customers might
...
`registry.redhat.io`.
(link:https://bugzilla.redhat.com/show_bug.cgi?id=1826028[*BZ#1826028*])

* Previously, the web console only showed name, namespace, and creation date
when listing OLM Subscriptions on the Home -> Search page. The web console now
shows additional subscription details.
(link:https://bugzilla.redhat.com/show_bug.cgi?id=1827747[*BZ#1827747*])

* The Azure infrastructure name is used for generated Azure containers and
storage accounts. Therefore, if the Azure infrastructure name contained
uppercase letters, the container would successfully be created, but the storage
account creation would fail. This bug fix adjusts the container name creation
logic to discard invalid characters, allowing the image registry to deploy on an
infrastructure that contains invalid characters in its name.
(link:https://bugzilla.redhat.com/show_bug.cgi?id=1832144[*BZ#1832144*])

* The CVO had a race condition where it would consider a timed-out update
reconciliation cycle a successful update. This only happened for restricted
network clusters where the Operator timed out attempting to fetch release image
signatures. This bug caused the CVO to enter its shuffled-manifest
reconciliation mode, which could break the cluster if the manifests were applied
in an order that the components could not handle. The CVO now treats timed-out
updates as failures, so it no longer enters reconciling mode before the update
succeeds.
(link:https://bugzilla.redhat.com/show_bug.cgi?id=1844117[*BZ#1844117*])

[[ocp-4-3-26-upgrading]]
==== Upgrading
...
[[RHSA-2020:2635]]
=== RHSA-2020:2635 - Moderate: {product-title} 4.3 Security Update

Issued: 2020-06-23

An update for `python-psutil` is now available for {product-title} 4.3. Details of
the update are documented in the
link:https://access.redhat.com/errata/RHSA-2020:2635[RHSA-2020:2635] advisory.

[[ocp-4-3-27]]
=== RHBA-2020:2628 - {product-title} 4.3.27 Bug Fix Update

Issued: 2020-06-30

{product-title} release 4.3.27 is now available. The list of packages included
in the update are documented in the
link:https://access.redhat.com/errata/RHBA-2020:2627[RHBA-2020:2627] advisory.
The container images and bug fixes included in the update are provided by the
link:https://access.redhat.com/errata/RHBA-2020:2628[RHBA-2020:2628] advisory.

Space precluded documenting all of the container images for this release in the
advisory. See the following article for notes on the container images in this
release:

link:https://access.redhat.com/solutions/5186371[{product-title} 4.3.27 container image list]

[[ocp-4-3-27-upgrading]]
...
[[ocp-4-3-28]]
=== RHBA-2020:2805 - {product-title} 4.3.28 Bug Fix Update

Issued: 2020-07-07

{product-title} release 4.3.28 is now available. The list of packages included in
the update are documented in the
link:https://access.redhat.com/errata/RHBA-2020:2804[RHBA-2020:2804] advisory.
The container images and bug fixes included in the update are provided by the
link:https://access.redhat.com/errata/RHBA-2020:2805[RHBA-2020:2805] advisory.

Space precluded documenting all of the container images for this release in the
advisory. See the following article for notes on the container images in this
release:

link:https://access.redhat.com/solutions/5206471[{product-title} 4.3.28 container image list]

[[ocp-4-3-28-bug-fixes]]
==== Bug Fixes

* Previously, triggers did not work on v1.StatefulSet objects because the
trigger controller did not recognize StatefulSet as GA. The issue has been
resolved in this release.
(link:https://bugzilla.redhat.com/show_bug.cgi?id=1831888[*BZ#1831888*])
...
(link:https://bugzilla.redhat.com/show_bug.cgi?id=1835578[*BZ#1835578*])
...
specifies the UDP protocol, but the old Amphora image for the existent DNS load
balancer does not support the new listener and causes the listener creation to
fail. With this release, the DNS service that requires UDP is recreated,
causing the load balancer to be recreated with the new Amphora version.
Recreating the service and load balancer causes some down time for DNS
resolution. When this process is complete, the load balancer for the DNS service
is created with all the required listeners.
(link:https://bugzilla.redhat.com/show_bug.cgi?id=1846459[*BZ#1846459*])

* Previously, the Kubernetes volume plugin for Azure disks was not able to find
attached Azure volumes because it expected new udev rules installed on the host
operating system. As a result, any Pod that used the volumes could not start on
RHEL 7. With this release, the Kubernetes volume plugin for Azure disks scans
for attached Azure disks even with RHEL 7 udev rules, and Pods with Azure disk
volumes are able to start on RHEL 7.
(link:https://bugzilla.redhat.com/show_bug.cgi?id=1847089[*BZ#1847089*])
...
the correct order.
(link:https://bugzilla.redhat.com/show_bug.cgi?id=1849171[*BZ#1849171*])

[[ocp-4-3-28-upgrading]]
==== Upgrading
...
[[ocp-4-3-29]]
=== RHBA-2020:2872 - {product-title} 4.3.29 Bug Fix Update

Issued: 2020-07-14

{product-title} release 4.3.29 is now available. The list of packages included in
the update are documented in the
link:https://access.redhat.com/errata/RHBA-2020:2879[RHBA-2020:2879] advisory.
The container images and bug fixes included in the update are provided by the
link:https://access.redhat.com/errata/RHBA-2020:2872[RHBA-2020:2872] advisory.

Space precluded documenting all of the container images for this release in the
advisory. See the following article for notes on the container images in this
release:

link:https://access.redhat.com/solutions/5217801[{product-title} 4.3.29 container image list]

[[ocp-4-3-29-upgrading]]
==== Upgrading
...
[[ocp-4-3-31]]
=== RHBA-2020:3180 - {product-title} 4.3.31 Bug Fix Update

Issued: 2020-08-05

{product-title} release 4.3.31 is now available. The container images and bug
fixes in the update are documented in the
link:https://access.redhat.com/errata/RHBA-2020:3180[RHBA-2020:3180] advisory.
The list of packages included included in the update are provided by the
link:https://access.redhat.com/errata/RHBA-2020:3179[RHBA-2020:3179] advisory.

Space precluded documenting all of the container images for this release in the
advisory. See the following article for notes on the container images in this
release:

link:https://access.redhat.com/solutions/5286571[{product-title} 4.3.31 container image list]

[[ocp-4-3-31-upgrading]]
==== Upgrading
...
[[RHSA-2020:3183]]
=== RHSA-2020:3183 - Moderate: {product-title} 4.3 Security Update

Issued: 2020-08-05

An update for `openshift` is now available for {product-title} 4.3. Details of
the update are documented in the
link:https://access.redhat.com/errata/RHSA-2020:3183[RHSA-2020:3183] advisory.

[[RHSA-2020:3184]]
=== RHSA-2020:3184 - Moderate: {product-title} 4.3 Security Update

Issued: 2020-08-05

An update for `openshift-enterprise-hyperkube-container` is now available for
{product-title} 4.3. Details of the update are documented in the
link:https://access.redhat.com/errata/RHSA-2020:3184[RHSA-2020:3184] advisory.

[[ocp-4-3-33]]
=== RHBA-2020:3259 - {product-title} 4.3.33 Bug Fix Update

Issued: 2020-08-19

{product-title} release 4.3.33 is now available. The container images and bug
fixes in the update are documented in the
link:https://access.redhat.com/errata/RHBA-2020:3259[RHBA-2020:3259] advisory.
The list of packages included included in the update are provided by the
link:https://access.redhat.com/errata/RHBA-2020:3258[RHBA-2020:3258] advisory.

Space precluded documenting all of the container images for this release in the
advisory. See the following article for notes on the container images in this
release:

link:https://access.redhat.com/solutions/5323101[{product-title} 4.3.33 container image list]

[[ocp-4-3-33-upgrading]]
==== Upgrading
...
[[ocp-4-3-35]]
=== RHBA-2020:3457 - {product-title} 4.3.35 Bug Fix Update

Issued: 2020-09-09

{product-title} release 4.3.35 is now available. The container images and bug
fixes in the update are documented in the
link:https://access.redhat.com/errata/RHBA-2020:3457[RHBA-2020:3457] advisory.
The list of packages included included in the update are provided by the
link:https://access.redhat.com/errata/RHBA-2020:3458[RHBA-2020:3458] advisory.

Space precluded documenting all of the container images for this release in the
advisory. See the following article for notes on the container images in this
release:

link:https://access.redhat.com/solutions/5367171[{product-title} 4.3.35 container image list]

[[ocp-4-3-35-upgrading]]
==== Upgrading
...
[[RHSA-2020:3616]]
=== RHSA-2020:3616 - Important: {product-title} 4.3 Security Update

Issued: 2020-09-09

An update for `jenkins-2-plugins` is now available for {product-title} 4.3.
Details of the update are documented in the
link:https://access.redhat.com/errata/RHSA-2020:3616[RHSA-2020:3616] advisory.

[[ocp-4-3-38]]
=== RHBA-2020:3609 - {product-title} 4.3.38 Bug Fix Update

Issued: 2020-09-23

{product-title} release 4.3.38 is now available. The container images and bug
fixes in the update are documented in the
link:https://access.redhat.com/errata/RHBA-2020:3609[RHBA-2020:3609] advisory.
The list of packages included included in the update are provided by the
link:https://access.redhat.com/errata/RHBA-2020:3610[RHBA-2020:3610] advisory.

Space precluded documenting all of the container images for this release in the
advisory. See the following article for notes on the container images in this
release:

link:https://access.redhat.com/solutions/5424261[{product-title} 4.3.38 container image list]

[[ocp-4-3-38-upgrading]]
==== Upgrading
...
[[RHSA-2020:3808]]
=== RHSA-2020:3808 - Important: {product-title} 4.3 Security Update

Issued: 2020-09-23

An update for `jenkins` and `openshift` is now available for {product-title}
4.3. Details of the update are documented in the
link:https://access.redhat.com/errata/RHSA-2020:3808[RHSA-2020:3808] advisory.

[[RHSA-2020:3809]]
=== RHSA-2020:3809 - Moderate: {product-title} 4.3 Security Update

Issued: 2020-09-23

An update for `openshift-enterprise-hyperkube-container` and
`sriov-dp-admission-controller-container` is now available for {product-title}
4.3. Details of the update are documented in the
link:https://access.redhat.com/errata/RHSA-2020:3809[RHSA-2020:3809] advisory.

[[ocp-4-3-40]]
=== RHSA-2020:4264 - Low: {product-title} 4.3.40 Security and Bug Fix Update

Issued: 2020-10-20

{product-title} release 4.3.40, which includes a security update for `golang.org/x/crypto`, is now available. The container images, bug fixes, and CVEs in the update are documented in the link:https://access.redhat.com/errata/RHSA-2020:4264[RHSA-2020:4264] advisory.

Space precluded documenting all of the container images for this release in the advisory. See the following article for notes on the container images in this release:

link:https://access.redhat.com/solutions/5500271[{product-title} 4.3.40 container image list]

[[ocp-4-3-40-upgrading]]
==== Upgrading

To upgrade an existing {product-title} 4.3 cluster to this latest release, see xref:../updating/updating-cluster-cli.adoc#update-service-overview_updating-cluster-cli[Updating a cluster by using the CLI for instructions.]

[IMPORTANT]
====
If you are upgrading to this release from {product-title} 4.2 or {product-title} 4.3.3 or earlier, you must restart all Pods after the upgrade is complete.
...
[[RHSA-2020:4265]]
=== RHSA-2020:4265 - Important: {product-title} 4.3 Security Update

Issued: 2020-10-20

An update for `jenkins-2-plugins` is now available for {product-title} 4.3. Details of the update are documented in the link:https://access.redhat.com/errata/RHSA-2020:4265[RHSA-2020:4265] advisory.
