...
{product-title} {product-version} is supported on {op-system-base-full} 8.8 and any subsequent version of {op-system-base-full} 8 which is released before End of Life of {product-title} {product-version} and on {op-system-first} 4.15.
