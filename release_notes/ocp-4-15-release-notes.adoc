...
The Service Binding Operator is deprecated and will be removed in a future {product-title} release. See link:https://github.com/redhat-developer/service-binding-operator?tab=readme-ov-file#deprecation-notice[The Service Binding Operator] for more information.
