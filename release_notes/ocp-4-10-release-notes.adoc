...
For more information, see xref:../post_installation_configuration/network-configuration.adoc#nw-osp-enabling-ovs-offload_post-install-network-configuration
