...
* Previously the Ingress Operator would detect changes made through the Ingress Controller and set the Ingress Operator’s “Upgradeable” status condition to “False” blocking upgrades. With this update, the Ingress Operator no longer blocks upgrades. (link:https://bugzilla.redhat.com/show_bug.cgi?id=2097735[*BZ#2097735*])
