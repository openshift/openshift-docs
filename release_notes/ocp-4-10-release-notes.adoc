...
[id="ocp-4-10-27"]
=== RHSA-2022:6027 - {product-title} 4.10.27 bug fix and security update

Issued: 2022-08-16

{product-title} release 4.10.27, which includes security updates, is now available. The bug fixes that are included in the update are listed in the link:https://access.redhat.com/errata/RHSA-2022:5875[RHSA-2022:6027] advisory. The RPM packages that are included in the update are provided by the link:https://access.redhat.com/errata/RHBA-2022:6026[RHBA-2022:6026] advisory.

Space precluded documenting all of the container images for this release in the advisory. See the following article for notes on the container images in this release:

link:https://access.redhat.com/solutions/6971893[{product-title} 4.10.27 container image list]

[id="ocp-4-10-27-upgrading"]
==== Updating
