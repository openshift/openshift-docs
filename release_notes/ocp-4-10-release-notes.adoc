...
When using the web console, you can now switch between YAML and the form, keeping any changes made. Previously, changes were not retained when switching and, after switching to YAML, you could not return to the form.
