...
You can now select compute machine affinity when you install a cluster on {rh-openstack}. By default, compute machines are deployed with a soft anti-affinity policy, but you can also choose strict anti-affinity or anti-affinity server policies.
