...
[id="ocp-4-10-z"]
=== RHBA-2022:xxxx - {product-title} 4.10.z bug fix update

Issued: yyyy-mm-dd

{product-title} release 4.10.z is now available. The bug fixes that are included in the update are listed in the link:https://access.redhat.com/errata/RHBA-2022:xxxx[RHBA-2022:xxxx] advisory. The RPM packages that are included in the update are provided by the link:https://access.redhat.com/errata/RHBA-2022:xxxx[RHBA-2022:xxxx] advisory.

You can view the container images in this release by running the following command:

[source,terminal]
----
$ oc adm release info 4.y.z --pullspecs
----
//replace 4.y.z for the correct values for the release. You do not need to update oc to run this command.

[id="ocp-4-10-z-upgrading"]
==== Upgrading
