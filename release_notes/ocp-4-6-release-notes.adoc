...
[id="ocp-4-6-rhcos-uses-rhel"]
==== RHCOS now uses RHEL 8.2

{op-system} now uses {op-system-base} 8.2 packages in {product-title} 4.6. This enables you to have the latest fixes, features, and enhancements, as well as the latest hardware support and driver updates.
