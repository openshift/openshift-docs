...
Previously, details about how to maintain bare metal hosts in the web console were undocumented. This information has been added. For more information, see xref:../scalability_and_performance/managing-bare-metal-hosts.adoc[Managing bare metal hosts]
...
[id="ocp-4-6-noe-maintenance-operator-cr"]
==== Set nodes to maintenance mode using NodeMaintenance custom resources

Previously, putting a node into maintenance mode using a `NodeMaintenance` custom resource was not documented. This information has been added. For more information, see xref:../virt/node_maintenance/virt-setting-node-maintenance.adoc#virt-setting-node-to-maintenance-mode-with-cr_virt-setting-node-maintenance[Setting a node to maintenance mode with a NodeMaintenance custom resource]
