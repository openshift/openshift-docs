...
Previously, how to maintain bare metal hosts in the web console was not documented. This is now fixed. For more information, see xref:../scalability_and_performance/managing-bare-metal-hosts.adoc[Managing bare metal hosts]
