...
[id="ocp-4-6-rhcos-rhel-8-2-packages"]
==== {op-system} now uses {op-system-base} 8.2

{op-system} now uses {op-system-base-full} 8.2 packages in {product-title} 4.6. These packages provide you fixes, features, and enhancements, as well as hardware support and driver updates.
...
With this additional information, Red Hat can provide improved remediation steps in {cluster-manager-first}.
...
+
*Important*: If you are updating from an earlier release, update to 4.5.16 before you update to 4.6. (link:https://bugzilla.redhat.com/show_bug.cgi?id=1874671[*BZ#1874671*]).
...
[id="ocp-4-6-3-updating"]
==== Updating

To update an existing {product-title} 4.6 cluster to this latest release, see xref:../updating/updating-cluster-cli.adoc[Updating a cluster using the CLI] for instructions.
...
[id="ocp-4-6-57-updating"]
==== Updating

To update an existing {product-title} 4.6 cluster to this latest release, see xref:../updating/updating-cluster-cli.adoc[Updating a cluster using the CLI] for instructions.

[id="ocp-4-6-58"]
=== RHSA-2022:2264 - {product-title} 4.6.58 bug fix and security update

Issued: 2022-05-25

{product-title} release 4.6.58, which includes security updates, is now available. The bug fixes that are included in the update are listed in the link:https://access.redhat.com/errata/RHSA-2022:2264[RHSA-2022:2264] advisory. The RPM packages that are included in the update are provided by the link:https://access.redhat.com/errata/RHSA-2022:2263[RHSA-2022:2263] advisory.
...
[id="ocp-4-6-58-updating"]
==== Updating

To update an existing {product-title} 4.6 cluster to this latest release, see xref:../updating/updating-cluster-cli.adoc[Updating a cluster using the CLI] for instructions.

[id="ocp-4-6-59"]
=== RHBA-2022:4948 - {product-title} 4.6.59 bug fix and security update

Issued: 2022-06-17

{product-title} release 4.6.59, which includes security updates, is now available. The bug fixes that are included in the update are listed in the link:https://access.redhat.com/errata/RHBA-2022:4948[RHBA-2022:4948] advisory. The RPM packages that are included in the update are provided by the link:https://access.redhat.com/errata/RHSA-2022:4947[RHSA-2022:4947] advisory.
...
[id="ocp-4-6-59-updating"]
==== Updating

To update an existing {product-title} 4.6 cluster to this latest release, see xref:../updating/updating-cluster-cli.adoc[Updating a cluster using the CLI] for instructions.

[id="ocp-4-6-60"]
=== RHBA-2022:5572 - {product-title} 4.6.60 bug fix update

Issued: 2022-07-21

{product-title} release 4.6.60, is now available. The bug fixes that are included in the update are listed in the link:https://access.redhat.com/errata/RHBA-2022:5572[RHBA-2022:5572] advisory. The RPM packages that are included in the update are provided by the link:https://access.redhat.com/errata/RHBA-2022:5571[RHBA-2022:5571] advisory.
...
[id="ocp-4-6-60-updating"]
==== Updating

To update an existing {product-title} 4.6 cluster to this latest release, see xref:../updating/updating-cluster-cli.adoc[Updating a cluster using the CLI] for instructions.

[id="ocp-4-6-61"]
=== RHSA-2022:6262 - {product-title} 4.6.61 bug fix update

Issued: 2022-09-09

{product-title} release 4.6.61, which includes security fixes, is now available. The bug fixes that are included in the update are listed in the link:https://access.redhat.com/errata/RHSA-2022:6262[RHSA-2022:6262] advisory. The RPM packages that are included in the update are provided by the link:https://access.redhat.com/errata/RHBA-2022:6261[RHBA-2022:6261] advisory.
...
[id="ocp-4-6-61-updating"]
==== Updating

To update an existing {product-title} 4.6 cluster to this latest release, see xref:../updating/updating-cluster-cli.adoc[Updating a cluster using the CLI] for instructions.

[id="ocp-4-6-62"]
=== RHBA-2022:7306 - {product-title} 4.6.62 bug fix update

Issued: 2022-11-10

{product-title} release 4.6.62 is now available. The bug fixes that are included in the update are listed in the link:https://access.redhat.com/errata/RHBA-2022:7306[RHBA-2022:7306] advisory. The RPM packages that are included in the update are provided by the link:https://access.redhat.com/errata/RHBA-2022:7305[RHBA-2022:7305] advisory.

You can view the container images in this release by running the following command:

[source,terminal]
----
$ oc adm release info 4.6.62 --pullspecs
----

[id="ocp-4-6-62-updating"]
==== Updating
