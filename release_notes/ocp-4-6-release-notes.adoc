...
[id="ocp-4-6-2"]
=== RHBA-2020:4339 - {product-title} 4.6.2 image release and bug fix advisory

Issued: 2020-11-09

{product-title} release 4.6.2 is now available. The list of container images and bug fixes included in the update are documented in the link:https://access.redhat.com/errata/RHBA-2020:4339[RHBA-2020:4339] advisory. The RPM packages included in the update are provided by the link:https://access.redhat.com/errata/RHBA-2020:4340[RHBA-2020:4340] advisory.

Space precluded documenting all of the container images for this release in the advisory. See the following article for notes on the container images in this release:

link:https://access.redhat.com/solutions/5551151[{product-title} 4.6.2 container image list]
