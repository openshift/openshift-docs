...
https://cloud.redhat.com/openshift. The Red Hat OpenShift Cluster Manager
...
{product-title}. See link:https://issues.jboss.org/browse/OSSM-39[Issue OSSM-39]
for more information. For a workaround, see
link:https://access.redhat.com/solutions/4507801[Openshift Container Platform
4.x Upgrade Fails When OpenShift Service Mesh is Installed].
