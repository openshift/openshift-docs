...
[[ocp-4-2-21]]
=== RHBA-2020:0613 - {product-title} 4.2.21 Bug Fix Update

Issued: 2020-03-03

{product-title} release 4.2.21 is now available. The list of packages included in
the update are documented in the
link:https://access.redhat.com/errata/RHBA-2020:0613[RHBA-2020:0613] advisory.
The container images and bug fixes included in the update are provided by the
link:https://access.redhat.com/errata/RHBA-2020:0614[RHBA-2020:0614] advisory.

Space precluded documenting all of the container images for this release in the
advisory. See the following article for notes on the container images in this
release:

link:https://access.redhat.com/solutions/4867621[{product-title} 4.2.21 container image list]

[[ocp-4-2-21-upgrading]]
==== Upgrading

To upgrade an existing {product-title} 4.2 cluster to this latest release, see
xref:../updating/updating-cluster-cli.adoc#update-service-overview_updating-cluster-cli[Updating a cluster by using the CLI for instructions.]

[[ocp-4-2-21-known-issues]]
==== Known issues

For the NFD Operator deployment to succeed, you must use the default update
channel of `4.3` and choose the default namespace, not custom namespace.
(link:https://bugzilla.redhat.com/show_bug.cgi?id=1808503[*BZ#1808503*])

[[RHSA-2020-0617]]
=== RHSA-2020:0617 - Moderate: {product-title} 4.2 security update

Issued: 2020-03-03

An update is now available for {product-title} 4.2. Details of the update are
documented in the
link:https://access.redhat.com/errata/RHSA-2020:0617[RHSA-2020:0617] advisory.

[[RHSA-2020-0652]]
=== RHSA-2020:0652 - Moderate: {product-title} 4.2 security update

Issued: 2020-03-03

An update for ose-installer-artifacts-container and ose-installer-container is
now available for {product-title} 4.2. Details of the update are documented in
the link:https://access.redhat.com/errata/RHSA-2020:0652[RHSA-2020:0652]
advisory.

[[ocp-4-2-22]]
=== RHBA-2020:0684 - {product-title} 4.2.22 Bug Fix Update

Issued: 2020-03-10

{product-title} release 4.2.22 is now available. The list of packages included in
the update are documented in the
link:https://access.redhat.com/errata/RHBA-2020:0684[RHBA-2020:0684] advisory.
The container images and bug fixes included in the update are provided by the
link:https://access.redhat.com/errata/RHBA-2020:0685[RHBA-2020:0685] advisory.

Space precluded documenting all of the container images for this release in the
advisory. See the following article for notes on the container images in this
release:

link:https://access.redhat.com/solutions/4880181[{product-title} 4.2.22 container image list]

[[ocp-4-2-22-upgrading]]
==== Upgrading
...
[[RHSA-2020-0688]]
=== RHSA-2020:0688 - Moderate: {product-title} 4.2 security update

Issued: 2020-03-10

An update for runc is now available for {product-title} 4.2. Details of the
update are documented in the
link:https://access.redhat.com/errata/RHSA-2020:0688[RHSA-2020:0688] advisory.

[[RHSA-2020-0689]]
=== RHSA-2020:0689 - Moderate: {product-title} 4.2 security update

Issued: 2020-03-10

An update for skopeo is now available for {product-title} 4.2. Details of the
update are documented in the
link:https://access.redhat.com/errata/RHSA-2020:0689[RHSA-2020:0689] advisory.

[[ocp-4-2-23]]
=== RHBA-2020:0786 - {product-title} 4.2.23 Bug Fix Update

Issued: 2020-03-18

{product-title} release 4.2.23 is now available. The list of packages included in
the update are documented in the
link:https://access.redhat.com/errata/RHBA-2020:0786[RHBA-2020:0786] advisory.
The container images and bug fixes included in the update are provided by the
link:https://access.redhat.com/errata/RHBA-2020:0787[RHBA-2020:0787] advisory.

Space precluded documenting all of the container images for this release in the
advisory. See the following article for notes on the container images in this
release:

link:https://access.redhat.com/solutions/4903761[{product-title} 4.2.23 container image list]

[[ocp-4-2-23-upgrading]]
==== Upgrading
...
[[ocp-4-2-25]]
=== RHBA-2020:0826 - {product-title} 4.2.25 Bug Fix Update

Issued: 2020-03-25

{product-title} release 4.2.25 is now available. The list of packages included in
the update are documented in the
link:https://access.redhat.com/errata/RHBA-2020:0825[RHBA-2020:0825] advisory.
The container images and bug fixes included in the update are provided by the
link:https://access.redhat.com/errata/RHBA-2020:0826[RHBA-2020:0826] advisory.

Space precluded documenting all of the container images for this release in the
advisory. See the following article for notes on the container images in this
release:

link:https://access.redhat.com/solutions/4921141[{product-title} 4.2.25 container image list]

[[ocp-4-2-25-upgrading]]
==== Upgrading
...
[[RHSA-2020-0830]]
=== RHSA-2020:0830 - Moderate: {product-title} 4.2 security update

Issued: 2020-03-25

An update for openshift-enterprise-mediawiki-container is now available for {product-title} 4.2. Details of the
update are documented in the
link:https://access.redhat.com/errata/RHSA-2020:0830[RHSA-2020:0830] advisory.

[[ocp-4-2-26]]
=== RHBA-2020:0935 - {product-title} 4.2.26 Bug Fix Update

Issued: 2020-04-02

{product-title} release 4.2.26 is now available. The list of packages included in
the update are documented in the
link:https://access.redhat.com/errata/RHBA-2020:0935[RHBA-2020:0935] advisory.
The container images and bug fixes included in the update are provided by the
link:https://access.redhat.com/errata/RHBA-2020:0936[RHBA-2020:0936] advisory.

Space precluded documenting all of the container images for this release in the
advisory. See the following article for notes on the container images in this
release:

link:https://access.redhat.com/solutions/4931791[{product-title} 4.2.26 container image list]

[[ocp-4-2-26-upgrading]]
==== Upgrading
...
[[ocp-4-2-27]]
=== RHBA-2020:1263 - {product-title} 4.2.27 Bug Fix Update

Issued: 2020-04-07

{product-title} release 4.2.27 is now available. The list of packages included in
the update are documented in the
link:https://access.redhat.com/errata/RHBA-2020:1256[RHBA-2020:1256] advisory.
The container images and bug fixes included in the update are provided by the
link:https://access.redhat.com/errata/RHBA-2020:1263[RHBA-2020:1263] advisory.

Space precluded documenting all of the container images for this release in the
advisory. See the following article for notes on the container images in this
release:

link:https://access.redhat.com/solutions/4966501[{product-title} 4.2.27 container image list]

[[ocp-4-2-27-upgrading]]
==== Upgrading
...
[[ocp-4-2-28]]
=== RHBA-2020:1398 - {product-title} 4.2.28 Bug Fix Update

Issued: 2020-04-14

{product-title} release 4.2.28 is now available. The list of packages included in
the update are documented in the
link:https://access.redhat.com/errata/RHBA-2020:1397[RHBA-2020:1397] advisory.
The container images and bug fixes included in the update are provided by the
link:https://access.redhat.com/errata/RHBA-2020:1398[RHBA-2020:1398] advisory.

Space precluded documenting all of the container images for this release in the
advisory. See the following article for notes on the container images in this
release:

link:https://access.redhat.com/solutions/4978111[{product-title} 4.2.28 container image list]

[[ocp-4-2-28-upgrading]]
==== Upgrading
...
[[RHSA-2020-1401]]
=== RHSA-2020:1401 - Important: {product-title} 4.2 security update

Issued: 2020-04-14

An update for buildah is now available for {product-title} 4.2. Details of the
update are documented in the
link:https://access.redhat.com/errata/RHSA-2020:1401[RHSA-2020:1401] advisory.

[[RHSA-2020-1402]]
=== RHSA-2020:1402 - Moderate: {product-title} 4.2 security update

Issued: 2020-04-14

An update for openshift-enterprise-builder-container is now available for {product-title} 4.2. Details of the
update are documented in the
link:https://access.redhat.com/errata/RHSA-2020:1402[RHSA-2020:1402] advisory.

[[ocp-4-2-29]]
=== RHBA-2020:1450 - {product-title} 4.2.29 Bug Fix Update

Issued: 2020-04-21

{product-title} release 4.2.29 is now available. The list of packages included in
the update are documented in the
link:https://access.redhat.com/errata/RHBA-2020:1451[RHBA-2020:1451] advisory.
The container images and bug fixes included in the update are provided by the
link:https://access.redhat.com/errata/RHBA-2020:1450[RHBA-2020:1450] advisory.

Space precluded documenting all of the container images for this release in the
advisory. See the following article for notes on the container images in this
release:

link:https://access.redhat.com/solutions/4999561[{product-title} 4.2.29 container image list]

[[ocp-4-2-29-upgrading]]
==== Upgrading
...
[[RHSA-2020-1526]]
=== RHSA-2020:1526 - Moderate: {product-title} 4.2 security update

Issued: 2020-04-21

An update for openshift-enterprise-hyperkube-container is now available for
{product-title} 4.2. Details of the update are documented in the
link:https://access.redhat.com/errata/RHSA-2020:1526[RHSA-2020:1526] advisory.

[[RHSA-2020-1527]]
=== RHSA-2020:1527 - Moderate: {product-title} 4.2 security update

Issued: 2020-04-21

An update for openshift is now available for {product-title} 4.2. Details of the
update are documented in the
link:https://access.redhat.com/errata/RHSA-2020:1527[RHSA-2020:1527] advisory.

[[ocp-4-2-33]]
=== RHBA-2020:2023 - {product-title} 4.2.33 Bug Fix Update

Issued: 2020-05-13

{product-title} release 4.2.33 is now available. The list of packages included in
the update are documented in the
link:https://access.redhat.com/errata/RHBA-2020:2022[RHBA-2020:2022] advisory.
The container images and bug fixes included in the update are provided by the
link:https://access.redhat.com/errata/RHBA-2020:2023[RHBA-2020:2023] advisory.

Space precluded documenting all of the container images for this release in the
advisory. See the following article for notes on the container images in this
release:

link:https://access.redhat.com/solutions/5062021[{product-title} 4.2.33 container image list]

[[ocp-4-2-33-upgrading]]
==== Upgrading
...
[[RHSA-2020-2026]]
=== RHSA-2020:2026 - Important: {product-title} 4.2 security update

Issued: 2020-05-13

An update for openshift-cluster-image-registry-operator is now available for
{product-title} 4.2. Details of the update are documented in the
link:https://access.redhat.com/errata/RHSA-2020:2026[RHSA-2020:2026] advisory.

[[RHSA-2020-2027]]
=== RHSA-2020:2027 - Moderate: {product-title} 4.2 security update
...
[[ocp-4-2-36]]
=== RHBA-2020:2589 - {product-title} 4.2.36 Bug Fix Update

Issued: 2020-07-01

{product-title} release 4.2.36 is now available. The list of packages included in
the update are documented in the
link:https://access.redhat.com/errata/RHBA-2020:2588[RHBA-2020:2588] advisory.
The container images and bug fixes included in the update are provided by the
link:https://access.redhat.com/errata/RHBA-2020:2589[RHBA-2020:2589] advisory.

Space precluded documenting all of the container images for this release in the
advisory. See the following article for notes on the container images in this
release:

link:https://access.redhat.com/solutions/5186841[{product-title} 4.2.36 container image list]

[[ocp-4-2-36-upgrading]]
==== Upgrading
...
[[RHSA-2020-2592]]
=== RHSA-2020:2592 - Moderate: {product-title} 4.2 security update

Issued: 2020-07-01

An update for containernetworking-plugins is now available for {product-title}
4.2. Details of the update are documented in the
link:https://access.redhat.com/errata/RHSA-2020:2592[RHSA-2020:2592] advisory.

[[RHSA-2020-2593]]
=== RHSA-2020:2593 - Moderate: {product-title} 4.2 security update

Issued: 2020-07-01

An update for python-psutil is now available for {product-title} 4.2. Details of
the update are documented in the
link:https://access.redhat.com/errata/RHSA-2020:2593[RHSA-2020:2593] advisory.

[[RHSA-2020-2594]]
=== RHSA-2020:2594 - Moderate: {product-title} 4.2 security update

Issued: 2020-07-01

An update for openshift is now available for {product-title} 4.2. Details of the
update are documented in the
link:https://access.redhat.com/errata/RHSA-2020:2594[RHSA-2020:2594] advisory.

[[RHSA-2020-2595]]
=== RHSA-2020:2595 - Moderate: {product-title} 4.2 security update

Issued: 2020-07-01

An update for ose-machine-config-operator-container is now available for
{product-title} 4.2. Details of the update are documented in the
link:https://access.redhat.com/errata/RHSA-2020:2595[RHSA-2020:2595] advisory.

[[RHSA-2020-2776]]
=== RHSA-2020:2776 - Moderate: {product-title} 4.2 security update

Issued: 2020-07-01

An update for cri-o is now available for {product-title} 4.2. Details of the
update are documented in the
link:https://access.redhat.com/errata/RHSA-2020:2776[RHSA-2020:2776] advisory.
