...
* Fixed an issue where vulnerability data differed between Vulnerability Management 2.0 and Vulnerability Management 1.0 due to inconsistencies in vulnerability reporting, affecting images such as `quay.io/openshift-release-dev/ocp-v4.0-art-dev`.
