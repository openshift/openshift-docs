...
With {product-title-short} 4.4, the {product-title-short} Operator is independent of the platform. It has a longer life cycle, full and maintenance support phases have been introduced, and the release cadence has been reduced.

For more information, see the Red Hat Knowledge Base solution link:https://access.redhat.com/articles/7045053[{product-title} Support Matrix].
