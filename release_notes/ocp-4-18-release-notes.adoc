...
{product-title} {product-version} is supported on {op-system-base-full} 8.8 and a later version of {op-system-base-full} 8 that is rleased before End of Life (EoL) of {product-title} {product-version} as well as on {op-system-first} 4.18
