...
* Disk encryption with PCR 1 and 7 protection fails on systems that automatically create additional EFI entries during boot. These extra entries modify EFI variables, preventing server attestation with PCR 1. (link:https://issues.redhat.com/browse/OCPBUGS-45985[*OCPBUGS-45985*])
