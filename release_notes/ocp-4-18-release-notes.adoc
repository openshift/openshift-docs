...
[id="ocp-4-18-installation-and-update-aws-thailand{context}"]
==== Installing a cluster on {aws-short} in the Thailand region

You can now install an {product-title} cluster on {aws-short} in the Thailand region (`ap-southeast-7`).
