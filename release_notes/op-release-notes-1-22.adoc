...
[id="op-release-notes-1-22"]
= {pipelines-title} release notes
:context: op-release-notes-1-22
:toc:
...
// Release notes for Red Hat OpenShift Pipelines 1.22.6
include::modules/op-release-notes-1-22-6.adoc[leveloffset=+1]
