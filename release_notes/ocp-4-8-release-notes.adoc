...
* Previously, some resource names in the *Resources* menu and the kind for some resources were not internationalized. The menu is now internationalized. (link:https://bugzilla.redhat.com/show_bug.cgi?id=1921267[*BZ#1921267*])
...
* Tables previously displaying incorrectly on mobile devices now display correctly. (link:https://bugzilla.redhat.com/show_bug.cgi?id=1927013[*BZ#1927013*])
