...
* Previously, Reliable Autonomic Distributed Object Store (RADOS) Block Devices (RBDs) were visible in unprivileged container pods running `lsbkk`. This has been fixed and RBDs no longer are visible in unprivileged container pods running `lsblk`. (link:https://bugzilla.redhat.com/show_bug.cgi?id=1772993[*BZ#1772993*]).
