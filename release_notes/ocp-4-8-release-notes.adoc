...
This release includes critical security updates for link:https://access.redhat.com/security/cve/CVE-2021-44228[CVE-2021-44228], which affects the Apache Log4j utility. Fixes for this flaw are provided by the link:https://access.redhat.com/errata/RHSA-2021:5108[RHSA-2021:5108] advisory.
