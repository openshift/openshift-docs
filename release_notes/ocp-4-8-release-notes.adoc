...
The automatic rotation of the `/etc/kubernetes/kubelet-ca.crt` certificate authority (CA) no longer forces a reboot of the cluster. This CA is managed by the system and not the user.
