...
//ROX-31554
* Fixed an issue that caused Central to panic when receiving unknown event types from newer Sensor versions.

This release addresses the following security vulnerability:

* Race condition during query cancellation in the database/sql standard library (link:https://access.redhat.com/security/cve/cve-2025-47907[CVE-2025-47907])
