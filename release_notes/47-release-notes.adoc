...
//ROX-29320
* Before this update, Scanner V4 falsely claimed not to support RHEL 10, although this was always the case. Scanner V4 now correctly indicates that it supports RHEL 10.
...
* link:https://access.redhat.com/security/cve/cve-2025-22871[CVE-2025-22871] Flaw in `net/http` allowed request smuggling due to improper handling of bare line feed (LF) in chunked data.
