...
* Migrates RHEL Server hosts to the RPM-based method for the kubelet
* Migrates container runtime and RHEL Atomic Hosts to the system container-based method for the kubelet only (since container runtime is part of RHEL Atomic Host.)
