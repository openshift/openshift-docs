...
See
xref:../install_config/logging/aggregate_logging_logs.html#sending-logs-to-external-rsyslog[Sending
...
|xref:../install_config/logging/aggregate_logging.adoc#aggregated-fluentd[Mux]
|TP
|TP
|TP
