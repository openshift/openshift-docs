...
As of {product-title} 3.10.119, Kuryr is moved out of
xref:ocp-310-technology-preview[Technology Preview] and now generally available.
...
|-
|-
|xref:ocp-3-10-119[GA*] footnoteref:[disclaimer]
...
With this release, xref:ocp-310-kuryr[Kuryr] is now moved out of
xref:ocp-310-technology-preview[Technology Preview] and now generally available.
