...
For more information, see xref:../using_images/other_images/jenkins_agents.adoc#using-images-other-images-jenkins-agents[Jenkins Agents].
...
longer supported, (sans the kubelet) with the exception of the node service RHEL
