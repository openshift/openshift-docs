...
- The integrated container registry now supports _image pullthrough_, allowing you to
...
----
+
Log into your local container registry, then pull the image from the integrated
registry:
+
----
...
a container Registry] for more information.
...
the container registry is version 2.2.x or earlier. {product-title} 3.2 currently
ships container registry 2.2.1. If you are using S3 storage with your registry, it
...
pushing and pulling images. {product-title} 3.2 currently ships container registry
