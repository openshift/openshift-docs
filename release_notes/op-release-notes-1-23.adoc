...
For an overview of {pipelines-title}, see xref:../discover/evaluate-openshift-pipelines-for-your-cicd-needs.adoc#understanding-openshift-pipelines_evaluate-openshift-pipelines-for-your-cicd-needs[Understand {pipelines-shortname} concepts].
