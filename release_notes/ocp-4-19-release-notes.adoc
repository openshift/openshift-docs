...
The *Getting Started* pane in the web console also provides resources such as, a tour of the console, information on setting up your cluster, and links to explore new features and capabilities.
