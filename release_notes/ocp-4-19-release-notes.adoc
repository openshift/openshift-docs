...
[id="ocp-4-19-installation-and-update-nutanix-agent-based-installer_{context}"]
==== Support for using the Agent-based Installer with Nutanix

With this release, you can install an {product-title} cluster on Nutanix by using the Agent-based Installer.

For more information, see xref:../installing/installing_nutanix/preparing-to-install-on-nutanix.adoc#preparing-to-install-on-nutanix-agent_preparing-to-install-on-nutanix[Agent-based Installer].
