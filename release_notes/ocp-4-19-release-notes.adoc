...
[id="ocp-4-19-install-update-cvo-log-levels_{context}"]
...
For more information, see xref:../updating/troubleshooting_updates/gathering-data-cluster-update.adoc#changing-log-data_troubleshooting_updates[Changing the CVO log level].
