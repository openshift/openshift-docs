...
// 4.19.47 RNs and updating
include::modules/zstream-4-19-47.adoc[leveloffset=+2]

// 4.19.45 RNs and updating
include::modules/zstream-4-19-45.adoc[leveloffset=+2]
...
// 4.19.34 z-stream RNs full document
