...
{product-title} 4.17 reintroduced a removed Kubernetes API, `admissionregistration.k8s.io/v1beta1`. This API is deprecated and is planned for removal in a future {product-title} release. Migrate any instances of this API to `admissionregistration.k8s.io/v1`.
