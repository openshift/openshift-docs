...
==== External Secrets Operator for Red Hat OpenShift (Technology Preview)
With this release, you can use the {external-secrets-operator}, available as a Technology Preview.
