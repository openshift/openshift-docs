...
This release now includes an _etcd_ section, where all of the existing documentation about etcd for {product-title} is consolidated. For more information, see xref:../etcd/etcd-overview.adoc#etc-overview[Overview of etcd].
