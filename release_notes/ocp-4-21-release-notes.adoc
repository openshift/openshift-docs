...
[id="ocp-4-21-about-this-release_{context}"]
== About this release
...
[id="ocp-4-21-add-on-support-status_{context}"]
...
[id="ocp-4-21-new-features-and-enhancements_{context}"]
...
[id="ocp-4-21-install-update-cvo-log-levels_{context}"]
...
[id="ocp-4-21-installation-and-update-vsphere-multiple-nics_{context}"]
...
[id="ocp-4-21-admin-ack-updating_{context}"]
==== Required administrator acknowledgment when updating from {product-title} 4.19 to 4.20

In {product-title} 4.17, a previously xref:../release_notes/ocp-4-21-release-notes.adoc#ocp-4-21-removed-kube-apis_release-notes[removed Kubernetes API] was inadvertently reintroduced. It has been removed again in {product-title} 4.20.
...
[id="ocp-4-21-capi-aws-capacity-preferences_{context}"]
...
[id="ocp-4-21-release-notes-monitoring_{context}"]
=== Monitoring

The in-cluster monitoring stack for this release includes the following new and modified features:

[id="ocp-4-21-monitoring-updates-to-monitoring-stack-components-and-dependencies"]
...
[id="ocp-4-21-monitoring-changes-to-alerting-rules"]
...
[id="ocp-4-21-monitoring-support-log-verbosity-for-metrics-server"]
...
[id="ocp-4-21-networking-gateway-api-ossm-version-bump_{context}"]
...
[id="ocp-4-21-support-for-bgp-routing-protocol_{context}"]
...
[id="ocp-4-21-support-for-route-advertisements-cudns-with-bgp_{context}"]
...
[id="ocp-4-21-tech-preview-PreconfiguredUDNAddresses_{context}"]
...
[id="ocp-4-21-migration-configure-ovs-nmstate_{context}"]
...
[id="ocp-4-21-networking-arm-dual-oc_{context}"]
...
[id="ocp-4-21-networking-namespaced-sriov-app-owners_{context}"]
...
[id="ocp-4-21-unnumbered-bgp-peering_{context}"]
...
[id="ocp-4-21-networking-pfrs-operator_{context}"]
...
[id="ocp-4-21-network-policies_{context}"]
...
[id="ocp-4-21-ptp-holdover_{context}"]
...
[id="ocp-4-21-coreos-ignition-2-21_{context}"]
==== Ignition update to version 2.21.0
...
[id="ocp-4-21-coreos-butane-0-23_{context}"]
==== Butane update to version 0.23.0

{op-system} now includes Butane version 0.23.0.

[id="ocp-4-21-coreos-rust-afterburn-5-7_{context}"]
...
[id="ocp-4-21-coreos-installer-update_{context}"]
...
[id="ocp-4-21-receive-packet-steering-disabled_{context}"]
...
[id="ocp-4-21-oc-mirror-v2-verify-creds_{context}"]
...
[id="ocp-4-21-docker-v2-registries-removed_{context}"]
...
[id="ocp-4-21-sunset-redhat-marketplace_{context}"]
...
[id="ocp-4-21-removed-kube-apis_{context}"]
...
.Kubernetes APIs removed from {product-title} 4.21
...
[source,terminal]
----
$ oc adm release info 4.21.0 --pullspecs
----

[id="ocp-4-21-0-updating_{context}"]
==== Updating
