...
The {ibmzProductName} and {linuxoneProductName} release on {product-title} adds improvements and new capabilities to {product-title} components and concepts.
...
[discrete]
==== {ibmzProductName} and {linuxoneProductName} supported and unsupported features
...
The following feature is available only for {product-title} on {ibmzProductName} and {linuxoneProductName}:

* HyperPAV enabled on {ibmzProductName} and {linuxoneProductName} for the virtual machines for FICON attached ECKD storage
====

.The following features are not supported on {product-title} on {ibmzProductName} and {linuxoneProductName}:
[%collapsible]
====
...
The {ibmpowerProductName} release on {product-title} adds improvements and new capabilities to {product-title} components and concepts.
...
[discrete]
==== {ibmpowerProductName} supported and unsupported features
...
.The following features are not supported on {product-title} on {ibmpowerProductName}:
[%collapsible]
====
