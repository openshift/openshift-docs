...
[[ocp-3-6-173-0-138]]
=== RHBA-2018:3598 - {product-title} 3.6.173.0.138 Bug Fix and Enhancement Update

Issued: 2018-11-19

{product-title} release 3.6.173.0.138 is now available. The list of packages and
bug fixes included in the update are documented in the
link:https://access.redhat.com/errata/RHBA-2018:3598[RHBA-2018:3598] advisory.
The list of container images included in the update are documented in the
link:https://access.redhat.com/errata/RHBA-2018:3597[RHBA-2018:3597] advisory.

[[ocp-3-6-173-0-138-upgrading]]
==== Upgrading
