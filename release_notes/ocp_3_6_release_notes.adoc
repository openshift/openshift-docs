...
[[ocp-3-6-rhea-2017-2644]]
=== RHEA-2017:2644 - {product-title} 3.6.1 images update

Issued: 2017-09-08

{product-title} release 3.6.1 is now available. The list of container
images included in the update are documented in the
...
[[ocp-3-6-rhea-2017-2644-upgrading]]
==== Upgrading
