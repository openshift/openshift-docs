...
// Release notes for Red Hat OpenShift GitOps 1.14.4
include::modules/gitops-release-notes-1-14-4.adoc[leveloffset=+1]

// Release notes for Red Hat OpenShift GitOps 1.14.3
include::modules/gitops-release-notes-1-14-3.adoc[leveloffset=+1]
...
include::modules/gitops-release-notes-1-14-0.adoc[leveloffset=+1]