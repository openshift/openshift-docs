...
//ROX-32636
* Fixed an issue where the scanner-db deployment failed to trigger `Container with privilege escalation allowed` violations by ensuring the security context correctly defaults to `allowPrivilegeEscalation: true` when unspecified.
