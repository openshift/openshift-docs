...
//ROX-31406
* Fixed an issue where duplicate policy categories appeared in the console due to inconsistent case sensitivity.
...
* Denial of service in `golang.org/x/crypto` (link:https://access.redhat.com/security/cve/cve-2025-47913[CVE-2025-47913])
