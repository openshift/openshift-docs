...
|`/v1/clustercves/suppress` APIs^[10,11]^
|DEP
|DEP
|DEP

|`/v1/clustercves/unsuppress` APIs^[10,11]^
|DEP
|DEP
|DEP

|`/v1/nodecves/suppress` APIs^[10,11]^
|DEP
|DEP
|DEP

|`/v1/nodecves/unsuppress` APIs^[10,11]^
|DEP
|DEP
|DEP
...
|Vulnerability Management (1.0) menu item^[12]^
|DEP
|DEP
|DEP
