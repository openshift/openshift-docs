...
For more information, see the xref:../operators/reference/operator-reference.adoc#cluster-cloud-controller-manager-operator_red-hat-operators[Cluster Cloud Controller Manager Operator] entry in the _Red Hat Operators reference_.
...
* See xref:ocp-kubernetes-1-22-3-updates[Updates from Kubernetes 1.22.3]

|OpenShift Pipelines Operator
|1.2.4
|Bug fixes:

* xref:ocp-4-9-9-BZ2022570[BZ#2022570]
|===
