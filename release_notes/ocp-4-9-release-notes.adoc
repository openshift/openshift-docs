...
With this update, administrators now have the ability to access node logs from the *Node* page. You can switch between individual log files and journal log units in order to inquire about the node by clicking the *Logs* tab. 
...
* Here (link:https://bugzilla.redhat.com/show_bug.cgi?id=2006756[*BZ#2006756*])
