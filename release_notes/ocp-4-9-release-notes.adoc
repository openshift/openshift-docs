...
* Previously, some OpenStack object storage instances responded with `204 No Content` when listing requests with no containers or objects. In these cases, {product-title} did not correctly handle listing responses. With this update, the installation program works around the issue of zero items to list. (link:https://issues.redhat.com/browse/OCPBUGS-6086[*OCPBUGS_6086*])
