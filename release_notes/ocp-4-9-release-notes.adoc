...
[id="ocp-4-9-operator-updates"]
== Operator reference

{product-title} 4.9 introduces or updates the following Operators:
...
* See xref:ocp-4-9-ptp-fast-event-notifications[Monitoring PTP fast events with the PTP fast event notification framework]

|OpenShift Pipelines Operator
|1.2.3
|New features:

* See xref:ocp-4-9-web-console-developer-perspective[Developer perspective]

|Special Resource Operator (new)
|1.0.0
|Technology Preview features:

* See xref:ocp-4-9-scale-special-resource-operator[Special Resource Operator (Technology Preview)]
...
* See xref:ocp-4-9-sriov-single-node[SR-IOV support for single node clusters]

|NFD Operator
|2.3.4
|New features:

* See xref:ocp-4-9-ibm-z[IBM Z and LinuxONE]
...
* See xref:ocp-4-9-networking-metallb[MetalLB load balancer]

|OpenShift Elasticsearch Operator
|2.3.4
|Notable technical changes:

* See xref:ocp-4-9-ibm-z[Elasticsearch changes]
