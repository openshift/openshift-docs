...
* For the OVN-Kubernetes cluster network provider, multicast traffic originating from a node is not broadcast to other nodes in the cluster. This will be resolved in a future release. (link:https://bugzilla.redhat.com/show_bug.cgi?id=2010374[*BZ#2010374*])
