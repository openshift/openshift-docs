...
[id="ocp-4-9-44"]
=== RHSA-2022:5668 - {product-title} 4.9.44 bug fix and security update

Issued: 2022-07-26

{product-title} release 4.9.44, which includes security updates, is now available. The bug fixes that are included in the update are listed in the link:https://access.redhat.com/errata/RHSA-2022:5668[RHSA-2022:5668] advisory. The RPM packages that are included in the update are provided by the link:https://access.redhat.com/errata/RHBA-2022:5667[RHBA-2022:5667] advisory.

Space precluded documenting all of the container images for this release in the advisory. See the following article for notes on the container images in this release:

link:https://access.redhat.com/solutions/6969340[{product-title} 4.9.44 container image list]

[id="ocp-4-9-44-updating"]
==== Updating
