...
<2> Update the `release-namespace` annotation to match the namespace if you used different name during your initial installation. The default value is `stackrox`.
====
