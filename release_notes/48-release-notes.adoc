...
* GnuGP memory corruption vulnerability can allow information disclosure and potential arbitrary code execution (link:https://access.redhat.com/security/cve/cve-2025-68973)[CVE-68973])
