...
Release notes for additional related components and products not included in the core xref:../release_notes/ocp-5-0-release-notes.adoc#ocp-5-0-release-notes[{product-title} {product-version} release notes] are available in the following documentation.
...
O::
xref:../backup_and_restore/application_backup_and_restore/release-notes/oadp-1-6-release-notes.adoc#oadp-1-6-release-notes[{oadp-first}]
+
...
+
xref:../virt/release_notes/virt-5-0-release-notes.adoc#virt-5-0-release-notes[Red Hat {VirtProductName}]
+
