...
Purpose: A compilation of links to release notes for additional related components, products, or Operators not included in the core RHOCP release notes.
...
This is because there might be different version compatabilities with RHOCP, or some components/products/Operators might not be available all for a given RHOCP version.