...
This is because there might be different version compatibilities with OCP, or some components/products/Operators might not be available all for a given OCP version.