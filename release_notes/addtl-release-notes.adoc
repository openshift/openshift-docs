...
L::
xref:../observability/logging/logging-6.1/log6x-release-notes-6.1.adoc#log6x-release-notes-6-1[{logging-uc}]
...
{nbsp} +
xref:../windows_containers/wmco_rn/windows-containers-release-notes-10-18-x.adoc#windows-containers-release-notes-10-18-x[{productwinc}] +
{nbsp} +
