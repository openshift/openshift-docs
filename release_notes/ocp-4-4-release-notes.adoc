...
annotation was used instead of `storageClassName` for the Local Storage Operator.
...
xref:../updating/updating-cluster-between-minor.adoc#update-upgrading-web_updating-cluster-between-minor[Updating a cluster by using the web console]
for instructions.
...
{product-title} release 4.4.14 is now available. The list of container images and
bug fixes included in the update are documented in the
link:https://access.redhat.com/errata/RHBA-2020:3075[RHBA-2020:3075] and
link:https://access.redhat.com/errata/RHBA-2020:3288[RHBA-2020:3288]
advisories. The RPM packages included in the update are provided by the
link:https://access.redhat.com/errata/RHBA-2020:3074[RHBA-2020:3074] advisory.
...
{product-title} 4.4. Details of the update are documented in the
link:https://access.redhat.com/errata/RHSA-2020:3078[RHSA-2020:3078] advisory.
...
{product-title} release 4.4.15 is now available. The list of container images and
bug fixes included in the update are documented in the
link:https://access.redhat.com/errata/RHBA-2020:3128[RHBA-2020:3128] advisory.
The RPM packages included in the update are provided by the
link:https://access.redhat.com/errata/RHBA-2020:3127[RHBA-2020:3127] advisory.
...
{product-title} release 4.4.16 is now available. The list of container images and
bug fixes included in the update are documented in the
link:https://access.redhat.com/errata/RHBA-2020:3237[RHBA-2020:3237] advisory.
The RPM packages included in the update are provided by the
link:https://access.redhat.com/errata/RHBA-2020:3238[RHBA-2020:3238] advisory.
...
{product-title} release 4.4.17 is now available. The list of container images and
bug fixes included in the update are documented in the
link:https://access.redhat.com/errata/RHBA-2020:3334[RHBA-2020:3334] advisory.
The RPM packages included in the update are provided by the
link:https://access.redhat.com/errata/RHBA-2020:3335[RHBA-2020:3335] advisory.
...
{product-title} release 4.4.18 is now available. The list of container images and
bug fixes included in the update are documented in the
link:https://access.redhat.com/errata/RHBA-2020:3440[RHBA-2020:3440] advisory.
The RPM packages included in the update are provided by the
link:https://access.redhat.com/errata/RHBA-2020:3441[RHBA-2020:3441] advisory.
...
{product-title} release 4.4.19 is now available. The list of container images and
bug fixes included in the update are documented in the
link:https://access.redhat.com/errata/RHBA-2020:3514[RHBA-2020:3514] advisory.
The RPM packages included in the update are provided by the
link:https://access.redhat.com/errata/RHBA-2020:3515[RHBA-2020:3515] advisory.
...
An update for `openshift` is now available for {product-title} 4.4. Details of
the update are documented in the
link:https://access.redhat.com/errata/RHSA-2020:3579[RHSA-2020:3579] advisory.
...
An update for `openshift-enterprise-hyperkube-container` is now available for
{product-title} 4.4. Details of the update are documented in the
link:https://access.redhat.com/errata/RHSA-2020:3580[RHSA-2020:3580] advisory.
...
{product-title} release 4.4.20 is now available. The list of container images and
bug fixes included in the update are documented in the
link:https://access.redhat.com/errata/RHBA-2020:3564[RHBA-2020:3564] advisory.
The RPM packages included in the update are provided by the
link:https://access.redhat.com/errata/RHBA-2020:3565[RHBA-2020:3565] advisory.
...
An update for `jenkins-2-plugins` is now available for {product-title} 4.4. Details of
the update are documented in the
link:https://access.redhat.com/errata/RHSA-2020:3625[RHSA-2020:3625] advisory.
...
{product-title} release 4.4.21 is now available. The list of container images and
bug fixes included in the update are documented in the
link:https://access.redhat.com/errata/RHBA-2020:3605[RHBA-2020:3605] advisory.
The RPM packages included in the update are provided by the
link:https://access.redhat.com/errata/RHBA-2020:3606[RHBA-2020:3606] advisory.
...
{product-title} release 4.4.23 is now available. The list of container images and
bug fixes included in the update are documented in the
link:https://access.redhat.com/errata/RHBA-2020:3715[RHBA-2020:3715] advisory.
The RPM packages included in the update are provided by the
link:https://access.redhat.com/errata/RHBA-2020:3716[RHBA-2020:3716] advisory.
...
An update for `golang.org/x/text` is now available for {product-title} 4.4. Details of
the update are documented in the
link:https://access.redhat.com/errata/RHSA-2020:3783[RHSA-2020:3783] advisory.
...
{product-title} release 4.4.26 is now available. The list of container images and
bug fixes included in the update are documented in the
link:https://access.redhat.com/errata/RHBA-2020:3764[RHBA-2020:3764] advisory.
The RPM packages included in the update are provided by the
link:https://access.redhat.com/errata/RHBA-2020:3765[RHBA-2020:3765] advisory.
...
{product-title} release 4.4.27 is now available. The list of container images and bug fixes included in the update are documented in the link:https://access.redhat.com/errata/RHBA-2020:4063[RHBA-2020:4063] advisory. The RPM packages included in the update are provided by the link:https://access.redhat.com/errata/RHBA-2020:4064[RHBA-2020:4064] advisory.
...
{product-title} release 4.4.29 is now available. The list of container images and bug fixes included in the update are documented in the link:https://access.redhat.com/errata/RHBA-2020:4224[RHBA-2020:4224] advisory. The RPM packages included in the update are provided by the link:https://access.redhat.com/errata/RHBA-2020:4225[RHBA-2020:4225] advisory.
...
{product-title} release 4.4.30 is now available. The list of container images and bug fixes included in the update are documented in the link:https://access.redhat.com/errata/RHBA-2020:4321[RHBA-2020:4321] advisory. The RPM packages included in the update are provided by the link:https://access.redhat.com/errata/RHBA-2020:4322[RHBA-2020:4322] advisory.
