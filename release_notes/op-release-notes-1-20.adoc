...
* xref:../about/understanding-openshift-pipelines.adoc#understanding-openshift-pipelines[Understanding {pipelines-shortname}]
...
* xref:../get-started/remote-pipelines-tasks-resolvers.adoc#resolver-hub_remote-pipelines-tasks-resolvers[{tekton-hub} deprecation note under Specifying from a Tekton catalog]
