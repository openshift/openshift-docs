...
* The managing compliance guide where you can find detailed instructions on how to use the compliance feature in {product-title-short} was updated. For more information, see xref:../operating/manage-compliance/managing-compliance-20.adoc#managing-compliance-20[Managing the compliance 2.0 feature].
