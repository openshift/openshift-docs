...
* The documentation to view and configure default policies, manage policy categories, and create your own categories was updated. For more information, see xref:../operating/manage_security_policies/about-security-policies.adoc#about-security-policies[About security policies].
