...
// Release notes for Red Hat OpenShift GitOps 1.16.5
include::modules/gitops-release-notes-1-16-5.adoc[leveloffset=+1]

// Release notes for Red Hat OpenShift GitOps 1.16.4
include::modules/gitops-release-notes-1-16-4.adoc[leveloffset=+1]

// Release notes for Red Hat OpenShift GitOps 1.16.3
include::modules/gitops-release-notes-1-16-3.adoc[leveloffset=+1]
