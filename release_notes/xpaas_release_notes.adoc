...
xref:../using_images/xpaas_images/eap.adoc#using-images-xpaas-images-eap[containerized xPaaS image] that is
designed for use with OpenShift Enterprise 3.0 and later.

However, there are xref:../using_images/xpaas_images/eap.adoc#using-images-xpaas-images-eap[significant
...
are available as xref:../using_images/xpaas_images/jws.adoc#using-images-xpaas-images-jws[containerized xPaaS
images] that are designed for use with OpenShift Enterprise 3.0 and later.

However, there are xref:../using_images/xpaas_images/jws.adoc#using-images-xpaas-images-jws[significant
...
xref:../using_images/xpaas_images/a_mq.adoc#using-images-xpaas-images-a-mq[containerized xPaaS image] that is
...
However, there are xref:../using_images/xpaas_images/a_mq.adoc#using-images-xpaas-images-a-mq[significant
...
xref:../using_images/xpaas_images/fuse.adoc#using-images-xpaas-images-fuse[containerized xPaaS image], known as
...
However, there are xref:../using_images/xpaas_images/fuse.adoc#using-images-xpaas-images-fuse[significant
...
xref:../using_images/xpaas_images/decision_server.adoc#using-images-xpaas-images-decision-server[containerized xPaaS
...
However, there are
xref:../using_images/xpaas_images/decision_server.adoc#using-images-xpaas-images-decision-server[significant differences]
...
xref:../using_images/xpaas_images/data_grid.adoc#using-images-xpaas-images-data-grid[containerized xPaaS image] that
...
However, there are xref:../using_images/xpaas_images/data_grid.adoc#using-images-xpaas-images-data-grid[significant
