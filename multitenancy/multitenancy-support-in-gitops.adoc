...
Multitenancy is a software architecture where a single software instance serves multiple distinct user groups, or tenants. Using multitenancy you can share a single Argo CD instance to deploy resources while maintaining isolation your between users. This section is useful to cluster administrators, and provides an understanding of Argo CD instance scopes and when to choose a particular mode.
