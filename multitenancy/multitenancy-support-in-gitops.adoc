...
* xref:../argocd_instance/setting-up-argocd-instance.adoc#gitops-deploy-resources-different-namespaces_setting-up-argocd-instance[Deploy resources to a different namespace]
...
[role="_additional-resources"]
== Additional resources
* xref:../argocd_applications/managing-apps-in-non-control-plane-namespaces.adoc#managing-apps-in-non-control-plane-namespaces[Manage apps in non-control plane namespaces]
...
* xref:../declarative_clusterconfig/configuring-an-openshift-cluster-by-deploying-an-application-with-cluster-configurations.adoc#configuring-an-openshift-cluster-by-deploying-an-application-with-cluster-configurations[Configure cluster with application deployment]
