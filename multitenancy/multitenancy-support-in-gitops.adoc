...
[role="_abstract"]
Multitenancy is a software architecture where a single software instance serves many distinct user groups, or tenants. Using multitenancy, you can share a single Argo CD instance to deploy resources while maintaining isolation between users.
